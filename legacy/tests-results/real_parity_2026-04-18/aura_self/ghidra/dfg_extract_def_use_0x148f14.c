...
LAB_00149264:
      ...
      if (__dest == (byte *)0x0) goto LAB_001492b0;
      goto LAB_00149278;
    }
      ...
      if (-1 < (int)uVar5) {
        if (__dest == (byte *)0x0) {
          *param_2 = 1 << (ulong)(uVar5 & 0x1f);
          if (-1 < (int)uVar6) {
LAB_001495e0:
            if (uVar5 == uVar6) goto LAB_00149604;
            if (__dest != (byte *)0x0) goto LAB_00149460;
          }
        }
        else {
          pcVar10 = strchr((char *)__dest,0x5b);
          if (pcVar10 != (char *)0x0) {
            if ((int)uVar6 < 0) goto LAB_001492b0;
            if (uVar5 != uVar6) goto LAB_00149460;
LAB_00149604:
            *param_3 = 0;
            goto LAB_001492b0;
          }
          *param_2 = 1 << (ulong)(uVar5 & 0x1f);
          if (-1 < (int)uVar6) goto LAB_001495e0;
LAB_00149460:
          pcVar10 = strchr((char *)__dest,0x5b);
          if (pcVar10 != (char *)0x0) goto LAB_00149470;
        }
        *param_3 = *param_3 | 1 << (ulong)(uVar5 & 0x1f);
      }
LAB_00149470:
      ...
      if (iVar3 == 0) {
        ...
        *param_2 = *param_2 | 0x10;
        ...
        if (((iVar3 != 0) && (iVar3 = strcasecmp(__s1,"retq"), iVar3 != 0)) &&
           (iVar3 = strcasecmp(__s1,"retn"), iVar3 != 0)) goto LAB_001492b0;
        uVar5 = 1;
      }
      *param_3 = uVar5;
      goto LAB_001492b0;
    ...
    *pbVar11 = 0;
    ...
    if (iVar3 != 0) {
      bVar2 = true;
      iVar3 = strcasecmp(__s1,"movsx");
      if (iVar3 != 0) goto LAB_0014905c;
      uVar5 = dfg_reg_from_operand(__dest);
      if (-1 < (int)uVar5) goto LAB_00149330;
      goto LAB_0014952c;
    }
    uVar5 = dfg_reg_from_operand(__dest);
    if ((int)uVar5 < 0) {
      uVar5 = dfg_reg_from_operand(pbVar13);
      if (-1 < (int)uVar5) goto LAB_00149264;
    }
    else {
LAB_00149330:
      pcVar10 = strchr((char *)__dest,0x5b);
...
LAB_00149278:
    pcVar10 = strchr((char *)__dest,0x5b);
    if (pcVar10 == (char *)0x0) goto LAB_001492b0;
    uVar5 = dfg_reg_from_operand(__dest);
  }
  if (-1 < (int)uVar5) {
    *param_3 = *param_3 | 1 << (ulong)(uVar5 & 0x1f);
