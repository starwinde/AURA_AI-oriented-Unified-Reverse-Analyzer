  ...
  if (uVar1 < 0xd77) {
    if (uVar1 < 0xd39) {
      if (uVar1 < 0xc91) {
        ...
        if ((uVar2 & 0x8552492) != 0) goto LAB_001d80a4;
        uVar2 = uVar2 & 0x4209249;
      }
    }
    else {
      uVar2 = 1L << ((ulong)(uVar1 - 0xd39) & 0x3f);
      if ((uVar2 & 0x2082082108420842) != 0) goto LAB_001d80a4;
...
joined_r0x001d8078:
        ...
        if ((uVar2 & 0x1815415550551555) != 0) goto LAB_001d8010;
        uVar2 = uVar2 & 0x6000000000000000;
      }
      else {
        uVar2 = 1L << ((ulong)(uVar1 - 0x147b) & 0x3f);
        if ((uVar2 & 0x1085249) != 0) goto LAB_001d8010;
...
LAB_001d80a4:
    ...
    if ((uVar2 & 0x4400000042108421) != 0) goto LAB_001d80a4;
