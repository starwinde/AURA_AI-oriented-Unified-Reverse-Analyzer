...

{
  ...
  SStream_concat0(param_3,&DAT_001f6ea0);
...
LAB_001c8edc:
  ...
  do {
    ...
    if ((uVar5 & 1) == 0) {
      SStream_concat(param_3,&DAT_001fad88,AsmStrsvreg_7 + (byte)RegAsmOffsetvreg_8[iVar4 - 1U],
                     param_4);
      lVar10 = *(long *)(param_1 + 800);
      if (*(int *)(lVar10 + 0x60) != 0) goto LAB_001c9024;
LAB_001c8f78:
      if (iVar3 + 1 != iVar12) goto LAB_001c8f84;
LAB_001c90c0:
...
LAB_001c9024:
      ...
      *(char *)(lVar11 + 0x67) = (char)uVar9 + '\x01';
      if (iVar3 + 1 == iVar12) goto LAB_001c90c0;
LAB_001c8f84:
      SStream_concat0(param_3,", ");
      if (iVar4 - 0x7bU < 0x1f) goto LAB_001c8ff0;
      if (iVar4 != 0x9a) goto LAB_001c8fa8;
      iVar4 = 0x7b;
    }
    iVar3 = iVar3 + 1;
  } while (iVar3 != iVar12);
  SStream_concat0(param_3,&DAT_001f6fa0);
  return;
}
