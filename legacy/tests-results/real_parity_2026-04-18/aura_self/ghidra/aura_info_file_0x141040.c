        ...
        if (*(int *)(lVar6 + 0x20) != 0) {
          ...
          do {
            while( true ) {
              ...
              lVar11 = lVar11 + 0x38;
              uVar12 = uVar5;
              if (*(uint *)(lVar6 + 0x20) <= uVar5) goto LAB_00141534;
            }
            __printf_chk(2,"  [%u] %-20s vaddr=0x%016lx  size=0x%08lx  %s\n",uVar12,"(null)",
                         *(undefined8 *)(lVar10 + 8),*(undefined8 *)(lVar10 + 0x18),&local_70);
            uVar12 = uVar12 + 1;
        ...
        if (*(int *)(lVar6 + 0x20) != 0) {
          ...
          do {
            while( true ) {
              ...
              putc(10,*(FILE **)puVar4);
              if (*(uint *)(lVar6 + 0x20) <= uVar12) goto LAB_00141250;
            }
            lVar11 = lVar11 + 0x38;
            putc(10,*(FILE **)puVar4);
          } while (uVar12 < *(uint *)(lVar6 + 0x20));
...
LAB_001416b0:
            ...
            if (*(int *)(lVar10 + 0x24) != 1) {
              ...
              __printf_chk(2,", \"address\": %lu, \"type\": \"%s\", \"binding\": \"%s\"}",uVar9,
                           pcVar7,pcVar3);
              if (*(uint *)(lVar6 + 0x30) <= uVar12 + 1) goto LAB_001412d0;
LAB_00141370:
              uVar12 = uVar12 + 1;
              lVar11 = lVar11 + 0x28;
              putc(0x2c,*(FILE **)puVar4);
            ...
            __printf_chk(2,", \"address\": %lu, \"type\": \"%s\", \"binding\": \"%s\"}",uVar9,pcVar7
                         ,"GLOBAL");
            if (uVar12 + 1 < *(uint *)(lVar6 + 0x30)) goto LAB_00141370;
LAB_001412d0:
            uVar12 = uVar12 + 1;
            lVar11 = lVar11 + 0x28;
            putc(10,*(FILE **)puVar4);
