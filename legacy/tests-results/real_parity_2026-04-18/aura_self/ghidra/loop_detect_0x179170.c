    ...
    if (local_f0[0] != 0) {
      ...
      do {
        ...
        if (uVar36 != 0) {
          puVar7 = __ptr;
LAB_00179264:
          if (*puVar7 != uVar9) goto LAB_00179258;
          ...
          if (local_90 != (uint *)0x0) {
            ...
            if (__ptr_00 != (byte *)0x0) {
              ...
              if (uVar31 == 0) {
                pvVar5 = malloc(0);
                uVar37 = 0;
                if (pvVar5 != (void *)0x0) goto LAB_0017937c;
              }
              else {
                uVar34 = 0;
                pbVar15 = __ptr_00;
...
LAB_001795c4:
            ...
            do {
              ...
              if (iVar4 - 0x17U < 2 || iVar4 == 0x1a) {
                if (-1 < iVar20) goto LAB_00179574;
                piVar12 = (int *)0x0;
                if (iVar4 == 0x17) goto LAB_001796f8;
                goto LAB_001795b8;
              }
              piVar26 = piVar26 + -0x22;
            } while (piVar26 != piVar23 + ((ulong)uVar32 - (ulong)uVar31) * 0x22 + -0x44);
            piVar26 = (int *)0x0;
            if (iVar20 < 0) goto LAB_001795c4;
LAB_00179574:
            piVar12 = (int *)(*(long *)(lVar27 + 8) + (long)iVar20 * 0x88);
            do {
              if (*piVar12 - 0x17U < 2 || *piVar12 == 0x1a) goto LAB_001795a8;
              iVar20 = iVar20 + -1;
              piVar12 = piVar12 + -0x22;
            } while (iVar20 != -1);
            piVar12 = (int *)0x0;
LAB_001795a8:
            if (piVar26 == (int *)0x0) goto LAB_001795c4;
            iVar4 = *piVar26;
            if (iVar4 == 0x17) {
              if (-1 < (int)uVar31) {
                piVar23 = *(int **)(lVar11 + 8);
                          ...
                          do {
                            if (piVar26[6] == piVar12[2]) {
                              ...
                              if (((1 < iVar4 - 0xdU && iVar4 != 0x11) && (9 < iVar4 - 0xbU)) ||
                                 ((uint)piVar12[0x12] < 2)) goto LAB_00179968;
                              uVar31 = piVar12[6];
...
LAB_001795b8:
              if (piVar12 == (int *)0x0 || iVar4 != 0x18) goto LAB_001795c4;
              uVar25 = 0;
              iVar4 = 0;
              uVar31 = 0;
              iVar20 = 0;
...
joined_r0x00179bb4:
            uVar31 = uVar28;
            uVar32 = uVar21;
            if (sVar19 == sVar35) goto LAB_00179c28;
            puVar38 = puVar38 + 0x18;
            sVar19 = sVar19 + 1;
          } while( true );
        }
...
LAB_00179258:
  puVar7 = puVar7 + 0x18;
  if (puVar7 == __ptr + (ulong)uVar36 * 0x18) goto LAB_001794c4;
  goto LAB_00179264;
LAB_001797e0:
      ...
      do {
        if (*(uint *)(puVar18 + 1) != 0) {
          ...
          do {
            if (piVar17[2] == iVar20) {
              iVar20 = *piVar17;
              if ((1 < iVar20 - 2U) || ((uint)piVar17[0x12] < 2)) goto LAB_001797d4;
              uVar21 = piVar17[6];
              if (uVar21 != uVar32 && piVar17[10] != uVar32) goto LAB_001797d4;
              if (uVar21 == uVar32) {
                uVar21 = piVar17[10];
              }
              uVar28 = 0;
...
LAB_001798d4:
  do {
    if (*(uint *)(puVar18 + 1) != 0) {
      ...
      do {
        if (piVar17[2] == uVar21) {
          if (*piVar17 != 1) goto LAB_001797d4;
...
LAB_001797d4:
  ...
  if (piVar23 == piVar26) goto LAB_00179968;
  goto LAB_001797e0;
LAB_00179c28:
  if (uVar31 != 0xffffffff) {
  ...
  uVar9 = uVar9 + 1;
  puVar7 = puVar7 + 0x18;
  if (uVar36 == uVar9) goto code_r0x00179c54;
  goto LAB_00179b94;
code_r0x00179c54:
