...
void emit_phi_assigns(long *param_1,uint param_2,int param_3,int *param_4)

{
  ...
  if (param_2 < *(uint *)((long *)*param_1 + 1)) {
    lVar11 = *(long *)*param_1 + (ulong)param_2 * 0x48;
              ...
              if (puVar3 != (undefined4 *)0x0) {
                ...
                *puVar3 = 10;
                ...
                if (puVar4 != (undefined4 *)0x0) {
                  *puVar4 = 0xd;
                  puVar4[0x26] = uVar2;
                  __snprintf_chk(puVar4 + 0x27,0x40,2,0x40,&DAT_001f82e8);
                }
                ...
                *(undefined8 *)(puVar3 + 0x28) = uVar5;
                if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
                  ...
                  if (uVar9 <= uVar6) {
                    ...
                    if (__ptr == (void *)0x0) goto LAB_0017cd7c;
                    uVar6 = param_4[0x28];
