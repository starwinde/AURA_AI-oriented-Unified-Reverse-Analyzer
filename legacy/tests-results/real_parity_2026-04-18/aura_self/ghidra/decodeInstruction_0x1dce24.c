  ...
  if (param_5 == 2) {
    ...
    *(long *)(param_1 + 0x58) = lVar17;
    if ((local_6e & 0xf0) == 0x40) {
      ...
      if (local_6e < 0x68) {
        if (uVar12 < 0x2e) {
          if (local_6e != 0x26) goto LAB_001de240;
        }
...
LAB_001de240:
      ...
      else if ((local_6e != 0xf0) && (1 < (uVar12 + 0xe & 0xff))) goto LAB_001de240;
    }
    else {
      param_2 = *(code **)(param_1 + 0x48);
      param_3 = *(undefined8 *)(param_1 + 0x50);
  ...
  lVar17 = lVar14 + 1;
  *(long *)(param_1 + 0x58) = lVar17;
  if (lVar14 != *(long *)(param_1 + 0x68)) goto LAB_001dcef8;
...
LAB_001dcf00:
    if (uVar12 < 0x2e) {
      ...
      if ((1L << ((ulong)(uVar12 - 0x2e) & 0x3f) & 0xc0000000010101U) == 0) {
        if (uVar12 == 0x67) {
          ...
          if (uVar12 != 0x66) {
            ...
            if (uVar12 != 0x62) {
              iVar5 = *(int *)(param_1 + 0x60);
              if (iVar5 != 2) goto LAB_001dd2d4;
              if (0xf < (uVar12 - 0x40 & 0xff)) goto LAB_001de79c;
              iVar5 = (**(code **)(param_1 + 0x48))
                                (*(undefined8 *)(param_1 + 0x50),&local_6d,lVar17);
              if (iVar5 != 0) goto switchD_001de4b8_caseD_10;
              iVar5 = *(int *)(param_1 + 0x60);
      ...
      if (uVar12 == 0x3e) {
        ...
        if (uVar12 == 0x2e) goto LAB_001dd2a0;
        if (uVar12 != 0x36) goto switchD_001de4b8_caseD_10;
        uVar13 = 2;
      }
      else if (uVar12 == 100) {
        uVar13 = 5;
        ...
        if (uVar12 != 0x65) goto switchD_001de4b8_caseD_10;
        uVar13 = 6;
      }
    }
LAB_001dd2a0:
...
LAB_001dcef8:
    if (uVar12 < 0x68) goto LAB_001dcf00;
    if (uVar12 == 0xf0) goto LAB_001ddfd4;
  }
  else {
    if (local_6e != 0xf3) {
...
LAB_001dd1dc:
        ...
        goto switchD_001de4b8_caseD_10;
      }
      goto LAB_001dcef8;
    }
    ...
    if (*(int *)(param_1 + 0x60) != 2) goto LAB_001dd264;
    if ((byte)(local_6d - 0x40) < 0x10) goto LAB_001dd1dc;
  }
  if (1 < (uVar12 + 0xe & 0xff)) goto LAB_001de714;
LAB_001dd264:
...
LAB_001dd054:
    ...
    if (iVar7 == 3) {
      ...
      if (uVar12 != 2) {
        if (uVar12 == 3) goto LAB_001dd098;
LAB_001ddad8:
        bVar3 = uVar12 != 1;
        uVar12 = 1;
        if (bVar3) goto switchD_001de4b8_caseD_10;
      }
LAB_001ddae0:
...
LAB_001dd098:
      ...
      if (iVar7 == 1) goto LAB_001dd098;
      if (iVar7 != 4) goto LAB_001dd2f0;
      ...
      if (bVar10 == 9) {
        ...
        if (bVar10 != 10) {
          if (bVar10 != 8) goto switchD_001de4b8_caseD_10;
          goto LAB_001dd098;
        }
        pcVar16 = *(code **)(param_1 + 0x48);
        uVar13 = 6;
    ...
    *(long *)(param_1 + 0x58) = *(long *)(param_1 + 0x58) + 1;
    ...
    if (uVar12 == 0xc5) {
      ...
      if ((iVar5 == 2) || (((byte)local_6a & 0xc0) == 0xc0)) {
        ...
        iVar7 = *(int *)(param_1 + 0x78);
        *(long *)(param_1 + 0x58) = *(long *)(param_1 + 0x58) + -1;
        if (iVar7 != 1) goto joined_r0x001dda58;
      }
      param_1[0x3c] = local_6e;
      iVar5 = (**(code **)(param_1 + 0x48))(*(undefined8 *)(param_1 + 0x50),param_1 + 0x3d);
      if (iVar5 == 0) {
...
LAB_001dd644:
      if (iVar5 == 0) goto LAB_001dd020;
      if (iVar5 == 1) goto LAB_001dda64;
      if (iVar5 == 2) goto LAB_001dd658;
      goto LAB_001dd054;
    }
    if (uVar12 == 0x8f) {
      iVar5 = (**(code **)(param_1 + 0x48))(*(undefined8 *)(param_1 + 0x50),&local_6a);
  ...
  if (iVar5 == 0) {
    ...
    if (bVar10 == 0) {
      ...
      if (*(int *)(param_1 + 0x84) == 0) {
        ...
        if (cVar11 == -0xe) goto LAB_001dddd0;
        uVar19 = uVar12 | 2;
        if (cVar11 != -0xd) {
          uVar19 = uVar12;
        }
...
LAB_001dd404:
      if ((*(ulong *)(param_1 + 0x80) & 0xffffffff0000ff00) != 0x20000f800 &&
        ...
        if ((*(int *)(param_1 + 0x60) == 0) || ((param_1[0x38] & 1U) != 0)) {
          ...
          if ((uVar12 >> 4 & 1) != 0) goto LAB_001ddb38;
...
LAB_001dd36c:
      bVar4 = param_1[0x3e];
      bVar10 = bVar4 & 3;
      if (bVar10 != 2) goto LAB_001dd37c;
LAB_001dde18:
      uVar6 = uVar12 | 0x42;
    }
    else {
      if (iVar5 != 1) {
        if (iVar5 != 4) goto switchD_001de4b8_caseD_10;
        goto LAB_001dd36c;
      }
      bVar4 = param_1[0x3d];
      bVar10 = bVar4 & 3;
      if (bVar10 == 2) goto LAB_001dde18;
LAB_001dd37c:
      if (bVar10 == 3) {
        uVar6 = uVar12 | 0x44;
      }
...
LAB_001dd3a8:
    ...
    if (iVar7 != 0) {
      uVar6 = uVar12;
      if (iVar7 != 2) goto LAB_001dd3e4;
LAB_001dda80:
      iVar5 = *(int *)(param_1 + 0x84);
      if ((param_1[0x38] & 1U) == 0) goto LAB_001dd3f0;
      bVar10 = param_1[0x81];
      if (bVar10 < 0x90) {
        if ((bVar10 < 0x82) || (iVar5 != 1)) goto LAB_001dd3f0;
LAB_001ddaac:
        uVar12 = uVar12 ^ 0x10;
        param_1[0x7e] = '\x04';
        param_1[0x7f] = '\x04';
        ...
        if (1 < (byte)(bVar10 + 0x18)) goto LAB_001dd3f0;
        if (iVar5 == 0) goto LAB_001ddaac;
      }
      goto LAB_001dd404;
    }
    uVar6 = uVar12 ^ 0x20;
          ...
          if (uVar6 < 0x13d) {
            ...
            if (uVar6 < 0x2c8) {
              if (uVar6 < 0x2bf) {
                ...
                if (0x21 < uVar12) goto switchD_001de4b8_caseD_10;
...
joined_r0x001ddbe0:
              if ((uVar8 & 1) != 0) goto LAB_001dd4e8;
            }
          }
          else {
...
LAB_001dd228:
        ...
        if (uVar6 == 0x3b5d) goto LAB_001dd4e8;
        uVar12 = uVar6 - 0x3b5f & 0xffff;
        if (0x3d < uVar12) goto switchD_001de4b8_caseD_10;
        uVar8 = 0x271389c4e0029215 >> ((ulong)uVar12 & 0x3f);
      }
joined_r0x001de208:
      if ((uVar8 & 1) == 0) goto switchD_001de4b8_caseD_10;
    }
LAB_001dd4e8:
    iVar5 = *(int *)(param_1 + 0x78);
    if (iVar5 == 3) {
...
LAB_001de480:
          ...
          if (0x21 < bVar10) goto switchD_001de4b8_caseD_10;
          uVar12 = (uint)bVar10;
          switch(bVar10) {
          case 0:
          case 0x1a:
          ...
          case 0xf:
            ...
            if ((iVar7 == 0) && ((*(int *)(param_1 + 0xc4) - 0x15U & 0xffffffef) == 0)) {
              ...
              if (cVar11 == '\r') {
                ...
                if (cVar11 != '\f') goto switchD_001de4b8_caseD_10;
          ...
          case 0x12:
            ...
            if (iVar7 != 0) goto switchD_001de4b8_caseD_10;
          ...
          if (iVar5 != 0) goto switchD_001de4b8_caseD_10;
switchD_001de4b8_caseD_0:
          lVar17 = lVar17 + 1;
          if (lVar17 == 6) goto LAB_001dd6f0;
          goto LAB_001de480;
        }
      }
...
LAB_001dd54c:
    ...
    if (uVar6 != 0) goto switchD_001de4b8_caseD_10;
switchD_001dd58c_caseD_0:
    lVar17 = lVar17 + 1;
    if (lVar17 == 6) goto code_r0x001dd6ec;
    goto LAB_001dd54c;
  }
switchD_001de4b8_caseD_10:
LAB_001dce94:
  uVar13 = 0xffffffff;
LAB_001dce98:
