...
/* WARNING: Removing unreachable block (ram,0x001e99ac) */
...

{
  ...
  if (uVar1 < 0x12) {
    ...
    case 0xe:
      ...
      break;
    default:
      goto switchD_001e9a3c_default;
    }
  }
  else {
    if ((0x19 < uVar1) || (uVar1 < 0x12)) {
switchD_001e9a3c_default:
