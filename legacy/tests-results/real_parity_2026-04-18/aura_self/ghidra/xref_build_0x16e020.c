            ...
            if ((*__s != 0) && (pcVar6 = strchr((char *)__s,0x5b), pcVar6 == (char *)0x0)) {
              ...
              if ((local_70 != __s) && ((*local_70 & 0xdf) == 0)) {
                ...
                if (*(uint *)((long)__ptr + 0xc) <= uVar1) {
                  ...
                  if (pvVar5 == (void *)0x0) goto LAB_0016e0d8;
                  *__ptr = pvVar5;
...
LAB_0016e0d8:
            uVar15 = uVar15 + 1;
            __s = __s + 0xe0;
            if (param_2 <= uVar15) goto LAB_0016e230;
          }
          if (__s[-0x40] == 0x6a) {
            if ((*__s != 0) && (pcVar6 = strchr((char *)__s,0x5b), pcVar6 == (char *)0x0)) {
              local_70 = (byte *)0x0;
          ...
          if (pcVar6 == (char *)0x0) {
            ...
            if (bVar13 != 0x5b && bVar13 != 0x25) {
              if (((byte)(bVar13 + 0x9f) < 0x1a) &&
                ...
                if (((bVar13 & 0xdf) == 0) || (bVar13 == 0x5d)) goto LAB_0016e0d8;
              }
              local_70 = (byte *)0x0;
              uVar9 = strtoull((char *)pbVar14,(char **)&local_70,0);
              if ((local_70 != pbVar14) &&
          ...
          if (pbVar14 == local_70) goto LAB_0016e0d8;
          lVar10 = *(long *)(__s + -0x60);
          uVar9 = -uVar8;
          if (iVar4 == 1) {
            uVar9 = uVar8;
