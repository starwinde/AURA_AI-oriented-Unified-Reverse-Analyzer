...
void callgraph_print_dot(undefined8 *param_1,FILE *param_2)

{
  ...
  if ((plVar12 != (long *)0x0) && (uVar10 = *(uint *)(plVar12 + 1), uVar10 != 0)) {
    ...
    lVar9 = 0;
    lVar7 = lVar8;
    if (*(int *)(lVar8 + 4) == -1) goto LAB_00164aa0;
LAB_00164a40:
    uVar11 = uVar11 + 1;
    if (uVar11 < uVar10) {
      while( true ) {
        ...
        do {
          while (*piVar4 != -1) {
            piVar4 = piVar4 + 6;
            if (piVar2 == piVar4) goto LAB_00164aa0;
          }
          if (*(long *)(piVar4 + 1) == *(long *)(lVar8 + 8)) goto LAB_00164a40;
          piVar4 = piVar4 + 6;
        } while (piVar2 != piVar4);
LAB_00164aa0:
...
LAB_00164b40:
    ...
    do {
      ...
      if (*(uint *)(lVar7 + lVar8) < *(uint *)(plVar13 + 1)) {
        puVar6 = (undefined1 *)(*plVar13 + (ulong)*(uint *)(lVar7 + lVar8) * 0x98 + 0x14);
      }
        ...
        if (*(uint *)(plVar13 + 1) != 0) {
          ...
          do {
            if (*(long *)(lVar9 + 8) == *plVar3) {
              __fprintf_chk(param_2,2,&DAT_001f71f8,(long)plVar3 + 0x14);
              goto LAB_00164c34;
            }
            plVar3 = plVar3 + 0x13;
          } while (plVar5 != plVar3);
...
LAB_00164c34:
        ...
        if (uVar11 < *(uint *)(plVar13 + 1)) {
          puVar6 = (undefined1 *)(*plVar13 + (ulong)uVar11 * 0x98 + 0x14);
        }
