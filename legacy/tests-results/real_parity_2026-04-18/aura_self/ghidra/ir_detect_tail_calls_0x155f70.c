...
undefined8 ir_detect_tail_calls(long *param_1)
      ...
      if (*(uint *)(puVar10 + 1) != 0) {
        ...
        do {
          while( true ) {
            ...
            piVar7 = piVar7 + 0x22;
            if (piVar7 == piVar11) goto LAB_001560c8;
          }
          piVar7 = piVar7 + 0x22;
...
LAB_001560c8:
  ...
  uVar15 = 0;
  puVar9 = puVar14 + (ulong)uVar1 * 0x12;
LAB_001560f8:
  uVar1 = *puVar14;
  if (1 < uVar1) {
    uVar2 = uVar1 - 1;
    lVar8 = *(long *)(puVar14 + -2);
    lVar13 = lVar8 + (ulong)uVar2 * 0x88;
    if ((*(int *)(lVar8 + (ulong)uVar2 * 0x88) == 0x1a) && (uVar4 = uVar1 - 2, -1 < (int)uVar4)) {
      piVar7 = (int *)(lVar8 + (ulong)uVar4 * 0x88);
      uVar6 = uVar4;
      while (*piVar7 != 0x19) {
        uVar6 = uVar6 - 1;
        if ((*piVar7 - 0x16U < 3) || (piVar7 = piVar7 + -0x22, uVar6 == 0xffffffff))
        goto LAB_001560ec;
      }
      uVar5 = piVar7[2];
      if (((uVar5 != 0xffffffff) &&
        ...
        uVar5 = uVar6 + 1;
        if (uVar2 <= uVar5) goto LAB_001561d4;
        piVar11 = (int *)(lVar8 + (ulong)uVar5 * 0x88);
        goto LAB_001561b8;
      }
    }
  }
  goto LAB_001560ec;
  while ((int *)(lVar8 + 0x88 + ((ulong)((uVar1 - 3) - uVar6) + (ulong)uVar5) * 0x88) != piVar11) {
LAB_001561b8:
    iVar3 = *piVar11;
    piVar11 = piVar11 + 0x22;
    if (iVar3 - 0x16U < 4) goto LAB_001560ec;
  }
LAB_001561d4:
  iVar3 = piVar7[0x12];
  ...
  *(int *)(lVar13 + 0x60) = piVar7[0x18];
  ...
  piVar7[0x18] = 0;
  if (uVar5 < uVar1) {
    memmove((void *)(lVar8 + (long)(int)uVar6 * 0x88),(void *)(lVar8 + (ulong)uVar5 * 0x88),
            ((ulong)(uVar4 - uVar6) + 1) * 0x88);
  }
  uVar15 = 1;
  *puVar14 = uVar2;
LAB_001560ec:
