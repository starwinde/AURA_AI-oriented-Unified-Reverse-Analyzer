...
LAB_00160a40:
    if ((*(byte *)(param_8 + local_c8) & 1) != 0) goto LAB_00160b80;
    lVar15 = *param_1;
    *(undefined1 *)(param_8 + local_c8) = 1;
    ...
    if ((int)uVar5 < 0) {
      if (((*(byte *)(param_4 + local_c8) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
        ...
        piVar23 = (int *)0x0;
        if (uVar5 != 0) goto LAB_00160ad0;
      }
    }
    else {
      piVar23 = (int *)(*(long *)(lVar21 + 8) + (long)(int)uVar5 * 0x88);
      do {
        if (*piVar23 - 0x17U < 2 || *piVar23 == 0x1a) goto LAB_00160ab8;
...
LAB_00162530:
                  ...
                  do {
                    ...
                    if ((uVar4 == (uint)uVar17) || (uVar5 = uVar5 + 1, uVar19 < uVar5)) {
                      if (uVar16 < uVar19) {
                        if (uVar16 != uVar18) goto LAB_001620d8;
                        uVar16 = (uint)uVar20;
                        uVar20 = local_c8;
                      }
                      break;
...
joined_r0x00162580:
                  uVar17 = uVar20;
                  uVar4 = uVar16;
                  if (puVar10 != (uint *)0x0) goto LAB_00161bec;
                }
LAB_00162114:
                iVar6 = 8;
                do {
...
LAB_001620d8:
                ...
                do {
                  ...
                  goto joined_r0x00162580;
                  uVar4 = uVar9;
                } while (uVar9 != uVar18);
                uVar17 = (ulong)uVar16;
                uVar4 = (uint)uVar20;
                if (puVar10 == (uint *)0x0) goto LAB_00162114;
LAB_00161bec:
                if ((puVar10[6] != 3) || (iVar6 = 8, (puVar10[0x11] & 1) == 0)) goto LAB_00162114;
                do {
                  fputc(0x20,param_9);
                  iVar6 = iVar6 + -1;
                } while (iVar6 != 0);
                  ...
                  if (uVar16 != 0xd) {
                    if (uVar16 < 0xe) {
                      if (uVar16 == 0xb) {
                        ...
                        if (uVar16 != 0xc) goto LAB_0016289c;
                        fwrite(&DAT_001f83c8,1,4,param_9);
                      }
                      goto LAB_00161ca4;
                    }
                    if (uVar16 == 0xe) goto LAB_0016266c;
                  }
...
LAB_00162688:
                  ...
                  if (uVar16 < 0x14) {
                    if (uVar16 == 0x11) goto LAB_00162688;
                  }
                  else if (uVar16 != 0x14) {
LAB_0016289c:
...
LAB_00161ca4:
              ...
              uVar16 = *(uint *)(param_1 + 1);
              if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_00160b80;
...
LAB_0016157c:
              ...
              lVar15 = extraout_x12;
              uVar16 = extraout_w11;
              if (uVar5 < extraout_w11) goto LAB_00161034;
            }
          }
        }
        else {
LAB_00160ad0:
          ...
          do {
            if (*puVar10 == uVar18) goto LAB_00160b00;
            uVar4 = uVar4 + 1;
...
LAB_00160b00:
          if (piVar23 != (int *)0x0) {
            if (*piVar23 == 0x17) {
              ...
              uVar16 = piVar23[0x1a];
              cf_emit_block_body_part_0_isra_0(lVar15,local_c8,param_9,2);
              if (puVar10 == (uint *)0x0) goto LAB_001624ac;
              uVar4 = puVar10[5];
              uVar19 = *(uint *)(param_1 + 1);
              if (uVar4 < uVar19) {
                if (uVar5 == uVar4) {
                ...
                if (uVar5 < uVar19) {
                  lVar15 = *param_1;
                  if (uVar5 != uVar18) goto LAB_00162530;
                }
      ...
      if (piVar11[4] != 0) {
        do {
          ...
          if ((*(byte *)(lVar21 + 0xc) & 1) == 0) {
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar5 < uVar16) goto LAB_00161a34;
LAB_001619a8:
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar16 <= uVar5) goto LAB_001619a8;
LAB_00161a34:
            pvVar12 = calloc((ulong)uVar16,1);
            if (pvVar12 == (void *)0x0) goto LAB_001619a8;
            uVar4 = piVar11[8];
...
LAB_00161af0:
      ...
      uVar16 = *(uint *)(param_1 + 1);
      uVar5 = piVar11[6];
      if (uVar5 < uVar16 && param_3 != uVar5) goto LAB_001614c0;
      goto LAB_00160b80;
    }
...
LAB_00161484:
    ...
    if (piVar23 == (int *)0x0) goto LAB_00160b80;
    iVar6 = *piVar23;
    if (iVar6 == 0x18) {
      uVar5 = piVar23[0x19];
      uVar16 = *(uint *)(param_1 + 1);
      if (param_3 != uVar5 && uVar5 < uVar16) goto LAB_001614c0;
      goto LAB_00160b80;
    }
    if (iVar6 == 0x1a) {
      iVar6 = 8;
        ...
        if (piVar23[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              lVar15 = lVar15 + 1;
              uVar16 = (uint)lVar15;
              if ((uint)piVar23[0x18] <= uVar16) goto LAB_00161550;
            }
            __fprintf_chk(param_9,2,&DAT_001f82e8);
            lVar15 = lVar15 + 1;
...
LAB_00161550:
    ...
    if (iVar6 != 0x17) goto LAB_00160b80;
    uVar16 = piVar23[0x19];
    uVar5 = piVar23[0x1a];
...
LAB_00161710:
        ...
        if (uVar4 < uVar18) goto LAB_00160bfc;
        local_80[0] = uVar18;
        local_78 = param_5;
        plStack_70 = param_1;
      ...
      uVar18 = *(uint *)(param_1 + 1);
      if (uVar18 <= uVar4) goto LAB_00161710;
LAB_00160bfc:
      uVar20 = (ulong)uVar4;
      if (uVar5 == uVar4) {
        iVar6 = 8;
            ...
            if (uVar5 != 0) {
              ...
              do {
                ...
                if ((*(int *)(*(long *)(lVar15 + 8) + lVar21 * 0x88) == 0x1b) &&
                  ...
                  uVar17 = 0;
LAB_00161f30:
                  if (uVar16 != *(uint *)(*(long *)(lVar22 + 0x58) + uVar17 * 4)) goto LAB_00161f24;
                  iVar6 = 0xc;
                  do {
                    fputc(0x20,param_9);
                    iVar6 = iVar6 + -1;
...
LAB_00160d5c:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar18 = *(uint *)(lVar15 + 0x10);
                    if (uVar18 <= (uint)lVar21) goto LAB_00160e0c;
                  }
LAB_00160d10:
                  lVar21 = lVar21 + 1;
...
LAB_00160f1c:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar16 = *(uint *)(lVar15 + 0x10);
                    if (uVar16 <= (uint)lVar21) goto LAB_00160fc8;
                  }
LAB_00160ed0:
                  lVar21 = lVar21 + 1;
                } while ((uint)lVar21 < uVar16);
...
LAB_00160fc8:
    ...
    if (1 < iVar6 - 1U) {
      if (1 < iVar7 - 1U) goto LAB_00160bdc;
      iVar6 = 8;
      do {
        fputc(0x20,param_9);
        iVar6 = iVar6 + -1;
      ...
      if (*(uint *)(param_1 + 1) <= uVar16 || param_3 == uVar16) goto LAB_00160b80;
      bVar2 = *(byte *)(param_8 + (ulong)uVar16);
      uVar5 = uVar16;
      goto joined_r0x001616a4;
    }
    iVar8 = 8;
    if (iVar7 - 1U < 2) {
      do {
...
LAB_001614c0:
  ...
  if ((*(byte *)(param_8 + (ulong)uVar5) & 1) != 0) goto LAB_00160b80;
  goto LAB_00160a40;
LAB_00161f24:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_00161ee4;
  goto LAB_00161f30;
LAB_00161348:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_00161308;
  goto LAB_00161354;
LAB_00160d50:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_00160d10;
  goto LAB_00160d5c;
LAB_00160f10:
  uVar17 = uVar17 + 1;
  if (*(uint *)(lVar22 + 0x60) == uVar17) goto LAB_00160ed0;
  goto LAB_00160f1c;
}
