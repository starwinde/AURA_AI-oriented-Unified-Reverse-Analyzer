...
LAB_001703c8:
    local_80 = (long *)0x0;
    local_8c = 0;
    if (param_2 != 0) goto LAB_001703cc;
LAB_00170f08:
    plVar5 = local_80;
...
LAB_00171128:
      ...
      if ((uVar8 & 1) != 0) goto LAB_001714cc;
LAB_0017113c:
      local_78 = 0;
      if ((uVar8 >> 1 & 1) != 0) goto LAB_00171450;
LAB_00171140:
      uStack_70 = 0;
      if ((uVar8 >> 2 & 1) != 0) goto LAB_00171468;
      do {
        lVar1 = *plVar21;
        lVar18 = plVar21[1];
        while( true ) {
          if (lVar1 != 0) {
            ...
            uVar22 = uVar22 + 1;
            lVar20 = lVar20 + 0x38;
            if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_0017117c;
            goto LAB_00171128;
          }
          __fprintf_chk(param_3,2,"| %u | `%s` | `0x%lx` | %lu | %s |\n",uVar22,&DAT_001fbd80,lVar18
                        ,plVar21[3],&local_78);
          uVar22 = uVar22 + 1;
          lVar20 = lVar20 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_0017117c;
          plVar21 = (long *)(*(long *)(lVar9 + 0x18) + lVar20);
          uVar8 = *(uint *)(plVar21 + 6);
          if ((uVar8 & 1) == 0) goto LAB_0017113c;
LAB_001714cc:
          local_78 = 0x52;
          if ((uVar8 >> 1 & 1) == 0) goto LAB_00171140;
LAB_00171450:
          uStack_70 = 0;
          __strcat_chk(&local_78,&DAT_001fa528,0x10);
          if ((*(uint *)(plVar21 + 6) >> 2 & 1) == 0) break;
LAB_00171468:
          __strcat_chk(&local_78,&DAT_001fa530,0x10);
          lVar1 = *plVar21;
          lVar18 = plVar21[1];
        }
      } while( true );
...
LAB_0017117c:
    ...
    if (uVar2 != 0) {
      do {
        ...
        bVar4 = false;
        while( true ) {
          puVar15 = &DAT_001fa160;
          if (!bVar6) {
            if (uVar2 < 3 || bVar4) {
              if (uVar2 == 1) {
                puVar15 = &DAT_001f6e40;
              }
              else {
                puVar15 = &DAT_001f82d8;
                if (uVar2 == 2) {
                  puVar15 = &DAT_001fa158;
                }
              }
            }
            else {
          ...
          __fprintf_chk(param_3,2,"| %u | `%s` | `0x%lx` | %lu | %s |\n",uVar3,*puVar17,puVar17[2],
                        puVar17[3],puVar15);
          if (uVar8 <= uVar3 + 1) goto LAB_0017128c;
          puVar17 = (undefined8 *)(*(long *)(lVar9 + 0x28) + lVar20);
          uVar2 = *(uint *)(puVar17 + 4);
          bVar6 = uVar2 == 3;
          uVar3 = uVar3 + 1;
...
LAB_0017128c:
    ...
    if (((plVar5 == (long *)0x0) || (plVar21 = (long *)*plVar5, plVar21 == (long *)0x0)) ||
      ...
      fputc(10,param_3);
      fwrite("## Call Graph\n\n",1,0xf,param_3);
      if (plVar5 != (long *)0x0) goto LAB_0017130c;
LAB_00171320:
...
LAB_0017130c:
      ...
      if ((plVar21 == (long *)0x0) || ((int)plVar21[1] == 0)) goto LAB_00171320;
    ...
    do {
      if (((char *)*puVar17 != (char *)0x0) &&
         (iVar7 = strcmp((char *)*puVar17,".text"), iVar7 == 0)) goto LAB_001703a8;
      puVar17 = puVar17 + 7;
    } while (puVar19 + (ulong)uVar22 * 7 != puVar17);
    uVar8 = *(uint *)(puVar19 + 6);
    puVar17 = puVar19;
    while ((uVar8 >> 2 & 1) == 0) {
      if (puVar19 + (ulong)uVar22 * 7 == puVar17 + 7) goto LAB_001703b8;
      uVar8 = *(uint *)(puVar17 + 0xd);
      puVar17 = puVar17 + 7;
    }
LAB_001703a8:
    if (((puVar17[5] == 0) || (puVar17[4] == 0)) ||
       (lVar20 = disasm_init(*(undefined4 *)(lVar9 + 0xc)), lVar20 == 0)) goto LAB_001703b8;
    ...
    disasm_destroy(lVar20);
    local_80 = (long *)0x0;
    if (iVar7 < 1) goto LAB_001703c8;
    local_80 = (long *)func_detect(local_a0,(long)local_8c,lVar9,0);
    if (param_2 == 0) goto LAB_00170f08;
LAB_001703cc:
    plVar5 = local_80;
    fwrite(&DAT_001fa1c0,1,2,param_3);
    fwrite(&DAT_001f7e28,1,2,param_3);
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fa1c8,param_1);
    fwrite(&DAT_001fa1e0,1,2,param_3);
    fwrite(&DAT_001f7e28,1,2,param_3);
    uVar22 = *(uint *)(lVar9 + 8);
    if (uVar22 == 3) {
      pcVar12 = "Mach-O";
    ...
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fa1f0,pcVar12);
    fwrite(&DAT_001fa1e0,1,2,param_3);
    fwrite(&DAT_001f7e28,1,2,param_3);
    ...
    if (*(int *)(lVar9 + 0x20) != 0) {
      ...
      do {
        while( true ) {
          ...
          puVar13 = &DAT_001fbd80;
          if (puVar14 != (undefined1 *)0x0) {
            puVar13 = puVar14;
          }
          uVar22 = uVar22 + 1;
          __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001f9970,puVar13);
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","vaddr",*(undefined8 *)(lVar1 + 8));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001f9988,*(undefined8 *)(lVar1 + 0x18));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"flags\": %u",*(undefined4 *)(lVar1 + 0x30));
          if (*(uint *)(lVar9 + 0x20) <= uVar22) break;
          __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001f6eb8);
          lVar20 = lVar20 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_00170728;
        }
        lVar20 = lVar20 + 0x38;
        __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001fbd80);
    ...
    if (*(int *)(lVar9 + 0x30) != 0) {
      ...
      do {
        while( true ) {
          ...
          lVar20 = lVar20 + 0x28;
          __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001fbd80);
          if (*(uint *)(lVar9 + 0x30) <= uVar22) goto LAB_001708d0;
        }
        __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001f6eb8);
        lVar20 = lVar20 + 0x28;
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            lVar1 = lVar18 + lVar20;
            fwrite("    {",1,5,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001f9970,lVar1 + 0x14);
            fwrite(", ",1,2,param_3);
            uVar22 = uVar22 + 1;
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","start",*(undefined8 *)(lVar18 + lVar20));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fa2c8,*(undefined8 *)(lVar1 + 8));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001f9988,*(undefined4 *)(lVar1 + 0x10));
            if (uVar22 < *(uint *)(plVar21 + 1)) break;
            lVar20 = lVar20 + 0x98;
            __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001fbd80);
            if (*(uint *)(plVar21 + 1) <= uVar22) goto LAB_00170aa4;
          }
          __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001f6eb8);
          lVar20 = lVar20 + 0x98;
        } while (uVar22 < *(uint *)(plVar21 + 1));
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fa2f8,*(undefined8 *)(lVar1 + 0x10))
            ;
            if (uVar22 < *(uint *)(plVar21 + 1)) break;
            __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001fbd80);
            lVar20 = lVar20 + 0x18;
            if (*(uint *)(plVar21 + 1) <= uVar22) goto LAB_00170c80;
          }
          __fprintf_chk(param_3,2,&DAT_001fa288,&DAT_001f6eb8);
          lVar20 = lVar20 + 0x18;
        } while (uVar22 < *(uint *)(plVar21 + 1));
...
LAB_00170c80:
    fwrite("  ],\n",1,5,param_3);
    fwrite("  \"stats\": {\n",1,0xd,param_3);
    fwrite(&DAT_001fa310,1,4,param_3);
...
LAB_001715b4:
      ...
      fwrite(&DAT_001fa1e0,1,2,param_3);
      if (plVar5[1] == 0) goto LAB_001715b4;
      uVar16 = *(undefined4 *)(plVar5[1] + 8);
    }
    fwrite(&DAT_001fa310,1,4,param_3);
    __fprintf_chk(param_3,2,"\"%s\": %lu","call_edge_count",uVar16);
    fputc(10,param_3);
    fwrite(&DAT_001fa360,1,4,param_3);
    fwrite(&DAT_001f7888,1,2,param_3);
  }
