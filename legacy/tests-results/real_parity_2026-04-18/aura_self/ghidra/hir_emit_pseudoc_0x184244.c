  ...
  if (*(int *)(param_1 + 0xdd0) != 0) {
    do {
      if (*pcVar14 == '\0') {
        ...
        if (uVar3 <= iVar15 + 1U) goto LAB_00184340;
      }
      else {
...
LAB_001847d0:
  fwrite(&DAT_001f7ca0,1,4,param_2);
  goto LAB_00184344;
LAB_00184468:
  iVar15 = (int)plVar5[1];
  pcVar14 = local_b0;
...
LAB_0018449c:
  ...
  lVar17 = lVar17 + 1;
  if (s_stack_var_count <= (uint)lVar17) goto code_r0x00184514;
  goto LAB_001843f8;
code_r0x00184514:
  if (s_stack_var_count == 0) goto LAB_00184518;
  goto LAB_001847b4;
LAB_00184340:
  if (uVar3 == 0) goto LAB_001847d0;
LAB_00184344:
  fwrite(&DAT_001fb058,1,4,param_2);
  ...
  if (__stream == (FILE *)0x0) {
    ...
    fclose(__stream);
    if ((*(long *)(param_1 + 0xdd8) == 0) || (*(int *)(param_1 + 0xde0) == 0)) {
      if (s_stack_var_count != 0) goto LAB_001843cc;
    }
    else {
          ...
          if (*(uint *)(s_emit_stack_frame + 0x20) != 0) {
            ...
            if (*(long *)(s_emit_stack_frame + 8) < 1) {
              do {
                ...
                if (lVar19 == lVar1) goto LAB_00184468;
                plVar5 = plVar5 + 6;
      ...
      do {
        do {
          do {
            ...
            __ptr_00 = __ptr;
            if (pcVar7 == (char *)0x0) goto LAB_00184688;
            pcVar6 = pcVar7 + 1;
        ...
        if ((piVar9 != (int *)0x0) && (*(uint *)(param_1 + 0xde0) != 0)) {
          ...
          do {
            if (*piVar9 == (int)uVar8) goto LAB_00184558;
            piVar9 = piVar9 + 0x33;
        ...
        if ((__ptr != (void *)0x0) && (lVar17 = 0, uVar3 != 0)) {
          do {
            if (*(ulong *)((long)__ptr + lVar17 * 8) == uVar8) goto LAB_00184558;
            lVar17 = lVar17 + 1;
        ...
        if (__ptr != (void *)0x0) {
          if ((uint)uVar18 <= uVar3) {
            ...
            if (uVar2 <= uVar3) goto LAB_0018467c;
          }
...
LAB_00184688:
  ...
  fwrite(&DAT_001f7888,1,2,param_2);
  uVar4 = 0;
LAB_001846dc:
