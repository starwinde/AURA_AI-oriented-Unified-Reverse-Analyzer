...

{
  ...
  if (uVar7 == 0x370) {
    ...
    if (iVar8 == 0xc) {
      ...
      if (lVar12 == -4) {
        SStream_concat0(param_2,&DAT_001f7988);
        MCInst_setOpcodePub(param_1,0x80);
        printPredicateOperand(param_1,4,param_2);
        SStream_concat0(param_2,&DAT_001fbe60);
...
LAB_001b92bc:
        ...
        if (lVar12 == 0) {
          SStream_concat0(param_2,&DAT_001f6fa0,0);
          return;
        }
        goto LAB_001ba2b4;
      }
...
LAB_001b91c4:
      ...
      iVar8 = MCOperand_getReg();
      if (iVar8 != 0xc) goto LAB_001b8760;
...
LAB_001b8ad4:
        ...
        iVar8 = MCOperand_getReg();
        if (iVar8 == 0xc) {
          SStream_concat0(param_2,&DAT_001fbe70);
          uVar18 = 0x18a;
          goto LAB_001b91f0;
        }
      }
      else if (uVar7 < 0x697) {
        if (uVar7 == 0x387) goto LAB_001b8984;
        if (uVar7 == 0x692) goto LAB_001b8ad4;
      }
      else if (uVar7 == 0xa45) goto LAB_001b91c4;
    }
    else {
      if (uVar7 == 0xc0f) {
LAB_001b8984:
...
LAB_001b8fac:
          ...
          if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
            SStream_concat0(param_2,&DAT_001f7990);
            MCInst_setOpcodePub(param_1,0x7f);
            printPredicateOperand(param_1,2,param_2);
            if (uVar7 == 0xb17) {
              SStream_concat0(param_2,&DAT_001fbdb0);
            }
            SStream_concat0(param_2,&DAT_001fba80);
...
joined_r0x001b86c4:
        ...
        else if (uVar7 == 0xbe3) goto LAB_001b8650;
      }
      else if (uVar7 == 0xc5d) {
        uVar7 = 3;
        bVar5 = true;
        ...
        SStream_concat0(param_2,&DAT_001fbe78);
...
LAB_001ba08c:
        ...
        if (uVar7 == 0x262) goto LAB_001b9438;
        if (uVar7 == 0x27a) goto LAB_001b8fac;
      }
      else if (uVar7 == 0x29d) {
        MCInst_getOperand(param_1,2);
        iVar8 = MCOperand_getReg();
...
LAB_001b9308:
      ...
      if (uVar7 == 0x2b1) {
        ...
        uVar7 = uVar9 & 7;
        if (uVar7 == 3) {
          SStream_concat0(param_2,&DAT_001f8088);
          MCInst_setOpcodePub(param_1,99);
        }
        else if ((uVar9 >> 2 & 1) == 0) {
          if (uVar7 == 1) {
            SStream_concat0(param_2,&DAT_001f8090);
            MCInst_setOpcodePub(param_1,10);
          }
          else {
            if (uVar7 != 2) goto LAB_001b9f84;
            SStream_concat0(param_2,&DAT_001f8080);
          ...
          SStream_concat0(param_2,&DAT_001fb6a8);
          MCInst_setOpcodePub(param_1,0x94);
        }
        else {
LAB_001b9f84:
          SStream_concat0(param_2,&DAT_001fbd80);
        }
...
LAB_001b8650:
      ...
      if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
        ...
        SStream_concat0(param_2,&DAT_001fba80);
        iVar8 = *(int *)(*(long *)(param_1 + 800) + 0x60);
        goto joined_r0x001b86c4;
      }
    }
    else if (uVar7 == 0x365) goto LAB_001b9308;
LAB_001b8760:
