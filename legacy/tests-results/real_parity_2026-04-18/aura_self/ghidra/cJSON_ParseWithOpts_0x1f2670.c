    ...
    *puVar3 = 0;
    ...
    if (local_80 != (char *)0x0) {
      if (local_70 == 0) {
        if (local_78 < 5) {
          ppcVar4 = &local_80;
          if (local_78 == 0) goto LAB_001f2780;
        }
        ...
        do {
          if (0x20 < (byte)local_80[local_70]) {
            ppcVar4 = &local_80;
            if (local_70 != local_78) goto LAB_001f2780;
            break;
          }
          local_70 = local_70 + 1;
...
LAB_001f2820:
        if (local_80[local_70] == '\0') goto LAB_001f2790;
      }
    }
    else if (local_70 < local_78) {
      do {
        if (0x20 < (byte)local_80[local_70]) {
          if (local_70 != local_78) goto LAB_001f2818;
          break;
        }
        local_70 = local_70 + 1;
      } while (local_70 != local_78);
