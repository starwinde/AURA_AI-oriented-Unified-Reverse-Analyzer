...

{
  ...
  if (uVar2 < 0xb14) {
    if (0xb0b < uVar2) goto joined_r0x001966fc;
    if (uVar2 < 0x275) {
      if (0x26c < uVar2) goto joined_r0x001966fc;
    }
    else if (uVar2 - 0x341 < 8) goto joined_r0x001966fc;
  }
  else {
    if (7 < uVar2 - 0xbd3) goto LAB_00196628;
joined_r0x001966fc:
    if (uVar6 - 10 < 2) {
      return 0;
    }
...
LAB_00196698:
        ...
        if ((uVar5 & 0x9999) == 0) goto LAB_001966ac;
        goto LAB_001967a8;
      }
    }
    else {
      uVar2 = uVar2 - 0x339;
      if (uVar2 < 0x10) goto LAB_00196698;
    }
  }
  else {
    if (0xf < uVar2 - 0xbcb) goto LAB_001966bc;
    uVar5 = 1L << ((ulong)(uVar2 - 0xbcb) & 0x3f);
    if ((uVar5 & 0x9999) != 0) goto LAB_001967a8;
LAB_001966ac:
    if ((uVar5 & 0x4444) != 0) {
      uVar3 = uVar3 | uVar1 << 8;
    }
