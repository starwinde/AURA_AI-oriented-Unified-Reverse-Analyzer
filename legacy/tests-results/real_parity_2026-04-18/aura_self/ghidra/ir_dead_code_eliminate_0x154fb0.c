      ...
      if (piVar18[(ulong)uVar13 * 0x12 + 4] != 0) {
        ...
        do {
          while (iVar35 = *piVar17, 1 < iVar35 - 0x17U) {
            ...
            if (piVar16 == piVar17) goto LAB_00155184;
          }
          piVar21 = local_70;
          iVar36 = 0;
...
LAB_00155210:
      ...
      if ((uVar29 & 0xf) != 0) {
        ...
        if (uVar13 < uVar29) goto LAB_00155210;
      }
    }
    if (uVar31 == 0) goto LAB_001554ec;
    lVar22 = 0;
    pcVar5 = __ptr;
    do {
      while (*pcVar5 != '\0') {
        pcVar5 = pcVar5 + 1;
        lVar22 = lVar22 + 0x48;
        if (__ptr + uVar25 == pcVar5) goto LAB_00155404;
      }
      lVar26 = 0;
      uVar29 = 0;
...
LAB_00155488:
      ...
      if (uVar8 != 0) {
        ...
        do {
          ...
          lVar22 = lVar22 + 1;
          if (uVar8 <= (uint)lVar22) goto LAB_001558f8;
          uVar29 = *(uint *)(param_1 + 1);
        } while( true );
      }
      goto LAB_00155478;
...
LAB_001559ec:
  ...
  if (0xfffffffd < uVar29 - 1) goto LAB_00154ff0;
  uVar25 = (ulong)uVar29;
  __ptr_01 = calloc(uVar25,8);
  if (__ptr_01 == (void *)0x0) goto LAB_00154ff0;
    ...
    if (plVar6 != (long *)0x0) {
      ...
      do {
        while (*puVar14 == 0) {
          ...
          if (plVar24 == plVar27) goto LAB_001555fc;
        }
...
LAB_00155478:
    ...
    if (uVar29 <= uVar13) goto LAB_001559ec;
    goto LAB_00155488;
  }
  piVar16 = *(int **)piVar18;
  uVar31 = 0;
  do {
    while ((*piVar16 != 0x1b || (uVar15 = piVar16[0x18], uVar15 == 0))) {
      ...
      if (uVar8 <= uVar31) goto LAB_001559d8;
    }
