                    ...
                    if (param_3 == 0) {
                      ...
                      if ((int)plVar4[1] != 0) {
                        ...
                        do {
                          ...
                          if ((uVar8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72b0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 1 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72c0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 2 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72c8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 3 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72d0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 4 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72d8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 5 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72e0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 6 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72e8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 7 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_001f72f0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_002096e8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 9 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,&DAT_002096f8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 10 & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,"r10");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xb & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,"r11");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xc & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,"r12");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xd & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,"r13");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xe & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,"r14");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xf & 1) != 0) {
                            __printf_chk(2,&DAT_001f72b8,"r15");
                          }
                          __printf_chk(2,"\n    kill: ");
                          uVar8 = *(uint *)(lVar6 + 4);
                          if ((uVar8 & 1) != 0) {
                          ...
                          if (uVar8 != 0) {
                            do {
                              while( true ) {
                                ...
                                if ((uVar8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72b0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 1 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72c0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 2 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72c8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 3 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72d0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 4 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72d8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 5 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72e0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 6 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72e8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 7 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_001f72f0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_002096e8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 9 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,&DAT_002096f8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 10 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,"r10");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xb & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,"r11");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xc & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,"r12");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xd & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,"r13");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xe & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,"r14");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xf & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7338,"r15");
                                }
                                __printf_chk(2,"  use:");
                                uVar8 = *(uint *)(lVar16 + 4);
                                if ((uVar8 & 1) != 0) {
                                ...
                                uVar8 = *(uint *)(lVar6 + 0x18);
                                uVar15 = uVar15 + 1;
                                if (uVar8 <= (uint)uVar15) goto LAB_00142398;
                              }
                              uVar15 = uVar15 + 1;
                          ...
                          do {
                            ...
                            do {
                              if ((1 << (ulong)((uint)lVar7 & 0x1f) & uVar9) != 0) {
                                ...
                                __printf_chk(2,&DAT_001f71f8,(&s_reg_names)[lVar7]);
                                bVar3 = false;
                              }
                              lVar7 = lVar7 + 1;
                            } while (lVar7 != 0x10);
                          ...
                          if (uVar9 != 0) {
                            do {
                              while( true ) {
                                ...
                                lVar6 = lVar6 + 8;
                                uVar11 = uVar1;
                                if (uVar9 <= uVar1) goto LAB_00142e48;
                              }
                              lVar6 = lVar6 + 8;
                              uVar11 = uVar1;
                            } while (uVar1 < uVar9);
