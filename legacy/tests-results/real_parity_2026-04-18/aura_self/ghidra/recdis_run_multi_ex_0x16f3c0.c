...

{
  ...
  if (((param_1 == 0 || param_2 == 0) || ((param_3 == 0 || param_5 == 0) || param_6 == 0)) ||
     (__ptr = calloc(1,0x10), __ptr == (long *)0x0)) goto LAB_0016f95c;
...
LAB_0016f518:
        ...
        *(uint *)(__ptr_01 + 1) = uVar29;
        if (uVar1 != 0) {
          uVar13 = 0;
          do {
            if (uVar26 == __ptr_03[uVar13]) goto LAB_0016f518;
            uVar13 = uVar13 + 1;
          } while (uVar13 != uVar1);
        }
        ...
        if (uVar7 <= uVar1) {
          ...
          if (puVar17 == (ulonglong *)0x0) goto LAB_0016f518;
          *__ptr_00 = puVar17;
                ...
                if (((iVar8 == 0) && (*__s != '\0')) &&
                  ...
                  if (((local_70 != __s) && (param_4 <= uVar18)) && (uVar18 < uVar13)) {
                    if (iVar22 != 0) {
                      puVar16 = puVar17;
                      do {
                        if (*puVar16 == uVar18) goto LAB_0016f6f4;
                        puVar16 = puVar16 + 1;
                ...
                if (((__s[-0x40] == 'j') && (iVar8 = strcmp(pcVar28,"jmp"), iVar8 != 0)) &&
                  ...
                  if ((local_70 != __s) && (param_4 <= uVar18 && uVar18 < uVar13)) {
                    if (*(uint *)(__ptr_00 + 1) != 0) {
                      ...
                      do {
                        if (*puVar23 == uVar18) goto LAB_0016f728;
                        puVar23 = puVar23 + 1;
...
LAB_0016f990:
                  ...
                  goto LAB_0016f754;
                  if (iVar22 == 0) goto LAB_0016fe1c;
                  puVar16 = puVar17;
                  goto LAB_0016fa0c;
                }
                if (iVar9 == 0) goto LAB_0016f990;
                __s = __s + 0xe0;
                uVar29 = uVar27;
              } while (uVar7 != uVar27);
              goto LAB_0016f850;
...
LAB_0016fa0c:
    if (*puVar16 == uVar18) goto LAB_0016f754;
  }
LAB_0016fe1c:
...
LAB_0016fc60:
              ...
              if ((uVar30 < uVar13 && param_4 <= uVar30) && local_70 != __nptr) {
                ...
                if (pcVar28 == (char *)0x0 || !bVar5) goto LAB_0016fd58;
                goto LAB_0016fcc0;
              }
            }
            cVar6 = pcVar14[2];
            ...
            if (uVar15 <= param_3) {
              do {
                ...
                if (uVar21 < uVar13 && param_4 <= uVar21) {
                  ...
                  if (iVar22 != 0) {
                    do {
                      if (uVar21 == *puVar16) goto LAB_0016fdb0;
                      puVar16 = puVar16 + 1;
                    } while (puVar17 + (ulong)uVar1 + 1 != puVar16);
                  }
                  queue_push_isra_0(__ptr_01);
...
LAB_0016f850:
  ...
  if (__ptr_02 != (ulong *)0x0) {
    ...
    *(uint *)(__ptr_02 + 2) = uVar27;
    ...
    if (pvVar11 != (void *)0x0) goto code_r0x0016f884;
    free(__ptr_02);
  }
  free(pvVar10);
  uVar29 = *(uint *)(__ptr_01 + 1);
  ...
  *puVar24 = *__ptr_02;
  ...
  do {
    while ((uVar26 != *(ulong *)(pbVar20 + -9) ||
      ...
      if (param_6 <= uVar13) goto LAB_0016f924;
    }
    iVar22 = (int)uVar13;
    uVar13 = uVar13 + 1;
    pbVar20 = pbVar20 + 0x10;
