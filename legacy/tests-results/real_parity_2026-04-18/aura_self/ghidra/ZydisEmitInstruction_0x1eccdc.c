...
LAB_001ece10:
    ...
    if (uVar1 == 4) {
      ...
      if (4 < uVar1) goto LAB_001ece10;
      if (uVar1 == 3) {
        iVar2 = ZydisEmitVex(param_1,param_2);
      }
      else {
        if (3 < uVar1) goto LAB_001ece10;
        if (uVar1 < 2) {
          iVar2 = ZydisEmitRex(param_1,param_2);
        }
        else {
          if (uVar1 != 2) goto LAB_001ece10;
...
LAB_001ecf98:
    ...
    if (uVar1 == 3) {
      ...
      if (uVar1 == 2) {
        ...
        if (2 < uVar1) goto LAB_001ecf98;
        if (uVar1 == 0) goto LAB_001ecfdc;
        if (uVar1 != 1) goto LAB_001ecf98;
        iVar2 = ZydisEmitByte(0xf,param_2);
      }
    }
  }
