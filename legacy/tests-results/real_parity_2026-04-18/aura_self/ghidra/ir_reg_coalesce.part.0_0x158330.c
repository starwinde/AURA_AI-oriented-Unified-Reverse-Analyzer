...
LAB_00158438:
    ...
    *(uint *)((long)__ptr + (ulong)uVar4 * 4) = uVar4;
    ...
    puVar7 = __ptr;
    uVar33 = _DAT_00209ea0;
    uVar34 = _UNK_00209ea8;
    do {
      puVar20 = puVar7 + 2;
      puVar7[1] = uVar34;
      *puVar7 = uVar33;
    ...
    if ((uVar13 & 3) != 0) goto LAB_00158438;
  }
  if (uVar12 != 0) {
...
LAB_0015848c:
            ...
            if (uVar12 <= uVar4) goto LAB_001585c0;
          }
          uVar21 = piVar14[2];
          uVar17 = piVar14[6];
          if (uVar21 == 0xffffffff || uVar17 == 0xffffffff) goto LAB_0015848c;
          uVar5 = uVar21;
          if (uVar21 < uVar17) {
            uVar5 = uVar17;
          }
          if (uVar13 <= uVar5 || uVar21 == uVar17) goto LAB_0015848c;
...
LAB_001585ac:
            ...
            if (uVar17 == uVar21) goto LAB_001585ac;
            uVar12 = uVar21;
            if (uVar17 < uVar21) {
              uVar12 = uVar17;
            }
            ...
            *(uint *)((long)__ptr + (ulong)uVar17 * 4) = uVar12;
            if (iVar6 != iVar2) goto LAB_001585ac;
...
LAB_001585c0:
    ...
    do {
      while (uVar13 = *puVar19, uVar13 == 0) {
        ...
        *puVar19 = 0;
        puVar19 = puVar22;
        if (puVar22 == puVar24) goto LAB_001586e4;
      }
...
LAB_00158844:
              piVar14 = piVar14 + 0x22;
              if (piVar14 == piVar26) goto LAB_00158890;
            }
            iVar6 = *piVar14;
            iVar2 = piVar14[3];
            if (iVar6 != 1) {
...
LAB_00158b04:
                            ...
                            if (piVar18 == piVar25) goto LAB_00158b58;
                          }
                          uVar4 = piVar14[((uVar10 ^ 1) + 1) * 4 + 2];
                          *(undefined1 *)((long)__ptr_04 + uVar15) = 1;
                          if (uVar12 <= uVar4) goto LAB_00158b04;
                          piVar18 = piVar18 + 0x22;
          ...
          if ((*(char *)((long)pvVar9 + uVar15) == '\0') ||
            ...
            if (uVar12 < uVar13) {
              ...
              if (*(long *)(lVar32 + uVar15 * 8) == 0) {
                if (*(char *)((long)__ptr_04 + uVar15) == '\0' || 4 < iVar30) goto LAB_00158bf0;
                iVar31 = iVar30 + 1;
...
LAB_00158bf0:
              if (*(char *)((long)__ptr_03 + uVar15) == '\0') {
                ...
                if (iVar6 == 0) {
                  local_88[0] = s_result_001f8220[0];
                  local_88[1] = s_result_001f8220[1];
                  local_88[2] = s_result_001f8220[2];
                  local_88[3] = s_result_001f8220[3];
                  local_88[4] = s_result_001f8220[4];
                  local_88[5] = s_result_001f8220[5];
                  local_88[6] = s_result_001f8220[6];
                }
                else {
          ...
          if (uVar13 == uVar12) goto LAB_00158bb4;
        }
        uVar15 = uVar15 + 1;
        __ptr_00 = g_rank;
        iVar30 = iVar31;
