...
LAB_0015ca70:
    if ((*(byte *)(param_8 + local_c8) & 1) != 0) goto LAB_0015cbb0;
    lVar15 = *param_1;
    *(undefined1 *)(param_8 + local_c8) = 1;
    lVar21 = lVar15 + local_c8 * 0x48;
    ...
    if ((int)uVar5 < 0) {
      if (((*(byte *)(param_4 + local_c8) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
        ...
        piVar23 = (int *)0x0;
        if (uVar5 != 0) goto LAB_0015cb00;
      }
    }
    else {
      piVar23 = (int *)(*(long *)(lVar21 + 8) + (long)(int)uVar5 * 0x88);
      do {
        if (*piVar23 - 0x17U < 2 || *piVar23 == 0x1a) goto LAB_0015cae8;
...
LAB_0015e590:
                  ...
                  uVar17 = uVar20;
                  do {
                    uVar4 = *(uint *)(lVar15 + uVar17 * 0x48 + 0x34);
                    if ((uVar4 == (uint)uVar17) || (uVar5 = uVar5 + 1, uVar19 < uVar5)) {
                      if (uVar16 < uVar19) {
                        if (uVar16 != uVar18) goto LAB_0015e138;
                        uVar16 = (uint)uVar20;
                        uVar20 = local_c8;
                      }
                      break;
...
joined_r0x0015e5e0:
                  uVar17 = uVar20;
                  uVar4 = uVar16;
                  if (puVar10 != (uint *)0x0) goto LAB_0015dc3c;
                }
LAB_0015e174:
                iVar6 = 0x10;
                do {
                ...
                if (piVar23[0x12] == 0) {
                  fwrite(&DAT_001f8240,1,4,param_9);
                }
                else if (piVar23[6] == -1) {
                  fwrite("__undef",1,7,param_9);
                }
                else {
                  __fprintf_chk(param_9,2,&DAT_001f82e8);
                }
                fwrite(&DAT_001f83f8,1,4,param_9);
              }
              else {
                if ((uVar19 <= uVar16) ||
...
LAB_0015e138:
                ...
                uVar4 = uVar16;
                do {
                  uVar9 = *(uint *)(lVar15 + (ulong)uVar4 * 0x48 + 0x34);
                  if ((uVar9 == uVar4) || (uVar5 = uVar5 + 1, uVar19 < uVar5))
                  goto joined_r0x0015e5e0;
                  uVar4 = uVar9;
                } while (uVar9 != uVar18);
                uVar17 = (ulong)uVar16;
                uVar4 = (uint)uVar20;
                if (puVar10 == (uint *)0x0) goto LAB_0015e174;
LAB_0015dc3c:
                ...
                __fprintf_chk(param_9,2,&DAT_001f82e8,puVar10[8]);
                uVar16 = puVar10[0x10];
                if (uVar16 == 0x10) {
LAB_0015e6cc:
                  fwrite(&DAT_001f83b0,1,4,param_9);
                }
                else if (uVar16 < 0x11) {
                  if (uVar16 != 0xd) {
                    if (uVar16 < 0xe) {
                      if (uVar16 == 0xb) {
                        fwrite(&DAT_001f83d0,1,4,param_9);
                      }
                      else {
                        if (uVar16 != 0xc) goto LAB_0015e8fc;
                        fwrite(&DAT_001f83c8,1,4,param_9);
                      }
                      goto LAB_0015dcf4;
                    }
                    if (uVar16 == 0xe) goto LAB_0015e6cc;
                  }
                  fwrite(&DAT_001f83a8,1,3,param_9);
                }
                else if (uVar16 == 0x13) {
LAB_0015e6e8:
                  fwrite(&DAT_001f83b8,1,3,param_9);
                }
                else {
                  if (uVar16 < 0x14) {
                    if (uVar16 == 0x11) goto LAB_0015e6e8;
                  }
                  else if (uVar16 != 0x14) {
LAB_0015e8fc:
                    fwrite(&DAT_001f8318,1,3,param_9);
                    goto LAB_0015dcf4;
                  }
                  fwrite(&DAT_001f83c0,1,4,param_9);
                }
LAB_0015dcf4:
                __fprintf_chk(param_9,2,"v%u; ",puVar10[0xf]);
                __fprintf_chk(param_9,2,&DAT_001f82e8,puVar10[8]);
                if (puVar10[0xe] == 2) {
                  fwrite(&DAT_001f83e0,1,4,param_9);
                }
                else {
                  fwrite(&DAT_001f83e8,1,4,param_9);
                }
              ...
              fwrite(&DAT_001f7888,1,2,param_9);
              uVar16 = *(uint *)(param_1 + 1);
              if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_0015cbb0;
...
LAB_0015d5cc:
              ...
              lVar15 = extraout_x12;
              uVar16 = extraout_w11;
              if (uVar5 < extraout_w11) goto LAB_0015d074;
            }
          }
        }
        else {
LAB_0015cb00:
          ...
          do {
            if (*puVar10 == uVar18) goto LAB_0015cb30;
            uVar4 = uVar4 + 1;
...
LAB_0015cb30:
          if (piVar23 != (int *)0x0) {
            if (*piVar23 == 0x17) {
              ...
              uVar16 = piVar23[0x1a];
              cf_emit_block_body_part_0_isra_0(lVar15,local_c8,param_9,4);
              if (puVar10 == (uint *)0x0) goto LAB_0015e50c;
              uVar4 = puVar10[5];
              uVar19 = *(uint *)(param_1 + 1);
              if (uVar4 < uVar19) {
                if (uVar5 == uVar4) {
                ...
                if (uVar5 < uVar19) {
                  lVar15 = *param_1;
                  if (uVar5 != uVar18) goto LAB_0015e590;
                }
...
LAB_0015d074:
              if (uVar5 != uVar18) {
                lVar15 = lVar15 + (ulong)uVar5 * 0x48;
...
LAB_0015d0fc:
                ...
                fwrite(&DAT_001f8368,1,3,param_9);
                uVar16 = *(uint *)(param_1 + 1);
                if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_0015cbb0;
                local_c8 = (ulong)uVar4;
                goto LAB_0015ca70;
      ...
      if (piVar11[4] != 0) {
        do {
          ...
          if ((*(byte *)(lVar21 + 0xc) & 1) == 0) {
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar5 < uVar16) goto LAB_0015da84;
LAB_0015d9f8:
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar16 <= uVar5) goto LAB_0015d9f8;
LAB_0015da84:
            pvVar12 = calloc((ulong)uVar16,1);
            if (pvVar12 == (void *)0x0) goto LAB_0015d9f8;
            uVar4 = piVar11[8];
            if (uVar4 != 0 && uVar18 < uVar16) {
              ...
              uVar9 = uVar18;
              while( true ) {
                lVar14 = lVar22 + (ulong)uVar9 * 0x48;
...
LAB_0015db40:
      ...
      uVar16 = *(uint *)(param_1 + 1);
      uVar5 = piVar11[6];
      if (uVar5 < uVar16 && param_3 != uVar5) goto LAB_0015d510;
      goto LAB_0015cbb0;
    }
...
LAB_0015d4d4:
    ...
    if (piVar23 == (int *)0x0) goto LAB_0015cbb0;
    iVar6 = *piVar23;
    if (iVar6 == 0x18) {
      uVar5 = piVar23[0x19];
      uVar16 = *(uint *)(param_1 + 1);
      if (param_3 != uVar5 && uVar5 < uVar16) goto LAB_0015d510;
      goto LAB_0015cbb0;
    }
    if (iVar6 == 0x1a) {
      iVar6 = 0x10;
        ...
        if (piVar23[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              lVar15 = lVar15 + 1;
              uVar16 = (uint)lVar15;
              if ((uint)piVar23[0x18] <= uVar16) goto LAB_0015d5a0;
            }
            __fprintf_chk(param_9,2,&DAT_001f82e8);
            lVar15 = lVar15 + 1;
...
LAB_0015d5a0:
    ...
    if (iVar6 != 0x17) goto LAB_0015cbb0;
    uVar16 = piVar23[0x19];
    uVar5 = piVar23[0x1a];
...
LAB_0015d760:
        ...
        if (uVar4 < uVar18) goto LAB_0015cc2c;
        local_80[0] = uVar18;
        local_78 = param_5;
        plStack_70 = param_1;
        ...
        fwrite(&DAT_001f8498,1,4,param_9);
        if (piVar23[0x12] == 0) {
          fwrite(&DAT_001f8240,1,4,param_9);
        }
        else if (piVar23[6] == -1) {
      ...
      uVar18 = *(uint *)(param_1 + 1);
      if (uVar18 <= uVar4) goto LAB_0015d760;
LAB_0015cc2c:
      uVar20 = (ulong)uVar4;
      if (uVar5 == uVar4) {
        iVar6 = 0x10;
            ...
            if (uVar5 != 0) {
              ...
              do {
                ...
                if ((*(int *)(*(long *)(lVar15 + 8) + lVar21 * 0x88) == 0x1b) &&
                  ...
                  uVar17 = 0;
LAB_0015df90:
                  if (uVar16 != *(uint *)(*(long *)(lVar22 + 0x58) + uVar17 * 4)) goto LAB_0015df84;
                  iVar6 = 0x14;
                  do {
                    fputc(0x20,param_9);
                    iVar6 = iVar6 + -1;
                  ...
                  fwrite(&DAT_001f82f0,1,3,param_9);
...
LAB_0015d358:
          ...
          if (pvVar12 != (void *)0x0) {
            *(undefined1 *)((long)pvVar12 + local_c8) = 1;
            emit_region(param_1,uVar16,uVar20,param_4,param_5,param_6,param_7,pvVar12,param_9,5);
            if (uVar4 < *(uint *)(param_1 + 1)) {
              lVar15 = *param_1 + (ulong)uVar4 * 0x48;
...
LAB_0015cd94:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar18 = *(uint *)(lVar15 + 0x10);
                    if (uVar18 <= (uint)lVar21) goto LAB_0015ce44;
                  }
LAB_0015cd48:
                  lVar21 = lVar21 + 1;
...
LAB_0015cf5c:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar16 = *(uint *)(lVar15 + 0x10);
                    if (uVar16 <= (uint)lVar21) goto LAB_0015d008;
                  }
LAB_0015cf10:
                  lVar21 = lVar21 + 1;
                } while ((uint)lVar21 < uVar16);
...
LAB_0015d008:
    ...
    if (1 < iVar6 - 1U) {
      if (1 < iVar7 - 1U) goto LAB_0015cc0c;
      iVar6 = 0x10;
      do {
        fputc(0x20,param_9);
        iVar6 = iVar6 + -1;
      ...
      if (*(uint *)(param_1 + 1) <= uVar16 || param_3 == uVar16) goto LAB_0015cbb0;
      bVar2 = *(byte *)(param_8 + (ulong)uVar16);
      uVar5 = uVar16;
      goto joined_r0x0015d6f4;
    }
    iVar8 = 0x10;
    if (iVar7 - 1U < 2) {
      do {
...
LAB_0015d510:
  ...
  if ((*(byte *)(param_8 + (ulong)uVar5) & 1) != 0) goto LAB_0015cbb0;
  goto LAB_0015ca70;
LAB_0015df84:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015df44;
  goto LAB_0015df90;
LAB_0015d398:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015d358;
  goto LAB_0015d3a4;
LAB_0015cd88:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015cd48;
  goto LAB_0015cd94;
LAB_0015cf50:
  uVar17 = uVar17 + 1;
  if (*(uint *)(lVar22 + 0x60) == uVar17) goto LAB_0015cf10;
  goto LAB_0015cf5c;
}
