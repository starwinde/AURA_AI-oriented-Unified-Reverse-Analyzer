...
joined_r0x00156d68:
                    ...
                    uVar24 = *(uint *)(param_1 + 1);
                    lVar29 = lVar29 + 0x88;
                    if (uVar18 <= uVar30) goto LAB_001569f0;
                    goto LAB_00156920;
                  }
...
LAB_00156b3c:
            ...
            *(uint *)(puVar22 + 2) = uVar2;
            if (uVar24 != 1) goto LAB_00156b3c;
          }
          puVar22 = puVar22 + 0xc;
          if (puVar22 == puVar23) goto LAB_00156be8;
        }
        puVar19 = puVar22 + 0xc;
