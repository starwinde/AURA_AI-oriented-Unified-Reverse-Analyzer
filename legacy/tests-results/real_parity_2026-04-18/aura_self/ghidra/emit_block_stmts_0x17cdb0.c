        ...
        do {
          ...
          if (1 < iVar4 - 0x17U && (iVar4 != 0x1a && iVar4 != 0x1b)) {
            ...
            if ((uVar3 == 0xffffffff) ||
              ...
              if (iVar4 == 0x16) goto LAB_0017d2d4;
              if (iVar4 == 0x19) goto LAB_0017d1ac;
            }
            else if (iVar4 == 0x16) {
LAB_0017d2d4:
                ...
                if (puVar5 == (undefined4 *)0x0) {
                  ...
                  *puVar5 = 10;
                  ...
                  if (puVar9 != (undefined4 *)0x0) {
                    *puVar9 = 0xd;
                    puVar9[0x26] = uVar13;
                    __snprintf_chk(puVar9 + 0x27,0x40,2,0x40,&DAT_001f82e8,uVar13);
                  }
                  uVar13 = *(uint *)(lVar12 + 0x10);
              ...
              if (puVar6 != (undefined4 *)0x0) {
                *puVar6 = 10;
                ...
                if (puVar5 != (undefined4 *)0x0) {
                  *puVar5 = 0xd;
                  puVar5[0x26] = uVar3;
                  __snprintf_chk(puVar5 + 0x27,0x40,2,0x40,&DAT_001f82e8,uVar3);
                }
                *(undefined4 **)(puVar6 + 0x26) = puVar5;
        ...
        do {
          ...
          if (1 < iVar4 - 0x1aU && (iVar4 != 0x17 && iVar4 != 0x18)) {
            ...
            if ((uVar10 == 0xffffffff) ||
              ...
              if (iVar4 == 0x16) goto LAB_0017d000;
              if (iVar4 == 0x19) goto LAB_0017cf48;
            }
            else if (iVar4 == 0x16) {
LAB_0017d000:
              if ((1 < *(uint *)(lVar1 + 0x48)) &&
...
LAB_0017d2a0:
                  ...
                  if (pvVar8 == (void *)0x0) goto LAB_0017cff8;
                  uVar10 = param_3[0x28];
...
LAB_0017cf48:
                ...
                if (((uVar13 == 0xffffffff) || (*(uint *)(*param_1 + 0x10) <= uVar13)) ||
                  ...
                  if ((puVar6 != (undefined4 *)0x0) && (*puVar6 = 0xc, *param_3 == 0)) {
                    ...
                    uVar13 = param_3[0x29];
                    pvVar8 = *(void **)(param_3 + 0x26);
                    if (uVar13 <= uVar10) goto LAB_0017d2a0;
                    goto LAB_0017d090;
                  }
                }
                else {
                  ...
                  if (puVar5 != (undefined4 *)0x0) {
                    ...
                    *(undefined4 **)(puVar5 + 0x26) = puVar9;
                    *(undefined4 **)(puVar5 + 0x28) = puVar6;
                    goto joined_r0x0017cff4;
                  }
                }
              }
              else {
                puVar5 = calloc(1,0x130);
                if (puVar5 == (undefined4 *)0x0) goto LAB_0017cf10;
                *puVar5 = 10;
                puVar6 = calloc(1,0x130);
                if (puVar6 != (undefined4 *)0x0) {
                  *puVar6 = 0xd;
                  puVar6[0x26] = uVar10;
                  __snprintf_chk(puVar6 + 0x27,0x40,2,0x40,&DAT_001f82e8,uVar10);
                }
