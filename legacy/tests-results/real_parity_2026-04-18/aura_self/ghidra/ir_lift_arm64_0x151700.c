  ...
  if ((param_1 != (long *)0x0) && (local_288 = calloc(1,0xa0), local_288 != (long *)0x0)) {
    *(undefined4 *)(local_288 + 2) = 0;
    ...
    if ((int)param_1[1] != 0) {
      do {
        plVar16 = local_288;
        uVar25 = *(uint *)(local_288 + 1);
        uVar30 = *(uint *)((long)local_288 + 0xc);
            ...
            do {
              while (cVar9 != '[') {
                if (cVar9 == ']') {
                  ...
                  memcpy(local_158,pcVar34,sVar26);
                  local_158[sVar26] = '\0';
                  cVar9 = local_158[0];
                  if (local_158[0] == '\0') goto LAB_00151ec0;
                  sVar26 = strlen(local_158);
                  pcVar34 = local_158 + (sVar26 - 1);
                  if (local_158 < pcVar34) goto LAB_00151e74;
                  goto LAB_00151e84;
                }
                pcVar33 = pcVar33 + 1;
                cVar9 = *pcVar33;
...
LAB_00151d60:
            snprintf(local_158,0x40,"%s",pcVar34);
            cVar9 = local_158[0];
            if (local_158[0] != '\0') {
              sVar26 = strlen(local_158);
              pcVar34 = local_158 + (sVar26 - 1);
              if (local_158 < pcVar34) {
                do {
                  cVar9 = local_158[0];
                  if (*pcVar34 != ' ') break;
                  pcVar33 = pcVar34 + -1;
              ...
              if (cVar9 == ' ') {
                ...
                if (pcVar34 != local_158) {
                  sVar26 = strlen(pcVar34);
                  __memmove_chk(local_158,pcVar34,sVar26 + 1,0x40);
                }
              }
            }
    ...
    do {
      while (cVar9 != '[') {
        if (cVar9 == ']') {
          ...
          if (local_158[0x40] == '\0') goto LAB_00152088;
...
LAB_00151f08:
  ...
  if (iVar10 == 0) {
    local_2a0 = 0xfffffffe;
    iVar10 = arm64_reg_lookup(pcVar34,&local_29c,&local_290);
  }
  else {
    iVar10 = arm64_reg_lookup(pcVar34,&local_29c,&local_290);
  }
...
LAB_0015217c:
  ...
  uVar25 = local_2a0;
  if (iVar11 == 0) {
    if ((int)local_2a0 < 0) goto LAB_00151ae8;
    if (!bVar6) {
      ...
      if (iVar10 == 1) {
        lVar36 = CONCAT44(uStack_27c,local_280);
      }
      else {
        iVar10 = __isoc99_sscanf(pcVar21,&DAT_001f7eb0,&local_278);
        if (iVar10 != 1) goto LAB_001521a4;
        lVar36 = CONCAT44(local_278._4_4_,(int)local_278);
      }
    }
    if (lVar36 != 0) {
      iVar10 = arm_emit_const(puVar2,local_288,lVar36,uVar15);
      if (iVar10 == -1) goto LAB_00152408;
      lVar29 = lVar29 + 1;
      *(int *)((long)&local_1e8 + (long)(int)uVar25 * 4) = iVar10;
      uVar30 = *(uint *)(lVar1 + 0x18);
      *(undefined4 *)((long)&local_270 + (long)(int)uVar25 * 4) = 5;
...
LAB_001521a4:
    ...
    lVar29 = lVar29 + 1;
    *(undefined4 *)((long)&local_270 + (long)(int)uVar25 * 4) = 5;
    *(int *)(local_288 + 2) = (int)lVar31 + 1;
    *(int *)((long)&local_1e8 + (long)(int)uVar25 * 4) = (int)lVar31;
  ...
  if (((iVar11 == 0) || (iVar11 = strcmp(pcVar21,"movz"), iVar11 == 0)) ||
    ...
    if (-1 < (int)local_2a0) {
      ...
      *(undefined4 *)((long)puVar18 + 0xc) = local_294;
      ...
      lVar29 = lVar29 + 1;
      *(int *)((long)&local_1e8 + (long)(int)uVar25 * 4) = iVar10;
      *(undefined4 *)((long)&local_270 + (long)(int)uVar25 * 4) = local_294;
      puVar18[0xe] = uVar15;
      if (*(uint *)(lVar1 + 0x18) <= (uint)lVar29) goto LAB_00151afc;
      goto LAB_001518f0;
    }
...
LAB_00151a24:
        ...
        *(int *)((long)&local_1e8 + (long)(int)uVar25 * 4) = iVar11;
        *(undefined4 *)((long)&local_270 + (long)(int)uVar25 * 4) = local_294;
      ...
      if (-1 < (int)local_2a0) {
        lVar31 = (long)(int)local_2a0;
        iVar10 = *(int *)((long)&local_1e8 + lVar31 * 4);
        if (iVar10 == -1) {
          iVar10 = (int)local_288[2];
          *(int *)(local_288 + 2) = iVar10 + 1;
        }
        if (local_29c < 0x20) {
          ...
          auVar44 = arm_emit_const(puVar2,local_288,lVar36,uVar15);
          uVar38 = auVar44._8_8_;
          iVar12 = auVar44._0_4_;
          uVar37 = auVar44._4_4_;
          if (iVar12 == -1) goto LAB_00152408;
        ...
        *(int *)((long)&local_1e8 + lVar31 * 4) = iVar11;
        *(uint *)(puVar2 + 2) = uVar25 + 1;
        *(undefined4 *)((long)&local_270 + lVar31 * 4) = uVar43;
              ...
              do {
                ...
                *(undefined8 *)(puVar20 + 4) = 0;
                if ((local_280 < 0x20) &&
                  ...
                  auVar44 = arm_emit_const(puVar2,local_288,
                                           CONCAT44(local_278._4_4_,(int)local_278) + lVar31 * 8,
                                           uVar15);
                ...
                *(undefined8 *)(puVar20 + 0x1c) = uVar15;
                if ((int)uVar19 < 0x20) {
                  ...
                  *(int *)((long)&local_1e8 + uVar19) = iVar10;
                  *(undefined4 *)((long)&local_270 + uVar19) = uVar13;
                }
                lVar31 = lVar31 + 1;
                if (lVar31 == 2) break;
LAB_0015335c:
                for (; (int)lVar31 == 0; lVar31 = lVar31 + 1) {
                  uVar19 = (ulong)local_2a0;
                  uVar13 = local_294;
                  if (-1 < (int)local_2a0) goto LAB_00153240;
                }
                uVar19 = (ulong)local_29c;
                uVar13 = local_290;
                ...
                if (uVar25 == 0xffffffff) {
                  ...
                  *(undefined1 (*) [16])(puVar20 + 10) = auVar44;
                  ...
                  if (uVar25 < 0x20) {
                    ...
                    iVar10 = *(int *)((long)&local_1e8 + uVar19);
                    if (iVar10 == -1) goto LAB_001536a0;
                    uVar13 = *(undefined4 *)((long)&local_270 + uVar19);
                  }
                  else {
LAB_001536a0:
                    iVar10 = (int)local_288[2];
            ...
            if (iVar10 == 0) {
              ...
              if (local_29c < 0x20) {
                ...
                uVar43 = auVar44._4_4_;
                if (local_2dc == -1) goto LAB_00152408;
              }
LAB_00152d40:
...
LAB_00153ad8:
                    ...
                    uVar13 = arm64_cond_suffix_to_cmp(lVar31 + 0x22,&local_278);
                    iVar10 = (int)local_288[2];
                    *(int *)(local_288 + 2) = iVar10 + 1;
                    puVar20 = (undefined4 *)arm_irblock_alloc_instr(puVar2);
                    if (puVar20 == (undefined4 *)0x0) goto LAB_00152408;
                ...
                if (iVar10 != 0) {
                  ...
                  if (iVar10 == 0) {
                    ...
                    *(undefined8 *)(puVar20 + 4) = 0;
                    if (local_158[0] == '#') {
                      uVar24 = strtoull(local_158 + 1,(char **)0x0,0);
                    }
                    else if (local_158[0] == '0') {
                      uVar24 = strtoull(local_158,(char **)0x0,0);
                    }
                    else {
                      uVar24 = 0;
                    }
                    ...
                    *(undefined8 *)(puVar20 + 6) = DAT_00209d70;
                    do {
                      if (*(int *)((long)&local_1e8 + uVar19 * 4) == -1) {
                    ...
                    *(undefined8 *)(puVar20 + 0x16) = 0;
                    ...
                    do {
                      uVar13 = *(undefined4 *)((long)&local_270 + lVar31 * 4);
                      lVar36 = lVar31 * 4;
                      lVar31 = lVar31 + 1;
                      *puVar22 = *(undefined4 *)((long)&local_1e8 + lVar36);
                      puVar22[1] = uVar13;
...
LAB_0015400c:
                  ...
                  if (iVar10 != 0) {
                    ...
                    if (iVar10 == 0) {
                      ...
                      if ((cVar9 == '\0') ||
                         (uVar24 = strtoull(pcVar21,(char **)&local_278,0),
...
LAB_00153fc0:
                  ...
                  *(undefined8 *)(puVar20 + 4) = 0;
                  if (local_2a0 < 0x20) {
                    uVar19 = -(ulong)(local_2a0 >> 0x1f) & 0xfffffffc00000000 |
                             (ulong)local_2a0 << 2;
                    iVar11 = *(int *)((long)&local_1e8 + uVar19);
...
LAB_0015404c:
                  ...
                  if (pcVar21 != (char *)0x0) {
                    ...
                    for (lVar31 = 0;
                      ...
                      *(byte *)((long)&local_168 + lVar31) = bVar5;
                    }
                    *(undefined1 *)((long)&local_168 + (long)(int)lVar31) = 0;
                  }
                ...
                *(undefined8 *)(puVar20 + 8) = 0;
                if (local_29c < 0x20) {
                  uVar23 = -(ulong)(local_29c >> 0x1f) & 0xfffffffc00000000 | (ulong)local_29c << 2;
                  iVar11 = *(int *)((long)&local_1e8 + uVar23);
                  if (iVar11 == -1) goto LAB_00153940;
                  uVar13 = *(undefined4 *)((long)&local_270 + uVar23);
                }
                else {
LAB_00153940:
                  iVar11 = (int)local_288[2];
...
LAB_00153864:
                  ...
                  *(int *)(local_288 + 2) = iVar11 + 1;
                  ...
                  uVar23 = -(ulong)(local_280 >> 0x1f) & 0xfffffffc00000000 | (ulong)local_280 << 2;
                  iVar11 = *(int *)((long)&local_1e8 + uVar23);
                ...
                puVar20[0xe] = iVar11;
                puVar20[0xf] = uVar13;
                *(undefined4 *)((long)&local_270 + uVar19) = local_294;
                *(int *)((long)&local_1e8 + uVar19) = iVar10;
                puVar20[2] = iVar10;
                puVar20[3] = local_294;
                *(undefined8 *)(puVar20 + 4) = 0;
            ...
            if (local_2a0 < 0x20) {
              uVar19 = -(ulong)(local_2a0 >> 0x1f) & 0xfffffffc00000000 | (ulong)local_2a0 << 2;
              iVar10 = *(int *)((long)&local_1e8 + uVar19);
              if (iVar10 == -1) goto LAB_001535ec;
              uVar43 = *(undefined4 *)((long)&local_270 + uVar19);
            }
            else {
LAB_001535ec:
              uVar43 = 4;
          ...
          *(undefined4 *)(puVar18 + 1) = 0xffffffff;
          if (local_280 < 0x20) {
            lVar31 = (long)(int)local_280;
            iVar11 = *(int *)((long)&local_1e8 + lVar31 * 4);
...
LAB_00152580:
  ...
  *(undefined4 *)((long)puVar18 + 0xc) = uVar13;
  if (local_280 < 0x20) {
    lVar31 = (long)(int)local_280;
    iVar12 = *(int *)((long)&local_1e8 + lVar31 * 4);
    if (iVar12 != -1) {
      ...
      *(uint *)(puVar2 + 2) = uVar30 + 1;
      ...
      uVar43 = *(undefined4 *)((long)&local_270 + lVar31 * 4);
      *(undefined4 *)((long)pvVar14 + lVar36 + 0x84) = 0;
      *(undefined8 *)((long)pvVar14 + lVar36 + 0xc) = 0;
      *(undefined8 *)((long)pvVar14 + lVar36 + 4) = 0;
      *(undefined8 *)((long)pvVar14 + lVar36 + 0x1c) = 0;
...
LAB_00152ad4:
  ...
  *(int *)((long)&local_1e8 + (long)(int)uVar25 * 4) = iVar10;
  uVar30 = *(uint *)(lVar1 + 0x18);
  *(undefined4 *)((long)&local_270 + (long)(int)uVar25 * 4) = uVar13;
  if (uVar30 <= (uint)lVar29) goto LAB_00151afc;
  goto LAB_001518f0;
  while( true ) {
    pcVar33 = pcVar34 + -1;
...
LAB_001522d0:
    ...
    iVar11 = __isoc99_sscanf(pcVar34,"0x%lx",&local_280);
    if (iVar11 == 1) {
      lVar36 = CONCAT44(uStack_27c,local_280);
      bVar6 = true;
    }
    else {
      iVar11 = __isoc99_sscanf(pcVar34,&DAT_001f7eb0,&local_278);
      if (iVar11 == 1) {
        lVar36 = CONCAT44(local_278._4_4_,(int)local_278);
        bVar6 = true;
      }
...
LAB_00152360:
    ...
    iVar10 = __isoc99_sscanf(pcVar34,"0x%lx",&local_280);
    if (iVar10 == 1) {
      ...
      uVar38 = 0;
      iVar10 = __isoc99_sscanf(pcVar34,&DAT_001f7eb0,&local_278);
      if (iVar10 == 1) {
  ...
  goto LAB_0015217c;
LAB_00153604:
  if (((uVar30 == 0x1f) && (lVar31 = CONCAT44(local_278._4_4_,(int)local_278), lVar31 != 0)) &&
     (pcVar21 = strchr(local_158 + 0x80,0x21), pcVar21 != (char *)0x0)) {
    auVar44 = arm_emit_const(puVar2,local_288,lVar31,uVar15);
    iVar10 = (int)local_288[2];
    *(int *)(local_288 + 2) = iVar10 + 1;
    puVar20 = (undefined4 *)arm_irblock_alloc_instr(puVar2);
    if (puVar20 == (undefined4 *)0x0) goto LAB_00152408;
