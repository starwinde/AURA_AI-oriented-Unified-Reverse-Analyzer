...
LAB_00198124:
    ...
    if (0x646 < uVar1) goto LAB_00198178;
LAB_001981dc:
    if (0x62d < uVar1) {
      uVar1 = uVar1 - 0x62e;
joined_r0x00198198:
      ...
      if ((uVar4 & 0x14a5000) == 0) {
        if ((uVar4 & 0x999) == 0) goto LAB_00198228;
        iVar2 = 1;
      }
      else {
        iVar2 = 2;
    ...
    if (uVar1 - 0x5e7 < 9) goto LAB_00198124;
LAB_001981b0:
    MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (ulong)uVar3 * 2));
LAB_001981cc:
    uVar1 = MCInst_getOpcode(param_1);
    if (uVar1 < 0x647) goto LAB_001981dc;
LAB_00198178:
    uVar1 = uVar1 - 0x675;
    if (uVar1 < 0x19) goto joined_r0x00198198;
  }
LAB_00198228:
  uVar1 = MCInst_getOpcode(param_1);
  if (uVar1 < 0x647) {
    if (0x62d < uVar1) {
      ...
      if ((uVar4 & 0x14a5000) == 0) goto LAB_0019825c;
LAB_001983d0:
      uVar1 = uVar3 + 4;
LAB_0019826c:
    ...
    if ((uVar4 & 0x14a5000) != 0) goto LAB_001983d0;
LAB_0019825c:
    if ((uVar4 & 0x999) != 0) {
      uVar1 = uVar3 + 2;
      goto LAB_0019826c;
  ...
  if (iVar2 - 0x675U < 0x19) {
    ...
    if ((uVar4 & 0x14a5000) == 0) {
      uVar3 = uVar3 + 3;
      if ((uVar4 & 0x999) == 0) goto LAB_001982d8;
    }
    else {
      uVar3 = uVar3 + 6;
    }
...
LAB_001982d8:
  ...
  if (uVar3 < 0x647) {
    if (0x630 < uVar3) {
      if ((0x210911UL >> ((ulong)(uVar3 - 0x631) & 0x3f) & 1) != 0) goto LAB_001983f4;
      goto LAB_00198330;
    }
    if (uVar3 < 0x5b2) {
      if (0x573 < uVar3) {
        uVar5 = 0x3060c183cc7860f3 >> ((ulong)(uVar3 - 0x574) & 0x3f);
        goto joined_r0x00198500;
      }
      if (uVar3 < 0x56b) {
        if (uVar3 < 0x569) goto LAB_00198330;
        goto LAB_00198320;
      }
      if (uVar3 - 0x56d < 4) goto LAB_00198320;
    }
    else {
      if (0x22 < uVar3 - 0x5df) goto LAB_00198330;
...
LAB_001983f4:
    ...
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    if ((int)uVar5 != 0) goto LAB_00198428;
LAB_0019834c:
    MCOperand_CreateImm0(param_1,0);
    uVar4 = (ulong)(param_2 & 0xf);
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x5b2) goto LAB_0019836c;
LAB_00198450:
