...

{
  ...
  lVar18 = *param_1;
  lVar23 = lVar18 + (ulong)param_2 * 0x48;
    ...
    do {
      ...
      if ((uVar2 < uVar1) && ((*(byte *)(param_3 + (ulong)uVar2) & 1) == 0)) {
        *(undefined1 *)(param_3 + (ulong)uVar2) = 1;
        lVar11 = lVar18 + (ulong)uVar2 * 0x48;
...
joined_r0x00179fec:
              if ((bVar7 & 1) == 0) {
                *(undefined1 *)(param_3 + (ulong)uVar3) = 1;
                lVar13 = lVar18 + (ulong)uVar3 * 0x48;
...
joined_r0x0017a060:
                      if ((bVar7 & 1) == 0) {
                        *(undefined1 *)(param_3 + (ulong)uVar4) = 1;
                        lVar19 = lVar18 + (ulong)uVar4 * 0x48;
...
joined_r0x0017a0d4:
                              if ((bVar7 & 1) == 0) {
                                *(undefined1 *)(param_3 + (ulong)uVar5) = 1;
                                lVar9 = lVar18 + (ulong)uVar5 * 0x48;
                                uVar8 = *(uint *)(lVar9 + 0x20);
                                if (uVar8 != 0) {
                                  puVar15 = *(uint **)(lVar9 + 0x18);
                                  lVar20 = 0;
                                  uVar6 = *puVar15;
                                  if (uVar1 <= uVar6) goto LAB_0017a15c;
                                  do {
...
LAB_0017a15c:
                                    do {
                                      lVar20 = lVar20 + 1;
                                      if (uVar8 <= (uint)lVar20) goto LAB_0017a20c;
