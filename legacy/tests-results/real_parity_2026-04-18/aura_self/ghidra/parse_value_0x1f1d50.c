...

{
  ...
  if ((param_2 == (long *)0x0) || (lVar14 = *param_2, lVar14 == 0)) goto LAB_001f1e44;
  uVar2 = param_2[1];
  uVar10 = param_2[2];
  uVar6 = uVar10 + 4;
  if (uVar2 < uVar6) {
    ...
    {
LAB_001f1e00:
      if (uVar2 <= uVar10) goto LAB_001f1e44;
          ...
          if (uVar10 < uVar2) {
            do {
              if (0x20 < *(byte *)(lVar14 + uVar10)) {
                if (uVar2 == uVar10) goto LAB_001f24a0;
                uVar10 = param_2[2];
                if (uVar2 <= uVar10) goto LAB_001f2454;
                goto LAB_001f22bc;
              }
              uVar10 = uVar10 + 1;
              param_2[2] = uVar10;
...
LAB_001f22bc:
              if (*(char *)(lVar14 + uVar10) == ']') {
                ...
                do {
                  ...
                  puVar13 = puVar12;
                  if (puVar7 == (undefined8 *)0x0) goto LAB_001f2460;
                  puVar7[1] = 0;
                  *puVar7 = 0;
                  puVar7[3] = 0;
                  puVar7[2] = 0;
                  ...
                  if (iVar4 == 0) goto LAB_001f2438;
                  lVar14 = *param_2;
                  uVar6 = param_2[1];
                  uVar10 = param_2[2];
                  if (lVar14 == 0) {
LAB_001f23a4:
                    if (uVar6 <= uVar10) goto LAB_001f2438;
                  }
                  else {
                    if (uVar6 <= uVar10) goto LAB_001f2438;
                    do {
                      if (0x20 < *(byte *)(lVar14 + uVar10)) {
                        if (uVar10 != uVar6) goto LAB_001f23a4;
                        break;
                      }
                      uVar10 = uVar10 + 1;
                      param_2[2] = uVar10;
                ...
                if ((uVar6 <= uVar10) || (*(char *)(lVar14 + uVar10) != ']')) goto LAB_001f2438;
        ...
        if (uVar10 < uVar2) {
          do {
            if (0x20 < *(byte *)(lVar14 + uVar10)) {
              if (uVar2 == uVar10) goto LAB_001f24b4;
              uVar10 = param_2[2];
              if (uVar2 <= uVar10) goto LAB_001f2454;
              goto LAB_001f1f44;
            }
...
LAB_001f202c:
                ...
                if (*(char *)(lVar14 + uVar10) != ':') goto LAB_001f2438;
                uVar10 = uVar10 + 1;
                param_2[2] = uVar10;
...
LAB_001f20dc:
                  ...
                  do {
                    if (0x20 < *(byte *)(lVar14 + uVar10)) {
                      if (uVar10 != uVar6) goto LAB_001f20dc;
                      break;
                    }
                    uVar10 = uVar10 + 1;
                    param_2[2] = uVar10;
