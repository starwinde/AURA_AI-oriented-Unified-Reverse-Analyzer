...

{
  ...
  SStream_concat0(param_2,(uVar8 & 0x3fff) + 0x3e5c7f);
  uVar9 = (((ulong)uVar8 & 0xfc000) >> 0xe) - 1;
  if (0x32 < uVar9) goto switchD_001e0530_default;
...
LAB_001e09a4:
  ...
  if (0x17 < uVar9) goto switchD_001e0530_default;
  switch(uVar9 & 0xffffffff) {
  case 0:
    SStream_concat0(param_2,", ");
    goto LAB_001e0718;
  case 1:
    ...
    goto switchD_001e0530_default;
  case 2:
    puVar15 = &DAT_001fb598;
    break;
  case 3:
    puVar15 = &DAT_001fb5a0;
    break;
  case 4:
    puVar15 = &DAT_001fb5a8;
    break;
  case 5:
    puVar15 = &DAT_001fb5b0;
    break;
  case 6:
    SStream_concat0(param_2,&DAT_001fb548);
    printOperand(param_1,0,param_2);
    goto switchD_001e0530_default;
  case 7:
    SStream_concat0(param_2,&DAT_002011e8);
    op_addReg(param_1,0x12);
    goto switchD_001e0530_default;
  case 8:
    SStream_concat0(param_2,&DAT_002011f0);
    op_addReg(param_1,3);
    goto switchD_001e0530_default;
  case 9:
  ...
  case 10:
    ...
    goto switchD_001e0530_default;
  case 0xb:
    SStream_concat0(param_2,&DAT_00201208);
    op_addReg(param_1,2);
    goto switchD_001e0530_default;
  case 0xc:
    goto switchD_001e0690_caseD_c;
  case 0xd:
    SStream_concat0(param_2,&DAT_00201218);
    op_addImm(param_1,1);
    goto switchD_001e0530_default;
  case 0xe:
    SStream_concat0(param_2,&DAT_001fb568);
  ...
  case 0xf:
    ...
    goto LAB_001e0718;
  case 0x10:
    puVar15 = &DAT_001fb658;
    break;
  case 0x11:
    puVar15 = &DAT_001fb660;
    break;
  case 0x12:
    puVar15 = &DAT_001fb668;
    break;
  case 0x13:
    puVar15 = &DAT_001fb670;
    break;
  case 0x14:
    puVar15 = &DAT_001fb678;
    break;
  case 0x15:
    puVar15 = &DAT_001fb680;
    break;
  case 0x16:
    puVar15 = &DAT_001fb688;
    break;
  case 0x17:
    puVar15 = &DAT_001fb690;
    break;
  default:
    goto switchD_001e0530_default;
  }
...
LAB_001e1754:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    ...
    goto switchD_001e0530_default;
  case 0x1c:
    goto switchD_001e158c_caseD_1c;
  case 0x1d:
  case 0x1e:
    SStream_concat0(param_2,"ymmword ptr ");
    uVar3 = 0x20;
...
LAB_001e1858:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    ...
    goto switchD_001e0530_default;
  default:
    goto switchD_001e158c_default;
  }
LAB_001e0740:
  uVar9 = (CONCAT44(uVar5,uVar8) >> 0x1f & 0x3f) - 1;
  if (0x22 < uVar9) goto switchD_001e0530_default;
  switch(uVar9 & 0xffffffff) {
  case 0:
    goto switchD_001e076c_caseD_0;
  case 1:
  ...
  case 5:
    ...
    break;
  case 6:
switchD_001e0690_caseD_c:
    SStream_concat0(param_2,&DAT_00201210);
  ...
  case 0xf:
    ...
    goto LAB_001e11d8;
  case 0x10:
    goto switchD_001e076c_caseD_10;
  case 0x11:
    goto switchD_001e076c_caseD_11;
  case 0x12:
    goto switchD_001e076c_caseD_12;
  case 0x13:
    goto switchD_001e076c_caseD_13;
  case 0x14:
    goto switchD_001e076c_caseD_14;
  case 0x15:
...
LAB_001e1e40:
    ...
    if (0x1d < uVar9) goto switchD_001e1f04_default;
    switch(uVar9 & 0xffffffff) {
    case 0:
    case 0x10:
      SStream_concat0(param_2,"xmmword ptr ");
...
switchD_001e1a64_caseD_5:
    ...
    case 0x19:
      ...
      break;
    case 0x1a:
      goto switchD_001e1f04_caseD_1a;
    case 0x1b:
      goto switchD_001e1f04_caseD_1b;
    case 0x1c:
      SStream_concat0(param_2,"byte ptr ");
      uVar3 = 1;
LAB_001e2054:
...
LAB_001e1f1c:
      *(undefined1 *)(param_1 + 0x328) = uVar3;
      ...
      break;
    default:
      goto switchD_001e1f04_default;
    }
    uVar9 = ((ulong)(uVar5 >> 0x14) & 0xf) - 1;
    if (10 < uVar9) break;
    switch(uVar9 & 0xffffffff) {
    case 0:
switchD_001e076c_caseD_11:
      SStream_concat0(param_2,"{1to2}");
      break;
    case 1:
switchD_001e076c_caseD_12:
      SStream_concat0(param_2,"{1to4}");
      break;
    case 2:
switchD_001e076c_caseD_13:
      SStream_concat0(param_2,"{1to8}");
      break;
    case 3:
      SStream_concat0(param_2,", ");
...
LAB_001e1f78:
      uVar8 = uVar5 >> 0x18 & 7;
      if (uVar8 == 3) {
switchD_001e1f04_caseD_1b:
        printU8Imm(param_1,8,param_2);
      }
      else if ((uVar5 >> 0x1a & 1) == 0) {
        if (uVar8 == 1) {
switchD_001e1f04_caseD_1a:
...
switchD_001e158c_caseD_1c:
        printU8Imm(param_1,5,param_2);
      }
      else {
        if (uVar8 != 5) goto LAB_001e2398;
switchD_001e1f04_default:
        printU8Imm(param_1,4,param_2);
      }
      break;
    case 10:
switchD_001e076c_caseD_10:
      SStream_concat0(param_2,", {sae}");
      op_addAvxSae(param_1);
    }
  }
switchD_001e0530_default:
