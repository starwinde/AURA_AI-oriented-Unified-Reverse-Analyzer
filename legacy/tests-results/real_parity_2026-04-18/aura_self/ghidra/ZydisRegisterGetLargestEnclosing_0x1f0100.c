...

{
  ...
  if (5 < param_1) goto LAB_001f023c;
  if (param_1 < 4) {
    if (param_1 == 3) {
LAB_001f0228:
      local_a = 1;
...
LAB_001f023c:
      ...
      if (param_1 == 2) goto LAB_001f0234;
      if (2 < param_1) goto LAB_001f023c;
      if (param_1 != 0) {
        if (param_1 != 1) goto LAB_001f023c;
        goto LAB_001f0228;
      }
      local_a = 2;
    }
...
LAB_001f03a4:
        ...
        if (local_a == 0) {
          ...
          if (local_a != 1) goto LAB_001f03a4;
          uVar2 = local_9 + 0x45;
        }
      }
    }
