...
LAB_001952c0:
    ...
    if ((uVar6 & uVar11 & 1) != 0) goto LAB_001952f4;
LAB_00195278:
    if ((param_2 & 0x1000000) == 0) {
      ...
      uVar6 = 0;
      uVar7 = 3;
      if ((uVar11 & 1) == 0) goto joined_r0x0019530c;
    }
  }
  else {
    if (uVar3 - 0x29b < 4) goto LAB_001952c0;
LAB_00195250:
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar8 * 2));
    uVar3 = (uint)(uVar5 >> 0x17) & 1;
    uVar11 = uVar10 ^ 1 | uVar11;
    if ((uVar6 & uVar11 & 1) == 0) goto LAB_00195278;
LAB_001952f4:
    uVar10 = 0x10000;
  }
  uVar7 = 3;
