...
LAB_001c8178:
    ...
    if (iVar4 == 0) {
      ...
      if (uVar5 == 0xbf5) goto LAB_001c8358;
      if (uVar5 < 0xbf6) {
        if (uVar5 != 0x6d4) {
          if (0x6d4 < uVar5) {
            if (uVar5 != 0xb3e) {
              if (uVar5 < 0xb3f) {
                if (uVar5 == 0xb39) goto LAB_001c8358;
                if (uVar5 == 0xb3c) goto LAB_001c81e8;
              }
              else if (uVar5 == 0xb41) {
LAB_001c81e8:
                local_44 = 2;
...
LAB_001c8398:
      ...
      if (uVar5 == 0x13db) goto LAB_001c8358;
      if (uVar5 < 0x13dc) {
        if (uVar5 == 0xd7b) goto LAB_001c82e0;
        if (uVar5 < 0xd7c) {
          if (uVar5 == 0xbfa) goto LAB_001c8358;
          if ((uVar5 == 0xbfd) || (uVar5 == 0xbf8)) goto LAB_001c81e8;
        }
        else if (uVar5 - 0x10f6 < 9) {
          uVar7 = 0x155L >> ((ulong)(uVar5 - 0x10f6) & 0x3f);
joined_r0x001c8450:
          if ((uVar7 & 1) != 0) goto LAB_001c8398;
        }
      }
      else {
        if (uVar5 == 0x14b7) goto LAB_001c82e0;
        if (uVar5 < 0x14b8) {
          if (uVar5 == 0x13e0) goto LAB_001c8358;
          if ((uVar5 == 0x13e3) || (uVar5 == 0x13de)) goto LAB_001c81e8;
        }
        else if (uVar5 - 0x16a4 < 7) {
          uVar7 = 0x55L >> ((ulong)(uVar5 - 0x16a4) & 0x3f);
          goto joined_r0x001c8450;
        }
      }
LAB_001c8168:
      if (iVar4 == 0) {
        ...
        if (uVar5 != 0x6d4) {
          if (0x6d4 < uVar5) {
            if (uVar5 != 0xb3e) {
              if (uVar5 < 0xb3f) {
                if (uVar5 == 0xb39) goto LAB_001c8358;
                if (uVar5 == 0xb3c) goto LAB_001c8338;
              }
              else if (uVar5 == 0xb41) {
LAB_001c8338:
                local_44 = 2;
...
LAB_001c82e0:
        ...
        if (uVar5 < 0xd7c) {
          ...
          uVar7 = 0x155L >> ((ulong)(uVar5 - 0x10f6) & 0x3f);
joined_r0x001c8424:
          if ((uVar7 & 1) != 0) goto LAB_001c82a4;
        }
      }
      else {
        if (uVar5 == 0x14b7) goto LAB_001c82e0;
