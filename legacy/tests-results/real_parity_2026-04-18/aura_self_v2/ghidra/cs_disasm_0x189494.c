        ...
        do {
          ...
          *(long *)(piVar5 + 2) = lVar11;
          ...
          if ((uVar7 & 1) == 0) {
            ...
            if ((*(byte *)(param_1 + 0x20) & 1) == 0) goto joined_r0x00189958;
            bVar2 = *(byte *)((long)param_1 + 0x81);
            __n = (size_t)bVar2;
            if (uVar12 < bVar2) goto joined_r0x00189958;
...
LAB_0018967c:
        ...
        uVar13 = uVar14;
joined_r0x00189958:
        if (local_6a8 == 0) goto LAB_00189848;
        piVar5 = local_688;
        if ((uVar13 != local_69c) &&
