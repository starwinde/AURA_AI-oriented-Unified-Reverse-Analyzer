...

{
  ...
  SStream_concat0(param_2,(*(uint *)(OpInfo0_5 + uVar11 * 4) & 0x3fff) + 0x20ac4f);
  uVar11 = ((ulong)(uVar3 >> 0xe) & 0x7f) - 1;
  if (0x65 < uVar11) goto switchD_0018fe1c_default;
...
LAB_00190568:
  ...
  case 9:
    ...
    goto LAB_00190568;
  case 10:
    goto switchD_0018fe1c_caseD_a;
  case 0xb:
  case 0x1a:
    goto switchD_0018fe1c_caseD_b;
  case 0xc:
    goto switchD_0018fe1c_caseD_c;
  case 0xd:
    goto switchD_0018fe1c_caseD_d;
  case 0xf:
  case 0x27:
    goto switchD_0018fe1c_caseD_f;
  case 0x10:
  ...
  case 0x18:
    ...
    goto LAB_00190524;
  case 0x19:
    goto switchD_0018fe1c_caseD_19;
  case 0x1b:
    printPCRelImm_constprop_0(param_1,param_2);
    goto switchD_0018fe1c_default;
  case 0x1c:
    goto switchD_0018fe1c_caseD_1c;
  case 0x1d:
    uVar5 = 1;
    goto LAB_00190520;
  case 0x1e:
...
LAB_00191004:
    ...
    if (bVar7 < 10) {
      SStream_concat(param_2,&DAT_001fb530);
    }
    else {
...
LAB_00191290:
    ...
    printOperand(param_1,0,param_2);
LAB_001912d8:
    SStream_concat0(param_2,&DAT_001fb568);
...
LAB_00191094:
  ...
  case 0x50:
    ...
    goto LAB_00191158;
  case 0x51:
    goto switchD_0018fe1c_caseD_51;
  case 0x54:
    uVar5 = 0x20;
LAB_001905ec:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
...
LAB_00190664:
  ...
  case 0x5a:
    ...
    goto LAB_001907d4;
  case 0x5b:
    goto switchD_0018fe1c_caseD_5b;
  case 0x5c:
    uVar14 = 8;
LAB_00191158:
    printOperand(param_1,uVar14,param_2);
...
LAB_00191348:
  ...
  if (0x61 < uVar11) goto switchD_0018fe1c_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
...
LAB_00191678:
  ...
  case 0x11:
    ...
    goto switchD_0018fe1c_default;
  case 0x12:
    SStream_concat0(param_2,&DAT_001fb598);
    break;
  case 0x13:
    SStream_concat0(param_2,&DAT_001fb5a0);
    break;
  case 0x14:
    SStream_concat0(param_2,&DAT_001fb5a8);
    break;
  case 0x15:
  case 0x1c:
    uVar5 = 8;
    goto LAB_00190b40;
  case 0x16:
    SStream_concat0(param_2,&DAT_001fb5b0);
    break;
  case 0x17:
    iVar8 = MCInst_getOpcode(param_1);
    if ((iVar8 == 0x39b) || (iVar8 == 0x3b2)) {
...
switchD_0018fe1c_caseD_f:
  ...
  case 0x27:
    ...
    break;
  case 0x28:
    goto switchD_001905a4_caseD_28;
  case 0x29:
    goto switchD_001905a4_caseD_29;
  case 0x2a:
...
LAB_00190694:
  ...
  case 0x4e:
    ...
    goto LAB_00190bc4;
  case 0x4f:
switchD_0018fe1c_caseD_51:
    uVar5 = 0x20;
    goto LAB_00190520;
  case 0x50:
switchD_0018fe1c_caseD_5b:
    uVar5 = 0x40;
LAB_00190520:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_00190524:
...
LAB_00190ba8:
  ...
  case 0x54:
    ...
    break;
  case 0x57:
    SStream_concat0(param_2,&DAT_001fb658);
    break;
  case 0x58:
    SStream_concat0(param_2,&DAT_001fb660);
    break;
  case 0x59:
    SStream_concat0(param_2,&DAT_001fb668);
    break;
  case 0x5a:
    SStream_concat0(param_2,&DAT_001fb670);
    break;
  case 0x5b:
    SStream_concat0(param_2,&DAT_001fb678);
    break;
  case 0x5c:
    SStream_concat0(param_2,&DAT_001fb680);
    break;
  case 0x5d:
    SStream_concat0(param_2,&DAT_001fb688);
    break;
  case 0x5e:
    SStream_concat0(param_2,&DAT_001fb690);
    break;
  case 0x5f:
    uVar14 = 7;
LAB_00191860:
...
LAB_00190b84:
  ...
  if (0x34 < uVar11) goto switchD_0018fe1c_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,1,param_2);
    break;
...
LAB_00190ef0:
    ...
    goto switchD_0018fe1c_default;
  case 0x10:
switchD_0018fe1c_caseD_1c:
    uVar5 = 1;
    goto LAB_001904c4;
  case 0x11:
switchD_0018fe1c_caseD_d:
    uVar5 = 4;
    goto LAB_001904c4;
  case 0x12:
switchD_0018fe1c_caseD_b:
    uVar5 = 8;
    goto LAB_001904c4;
  case 0x13:
switchD_0018fe1c_caseD_c:
    uVar5 = 2;
LAB_001904c4:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_001904c8:
    ...
    goto joined_r0x001907b4;
  case 0x14:
    uVar14 = 3;
LAB_00190be8:
    printOperand(param_1,uVar14,param_2);
switchD_001906d4_caseD_2:
    SStream_concat0(param_2,", ");
    break;
  case 0x15:
    SStream_concat0(param_2,"{1to4}, ");
...
LAB_00190cb0:
  ...
  if (0xd < uVar11) goto switchD_0018fe1c_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,0,param_2);
    break;
...
LAB_00191d40:
          ...
          if (uVar11 == 4) goto switchD_001905a4_caseD_29;
          if (uVar11 != 5) goto LAB_00191d40;
          SStream_concat0(param_2,", ");
          printOperand(param_1,0,param_2);
        }
        uVar11 = uVar12 >> 0x2d;
        if (uVar11 == 3) {
          ...
          if ((bVar6 & 2) != 0) goto LAB_0019086c;
          SStream_concat0(param_2,&DAT_001f6fa0);
          goto switchD_0018fe1c_default;
        }
        if (uVar12 >> 0x2f == 0) {
          if (uVar11 == 1) goto switchD_001905a4_caseD_29;
          if (uVar11 == 2) goto switchD_0018fe1c_default;
        }
        else if (uVar11 == 4) {
          pcVar15 = ", ";
LAB_00190540:
...
switchD_0018fe1c_default:
    ...
    if (uVar11 != 8) {
      if (8 < uVar11) {
        uVar14 = 3;
        if (uVar11 != 9) goto switchD_0018fe1c_default;
        goto LAB_0019079c;
      }
      if (uVar11 == 6) goto switchD_001905a4_caseD_28;
switchD_001905a4_caseD_29:
LAB_0019086c:
      SStream_concat0(param_2,"} {z}");
      op_addAvxZeroOpmask(param_1);
      goto switchD_0018fe1c_default;
    }
switchD_0019071c_caseD_b:
    uVar14 = 5;
LAB_0019079c:
    printOperand(param_1,uVar14,param_2);
    SStream_concat0(param_2,&DAT_001f6fa0);
...
joined_r0x001907b4:
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
    ...
    if (uVar9 < 0x9a5) {
      ...
      if (0x3d < uVar9 - 0xa07) goto LAB_0018ff0c;
            ...
            do {
              ...
              while (cVar2 != -0x80) {
                ...
                *pcVar4 = cVar2;
                pcVar15 = pcVar15 + -1;
                uVar9 = uVar1 & 0xff;
                if (uVar20 < (uVar1 & 0xff)) goto LAB_001902ec;
                pcVar4 = pcVar4 + 1;
                cVar2 = *pcVar15;
              }
              uVar1 = uVar9 + 1;
