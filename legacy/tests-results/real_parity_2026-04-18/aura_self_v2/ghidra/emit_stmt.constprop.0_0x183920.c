...

{
  ...
  case 0:
    ...
    return uVar5;
  case 1:
    fwrite(&DAT_001fa310,1,4,param_2);
    fwrite(&DAT_001f8498,1,4,param_2);
    emit_expr(*(undefined8 *)(param_1 + 0x26),param_2,0);
    fwrite(&DAT_001f83f8,1,4,param_2);
  ...
  case 4:
    ...
    if (piVar3 != (int *)0x0) {
      if (*piVar3 == 10) {
        ...
        fwrite(&DAT_001f82f0,1,3,param_2);
    ...
    fwrite(&DAT_001fae08,1,2,param_2);
...
LAB_00183c4c:
    fwrite(&DAT_001fa310,1,4,param_2);
LAB_00183c70:
    sVar6 = fwrite(&DAT_001f7888,1,2,param_2);
    return sVar6;
  case 6:
    fwrite(&DAT_001fa310,1,4,param_2);
  ...
  case 0xc:
    ...
    fwrite(&DAT_001fafb8,1,2,param_2);
