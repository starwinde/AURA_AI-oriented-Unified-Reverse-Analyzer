...
void FUN_001ad4ec(long param_1,int param_2,undefined8 param_3)

{
  ...
  if (uVar3 == 3) {
    SStream_concat0(param_3,&DAT_001f8088);
    goto LAB_001ad5e0;
  }
  if ((uVar2 >> 2 & 1) == 0) {
    if (uVar3 == 1) {
      SStream_concat0(param_3,&DAT_001f8090);
      goto LAB_001ad5e0;
    }
    if (uVar3 == 2) {
      SStream_concat0(param_3,&DAT_001f8080);
      goto LAB_001ad5e0;
    }
  }
  else {
    ...
    if (uVar3 == 5) {
      SStream_concat0(param_3,&DAT_001fb6a8);
      return;
    }
  }
  SStream_concat0(param_3,&DAT_001fbd80);
LAB_001ad5e0:
  SStream_concat0(param_3,&DAT_001fbca0);
  lVar9 = *(long *)(param_1 + 800);
