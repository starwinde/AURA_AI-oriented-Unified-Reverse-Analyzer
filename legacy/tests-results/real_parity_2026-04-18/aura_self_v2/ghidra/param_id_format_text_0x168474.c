...
void param_id_format_text(long *param_1,long param_2)
    ...
    if ((int)param_1[1] != 0) {
      ...
      do {
        while( true ) {
          ...
          uVar7 = uVar7 + 1;
          lVar8 = lVar8 + 0xd8;
          if (*(uint *)(param_1 + 1) <= uVar7) goto LAB_0016840c;
        }
