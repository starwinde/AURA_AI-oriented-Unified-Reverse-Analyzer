...
LAB_00146724:
              if (uVar18 == 0) goto LAB_00146a80;
LAB_00146728:
              pvVar13 = calloc((ulong)uVar18,0x38);
              *(void **)(param_1 + 0x18) = pvVar13;
              if (pvVar13 == (void *)0x0) goto LAB_00146868;
            }
            else {
              if (0x37 < param_3) {
                uVar10 = 0;
...
LAB_00146fc0:
                *(undefined4 *)(param_1 + 0x30) = 0;
                ...
                if (param_3 - lVar20 < (ulong)local_ec) goto LAB_00146fc0;
                if (uVar11 < uVar33) {
                  uVar33 = uVar11;
                }
                uVar10 = 0;
                  ...
                  if (((uVar11 != 0 && uVar11 < (uint)local_f8) && bVar6 < 0x20) &&
                    ...
                    if (sVar16 < param_3 - uVar21) {
                      ...
                      if ((bVar6 & (bVar6 & 0xe) == 0) == 0) {
                        if ((bVar6 & 0xe) != 0xe) goto LAB_001469ac;
                        uVar24 = 1;
                      }
                      else {
                        uVar11 = 1;
