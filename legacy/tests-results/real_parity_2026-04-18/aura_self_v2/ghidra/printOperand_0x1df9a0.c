...

{
  ...
  if ((uVar9 & 1) == 0) {
    ...
    if ((uVar9 & 1) == 0) goto LAB_001dfb30;
    ...
    if (uVar6 < 0x1ce) {
      if (uVar6 < 0x1cc) {
        if (0xac < uVar6) {
          if (uVar6 != 0xee) {
            if (uVar6 == 0x15f) goto LAB_001dfdd8;
            if (uVar6 != 0xe5) goto LAB_001dfdb8;
          }
LAB_001dfd6c:
          uVar9 = uVar9 & 0xff;
        ...
        if (uVar6 < 0xaa) {
          if (uVar6 == 0x18) goto LAB_001dfe24;
          goto LAB_001dfdb8;
        }
        uVar4 = 4;
        if ((int)param_2 == 1) {
...
LAB_001dfe24:
        ...
        if (uVar6 == 0x203) goto LAB_001dfd6c;
      }
      else if (uVar6 == 0x5df) goto LAB_001dfe24;
LAB_001dfdb8:
