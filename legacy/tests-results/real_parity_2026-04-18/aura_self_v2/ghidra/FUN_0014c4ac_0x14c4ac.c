...
LAB_0014c654:
                    lVar17 = lVar17 + 1;
                    puVar18 = puVar18 + 9;
                    if (uVar2 <= (uint)lVar17) goto LAB_0014c74c;
                  }
                  puVar7 = (uint *)*puVar18;
                  uVar27 = 0xffffffff;
                  ...
                  do {
                    while( true ) {
                      ...
                      iVar16 = (int)uVar27;
                      puVar7 = puVar7 + 1;
                      if (puVar1 == puVar7) goto LAB_0014c71c;
                    }
                    iVar13 = __s[uVar27];
                    uVar15 = uVar14;
                    uVar19 = uVar27;
...
LAB_0014c71c:
                  ...
                  if (puVar5[lVar17] == iVar16) goto LAB_0014c654;
              ...
              do {
                while (piVar12 = puVar5 + lVar17, *piVar12 == -1) {
                  *piVar8 = (int)lVar17;
                  lVar17 = lVar17 + 1;
                  piVar8 = piVar8 + 0x12;
                  if (uVar2 <= (uint)lVar17) goto LAB_0014c798;
                }
                lVar17 = lVar17 + 1;
                *piVar8 = *piVar12;
                piVar8 = piVar8 + 0x12;
                        ...
                        do {
                          ...
                          if (uVar24 == 0) {
                            ...
                            do {
                              iVar13 = *piVar12;
                              piVar12 = piVar12 + 1;
                              if (iVar13 == (int)lVar17) goto LAB_0014c878;
...
LAB_0014c878:
                ...
                uVar4 = DAT_00209d68;
                lVar17 = lVar17 + 1;
                if (uVar2 <= (uint)lVar17) goto LAB_0014c8e8;
                lVar21 = *param_1;
              } while( true );
            }
            free(__s);
...
LAB_0014cc5c:
      ...
      if (uVar2 == 1) {
            ...
            do {
              if ((*piVar8 != 0x1b) && (piVar8[2] != -1)) {
                if (*(char *)((long)__ptr_00 + uVar14) == '\0') {
                  *(int *)((long)pvVar9 + (long)iStack_20 * 4) = (int)uVar14;
        ...
        if (__ptr_01 == (void *)0x0) goto LAB_0014ccac;
        lStack_28 = 0;
        if (0 < iStack_20) {
          do {
            lVar21 = lVar21 + (ulong)*(uint *)((long)pvVar9 + lStack_28 * 4) * 0x48;
...
LAB_0014c9f8:
                  lVar17 = lVar17 + 1;
                  if (uVar24 <= (uint)lVar17) goto LAB_0014cb7c;
                }
                lVar6 = *param_1;
...
LAB_0014cc44:
                ...
                *(void **)(puVar26 + 0x16) = pvVar11;
                if (pvVar11 == (void *)0x0 || pvVar10 == (void *)0x0) goto LAB_0014cc44;
                if (uVar24 != 0) {
                ...
                lVar17 = lVar17 + 1;
                uVar24 = *(uint *)(lVar21 + 0x40);
                *(uint *)((long)pvVar9 + (long)iStack_20 * 4) = uVar3;
                iStack_20 = iStack_20 + 1;
...
LAB_0014cb7c:
            ...
            if (iStack_20 <= (int)lStack_28) break;
            lVar21 = *param_1;
          } while( true );
        }
        free(pvVar9);
