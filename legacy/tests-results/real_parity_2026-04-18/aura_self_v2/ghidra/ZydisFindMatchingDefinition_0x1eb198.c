...
LAB_001eb3e8:
              if ((((!bVar1) || ((*(byte *)(local_20 + 5) & 0x40) == 0)) &&
                ...
                *(undefined1 *)((long)param_2 + 0x35) = 0;
                if ((((*(byte *)(local_20 + 4) & 0xe) == 2) || (*(char *)(param_2 + 5) != '\b')) &&
                  ...
                  if (cVar5 != '\0') {
                    if ((undefined8 *)param_2[1] == local_28) goto LAB_001eb9a0;
                    local_3b = local_3b + 1;
                  ...
                  if (*(char *)((long)param_2 + 0x29) == '\0') {
                    ...
                    /* WARNING: Subroutine does not return */
                      __assert_fail("definition->address_sizes & (match->easz >> 4)",
                           ...
                           (uint)(*(byte *)((long)param_2 + 0x29) >> 4)) == 0) goto LAB_001eb9a0;
                  if (uVar7 == 4) {
                    ...
                    /* WARNING: Subroutine does not return */
                      ...
                      else if (*(char *)(param_2 + 5) == ' ') goto LAB_001eb9a0;
                    }
          ...
          else if ((*param_1 == 0) || ((*(byte *)((long)local_28 + 6) & 7) != 5)) goto LAB_001eb3e8;
        }
      }
LAB_001eb9a0:
