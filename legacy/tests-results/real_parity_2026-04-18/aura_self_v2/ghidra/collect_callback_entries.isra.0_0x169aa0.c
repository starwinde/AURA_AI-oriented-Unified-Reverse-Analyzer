...
LAB_00169b48:
  ...
  if (param_3 <= uVar11) goto LAB_00169d90;
  goto LAB_00169b58;
LAB_00169c58:
  local_170 = 0;
...
LAB_00169d18:
    if (local_170 == *puVar6) goto LAB_00169c4c;
  }
LAB_00169d30:
  if (*param_6 <= uVar8) {
    uVar8 = *param_6 << 1;
    ...
    if (puVar9 == (ulong *)0x0) goto LAB_00169d90;
    *param_6 = uVar8;
    *param_4 = puVar9;
    uVar8 = *param_5;
  }
...
LAB_00169c4c:
  ...
  if (pcVar13 == pcVar10) goto LAB_00169b48;
  goto LAB_00169c58;
}
