...
LAB_001f5c2c:
      do {
        puVar6 = (undefined8 *)(*(code *)global_hooks)(0x40);
        if (puVar6 == (undefined8 *)0x0) goto LAB_001f5e6c;
        puVar6[1] = 0;
        *puVar6 = 0;
        puVar6[3] = 0;
        puVar6[2] = 0;
...
LAB_001f5cd8:
          do {
            ...
            if (puVar7 == (undefined8 *)0x0) goto LAB_001f5e64;
            puVar7[1] = 0;
            *puVar7 = 0;
            puVar7[3] = 0;
            puVar7[2] = 0;
...
LAB_001f5d70:
              do {
                ...
                if (puVar8 == (undefined8 *)0x0) goto LAB_001f5e5c;
                puVar8[1] = 0;
                *puVar8 = 0;
                puVar8[3] = 0;
                puVar8[2] = 0;
                    ...
                    do {
                      ...
                      if (plVar16 == (long *)0x0) {
                        ...
                        *plVar16 = (long)plVar10;
                        ...
                        if (local_40 == (long *)0x0) goto LAB_001f5ea8;
                      }
                      plVar9 = (long *)cJSON_Duplicate_rec(local_40,5,1);
                      plVar16 = plVar10;
...
LAB_001f5ee4:
            ...
            if (puVar15 == (undefined8 *)0x0) {
              ...
              puVar6[2] = puVar7;
              puVar15 = puVar7;
              if (plVar13 == (long *)0x0) goto LAB_001f5f10;
              goto LAB_001f5cd8;
            }
            *puVar15 = puVar7;
            plVar13 = (long *)*plVar13;
...
LAB_001f5f10:
        ...
        if (local_28 == (undefined8 *)0x0) {
          ...
          puVar11[2] = puVar6;
          local_28 = puVar6;
          if (local_30 == (long *)0x0) goto LAB_001f6058;
          goto LAB_001f5c2c;
        }
        *local_28 = puVar6;
        puVar6[1] = local_28;
...
LAB_001f6058:
    ...
    if (local_8 == (undefined8 *)0x0) {
      ...
      puVar3[2] = puVar11;
      local_18 = puVar11;
      if (puVar6 == (undefined8 *)0x0) goto LAB_001f61dc;
    }
    else {
      *local_8 = puVar11;
      puVar11[1] = local_8;
      puVar6 = (undefined8 *)*local_18;
      local_18 = puVar11;
      if (puVar6 == (undefined8 *)0x0) goto LAB_001f61d0;
    }
    local_18 = puVar6;
    puVar6 = (undefined8 *)(*(code *)global_hooks)(0x40);
    local_8 = puVar11;
