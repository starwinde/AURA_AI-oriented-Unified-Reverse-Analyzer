  ...
  *(char *)(param_1 + 0x42) =
  ...
  if (iVar6 == 0) {
    ...
    *(long *)(param_1 + 0x58) = lVar11;
    ...
    if (cVar2 == '\x04') {
      iVar9 = 0x24;
      *(undefined8 *)(param_1 + 0xbc) = DAT_00209dc0;
    }
    else if (cVar2 == '\b') {
      iVar9 = 0x34;
      *(undefined8 *)(param_1 + 0xbc) = DAT_00209dc8;
    }
    else if (cVar2 == '\x02') {
      iVar9 = 0x14;
      *(undefined8 *)(param_1 + 0xbc) = DAT_00209db8;
    }
    else {
...
LAB_001dc654:
          ...
          if (iVar6 != 1) {
            ...
            *(undefined8 *)(param_1 + 0xc4) = DAT_00209dd0;
            if ((*(byte *)(param_1 + 0x10) & 1) != 0) {
              iVar6 = 0;
              goto LAB_001dc598;
            }
...
LAB_001dc528:
      ...
      *(undefined4 *)(param_1 + 200) = 0;
      if (uVar13 != 4) {
        ...
        *(undefined8 *)(param_1 + 0xc4) = DAT_00209dd8;
        if ((*(byte *)(param_1 + 0x10) & 1) == 0) {
          lVar14 = 0;
          *(undefined1 *)(param_1 + 0x10) = 1;
          *(char *)(param_1 + 0x40) = cVar5 - (char)*(undefined8 *)(param_1 + 0x68);
