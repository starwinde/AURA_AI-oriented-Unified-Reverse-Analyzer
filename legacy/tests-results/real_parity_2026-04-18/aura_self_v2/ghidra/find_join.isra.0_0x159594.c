...
uint find_join_isra_0(long param_1,uint param_2,uint param_3,uint param_4)

{
  ...
  uVar2 = param_2;
  if (uVar8 < param_2) {
    lVar3 = param_1 + (ulong)param_3 * 0x48;
    uVar8 = *(uint *)(lVar3 + 0x30);
    if ((uVar8 != 1) ||
       ((uVar2 = **(uint **)(lVar3 + 0x28), param_4 != uVar2 &&
        ((lVar3 = param_1 + (ulong)param_4 * 0x48, *(int *)(lVar3 + 0x30) != 1 ||
      ...
      if ((__ptr != (void *)0x0 && __ptr_00 != (void *)0x0) && __ptr_01 != (uint *)0x0) {
        ...
        *__ptr_01 = param_3;
        while( true ) {
          if (uVar8 != 0) {
            puVar4 = *(uint **)(param_1 + (ulong)__ptr_01[uVar7] * 0x48 + 0x28);
            puVar1 = puVar4 + uVar8;
            do {
              uVar8 = *puVar4;
              puVar4 = puVar4 + 1;
          ...
          uVar8 = *(uint *)(param_1 + (ulong)__ptr_01[uVar7 & 0xffffffff] * 0x48 + 0x30);
        }
        uVar7 = 1;
        lVar3 = 0;
        ...
        *__ptr_01 = param_4;
        do {
          lVar5 = param_1 + (ulong)__ptr_01[lVar3] * 0x48;
