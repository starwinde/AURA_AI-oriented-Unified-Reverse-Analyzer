...

{
  ...
  if (uVar2 < 0xa03) {
    if (0x9c3 < uVar2) {
      ...
      if ((uVar5 & 0x61861b6db) != 0) goto LAB_001985b0;
      uVar5 = uVar5 & 0x4400000000000000;
      goto joined_r0x001986b8;
    }
    if (uVar2 < 0x9af) {
      if (uVar2 < 0x971) {
        if (uVar2 < 0x968) {
          if (0x965 < uVar2) goto LAB_001985b0;
        }
...
LAB_001985b0:
      ...
      else if ((0x3060c183cc7860f3U >> ((ulong)(uVar2 - 0x971) & 0x3f) & 1) != 0) goto LAB_001985b0;
    }
  }
  else {
    if (0x3c < uVar2 - 0xa06) goto LAB_001985c8;
...
LAB_001985c8:
  ...
  if (uVar2 == 0) {
    ...
    if (0x9a6 < uVar3) goto LAB_001986e4;
LAB_00198600:
    if (0x969 < uVar3) {
      uVar5 = 0x102040a214102885 >> ((ulong)(uVar3 - 0x96a) & 0x3f);
      goto joined_r0x00198704;
    }
    if (uVar3 == 0x966) goto LAB_00198624;
    if (uVar1 != 0xd) goto LAB_00198710;
LAB_00198970:
    ...
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x9a7) goto LAB_00198600;
LAB_001986e4:
    if (uVar3 - 0x9ad < 0x39) {
      uVar5 = 0x104104924800001 >> ((ulong)(uVar3 - 0x9ad) & 0x3f);
joined_r0x00198704:
      if ((uVar5 & 1) == 0) goto LAB_00198708;
    }
    else {
LAB_00198708:
      if (uVar1 == 0xd) goto LAB_00198970;
LAB_00198710:
      if (uVar1 != 0xf) {
...
LAB_0019877c:
    ...
    if ((uVar5 & 0x1ff000000061c387) != 0) goto LAB_0019877c;
    if ((uVar5 & 0xff80000000000) == 0) goto LAB_001987a0;
    if (0x1d < uVar1) {
      return 0;
    }
...
LAB_001987a0:
  ...
  if (uVar3 < 0xa04) {
    ...
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_00198808;
      uVar5 = (ulong)(uVar1 + 1);
    }
LAB_001987f0:
...
LAB_00198808:
  ...
  if (uVar3 < 0xa04) {
    ...
    if (0x3c < uVar3 - 0xa06) goto LAB_00198858;
    uVar6 = 1L << ((ulong)(uVar3 - 0xa06) & 0x3f);
    uVar5 = (ulong)(uVar1 + 4);
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_00198858;
      uVar5 = (ulong)(uVar1 + 2);
    }
  }
  MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (uVar5 & 0x1f) * 2));
