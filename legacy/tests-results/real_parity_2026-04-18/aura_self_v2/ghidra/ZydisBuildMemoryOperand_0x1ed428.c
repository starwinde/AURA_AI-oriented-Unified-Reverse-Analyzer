...
/* WARNING: Removing unreachable block (ram,0x001ed838) */
...
LAB_001ed710:
    ...
    if (0x10 < bVar1) goto LAB_001ed710;
    if (bVar1 == 0) {
      if ((bVar3 & 7) == 5) {
        *(undefined1 *)((long)param_3 + 0x21) = 8;
        param_3[5] = 0;
...
LAB_001ed874:
      ...
      if (bVar1 == 4) {
        *(undefined1 *)(param_3 + 3) = 2;
        ...
        if (4 < bVar1) goto LAB_001ed874;
        if (1 < bVar1) {
          if (bVar1 != 2) goto LAB_001ed874;
