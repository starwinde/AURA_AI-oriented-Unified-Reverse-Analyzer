...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n","Offset",&DAT_001f8d18,
                  &DAT_001f8d30,&DAT_001f8d28,&DAT_001faaa8,"Source");
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n",&DAT_001faaf0,&DAT_001faae0,
                  &DAT_001faae0,&DAT_001faae0,&DAT_001faae0,&DAT_001faaf0);
    if (*(int *)(param_1 + 4) != 0) {
      lVar11 = 0;
      uVar10 = 0;
      do {
        ...
        if (uVar5 == 2) {
          pcVar9 = "arg";
LAB_00176bb4:
          if (*(int *)(lVar1 + 0x24) == 1) goto LAB_00176c70;
LAB_00176bc0:
          pcVar7 = "heuristic";
        }
        else {
          ...
          if (*(int *)(lVar1 + 0x24) != 1) goto LAB_00176bc0;
LAB_00176c70:
          pcVar7 = "DWARF";
        }
