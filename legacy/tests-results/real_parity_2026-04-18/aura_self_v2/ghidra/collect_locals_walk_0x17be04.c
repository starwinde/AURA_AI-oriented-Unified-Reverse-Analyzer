...
LAB_0017c084:
            if (*(int *)(param_2 + 0xdd0) != 0) {
              uVar8 = 0;
              do {
                __snprintf_chk(auStack_88,0x40,2,0x40,&DAT_001fac58,uVar8);
                uVar8 = uVar8 + 1;
            ...
            if (uVar7 <= uVar8) {
              ...
              if (__ptr == (void *)0x0) goto switchD_0017be5c_caseD_6;
              uVar8 = *(uint *)(param_2 + 0xde0);
            ...
            *(int *)((long)__ptr + lVar10) = iVar1;
            __snprintf_chk((long)__ptr + lVar10 + 4,0x40,2,0x40,&DAT_001f82e8,iVar1);
          ...
          while (iVar1 != *piVar2) {
            piVar2 = piVar2 + 0x33;
            if (piVar4 == piVar2) goto LAB_0017c084;
          }
        }
        goto switchD_0017be5c_caseD_6;
      }
    } while (param_1 != (undefined4 *)0x0);
switchD_0017be5c_caseD_6:
  }
LAB_0017be80:
