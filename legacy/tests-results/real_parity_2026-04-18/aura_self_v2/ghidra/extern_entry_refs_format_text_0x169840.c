  ...
  if (uVar9 == 0) {
    ...
    if (uVar4 < 2) {
      ...
      do {
        ...
        pauVar3 = pauVar6 + 1;
        pauVar6 = pauVar6 + 3;
        auVar10 = a64_TBL(ZEXT816(0),auVar10,*pauVar3,_DAT_00209eb0);
        iVar11 = iVar11 + (_DAT_00209ed0 ^
                          (_DAT_00209ed0 ^ _DAT_00209ec0) & -(uint)(auVar10._0_4_ == 0));
        iVar12 = iVar12 + (_UNK_00209ed4 ^
                          (_UNK_00209ed4 ^ _UNK_00209ec4) & -(uint)(auVar10._4_4_ == 0));
        iVar13 = iVar13 + (_UNK_00209ed8 ^
                          (_UNK_00209ed8 ^ _UNK_00209ec8) & -(uint)(auVar10._8_4_ == 0));
        iVar14 = iVar14 + (_UNK_00209edc ^
                          (_UNK_00209edc ^ _UNK_00209ecc) & -(uint)(auVar10._12_4_ == 0));
