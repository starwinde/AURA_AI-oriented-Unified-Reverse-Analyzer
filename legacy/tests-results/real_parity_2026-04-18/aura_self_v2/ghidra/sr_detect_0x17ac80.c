        ...
        if ((bVar5 & 1) == 0) {
          ...
          if (uVar11 < uVar3) {
            ...
            while( true ) {
              ...
              uVar19 = (uint)uVar21;
              uVar22 = (uint)uVar23;
              if ((((bVar5 & 1) != 0) || (lVar12 = lVar24 + (ulong)uVar25 * 0x48, lVar12 == 0)) ||
                 (uVar25 = *(uint *)(lVar12 + 0x10), uVar25 == 0)) break;
              lVar6 = *(long *)(lVar12 + 8);
              lVar13 = (ulong)(uVar25 - 1) * 0x88;
              lVar12 = lVar6 + lVar13;
              ...
              iVar20 = uVar25 - 2;
              if (iVar20 < 0) break;
              piVar7 = (int *)(lVar6 + (ulong)uVar25 * 0x88 + -0x110);
              while ((*(int *)(lVar12 + 0x18) != piVar7[2] || (*piVar7 != 0xb))) {
                iVar20 = iVar20 + -1;
                piVar7 = piVar7 + -0x22;
                if (iVar20 == -1) goto joined_r0x0017b110;
              }
              if ((uint)piVar7[0x12] < 2) break;
              iVar16 = piVar7[6];
              if (iVar20 != 0) {
                piVar8 = (int *)(lVar6 + (long)iVar20 * 0x88 + -0x88);
                do {
                  if (*piVar8 == 1) {
                  ...
                  piVar8 = piVar8 + -0x22;
                } while (piVar8 != (int *)((long)iVar20 * 0x88 + (ulong)(iVar20 - 1) * -0x88 +
                                          lVar6 + -0x110));
              }
...
LAB_0017afb8:
              ...
              if (uVar22 <= uVar19) {
                ...
                if (__ptr_00 == (void *)0x0) goto LAB_0017ae98;
              }
              lVar12 = uVar21 * 0x10;
              ...
              *(undefined2 *)((long)__ptr_00 + lVar12 + 0xc) = 0;
              uVar21 = uVar15;
              if (uVar3 <= uVar25) {
                if (uVar19 + 1 < 2) goto LAB_0017b114;
                goto LAB_0017ada0;
              }
...
LAB_0017b114:
              ...
              if (uVar17 < uVar3) {
                ...
                *(undefined2 *)((long)__ptr_00 + lVar12 + 0xc) = 1;
                uVar15 = (ulong)uVar1;
                if (1 < uVar1) goto LAB_0017ada0;
                iVar20 = -1;
                iVar14 = 0;
LAB_0017b098:
                lVar24 = lVar24 + (ulong)uVar25 * 0x48;
                if ((lVar24 == 0) || (*(int *)(lVar24 + 0x10) == 0)) {
                  iVar26 = -1;
                }
                else {
                  iVar26 = -1;
                  lVar12 = (ulong)(*(int *)(lVar24 + 0x10) - 1) * 0x88;
...
LAB_0017ada0:
                ...
                iVar26 = -1;
                if (uVar25 < uVar3) goto LAB_0017b098;
              }
