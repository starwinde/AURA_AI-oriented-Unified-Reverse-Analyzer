...
LAB_001755b0:
          ...
          if ((iVar9 != 0) ||
             ((pcVar31 = strstr(pcVar16,"x29"), pcVar31 == (char *)0x0 &&
              (pcVar31 = strstr(pcVar16,"fp"), pcVar31 == (char *)0x0)))) goto LAB_001755f0;
        ...
        if (pcVar12 != (char *)0x0) {
          ...
          if (((iVar7 != 0) || (pcVar11 = strstr(pcVar16,"rsp"), pcVar11 == (char *)0x0)) &&
            ...
            if (cVar3 == ']') {
              ...
              if (pcVar11 == local_20d8) goto LAB_00176344;
            ...
            if (uVar8 != 0) {
              ...
              sVar23 = __nmemb;
              if (0x1ff < uVar8) goto LAB_00176344;
            }
...
LAB_001758b8:
      ...
      if (pvVar15 == (void *)0x0) goto LAB_001754e0;
...
LAB_00175dc8:
              ...
              *(uint *)(__ptr + 4) = uVar8;
              ...
              if ((long)uVar21 < 0) goto LAB_00175eb0;
              *(undefined4 *)((long)pvVar15 + lVar24 + 0x20) = 0;
LAB_00175d6c:
              pcVar12 = "var_%x";
LAB_00175d80:
              ...
              *(char **)((long)pvVar15 + lVar24 + 0x10) = pcVar12;
              uVar8 = *(uint *)((long)pvVar15 + lVar24 + 8);
joined_r0x00175da4:
              if (uVar8 == 4) goto LAB_00175dc8;
              if (3 < uVar8) {
                if (uVar8 == 8) goto LAB_00175e54;
                pcVar16 = "unknown";
                if (uVar8 == 0x10) {
                  pcVar16 = local_2118;
                }
            ...
            uVar25 = (ulong)uVar8;
            if (puVar14 == puVar32 + 2) goto LAB_00175ea0;
            puVar32 = puVar32 + 2;
          ...
          *(undefined4 *)((long)pvVar15 + lVar24 + 0x28) = uVar2;
          ...
          if (bVar1 && param_4 == 4) {
            if ((long)uVar21 < (long)uVar10) {
              if ((long)uVar21 < 0) goto LAB_00175cf4;
              *(undefined4 *)((long)pvVar15 + lVar24 + 0x20) = 0;
LAB_00175c8c:
              pcVar12 = "var_%x";
            }
            ...
            *(char **)((long)pvVar15 + lVar24 + 0x10) = pcVar12;
            ...
            if (uVar8 < 5) {
              if (uVar8 == 1) {
                ...
                pcVar16 = "uint16_t";
                if (uVar8 != 2) goto LAB_00175fc0;
              }
              goto LAB_00175958;
            }
            if (uVar8 == 8) goto LAB_00175ce4;
            if (uVar8 != 0x10) {
LAB_00175fc0:
              pcVar16 = "unknown";
              goto LAB_00175958;
...
LAB_00175958:
          ...
          uVar25 = (ulong)uVar8;
          if (puVar14 == puVar32 + 2) goto LAB_00175a48;
          puVar32 = puVar32 + 2;
          pvVar15 = (void *)__ptr[3];
        } while( true );
      }
        ...
        do {
          ...
          if (((((((bVar4 == 0x6c) && (pcVar16[-0x3f] == 'd')) && (pcVar16[-0x3e] == 'r')) ||
            ...
            if (pcVar31 == (char *)0x0) {
              ...
              if (pcVar31 + 1 == local_20d8) goto LAB_001758a8;
              uVar8 = (uint)*__s1;
            }
            ...
            if (uVar8 != 0) {
              ...
              do {
                if (uVar25 == *puVar14) {
                  ...
                  *(int *)((long)puVar14 + 0xc) = *(int *)((long)puVar14 + 0xc) + 1;
                  sVar30 = __nmemb;
                  goto joined_r0x001758a4;
                }
                puVar14 = puVar14 + 2;
              } while (puVar14 != &local_20a8 + __nmemb * 2);
              sVar23 = __nmemb;
              if (0x1ff < uVar8) goto LAB_001758a8;
            }
            uVar8 = uVar8 + 1;
            sVar30 = (size_t)uVar8;
            (&local_20a8)[sVar23 * 2] = uVar25;
          ...
          if (pcVar12 != (char *)0x0) {
            ...
            if ((((iVar7 != 0) || (pcVar11 = strstr(pcVar16,"esp"), pcVar11 == (char *)0x0)) &&
              ...
              if (cVar3 == ']') {
                ...
                if (pcVar31 == local_20d8) goto LAB_0017530c;
              ...
              if (uVar27 != 0) {
                ...
                sVar23 = __nmemb;
                if (0x1ff < uVar27) goto LAB_0017530c;
              }
...
LAB_00175a48:
    ...
    if (uVar8 != 0) {
      plVar29 = plVar28;
      do {
        if ((*plVar29 == 0) && ((int)plVar29[4] == 1)) goto LAB_00175a8c;
        plVar29 = plVar29 + 6;
...
LAB_00175a8c:
      if (local_2138 < 2) goto LAB_0017669c;
      plVar29 = plVar28;
      if (uVar8 != 1) goto LAB_00175aa0;
      if (param_6 == (long *)0x0) goto LAB_001766dc;
      if (plVar28 != (long *)0x0) goto LAB_00175b2c;
      uVar25 = 1;
      goto LAB_00175c04;
    }
    uVar8 = 1;
...
LAB_0017669c:
    ...
    do {
      uVar8 = (uint)uVar25;
      if ((int)*plVar29 == 3) goto LAB_001766c8;
      plVar29 = plVar29 + 6;
    } while (plVar18 != plVar29);
    if (local_2108 <= uVar8) {
LAB_001766c8:
      if (uVar8 == 1) goto LAB_001766d0;
      goto LAB_00175ea8;
    }
