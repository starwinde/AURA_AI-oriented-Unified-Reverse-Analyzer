      ...
      if (uVar4 < 0x15) {
        if (uVar4 != 0x12) {
          ...
          if ((char)param_1[0x3a] != '\0') {
            uVar6 = __fprintf_chk(param_2,2,&DAT_001faf48,param_1 + 0x28);
            return uVar6;
          }
          uVar6 = __fprintf_chk(param_2,2,&DAT_001faf50,param_1 + 0x28);
          return uVar6;
        }
        param_3 = 0xd;
...
LAB_00180e68:
    ...
    if (uVar4 == 0xf) {
      ...
      if (uVar4 < 0x13) {
        ...
        if ((param_1[0x2a] - 0xf & 0xfffffffa) != 0) goto LAB_00180eb4;
        if (iVar5 < param_3) {
          fputc(0x28,param_2);
        }
        ...
        switch(param_1[0x2a]) {
        case 2:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f8270);
          break;
        case 3:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f8278);
          break;
        case 4:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f8280);
          break;
        case 5:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f8288);
          break;
        case 6:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f8290);
          break;
        case 7:
          __fprintf_chk(param_2,2,&DAT_001f8320,"|");
          break;
        case 8:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f8298);
          break;
        case 9:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f82a0);
          break;
        case 10:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f82a8);
          break;
        case 0xb:
          __fprintf_chk(param_2,2,&DAT_001f8320,"==");
          break;
        case 0xc:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f82b0);
          break;
        case 0xd:
        case 0xf:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f82b8);
          break;
        case 0xe:
        case 0x10:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f82c0);
          break;
        case 0x11:
        case 0x13:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f82c8);
          break;
        case 0x12:
        case 0x14:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001f82d0);
          break;
        default:
          __fprintf_chk(param_2,2,&DAT_001f8320,&DAT_001faf30);
        }
        fwrite("(uint64_t)(",1,0xb,param_2);
        emit_expr(*(undefined8 *)(param_1 + 0x28),param_2,0);
...
LAB_00180e2c:
    ...
    if (uVar4 != 0x10) {
      if (uVar4 == 0xd) {
        if ((s_emit_func == 0) || (*(uint *)(s_emit_func + 0xdd0) == 0)) goto LAB_00180d00;
        puVar14 = (uint *)(s_emit_func + 0x1d8);
        uVar4 = 0;
        break;
      }
      if (uVar4 != 0xe) goto LAB_00180e68;
      if ((char)param_1[0x2a] != '\0') {
        uVar6 = __fprintf_chk(*(undefined8 *)(param_1 + 0x28),param_2,2,&DAT_001fad68);
        return uVar6;
      }
      uVar6 = *(ulong *)(param_1 + 0x26);
      if (((long)uVar6 < 0) || ((long)uVar6 < 0x100 && (char)param_1[0x22] == '\0')) {
        uVar6 = __fprintf_chk(param_2,2,&DAT_001fad70);
        return uVar6;
      }
    ...
    if (uVar4 == 3) {
      ...
      if (piVar10 != (int *)0x0) {
        if (*piVar10 == 0xf) {
          ...
          __ptr = &DAT_001f8280;
          if ((*piVar10 != 0xe) || ((char)piVar10[0x2a] != '\0')) goto LAB_00180dbc;
          lVar8 = *(long *)(piVar10 + 0x26);
          lVar12 = -lVar8;
          if (-1 < lVar8) {
            lVar12 = lVar8;
...
LAB_00180d00:
    ...
    uVar6 = __fprintf_chk(param_2,2,&DAT_001f82e8,param_1[0x26]);
    return uVar6;
  }
  goto LAB_00180cd8;
LAB_00181594:
