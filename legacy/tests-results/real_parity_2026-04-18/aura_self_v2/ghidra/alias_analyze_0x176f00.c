...
LAB_00176fe8:
        ...
        puVar5 = __ptr_00;
        uVar26 = _DAT_00209ea0;
        uVar27 = _UNK_00209ea8;
        do {
          puVar9 = puVar5 + 4;
        ...
        if ((uVar1 & 3) != 0) goto LAB_00176fe8;
      }
              ...
              while( true ) {
                ...
                if (uVar11 < 2) {
                  ...
                  if ((uVar11 < uVar1) && (puVar10[7] - 4 < 2)) {
                    ...
                    uVar11 = puVar10[10];
                    uVar6 = (ulong)uVar11;
                    if ((uVar1 <= uVar11) || (1 < puVar10[0xb] - 4)) goto LAB_00177080;
                    uVar7 = __ptr_00[uVar15];
                    puVar16 = __ptr_00 + uVar15;
                    if (uVar14 != uVar7) {
                      do {
                  ...
                  if (uVar14 == uVar11) goto LAB_001770e8;
...
LAB_00177080:
                ...
                if (uVar7 <= uVar4) goto LAB_00177100;
              }
              if (uVar11 == 0x1b) {
...
LAB_001774a8:
                      ...
                      if (uVar8 < uVar11) {
                        *puVar17 = uVar7;
                        lVar19 = lVar19 + 1;
                        uVar11 = puVar10[0x18];
                        if (uVar11 <= (uint)lVar19) goto LAB_001770e8;
                        goto LAB_00177498;
                      }
                      if (uVar8 == uVar11) {
                        *puVar18 = uVar22;
...
LAB_001775e0:
            ...
            if (uVar4 == uVar7) goto LAB_001775e0;
          }
          uVar7 = uVar7 + 1;
          puVar5 = puVar5 + 1;
        } while (uVar1 != uVar7);
        *(int *)((long)__ptr + 0x14) = iVar13;
        aura_log(1,0,0,&DAT_001fab50,lVar25,(ulong)uVar1);
        puVar24 = __ptr;
      }
      goto LAB_0017718c;
    }
