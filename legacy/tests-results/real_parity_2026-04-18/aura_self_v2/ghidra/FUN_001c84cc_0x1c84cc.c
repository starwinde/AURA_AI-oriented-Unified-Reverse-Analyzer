...
void FUN_001c84cc(long param_1,undefined8 param_2,undefined8 param_3)
...
LAB_001c869c:
    ...
    SStream_concat(param_3,&DAT_001fd3e0,puVar7);
    iVar4 = uVar8 - 4;
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto joined_r0x001c8560;
  }
  else {
    SStream_concat(param_3,&DAT_001fd3e0,&DAT_001fcb88);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto joined_r0x001c8560;
    iVar4 = 1;
  }
  lVar6 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
