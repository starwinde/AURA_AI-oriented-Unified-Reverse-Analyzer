...

{
  ...
  uVar2 = (uint)param_4;
  if (uVar2 == 0) {
    cs_snprintf(auStack_68,0x20,&DAT_001fd3e8,uVar1,param_5,PTR___stack_chk_guard_005ffe88,0);
    if (uVar1 == 0x68) goto LAB_001c93ac;
    if (uVar1 < 0x69) {
      if (uVar1 == 0x62) goto LAB_001c93a4;
      if (uVar1 == 100) {
LAB_001c9300:
        uVar3 = 0xd;
        goto LAB_001c9308;
...
LAB_001c940c:
      ...
      if (uVar1 == 0x73) goto LAB_001c9364;
    }
  }
  else {
...
LAB_001c93a4:
      ...
      if (uVar1 == 100) {
        if (uVar2 == 1) goto LAB_001c9300;
        uVar3 = 0xc;
        if (uVar2 == 2) goto LAB_001c9308;
      }
    }
    else if (uVar1 == 0x71) {
      if (uVar2 == 1) goto LAB_001c940c;
    }
    else if (uVar1 == 0x73) {
      uVar3 = 10;
      if ((uVar2 == 2) || (uVar3 = 9, uVar2 == 4)) goto LAB_001c9308;
      if (uVar2 != 1) {
        uVar3 = 0;
        goto LAB_001c9308;
      }
