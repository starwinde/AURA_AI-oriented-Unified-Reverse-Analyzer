...
LAB_00162a0c:
  if ((*(byte *)(param_8 + uVar23) & 1) != 0) goto LAB_00162b34;
  lVar19 = *param_1;
  *(undefined1 *)(param_8 + uVar23) = 1;
  lVar25 = lVar19 + uVar23 * 0x48;
  ...
  if ((int)uVar7 < 0) {
    if (((*(byte *)(param_4 + uVar23) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
      ...
      piVar12 = (int *)0x0;
      if (uVar7 != 0) goto LAB_00162a94;
    }
  }
  else {
    piVar12 = (int *)(*(long *)(lVar25 + 8) + (long)(int)uVar7 * 0x88);
    do {
      if (*piVar12 - 0x17U < 2 || *piVar12 == 0x1a) goto LAB_00162a80;
...
LAB_00163f7c:
                ...
                uVar11 = uVar21;
                do {
                  uVar3 = *(uint *)(lVar19 + (ulong)uVar11 * 0x48 + 0x34);
                  uVar2 = uVar21;
                  uVar5 = uVar7;
...
joined_r0x00163fcc:
                uVar6 = uVar5;
                if (puVar13 != (uint *)0x0) goto LAB_0016382c;
              }
LAB_00163bf4:
              iVar8 = 4;
              do {
...
LAB_00163bb8:
              ...
              do {
                ...
                goto joined_r0x00163fcc;
                uVar11 = uVar3;
              } while (uVar3 != uVar20);
              uVar2 = uVar7;
              if (puVar13 == (uint *)0x0) goto LAB_00163bf4;
LAB_0016382c:
              if ((puVar13[6] != 3) || (iVar8 = 4, (puVar13[0x11] & 1) == 0)) goto LAB_00163bf4;
              do {
                fputc(0x20,param_9);
                iVar8 = iVar8 + -1;
              } while (iVar8 != 0);
              __fprintf_chk(param_9,2,"for (v%u = v%u; ",puVar13[8],puVar13[9]);
              __fprintf_chk(param_9,2,&DAT_001f82e8,puVar13[8]);
              uVar21 = puVar13[0x10];
              if (uVar21 == 0x10) {
LAB_001640a8:
                ...
                if (uVar21 != 0xd) {
                  if (uVar21 < 0xe) {
                    if (uVar21 == 0xb) {
                      ...
                      if (uVar21 != 0xc) goto LAB_001640fc;
                      fwrite(&DAT_001f83c8,1,4,param_9);
                    }
                    goto LAB_001638e0;
                  }
                  if (uVar21 == 0xe) goto LAB_001640a8;
                }
...
LAB_001640d8:
                ...
                if (uVar21 < 0x14) {
                  if (uVar21 == 0x11) goto LAB_001640d8;
                }
                else if (uVar21 != 0x14) {
LAB_001640fc:
...
LAB_001638e0:
            ...
            uVar21 = *(uint *)(param_1 + 1);
            if (param_3 == uVar6 || uVar21 <= uVar6) goto LAB_00162b34;
            uVar23 = (ulong)uVar6;
            goto LAB_00162a0c;
          }
          if (*piVar12 == 0x18) {
...
LAB_00163214:
            ...
            lVar19 = extraout_x12;
            uVar21 = extraout_w11;
            if (uVar7 < extraout_w11) goto LAB_00162dac;
          }
        }
      }
      else {
LAB_00162a94:
        ...
        uVar6 = 0;
        do {
          if (*puVar13 == uVar20) goto LAB_00162ac0;
          uVar6 = uVar6 + 1;
...
LAB_00162ac0:
        if (piVar12 != (int *)0x0) {
          if (*piVar12 == 0x17) {
            ...
            uVar7 = piVar12[0x1a];
            cf_emit_block_body_part_0_constprop_0_isra_0(lVar19,uVar23,param_9);
            if (puVar13 == (uint *)0x0) goto LAB_00163ef0;
            uVar6 = puVar13[5];
            uVar24 = *(uint *)(param_1 + 1);
            uVar2 = uVar21;
            if (uVar6 < uVar24) {
              ...
              if (uVar21 < uVar24) {
                lVar19 = *param_1;
                if (uVar21 != uVar20) goto LAB_00163f7c;
              }
...
LAB_00162dac:
            if (uVar7 != uVar20) {
              lVar19 = lVar19 + (ulong)uVar7 * 0x48;
    ...
    if (piVar14[4] != 0) {
      do {
        ...
        if ((*(byte *)(lVar25 + 0xc) & 1) == 0) {
          ...
          uVar21 = *(uint *)(param_1 + 1);
          uVar7 = *(uint *)(lVar25 + 8);
          if (uVar7 < uVar21) goto LAB_001636a0;
LAB_00163610:
          ...
          uVar21 = *(uint *)(param_1 + 1);
          uVar7 = *(uint *)(lVar25 + 8);
          if (uVar21 <= uVar7) goto LAB_00163610;
LAB_001636a0:
          pvVar15 = calloc((ulong)uVar21,1);
          if (pvVar15 == (void *)0x0) goto LAB_00163610;
          uVar6 = piVar14[8];
...
LAB_00163758:
    ...
    uVar21 = *(uint *)(param_1 + 1);
    uVar7 = piVar14[6];
    if (uVar7 < uVar21 && param_3 != uVar7) goto LAB_00163158;
    goto LAB_00162b34;
  }
...
LAB_0016311c:
  ...
  if (piVar12 == (int *)0x0) goto LAB_00162b34;
  iVar8 = *piVar12;
  if (iVar8 == 0x18) {
    uVar7 = piVar12[0x19];
    uVar21 = *(uint *)(param_1 + 1);
      ...
      if (piVar12[0x18] != 0) {
        do {
          ...
          while( true ) {
            ...
            lVar19 = lVar19 + 1;
            uVar21 = (uint)lVar19;
            if ((uint)piVar12[0x18] <= uVar21) goto LAB_001631e8;
          }
          __fprintf_chk(param_9,2,&DAT_001f82e8);
          lVar19 = lVar19 + 1;
...
LAB_001631e8:
  ...
  if (iVar8 != 0x17) goto LAB_00162b34;
  uVar21 = piVar12[0x19];
  uVar7 = piVar12[0x1a];
  if ((param_5 != (undefined8 *)0x0) && (param_3 < *(uint *)(param_1 + 1))) {
    ...
    if (iVar8 - 1U < 2) {
      ...
      if (1 < iVar9 - 1U) goto LAB_00162b98;
      iVar8 = 4;
      do {
        fputc(0x20,param_9);
        iVar8 = iVar8 + -1;
...
LAB_00163398:
    ...
    uVar20 = *(uint *)(param_1 + 1);
    if (uVar20 <= uVar6) goto LAB_00163398;
  }
  uVar22 = (ulong)uVar6;
  if (uVar7 == uVar6) {
    iVar8 = 4;
  ...
  uVar21 = *(uint *)(param_1 + 1);
  uVar23 = uVar22;
  if (uVar21 <= uVar6 || param_3 == uVar6) goto LAB_00162b34;
  goto LAB_00162a0c;
LAB_00163158:
  uVar23 = (ulong)uVar7;
  if ((*(byte *)(param_8 + (ulong)uVar7) & 1) != 0) goto LAB_00162b34;
  goto LAB_00162a0c;
}
