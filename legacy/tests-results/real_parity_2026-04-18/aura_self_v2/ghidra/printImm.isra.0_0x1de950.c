  ...
  if ((param_5 & 1) == 0) {
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_4 != 0x8000000000000000) {
          lVar1 = -param_4;
          if (-10 < (long)param_4) {
            SStream_concat(param_3,&DAT_001fb4a8,lVar1);
            return;
          }
          do {
            param_4 = param_4 >> 4;
      ...
      if ((long)param_4 < 10) goto LAB_001de988;
      if (param_4 < 0x10) goto LAB_001deadc;
      do {
        param_4 = param_4 >> 4;
      } while (0xf < param_4);
      goto joined_r0x001de9f8;
    }
    if ((long)param_4 < 0) {
      if (param_4 == 0x8000000000000000) {
      ...
      if (-10 < (long)param_4) {
        SStream_concat(param_3,&DAT_001fb4a8,-param_4);
        return;
      }
    ...
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_1 == '\0') {
LAB_001deaf4:
          if (param_4 != 0x8000000000000000) goto LAB_001deb08;
LAB_001deb44:
        ...
        if (param_1 == '\x02') {
          ...
          if (param_1 != '\x01') goto LAB_001deaf4;
...
joined_r0x001de9f8:
      if (param_4 < 10) {
        SStream_concat(param_3,&DAT_00201110);
        return;
      }
LAB_001deadc:
  ...
  if ((long)param_4 < 10) {
LAB_001de988:
    SStream_concat(param_3,&DAT_001f9200);
    return;
  }
LAB_001de978:
