...
int ZydisEmitEvex(undefined8 *param_1,undefined8 param_2)

{
  ...
  iVar3 = ZydisEmitByte(0x62,param_2);
  local_28 = iVar3;
  if ((((-1 < iVar3) && (iVar3 = ZydisEmitByte(local_2c,param_2), local_24 = iVar3, -1 < iVar3)) &&
      (iVar3 = ZydisEmitByte(local_2b,param_2), local_20 = iVar3, -1 < iVar3)) &&
     (local_1c = ZydisEmitByte(local_29,param_2), iVar3 = local_1c, -1 < local_1c)) {
    iVar3 = 0x100000;
  }
