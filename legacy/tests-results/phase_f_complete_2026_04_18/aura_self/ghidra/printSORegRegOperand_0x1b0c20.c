...

{
  ...
  if (uVar3 == 3) {
    SStream_concat0(param_3,&DAT_001fa838);
    goto LAB_001b0d10;
  }
  if ((uVar2 >> 2 & 1) == 0) {
    if (uVar3 == 1) {
      SStream_concat0(param_3,&DAT_001fa840);
      goto LAB_001b0d10;
    }
    if (uVar3 == 2) {
    ...
    if (uVar3 == 5) {
      SStream_concat0(param_3,&DAT_001fdf90);
      return;
    }
  }
  SStream_concat0(param_3,&DAT_001fe668);
LAB_001b0d10:
  SStream_concat0(param_3,&DAT_001fe588);
  lVar9 = *(long *)(param_1 + 800);
