...
LAB_00159958:
    ...
    *(uint *)((long)__ptr + (ulong)uVar4 * 4) = uVar4;
    ...
    puVar7 = __ptr;
    uVar33 = _DAT_0020c6c0;
    uVar34 = _UNK_0020c6c8;
    do {
      puVar20 = puVar7 + 2;
      puVar7[1] = uVar34;
      *puVar7 = uVar33;
...
LAB_0015a110:
              if (*(char *)((long)__ptr_03 + uVar15) == '\0') {
                ...
                if (iVar6 == 0) {
                  local_88[0] = s_result_001faa18[0];
                  local_88[1] = s_result_001faa18[1];
                  local_88[2] = s_result_001faa18[2];
                  local_88[3] = s_result_001faa18[3];
                  local_88[4] = s_result_001faa18[4];
                  local_88[5] = s_result_001faa18[5];
                  local_88[6] = s_result_001faa18[6];
                }
                else {
