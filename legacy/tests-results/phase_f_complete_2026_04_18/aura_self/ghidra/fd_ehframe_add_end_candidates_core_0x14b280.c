...
int fd_ehframe_add_end_candidates_core
              (long param_1,uint param_2,long param_3,ulong param_4,ulong param_5,long param_6,
              undefined4 param_7)

{
  ...
  if ((param_1 != 0 && param_2 != 0) &&
    ...
    if (__base != (void *)0x0) {
      ...
      qsort(__base,(ulong)param_2,8,u64_cmp);
      iVar12 = 0;
      lVar6 = disasm_init(param_7);
      uVar11 = 0;
      if (lVar6 == 0) {
        iVar12 = 0;
        free(__base);
...
LAB_0014b390:
          ...
          if (param_4 <= uVar1 && uVar1 < param_5) {
            ...
            if (((param_2 <= uVar5) || (uVar4 = *(ulong *)((long)__base + uVar7 * 8), uVar1 < uVar4)
              ...
              uStack_70 = 0;
              uStack_78 = 0;
              iVar2 = disasm_run(lVar6,param_6 + (uVar1 - param_4),uVar4,uVar1,&local_148,1);
              if (((0 < iVar2) && ((int)local_128 != 0x706f6e)) &&
                 (iVar2 = candidateset_add(param_3,uVar1,4,0xffffffe6,0), iVar2 != 0)) {
                iVar12 = iVar12 + 1;
              }
            }
            goto LAB_0014b390;
