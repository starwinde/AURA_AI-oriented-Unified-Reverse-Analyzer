...

{
  ...
  if ((param_5 & 1) == 0) {
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_4 != 0x8000000000000000) {
          lVar1 = -param_4;
          if (-10 < (long)param_4) {
            SStream_concat(param_3,&DAT_001fdd90,lVar1);
            return;
          }
          do {
            param_4 = param_4 >> 4;
    ...
    if ((long)param_4 < 0) {
      ...
      if (-10 < (long)param_4) {
        SStream_concat(param_3,&DAT_001fdd90,-param_4);
        return;
      }
...
joined_r0x001e1128:
      if (param_4 < 10) {
        SStream_concat(param_3,&DAT_00203928);
        return;
      }
LAB_001e120c:
  ...
  if ((long)param_4 < 10) {
LAB_001e10b8:
    SStream_concat(param_3,&DAT_001fba70);
    return;
  }
LAB_001e10a8:
