...
uint ZydisGetOperandSizeFromElementSize
               (undefined8 *param_1,ushort *param_2,ushort param_3,char param_4)

{
  ...
  if (((*(byte *)(param_1[2] + 4) & 0xe) == 8) && (*(int *)*param_1 == 0)) {
    ...
    uVar2 = ZydisGetMachineModeWidth(*(undefined4 *)*param_1);
    for (local_4 = 0; local_4 < 3; local_4 = local_4 + 1) {
      cVar1 = eosz_priority_lookup_64[(long)local_4 + (long)(int)((uVar2 & 0xff) >> 5) * 3];
      if (((cVar1 != -1) &&
