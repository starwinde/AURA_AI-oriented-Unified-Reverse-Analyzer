...
LAB_001801a0:
        ...
        uVar10 = build_expr(param_1,piVar13[6]);
LAB_001801b0:
          ...
          *(undefined4 *)((long)pvVar11 + 0xa4) = 8;
          ...
          if (pvVar12 != (void *)0x0) {
            ...
            if (uVar17 < uVar2 && uVar22 != uVar17) {
              ...
              emit_region(param_1,uVar17,uVar2,pvVar11);
              pvVar19 = (void *)param_1[6];
            ...
            if (pvVar11 != (void *)0x0) {
              ...
              *(undefined4 *)((long)pvVar11 + 0xa4) = 8;
              ...
              if (pvVar12 != (void *)0x0) {
                ...
                emit_region(param_1,uVar26,uVar17,pvVar11);
      ...
      if (puVar14 != (undefined4 *)0x0) {
        ...
        *puVar14 = 10;
        ...
        if (puVar15 != (undefined4 *)0x0) {
          *puVar15 = 0xd;
          puVar15[0x26] = uVar4;
          __snprintf_chk(puVar15 + 0x27,0x40,2,0x40,&DAT_001faae0);
        }
        uVar4 = *(undefined4 *)(lVar18 + 0x24);
        *(undefined4 **)(puVar14 + 0x26) = puVar15;
        uVar10 = build_expr(param_1,uVar4);
        ...
        if (puVar15 != (undefined4 *)0x0) {
          ...
          *puVar15 = 0xf;
          ...
          if (puVar16 != (undefined4 *)0x0) {
            *puVar16 = 0xd;
            puVar16[0x26] = uVar4;
            __snprintf_chk(puVar16 + 0x27,0x40,2,0x40,&DAT_001faae0);
          }
          uVar10 = *(undefined8 *)(lVar18 + 0x30);
          *(undefined4 **)(puVar15 + 0x26) = puVar16;
          uVar10 = hir_const_create(uVar10);
        ...
        if (pvVar11 != (void *)0x0) {
          ...
          *(undefined4 *)((long)pvVar11 + 0xa4) = 8;
          ...
          if (pvVar12 != (void *)0x0) {
            ...
            *(undefined1 *)(lVar18 + uVar25) = 1;
            emit_region(param_1,uVar17,uVar25,pvVar11);
            memcpy((void *)param_1[6],pvVar12,(ulong)*(uint *)(*param_1 + 8));
    ...
    if (pvVar11 != (void *)0x0) {
      ...
      *(undefined1 *)((long)pvVar12 + uVar25) = 1;
      if ((uVar26 < uVar17) && ((*(byte *)((long)pvVar12 + (ulong)uVar26) & 1) == 0)) {
        emit_region(param_1,uVar26,param_3,piVar13);
        pvVar12 = (void *)param_1[6];
        sVar27 = (size_t)*(uint *)(*param_1 + 8);
      }
