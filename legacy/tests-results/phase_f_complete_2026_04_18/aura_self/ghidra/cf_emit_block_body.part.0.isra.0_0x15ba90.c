...
LAB_0015bae0:
      ...
      if (uVar2 == 0x15) {
        if (puVar1[2] == 0xffffffff) {
          ...
          __fprintf_chk(param_3,2,&DAT_001faae0);
        }
        switch(puVar1[3]) {
        case 0:
          pcVar3 = "void";
        ...
        if (uVar2 != 0x19) {
          if (uVar2 == 0x1c) {
            if (2 < puVar1[0x12]) {
              ...
              fwrite(&DAT_001faae8,1,3,param_3);
              ...
              fwrite(&DAT_001fab10,1,3,param_3);
              ...
              fwrite(&DAT_001f9a40,1,3,param_3);
              uVar7 = puVar1[0xe];
              goto joined_r0x0015be10;
            }
          }
        ...
        if (puVar1[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              fwrite("__undef",1,7,param_3);
              uVar7 = (uint)lVar8;
              if (puVar1[0x18] <= uVar7) goto LAB_0015beb8;
            }
            __fprintf_chk(param_3,2,&DAT_001faae0);
            lVar8 = lVar8 + 1;
...
LAB_0015beb8:
        fwrite(&DAT_001fab60,1,3,param_3);
        uVar7 = *(uint *)(param_1 + 0x10);
        goto LAB_0015bae0;
      }
      if (uVar2 == 1) {
      ...
      if (uVar2 < 2) {
        if (puVar1[0x12] == 0) goto LAB_0015bb5c;
        if (puVar1[2] == 0xffffffff) {
          fwrite("__undef",1,7,param_3);
        }
        else {
