        ...
        if ((param_5 == (undefined8 *)0x0) || (uVar5 = *(uint *)(param_5 + 1), uVar5 == 0)) {
          if (piVar23 != (int *)0x0) {
            if (*piVar23 == 0x17) {
              ...
              uVar16 = piVar23[0x1a];
              cf_emit_block_body_part_0_isra_0(lVar15,local_c8,param_9,2);
LAB_001639cc:
...
LAB_001625dc:
                ...
                uVar16 = *(uint *)(param_1 + 1);
                if (uVar18 < uVar16) {
                  cf_emit_block_body_part_0_isra_0(*param_1,local_c8,param_9,3);
                  uVar16 = *(uint *)(param_1 + 1);
                }
                uVar18 = piVar23[0x19];
                ...
                if (uVar5 < uVar16) {
                  cf_emit_block_body_part_0_isra_0(*param_1,uVar5,param_9,3);
                }
                iVar6 = 8;
                do {
                  fputc(0x20,param_9);
...
LAB_00163010:
            emit_region(param_1,uVar5,param_3,param_4,param_5,param_6,param_7,pvVar12,param_9,4);
            free(pvVar12);
            bVar2 = *(byte *)(lVar21 + 0xd);
          }
          if ((bVar2 & 1) == 0) {
...
joined_r0x00162bc4:
        if ((bVar2 & 1) == 0) {
          emit_region(param_1,uVar5,param_3,param_4,param_5,param_6,param_7,param_8,param_9,2);
        }
      }
    }
  }
