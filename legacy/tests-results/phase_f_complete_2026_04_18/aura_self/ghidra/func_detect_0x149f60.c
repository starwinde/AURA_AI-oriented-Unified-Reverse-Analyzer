...
LAB_0014a234:
      ...
      fd_ehframe_add_candidates(param_3,local_d0,uVar30,lVar31);
      if ((*(int *)(param_3 + 0xc) == 4) && (*(uint *)(param_3 + 0x20) != 0)) {
        ...
        do {
          if (((char *)*puVar8 != (char *)0x0) &&
            ...
            if (puVar8[5] != 0) {
              fd_ehframe_add_end_candidates(param_3,local_d0,uVar30,lVar31,puVar8[5],4);
            }
            break;
          }
          puVar8 = puVar8 + 7;
      ...
      fd_datascan_add_candidates(param_3,local_d0,uVar30,lVar31,*(undefined4 *)(param_3 + 0xc),0);
