...
uint fd_plt_add_candidates(long param_1,long param_2)

{
  ...
  if ((param_1 != 0 && param_2 != 0) && (*(long *)(param_1 + 8) == 0x400000001)) {
    ...
    lVar3 = analyzer_registry_get("aarch64_plt_thunks");
    if (((lVar3 != 0) && (*(code **)(lVar3 + 0x28) != (code *)0x0)) &&
      ...
      if (iVar2 == 0) {
        if (local_58 != (long *)0x0) {
          ...
          if ((int)local_58[1] != 0) {
            do {
              iVar2 = candidateset_add(param_2,*(undefined8 *)(*plVar1 + lVar5),7,0xffffffaf,0);
              if (iVar2 == 0) break;
              uVar4 = uVar4 + 1;
              lVar5 = lVar5 + 0x18;
