    ...
    if (uVar2 < 0x12) {
      if (uVar2 == 0xe) {
        if ((char)param_1[0x2a] == '\0') {
          sVar4 = __fprintf_chk(param_2,2,&DAT_001fd658,*(undefined8 *)(param_1 + 0x26));
          return sVar4;
        }
        sVar4 = __fprintf_chk(*(undefined8 *)(param_1 + 0x28),param_2,2,&DAT_001fd650);
        return sVar4;
      }
      if (uVar2 < 0xf) {
        if (uVar2 != 0xc) {
...
LAB_00181b9c:
          ...
          sVar4 = __fprintf_chk(param_2,2,&DAT_001fd678,uVar6);
          return sVar4;
        }
        goto LAB_00181aa8;
      }
      if (uVar2 == 0xf) {
        ...
        __fprintf_chk(param_2,2,&DAT_001fab18,pcVar7);
...
LAB_00181a30:
    ...
    if (uVar2 != 0x12) {
      ...
      sVar4 = __fprintf_chk(param_2,2,&DAT_001fd670,puVar3,param_1 + 0x28);
      return sVar4;
    }
