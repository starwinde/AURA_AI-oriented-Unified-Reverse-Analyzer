...
LAB_00192f50:
            ...
            if ((((((uVar1 != 1) &&
                ...
                ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0x5f)),_DAT_0020c700
                         ), uVar1 != 6 &&
               ...
               ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0x8f)),_DAT_0020c700)
                , uVar1 != 9 &&
              ...
              a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0xef)),_DAT_0020c700);
            }
            uVar9 = uVar7 & 0xf0;
            if ((uVar7 & 0xf) != 0) {
              uVar7 = uVar18 - uVar9;
...
LAB_00192a8c:
    ...
    if (uVar20 != 0) {
      ...
      if ((iVar6 == 0) && (iVar6 = MCOperand_getReg(uVar10), iVar6 == 0)) {
        if ((long)uVar20 < 0) {
          ...
          SStream_concat(param_3,&DAT_001fba70,uVar20);
        }
        else {
  ...
  if ((iVar6 == 0) && (iVar6 = MCOperand_getReg(uVar10), iVar6 == 0)) {
    if (uVar20 == 0) {
      SStream_concat0(param_3,&DAT_001ffe38);
    }
  }
  else {
    ...
    if ((iVar6 != 0) && (iVar6 = MCOperand_getReg(uVar11), iVar6 != 0x1e)) {
      ...
      if (lVar16 != 1) {
        SStream_concat(param_3,&DAT_001fde38);
      }
    }
    SStream_concat0(param_3,")");
  }
