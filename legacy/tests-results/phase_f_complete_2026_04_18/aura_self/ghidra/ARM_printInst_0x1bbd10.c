...

{
  ...
  if (uVar7 == 0x370) {
    ...
    if (iVar8 == 0xc) {
      ...
      if (lVar12 == -4) {
        SStream_concat0(param_2,&DAT_001fa120);
        MCInst_setOpcodePub(param_1,0x80);
        printPredicateOperand(param_1,4,param_2);
        SStream_concat0(param_2,&DAT_001fe748);
...
LAB_001bc9ec:
        ...
        if (lVar12 == 0) {
          SStream_concat0(param_2,&DAT_001f96d0,0);
          return;
        }
        goto LAB_001bd9e4;
      }
...
LAB_001bc204:
        ...
        iVar8 = MCOperand_getReg();
        if (iVar8 == 0xc) {
          SStream_concat0(param_2,&DAT_001fe758);
          uVar18 = 0x18a;
          goto LAB_001bc920;
        }
      }
...
LAB_001bc6dc:
          ...
          if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
            SStream_concat0(param_2,&DAT_001fa128);
            MCInst_setOpcodePub(param_1,0x7f);
            printPredicateOperand(param_1,2,param_2);
            if (uVar7 == 0xb17) {
              SStream_concat0(param_2,&DAT_001fe698);
            }
            SStream_concat0(param_2,&DAT_001fe368);
...
joined_r0x001bbdf4:
        ...
        SStream_concat0(param_2,&DAT_001fe760);
...
LAB_001bca38:
      ...
      if (uVar7 == 0x2b1) {
        ...
        uVar7 = uVar9 & 7;
        if (uVar7 == 3) {
          SStream_concat0(param_2,&DAT_001fa838);
          MCInst_setOpcodePub(param_1,99);
        }
        else if ((uVar9 >> 2 & 1) == 0) {
          if (uVar7 == 1) {
            SStream_concat0(param_2,&DAT_001fa840);
            MCInst_setOpcodePub(param_1,10);
          }
          else {
            if (uVar7 != 2) goto LAB_001bd6b4;
            SStream_concat0(param_2,&DAT_001fa830);
          ...
          SStream_concat0(param_2,&DAT_001fdf90);
          MCInst_setOpcodePub(param_1,0x94);
        }
        else {
LAB_001bd6b4:
          SStream_concat0(param_2,&DAT_001fe668);
        }
