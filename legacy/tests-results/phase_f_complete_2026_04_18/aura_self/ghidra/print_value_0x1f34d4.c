  ...
  if (bVar2 < 0x11) {
    ...
    if (bVar2 < 5) {
      if (bVar2 == 1) {
        ...
        uVar3 = s_false_00203aa0._4_2_;
        if (pcVar11 == (char *)0x0) goto LAB_001f359c;
        *(undefined4 *)pcVar11 = s_false_00203aa0._0_4_;
        *(undefined2 *)(pcVar11 + 4) = uVar3;
      }
      else {
        if ((bVar2 != 2) ||
           (puVar8 = (undefined4 *)ensure(param_2,5), uVar4 = DAT_00203ab4,
...
LAB_001f3564:
      ...
      if ((NAN(dVar21)) || (dVar22 = ABS(dVar21), 1.79769313486232e+308 < dVar22)) {
        uVar6 = 4;
        local_90 = (ulong)CONCAT14(DAT_0020c51c,DAT_0020c518);
LAB_001f362c:
...
LAB_001f3a2c:
        ...
        iVar7 = __isoc99_sscanf(&local_90,&DAT_0020c528,&local_98);
        if (iVar7 == 1) {
...
LAB_001f3ba4:
    ...
    if (bVar2 == 0x40) {
      ...
      *puVar12 = 0x5b;
      lVar17 = _DAT_0020c6f0;
      lVar15 = param_2[2] + _DAT_0020c6f0;
      param_2[3] = param_2[3] + _UNK_0020c6f8;
      param_2[2] = lVar15;
