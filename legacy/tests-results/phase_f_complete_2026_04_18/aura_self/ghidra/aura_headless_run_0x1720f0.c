      ...
      do {
        ...
        while( true ) {
          if (lVar1 != 0) {
            ...
            uVar22 = uVar22 + 1;
            lVar20 = lVar20 + 0x38;
            if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_00172fbc;
            goto LAB_00172f68;
          }
          __fprintf_chk(param_3,2,"| %u | `%s` | `0x%lx` | %lu | %s |\n",uVar22,&DAT_001fe668,lVar18
                        ,plVar21[3],&local_78);
          uVar22 = uVar22 + 1;
          lVar20 = lVar20 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_00172fbc;
...
LAB_00173290:
          uStack_70 = 0;
          __strcat_chk(&local_78,&DAT_001fcd98,0x10);
          if ((*(uint *)(plVar21 + 6) >> 2 & 1) == 0) break;
LAB_001732a8:
          __strcat_chk(&local_78,&DAT_001fcda0,0x10);
          lVar1 = *plVar21;
          lVar18 = plVar21[1];
        }
      } while( true );
...
LAB_00172fbc:
    ...
    if (uVar2 != 0) {
      do {
        ...
        bVar4 = false;
        while( true ) {
          puVar15 = &DAT_001fc9d0;
          if (!bVar6) {
            if (uVar2 < 3 || bVar4) {
              if (uVar2 == 1) {
                puVar15 = &DAT_001f9570;
              }
              else {
                puVar15 = &DAT_001faad0;
                if (uVar2 == 2) {
                  puVar15 = &DAT_001fc9c8;
                }
              }
            }
            else {
...
LAB_0017314c:
      ...
      if ((plVar21 == (long *)0x0) || ((int)plVar21[1] == 0)) goto LAB_00173160;
    ...
    do {
      if (((char *)*puVar17 != (char *)0x0) &&
         (iVar7 = strcmp((char *)*puVar17,".text"), iVar7 == 0)) goto LAB_001721e8;
      puVar17 = puVar17 + 7;
    } while (puVar19 + (ulong)uVar22 * 7 != puVar17);
    uVar8 = *(uint *)(puVar19 + 6);
    puVar17 = puVar19;
    while ((uVar8 >> 2 & 1) == 0) {
      if (puVar19 + (ulong)uVar22 * 7 == puVar17 + 7) goto LAB_001721f8;
      uVar8 = *(uint *)(puVar17 + 0xd);
      puVar17 = puVar17 + 7;
    }
LAB_001721e8:
    if (((puVar17[5] == 0) || (puVar17[4] == 0)) ||
       (lVar20 = disasm_init(*(undefined4 *)(lVar9 + 0xc)), lVar20 == 0)) goto LAB_001721f8;
...
LAB_0017220c:
    ...
    fwrite(&DAT_001fa5e0,1,2,param_3);
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fca38,param_1);
    fwrite(&DAT_001fca50,1,2,param_3);
    fwrite(&DAT_001fa5e0,1,2,param_3);
    uVar22 = *(uint *)(lVar9 + 8);
    if (uVar22 == 3) {
      pcVar12 = "Mach-O";
    ...
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fca60,pcVar12);
    fwrite(&DAT_001fca50,1,2,param_3);
    fwrite(&DAT_001fa5e0,1,2,param_3);
    ...
    if (*(int *)(lVar9 + 0x20) != 0) {
      ...
      do {
        while( true ) {
          ...
          puVar13 = &DAT_001fe668;
          if (puVar14 != (undefined1 *)0x0) {
            puVar13 = puVar14;
          }
          uVar22 = uVar22 + 1;
          __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fc1e0,puVar13);
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","vaddr",*(undefined8 *)(lVar1 + 8));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fc1f8,*(undefined8 *)(lVar1 + 0x18));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"flags\": %u",*(undefined4 *)(lVar1 + 0x30));
          if (*(uint *)(lVar9 + 0x20) <= uVar22) break;
          __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001f95e8);
          lVar20 = lVar20 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_00172568;
        }
        lVar20 = lVar20 + 0x38;
        __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001fe668);
    ...
    if (*(int *)(lVar9 + 0x30) != 0) {
      ...
      do {
        while( true ) {
          ...
          lVar20 = lVar20 + 0x28;
          __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001fe668);
          if (*(uint *)(lVar9 + 0x30) <= uVar22) goto LAB_00172710;
        }
        __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001f95e8);
        lVar20 = lVar20 + 0x28;
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            lVar1 = lVar18 + lVar20;
            fwrite("    {",1,5,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fc1e0,lVar1 + 0x14);
            fwrite(", ",1,2,param_3);
            uVar22 = uVar22 + 1;
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","start",*(undefined8 *)(lVar18 + lVar20));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fcb38,*(undefined8 *)(lVar1 + 8));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fc1f8,*(undefined4 *)(lVar1 + 0x10));
            if (uVar22 < *(uint *)(plVar21 + 1)) break;
            lVar20 = lVar20 + 0x98;
            __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001fe668);
            if (*(uint *)(plVar21 + 1) <= uVar22) goto LAB_001728e4;
          }
          __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001f95e8);
          lVar20 = lVar20 + 0x98;
        } while (uVar22 < *(uint *)(plVar21 + 1));
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fcb68,*(undefined8 *)(lVar1 + 0x10))
            ;
            if (uVar22 < *(uint *)(plVar21 + 1)) break;
            __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001fe668);
            lVar20 = lVar20 + 0x18;
            if (*(uint *)(plVar21 + 1) <= uVar22) goto LAB_00172ac0;
          }
          __fprintf_chk(param_3,2,&DAT_001fcaf8,&DAT_001f95e8);
          lVar20 = lVar20 + 0x18;
        } while (uVar22 < *(uint *)(plVar21 + 1));
...
LAB_00172ac0:
    fwrite("  ],\n",1,5,param_3);
    fwrite("  \"stats\": {\n",1,0xd,param_3);
    fwrite(&DAT_001fcb80,1,4,param_3);
...
LAB_001733f4:
    ...
    fputc(10,param_3);
    fwrite(&DAT_001fcbd0,1,4,param_3);
    fwrite(&DAT_001fa020,1,2,param_3);
  }
