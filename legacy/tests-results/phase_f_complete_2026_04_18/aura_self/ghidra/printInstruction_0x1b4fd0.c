...

{
  ...
  SStream_concat0(param_2,(uVar11 & 0xfff) + 0x2449cf);
    ...
    if ((uVar5 != 0) &&
      ...
      do {
        if (((uVar5 >> (ulong)(uVar22 & 0x1f) ^ uVar6) & 1) == 0) {
          SStream_concat0(param_2,&DAT_00202578);
        }
        else {
  ...
  case 0xd:
    ...
    SStream_concat(param_2,&DAT_001fe248,uVar4);
  ...
  case 0xe:
    ...
    if (iVar7 == 2) {
      puVar18 = &DAT_001fe230;
    }
    else {
      puVar18 = &DAT_001fe238;
      if (iVar7 != 3) {
        puVar18 = &DAT_001fe668;
      }
    }
  ...
  case 0x11:
    ...
    uVar4 = MCOperand_getImm();
    SStream_concat(param_2,&DAT_001fdfe8,uVar4);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      lVar17 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
      bVar1 = *(byte *)(lVar17 + 0x80);
      lVar13 = lVar17 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10;
  ...
  case 0x15:
    ...
    if (lVar13 == 0) {
      ...
      *(undefined8 *)(lVar13 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x94) = DAT_0020c5c0;
    ...
    lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
    bVar1 = *(byte *)(lVar13 + 0x80);
    *(undefined8 *)(lVar13 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x94) = DAT_0020c5b8;
    *(byte *)(lVar13 + 0x80) = bVar1 + 1;
    return;
  case 0x16:
...
switchD_001b5298_default:
    SStream_concat0(param_2,&DAT_001fe588);
    goto LAB_001b50e0;
  }
  switch(uVar12 & 0xffffffff) {
  case 0:
    SStream_concat0(param_2,&DAT_001fe258);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b6d30;
  case 1:
    SStream_concat0(param_2,&DAT_001fe260);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b6d10;
  case 2:
    SStream_concat0(param_2,&DAT_001fe268);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
  ...
  case 5:
    goto switchD_001b5064_default;
  case 6:
    SStream_concat0(param_2,&DAT_001fe270);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
    lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
...
LAB_001b5d68:
  ...
  case 0x10:
    ...
    goto LAB_001b52c8;
  case 0x11:
    SStream_concat0(param_2,&DAT_001fe2c0);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x13:
    ...
    goto LAB_001b52c8;
  case 0x14:
    SStream_concat0(param_2,&DAT_001fe2d8);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
LAB_001b5f9c:
    ...
    return;
  case 0x1f:
    SStream_concat0(param_2,&DAT_001fe360);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x26:
    ...
    break;
  case 0x27:
    SStream_concat0(param_2,&DAT_001fe3e0);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
joined_r0x001b6d10:
    ...
    goto LAB_001b50e0;
  case 0x2b:
    SStream_concat0(param_2,&DAT_001fe408);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
joined_r0x001b6cf0:
    if (iVar7 != 0) {
  ...
  case 0x30:
    ...
    goto LAB_001b62f4;
  case 0x31:
    SStream_concat0(param_2,&DAT_001fe460);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
switchD_001b5298_caseD_4:
  ...
  case 0x34:
    ...
    if (uVar11 < 10) {
      SStream_concat(param_2,&DAT_001fdfe0,uVar11);
    }
    else {
...
LAB_001b5e5c:
  ...
  case 0x43:
    ...
    break;
  case 0x44:
    SStream_concat0(param_2,&DAT_001fe568);
    goto LAB_001b50e0;
  case 0x45:
...
LAB_001b6314:
    ...
    return;
  case 0x47:
    SStream_concat0(param_2,&DAT_001fe580);
    printOperand(param_1,0,param_2);
    return;
  case 0x48:
    printPredicateOperand(param_1,4,param_2);
...
switchD_001b5300_default:
  ...
  case 1:
    ...
    SStream_concat0(param_2,&DAT_001fe590);
    lVar13 = *(long *)(param_1 + 800);
    MCInst_getOperand(param_1,0);
    iVar7 = MCOperand_getReg();
...
LAB_001b77a8:
    SStream_concat0(param_2,&DAT_001fe598);
...
LAB_001b7b20:
  ...
  case 0xd:
    ...
    if ((uVar5 >> 2 & 1) == 0) {
      ...
      if (uVar5 == 0) {
        uVar5 = 0x10;
        SStream_concat0(param_2,&DAT_001fe5a0);
      }
    }
    else {
      SStream_concat0(param_2,&DAT_002066b0);
      if ((uVar5 >> 1 & 1) != 0) {
LAB_001ba138:
      ...
      if ((uVar5 & 1) != 0) {
LAB_001b6f04:
        SStream_concat0(param_2,&DAT_001fe228);
      }
    }
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
LAB_001ba0e8:
    ...
    SStream_concat(param_2,&DAT_001fdd70,uVar12);
LAB_001b7388:
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
...
switchD_001b5064_caseD_13:
  ...
  case 0x37:
    ...
    SStream_concat0(param_2,&DAT_001fe5b0);
    lVar13 = *(long *)(param_1 + 800);
    ...
    *(undefined8 *)(lVar17 + 0x8c) = DAT_0020c5c8;
...
LAB_001b5108:
  ...
  case 4:
    ...
    SStream_concat((double)(float)((uVar10 >> 4 & 3) << 0x17 | (uVar10 & 0xf) << 0x13 |
                                  uVar5 | uVar11),param_2,&DAT_001fe5c0);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
  ...
  case 6:
    ...
    uVar11 = MCOperand_getImm();
    if (uVar11 < 10) {
      SStream_concat(param_2,&DAT_001fe118,uVar11);
    }
    else {
      SStream_concat(param_2,"{0x%x}",uVar11);
    }
...
LAB_001b9734:
          ...
          SStream_concat(param_2,&DAT_001fdfa8,puVar18,uVar5);
        }
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
          lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
          if (uVar10 == 0) {
...
LAB_001b9770:
      ...
      case 0x30:
        ...
        return;
      case 0x31:
        SStream_concat0(param_2,&DAT_001fe648);
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
          return;
        }
...
switchD_001b9ce0_caseD_1:
      ...
      case 0x14:
        ...
        return;
      case 0x15:
        SStream_concat0(param_2,&DAT_001fe658);
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
          return;
        }
