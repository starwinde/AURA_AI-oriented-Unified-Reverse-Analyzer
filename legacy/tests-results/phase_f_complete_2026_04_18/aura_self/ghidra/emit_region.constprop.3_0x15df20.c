        ...
        if ((param_5 == (undefined8 *)0x0) || (uVar5 = *(uint *)(param_5 + 1), uVar5 == 0)) {
          if (piVar23 != (int *)0x0) {
            if (*piVar23 == 0x17) {
              ...
              uVar16 = piVar23[0x1a];
              cf_emit_block_body_part_0_isra_0(lVar15,local_c8,param_9,4);
LAB_0015fa2c:
...
LAB_0015f694:
                ...
                if (piVar23[0x12] == 0) {
                  fwrite(&DAT_001faa38,1,4,param_9);
                }
                else if (piVar23[6] == -1) {
                  fwrite("__undef",1,7,param_9);
                }
                else {
                  __fprintf_chk(param_9,2,&DAT_001faae0);
                }
                fwrite(&DAT_001fabf0,1,4,param_9);
              }
              else {
                if ((uVar19 <= uVar16) ||
...
LAB_0015f15c:
                ...
                __fprintf_chk(param_9,2,&DAT_001faae0,puVar10[8]);
                uVar16 = puVar10[0x10];
                if (uVar16 == 0x10) {
LAB_0015fbec:
                  ...
                  if (uVar16 != 0xd) {
                    if (uVar16 < 0xe) {
                      if (uVar16 == 0xb) {
                        ...
                        fwrite(&DAT_001fabc0,1,4,param_9);
                      }
                      goto LAB_0015f214;
                    }
...
LAB_0015fc08:
                  fwrite(&DAT_001fabb0,1,3,param_9);
                }
                else {
                  if (uVar16 < 0x14) {
...
LAB_0015fe1c:
                    fwrite(&DAT_001fab10,1,3,param_9);
                    goto LAB_0015f214;
                  }
...
LAB_0015f214:
                ...
                __fprintf_chk(param_9,2,&DAT_001faae0,puVar10[8]);
                if (puVar10[0xe] == 2) {
                  fwrite(&DAT_001fabd8,1,4,param_9);
                }
                else {
              ...
              if (pvVar12 != (void *)0x0) {
                *(undefined1 *)((long)pvVar12 + local_c8) = 1;
                emit_region(param_1,uVar17,local_c8,param_4,param_5,param_6,param_7,pvVar12,param_9,
                            5);
                free(pvVar12);
              }
              iVar6 = 0x10;
              ...
              fwrite(&DAT_001fa020,1,2,param_9);
              uVar16 = *(uint *)(param_1 + 1);
...
LAB_0015e61c:
                ...
                uVar16 = *(uint *)(param_1 + 1);
                if (uVar18 < uVar16) {
                  cf_emit_block_body_part_0_isra_0(*param_1,local_c8,param_9,5);
                  uVar16 = *(uint *)(param_1 + 1);
                }
                uVar18 = piVar23[0x19];
                if ((uVar18 != uVar5) && (pvVar12 = calloc((ulong)uVar16,1), pvVar12 != (void *)0x0)
                  ...
                  *(undefined1 *)((long)pvVar12 + local_c8) = 1;
                  emit_region(param_1,uVar18,uVar5,param_4,param_5,param_6,param_7,pvVar12,param_9,5
                             );
                  free(pvVar12);
                  uVar16 = *(uint *)(param_1 + 1);
                }
                if (uVar5 < uVar16) {
                  cf_emit_block_body_part_0_isra_0(*param_1,uVar5,param_9,5);
                }
                iVar6 = 0x10;
                do {
                  fputc(0x20,param_9);
                ...
                fwrite(&DAT_001fab60,1,3,param_9);
                uVar16 = *(uint *)(param_1 + 1);
                if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_0015e0d0;
                local_c8 = (ulong)uVar4;
                goto LAB_0015df90;
...
LAB_0015f060:
            emit_region(param_1,uVar5,param_3,param_4,param_5,param_6,param_7,pvVar12,param_9,6);
            free(pvVar12);
            bVar2 = *(byte *)(lVar21 + 0xd);
          }
          if ((bVar2 & 1) == 0) {
...
LAB_0015ec80:
        ...
        fwrite(&DAT_001fac90,1,4,param_9);
        if (piVar23[0x12] == 0) {
          fwrite(&DAT_001faa38,1,4,param_9);
        }
        else if (piVar23[6] == -1) {
...
LAB_0015e14c:
      ...
      if (uVar5 == uVar4) {
        ...
        if (pvVar12 != (void *)0x0) {
          *(undefined1 *)((long)pvVar12 + local_c8) = 1;
          emit_region(param_1,uVar16,uVar20,param_4,param_5,param_6,param_7,pvVar12,param_9,5);
...
LAB_0015f4b0:
                  ...
                  fwrite(&DAT_001faae8,1,3,param_9);
...
LAB_0015f464:
        ...
        if (uVar16 == uVar4) {
          ...
          if (pvVar12 != (void *)0x0) {
            *(undefined1 *)((long)pvVar12 + local_c8) = 1;
            emit_region(param_1,uVar5,uVar20,param_4,param_5,param_6,param_7,pvVar12,param_9,5);
            if (uVar4 < *(uint *)(param_1 + 1)) {
              lVar15 = *param_1 + uVar20 * 0x50;
...
joined_r0x0015ec14:
        if ((bVar2 & 1) == 0) {
          emit_region(param_1,uVar5,param_3,param_4,param_5,param_6,param_7,param_8,param_9,4);
        }
      }
    }
  }
