      ...
      if (uVar4 < 0x15) {
        if (uVar4 != 0x12) {
          ...
          if ((char)param_1[0x3a] != '\0') {
            uVar6 = __fprintf_chk(param_2,2,&DAT_001fd830,param_1 + 0x28);
            return uVar6;
          }
          uVar6 = __fprintf_chk(param_2,2,&DAT_001fd838,param_1 + 0x28);
          return uVar6;
        }
        param_3 = 0xd;
        __fprintf_chk(param_2,2,&DAT_001fd668,param_1 + 0x28);
...
LAB_00183598:
        ...
        if (3 < param_3) {
          ...
          fwrite(&DAT_001fab10,1,3,param_2);
          emit_expr(*(undefined8 *)(param_1 + 0x28),param_2,3);
          fwrite(&DAT_001f9a40,1,3,param_2);
    ...
    if (uVar4 == 0xf) {
      ...
      if (uVar4 < 0x13) {
        ...
        switch(param_1[0x2a]) {
        case 2:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faa68);
          break;
        case 3:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faa70);
          break;
        case 4:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faa78);
          break;
        case 5:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faa80);
          break;
        case 6:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faa88);
          break;
        case 7:
          __fprintf_chk(param_2,2,&DAT_001fab18,"|");
          break;
        case 8:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faa90);
          break;
        case 9:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faa98);
          break;
        case 10:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faaa0);
          break;
        case 0xb:
          __fprintf_chk(param_2,2,&DAT_001fab18,"==");
          break;
        case 0xc:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faaa8);
          break;
        case 0xd:
        case 0xf:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faab0);
          break;
        case 0xe:
        case 0x10:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faab8);
          break;
        case 0x11:
        case 0x13:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faac0);
          break;
        case 0x12:
        case 0x14:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001faac8);
          break;
        default:
          __fprintf_chk(param_2,2,&DAT_001fab18,&DAT_001fd818);
        }
        fwrite("(uint64_t)(",1,0xb,param_2);
        emit_expr(*(undefined8 *)(param_1 + 0x28),param_2,0);
...
LAB_0018355c:
    ...
    if (uVar4 != 0x10) {
      if (uVar4 == 0xd) {
        if ((s_emit_func == 0) || (*(uint *)(s_emit_func + 0xdd0) == 0)) goto LAB_00183430;
      ...
      if ((char)param_1[0x2a] != '\0') {
        uVar6 = __fprintf_chk(*(undefined8 *)(param_1 + 0x28),param_2,2,&DAT_001fd650);
        return uVar6;
      }
      uVar6 = *(ulong *)(param_1 + 0x26);
      if (((long)uVar6 < 0) || ((long)uVar6 < 0x100 && (char)param_1[0x22] == '\0')) {
        uVar6 = __fprintf_chk(param_2,2,&DAT_001fd658);
        return uVar6;
      }
...
LAB_00183430:
    ...
    uVar6 = __fprintf_chk(param_2,2,&DAT_001faae0,param_1[0x26]);
    return uVar6;
  }
  goto LAB_00183408;
LAB_00183cc4:
