...
LAB_001da8cc:
        ...
        SStream_concat(param_2,&DAT_001ffc48,
    ...
    if ((((uVar24 & 1) != 0) && (lVar18 = MCOperand_getImm(uVar16), lVar18 == 0)) &&
      ...
      if (lVar18 == 0xf) {
        if (uVar12 < 2) {
          ...
          puVar28 = &DAT_001ff480;
        }
        goto LAB_001d99d0;
      }
      if (lVar18 == 0x1f) {
        if ((bVar7 || bVar6) && bVar8) {
          puVar28 = &DAT_001ffc28;
          goto LAB_001d99d0;
        }
      }
      else if (lVar18 == 7) {
        if (uVar12 < 2) {
          puVar28 = &DAT_001ff330;
        }
        else {
          if (bVar7 || bVar6) goto LAB_001d8ef0;
          puVar28 = &DAT_001ff470;
        }
LAB_001d99d0:
...
LAB_001d8efc:
      ...
      if (lVar27 < lVar18) {
        ...
        puVar28 = &DAT_001ff398;
        if (uVar12 < 2) {
          puVar28 = &DAT_001ff018;
        }
        iVar9 = MCOperand_getReg(uVar25);
        uVar4 = *(ushort *)(RegAsmOffsetNoRegAltName_12 + (ulong)(iVar9 - 1) * 2);
        iVar9 = MCOperand_getReg(uVar19);
      ...
      if (bVar8 || iVar13 == 0x1f) {
        if (iVar13 == 0x3f || !bVar6) {
          local_b8 = &DAT_001fa838;
          if (((bVar8 || iVar13 != 0x1f) && (iVar13 != 0x3f || !bVar6)) &&
             (local_b8 = &DAT_001fa840, iVar9 != 0xfd9 || iVar13 != 0x1f)) {
LAB_001dadfc:
            if (!bVar7 || iVar13 != 0x3f) goto LAB_001d8efc;
LAB_001da488:
            local_b8 = &DAT_001fa840;
          }
        }
        else {
          if (iVar13 + 1 == iVar15) {
...
LAB_001d90b8:
    ...
    if (iVar9 - 0x489U < 2) {
      ...
      if ((iVar14 == 8) || (iVar14 = MCOperand_getReg(uVar19), iVar14 == 9)) {
        ...
        uVar11 = AArch64_map_insn(&DAT_001feca0);
        MCInst_setOpcodePub(param_1,uVar11);
        lVar18 = *(long *)(param_1 + 800);
        if (*(int *)(lVar18 + 0x60) != 0) {
          uVar11 = MCInst_getOpcode(param_1);
        ...
        SStream_concat0(param_2,", ");
        printInt32Bang(param_2,iVar13 + 1);
        uVar11 = AArch64_map_insn(&DAT_001feca8);
        MCInst_setOpcodePub(param_1,uVar11);
        lVar18 = *(long *)(param_1 + 800);
        if (*(int *)(lVar18 + 0x60) != 0) {
          uVar11 = MCInst_getOpcode(param_1);
