...
LAB_0017e9b4:
          ...
          if (*(int *)(param_2 + 0xdd0) != 0) {
            uVar8 = 0;
            do {
              __snprintf_chk(auStack_98,0x40,2,0x40,&DAT_001fd530,uVar8);
              uVar8 = uVar8 + 1;
          ...
          *(int *)((long)__ptr + lVar10) = iVar1;
          __snprintf_chk((long)__ptr + lVar10 + 4,0x40,2,0x40,&DAT_001faae0,iVar1);
          ir_type_to_hir_ex(uVar9,uVar11);
