...

{
  ...
  SStream_concat0(param_2,(*(uint *)(OpInfo0_5 + uVar11 * 4) & 0x3fff) + 0x20d46f);
...
LAB_00194734:
    ...
    if (bVar7 < 10) {
      SStream_concat(param_2,&DAT_001fde18);
    }
    else {
...
LAB_00194da8:
  ...
  case 0x11:
    ...
    goto switchD_0019354c_default;
  case 0x12:
    SStream_concat0(param_2,&DAT_001fde80);
    break;
  case 0x13:
    SStream_concat0(param_2,&DAT_001fde88);
    break;
  case 0x14:
    SStream_concat0(param_2,&DAT_001fde90);
    break;
  case 0x15:
  case 0x1c:
    uVar5 = 8;
    goto LAB_00194270;
  case 0x16:
    SStream_concat0(param_2,&DAT_001fde98);
    break;
  case 0x17:
    iVar8 = MCInst_getOpcode(param_1);
    if ((iVar8 == 0x39b) || (iVar8 == 0x3b2)) {
...
LAB_001942d8:
  ...
  case 0x5a:
    ...
    break;
  case 0x5b:
    SStream_concat0(param_2,&DAT_001fdf60);
    break;
  case 0x5c:
    SStream_concat0(param_2,&DAT_001fdf68);
    break;
  case 0x5d:
    SStream_concat0(param_2,&DAT_001fdf70);
    break;
  case 0x5e:
    SStream_concat0(param_2,&DAT_001fdf78);
    break;
  case 0x5f:
    uVar14 = 7;
LAB_00194f90:
