...

{
  ...
  if ((uVar7 & 1) == 0) {
    ...
    if (uVar3 >> 4 == 0) {
      ...
      SStream_concat0(param_3,&DAT_001fe218);
    }
    else {
      SStream_concat0(param_3,&DAT_001fe210);
    }
    if ((uVar4 & 0xf) == 0) {
      return;
    }
    SStream_concat0(param_3,&DAT_001fe220);
    if ((uVar4 >> 3 & 1) == 0) {
      uVar9 = 0;
      uVar11 = 1;
      uVar13 = 2;
      ...
      SStream_concat0(param_3,&DAT_001fe228);
      uVar9 = 8;
      uVar11 = 9;
      uVar13 = 10;
      uVar12 = 0xb;
    ...
    if ((uVar4 >> 1 & 1) != 0) {
      SStream_concat0(param_3,&DAT_001fdfb0);
      uVar11 = uVar12;
      uVar9 = uVar13;
    }
    if ((uVar4 & 1) != 0) {
  ...
  if (uVar4 == 0xffffffff) {
    if (uVar3 < 10) {
      SStream_concat(param_3,&DAT_001fddc0,uVar3);
    }
    else {
      SStream_concat(param_3,&DAT_001fe1f0,uVar3);
    }
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
