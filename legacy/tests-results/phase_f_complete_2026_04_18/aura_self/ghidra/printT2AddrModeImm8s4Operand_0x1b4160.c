...
void printT2AddrModeImm8s4Operand(long param_1,int param_2,undefined8 param_3,char param_4)

{
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
    ...
    if (iVar2 != -0x80000000) goto LAB_001b4208;
LAB_001b4278:
    iVar8 = 0;
    iVar2 = 0;
  }
    ...
    *(undefined4 *)(lVar9 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x98) = uVar3;
    iVar2 = MCOperand_getImm(uVar5);
    if (iVar2 == -0x80000000) goto LAB_001b4278;
LAB_001b4208:
    iVar8 = -iVar2;
    if (-1 < iVar2) {
      if (iVar2 < 1 && param_4 == '\0') {
        ...
        SStream_concat(param_3,0x1fe000,iVar2);
      }
      goto LAB_001b4290;
    }
  }
