...
LAB_00186f00:
  fwrite(&DAT_001fa458,1,4,param_2);
  goto LAB_00186a74;
LAB_00186b98:
  iVar15 = (int)plVar5[1];
  pcVar14 = local_b0;
...
LAB_00186bcc:
  ...
  lVar17 = lVar17 + 1;
  if (s_stack_var_count <= (uint)lVar17) goto code_r0x00186c44;
  goto LAB_00186b28;
code_r0x00186c44:
  if (s_stack_var_count == 0) goto LAB_00186c48;
  goto LAB_00186ee4;
LAB_00186a70:
  if (uVar3 == 0) goto LAB_00186f00;
LAB_00186a74:
  fwrite(&DAT_001fd940,1,4,param_2);
  ...
  if (__stream == (FILE *)0x0) {
    ...
    fclose(__stream);
    if ((*(long *)(param_1 + 0xdd8) == 0) || (*(int *)(param_1 + 0xde0) == 0)) {
      if (s_stack_var_count != 0) goto LAB_00186afc;
    }
    else {
