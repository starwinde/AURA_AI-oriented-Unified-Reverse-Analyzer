...
LAB_00191650:
    ...
    uVar14 = uVar7;
    if ((long)uVar7 < 10) {
      SStream_concat(param_3,&DAT_001fddf8,uVar7);
      goto LAB_00191048;
    }
LAB_00191568:
    uVar7 = uVar14;
...
LAB_00191010:
      if (uVar7 < 10) {
LAB_001916c4:
        SStream_concat(param_3,&DAT_001fde18,uVar7);
      }
      else {
        if (uVar3 == 0) {
