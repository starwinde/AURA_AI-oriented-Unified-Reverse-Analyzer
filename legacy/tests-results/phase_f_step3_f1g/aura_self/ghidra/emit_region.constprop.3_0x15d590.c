...
LAB_0015d600:
    if ((*(byte *)(param_8 + local_c8) & 1) != 0) goto LAB_0015d740;
    lVar15 = *param_1;
    *(undefined1 *)(param_8 + local_c8) = 1;
    ...
    if ((int)uVar5 < 0) {
      if (((*(byte *)(param_4 + local_c8) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
        ...
        piVar23 = (int *)0x0;
        if (uVar5 != 0) goto LAB_0015d690;
      }
    }
    else {
      piVar23 = (int *)(*(long *)(lVar21 + 8) + (long)(int)uVar5 * 0x88);
      do {
        if (*piVar23 - 0x17U < 2 || *piVar23 == 0x1a) goto LAB_0015d678;
...
LAB_0015f120:
                  ...
                  do {
                    ...
                    if ((uVar4 == (uint)uVar17) || (uVar5 = uVar5 + 1, uVar19 < uVar5)) {
                      if (uVar16 < uVar19) {
                        if (uVar16 != uVar18) goto LAB_0015ecc8;
                        uVar16 = (uint)uVar20;
                        uVar20 = local_c8;
                      }
                      break;
...
joined_r0x0015f170:
                  uVar17 = uVar20;
                  uVar4 = uVar16;
                  if (puVar10 != (uint *)0x0) goto LAB_0015e7cc;
                }
LAB_0015ed04:
                iVar6 = 0x10;
                do {
                ...
                if (piVar23[0x12] == 0) {
                  fwrite(&DAT_001f8e60,1,4,param_9);
                }
                else if (piVar23[6] == -1) {
                  fwrite("__undef",1,7,param_9);
                }
                else {
                  __fprintf_chk(param_9,2,&DAT_001f8f08);
                }
                fwrite(&DAT_001f9018,1,4,param_9);
              }
              else {
                if ((uVar19 <= uVar16) ||
...
LAB_0015ecc8:
                ...
                do {
                  ...
                  goto joined_r0x0015f170;
                  uVar4 = uVar9;
                } while (uVar9 != uVar18);
                uVar17 = (ulong)uVar16;
                uVar4 = (uint)uVar20;
                if (puVar10 == (uint *)0x0) goto LAB_0015ed04;
LAB_0015e7cc:
                ...
                __fprintf_chk(param_9,2,&DAT_001f8f08,puVar10[8]);
                uVar16 = puVar10[0x10];
                if (uVar16 == 0x10) {
LAB_0015f25c:
                  fwrite(&DAT_001f8fd0,1,4,param_9);
                }
                else if (uVar16 < 0x11) {
                  if (uVar16 != 0xd) {
                    if (uVar16 < 0xe) {
                      if (uVar16 == 0xb) {
                        fwrite(&DAT_001f8ff0,1,4,param_9);
                      }
                      else {
                        if (uVar16 != 0xc) goto LAB_0015f48c;
                        fwrite(&DAT_001f8fe8,1,4,param_9);
                      }
                      goto LAB_0015e884;
                    }
                    if (uVar16 == 0xe) goto LAB_0015f25c;
                  }
                  fwrite(&DAT_001f8fc8,1,3,param_9);
                }
                else if (uVar16 == 0x13) {
LAB_0015f278:
                  fwrite(&DAT_001f8fd8,1,3,param_9);
                }
                else {
                  if (uVar16 < 0x14) {
                    if (uVar16 == 0x11) goto LAB_0015f278;
                  }
                  else if (uVar16 != 0x14) {
LAB_0015f48c:
                    fwrite(&DAT_001f8f38,1,3,param_9);
                    goto LAB_0015e884;
                  }
                  fwrite(&DAT_001f8fe0,1,4,param_9);
                }
LAB_0015e884:
                __fprintf_chk(param_9,2,"v%u; ",puVar10[0xf]);
                __fprintf_chk(param_9,2,&DAT_001f8f08,puVar10[8]);
                if (puVar10[0xe] == 2) {
                  fwrite(&DAT_001f9000,1,4,param_9);
                }
                else {
                  fwrite(&DAT_001f9008,1,4,param_9);
                }
              ...
              fwrite(&DAT_001f8448,1,2,param_9);
              uVar16 = *(uint *)(param_1 + 1);
              if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_0015d740;
...
LAB_0015e15c:
              ...
              lVar15 = extraout_x12;
              uVar16 = extraout_w11;
              if (uVar5 < extraout_w11) goto LAB_0015dc04;
            }
          }
        }
        else {
LAB_0015d690:
          ...
          do {
            if (*puVar10 == uVar18) goto LAB_0015d6c0;
            uVar4 = uVar4 + 1;
...
LAB_0015d6c0:
          if (piVar23 != (int *)0x0) {
            if (*piVar23 == 0x17) {
              ...
              uVar16 = piVar23[0x1a];
              cf_emit_block_body_part_0_isra_0(lVar15,local_c8,param_9,4);
              if (puVar10 == (uint *)0x0) goto LAB_0015f09c;
              uVar4 = puVar10[5];
              uVar19 = *(uint *)(param_1 + 1);
              if (uVar4 < uVar19) {
                if (uVar5 == uVar4) {
                ...
                if (uVar5 < uVar19) {
                  lVar15 = *param_1;
                  if (uVar5 != uVar18) goto LAB_0015f120;
                }
...
LAB_0015dc8c:
                ...
                fwrite(&DAT_001f8f88,1,3,param_9);
                uVar16 = *(uint *)(param_1 + 1);
                if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_0015d740;
                local_c8 = (ulong)uVar4;
                goto LAB_0015d600;
      ...
      if (piVar11[4] != 0) {
        do {
          ...
          if ((*(byte *)(lVar21 + 0xc) & 1) == 0) {
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar5 < uVar16) goto LAB_0015e614;
LAB_0015e588:
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar16 <= uVar5) goto LAB_0015e588;
LAB_0015e614:
            pvVar12 = calloc((ulong)uVar16,1);
            if (pvVar12 == (void *)0x0) goto LAB_0015e588;
            uVar4 = piVar11[8];
...
LAB_0015e6d0:
      ...
      uVar16 = *(uint *)(param_1 + 1);
      uVar5 = piVar11[6];
      if (uVar5 < uVar16 && param_3 != uVar5) goto LAB_0015e0a0;
      goto LAB_0015d740;
    }
...
LAB_0015e064:
    ...
    if (piVar23 == (int *)0x0) goto LAB_0015d740;
    iVar6 = *piVar23;
    if (iVar6 == 0x18) {
      uVar5 = piVar23[0x19];
      uVar16 = *(uint *)(param_1 + 1);
      if (param_3 != uVar5 && uVar5 < uVar16) goto LAB_0015e0a0;
      goto LAB_0015d740;
    }
    if (iVar6 == 0x1a) {
      iVar6 = 0x10;
        ...
        if (piVar23[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              lVar15 = lVar15 + 1;
              uVar16 = (uint)lVar15;
              if ((uint)piVar23[0x18] <= uVar16) goto LAB_0015e130;
            }
            __fprintf_chk(param_9,2,&DAT_001f8f08);
            lVar15 = lVar15 + 1;
...
LAB_0015e130:
    ...
    if (iVar6 != 0x17) goto LAB_0015d740;
    uVar16 = piVar23[0x19];
    uVar5 = piVar23[0x1a];
...
LAB_0015e2f0:
        ...
        if (uVar4 < uVar18) goto LAB_0015d7bc;
        local_80[0] = uVar18;
        local_78 = param_5;
        plStack_70 = param_1;
        ...
        fwrite(&DAT_001f90b8,1,4,param_9);
        if (piVar23[0x12] == 0) {
          fwrite(&DAT_001f8e60,1,4,param_9);
        }
        else if (piVar23[6] == -1) {
      ...
      uVar18 = *(uint *)(param_1 + 1);
      if (uVar18 <= uVar4) goto LAB_0015e2f0;
LAB_0015d7bc:
      uVar20 = (ulong)uVar4;
      if (uVar5 == uVar4) {
        iVar6 = 0x10;
            ...
            if (uVar5 != 0) {
              ...
              do {
                ...
                if ((*(int *)(*(long *)(lVar15 + 8) + lVar21 * 0x88) == 0x1b) &&
                  ...
                  uVar17 = 0;
LAB_0015eb20:
                  if (uVar16 != *(uint *)(*(long *)(lVar22 + 0x58) + uVar17 * 4)) goto LAB_0015eb14;
                  iVar6 = 0x14;
                  do {
                    fputc(0x20,param_9);
                    iVar6 = iVar6 + -1;
                  ...
                  fwrite(&DAT_001f8f10,1,3,param_9);
...
LAB_0015d924:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar18 = *(uint *)(lVar15 + 0x10);
                    if (uVar18 <= (uint)lVar21) goto LAB_0015d9d4;
                  }
LAB_0015d8d8:
                  lVar21 = lVar21 + 1;
...
LAB_0015daec:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar16 = *(uint *)(lVar15 + 0x10);
                    if (uVar16 <= (uint)lVar21) goto LAB_0015db98;
                  }
LAB_0015daa0:
                  lVar21 = lVar21 + 1;
                } while ((uint)lVar21 < uVar16);
...
LAB_0015db98:
    ...
    if (1 < iVar6 - 1U) {
      if (1 < iVar7 - 1U) goto LAB_0015d79c;
      iVar6 = 0x10;
      do {
        fputc(0x20,param_9);
        iVar6 = iVar6 + -1;
      ...
      if (*(uint *)(param_1 + 1) <= uVar16 || param_3 == uVar16) goto LAB_0015d740;
      bVar2 = *(byte *)(param_8 + (ulong)uVar16);
      uVar5 = uVar16;
      goto joined_r0x0015e284;
    }
    iVar8 = 0x10;
    if (iVar7 - 1U < 2) {
      do {
...
LAB_0015e0a0:
  ...
  if ((*(byte *)(param_8 + (ulong)uVar5) & 1) != 0) goto LAB_0015d740;
  goto LAB_0015d600;
LAB_0015eb14:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015ead4;
  goto LAB_0015eb20;
LAB_0015df28:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015dee8;
  goto LAB_0015df34;
LAB_0015d918:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015d8d8;
  goto LAB_0015d924;
LAB_0015dae0:
  uVar17 = uVar17 + 1;
  if (*(uint *)(lVar22 + 0x60) == uVar17) goto LAB_0015daa0;
  goto LAB_0015daec;
}
