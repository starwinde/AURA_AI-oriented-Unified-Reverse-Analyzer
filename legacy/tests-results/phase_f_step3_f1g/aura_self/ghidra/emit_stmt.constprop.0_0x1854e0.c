...
size_t emit_stmt_constprop_0(undefined4 *param_1,FILE *param_2)

{
  ...
  case 0:
    ...
    if (param_1[0x28] == 0) {
      ...
      do {
        emit_stmt_constprop_0(*(undefined8 *)(*(long *)(param_1 + 0x26) + lVar7 * 8),param_2);
    ...
    return uVar5;
  case 1:
    fwrite(&DAT_001fafb0,1,4,param_2);
    fwrite(&DAT_001f90b8,1,4,param_2);
    emit_expr(*(undefined8 *)(param_1 + 0x26),param_2,0);
    fwrite(&DAT_001f9018,1,4,param_2);
    emit_stmt_constprop_1(*(undefined8 *)(param_1 + 0x28),param_2);
    if (*(long *)(param_1 + 0x2a) != 0) {
      fwrite(&DAT_001fafb0,1,4,param_2);
      fwrite("} else {\n",1,9,param_2);
      emit_stmt_constprop_1(*(undefined8 *)(param_1 + 0x2a),param_2);
    }
    goto LAB_0018580c;
  case 2:
    fwrite(&DAT_001fafb0,1,4,param_2);
  ...
  case 4:
    ...
    if (piVar3 != (int *)0x0) {
      if (*piVar3 == 10) {
        ...
        fwrite(&DAT_001f8f10,1,3,param_2);
    ...
    fwrite(&DAT_001fbb10,1,2,param_2);
    ...
    fwrite(&DAT_001f9018,1,4,param_2);
    emit_stmt_constprop_1(*(undefined8 *)(param_1 + 0x2c),param_2);
    fwrite(&DAT_001fafb0,1,4,param_2);
    goto LAB_00185830;
  case 5:
    fwrite(&DAT_001fafb0,1,4,param_2);
    ...
    if (param_1[0x2a] != 0) {
      ...
      do {
        ...
        uVar2 = uVar2 + 1;
        lVar7 = lVar7 + 0x18;
        emit_stmt_constprop_1(*(undefined8 *)(lVar4 + 0x10),param_2);
        fwrite(&DAT_001fafb0,1,4,param_2);
        fwrite(&DAT_001fafb0,1,4,param_2);
        fwrite("break;\n",1,7,param_2);
...
LAB_0018580c:
    fwrite(&DAT_001fafb0,1,4,param_2);
LAB_00185830:
    sVar6 = fwrite(&DAT_001f8448,1,2,param_2);
    return sVar6;
  case 6:
    fwrite(&DAT_001fafb0,1,4,param_2);
  ...
  case 10:
    ...
    if (((((piVar3 == (int *)0x0) || (*piVar3 != 0x10)) || (piVar3[0x28] != 3)) ||
      ...
      fwrite(&DAT_001fafb0,1,4,param_2);
      __ptr_00 = "/* prologue: save to stack */\n";
      sVar6 = 0x1e;
    }
    break;
  case 0xb:
  ...
  case 0xc:
    ...
    fwrite(&DAT_001fbcc0,1,2,param_2);
  ...
  sVar6 = fwrite(__ptr_00,1,sVar6,param_2);
  return sVar6;
}
