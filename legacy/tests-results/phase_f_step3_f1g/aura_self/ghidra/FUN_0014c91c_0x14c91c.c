...
LAB_0014cac4:
                    lVar17 = lVar17 + 1;
                    puVar18 = puVar18 + 10;
                    if (uVar2 <= (uint)lVar17) goto LAB_0014cbb8;
                  }
                  puVar8 = (uint *)*puVar18;
                  uVar26 = 0xffffffff;
                  ...
                  do {
                    while( true ) {
                      ...
                      iVar16 = (int)uVar26;
                      puVar8 = puVar8 + 1;
                      if (puVar8 == puVar1) goto LAB_0014cb8c;
                    }
                    iVar5 = __s[uVar26];
                    uVar27 = uVar15;
                    uVar23 = uVar26;
...
LAB_0014cb8c:
                  ...
                  if (puVar6[lVar17] == iVar16) goto LAB_0014cac4;
              ...
              do {
                while (piVar14 = puVar6 + lVar17, *piVar14 == -1) {
                  *piVar9 = (int)lVar17;
                  lVar17 = lVar17 + 1;
                  piVar9 = piVar9 + 0x14;
                  if (uVar2 <= (uint)lVar17) goto LAB_0014cc00;
                }
                lVar17 = lVar17 + 1;
                *piVar9 = *piVar14;
                piVar9 = piVar9 + 0x14;
                        ...
                        do {
                          ...
                          if (uVar24 == 0) {
                            ...
                            do {
                              iVar5 = *piVar14;
                              piVar14 = piVar14 + 1;
                              if (iVar5 == (int)lVar17) goto LAB_0014cce0;
...
LAB_0014cce0:
                ...
                lVar17 = lVar17 + 1;
                if (uVar2 <= (uint)lVar17) goto LAB_0014cd50;
                lVar20 = *param_1;
              } while( true );
            }
            free(__s);
  ...
  if (1 < uVar2) {
    ...
    if (uVar15 == 0) {
      ...
      do {
        if (*(uint *)(puVar18 + 1) != 0) {
          piVar9 = (int *)*puVar18;
          piVar14 = piVar9 + (ulong)*(uint *)(puVar18 + 1) * 0x22;
          do {
            ...
            do {
              ...
              if ((uVar3 < uVar2) && (*(char *)((long)__ptr_01 + (ulong)uVar3) == '\0')) {
                *(undefined1 *)((long)__ptr_01 + (ulong)uVar3) = 1;
                iVar5 = insert_one_phi_at(param_1,uVar3);
                if (iVar5 != 0) goto LAB_0014d084;
                uVar24 = *(uint *)(lVar20 + 0x40);
