...
joined_r0x0016aaf0:
              if (bVar3 == 0) {
LAB_0016a864:
                if (iVar19 < 1) goto LAB_0016a8d0;
                goto LAB_0016a86c;
              }
            }
            pcVar7 = strchr((char *)__haystack,0x23);
            if (pcVar7 == (char *)0x0) goto LAB_0016a864;
            bVar3 = pcVar7[1];
            __haystack = (byte *)(pcVar7 + 1);
            if (bVar3 == 0x30) {
              if ((pcVar7[2] & 0xdfU) == 0x58) goto LAB_0016a810;
              ppuVar8 = __ctype_b_loc();
              uVar4 = (*ppuVar8)[0x30];
            }
            else {
            ...
            if ((uVar4 >> 0xb & 1) == 0) goto joined_r0x0016aaf0;
            local_90 = 0;
            iVar6 = __isoc99_sscanf(__haystack,&DAT_001f9ea0,&local_90);
            if ((iVar6 == 1) &&
               ((iVar19 < 1 ||
                ((local_88[0] != local_90 &&
                 ((iVar19 == 1 ||
...
LAB_0016a878:
          uVar12 = *puVar22;
          if ((plVar21 == (long *)0x0) || (*(uint *)(param_1 + 0x20) == 0)) goto joined_r0x0016a9bc;
          plVar23 = plVar21;
LAB_0016a898:
          if (((plVar23[3] == 0) || (uVar12 < (ulong)plVar23[1])) ||
             ((ulong)(plVar23[3] + plVar23[1]) <= uVar12)) goto LAB_0016a8b8;
          pcVar7 = (char *)*plVar23;
          if (pcVar7 == (char *)0x0) goto joined_r0x0016a9bc;
          uVar13 = (uint)uVar14;
          uVar16 = (uint)uVar17;
          pvVar11 = pvVar15;
          if (uVar16 <= uVar13) {
...
LAB_0016a8b8:
  plVar23 = plVar23 + 7;
  if (plVar23 == plVar21 + (ulong)*(uint *)(param_1 + 0x20) * 7) goto joined_r0x0016a9bc;
  goto LAB_0016a898;
joined_r0x0016a9bc:
  puVar22 = puVar22 + 1;
  if (puVar22 == puVar1) goto LAB_0016a8d0;
  goto LAB_0016a878;
}
