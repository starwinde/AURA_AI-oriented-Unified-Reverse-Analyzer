...
LAB_00196e80:
    ...
    if ((uVar6 & uVar11 & 1) != 0) goto LAB_00196eb4;
LAB_00196e38:
    if ((param_2 & 0x1000000) == 0) {
      ...
      uVar6 = 0;
      uVar7 = 3;
      if ((uVar11 & 1) == 0) goto joined_r0x00196ecc;
    }
  }
  else {
    if (uVar3 - 0x29b < 4) goto LAB_00196e80;
LAB_00196e10:
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar8 * 2));
    uVar3 = (uint)(uVar5 >> 0x17) & 1;
    uVar11 = uVar10 ^ 1 | uVar11;
    if ((uVar6 & uVar11 & 1) == 0) goto LAB_00196e38;
LAB_00196eb4:
    uVar10 = 0x10000;
  }
  uVar7 = 3;
