...

{
  ...
  uVar11 = 0x1000000d;
  uVar13 = 5;
  puVar12 = (undefined8 *)(*param_1 + 8) + (ulong)*(uint *)(param_1 + 1) * 10;
        ...
        do {
          while (uVar8 = *puVar6, 0xe < uVar8) {
            if (uVar8 == 0x1b) {
              ...
              if (uVar8 - 0x11 < 4) goto LAB_00158394;
            }
...
LAB_0015826c:
            puVar6 = puVar6 + 0x22;
            if (puVar6 == puVar18) goto LAB_00158278;
          }
          if (10 < uVar8) {
LAB_00158394:
            uVar4 = 6;
LAB_00158244:
          ...
          if (8 < uVar8) {
LAB_00158238:
            if (puVar6[0x12] == 0) goto LAB_0015826c;
LAB_00158240:
            uVar4 = (ulong)puVar6[7];
            goto LAB_00158244;
          }
          if (uVar8 < 2) {
            if (uVar8 != 0) goto LAB_0015826c;
            goto LAB_00158238;
          }
          if (1 < puVar6[0x12]) {
          ...
          if (puVar6[0x12] == 1) goto LAB_00158240;
          puVar6 = puVar6 + 0x22;
