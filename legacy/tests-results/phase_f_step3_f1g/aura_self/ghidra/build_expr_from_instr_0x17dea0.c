      ...
      *puVar5 = 0x10;
      ...
      if (uVar3 == 0) {
        ...
        if (puVar8 != (undefined4 *)0x0) {
          *puVar8 = 0xd;
          puVar8[0x26] = uVar3;
          __snprintf_chk(puVar8 + 0x27,0x40,2,0x40,&DAT_001f8f08,uVar3);
        }
      }
      else {
...
LAB_0017df48:
    ...
    if (uVar3 < 0x16) {
      ...
      if (uVar3 < 2) {
        ...
        puVar5 = calloc(1,0x130);
        if (puVar5 == (undefined4 *)0x0) goto LAB_0017e04c;
        uVar1 = param_2[6];
        *puVar5 = 0xf;
        puVar5[0x2a] = uVar3;
      ...
      if (uVar3 == 0x19) {
        puVar5 = calloc(1,0x130);
        if (puVar5 == (undefined4 *)0x0) goto LAB_0017e47c;
        uVar3 = param_2[0x12];
        *puVar5 = 0x11;
        uVar2 = DAT_001f7f0c;
              ...
              do {
                if (((char *)*puVar9 != (char *)0x0) &&
                  ...
                  if ((((ulong)puVar9[1] <= uVar17) &&
                    ...
                    if (*(uint *)(local_60 + 1) == 0) goto LAB_0017e460;
                    iVar4 = 0;
    ...
    if (puVar5 != (undefined4 *)0x0) {
      *puVar5 = 0xd;
      puVar5[0x26] = uVar3;
      __snprintf_chk(puVar5 + 0x27,0x40,2,0x40,&DAT_001f8f08,uVar3);
    }
  }
  goto LAB_0017e04c;
LAB_0017e3fc:
  if ((int)plVar18[2] != 4) goto LAB_0017e3f0;
...
LAB_0017e3f0:
  plVar18 = plVar18 + 4;
  if (plVar18 == plVar14) goto LAB_0017e460;
  goto LAB_0017e3fc;
LAB_0017e460:
  reloc_table_destroy(&local_60);
LAB_0017e370:
