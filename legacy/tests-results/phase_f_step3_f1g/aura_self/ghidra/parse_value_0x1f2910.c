...

{
  ...
  if ((param_2 == (long *)0x0) || (lVar14 = *param_2, lVar14 == 0)) goto LAB_001f2a04;
  uVar2 = param_2[1];
  uVar10 = param_2[2];
  uVar6 = uVar10 + 4;
  if (uVar2 < uVar6) {
    ...
    {
LAB_001f29c0:
      if (uVar2 <= uVar10) goto LAB_001f2a04;
          ...
          if (uVar10 < uVar2) {
            do {
              if (0x20 < *(byte *)(lVar14 + uVar10)) {
                if (uVar2 == uVar10) goto LAB_001f3060;
                uVar10 = param_2[2];
                if (uVar2 <= uVar10) goto LAB_001f3014;
                goto LAB_001f2e7c;
              }
              uVar10 = uVar10 + 1;
              param_2[2] = uVar10;
...
LAB_001f2e7c:
              if (*(char *)(lVar14 + uVar10) == ']') {
                ...
                do {
                  ...
                  puVar13 = puVar12;
                  if (puVar7 == (undefined8 *)0x0) goto LAB_001f3020;
                  puVar7[1] = 0;
                  *puVar7 = 0;
                  puVar7[3] = 0;
                  puVar7[2] = 0;
                  ...
                  if (iVar4 == 0) goto LAB_001f2ff8;
                  lVar14 = *param_2;
                  uVar6 = param_2[1];
                  uVar10 = param_2[2];
                  if (lVar14 == 0) {
LAB_001f2f64:
                    if (uVar6 <= uVar10) goto LAB_001f2ff8;
                  }
                  else {
                    if (uVar6 <= uVar10) goto LAB_001f2ff8;
                    do {
                      if (0x20 < *(byte *)(lVar14 + uVar10)) {
                        if (uVar10 != uVar6) goto LAB_001f2f64;
                        break;
                      }
                      uVar10 = uVar10 + 1;
                      param_2[2] = uVar10;
                ...
                if ((uVar6 <= uVar10) || (*(char *)(lVar14 + uVar10) != ']')) goto LAB_001f2ff8;
        ...
        if (uVar10 < uVar2) {
          do {
            if (0x20 < *(byte *)(lVar14 + uVar10)) {
              if (uVar2 == uVar10) goto LAB_001f3074;
              uVar10 = param_2[2];
              if (uVar2 <= uVar10) goto LAB_001f3014;
              goto LAB_001f2b04;
            }
...
LAB_001f2bec:
                ...
                if (*(char *)(lVar14 + uVar10) != ':') goto LAB_001f2ff8;
                uVar10 = uVar10 + 1;
                param_2[2] = uVar10;
...
LAB_001f2c9c:
                  ...
                  do {
                    if (0x20 < *(byte *)(lVar14 + uVar10)) {
                      if (uVar10 != uVar6) goto LAB_001f2c9c;
                      break;
                    }
                    uVar10 = uVar10 + 1;
                    param_2[2] = uVar10;
