...
LAB_00166868:
        ...
        if ((((4 < uVar11) && (pcVar6 = *(char **)(*param_1 + 8), *pcVar6 == '\x7f')) &&
          ...
          if (pcVar6[4] == '\x01') {
            ...
            if (pcVar6[4] != '\x02') goto LAB_00166898;
            if (uVar11 == 5) {
              lVar18 = 8;
              uVar11 = 0x10;
              uVar5 = 8;
                        ...
                        if (uVar11 != 0) {
                          ...
                          if (uVar11 <= uVar9) {
                            ...
                            do {
                              ...
                              if (iVar4 == 0x100) goto LAB_00166ad8;
...
LAB_00166b50:
  ...
  uVar16 = uVar16 + 1;
  if (uVar20 <= uVar16) goto LAB_00166ad8;
  uVar9 = puVar8[3];
