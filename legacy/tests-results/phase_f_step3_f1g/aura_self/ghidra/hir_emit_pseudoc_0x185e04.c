  ...
  if (*(int *)(param_1 + 0xdd0) != 0) {
    do {
      if (*pcVar14 == '\0') {
        ...
        if (uVar3 <= iVar15 + 1U) goto LAB_00185f00;
      }
      else {
...
LAB_00186390:
  fwrite(&DAT_001f8878,1,4,param_2);
  goto LAB_00185f04;
LAB_00186028:
  iVar15 = (int)plVar5[1];
  pcVar14 = local_b0;
...
LAB_0018605c:
  ...
  lVar17 = lVar17 + 1;
  if (s_stack_var_count <= (uint)lVar17) goto code_r0x001860d4;
  goto LAB_00185fb8;
code_r0x001860d4:
  if (s_stack_var_count == 0) goto LAB_001860d8;
  goto LAB_00186374;
LAB_00185f00:
  if (uVar3 == 0) goto LAB_00186390;
LAB_00185f04:
  fwrite(&DAT_001fbd60,1,4,param_2);
  ...
  if (__stream == (FILE *)0x0) {
    ...
    fclose(__stream);
    if ((*(long *)(param_1 + 0xdd8) == 0) || (*(int *)(param_1 + 0xde0) == 0)) {
      if (s_stack_var_count != 0) goto LAB_00185f8c;
    }
    else {
          ...
          if (*(uint *)(s_emit_stack_frame + 0x20) != 0) {
            ...
            if (*(long *)(s_emit_stack_frame + 8) < 1) {
              do {
                ...
                if (lVar19 == lVar1) goto LAB_00186028;
                plVar5 = plVar5 + 6;
      ...
      do {
        do {
          do {
            ...
            __ptr_00 = __ptr;
            if (pcVar7 == (char *)0x0) goto LAB_00186248;
            pcVar6 = pcVar7 + 1;
        ...
        if ((piVar9 != (int *)0x0) && (*(uint *)(param_1 + 0xde0) != 0)) {
          ...
          do {
            if (*piVar9 == (int)uVar8) goto LAB_00186118;
            piVar9 = piVar9 + 0x33;
        ...
        if ((__ptr != (void *)0x0) && (lVar17 = 0, uVar3 != 0)) {
          do {
            if (*(ulong *)((long)__ptr + lVar17 * 8) == uVar8) goto LAB_00186118;
            lVar17 = lVar17 + 1;
        ...
        if (__ptr != (void *)0x0) {
          if ((uint)uVar18 <= uVar3) {
            ...
            if (uVar2 <= uVar3) goto LAB_0018623c;
          }
...
LAB_00186248:
  ...
  fwrite(&DAT_001f8448,1,2,param_2);
  uVar4 = 0;
LAB_0018629c:
