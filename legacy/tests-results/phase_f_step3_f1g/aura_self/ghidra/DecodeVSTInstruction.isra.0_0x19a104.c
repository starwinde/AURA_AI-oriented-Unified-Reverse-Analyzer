...

{
  ...
  if (uVar2 < 0xa03) {
    if (0x9c3 < uVar2) {
      ...
      if ((uVar5 & 0x61861b6db) != 0) goto LAB_0019a170;
      uVar5 = uVar5 & 0x4400000000000000;
      goto joined_r0x0019a278;
    }
    if (uVar2 < 0x9af) {
      if (uVar2 < 0x971) {
        if (uVar2 < 0x968) {
          if (0x965 < uVar2) goto LAB_0019a170;
        }
...
LAB_0019a170:
      ...
      else if ((0x3060c183cc7860f3U >> ((ulong)(uVar2 - 0x971) & 0x3f) & 1) != 0) goto LAB_0019a170;
    }
  }
  else {
    if (0x3c < uVar2 - 0xa06) goto LAB_0019a188;
...
LAB_0019a188:
  ...
  if (uVar2 == 0) {
    ...
    if (0x9a6 < uVar3) goto LAB_0019a2a4;
LAB_0019a1c0:
    if (0x969 < uVar3) {
      uVar5 = 0x102040a214102885 >> ((ulong)(uVar3 - 0x96a) & 0x3f);
      goto joined_r0x0019a2c4;
    }
    if (uVar3 == 0x966) goto LAB_0019a1e4;
    if (uVar1 != 0xd) goto LAB_0019a2d0;
LAB_0019a530:
    ...
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x9a7) goto LAB_0019a1c0;
LAB_0019a2a4:
    if (uVar3 - 0x9ad < 0x39) {
      uVar5 = 0x104104924800001 >> ((ulong)(uVar3 - 0x9ad) & 0x3f);
joined_r0x0019a2c4:
      if ((uVar5 & 1) == 0) goto LAB_0019a2c8;
    }
    else {
LAB_0019a2c8:
      if (uVar1 == 0xd) goto LAB_0019a530;
LAB_0019a2d0:
      if (uVar1 != 0xf) {
...
LAB_0019a33c:
    ...
    if ((uVar5 & 0x1ff000000061c387) != 0) goto LAB_0019a33c;
    if ((uVar5 & 0xff80000000000) == 0) goto LAB_0019a360;
    if (0x1d < uVar1) {
      return 0;
    }
...
LAB_0019a360:
  ...
  if (uVar3 < 0xa04) {
    ...
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_0019a3c8;
      uVar5 = (ulong)(uVar1 + 1);
    }
LAB_0019a3b0:
...
LAB_0019a3c8:
  ...
  if (uVar3 < 0xa04) {
    ...
    if (0x3c < uVar3 - 0xa06) goto LAB_0019a418;
    uVar6 = 1L << ((ulong)(uVar3 - 0xa06) & 0x3f);
    uVar5 = (ulong)(uVar1 + 4);
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_0019a418;
      uVar5 = (ulong)(uVar1 + 2);
    }
  }
  MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (uVar5 & 0x1f) * 2));
