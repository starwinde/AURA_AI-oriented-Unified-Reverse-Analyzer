...
void FUN_001ca08c(long param_1,undefined8 param_2,undefined8 param_3)
...
LAB_001ca25c:
    ...
    SStream_concat(param_3,&DAT_001fe068,puVar7);
    iVar4 = uVar8 - 4;
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto joined_r0x001ca120;
  }
  else {
    SStream_concat(param_3,&DAT_001fe068,&DAT_001fd890);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto joined_r0x001ca120;
    iVar4 = 1;
  }
  lVar6 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
