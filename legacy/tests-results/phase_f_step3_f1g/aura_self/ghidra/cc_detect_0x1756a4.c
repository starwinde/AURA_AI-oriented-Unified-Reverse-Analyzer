...

{
  ...
  local_90 = 0;
  local_88 = 0;
  if (param_2 == 0 || param_3 == 0) goto LAB_00175780;
  if (param_4 == 3) {
    local_98 = 6;
    goto LAB_00175780;
  }
  if (3 < param_4) {
    if (param_4 != 4) goto LAB_00175780;
    uVar18 = param_3;
    if (0x14 < param_3) {
      uVar18 = 0x14;
    }
...
LAB_001759e8:
            ...
            if (pcVar23 != (char *)0x0) {
              ...
              do {
                ...
                if (pcVar12 == (char *)0x0) goto LAB_001759d0;
            ...
            do {
              ...
              if (pcVar14 == (char *)0x0) goto LAB_001759e8;
            ...
            if (iVar8 == 0) {
LAB_00175a70:
              if (!bVar5) goto LAB_001759d0;
            }
            else {
LAB_001759b4:
              iVar8 = strncmp(pcVar13,*ppuVar16,2);
              if (iVar8 == 0) goto LAB_00175a70;
            }
...
LAB_00175e64:
        ...
        if (pcVar23 != (char *)0x0) {
          ...
          do {
            pcVar12 = strstr(pcVar14,pcVar23);
            if (pcVar12 == (char *)0x0) {
              if (ppuVar16[1] == (undefined *)0x0) goto joined_r0x00175f34;
              bVar5 = false;
              goto LAB_00175da8;
            }
            pcVar14 = pcVar12 + sVar11;
...
LAB_00175e14:
          ...
          if ((*pcVar13 == '\0') && (pcVar14 = strchr(pcVar19,0x2c), pcVar14 != (char *)0x0)) {
            ...
            do {
              ...
              if (pcVar15 == (char *)0x0) {
                if (pcVar20 == (char *)0x0) goto LAB_00175f1c;
                sVar11 = strlen(pcVar20);
                pcVar23 = pcVar14;
                goto LAB_00175fcc;
              }
...
LAB_00175da8:
          ...
          do {
            ...
            if (pcVar12 == (char *)0x0) {
              if (!bVar5) goto joined_r0x00175f34;
              break;
            }
            pcVar14 = pcVar12 + sVar11;
          } while (((pcVar19 < pcVar12) &&
  ...
  if ((uVar6 & 0x88) == 0 || (uVar6 & 0x104) == 0) {
    if ((iVar8 == 0) || (local_88._4_2_ == 0)) goto LAB_00175ab8;
...
LAB_00175fcc:
    ...
    if (pcVar12 == (char *)0x0) goto LAB_00175f1c;
  }
LAB_00175f14:
  *(undefined1 *)puVar22 = 1;
LAB_00175f1c:
  *pcVar13 = '\x01';
joined_r0x00175f34:
  if (ppuVar16 == &PTR_DAT_005e0140) goto LAB_00175f38;
  puVar22 = (undefined8 *)((long)puVar22 + 1);
  pcVar13 = pcVar13 + 1;
  pcVar20 = ppuVar16[3];
  ppuVar16 = ppuVar16 + 2;
...
LAB_00175f38:
  ...
  if (pcVar17 == pcVar19) goto LAB_00175f48;
  goto LAB_00175cf0;
LAB_00175f48:
  if ((char)local_78 != '\0') {
    if (local_78._1_1_ == '\0') {
...
LAB_00175b18:
    if ((((*pcVar17 == 'x') && (pcVar17[1] == '0')) || ((*pcVar17 == 'w' && (pcVar17[1] == '0'))))
      ...
      if (uVar18 <= uVar21) goto LAB_00176160;
  ...
  while( true ) {
    while (pcVar13 = strstr(pcVar17,"w0"), pcVar13 != (char *)0x0) {
      ...
      if (((pcVar13 <= pcVar19) ||
         ...
         (0x19 < (byte)(pcVar13[2] + 0x9fU) && 9 < (byte)(pcVar13[2] - 0x30U))) goto LAB_00175780;
    }
