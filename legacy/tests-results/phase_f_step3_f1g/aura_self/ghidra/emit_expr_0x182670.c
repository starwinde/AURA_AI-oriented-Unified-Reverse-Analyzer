...

{
  ...
  do {
    while( true ) {
      ...
      uVar4 = *param_1;
      if (uVar4 == 0x11) {
        __fprintf_chk(param_2,2,&DAT_001fba80,param_1 + 0x26);
        lVar12 = 0;
        if (param_1[0x4a] != 0) {
          do {
            if ((int)lVar12 == 0) {
      ...
      if (uVar4 < 0x15) {
        if (uVar4 != 0x12) {
          ...
          if ((char)param_1[0x3a] != '\0') {
            uVar6 = __fprintf_chk(param_2,2,&DAT_001fbc50,param_1 + 0x28);
            return uVar6;
          }
          uVar6 = __fprintf_chk(param_2,2,&DAT_001fbc58,param_1 + 0x28);
          return uVar6;
        }
        param_3 = 0xd;
        __fprintf_chk(param_2,2,&DAT_001fba88,param_1 + 0x28);
...
LAB_00182a28:
        ...
        if (3 < param_3) {
          ...
          fwrite(&DAT_001f8f38,1,3,param_2);
          emit_expr(*(undefined8 *)(param_1 + 0x28),param_2,3);
          fwrite(&DAT_001f7ed0,1,3,param_2);
    ...
    if (uVar4 == 0xf) {
      ...
      if (uVar4 < 0x13) {
        ...
        if ((param_1[0x2a] - 0xf & 0xfffffffa) != 0) goto LAB_00182a74;
        if (iVar5 < param_3) {
          fputc(0x28,param_2);
        }
        ...
        switch(param_1[0x2a]) {
        case 2:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8e90);
          break;
        case 3:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8e98);
          break;
        case 4:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ea0);
          break;
        case 5:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ea8);
          break;
        case 6:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8eb0);
          break;
        case 7:
          __fprintf_chk(param_2,2,&DAT_001f8f40,"|");
          break;
        case 8:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8eb8);
          break;
        case 9:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ec0);
          break;
        case 10:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ec8);
          break;
        case 0xb:
          __fprintf_chk(param_2,2,&DAT_001f8f40,"==");
          break;
        case 0xc:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ed0);
          break;
        case 0xd:
        case 0xf:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ed8);
          break;
        case 0xe:
        case 0x10:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ee0);
          break;
        case 0x11:
        case 0x13:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ee8);
          break;
        case 0x12:
        case 0x14:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001f8ef0);
          break;
        default:
          __fprintf_chk(param_2,2,&DAT_001f8f40,&DAT_001fbc38);
        }
        fwrite("(uint64_t)(",1,0xb,param_2);
        emit_expr(*(undefined8 *)(param_1 + 0x28),param_2,0);
...
LAB_001829ec:
    ...
    if (uVar4 != 0x10) {
      if (uVar4 == 0xd) {
        if ((s_emit_func == 0) || (*(uint *)(s_emit_func + 0xdd0) == 0)) goto LAB_001828c0;
        puVar14 = (uint *)(s_emit_func + 0x1d8);
        uVar4 = 0;
        break;
      }
      if (uVar4 != 0xe) goto LAB_00182a28;
      if ((char)param_1[0x2a] != '\0') {
        uVar6 = __fprintf_chk(*(undefined8 *)(param_1 + 0x28),param_2,2,&DAT_001fba70);
        return uVar6;
      }
      uVar6 = *(ulong *)(param_1 + 0x26);
      if (((long)uVar6 < 0) || ((long)uVar6 < 0x100 && (char)param_1[0x22] == '\0')) {
        uVar6 = __fprintf_chk(param_2,2,&DAT_001fba78);
        return uVar6;
      }
    ...
    if (uVar4 == 3) {
      ...
      if (piVar10 != (int *)0x0) {
        if (*piVar10 == 0xf) {
          ...
          __ptr = &DAT_001f8ea0;
          if ((*piVar10 != 0xe) || ((char)piVar10[0x2a] != '\0')) goto LAB_0018297c;
          lVar8 = *(long *)(piVar10 + 0x26);
          lVar12 = -lVar8;
          if (-1 < lVar8) {
            lVar12 = lVar8;
...
LAB_001828c0:
    ...
    uVar6 = __fprintf_chk(param_2,2,&DAT_001f8f08,param_1[0x26]);
    return uVar6;
  }
  goto LAB_00182898;
LAB_00183154:
