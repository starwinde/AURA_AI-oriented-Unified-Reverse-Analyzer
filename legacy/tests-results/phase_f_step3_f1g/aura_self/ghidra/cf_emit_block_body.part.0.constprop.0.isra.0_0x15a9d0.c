...
LAB_0015aa10:
      ...
      if (uVar4 == 0x15) {
        if (puVar1[2] == 0xffffffff) {
          ...
          __fprintf_chk(param_3,2,&DAT_001f8f08);
        }
        switch(puVar1[3]) {
        case 0:
          pcVar2 = "void";
        ...
        if (uVar4 != 0x19) {
          if (uVar4 == 0x1c) {
            if (2 < puVar1[0x12]) {
              ...
              fwrite(&DAT_001f8f10,1,3,param_3);
              ...
              fwrite(&DAT_001f8f38,1,3,param_3);
              ...
              fwrite(&DAT_001f7ed0,1,3,param_3);
              uVar4 = puVar1[0xe];
...
LAB_0015addc:
        fwrite(&DAT_001f8f88,1,3,param_3);
        uVar4 = *(uint *)(param_1 + 0x10);
        goto LAB_0015aa10;
      }
      if (uVar4 == 1) {
