...

{
  ...
  SStream_concat0(param_2,(uVar11 & 0xfff) + 0x242def);
    ...
    if ((uVar5 != 0) &&
      ...
      do {
        if (((uVar5 >> (ulong)(uVar22 & 0x1f) ^ uVar6) & 1) == 0) {
          SStream_concat0(param_2,&DAT_00200998);
        }
        else {
  ...
  case 0xd:
    ...
    SStream_concat(param_2,&DAT_001fc668,uVar4);
  ...
  case 0xe:
    ...
    if (iVar7 == 2) {
      puVar18 = &DAT_001fc650;
    }
    else {
      puVar18 = &DAT_001fc658;
      if (iVar7 != 3) {
        puVar18 = &DAT_001fca88;
      }
    }
    ...
    break;
  case 0xf:
    goto switchD_001b34f4_caseD_f;
  case 0x10:
    goto switchD_001b34f4_caseD_10;
  case 0x11:
    MCInst_getOperand(param_1,1);
    uVar4 = MCOperand_getImm();
    SStream_concat(param_2,&DAT_001fc668,uVar4);
    ...
    uVar4 = MCOperand_getImm();
    SStream_concat(param_2,&DAT_001fc408,uVar4);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      lVar17 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
      bVar1 = *(byte *)(lVar17 + 0x80);
      lVar13 = lVar17 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10;
  ...
  case 0x12:
    ...
    *(byte *)(lVar17 + 0x80) = bVar1 + 1;
    return;
  case 0x13:
    goto switchD_001b34f4_caseD_13;
  case 0x14:
  ...
  case 0x15:
    ...
    if (lVar13 == 0) {
      ...
      *(undefined8 *)(lVar13 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x94) = DAT_0020a9e0;
      *(byte *)(lVar13 + 0x80) = bVar1 + 1;
      return;
    }
    SStream_concat0(param_2,&DAT_001fc670);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
    lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
    bVar1 = *(byte *)(lVar13 + 0x80);
    *(undefined8 *)(lVar13 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x94) = DAT_0020a9d8;
    *(byte *)(lVar13 + 0x80) = bVar1 + 1;
    return;
  case 0x16:
  ...
  case 0x1e:
    ...
    break;
  default:
    goto switchD_001b34f4_default;
  }
  uVar12 = (((ulong)uVar11 & 0xfe0000) >> 0x11) - 1;
  if (0x49 < uVar12) {
switchD_001b3728_default:
    SStream_concat0(param_2,&DAT_001fc9a8);
    goto LAB_001b3570;
  }
  switch(uVar12 & 0xffffffff) {
  case 0:
    SStream_concat0(param_2,&DAT_001fc678);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b51c0;
  case 1:
    SStream_concat0(param_2,&DAT_001fc680);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b51a0;
  case 2:
    SStream_concat0(param_2,&DAT_001fc688);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b5180;
  case 3:
    SStream_concat0(param_2,&DAT_001fc788);
    goto LAB_001b3570;
  case 4:
    goto switchD_001b3728_caseD_4;
  case 5:
    goto switchD_001b34f4_default;
  case 6:
    SStream_concat0(param_2,&DAT_001fc690);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
    lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
...
LAB_001b41f8:
  ...
  case 0x10:
    ...
    goto LAB_001b3758;
  case 0x11:
    SStream_concat0(param_2,&DAT_001fc6e0);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x13:
    ...
    goto LAB_001b3758;
  case 0x14:
    SStream_concat0(param_2,&DAT_001fc6f8);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x17:
    ...
    goto LAB_001b3758;
  case 0x18:
    SStream_concat0(param_2,&DAT_001fc718);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
LAB_001b442c:
    ...
    return;
  case 0x1f:
    SStream_concat0(param_2,&DAT_001fc780);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x26:
    ...
    break;
  case 0x27:
    SStream_concat0(param_2,&DAT_001fc800);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
joined_r0x001b51a0:
    ...
    goto LAB_001b3570;
  case 0x2b:
    SStream_concat0(param_2,&DAT_001fc828);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
joined_r0x001b5180:
    if (iVar7 != 0) {
  ...
  case 0x2c:
    ...
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_001b47a4;
  ...
  case 0x30:
    ...
    goto LAB_001b4784;
  case 0x31:
    SStream_concat0(param_2,&DAT_001fc880);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
switchD_001b3728_caseD_4:
  ...
  case 0x34:
    ...
    if (uVar11 < 10) {
      SStream_concat(param_2,&DAT_001fc400,uVar11);
    }
    else {
...
LAB_001b42ec:
  ...
  case 0x43:
    ...
    break;
  case 0x44:
    SStream_concat0(param_2,&DAT_001fc988);
    goto LAB_001b3570;
  case 0x45:
    SStream_concat0(param_2,"\tsp, ");
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b4774;
  case 0x46:
    SStream_concat0(param_2,"\tsp!, ");
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
joined_r0x001b4774:
    if (iVar7 == 0) goto LAB_001b47a4;
    lVar13 = *(long *)(param_1 + 0x310);
    uVar14 = 0xc00000001;
LAB_001b4784:
...
LAB_001b47a4:
    ...
    return;
  case 0x47:
    SStream_concat0(param_2,&DAT_001fc9a0);
    printOperand(param_1,0,param_2);
    return;
  case 0x48:
    printPredicateOperand(param_1,4,param_2);
...
switchD_001b3790_default:
  ...
  case 1:
    ...
    SStream_concat0(param_2,&DAT_001fc9b0);
    lVar13 = *(long *)(param_1 + 800);
    MCInst_getOperand(param_1,0);
    iVar7 = MCOperand_getReg();
...
LAB_001b5c38:
    SStream_concat0(param_2,&DAT_001fc9b8);
...
LAB_001b5fb0:
  ...
  case 0xc:
    ...
    SStream_concat(param_2,&DAT_001fc408,uVar4);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b5b2c;
  case 0xd:
    MCInst_getOperand(param_1,1);
    uVar5 = MCOperand_getImm();
    if ((uVar5 >> 2 & 1) == 0) {
      if ((uVar5 >> 1 & 1) != 0) goto LAB_001b85c8;
      if ((uVar5 & 1) != 0) goto LAB_001b5394;
      if (uVar5 == 0) {
        uVar5 = 0x10;
        SStream_concat0(param_2,&DAT_001fc9c0);
      }
    }
    else {
      SStream_concat0(param_2,&DAT_00204ad0);
      if ((uVar5 >> 1 & 1) != 0) {
LAB_001b85c8:
      ...
      if ((uVar5 & 1) != 0) {
LAB_001b5394:
        SStream_concat0(param_2,&DAT_001fc648);
      }
    }
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0xf:
    ...
    return;
  case 0x10:
    goto switchD_001b73e0_caseD_e;
  case 0x11:
    printAddrMode7Operand(param_1,2,param_2);
    SStream_concat0(param_2,", ");
    break;
  case 0x12:
    goto switchD_001b73e0_caseD_10;
  case 0x13:
    MCInst_getOperand(param_1,1);
    uVar4 = MCOperand_getImm();
    SStream_concat(param_2,&DAT_001fc668,uVar4);
...
LAB_001b3bd0:
  ...
  case 0x16:
    ...
    pcVar2 = (code *)SoftwareBreakpoint(1000,0x1b9d9c);
    (*pcVar2)();
  case 0x17:
    MCInst_getOperand(param_1,1);
    uVar6 = MCOperand_getImm();
...
LAB_001b8578:
      ...
      if (uVar5 == 0x1e) {
        ...
        if ((uVar6 >> 6 & 1) == 0) {
          uVar12 = uVar21;
          if ((uVar6 >> 7 & 1) == 0) goto LAB_001b8570;
    ...
    SStream_concat(param_2,&DAT_001fc190,uVar12);
LAB_001b5818:
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
...
switchD_001b34f4_caseD_13:
  ...
  case 0x37:
    ...
    SStream_concat0(param_2,&DAT_001fc9d0);
    lVar13 = *(long *)(param_1 + 800);
    ...
    *(undefined8 *)(lVar17 + 0x8c) = DAT_0020a9e8;
  ...
  case 0x3a:
    ...
    return;
  default:
    goto switchD_001b3790_default;
  }
LAB_001b3598:
  uVar12 = (CONCAT44(uVar10,uVar11) >> 0x1e & 0x1f) - 1;
  if (0x1c < uVar12) goto switchD_001b37a8_default;
  switch(uVar12 & 0xffffffff) {
  case 0:
    break;
  case 1:
  ...
  case 4:
    ...
    SStream_concat((double)(float)((uVar10 >> 4 & 3) << 0x17 | (uVar10 & 0xf) << 0x13 |
                                  uVar5 | uVar11),param_2,&DAT_001fc9e0);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
  ...
  case 6:
    ...
    uVar11 = MCOperand_getImm();
    if (uVar11 < 10) {
      SStream_concat(param_2,&DAT_001fc538,uVar11);
    }
    else {
      SStream_concat(param_2,"{0x%x}",uVar11);
    }
...
switchD_001b73e0_caseD_10:
      ...
      case 0x24:
        ...
        if ((uVar12 & 1) == 0) goto LAB_001b951c;
        SStream_concat0(param_2,&DAT_001fc3c0);
        lVar13 = *(long *)(param_1 + 800);
        MCOperand_getReg(uVar14);
        ...
        uVar10 = uVar10 & 0x100;
        if (uVar11 == 0) {
          if (uVar10 == 0) goto LAB_001b7c00;
          uVar5 = 0;
          puVar18 = &DAT_001f8e98;
LAB_001b7bc4:
          ...
          SStream_concat(param_2,&DAT_001fc3c8,puVar18,uVar5);
        }
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
          lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
          if (uVar10 == 0) {
...
LAB_001b7c00:
      ...
      case 0x30:
        ...
        return;
      case 0x31:
        SStream_concat0(param_2,&DAT_001fca68);
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
          return;
        }
      ...
      case 0x37:
        ...
        return;
      case 0x38:
        goto switchD_001b8dd4_caseD_24;
      case 0x39:
...
LAB_001b951c:
      ...
      case 0x3f:
        ...
        return;
      default:
        goto switchD_001b73e0_default;
      }
    }
    else {
switchD_001b73e0_default:
      printOperand(param_1,1,param_2);
    }
...
switchD_001b8170_caseD_1:
      ...
      case 0xf:
        ...
        return;
      case 0x10:
        goto switchD_001b8dd4_caseD_1c;
      case 0x11:
      ...
      case 0x14:
        ...
        return;
      case 0x15:
        SStream_concat0(param_2,&DAT_001fca78);
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
          return;
        }
        ...
        return;
      default:
        goto switchD_001b8170_default;
      }
    }
    else {
switchD_001b8170_default:
      SStream_concat0(param_2,", ");
    }
...
switchD_001b8dd4_caseD_6:
      ...
      case 0x19:
        ...
        return;
      case 0x1a:
        goto switchD_001b8dd4_caseD_1a;
      case 0x1b:
        printVectorIndex(param_1,4,param_2);
        return;
      case 0x1c:
switchD_001b8dd4_caseD_1c:
      ...
      case 0x23:
        ...
        return;
      case 0x24:
switchD_001b8dd4_caseD_24:
        printThumbS4ImmOperand_constprop_0(param_1,param_2);
        return;
      default:
        goto switchD_001b8dd4_default;
      }
    }
    else {
switchD_001b8dd4_default:
      printOperand(param_1,2,param_2);
    }
...
switchD_001b3664_caseD_6:
    ...
    if (uVar12 < 0xb) {
      ...
      case 1:
        ...
        return;
      case 2:
switchD_001b8170_caseD_d:
        printAddrMode6Operand(param_1,3,param_2);
        return;
      case 3:
switchD_001b8dd4_caseD_1a:
        printAddrMode6Operand(param_1,4,param_2);
        printAddrMode6OffsetOperand(param_1,6,param_2);
        return;
      case 4:
...
switchD_001b34f4_default:
  return;
switchD_001b3790_caseD_e:
  SStream_concat0(param_2,", ");
  goto LAB_001b3598;
}
