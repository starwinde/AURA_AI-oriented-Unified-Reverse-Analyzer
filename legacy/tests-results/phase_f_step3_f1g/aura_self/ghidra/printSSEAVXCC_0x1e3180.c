...

{
  ...
  switch(bVar1 & 0x1f) {
  case 1:
    SStream_concat0(param_3,&DAT_001fc5c8);
  ...
  case 3:
    ...
    break;
  case 4:
    SStream_concat0(param_3,&DAT_00201e98);
    op_addAvxCC(param_1,5);
    break;
  case 5:
    SStream_concat0(param_3,&DAT_00201ea0);
    op_addAvxCC(param_1,6);
    break;
  case 6:
    SStream_concat0(param_3,&DAT_001f8818);
    op_addAvxCC(param_1,7);
    break;
  case 7:
    SStream_concat0(param_3,&DAT_00201ea8);
  ...
  case 8:
    ...
    break;
  case 9:
    SStream_concat0(param_3,&DAT_001f8810);
    op_addAvxCC(param_1,10);
    break;
  case 10:
    SStream_concat0(param_3,&DAT_00201eb8);
  ...
  case 0xd:
    ...
    break;
  case 0xe:
    SStream_concat0(param_3,&DAT_001fc5d0);
    op_addAvxCC(param_1,0xf);
    break;
  case 0xf:
    SStream_concat0(param_3,&DAT_00201ed0);
  ...
  case 0x1f:
    ...
    break;
  default:
    SStream_concat0(param_3,&DAT_001fc580);
