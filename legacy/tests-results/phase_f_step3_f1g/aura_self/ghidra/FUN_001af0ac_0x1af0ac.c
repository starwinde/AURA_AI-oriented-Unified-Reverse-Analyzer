...
void FUN_001af0ac(long param_1,int param_2,undefined8 param_3)

{
  ...
  if (uVar3 == 3) {
    SStream_concat0(param_3,&DAT_001f8c60);
    goto LAB_001af1a0;
  }
  if ((uVar2 >> 2 & 1) == 0) {
    if (uVar3 == 1) {
      SStream_concat0(param_3,&DAT_001f8c68);
      goto LAB_001af1a0;
    }
    if (uVar3 == 2) {
      SStream_concat0(param_3,&DAT_001f8c58);
      goto LAB_001af1a0;
    }
  }
  else {
    ...
    if (uVar3 == 5) {
      SStream_concat0(param_3,&DAT_001fc3b0);
      return;
    }
  }
  SStream_concat0(param_3,&DAT_001fca88);
LAB_001af1a0:
  SStream_concat0(param_3,&DAT_001fc9a8);
  lVar9 = *(long *)(param_1 + 800);
