...
long cs_disasm(int *param_1,undefined1 *param_2,ulong param_3,long param_4,long param_5,
              undefined8 *param_6)

{
  ...
  if (param_1 != (int *)0x0) {
    ...
    if (param_5 - 1U < 0x20) {
      ...
      piVar5 = (int *)(*(code *)cs_mem_calloc)(0xf8,param_5);
    }
    else {
      local_670 = 0x1f00;
      local_69c = 0x20;
      piVar5 = (int *)(*(code *)cs_mem_calloc)(0xf8,0x20);
    }
    if (piVar5 != (int *)0x0) {
      local_688 = piVar5;
      if (param_3 == 0) {
LAB_0018b408:
        ...
        do {
          ...
          local_108 = param_1;
          if (param_1[0x18] != 0) {
            uVar6 = (*(code *)cs_mem_malloc)(0x748);
          }
          ...
          *(long *)(piVar5 + 2) = lVar11;
          ...
          if ((uVar7 & 1) == 0) {
            if (param_1[0x18] != 0) {
              (*(code *)cs_mem_free)(*(undefined8 *)(piVar5 + 0x3c));
            }
            if ((*(byte *)(param_1 + 0x20) & 1) == 0) goto joined_r0x0018b518;
            bVar2 = *(byte *)((long)param_1 + 0x81);
            __n = (size_t)bVar2;
            if (uVar12 < bVar2) goto joined_r0x0018b518;
            if (*(code **)(param_1 + 0x24) == (code *)0x0) {
              ...
              *(short *)(piVar5 + 4) = (short)__n;
              ...
              strncpy((char *)((long)piVar5 + 0x2a),*(char **)(param_1 + 0x22),0x1f);
LAB_0018b23c:
              iVar4 = cs_snprintf((long)piVar5 + 0x4a,0xa0,"0x%02x",*__src);
              lVar16 = 0xa0 - (long)iVar4;
              lVar10 = (long)piVar5 + 0x4a + (long)iVar4;
              if (__n != 1) {
                sVar15 = 1;
                do {
                  iVar4 = cs_snprintf(lVar10,lVar16,", 0x%02x",__src[sVar15]);
            ...
            *(ushort *)(local_118 + 4) = local_632;
            ...
            fill_insn(param_1,piVar5,auStack_630,auStack_428,*(undefined8 *)(param_1 + 0x12),__src);
            if (*param_1 == 3) {
          ...
          if (uVar14 == local_69c) {
            ...
            piVar8 = (int *)(*(code *)cs_mem_realloc)(local_688);
            if (piVar8 == (int *)0x0) {
        ...
        uVar13 = uVar14;
joined_r0x0018b518:
        if (local_6a8 == 0) goto LAB_0018b408;
        piVar5 = local_688;
        if ((uVar13 != local_69c) &&
           (piVar5 = (int *)(*(code *)cs_mem_realloc)
          ...
          if (param_1[0x18] != 0) {
            ...
            do {
              ...
              piVar8 = piVar5 + 0x3c;
              piVar5 = piVar5 + 0x3e;
              (*(code *)cs_mem_free)(*(undefined8 *)piVar8);
