...
/* WARNING: Removing unreachable block (ram,0x001ee630) */
...
LAB_001ee7c0:
        ...
        if (uVar2 == 3) {
          *(undefined1 *)((long)param_2 + 0x14) = 2;
          ...
          if (3 < uVar2) goto LAB_001ee7c0;
          if (uVar2 == 1) {
            *(undefined1 *)((long)param_2 + 0x14) = 0;
          }
          else {
            if (uVar2 != 2) goto LAB_001ee7c0;
            *(undefined1 *)((long)param_2 + 0x14) = 1;
          }
        }
      }
...
LAB_001eeb28:
    ...
    if (bVar4 == 2) {
      *param_2 = *param_2 | 0x40000000;
      ...
      if (2 < bVar4) goto LAB_001eeb28;
      if ((*(byte *)(param_1[1] + 8) & 3) != 0) {
        if (bVar4 != 1) goto LAB_001eeb28;
        *param_2 = *param_2 | 0x80000000000;
      }
    }
  }
...
LAB_001eec2c:
      ...
      else if (bVar4 != 0x20) goto LAB_001eec2c;
    }
  }
...
LAB_001eef30:
      ...
      if (uVar2 == 3) {
        ...
        *(undefined1 *)((long)param_2 + 0x22) = *(undefined1 *)((long)param_1 + 0x2b);
        ...
        if (3 < uVar2) goto LAB_001eef30;
        if (uVar2 == 1) {
          ZydisBuildRegisterOperand(puVar1,pbVar6,param_2);
        }
        else {
          if (uVar2 != 2) goto LAB_001eef30;
          if ((*pbVar6 & 0x3f) == 0x20) {
            *(undefined1 *)((long)param_2 + 0x21) = *(undefined1 *)((long)param_1 + 0x2a);
