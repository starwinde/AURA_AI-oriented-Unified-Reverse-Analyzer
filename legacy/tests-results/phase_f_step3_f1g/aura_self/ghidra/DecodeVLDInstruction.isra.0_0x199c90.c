...
LAB_00199ce4:
    ...
    if (0x646 < uVar1) goto LAB_00199d38;
LAB_00199d9c:
    if (0x62d < uVar1) {
      uVar1 = uVar1 - 0x62e;
joined_r0x00199d58:
      ...
      if ((uVar4 & 0x14a5000) == 0) {
        if ((uVar4 & 0x999) == 0) goto LAB_00199de8;
        iVar2 = 1;
      }
      else {
        iVar2 = 2;
    ...
    if (uVar1 - 0x5e7 < 9) goto LAB_00199ce4;
LAB_00199d70:
    MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (ulong)uVar3 * 2));
LAB_00199d8c:
    uVar1 = MCInst_getOpcode(param_1);
    if (uVar1 < 0x647) goto LAB_00199d9c;
LAB_00199d38:
    uVar1 = uVar1 - 0x675;
    if (uVar1 < 0x19) goto joined_r0x00199d58;
  }
LAB_00199de8:
  uVar1 = MCInst_getOpcode(param_1);
  if (uVar1 < 0x647) {
    if (0x62d < uVar1) {
      ...
      if ((uVar4 & 0x14a5000) == 0) goto LAB_00199e1c;
LAB_00199f90:
      uVar1 = uVar3 + 4;
LAB_00199e2c:
    ...
    if ((uVar4 & 0x14a5000) != 0) goto LAB_00199f90;
LAB_00199e1c:
    if ((uVar4 & 0x999) != 0) {
      uVar1 = uVar3 + 2;
      goto LAB_00199e2c;
  ...
  if (iVar2 - 0x675U < 0x19) {
    ...
    if ((uVar4 & 0x14a5000) == 0) {
      uVar3 = uVar3 + 3;
      if ((uVar4 & 0x999) == 0) goto LAB_00199e98;
    }
    else {
      uVar3 = uVar3 + 6;
    }
...
LAB_00199e98:
  ...
  if (uVar3 < 0x647) {
    if (0x630 < uVar3) {
      if ((0x210911UL >> ((ulong)(uVar3 - 0x631) & 0x3f) & 1) != 0) goto LAB_00199fb4;
      goto LAB_00199ef0;
    }
    if (uVar3 < 0x5b2) {
      if (0x573 < uVar3) {
        uVar5 = 0x3060c183cc7860f3 >> ((ulong)(uVar3 - 0x574) & 0x3f);
        goto joined_r0x0019a0c0;
      }
      if (uVar3 < 0x56b) {
        if (uVar3 < 0x569) goto LAB_00199ef0;
        goto LAB_00199ee0;
      }
      if (uVar3 - 0x56d < 4) goto LAB_00199ee0;
    }
    else {
      if (0x22 < uVar3 - 0x5df) goto LAB_00199ef0;
...
LAB_00199fb4:
    ...
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    if ((int)uVar5 != 0) goto LAB_00199fe8;
LAB_00199f0c:
    MCOperand_CreateImm0(param_1,0);
    uVar4 = (ulong)(param_2 & 0xf);
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x5b2) goto LAB_00199f2c;
LAB_0019a010:
