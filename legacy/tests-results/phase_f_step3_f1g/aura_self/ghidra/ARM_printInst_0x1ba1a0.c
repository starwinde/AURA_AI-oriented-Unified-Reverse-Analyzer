...

{
  ...
  if (uVar7 == 0x370) {
    ...
    if (iVar8 == 0xc) {
      ...
      if (lVar12 == -4) {
        SStream_concat0(param_2,&DAT_001f8548);
        MCInst_setOpcodePub(param_1,0x80);
        printPredicateOperand(param_1,4,param_2);
        SStream_concat0(param_2,&DAT_001fcb68);
...
LAB_001bae7c:
        ...
        if (lVar12 == 0) {
          SStream_concat0(param_2,&DAT_001f7b60,0);
          return;
        }
        goto LAB_001bbe74;
      }
...
LAB_001bad84:
      ...
      iVar8 = MCOperand_getReg();
      if (iVar8 != 0xc) goto LAB_001ba320;
...
LAB_001ba694:
        ...
        iVar8 = MCOperand_getReg();
        if (iVar8 == 0xc) {
          SStream_concat0(param_2,&DAT_001fcb78);
          uVar18 = 0x18a;
          goto LAB_001badb0;
        }
      }
      else if (uVar7 < 0x697) {
        if (uVar7 == 0x387) goto LAB_001ba544;
        if (uVar7 == 0x692) goto LAB_001ba694;
      }
      else if (uVar7 == 0xa45) goto LAB_001bad84;
    }
    else {
      if (uVar7 == 0xc0f) {
LAB_001ba544:
...
LAB_001bab6c:
          ...
          if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
            SStream_concat0(param_2,&DAT_001f8550);
            MCInst_setOpcodePub(param_1,0x7f);
            printPredicateOperand(param_1,2,param_2);
            if (uVar7 == 0xb17) {
              SStream_concat0(param_2,&DAT_001fcab8);
            }
            SStream_concat0(param_2,&DAT_001fc788);
...
joined_r0x001ba284:
        ...
        else if (uVar7 == 0xbe3) goto LAB_001ba210;
      }
      else if (uVar7 == 0xc5d) {
        uVar7 = 3;
        bVar5 = true;
        ...
        SStream_concat0(param_2,&DAT_001fcb80);
...
LAB_001bbc4c:
        ...
        if (uVar7 == 0x262) goto LAB_001baff8;
        if (uVar7 == 0x27a) goto LAB_001bab6c;
      }
      else if (uVar7 == 0x29d) {
        MCInst_getOperand(param_1,2);
        iVar8 = MCOperand_getReg();
...
LAB_001baec8:
      ...
      if (uVar7 == 0x2b1) {
        ...
        uVar7 = uVar9 & 7;
        if (uVar7 == 3) {
          SStream_concat0(param_2,&DAT_001f8c60);
          MCInst_setOpcodePub(param_1,99);
        }
        else if ((uVar9 >> 2 & 1) == 0) {
          if (uVar7 == 1) {
            SStream_concat0(param_2,&DAT_001f8c68);
            MCInst_setOpcodePub(param_1,10);
          }
          else {
            if (uVar7 != 2) goto LAB_001bbb44;
            SStream_concat0(param_2,&DAT_001f8c58);
...
LAB_001ba210:
      ...
      if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
        ...
        SStream_concat0(param_2,&DAT_001fc788);
        iVar8 = *(int *)(*(long *)(param_1 + 800) + 0x60);
        goto joined_r0x001ba284;
      }
    }
    else if (uVar7 == 0x365) goto LAB_001baec8;
LAB_001ba320:
