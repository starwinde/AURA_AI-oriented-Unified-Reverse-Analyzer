          ...
          if (cVar7 != '\0') {
            ...
            do {
              ...
              if (cVar7 == ']') {
                ...
                local_168[sVar23] = '\0';
                cVar7 = local_168[0];
                if (local_168[0] == '\0') goto LAB_00152488;
                sVar23 = strlen(local_168);
                pcVar31 = local_168 + (sVar23 - 1);
                if (pcVar31 <= local_168) goto LAB_00152448;
                goto LAB_00152438;
              }
              pcVar30 = pcVar30 + 1;
              cVar7 = *pcVar30;
  ...
  if (cVar7 != '\0') {
    ...
    do {
      ...
      if (cVar7 == ']') {
        ...
        if (local_168[0x40] == '\0') goto LAB_00152658;
...
LAB_00152754:
  ...
  uVar22 = local_2b0;
  if (iVar9 == 0) {
    if ((int)local_2b0 < 0) goto LAB_00152170;
    if (bVar4) {
LAB_00152800:
      if (uVar38 != 0) {
      ...
      if (iVar8 == 1) {
        ...
        iVar8 = __isoc99_sscanf(pcVar19,&DAT_001f8a88,&local_288);
...
LAB_00152f6c:
        ...
        if ((int)local_2b0 < 0) goto LAB_00152f6c;
...
joined_r0x00153124:
    ...
    if (iVar10 == 0) {
      uVar22 = local_2b0;
      uVar11 = local_2a4;
      if (-1 < (int)local_2b0) goto LAB_00152b90;
      goto LAB_00152170;
    }
      ...
      do {
        ...
        *(undefined8 *)(puVar17 + 4) = 0;
        if ((local_290 < 0x20) &&
          ...
          *(undefined8 *)(puVar17 + 8) = 0;
          *(undefined8 *)(puVar17 + 6) = DAT_0020a9a8;
        }
        puVar17[0x12] = 1;
...
LAB_001538f4:
        for (; (int)lVar35 == 0; lVar35 = lVar35 + 1) {
          uVar38 = (ulong)local_2b0;
          uVar11 = local_2a4;
          if (-1 < (int)local_2b0) goto LAB_001537e4;
        }
...
LAB_00152880:
    ...
    if (iVar9 == 1) {
      ...
      iVar9 = __isoc99_sscanf(pcVar31,&DAT_001f8a88,&local_288);
      if (iVar9 == 1) {
        uVar38 = CONCAT44(local_288._4_4_,(int)local_288);
        bVar4 = true;
      }
...
LAB_00152910:
    ...
    if (iVar10 == 1) {
      ...
      iVar10 = __isoc99_sscanf(pcVar31,&DAT_001f8a88,&local_288);
      local_310 = 0;
      if (iVar10 == 1) {
