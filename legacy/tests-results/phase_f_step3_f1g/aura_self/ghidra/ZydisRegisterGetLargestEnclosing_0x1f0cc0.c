...

{
  ...
  if (5 < param_1) goto LAB_001f0dfc;
  if (param_1 < 4) {
    if (param_1 == 3) {
LAB_001f0de8:
      local_a = 1;
...
LAB_001f0dfc:
      ...
      if (param_1 == 2) goto LAB_001f0df4;
      if (2 < param_1) goto LAB_001f0dfc;
      if (param_1 != 0) {
        if (param_1 != 1) goto LAB_001f0dfc;
        goto LAB_001f0de8;
      }
      local_a = 2;
    }
...
LAB_001f0f64:
        ...
        if (local_a == 0) {
          ...
          if (local_a != 1) goto LAB_001f0f64;
          uVar2 = local_9 + 0x45;
        }
      }
    }
