...

{
  ...
  if ((uVar7 & 1) != 0) {
    ...
    SStream_concat(param_3,&DAT_001fc1f8,
                   &AsmStrs_0 + *(ushort *)(RegAsmOffset_1 + (ulong)(uVar3 - 1) * 2));
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_0018f408;
    uVar3 = uVar3 & 0xffff;
            ...
            do {
              ...
              while (bVar17 != 0x80) {
                ...
                *pbVar2 = bVar17;
                pbVar9 = pbVar9 + -1;
                uVar3 = uVar4 & 0xff;
                if (uVar10 < (uVar4 & 0xff)) goto LAB_0018f918;
                pbVar2 = pbVar2 + 1;
                bVar17 = *pbVar9;
              }
              uVar4 = uVar3 + 1;
...
LAB_0018f918:
  ...
  if ((uVar7 & 1) == 0) goto LAB_0018f408;
  ...
  if (uVar3 == 1) {
    ...
    if (uVar10 < 0x1ce) {
      if (uVar10 < 0x1cc) {
        if (0xac < uVar10) {
          if (uVar10 != 0xee) {
            if (uVar10 == 0x15f) goto LAB_0018fb68;
            if (uVar10 != 0xe5) goto LAB_0018fae0;
          }
LAB_0018fa48:
          uVar7 = uVar7 & 0xff;
          if (uVar7 < 10) goto LAB_0018fb54;
          SStream_concat(param_3,"$0x%x",uVar7);
          goto LAB_0018f4d8;
        }
        if (0xa9 < uVar10) goto LAB_0018f9e8;
        if (uVar10 == 0x18) goto LAB_0018fb48;
      }
      goto LAB_0018fae0;
    }
    if (uVar10 == 0x279) goto LAB_0018fb68;
    if (uVar10 < 0x27a) {
      if (uVar10 == 0x200) {
LAB_0018fb48:
        uVar7 = uVar14;
        if (uVar14 < 10) goto LAB_0018fb54;
        goto LAB_0018f4b0;
      }
      if (uVar10 == 0x203) goto LAB_0018fa48;
    }
    else if (uVar10 == 0x5df) goto LAB_0018fb48;
LAB_0018fae0:
    uVar7 = uVar14;
    uVar14 = uVar7;
    if ((long)uVar7 < 10) {
      SStream_concat(param_3,&DAT_001fc218,uVar7);
      goto LAB_0018f4d8;
    }
LAB_0018f9f8:
    uVar7 = uVar14;
    ...
    uVar14 = uVar7;
    if (uVar10 < 0x1ce) {
      if (0x1cb < uVar10) goto LAB_0018fae0;
      if (0xac < uVar10) {
        if (uVar10 != 0xee) {
          if (uVar10 == 0x15f) goto LAB_0018fb68;
          if (uVar10 != 0xe5) goto LAB_0018fa90;
        }
        goto LAB_0018fa48;
      }
      if (uVar10 < 0xaa) {
        if (uVar10 == 0x18) goto LAB_0018f4a0;
        goto LAB_0018fa90;
      }
LAB_0018f9e8:
      uVar3 = 4;
...
LAB_0018fb68:
      ...
      if (uVar10 < 0x27a) {
        if (uVar10 != 0x200) {
          if (uVar10 == 0x203) goto LAB_0018fa48;
LAB_0018fa90:
          if (-1 < (long)uVar7) goto LAB_0018fae0;
      ...
      else if (uVar10 != 0x5df) goto LAB_0018fa90;
LAB_0018f4a0:
      if (uVar7 < 10) {
LAB_0018fb54:
        SStream_concat(param_3,&DAT_001fc238,uVar7);
      }
      else {
        if (uVar3 == 0) {
