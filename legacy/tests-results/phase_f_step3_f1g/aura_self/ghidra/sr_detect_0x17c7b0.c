          ...
          if (uVar11 < uVar3) {
            ...
            while( true ) {
              ...
              while ((*(int *)(lVar12 + 0x18) != piVar7[2] || (*piVar7 != 0xb))) {
                iVar20 = iVar20 + -1;
                piVar7 = piVar7 + -0x22;
                if (iVar20 == -1) goto joined_r0x0017cc40;
              }
...
LAB_0017cae8:
              ...
              if (uVar22 <= uVar19) {
                ...
                if (__ptr_00 == (void *)0x0) goto LAB_0017c9c8;
              }
              lVar12 = uVar21 * 0x10;
              ...
              *(undefined2 *)((long)__ptr_00 + lVar12 + 0xc) = 0;
              uVar21 = uVar15;
              if (uVar3 <= uVar25) {
                if (uVar19 + 1 < 2) goto LAB_0017cc44;
                goto LAB_0017c8d0;
              }
...
LAB_0017c8d0:
                ...
                iVar26 = -1;
                if (uVar25 < uVar3) goto LAB_0017cbc8;
              }
