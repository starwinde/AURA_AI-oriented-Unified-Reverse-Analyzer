...
/* WARNING: Removing unreachable block (ram,0x001ea56c) */
...

{
  ...
  if (uVar1 < 0x12) {
    ...
    case 0xe:
      ...
      break;
    default:
      goto switchD_001ea5fc_default;
    }
  }
  else {
    if ((0x19 < uVar1) || (uVar1 < 0x12)) {
switchD_001ea5fc_default:
