  ...
  if (uVar2 != 0) {
    ...
    do {
      ...
      if (((sVar4 == 0) || (*(char *)((long)piVar1 + sVar4 + 0x43) != '*')) &&
         (param_3 != (char *)0x0)) {
        if ((char)piVar1[1] == '\0') {
          __snprintf_chk(acStack_a8,0x40,2,0x40,&DAT_001fbbb0,*piVar1);
        }
        else {
          __snprintf_chk(acStack_a8,0x40,2,0x40,&DAT_001fbba8,piVar1 + 1);
        }
        pcVar5 = strstr(param_3,acStack_a8);
        fwrite(&DAT_001fafb0,1,4,param_2);
        if ((char)piVar1[1] == '\0') {
          puVar7 = &DAT_001f8ea0;
          if (pcVar5 == (char *)0x0) goto LAB_00182514;
          goto LAB_00182518;
        }
        puVar7 = &DAT_001f8ea0;
        if (pcVar5 == (char *)0x0) goto LAB_00182538;
LAB_00182480:
