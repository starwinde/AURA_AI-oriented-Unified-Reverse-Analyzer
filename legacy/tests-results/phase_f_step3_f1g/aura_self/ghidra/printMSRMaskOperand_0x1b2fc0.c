...

{
  ...
  if ((uVar7 & 1) == 0) {
    ...
    if (uVar3 >> 4 == 0) {
      ...
      SStream_concat0(param_3,&DAT_001fc638);
    }
    else {
      SStream_concat0(param_3,&DAT_001fc630);
    }
    if ((uVar4 & 0xf) == 0) {
      return;
    }
    SStream_concat0(param_3,&DAT_001fc640);
    if ((uVar4 >> 3 & 1) == 0) {
      uVar9 = 0;
      uVar11 = 1;
      uVar13 = 2;
      ...
      SStream_concat0(param_3,&DAT_001fc648);
      uVar9 = 8;
      uVar11 = 9;
      uVar13 = 10;
      uVar12 = 0xb;
    ...
    if ((uVar4 >> 1 & 1) != 0) {
      SStream_concat0(param_3,&DAT_001fc3d0);
      uVar11 = uVar12;
      uVar9 = uVar13;
    }
    if ((uVar4 & 1) != 0) {
  ...
  if (uVar4 == 0xffffffff) {
    if (uVar3 < 10) {
      SStream_concat(param_3,&DAT_001fc1e0,uVar3);
    }
    else {
      SStream_concat(param_3,&DAT_001fc610,uVar3);
    }
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
