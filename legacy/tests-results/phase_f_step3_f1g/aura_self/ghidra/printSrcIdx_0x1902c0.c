...
LAB_00190680:
            ...
            if (((((uVar1 != 1) &&
                  (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x1f)),_DAT_0020ab20
                          ), uVar1 != 2)) &&
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x2f)),_DAT_0020ab20)
                 , uVar1 != 3)) &&
                ((((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x3f)),
                 ...
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x8f)),_DAT_0020ab20)
                 , uVar1 != 9)))) &&
               ((((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x9f)),_DAT_0020ab20
                          ), uVar1 != 10 &&
                  (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xaf)),_DAT_0020ab20
                          ), uVar1 != 0xb)) &&
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xbf)),_DAT_0020ab20)
                 , uVar1 != 0xc)) &&
                ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xcf)),_DAT_0020ab20)
                 , uVar1 != 0xd &&
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xdf)),_DAT_0020ab20)
                 , uVar1 == 0xf)))))) {
              a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xef)),_DAT_0020ab20);
            }
            uVar9 = uVar7 & 0xf0;
            if ((uVar7 & 0xf) != 0) {
              uVar7 = uVar11 - uVar9;
              uVar13 = (ulong)((uVar7 & 0xff) + 1 & 0xff);
              if (6 < (uVar7 & 0xff)) goto LAB_00190644;
              goto LAB_00190680;
            }
          }
        }
          ...
          do {
            ...
            while (cVar3 != -0x80) {
              ...
              *pcVar4 = cVar3;
              pcVar8 = pcVar8 + -1;
              uVar7 = uVar1 & 0xff;
              if (uVar11 < (uVar1 & 0xff)) goto LAB_00190770;
              pcVar4 = pcVar4 + 1;
              cVar3 = *pcVar8;
            }
            uVar1 = uVar7 + 1;
...
joined_r0x001907a8:
  if (iVar5 != 0) {
    ...
    SStream_concat0(param_3,&DAT_001fc250);
  ...
  SStream_concat0(param_3,0x1fc000);
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 3) {
