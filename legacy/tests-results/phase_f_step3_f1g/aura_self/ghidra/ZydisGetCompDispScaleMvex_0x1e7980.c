...
/* WARNING: Removing unreachable block (ram,0x001e7b44) */
...
LAB_001e7a64:
      ...
      if (1 < uVar1 - 3) goto LAB_001e7a64;
      local_a = 2;
    }
  }
...
LAB_001e7d6c:
    ...
    if (0x19 < uVar1) goto LAB_001e7db4;
    if (uVar1 != 0x18) {
      if (0x18 < uVar1) goto LAB_001e7db4;
      if (uVar1 == 0x17) goto LAB_001e7d6c;
      if (0x17 < uVar1) {
LAB_001e7db4:
                    /* WARNING: Subroutine does not return */
...
LAB_001e7c88:
          ...
          if ((uVar1 < 0x16) && (uVar1 < 0x15)) {
            if (uVar1 < 10) {
              ...
              if ((uVar6 & 0x288) != 0) goto LAB_001e7c88;
            }
          }
        }
        goto LAB_001e7db4;
