        ...
        do {
          ...
          *(long *)(piVar5 + 2) = lVar11;
          ...
          if ((uVar7 & 1) == 0) {
            ...
            if ((*(byte *)(param_1 + 0x20) & 1) == 0) goto joined_r0x0018ca98;
            bVar2 = *(byte *)((long)param_1 + 0x81);
            __n = (size_t)bVar2;
            if (uVar12 < bVar2) goto joined_r0x0018ca98;
...
LAB_0018c7bc:
        ...
        uVar13 = uVar14;
joined_r0x0018ca98:
        if (local_6a8 == 0) goto LAB_0018c988;
        piVar5 = local_688;
        if ((uVar13 != local_69c) &&
