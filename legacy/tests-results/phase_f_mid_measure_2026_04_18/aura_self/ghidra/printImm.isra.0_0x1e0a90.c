  ...
  if ((param_5 & 1) == 0) {
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_4 != 0x8000000000000000) {
          lVar1 = -param_4;
          if (-10 < (long)param_4) {
            SStream_concat(param_3,&DAT_001fd730,lVar1);
            return;
          }
          do {
            param_4 = param_4 >> 4;
      ...
      if ((long)param_4 < 10) goto LAB_001e0ac8;
      if (param_4 < 0x10) goto LAB_001e0c1c;
      do {
        param_4 = param_4 >> 4;
      } while (0xf < param_4);
      goto joined_r0x001e0b38;
    }
    if ((long)param_4 < 0) {
      if (param_4 == 0x8000000000000000) {
      ...
      if (-10 < (long)param_4) {
        SStream_concat(param_3,&DAT_001fd730,-param_4);
        return;
      }
    ...
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_1 == '\0') {
LAB_001e0c34:
          if (param_4 != 0x8000000000000000) goto LAB_001e0c48;
LAB_001e0c84:
        ...
        if (param_1 == '\x02') {
          ...
          if (param_1 != '\x01') goto LAB_001e0c34;
...
joined_r0x001e0b38:
      if (param_4 < 10) {
        SStream_concat(param_3,&DAT_002032c8);
        return;
      }
LAB_001e0c1c:
  ...
  if ((long)param_4 < 10) {
LAB_001e0ac8:
    SStream_concat(param_3,&DAT_001fb420);
    return;
  }
LAB_001e0ab8:
