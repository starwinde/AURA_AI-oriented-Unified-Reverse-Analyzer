...

{
  ...
  case 4:
    ...
    break;
  case 5:
    SStream_concat0(param_3,&DAT_00203420);
    op_addAvxCC(param_1,6);
    break;
  case 6:
    SStream_concat0(param_3,&DAT_001f9d98);
    op_addAvxCC(param_1,7);
    break;
  case 7:
    SStream_concat0(param_3,&DAT_00203428);
  ...
  case 8:
    ...
    break;
  case 9:
    SStream_concat0(param_3,&DAT_001f9d90);
    op_addAvxCC(param_1,10);
    break;
  case 10:
    SStream_concat0(param_3,&DAT_00203438);
