...
LAB_0015d720:
    if ((*(byte *)(param_8 + local_c8) & 1) != 0) goto LAB_0015d860;
    lVar15 = *param_1;
    *(undefined1 *)(param_8 + local_c8) = 1;
    ...
    if ((int)uVar5 < 0) {
      if (((*(byte *)(param_4 + local_c8) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
        ...
        piVar23 = (int *)0x0;
        if (uVar5 != 0) goto LAB_0015d7b0;
      }
    }
    else {
      piVar23 = (int *)(*(long *)(lVar21 + 8) + (long)(int)uVar5 * 0x88);
      do {
        if (*piVar23 - 0x17U < 2 || *piVar23 == 0x1a) goto LAB_0015d798;
...
LAB_0015f240:
                  ...
                  do {
                    ...
                    if ((uVar4 == (uint)uVar17) || (uVar5 = uVar5 + 1, uVar19 < uVar5)) {
                      if (uVar16 < uVar19) {
                        if (uVar16 != uVar18) goto LAB_0015ede8;
                        uVar16 = (uint)uVar20;
                        uVar20 = local_c8;
                      }
                      break;
...
joined_r0x0015f290:
                  uVar17 = uVar20;
                  uVar4 = uVar16;
                  if (puVar10 != (uint *)0x0) goto LAB_0015e8ec;
                }
LAB_0015ee24:
                iVar6 = 0x10;
                do {
                ...
                if (piVar23[0x12] == 0) {
                  fwrite(&DAT_001fa3e0,1,4,param_9);
                }
                else if (piVar23[6] == -1) {
                  fwrite("__undef",1,7,param_9);
                }
                else {
                  __fprintf_chk(param_9,2,&DAT_001fa488);
                }
                fwrite(&DAT_001fa598,1,4,param_9);
              }
              else {
                if ((uVar19 <= uVar16) ||
...
LAB_0015ede8:
                ...
                do {
                  ...
                  goto joined_r0x0015f290;
                  uVar4 = uVar9;
                } while (uVar9 != uVar18);
                uVar17 = (ulong)uVar16;
                uVar4 = (uint)uVar20;
                if (puVar10 == (uint *)0x0) goto LAB_0015ee24;
LAB_0015e8ec:
                ...
                __fprintf_chk(param_9,2,&DAT_001fa488,puVar10[8]);
                uVar16 = puVar10[0x10];
                if (uVar16 == 0x10) {
LAB_0015f37c:
                  fwrite(&DAT_001fa550,1,4,param_9);
                }
                else if (uVar16 < 0x11) {
                  if (uVar16 != 0xd) {
                    if (uVar16 < 0xe) {
                      if (uVar16 == 0xb) {
                        fwrite(&DAT_001fa570,1,4,param_9);
                      }
                      else {
                        if (uVar16 != 0xc) goto LAB_0015f5ac;
                        fwrite(&DAT_001fa568,1,4,param_9);
                      }
                      goto LAB_0015e9a4;
                    }
                    if (uVar16 == 0xe) goto LAB_0015f37c;
                  }
                  fwrite(&DAT_001fa548,1,3,param_9);
                }
                else if (uVar16 == 0x13) {
LAB_0015f398:
                  fwrite(&DAT_001fa558,1,3,param_9);
                }
                else {
                  if (uVar16 < 0x14) {
                    if (uVar16 == 0x11) goto LAB_0015f398;
                  }
                  else if (uVar16 != 0x14) {
LAB_0015f5ac:
                    fwrite(&DAT_001fa4b8,1,3,param_9);
                    goto LAB_0015e9a4;
                  }
                  fwrite(&DAT_001fa560,1,4,param_9);
                }
LAB_0015e9a4:
                __fprintf_chk(param_9,2,"v%u; ",puVar10[0xf]);
                __fprintf_chk(param_9,2,&DAT_001fa488,puVar10[8]);
                if (puVar10[0xe] == 2) {
                  fwrite(&DAT_001fa580,1,4,param_9);
                }
                else {
                  fwrite(&DAT_001fa588,1,4,param_9);
                }
              ...
              fwrite(&DAT_001f99c8,1,2,param_9);
              uVar16 = *(uint *)(param_1 + 1);
              if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_0015d860;
...
LAB_0015e27c:
              ...
              lVar15 = extraout_x12;
              uVar16 = extraout_w11;
              if (uVar5 < extraout_w11) goto LAB_0015dd24;
            }
          }
        }
        else {
LAB_0015d7b0:
          ...
          do {
            if (*puVar10 == uVar18) goto LAB_0015d7e0;
            uVar4 = uVar4 + 1;
...
LAB_0015d7e0:
          if (piVar23 != (int *)0x0) {
            if (*piVar23 == 0x17) {
              ...
              uVar16 = piVar23[0x1a];
              cf_emit_block_body_part_0_isra_0(lVar15,local_c8,param_9,4);
              if (puVar10 == (uint *)0x0) goto LAB_0015f1bc;
              uVar4 = puVar10[5];
              uVar19 = *(uint *)(param_1 + 1);
              if (uVar4 < uVar19) {
                if (uVar5 == uVar4) {
                ...
                if (uVar5 < uVar19) {
                  lVar15 = *param_1;
                  if (uVar5 != uVar18) goto LAB_0015f240;
                }
...
LAB_0015ddac:
                ...
                fwrite(&DAT_001fa508,1,3,param_9);
                uVar16 = *(uint *)(param_1 + 1);
                if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_0015d860;
                local_c8 = (ulong)uVar4;
                goto LAB_0015d720;
      ...
      if (piVar11[4] != 0) {
        do {
          ...
          if ((*(byte *)(lVar21 + 0xc) & 1) == 0) {
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar5 < uVar16) goto LAB_0015e734;
LAB_0015e6a8:
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar16 <= uVar5) goto LAB_0015e6a8;
LAB_0015e734:
            pvVar12 = calloc((ulong)uVar16,1);
            if (pvVar12 == (void *)0x0) goto LAB_0015e6a8;
            uVar4 = piVar11[8];
...
LAB_0015e7f0:
      ...
      uVar16 = *(uint *)(param_1 + 1);
      uVar5 = piVar11[6];
      if (uVar5 < uVar16 && param_3 != uVar5) goto LAB_0015e1c0;
      goto LAB_0015d860;
    }
...
LAB_0015e184:
    ...
    if (piVar23 == (int *)0x0) goto LAB_0015d860;
    iVar6 = *piVar23;
    if (iVar6 == 0x18) {
      uVar5 = piVar23[0x19];
      uVar16 = *(uint *)(param_1 + 1);
      if (param_3 != uVar5 && uVar5 < uVar16) goto LAB_0015e1c0;
      goto LAB_0015d860;
    }
    if (iVar6 == 0x1a) {
      iVar6 = 0x10;
        ...
        if (piVar23[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              lVar15 = lVar15 + 1;
              uVar16 = (uint)lVar15;
              if ((uint)piVar23[0x18] <= uVar16) goto LAB_0015e250;
            }
            __fprintf_chk(param_9,2,&DAT_001fa488);
            lVar15 = lVar15 + 1;
...
LAB_0015e250:
    ...
    if (iVar6 != 0x17) goto LAB_0015d860;
    uVar16 = piVar23[0x19];
    uVar5 = piVar23[0x1a];
...
LAB_0015e410:
        ...
        if (uVar4 < uVar18) goto LAB_0015d8dc;
        local_80[0] = uVar18;
        local_78 = param_5;
        plStack_70 = param_1;
        ...
        fwrite(&DAT_001fa638,1,4,param_9);
        if (piVar23[0x12] == 0) {
          fwrite(&DAT_001fa3e0,1,4,param_9);
        }
        else if (piVar23[6] == -1) {
      ...
      uVar18 = *(uint *)(param_1 + 1);
      if (uVar18 <= uVar4) goto LAB_0015e410;
LAB_0015d8dc:
      uVar20 = (ulong)uVar4;
      if (uVar5 == uVar4) {
        iVar6 = 0x10;
            ...
            if (uVar5 != 0) {
              ...
              do {
                ...
                if ((*(int *)(*(long *)(lVar15 + 8) + lVar21 * 0x88) == 0x1b) &&
                  ...
                  uVar17 = 0;
LAB_0015ec40:
                  if (uVar16 != *(uint *)(*(long *)(lVar22 + 0x58) + uVar17 * 4)) goto LAB_0015ec34;
                  iVar6 = 0x14;
                  do {
                    fputc(0x20,param_9);
                    iVar6 = iVar6 + -1;
                  ...
                  fwrite(&DAT_001fa490,1,3,param_9);
...
LAB_0015da44:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar18 = *(uint *)(lVar15 + 0x10);
                    if (uVar18 <= (uint)lVar21) goto LAB_0015daf4;
                  }
LAB_0015d9f8:
                  lVar21 = lVar21 + 1;
...
LAB_0015dc0c:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar16 = *(uint *)(lVar15 + 0x10);
                    if (uVar16 <= (uint)lVar21) goto LAB_0015dcb8;
                  }
LAB_0015dbc0:
                  lVar21 = lVar21 + 1;
                } while ((uint)lVar21 < uVar16);
...
LAB_0015dcb8:
    ...
    if (1 < iVar6 - 1U) {
      if (1 < iVar7 - 1U) goto LAB_0015d8bc;
      iVar6 = 0x10;
      do {
        fputc(0x20,param_9);
        iVar6 = iVar6 + -1;
      ...
      if (*(uint *)(param_1 + 1) <= uVar16 || param_3 == uVar16) goto LAB_0015d860;
      bVar2 = *(byte *)(param_8 + (ulong)uVar16);
      uVar5 = uVar16;
      goto joined_r0x0015e3a4;
    }
    iVar8 = 0x10;
    if (iVar7 - 1U < 2) {
      do {
...
LAB_0015e1c0:
  ...
  if ((*(byte *)(param_8 + (ulong)uVar5) & 1) != 0) goto LAB_0015d860;
  goto LAB_0015d720;
LAB_0015ec34:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015ebf4;
  goto LAB_0015ec40;
LAB_0015e048:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015e008;
  goto LAB_0015e054;
LAB_0015da38:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_0015d9f8;
  goto LAB_0015da44;
LAB_0015dc00:
  uVar17 = uVar17 + 1;
  if (*(uint *)(lVar22 + 0x60) == uVar17) goto LAB_0015dbc0;
  goto LAB_0015dc0c;
}
