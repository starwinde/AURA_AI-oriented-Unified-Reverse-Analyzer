...
LAB_001bb690:
        *(undefined2 *)(lVar7 + 0x79) = 0x101;
        ...
        if ((uVar4 & 0x18804080001111) != 0) goto LAB_001bb690;
      ...
      if (0xb05 < uVar1) {
        ...
        if ((uVar4 & 0x40810202081111) != 0) goto LAB_001bb690;
        uVar4 = uVar4 & 0x81020404102222;
joined_r0x001bb678:
        if (uVar4 != 0) goto LAB_001bb4d0;
      }
    }
    else if (uVar1 - 0xbcd < 0x2f) {
      uVar4 = 1L << ((ulong)(uVar1 - 0xbcd) & 0x3f);
      if ((uVar4 & 0x208084001111) != 0) goto LAB_001bb690;
