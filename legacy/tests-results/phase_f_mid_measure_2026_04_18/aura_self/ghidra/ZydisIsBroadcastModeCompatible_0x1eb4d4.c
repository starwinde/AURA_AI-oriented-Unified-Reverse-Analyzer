...
LAB_001eb584:
      ...
      if (param_2 == 1) {
        ...
        if (param_2 != 2) goto LAB_001eb584;
        local_7 = 0x20;
      }
    }
...
LAB_001eb738:
      ...
      if (bVar2 == 0x10) {
        ...
        if (0x10 < bVar2) goto LAB_001eb738;
        if (bVar2 == 8) {
          local_4 = 3;
        }
        else {
          if (8 < bVar2) goto LAB_001eb738;
          if (bVar2 == 2) {
            local_4 = 1;
          }
          else {
            if (bVar2 != 4) goto LAB_001eb738;
            local_4 = 2;
          }
        }
      }
