...
uint FUN_00198cac(long param_1,ulong param_2)

{
  ...
  iVar11 = (int)uVar12;
  if (uVar5 < 0x288) {
    if (0x284 < uVar5) goto LAB_00198e50;
LAB_00198d40:
    uVar5 = 3;
    uVar6 = MCInst_getOpcode(param_1);
    if (0x29a < uVar6) goto LAB_00198e70;
LAB_00198d50:
    if (uVar6 < 0x285) goto LAB_00198da8;
...
LAB_00199128:
        if (uVar15 != 0xf) goto LAB_00198da8;
        goto LAB_00198dac;
      }
      if ((uVar3 & 1) == 0) {
        ...
        if ((uVar4 & 1) == 0 && uVar2 == 0) goto LAB_00198db0;
        if ((uVar17 == 0xf) != 0 || uVar15 == uVar17) {
          uVar6 = 1;
        }
      }
      else {
        if (uVar15 == 0xf) goto LAB_00198dac;
        uVar6 = uVar14;
        if ((uVar4 & 1) == 0 && uVar2 == 0 || uVar15 != uVar17) goto LAB_00198da8;
      }
      goto LAB_00198ef0;
    }
    if ((uVar9 & 0xc80) != 0) {
      if ((uVar7 & uVar17 == 0xf) != 0) goto LAB_00199128;
      if (uVar15 == 0xf) {
        uVar5 = uVar14;
      }
    ...
    if ((uVar9 & 7) == 0) goto LAB_00198da8;
    if ((uVar7 & uVar17 == 0xf) != 0) {
      if (uVar15 == 0xe) goto LAB_00198dac;
      goto LAB_00198da8;
    }
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar6 = uVar14;
      if (((uVar4 & 1) != 0 || uVar2 != 0) && (uVar17 == 0xf) != 0) goto LAB_00199238;
    }
...
LAB_00198fb4:
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) goto LAB_00198f64;
        uVar10 = *(undefined2 *)(GPR + uVar18 * 2);
        goto LAB_00198fe0;
      }
    }
    else if (uVar7 - 0x360 < 3) goto LAB_00198fb4;
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar18 * 2));
  }
  else {
    if (2 < uVar5 - 0x360) goto LAB_00198d40;
LAB_00198e50:
    ...
    uVar6 = MCInst_getOpcode(param_1);
    if (uVar6 < 0x29b) goto LAB_00198d50;
LAB_00198e70:
    if (uVar6 == 0x367) {
LAB_001990fc:
      uVar6 = uVar5;
    ...
    if (uVar6 < 0x368) {
      if (uVar6 - 0x360 < 3) {
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) {
          ...
          else if (uVar17 == uVar15 + 1) goto LAB_00199238;
        }
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) goto LAB_00198ef0;
        goto LAB_00198db0;
      }
    }
    else if (uVar6 - 0x36a < 2) goto LAB_001990fc;
LAB_00198da8:
    uVar14 = uVar5;
LAB_00198dac:
    uVar6 = uVar14;
...
LAB_00198ef0:
    ...
    *(undefined1 *)(param_1 + 0x335) = 1;
    ...
    if ((0xb < iVar8 - 0x360U) || ((0xc87UL >> ((ulong)(iVar8 - 0x360U) & 0x3f) & 1) == 0)) {
      ...
      uVar7 = MCInst_getOpcode(param_1);
      if (uVar7 < 0x288) {
        if (uVar7 < 0x285) goto LAB_00198f64;
      }
      else {
joined_r0x00199248:
        if (2 < uVar7 - 0x360) goto LAB_00198f64;
      }
      goto LAB_00198fb4;
    }
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar18 * 2));
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar16 * 2));
    uVar7 = MCInst_getOpcode(param_1);
    if (0x287 < uVar7) goto joined_r0x00199248;
    if (0x284 < uVar7) goto LAB_00198fb4;
LAB_00198f64:
    iVar8 = MCInst_getOpcode(param_1);
