      ...
      do {
        while( true ) {
          ...
          *(undefined4 *)(pcVar13 + 0xc0) = *(undefined4 *)(lVar19 + 0xd0);
          ...
          if (*(uint *)(__s + 0xdd0) <= uVar25) goto LAB_001819d8;
        }
...
LAB_001819d8:
    ...
    if ((*(byte *)(param_5 + 0x12) & 1) == 0) {
      *(undefined4 *)(__s + 0x88) = DAT_001f9df8;
      __s[0x8c] = cVar4;
      __s[0x108] = '\0';
      __s[0x109] = '\0';
      __s[0x10a] = '\0';
...
LAB_00181e1c:
            ...
            uVar23 = *puVar21;
            sVar26 = sVar27;
            if (uVar23 <= uVar25) goto LAB_00181ad0;
          }
          uVar25 = uVar25 + 1;
          lVar24 = lVar24 + 0x88;
        } while (uVar25 < uVar23);
...
LAB_00181bbc:
              ...
              if (*puVar21 <= uVar20) goto LAB_00181bd0;
            }
            ...
            do {
              while (uVar3 = *(uint *)(lVar19 + lVar24 * 0x10), uVar23 <= uVar3) {
                lVar24 = lVar24 + 1;
                if (uVar5 <= (uint)lVar24) goto LAB_00181bbc;
              }
              lVar24 = lVar24 + 1;
              *(int *)((long)pvVar11 + (ulong)uVar3 * 4) =
                   *(int *)((long)pvVar11 + (ulong)uVar3 * 4) + 1;
