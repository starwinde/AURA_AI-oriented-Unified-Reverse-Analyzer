...

{
  ...
  if ((param_2 == (long *)0x0) || (lVar14 = *param_2, lVar14 == 0)) goto LAB_001f3f84;
  uVar2 = param_2[1];
  uVar10 = param_2[2];
  uVar6 = uVar10 + 4;
  if (uVar2 < uVar6) {
    ...
    {
LAB_001f3f40:
      if (uVar2 <= uVar10) goto LAB_001f3f84;
          ...
          if (uVar10 < uVar2) {
            do {
              if (0x20 < *(byte *)(lVar14 + uVar10)) {
                if (uVar2 == uVar10) goto LAB_001f45e0;
                uVar10 = param_2[2];
                if (uVar2 <= uVar10) goto LAB_001f4594;
                goto LAB_001f43fc;
              }
              uVar10 = uVar10 + 1;
              param_2[2] = uVar10;
...
LAB_001f43fc:
              if (*(char *)(lVar14 + uVar10) == ']') {
                ...
                do {
                  ...
                  puVar13 = puVar12;
                  if (puVar7 == (undefined8 *)0x0) goto LAB_001f45a0;
                  puVar7[1] = 0;
                  *puVar7 = 0;
                  puVar7[3] = 0;
                  puVar7[2] = 0;
                  ...
                  if (iVar4 == 0) goto LAB_001f4578;
                  lVar14 = *param_2;
                  uVar6 = param_2[1];
                  uVar10 = param_2[2];
                  if (lVar14 == 0) {
LAB_001f44e4:
                    if (uVar6 <= uVar10) goto LAB_001f4578;
                  }
                  else {
                    if (uVar6 <= uVar10) goto LAB_001f4578;
                    do {
                      if (0x20 < *(byte *)(lVar14 + uVar10)) {
                        if (uVar10 != uVar6) goto LAB_001f44e4;
                        break;
                      }
                      uVar10 = uVar10 + 1;
                      param_2[2] = uVar10;
                ...
                if ((uVar6 <= uVar10) || (*(char *)(lVar14 + uVar10) != ']')) goto LAB_001f4578;
        ...
        if (uVar10 < uVar2) {
          do {
            if (0x20 < *(byte *)(lVar14 + uVar10)) {
              if (uVar2 == uVar10) goto LAB_001f45f4;
              uVar10 = param_2[2];
              if (uVar2 <= uVar10) goto LAB_001f4594;
              goto LAB_001f4084;
            }
...
LAB_001f416c:
                ...
                if (*(char *)(lVar14 + uVar10) != ':') goto LAB_001f4578;
                uVar10 = uVar10 + 1;
                param_2[2] = uVar10;
...
LAB_001f421c:
                  ...
                  do {
                    if (0x20 < *(byte *)(lVar14 + uVar10)) {
                      if (uVar10 != uVar6) goto LAB_001f421c;
                      break;
                    }
                    uVar10 = uVar10 + 1;
                    param_2[2] = uVar10;
