  ...
  do {
    ...
    if (uVar27 != 0) {
      ...
      if (uVar27 - 1 < 4) {
        ...
        if ((uVar27 & 3) == 0) goto LAB_001586b4;
      }
...
LAB_00158724:
          ...
          if (uVar5 <= uVar27) goto LAB_00158808;
        }
        uVar17 = piVar23[0x18];
        if ((uVar17 == 0) ||
...
LAB_00158cc4:
        ...
        uVar5 = *(uint *)(param_1 + 1);
        local_18[4] = 0;
        if (uVar5 <= uVar18) goto LAB_00158ce4;
      }
    }
LAB_00158ce4:
    if ((int)uVar24 == 0) goto LAB_00158d18;
  }
  else {
    piVar12 = piVar21;
    do {
...
LAB_00158920:
    if ((int)uVar15 == 0) {
      uVar27 = piVar25[5];
      uVar17 = uVar18;
      if (uVar27 <= uVar18) goto LAB_00158950;
...
LAB_00158950:
    ...
    if (pvVar6 == (void *)0x0) goto LAB_00158a20;
    uVar18 = piVar25[4];
...
LAB_00158a30:
  lVar13 = lVar13 + 4;
  if ((ulong)uVar5 << 2 == lVar13) goto LAB_00158a3c;
  goto LAB_00158850;
  while( true ) {
    uVar17 = (int)uVar15 - 1;
    uVar15 = (ulong)uVar17;
...
LAB_00158ad0:
    if ((int)uVar15 == 0) {
      ...
      uVar17 = uVar18;
      if (uVar27 <= uVar18) goto LAB_00158b14;
      lVar10 = (ulong)uVar18 * 0x88;
      goto LAB_00158b90;
    }
  }
...
LAB_00158bdc:
  lVar13 = lVar13 + 4;
  if ((ulong)uVar5 << 2 == lVar13) goto LAB_00158be8;
  goto LAB_00158a70;
}
