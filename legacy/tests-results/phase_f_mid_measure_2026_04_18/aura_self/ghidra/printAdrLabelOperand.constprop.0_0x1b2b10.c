...
void printAdrLabelOperand_constprop_0(long param_1,undefined8 param_2,uint param_3)

{
  ...
  if (iVar2 == -0x80000000) {
    SStream_concat0(param_2,&DAT_001fd938);
    ...
    if (iVar2 < 0) {
      ...
      SStream_concat(param_2,&DAT_001fd738,iVar2);
    }
    else {
      SStream_concat(param_2,"#0x%x",iVar2);
    }
