    ...
    do {
      ...
      *(undefined1 *)(lVar17 + uVar25) = 1;
      ...
      if (-1 < (int)uVar16) {
        ...
        do {
          if (*piVar8 - 0x17U < 2 || *piVar8 == 0x1a) goto LAB_00180530;
          piVar8 = piVar8 + -0x22;
          ...
          if (puVar10 != (undefined4 *)0x0) {
            ...
            *puVar10 = 10;
            ...
            if (puVar14 != (undefined4 *)0x0) {
              *puVar14 = 0xd;
              puVar14[0x26] = uVar4;
              __snprintf_chk(puVar14 + 0x27,0x40,2,0x40,&DAT_001fa488);
            }
            ...
            if (puVar14 != (undefined4 *)0x0) {
              ...
              *puVar14 = 0xf;
              ...
              if (puVar15 != (undefined4 *)0x0) {
                *puVar15 = 0xd;
                puVar15[0x26] = uVar4;
                __snprintf_chk(puVar15 + 0x27,0x40,2,0x40,&DAT_001fa488);
              }
          ...
          *(void **)(puVar9 + 0x2c) = pvVar11;
          if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
            ...
            if (uVar26 <= uVar16) {
              ...
              if (pvVar11 == (void *)0x0) goto LAB_00180ed4;
              uVar16 = param_4[0x28];
...
joined_r0x00180b84:
            if (iVar3 != 0x17) {
              emit_block_stmts(param_1,uVar25,param_4);
              if (*(uint *)(lVar21 + 0x30) < 3) goto LAB_00180590;
              puVar9 = calloc(1,0x130);
            ...
            *(void **)(puVar9 + 0x28) = pvVar11;
            if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
              ...
              if (uVar22 <= uVar16) {
                ...
                if (pvVar11 == (void *)0x0) goto LAB_00180cc4;
                uVar16 = param_4[0x28];
                *(void **)(param_4 + 0x26) = pvVar11;
...
LAB_001817cc:
            *(void **)(puVar9 + 0x28) = pvVar11;
            if (uVar26 < uVar16) goto LAB_00181360;
LAB_00180e00:
            puVar10 = calloc(1,0x130);
            if (puVar10 != (undefined4 *)0x0) {
              *puVar10 = 0xe;
...
LAB_001817c8:
              ...
              *(undefined1 *)(lVar21 + uVar25) = 1;
              ...
              uVar16 = *(uint *)(local_190 + 1);
              pvVar12 = calloc((ulong)uVar16,1);
              if (pvVar12 == (void *)0x0) goto LAB_001817c8;
              lVar21 = param_1[6];
              __memcpy_chk(pvVar12,lVar21,(ulong)uVar16);
              uVar22 = *(uint *)(lVar17 + 4);
              *(undefined1 *)(lVar21 + uVar25) = 1;
...
LAB_00180ed4:
      ...
      if (2 < *(uint *)(lVar21 + 0x30)) {
        ...
        if (puVar9 != (undefined4 *)0x0) {
          *puVar9 = 5;
          if (piVar8 == (int *)0x0) goto LAB_00180888;
LAB_00180880:
          if (piVar8[0x12] == 0) goto LAB_00180888;
          puVar10 = (undefined4 *)build_expr(param_1,piVar8[6]);
LAB_0018092c:
      ...
      if (iVar1 != 0x18) {
        ...
        *(void **)(puVar9 + 0x28) = pvVar11;
        if (uVar26 < uVar16) {
          ...
          if ((param_4 != (int *)0x0) && (*param_4 == 0)) goto LAB_0018072c;
        }
        else {
LAB_00180fa0:
          if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
LAB_0018072c:
            ...
            if (uVar26 <= uVar16) {
              pvVar11 = realloc(pvVar11,((ulong)uVar26 & 0x7fffffff) << 4);
              if (pvVar11 == (void *)0x0) goto LAB_00180748;
              uVar16 = param_4[0x28];
              *(void **)(param_4 + 0x26) = pvVar11;
              param_4[0x29] = uVar26 << 1;
            }
    ...
    if (piVar8 == (int *)0x0) {
      ...
      *(void **)(piVar8 + 0x26) = pvVar11;
      ...
      if ((puVar10 != (undefined4 *)0x0) && (*puVar10 = 8, *piVar8 == 0)) {
        ...
        if (uVar26 <= uVar16) {
          pvVar11 = realloc(pvVar11,((ulong)uVar26 & 0x7fffffff) << 4);
          if (pvVar11 == (void *)0x0) goto LAB_00180a68;
          uVar16 = piVar8[0x28];
          *(void **)(piVar8 + 0x26) = pvVar11;
...
LAB_00180a84:
  if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
    ...
    if (uVar26 <= uVar16) {
      pvVar11 = realloc(pvVar11,((ulong)uVar26 & 0x7fffffff) << 4);
      if (pvVar11 == (void *)0x0) goto LAB_001805bc;
      uVar16 = param_4[0x28];
      *(void **)(param_4 + 0x26) = pvVar11;
      param_4[0x29] = uVar26 << 1;
    }
