...
LAB_0015b9f0:
  if ((*(byte *)(param_8 + uVar16) & 1) != 0) goto LAB_0015bb28;
  lVar20 = *param_1;
  *(undefined1 *)(param_8 + uVar16) = 1;
  ...
  if ((int)uVar6 < 0) {
    if (((*(byte *)(param_4 + uVar16) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
      ...
      piVar26 = (int *)0x0;
      if (uVar6 != 0) goto LAB_0015ba7c;
    }
  }
  else {
    piVar26 = (int *)(*(long *)(lVar24 + 8) + (long)(int)uVar6 * 0x88);
    do {
      if (*piVar26 - 0x17U < 2 || *piVar26 == 0x1a) goto LAB_0015ba64;
...
LAB_0015cd74:
              if (puVar12 != (uint *)0x0) goto LAB_0015c9a4;
            }
LAB_0015cd78:
            iVar7 = 0;
            if (0 < param_10) {
...
LAB_0015c118:
            ...
            lVar20 = extraout_x12;
            uVar21 = extraout_w11;
            if (uVar6 < extraout_w11) goto LAB_0015bdd4;
          }
        }
      }
      else {
LAB_0015ba7c:
        ...
        do {
          if (*puVar12 == uVar22) goto LAB_0015baac;
          uVar5 = uVar5 + 1;
...
LAB_0015baac:
        if (piVar26 != (int *)0x0) {
          if (*piVar26 == 0x17) {
            ...
            uVar6 = piVar26[0x1a];
            cf_emit_block_body_part_0_isra_0(lVar20,uVar16,param_9,param_10);
            if (puVar12 == (uint *)0x0) goto LAB_0015d108;
            uVar19 = *(uint *)(param_1 + 1);
            uVar5 = puVar12[5];
            uVar10 = uVar21;
            if (uVar5 < uVar19) {
              ...
              if (uVar21 < uVar19) {
                lVar20 = *param_1;
                if (uVar21 != uVar22) goto LAB_0015d1dc;
              }
              else if ((uVar6 < uVar19) &&
                      (lVar20 = *param_1, uVar5 = uVar21, uVar10 = uVar22, uVar6 != uVar22))
              goto LAB_0015cd3c;
...
LAB_0015c9a4:
            if ((puVar12[6] != 3) || ((puVar12[0x11] & 1) == 0)) goto LAB_0015cd78;
            iVar7 = 0;
            if (0 < param_10) {
              do {
                iVar7 = iVar7 + 1;
            ...
            __fprintf_chk(param_9,2,&DAT_001fa488,puVar12[8]);
            uVar21 = puVar12[0x10];
            if (uVar21 == 0x10) {
LAB_0015d2b8:
              ...
              if (uVar21 != 0xd) {
                if (uVar21 < 0xe) {
                  if (uVar21 == 0xb) {
                    ...
                    if (uVar21 != 0xc) goto LAB_0015d358;
                    fwrite(&DAT_001fa568,1,4,param_9);
                  }
                  goto LAB_0015ca58;
                }
                if (uVar21 == 0xe) goto LAB_0015d2b8;
              }
...
LAB_0015d2d4:
              ...
              if (uVar21 < 0x14) {
                if (uVar21 == 0x11) goto LAB_0015d2d4;
              }
              else if (uVar21 != 0x14) {
LAB_0015d358:
...
LAB_0015cad8:
            ...
            uVar21 = *(uint *)(param_1 + 1);
            if (uVar21 <= uVar5 || param_3 == uVar5) goto LAB_0015bb28;
            uVar16 = (ulong)uVar5;
            goto LAB_0015b9f0;
          }
          if (*piVar26 == 0x18) {
...
LAB_0015be5c:
              ...
              uVar21 = *(uint *)(param_1 + 1);
              if (uVar5 == param_3 || uVar21 <= uVar5) goto LAB_0015bb28;
              uVar16 = (ulong)uVar5;
              goto LAB_0015b9f0;
            }
          }
    ...
    if (piVar13[4] != 0) {
      ...
      do {
        ...
        if ((*(byte *)(lVar24 + 0xc) & 1) == 0) {
          ...
          uVar21 = *(uint *)(param_1 + 1);
          uVar6 = *(uint *)(lVar24 + 8);
          if (uVar6 < uVar21) goto LAB_0015c648;
LAB_0015c5a4:
          ...
          uVar21 = *(uint *)(param_1 + 1);
          uVar6 = *(uint *)(lVar24 + 8);
          if (uVar21 <= uVar6) goto LAB_0015c5a4;
LAB_0015c648:
          pvVar14 = calloc((ulong)uVar21,1);
          if (pvVar14 == (void *)0x0) goto LAB_0015c5a4;
          uVar5 = piVar13[8];
...
LAB_0015c700:
    ...
    uVar21 = *(uint *)(param_1 + 1);
    uVar6 = piVar13[6];
    if (uVar6 < uVar21 && uVar6 != param_3) goto LAB_0015c0ec;
    goto LAB_0015bb28;
  }
...
LAB_0015c0b0:
  ...
  if (piVar26 == (int *)0x0) goto LAB_0015bb28;
  iVar7 = *piVar26;
  if (iVar7 == 0x18) {
    uVar6 = piVar26[0x19];
    uVar21 = *(uint *)(param_1 + 1);
    if (param_3 != uVar6 && uVar6 < uVar21) goto LAB_0015c0ec;
    goto LAB_0015bb28;
  }
  if (iVar7 == 0x1a) {
    iVar7 = 0;
      ...
      if (piVar26[0x18] != 0) {
        do {
          ...
          while( true ) {
            ...
            lVar20 = lVar20 + 1;
            uVar21 = (uint)lVar20;
            if ((uint)piVar26[0x18] <= uVar21) goto LAB_0015c808;
          }
          __fprintf_chk(param_9,2,&DAT_001fa488);
          lVar20 = lVar20 + 1;
...
LAB_0015c068:
  ...
  if (iVar7 != 0x17) goto LAB_0015bb28;
  uVar21 = piVar26[0x19];
  uVar6 = piVar26[0x1a];
  if ((param_5 != (undefined8 *)0x0) && (param_3 < *(uint *)(param_1 + 1))) {
    ...
    if (iVar7 - 1U < 2) {
      ...
      if (1 < iVar8 - 1U) goto LAB_0015bb8c;
      iVar7 = 0;
      if (0 < param_10) {
        do {
          iVar7 = iVar7 + 1;
...
LAB_0015c2d8:
    ...
    uVar22 = *(uint *)(param_1 + 1);
    if (uVar22 <= uVar5) goto LAB_0015c2d8;
  }
  uVar23 = (ulong)uVar5;
  if (uVar5 == uVar6) {
    iVar7 = 0;
    ...
    if (uVar5 == uVar21) {
      ...
      if (iVar4 < 1) {
        fwrite("} else {\n",1,9,param_9);
        pvVar14 = calloc((ulong)*(uint *)(param_1 + 1),1);
        if (pvVar14 != (void *)0x0) goto LAB_0015bd0c;
      }
      else {
        iVar7 = 0;
        do {
...
LAB_0015c0ec:
  uVar16 = (ulong)uVar6;
  if ((*(byte *)(param_8 + (ulong)uVar6) & 1) != 0) goto LAB_0015bb28;
  goto LAB_0015b9f0;
}
