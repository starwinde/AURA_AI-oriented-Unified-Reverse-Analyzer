...
void shared_return_run(undefined8 param_1,long param_2,long param_3,undefined8 param_4,long *param_5
                      )

{
  ...
  if (param_2 != 0 && param_3 != 0) {
    local_30 = 0;
    uVar1 = shared_return_analyze_constprop_0(param_2,param_3,&local_30);
