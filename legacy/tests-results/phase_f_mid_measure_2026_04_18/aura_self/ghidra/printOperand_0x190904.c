...

{
  ...
  if ((uVar7 & 1) != 0) {
    ...
    SStream_concat(param_3,&DAT_001fd778,
                   &AsmStrs_0 + *(ushort *)(RegAsmOffset_1 + (ulong)(uVar3 - 1) * 2));
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_00190988;
    uVar3 = uVar3 & 0xffff;
            ...
            do {
              ...
              while (bVar17 != 0x80) {
                ...
                *pbVar2 = bVar17;
                pbVar9 = pbVar9 + -1;
                uVar3 = uVar4 & 0xff;
                if (uVar10 < (uVar4 & 0xff)) goto LAB_00190e98;
                pbVar2 = pbVar2 + 1;
                bVar17 = *pbVar9;
              }
              uVar4 = uVar3 + 1;
...
LAB_00190e98:
  ...
  if ((uVar7 & 1) == 0) goto LAB_00190988;
  ...
  if (uVar3 == 1) {
    ...
    if (uVar10 < 0x1ce) {
      if (uVar10 < 0x1cc) {
        if (0xac < uVar10) {
          if (uVar10 != 0xee) {
            if (uVar10 == 0x15f) goto LAB_001910e8;
            if (uVar10 != 0xe5) goto LAB_00191060;
          }
LAB_00190fc8:
          uVar7 = uVar7 & 0xff;
          if (uVar7 < 10) goto LAB_001910d4;
          SStream_concat(param_3,"$0x%x",uVar7);
          goto LAB_00190a58;
        }
        if (0xa9 < uVar10) goto LAB_00190f68;
        if (uVar10 == 0x18) goto LAB_001910c8;
      }
      goto LAB_00191060;
    }
    if (uVar10 == 0x279) goto LAB_001910e8;
    if (uVar10 < 0x27a) {
      if (uVar10 == 0x200) {
LAB_001910c8:
        uVar7 = uVar14;
        if (uVar14 < 10) goto LAB_001910d4;
        goto LAB_00190a30;
      }
      if (uVar10 == 0x203) goto LAB_00190fc8;
    }
    else if (uVar10 == 0x5df) goto LAB_001910c8;
LAB_00191060:
    uVar7 = uVar14;
    uVar14 = uVar7;
    if ((long)uVar7 < 10) {
      SStream_concat(param_3,&DAT_001fd798,uVar7);
      goto LAB_00190a58;
    }
LAB_00190f78:
    uVar7 = uVar14;
    ...
    uVar14 = uVar7;
    if (uVar10 < 0x1ce) {
      if (0x1cb < uVar10) goto LAB_00191060;
      if (0xac < uVar10) {
        if (uVar10 != 0xee) {
          if (uVar10 == 0x15f) goto LAB_001910e8;
          if (uVar10 != 0xe5) goto LAB_00191010;
        }
        goto LAB_00190fc8;
      }
      if (uVar10 < 0xaa) {
        if (uVar10 == 0x18) goto LAB_00190a20;
        goto LAB_00191010;
      }
LAB_00190f68:
      uVar3 = 4;
...
LAB_001910e8:
      ...
      if (uVar10 < 0x27a) {
        if (uVar10 != 0x200) {
          if (uVar10 == 0x203) goto LAB_00190fc8;
LAB_00191010:
          if (-1 < (long)uVar7) goto LAB_00191060;
      ...
      else if (uVar10 != 0x5df) goto LAB_00191010;
LAB_00190a20:
      if (uVar7 < 10) {
LAB_001910d4:
        SStream_concat(param_3,&DAT_001fd7b8,uVar7);
      }
      else {
        if (uVar3 == 0) {
