...
LAB_001dbb20:
      ...
      case '\x0e':
      case '\x0f':
        goto switchD_001dbb40_caseD_2;
      case '\x10':
        MCOperand_CreateReg0(param_4,*(undefined2 *)(llvmRegnums_0 + (local_88 & 0xffffffff) * 2));
        break;
      case '\x11':
        if (7 < (local_88._4_4_ & 0xff)) goto switchD_001dbb40_default;
      ...
      case '\x1c':
        ...
        uVar16 = uVar15;
        if (bVar1 == 1) {
          if (bVar2 == 0x14) goto LAB_001dc0f8;
          if (bVar2 < 0x15) {
            if (bVar2 != 0x12) {
              if (bVar2 == 0x13) goto LAB_001dbf94;
LAB_001dc034:
...
LAB_001dc0e8:
            ...
            if (bVar2 != 0x1b) goto LAB_001dc034;
            uVar6 = (uint)uVar15;
            if (local_a8._6_1_ == '\x02') {
              ...
              if (local_a8._6_1_ != '\x01') goto LAB_001dc034;
              if ((uVar6 >> 7 & 1) != 0) {
                uVar16 = uVar15 | 0xffffffffffffff00;
              }
            }
          ...
          if (bVar1 != 6) {
            if (bVar1 == 7) {
              ...
              if (0x2559 < uVar6) goto LAB_001dc034;
              if (uVar6 < 0x24ff) {
                if (uVar6 == 0x2b0) {
                  uVar9 = 0x2b2;
                }
                  ...
                  if (uVar6 == 0x2ab) {
                    ...
                    if (uVar6 == 0x2a7) {
                      ...
                      uVar9 = 0x2aa;
                      if (uVar6 != 0x2a9) goto LAB_001dc034;
                    }
                  }
                  else {
                    uVar9 = 0x2ae;
                    if (uVar6 != 0x2ad) goto LAB_001dc034;
                  }
                }
                else if (uVar6 == 0x2b8) {
                  uVar9 = 0x2ba;
                  ...
                  if (uVar6 != 0x2b3) goto LAB_001dc034;
                  uVar9 = 0x2b5;
                }
              }
              else {
              ...
              if ((uVar15 < 8) && ((uVar15 & 3) != 3)) goto LAB_001dbfa0;
              iVar4 = MCInst_getOpcode(param_4);
              uVar9 = 0x2370;
...
LAB_001dbf94:
          ...
          if (bVar2 != 0x14) {
            if (bVar2 == 0x12) goto LAB_001dc0e8;
            goto LAB_001dc034;
          }
LAB_001dc0f8:
          uVar16 = uVar15 | 0xffffffff00000000;
...
LAB_001dbfa0:
      ...
      case '!':
        ...
        break;
      default:
        goto switchD_001dbb40_default;
      }
    }
    goto LAB_001dbb04;
  }
switchD_001dbb40_default:
  uVar7 = 0;
LAB_001dba7c:
      ...
      if ((uStack_5c - 0x15 & 0xffffffef) == 0) {
        if ((uint)local_f0 != 0) {
          if ((uint)local_f0 - 1 < 0x20) {
                    /* WARNING: Could not recover jumptable at 0x001dbd18. Too many branches */
                    /* WARNING: Treating indirect jump as call */
            (*(code *)((long)*(short *)(&DAT_00360e84 + (ulong)((uint)local_f0 - 1) * 2) * 4 +
                      0x1dbd1c))();
            return;
          }
          goto switchD_001dbb40_default;
        ...
        if (uStack_f8._4_1_ == '\x01') {
          iVar4 = 0;
          if ((uint)local_f0 == 0) {
            if ((int)local_c0 != 2) goto LAB_001dc240;
          }
...
LAB_001dc198:
        ...
        if (uStack_5c < 3) {
          uVar7 = 9;
          if (uStack_5c == 0) {
            if ((int)uStack_58 == 0) goto switchD_001dbb40_default;
            if ((int)local_c0 == 2) {
...
LAB_001dc408:
          ...
          if (uStack_5c != 3) {
            uVar7 = 6;
            if (uStack_5c == 4) goto LAB_001dc198;
            switch(uStack_5c) {
            case 5:
...
LAB_001dc094:
    ...
    bVar1 = bVar1 - 2;
joined_r0x001dc064:
    if (3 < bVar1) goto switchD_001dbb40_default;
  }
  else {
    if (0x17 < bVar1) {
      bVar1 = bVar1 - 0x19;
      goto joined_r0x001dc064;
    }
    if (bVar1 < 0x13) goto switchD_001dbb40_default;
  }
  if ((uStack_5c - 0x15 & 0xffffffef) == 0) goto switchD_001dbb40_default;
  switch(uStack_5c) {
  case 0x31:
