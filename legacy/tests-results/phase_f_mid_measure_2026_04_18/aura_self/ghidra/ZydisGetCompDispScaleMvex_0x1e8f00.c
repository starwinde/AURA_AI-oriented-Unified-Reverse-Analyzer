...
/* WARNING: Removing unreachable block (ram,0x001e90c4) */
...
LAB_001e8fe4:
      ...
      if (1 < uVar1 - 3) goto LAB_001e8fe4;
      local_a = 2;
    }
  }
...
LAB_001e92ec:
    ...
    if (0x19 < uVar1) goto LAB_001e9334;
    if (uVar1 != 0x18) {
      if (0x18 < uVar1) goto LAB_001e9334;
      if (uVar1 == 0x17) goto LAB_001e92ec;
      if (0x17 < uVar1) {
LAB_001e9334:
                    /* WARNING: Subroutine does not return */
...
LAB_001e9208:
          ...
          if ((uVar1 < 0x16) && (uVar1 < 0x15)) {
            if (uVar1 < 10) {
              ...
              if ((uVar6 & 0x288) != 0) goto LAB_001e9208;
            }
          }
        }
        goto LAB_001e9334;
