      ...
      *puVar3 = 0;
      ...
      if (local_70 != (char *)0x0) {
        if (local_60 == 0) {
          if (uStack_68 < 5) {
            ppcVar4 = &local_70;
            if (uStack_68 != 0) goto LAB_001f4ef0;
          }
          else {
            if (*local_70 != -0x11) goto LAB_001f4ef0;
            if (local_70[1] != -0x45) goto LAB_001f4ef0;
            if (local_70[2] != -0x41) goto LAB_001f4ef0;
            local_60 = 3;
            bVar1 = local_70[3];
            while (bVar1 < 0x21) {
              local_60 = local_60 + 1;
              if (local_60 == uStack_68) goto LAB_001f4fa4;
LAB_001f4ef0:
