...

{
  ...
  if (param_1 == 0 || param_2 == (long *)0x0) goto LAB_001f2fac;
  ...
  if (bVar2 < 0x11) {
    ...
    if (bVar2 < 5) {
      if (bVar2 == 1) {
        ...
        uVar3 = s_false_00203440._4_2_;
        if (pcVar11 == (char *)0x0) goto LAB_001f2fac;
        *(undefined4 *)pcVar11 = s_false_00203440._0_4_;
        *(undefined2 *)(pcVar11 + 4) = uVar3;
      }
      else {
        if ((bVar2 != 2) ||
           (puVar8 = (undefined4 *)ensure(param_2,5), uVar4 = DAT_00203454,
           puVar8 == (undefined4 *)0x0)) goto LAB_001f2fac;
        *puVar8 = DAT_00203450;
        *(undefined1 *)(puVar8 + 1) = uVar4;
      }
LAB_001f2f74:
      ...
      if ((NAN(dVar21)) || (dVar22 = ABS(dVar21), 1.79769313486232e+308 < dVar22)) {
        uVar6 = 4;
        local_90 = (ulong)CONCAT14(DAT_0020bebc,DAT_0020beb8);
LAB_001f303c:
...
LAB_001f343c:
        ...
        iVar7 = __isoc99_sscanf(&local_90,&DAT_0020bec8,&local_98);
        if (iVar7 == 1) {
          if (dVar22 < ABS(local_98)) {
            dVar22 = ABS(local_98);
          }
          if (dVar22 * 2.220446049250313e-16 < ABS(local_98 - dVar21)) goto LAB_001f35b4;
        }
        else {
LAB_001f35b4:
          uVar6 = __sprintf_chk(dVar21,&local_90,2,0x1a,"%1.17g");
        }
        if (uVar6 < 0x1a) goto LAB_001f303c;
      }
    ...
    if (bVar2 == 0x40) {
          ...
          *puVar12 = 0x7b;
          ...
          if (plVar19 != (long *)0x0) {
            while( true ) {
              ...
              if (puVar12 == (undefined1 *)0x0) goto LAB_001f2fac;
              *puVar12 = 0x3a;
              if (*(int *)((long)param_2 + 0x24) != 0) {
                puVar12[1] = 9;
              }
              ...
              if (puVar14 == (undefined2 *)0x0) goto LAB_001f2fac;
              puVar16 = puVar14;
              if (*plVar19 != 0) {
      ...
      *puVar12 = 0x5b;
      lVar17 = _DAT_0020c090;
      lVar15 = param_2[2] + _DAT_0020c090;
      param_2[3] = param_2[3] + _UNK_0020c098;
      param_2[2] = lVar15;
