...

{
  ...
  case 1:
    ...
    fwrite(&DAT_001fa638,1,4,param_2);
    emit_expr(*(undefined8 *)(param_1 + 0x26),param_2,0);
    fwrite(&DAT_001fa598,1,4,param_2);
  ...
  case 4:
    ...
    if (piVar3 != (int *)0x0) {
      if (*piVar3 == 10) {
        ...
        fwrite(&DAT_001fa490,1,3,param_2);
    ...
    fwrite(&DAT_001fd090,1,2,param_2);
...
LAB_00186d8c:
    fwrite(&DAT_001fc530,1,4,param_2);
LAB_00186db0:
    sVar6 = fwrite(&DAT_001f99c8,1,2,param_2);
    return sVar6;
  case 6:
    fwrite(&DAT_001fc530,1,4,param_2);
  ...
  case 0xc:
    ...
    fwrite(&DAT_001fd240,1,2,param_2);
