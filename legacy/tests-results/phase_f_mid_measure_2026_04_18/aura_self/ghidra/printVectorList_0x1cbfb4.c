...
LAB_001cc01c:
  ...
  do {
    ...
    if ((uVar5 & 1) == 0) {
      SStream_concat(param_3,&DAT_001fd010,AsmStrsvreg_7 + (byte)RegAsmOffsetvreg_8[iVar4 - 1U],
                     param_4);
      lVar10 = *(long *)(param_1 + 800);
      if (*(int *)(lVar10 + 0x60) != 0) goto LAB_001cc164;
LAB_001cc0b8:
      if (iVar3 + 1 != iVar12) goto LAB_001cc0c4;
LAB_001cc200:
...
LAB_001cc164:
      ...
      *(char *)(lVar11 + 0x67) = (char)uVar9 + '\x01';
      if (iVar3 + 1 == iVar12) goto LAB_001cc200;
LAB_001cc0c4:
      SStream_concat0(param_3,", ");
      if (iVar4 - 0x7bU < 0x1f) goto LAB_001cc130;
      if (iVar4 != 0x9a) goto LAB_001cc0e8;
      iVar4 = 0x7b;
    }
    iVar3 = iVar3 + 1;
  } while (iVar3 != iVar12);
