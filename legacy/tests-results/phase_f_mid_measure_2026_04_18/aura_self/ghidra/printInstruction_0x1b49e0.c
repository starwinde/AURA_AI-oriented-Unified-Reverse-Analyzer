...

{
  ...
  SStream_concat0(param_2,(uVar11 & 0xfff) + 0x24436f);
    ...
    if ((uVar5 != 0) &&
      ...
      do {
        if (((uVar5 >> (ulong)(uVar22 & 0x1f) ^ uVar6) & 1) == 0) {
          SStream_concat0(param_2,&DAT_00201f18);
        }
        else {
  ...
  case 0xd:
    ...
    SStream_concat(param_2,&DAT_001fdbe8,uVar4);
  ...
  case 0xe:
    ...
    if (iVar7 == 2) {
      puVar18 = &DAT_001fdbd0;
    }
    else {
      puVar18 = &DAT_001fdbd8;
      if (iVar7 != 3) {
        puVar18 = &DAT_001fe008;
      }
    }
    ...
    break;
  case 0xf:
    goto switchD_001b4a74_caseD_f;
  case 0x10:
    goto switchD_001b4a74_caseD_10;
  case 0x11:
    MCInst_getOperand(param_1,1);
    uVar4 = MCOperand_getImm();
    SStream_concat(param_2,&DAT_001fdbe8,uVar4);
    ...
    uVar4 = MCOperand_getImm();
    SStream_concat(param_2,&DAT_001fd988,uVar4);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      lVar17 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
      bVar1 = *(byte *)(lVar17 + 0x80);
      lVar13 = lVar17 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10;
  ...
  case 0x12:
    ...
    *(byte *)(lVar17 + 0x80) = bVar1 + 1;
    return;
  case 0x13:
    goto switchD_001b4a74_caseD_13;
  case 0x14:
  ...
  case 0x15:
    ...
    if (lVar13 == 0) {
      ...
      *(undefined8 *)(lVar13 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x94) = DAT_0020bf60;
    ...
    lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
    bVar1 = *(byte *)(lVar13 + 0x80);
    *(undefined8 *)(lVar13 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x94) = DAT_0020bf58;
    *(byte *)(lVar13 + 0x80) = bVar1 + 1;
    return;
  case 0x16:
  ...
  case 0x1e:
    ...
    break;
  default:
    goto switchD_001b4a74_default;
  }
  uVar12 = (((ulong)uVar11 & 0xfe0000) >> 0x11) - 1;
  if (0x49 < uVar12) {
switchD_001b4ca8_default:
  ...
  case 0:
    ...
    goto joined_r0x001b6740;
  case 1:
    SStream_concat0(param_2,&DAT_001fdc00);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b6720;
  case 2:
    SStream_concat0(param_2,&DAT_001fdc08);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b6700;
  case 3:
    SStream_concat0(param_2,&DAT_001fdd08);
    goto LAB_001b4af0;
  case 4:
    goto switchD_001b4ca8_caseD_4;
  case 5:
    goto switchD_001b4a74_default;
  case 6:
...
LAB_001b5778:
  ...
  case 0x10:
    ...
    goto LAB_001b4cd8;
  case 0x11:
    SStream_concat0(param_2,&DAT_001fdc60);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x13:
    ...
    goto LAB_001b4cd8;
  case 0x14:
    SStream_concat0(param_2,&DAT_001fdc78);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x17:
    ...
    goto LAB_001b4cd8;
  case 0x18:
    SStream_concat0(param_2,&DAT_001fdc98);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
LAB_001b59ac:
    ...
    return;
  case 0x1f:
    SStream_concat0(param_2,&DAT_001fdd00);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0x26:
    ...
    break;
  case 0x27:
    SStream_concat0(param_2,&DAT_001fdd80);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
joined_r0x001b6720:
    ...
    goto LAB_001b4af0;
  case 0x2b:
    SStream_concat0(param_2,&DAT_001fdda8);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
joined_r0x001b6700:
    if (iVar7 != 0) {
  ...
  case 0x2c:
    ...
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_001b5d24;
  ...
  case 0x30:
    ...
    goto LAB_001b5d04;
  case 0x31:
    SStream_concat0(param_2,&DAT_001fde00);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
...
switchD_001b4ca8_caseD_4:
  ...
  case 0x34:
    ...
    if (uVar11 < 10) {
      SStream_concat(param_2,&DAT_001fd980,uVar11);
    }
    else {
...
LAB_001b586c:
  ...
  case 0x43:
    ...
    break;
  case 0x44:
    SStream_concat0(param_2,&DAT_001fdf08);
    goto LAB_001b4af0;
  case 0x45:
    SStream_concat0(param_2,"\tsp, ");
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b5cf4;
  case 0x46:
    SStream_concat0(param_2,"\tsp!, ");
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
joined_r0x001b5cf4:
    if (iVar7 == 0) goto LAB_001b5d24;
    lVar13 = *(long *)(param_1 + 0x310);
    uVar14 = 0xc00000001;
LAB_001b5d04:
...
LAB_001b5d24:
    ...
    return;
  case 0x47:
    SStream_concat0(param_2,&DAT_001fdf20);
    printOperand(param_1,0,param_2);
    return;
  case 0x48:
    printPredicateOperand(param_1,4,param_2);
...
switchD_001b4d10_default:
  ...
  case 1:
    ...
    SStream_concat0(param_2,&DAT_001fdf30);
    lVar13 = *(long *)(param_1 + 800);
    MCInst_getOperand(param_1,0);
    iVar7 = MCOperand_getReg();
...
LAB_001b71b8:
    SStream_concat0(param_2,&DAT_001fdf38);
...
LAB_001b7530:
  ...
  case 0xc:
    ...
    SStream_concat(param_2,&DAT_001fd988,uVar4);
    iVar7 = *(int *)(*(long *)(param_1 + 800) + 0x60);
    goto joined_r0x001b70ac;
  case 0xd:
    MCInst_getOperand(param_1,1);
    uVar5 = MCOperand_getImm();
    if ((uVar5 >> 2 & 1) == 0) {
      if ((uVar5 >> 1 & 1) != 0) goto LAB_001b9b48;
      if ((uVar5 & 1) != 0) goto LAB_001b6914;
      if (uVar5 == 0) {
        uVar5 = 0x10;
        SStream_concat0(param_2,&DAT_001fdf40);
      }
    }
    else {
      SStream_concat0(param_2,&DAT_00206050);
      if ((uVar5 >> 1 & 1) != 0) {
LAB_001b9b48:
      ...
      if ((uVar5 & 1) != 0) {
LAB_001b6914:
        SStream_concat0(param_2,&DAT_001fdbc8);
      }
    }
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
  ...
  case 0xf:
    ...
    return;
  case 0x10:
    goto switchD_001b8960_caseD_e;
  case 0x11:
    printAddrMode7Operand(param_1,2,param_2);
    SStream_concat0(param_2,", ");
    break;
  case 0x12:
    goto switchD_001b8960_caseD_10;
  case 0x13:
    MCInst_getOperand(param_1,1);
    uVar4 = MCOperand_getImm();
    SStream_concat(param_2,&DAT_001fdbe8,uVar4);
...
LAB_001b5150:
  ...
  case 0x16:
    ...
    pcVar2 = (code *)SoftwareBreakpoint(1000,0x1bb31c);
    (*pcVar2)();
  case 0x17:
    MCInst_getOperand(param_1,1);
    uVar6 = MCOperand_getImm();
...
LAB_001b9af8:
      ...
      if (uVar5 == 0x1e) {
        ...
        if ((uVar6 >> 6 & 1) == 0) {
          uVar12 = uVar21;
          if ((uVar6 >> 7 & 1) == 0) goto LAB_001b9af0;
    ...
    SStream_concat(param_2,&DAT_001fd710,uVar12);
LAB_001b6d98:
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
...
switchD_001b4a74_caseD_13:
  ...
  case 0x37:
    ...
    SStream_concat0(param_2,&DAT_001fdf50);
    lVar13 = *(long *)(param_1 + 800);
    ...
    *(undefined8 *)(lVar17 + 0x8c) = DAT_0020bf68;
  ...
  case 0x3a:
    ...
    return;
  default:
    goto switchD_001b4d10_default;
  }
LAB_001b4b18:
  uVar12 = (CONCAT44(uVar10,uVar11) >> 0x1e & 0x1f) - 1;
  if (0x1c < uVar12) goto switchD_001b4d28_default;
  switch(uVar12 & 0xffffffff) {
  case 0:
    break;
  case 1:
  ...
  case 4:
    ...
    SStream_concat((double)(float)((uVar10 >> 4 & 3) << 0x17 | (uVar10 & 0xf) << 0x13 |
                                  uVar5 | uVar11),param_2,&DAT_001fdf60);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
  ...
  case 6:
    ...
    uVar11 = MCOperand_getImm();
    if (uVar11 < 10) {
      SStream_concat(param_2,&DAT_001fdab8,uVar11);
    }
    else {
      SStream_concat(param_2,"{0x%x}",uVar11);
    }
...
switchD_001b8960_caseD_10:
      ...
      case 0x24:
        ...
        if ((uVar12 & 1) == 0) goto LAB_001baa9c;
        SStream_concat0(param_2,&DAT_001fd940);
        lVar13 = *(long *)(param_1 + 800);
        MCOperand_getReg(uVar14);
        ...
        uVar10 = uVar10 & 0x100;
        if (uVar11 == 0) {
          if (uVar10 == 0) goto LAB_001b9180;
          uVar5 = 0;
          puVar18 = &DAT_001fa418;
LAB_001b9144:
          ...
          SStream_concat(param_2,&DAT_001fd948,puVar18,uVar5);
        }
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
          lVar13 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
          if (uVar10 == 0) {
...
LAB_001b9180:
      ...
      case 0x30:
        ...
        return;
      case 0x31:
        SStream_concat0(param_2,&DAT_001fdfe8);
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
          return;
        }
      ...
      case 0x37:
        ...
        return;
      case 0x38:
        goto switchD_001ba354_caseD_24;
      case 0x39:
...
LAB_001baa9c:
      ...
      case 0x3f:
        ...
        return;
      default:
        goto switchD_001b8960_default;
      }
    }
    else {
switchD_001b8960_default:
      printOperand(param_1,1,param_2);
    }
...
switchD_001b96f0_caseD_1:
      ...
      case 0xf:
        ...
        return;
      case 0x10:
        goto switchD_001ba354_caseD_1c;
      case 0x11:
        SStream_concat0(param_2,&DAT_001fdff0);
        printAddrMode6Operand(param_1,1,param_2);
        printAddrMode6OffsetOperand(param_1,3,param_2);
        return;
      case 0x12:
      ...
      case 0x14:
        ...
        return;
      case 0x15:
        SStream_concat0(param_2,&DAT_001fdff8);
        if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
          return;
        }
        ...
        return;
      default:
        goto switchD_001b96f0_default;
      }
    }
    else {
switchD_001b96f0_default:
      SStream_concat0(param_2,", ");
    }
...
switchD_001ba354_caseD_6:
      ...
      case 0x19:
        ...
        return;
      case 0x1a:
        goto switchD_001ba354_caseD_1a;
      case 0x1b:
        printVectorIndex(param_1,4,param_2);
        return;
      case 0x1c:
switchD_001ba354_caseD_1c:
      ...
      case 0x23:
        ...
        return;
      case 0x24:
switchD_001ba354_caseD_24:
        printThumbS4ImmOperand_constprop_0(param_1,param_2);
        return;
      default:
        goto switchD_001ba354_default;
      }
    }
    else {
switchD_001ba354_default:
      printOperand(param_1,2,param_2);
    }
...
switchD_001b4be4_caseD_6:
    ...
    if (uVar12 < 0xb) {
      ...
      case 1:
        ...
        return;
      case 2:
switchD_001b96f0_caseD_d:
        printAddrMode6Operand(param_1,3,param_2);
        return;
      case 3:
switchD_001ba354_caseD_1a:
        printAddrMode6Operand(param_1,4,param_2);
        printAddrMode6OffsetOperand(param_1,6,param_2);
        return;
      case 4:
...
switchD_001b4a74_default:
  return;
switchD_001b4d10_caseD_e:
  SStream_concat0(param_2,", ");
  goto LAB_001b4b18;
}
