...
LAB_001493e4:
      ...
      if (__dest == (byte *)0x0) goto LAB_00149430;
      goto LAB_001493f8;
    }
      ...
      if (-1 < (int)uVar5) {
        if (__dest == (byte *)0x0) {
          *param_2 = 1 << (ulong)(uVar5 & 0x1f);
          if (-1 < (int)uVar6) {
LAB_00149760:
            if (uVar5 == uVar6) goto LAB_00149784;
            if (__dest != (byte *)0x0) goto LAB_001495e0;
          }
        }
        else {
          pcVar10 = strchr((char *)__dest,0x5b);
          if (pcVar10 != (char *)0x0) {
            if ((int)uVar6 < 0) goto LAB_00149430;
            if (uVar5 != uVar6) goto LAB_001495e0;
LAB_00149784:
            *param_3 = 0;
            goto LAB_00149430;
          }
          *param_2 = 1 << (ulong)(uVar5 & 0x1f);
          if (-1 < (int)uVar6) goto LAB_00149760;
LAB_001495e0:
          pcVar10 = strchr((char *)__dest,0x5b);
          if (pcVar10 != (char *)0x0) goto LAB_001495f0;
        }
        *param_3 = *param_3 | 1 << (ulong)(uVar5 & 0x1f);
      }
LAB_001495f0:
      ...
      if (iVar3 == 0) {
        ...
        *param_2 = *param_2 | 0x10;
        ...
        if (((iVar3 != 0) && (iVar3 = strcasecmp(__s1,"retq"), iVar3 != 0)) &&
           (iVar3 = strcasecmp(__s1,"retn"), iVar3 != 0)) goto LAB_00149430;
        uVar5 = 1;
      }
      *param_3 = uVar5;
      goto LAB_00149430;
    ...
    *pbVar11 = 0;
    ...
    if (iVar3 != 0) {
      bVar2 = true;
      iVar3 = strcasecmp(__s1,"movsx");
      if (iVar3 != 0) goto LAB_001491dc;
      uVar5 = dfg_reg_from_operand(__dest);
      if (-1 < (int)uVar5) goto LAB_001494b0;
      goto LAB_001496ac;
    }
    uVar5 = dfg_reg_from_operand(__dest);
    if ((int)uVar5 < 0) {
      uVar5 = dfg_reg_from_operand(pbVar13);
      if (-1 < (int)uVar5) goto LAB_001493e4;
    }
    else {
LAB_001494b0:
      pcVar10 = strchr((char *)__dest,0x5b);
...
LAB_001493f8:
    pcVar10 = strchr((char *)__dest,0x5b);
    if (pcVar10 == (char *)0x0) goto LAB_00149430;
    uVar5 = dfg_reg_from_operand(__dest);
  }
  if (-1 < (int)uVar5) {
    *param_3 = *param_3 | 1 << (ulong)(uVar5 & 0x1f);
