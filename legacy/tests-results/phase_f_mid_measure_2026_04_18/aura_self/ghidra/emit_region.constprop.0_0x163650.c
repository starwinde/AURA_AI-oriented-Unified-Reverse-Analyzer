...
LAB_001636bc:
  if ((*(byte *)(param_8 + uVar23) & 1) != 0) goto LAB_001637e4;
  lVar19 = *param_1;
  *(undefined1 *)(param_8 + uVar23) = 1;
  ...
  if ((int)uVar7 < 0) {
    if (((*(byte *)(param_4 + uVar23) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
      ...
      piVar12 = (int *)0x0;
      if (uVar7 != 0) goto LAB_00163744;
    }
  }
  else {
    piVar12 = (int *)(*(long *)(lVar25 + 8) + (long)(int)uVar7 * 0x88);
    do {
      if (*piVar12 - 0x17U < 2 || *piVar12 == 0x1a) goto LAB_00163730;
...
joined_r0x00164c7c:
                uVar6 = uVar5;
                if (puVar13 != (uint *)0x0) goto LAB_001644dc;
              }
LAB_001648a4:
              iVar8 = 4;
              do {
...
LAB_00164868:
              ...
              do {
                ...
                goto joined_r0x00164c7c;
                uVar11 = uVar3;
              } while (uVar3 != uVar20);
              uVar2 = uVar7;
              if (puVar13 == (uint *)0x0) goto LAB_001648a4;
LAB_001644dc:
              if ((puVar13[6] != 3) || (iVar8 = 4, (puVar13[0x11] & 1) == 0)) goto LAB_001648a4;
              do {
                fputc(0x20,param_9);
                iVar8 = iVar8 + -1;
              } while (iVar8 != 0);
              __fprintf_chk(param_9,2,"for (v%u = v%u; ",puVar13[8],puVar13[9]);
              __fprintf_chk(param_9,2,&DAT_001fa488,puVar13[8]);
              uVar21 = puVar13[0x10];
              if (uVar21 == 0x10) {
LAB_00164d58:
                ...
                if (uVar21 != 0xd) {
                  if (uVar21 < 0xe) {
                    if (uVar21 == 0xb) {
                      ...
                      if (uVar21 != 0xc) goto LAB_00164dac;
                      fwrite(&DAT_001fa568,1,4,param_9);
                    }
                    goto LAB_00164590;
                  }
                  if (uVar21 == 0xe) goto LAB_00164d58;
                }
...
LAB_00164d88:
                ...
                if (uVar21 < 0x14) {
                  if (uVar21 == 0x11) goto LAB_00164d88;
                }
                else if (uVar21 != 0x14) {
LAB_00164dac:
...
LAB_00164590:
            ...
            uVar21 = *(uint *)(param_1 + 1);
            if (param_3 == uVar6 || uVar21 <= uVar6) goto LAB_001637e4;
            uVar23 = (ulong)uVar6;
            goto LAB_001636bc;
          }
          if (*piVar12 == 0x18) {
...
LAB_00163ec4:
            ...
            lVar19 = extraout_x12;
            uVar21 = extraout_w11;
            if (uVar7 < extraout_w11) goto LAB_00163a5c;
          }
        }
      }
      else {
LAB_00163744:
        ...
        uVar6 = 0;
        do {
          if (*puVar13 == uVar20) goto LAB_00163770;
          uVar6 = uVar6 + 1;
...
LAB_00163770:
        if (piVar12 != (int *)0x0) {
          if (*piVar12 == 0x17) {
            ...
            uVar7 = piVar12[0x1a];
            cf_emit_block_body_part_0_constprop_0_isra_0(lVar19,uVar23,param_9);
            if (puVar13 == (uint *)0x0) goto LAB_00164ba0;
            uVar6 = puVar13[5];
            uVar24 = *(uint *)(param_1 + 1);
            uVar2 = uVar21;
            if (uVar6 < uVar24) {
              ...
              if (uVar21 < uVar24) {
                lVar19 = *param_1;
                if (uVar21 != uVar20) goto LAB_00164c2c;
              }
    ...
    if (piVar14[4] != 0) {
      do {
        ...
        if ((*(byte *)(lVar25 + 0xc) & 1) == 0) {
          ...
          uVar21 = *(uint *)(param_1 + 1);
          uVar7 = *(uint *)(lVar25 + 8);
          if (uVar7 < uVar21) goto LAB_00164350;
LAB_001642c0:
          ...
          uVar21 = *(uint *)(param_1 + 1);
          uVar7 = *(uint *)(lVar25 + 8);
          if (uVar21 <= uVar7) goto LAB_001642c0;
LAB_00164350:
          pvVar15 = calloc((ulong)uVar21,1);
          if (pvVar15 == (void *)0x0) goto LAB_001642c0;
          uVar6 = piVar14[8];
...
LAB_00164408:
    ...
    uVar21 = *(uint *)(param_1 + 1);
    uVar7 = piVar14[6];
    if (uVar7 < uVar21 && param_3 != uVar7) goto LAB_00163e08;
    goto LAB_001637e4;
  }
...
LAB_00163dcc:
  ...
  if (piVar12 == (int *)0x0) goto LAB_001637e4;
  iVar8 = *piVar12;
  if (iVar8 == 0x18) {
    uVar7 = piVar12[0x19];
    uVar21 = *(uint *)(param_1 + 1);
      ...
      if (piVar12[0x18] != 0) {
        do {
          ...
          while( true ) {
            ...
            lVar19 = lVar19 + 1;
            uVar21 = (uint)lVar19;
            if ((uint)piVar12[0x18] <= uVar21) goto LAB_00163e98;
          }
          __fprintf_chk(param_9,2,&DAT_001fa488);
          lVar19 = lVar19 + 1;
...
LAB_00163e98:
  ...
  if (iVar8 != 0x17) goto LAB_001637e4;
  uVar21 = piVar12[0x19];
  uVar7 = piVar12[0x1a];
  if ((param_5 != (undefined8 *)0x0) && (param_3 < *(uint *)(param_1 + 1))) {
    ...
    if (iVar8 - 1U < 2) {
      ...
      if (1 < iVar9 - 1U) goto LAB_00163848;
      iVar8 = 4;
      do {
        fputc(0x20,param_9);
        iVar8 = iVar8 + -1;
...
LAB_00164048:
    ...
    uVar20 = *(uint *)(param_1 + 1);
    if (uVar20 <= uVar6) goto LAB_00164048;
  }
  uVar22 = (ulong)uVar6;
  if (uVar7 == uVar6) {
    iVar8 = 4;
  ...
  uVar21 = *(uint *)(param_1 + 1);
  uVar23 = uVar22;
  if (uVar21 <= uVar6 || param_3 == uVar6) goto LAB_001637e4;
  goto LAB_001636bc;
LAB_00163e08:
  uVar23 = (ulong)uVar7;
  if ((*(byte *)(param_8 + (ulong)uVar7) & 1) != 0) goto LAB_001637e4;
  goto LAB_001636bc;
}
