...
void alias_print(undefined8 *param_1,FILE *param_2)
    ...
    if (uVar7 != 0) {
      ...
      do {
        while (*(uint *)((long)__ptr + uVar9 * 4) < 2) {
          uVar9 = uVar9 + 1;
          if (uVar7 <= (uint)uVar9) goto LAB_0017a49c;
        }
...
LAB_0017a47c:
          ...
          do {
            while( true ) {
              ...
              uVar7 = uVar7 + 1;
              puVar8 = puVar8 + 1;
              if (*(uint *)(param_1 + 2) <= uVar7) goto LAB_0017a47c;
            }
            __fprintf_chk(param_2,2,&DAT_001f9fc0,uVar7);
            uVar7 = uVar7 + 1;
            puVar8 = puVar8 + 1;
