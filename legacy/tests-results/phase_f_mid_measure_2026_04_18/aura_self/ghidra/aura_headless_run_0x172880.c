...
LAB_00172998:
    local_80 = (long *)0x0;
    local_8c = 0;
    if (param_2 != 0) goto LAB_0017299c;
LAB_001734d8:
    plVar5 = local_80;
...
LAB_001736f8:
      ...
      if ((uVar8 & 1) != 0) goto LAB_00173a9c;
LAB_0017370c:
      local_78 = 0;
      if ((uVar8 >> 1 & 1) != 0) goto LAB_00173a20;
LAB_00173710:
      uStack_70 = 0;
      if ((uVar8 >> 2 & 1) != 0) goto LAB_00173a38;
      do {
        lVar1 = *plVar21;
        lVar18 = plVar21[1];
        while( true ) {
          if (lVar1 != 0) {
            ...
            uVar22 = uVar22 + 1;
            lVar20 = lVar20 + 0x38;
            if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_0017374c;
            goto LAB_001736f8;
          }
          __fprintf_chk(param_3,2,"| %u | `%s` | `0x%lx` | %lu | %s |\n",uVar22,&DAT_001fe008,lVar18
                        ,plVar21[3],&local_78);
          uVar22 = uVar22 + 1;
          lVar20 = lVar20 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_0017374c;
          plVar21 = (long *)(*(long *)(lVar9 + 0x18) + lVar20);
          uVar8 = *(uint *)(plVar21 + 6);
          if ((uVar8 & 1) == 0) goto LAB_0017370c;
LAB_00173a9c:
          local_78 = 0x52;
          if ((uVar8 >> 1 & 1) == 0) goto LAB_00173710;
LAB_00173a20:
          uStack_70 = 0;
          __strcat_chk(&local_78,&DAT_001fc748,0x10);
          if ((*(uint *)(plVar21 + 6) >> 2 & 1) == 0) break;
LAB_00173a38:
          __strcat_chk(&local_78,&DAT_001fc750,0x10);
          lVar1 = *plVar21;
          lVar18 = plVar21[1];
        }
      } while( true );
      ...
      do {
        ...
        while( true ) {
          ...
          if (!bVar6) {
            if (uVar2 < 3 || bVar4) {
              if (uVar2 == 1) {
                puVar15 = &DAT_001f8f80;
              }
              else {
                puVar15 = &DAT_001fa478;
                if (uVar2 == 2) {
          ...
          __fprintf_chk(param_3,2,"| %u | `%s` | `0x%lx` | %lu | %s |\n",uVar3,*puVar17,puVar17[2],
                        puVar17[3],puVar15);
          if (uVar8 <= uVar3 + 1) goto LAB_0017385c;
          puVar17 = (undefined8 *)(*(long *)(lVar9 + 0x28) + lVar20);
          uVar2 = *(uint *)(puVar17 + 4);
          bVar6 = uVar2 == 3;
          uVar3 = uVar3 + 1;
...
LAB_0017385c:
    ...
    if (((plVar5 == (long *)0x0) || (plVar21 = (long *)*plVar5, plVar21 == (long *)0x0)) ||
      ...
      fputc(10,param_3);
      fwrite("## Call Graph\n\n",1,0xf,param_3);
      if (plVar5 != (long *)0x0) goto LAB_001738dc;
LAB_001738f0:
...
LAB_001738dc:
      ...
      if ((plVar21 == (long *)0x0) || ((int)plVar21[1] == 0)) goto LAB_001738f0;
    ...
    do {
      if (((char *)*puVar17 != (char *)0x0) &&
         (iVar7 = strcmp((char *)*puVar17,".text"), iVar7 == 0)) goto LAB_00172978;
      puVar17 = puVar17 + 7;
    } while (puVar19 + (ulong)uVar22 * 7 != puVar17);
    uVar8 = *(uint *)(puVar19 + 6);
    puVar17 = puVar19;
    while ((uVar8 >> 2 & 1) == 0) {
      if (puVar19 + (ulong)uVar22 * 7 == puVar17 + 7) goto LAB_00172988;
      uVar8 = *(uint *)(puVar17 + 0xd);
      puVar17 = puVar17 + 7;
    }
LAB_00172978:
    if (((puVar17[5] == 0) || (puVar17[4] == 0)) ||
       (lVar20 = disasm_init(*(undefined4 *)(lVar9 + 0xc)), lVar20 == 0)) goto LAB_00172988;
    ...
    disasm_destroy(lVar20);
    local_80 = (long *)0x0;
    if (iVar7 < 1) goto LAB_00172998;
    local_80 = (long *)func_detect(local_a0,(long)local_8c,lVar9,0);
    if (param_2 == 0) goto LAB_001734d8;
LAB_0017299c:
    plVar5 = local_80;
    fwrite(&DAT_001fc3e0,1,2,param_3);
    fwrite(&DAT_001f9f80,1,2,param_3);
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fc3e8,param_1);
    fwrite(&DAT_001fc400,1,2,param_3);
    fwrite(&DAT_001f9f80,1,2,param_3);
    uVar22 = *(uint *)(lVar9 + 8);
    if (uVar22 == 3) {
      pcVar12 = "Mach-O";
    ...
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fc410,pcVar12);
    fwrite(&DAT_001fc400,1,2,param_3);
    fwrite(&DAT_001f9f80,1,2,param_3);
    ...
    if (*(int *)(lVar9 + 0x20) != 0) {
      ...
      do {
        while( true ) {
          ...
          puVar13 = &DAT_001fe008;
          if (puVar14 != (undefined1 *)0x0) {
            puVar13 = puVar14;
          }
          uVar22 = uVar22 + 1;
          __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fbb90,puVar13);
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","vaddr",*(undefined8 *)(lVar1 + 8));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fbba8,*(undefined8 *)(lVar1 + 0x18));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"flags\": %u",*(undefined4 *)(lVar1 + 0x30));
          if (*(uint *)(lVar9 + 0x20) <= uVar22) break;
          __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001f8ff8);
          lVar20 = lVar20 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_00172cf8;
        }
        lVar20 = lVar20 + 0x38;
        __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001fe008);
    ...
    if (*(int *)(lVar9 + 0x30) != 0) {
      ...
      do {
        while( true ) {
          ...
          lVar20 = lVar20 + 0x28;
          __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001fe008);
          if (*(uint *)(lVar9 + 0x30) <= uVar22) goto LAB_00172ea0;
        }
        __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001f8ff8);
        lVar20 = lVar20 + 0x28;
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            lVar1 = lVar18 + lVar20;
            fwrite("    {",1,5,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fbb90,lVar1 + 0x14);
            fwrite(", ",1,2,param_3);
            uVar22 = uVar22 + 1;
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","start",*(undefined8 *)(lVar18 + lVar20));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fc4e8,*(undefined8 *)(lVar1 + 8));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fbba8,*(undefined4 *)(lVar1 + 0x10));
            if (uVar22 < *(uint *)(plVar21 + 1)) break;
            lVar20 = lVar20 + 0x98;
            __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001fe008);
            if (*(uint *)(plVar21 + 1) <= uVar22) goto LAB_00173074;
          }
          __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001f8ff8);
          lVar20 = lVar20 + 0x98;
        } while (uVar22 < *(uint *)(plVar21 + 1));
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fc518,*(undefined8 *)(lVar1 + 0x10))
            ;
            if (uVar22 < *(uint *)(plVar21 + 1)) break;
            __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001fe008);
            lVar20 = lVar20 + 0x18;
            if (*(uint *)(plVar21 + 1) <= uVar22) goto LAB_00173250;
          }
          __fprintf_chk(param_3,2,&DAT_001fc4a8,&DAT_001f8ff8);
          lVar20 = lVar20 + 0x18;
        } while (uVar22 < *(uint *)(plVar21 + 1));
...
LAB_00173250:
    fwrite("  ],\n",1,5,param_3);
    fwrite("  \"stats\": {\n",1,0xd,param_3);
    fwrite(&DAT_001fc530,1,4,param_3);
...
LAB_00173b84:
      ...
      fwrite(&DAT_001fc400,1,2,param_3);
      if (plVar5[1] == 0) goto LAB_00173b84;
      uVar16 = *(undefined4 *)(plVar5[1] + 8);
    }
    fwrite(&DAT_001fc530,1,4,param_3);
    __fprintf_chk(param_3,2,"\"%s\": %lu","call_edge_count",uVar16);
    fputc(10,param_3);
    fwrite(&DAT_001fc580,1,4,param_3);
    fwrite(&DAT_001f99c8,1,2,param_3);
  }
