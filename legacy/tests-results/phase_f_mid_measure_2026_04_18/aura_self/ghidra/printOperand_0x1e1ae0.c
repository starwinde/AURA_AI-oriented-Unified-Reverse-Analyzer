...

{
  ...
  if ((uVar9 & 1) == 0) {
    ...
    if ((uVar9 & 1) == 0) goto LAB_001e1c70;
    ...
    if (uVar6 < 0x1ce) {
      if (uVar6 < 0x1cc) {
        if (0xac < uVar6) {
          if (uVar6 != 0xee) {
            if (uVar6 == 0x15f) goto LAB_001e1f18;
            if (uVar6 != 0xe5) goto LAB_001e1ef8;
          }
LAB_001e1eac:
          uVar9 = uVar9 & 0xff;
        ...
        if (uVar6 < 0xaa) {
          if (uVar6 == 0x18) goto LAB_001e1f64;
          goto LAB_001e1ef8;
        }
        uVar4 = 4;
        if ((int)param_2 == 1) {
...
LAB_001e1f64:
        ...
        if (uVar6 == 0x203) goto LAB_001e1eac;
      }
      else if (uVar6 == 0x5df) goto LAB_001e1f64;
LAB_001e1ef8:
