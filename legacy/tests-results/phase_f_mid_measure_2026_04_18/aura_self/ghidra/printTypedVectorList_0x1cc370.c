...

{
  ...
  uVar2 = (uint)param_4;
  if (uVar2 == 0) {
    cs_snprintf(auStack_68,0x20,&DAT_001ff5f0,uVar1,param_5,PTR___stack_chk_guard_005ffe88,0);
    if (uVar1 == 0x68) goto LAB_001cc4ec;
    if (uVar1 < 0x69) {
      if (uVar1 == 0x62) goto LAB_001cc4e4;
      if (uVar1 == 100) {
LAB_001cc440:
        uVar3 = 0xd;
        goto LAB_001cc448;
...
LAB_001cc54c:
      ...
      if (uVar1 == 0x73) goto LAB_001cc4a4;
    }
  }
  else {
...
LAB_001cc4e4:
      ...
      if (uVar1 == 100) {
        if (uVar2 == 1) goto LAB_001cc440;
        uVar3 = 0xc;
        if (uVar2 == 2) goto LAB_001cc448;
      }
    }
    else if (uVar1 == 0x71) {
      if (uVar2 == 1) goto LAB_001cc54c;
    }
    else if (uVar1 == 0x73) {
      uVar3 = 10;
      if ((uVar2 == 2) || (uVar3 = 9, uVar2 == 4)) goto LAB_001cc448;
      if (uVar2 != 1) {
        uVar3 = 0;
        goto LAB_001cc448;
      }
