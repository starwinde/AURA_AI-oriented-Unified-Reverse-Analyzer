...
byte ZydisGetEffectiveImmSize(long *param_1,ulong param_2,long param_3)

{
  ...
  pbVar5 = (byte *)ZydisGetOperandDetails(param_3);
  local_14 = 0;
  cVar2 = ZydisIsImmSigned(*pbVar5 & 0x3f);
  if (cVar2 == '\0') {
    local_13 = ZydisGetUnsignedImmSize(param_2);
  }
  else {
    local_13 = ZydisGetSignedImmSize(param_2);
  }
  switch(*pbVar5 & 0x3f) {
  case 5:
  ...
  case 0xb:
    ...
    bVar4 = ZydisGetMaxAddressSize(*param_1);
    if ((local_13 < bVar4) &&
       (bVar3 = ZydisGetUnsignedImmSize(~((-1L << ((ulong)(bVar4 - 1) & 0x3f)) << 1) & param_2),
       local_13 < bVar3)) {
      local_13 = bVar4;
    }
    if (*(int *)*param_1 == 0) {
  ...
  case 0x12:
  case 0x19:
    bVar4 = ZydisGetScaledImmSize(param_1,&simm16_32_64_sizes_61,local_13);
    return bVar4;
  case 0x13:
  case 0x1a:
    bVar4 = ZydisGetScaledImmSize(param_1,&simm32_32_64_sizes_60,local_13);
    return bVar4;
  case 0x14:
  case 0x1b:
    bVar4 = ZydisGetScaledImmSize(param_1,&simm16_32_32_sizes_59,local_13);
    return bVar4;
  case 0x1c:
  case 0x1d:
  case 0x1e:
  ...
  case 0x22:
    ...
    if (uVar1 < 5) {
      ...
      if (uVar1 < 4) {
        ...
        if (uVar1 < 3) {
          if (uVar1 == 0) {
            bVar4 = ZydisGetScaledImmSize(param_1,&jimm16_32_32_sizes_58,local_13);
            return bVar4;
          }
          if (uVar1 == 1) {
            return 0;
