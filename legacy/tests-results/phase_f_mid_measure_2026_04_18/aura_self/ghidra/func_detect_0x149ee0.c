...

{
  ...
  if (__ptr != (undefined8 *)0x0) {
    ...
    *__ptr = 0;
    ...
    if (param_4 == (byte *)0x0) {
      if (param_3 == 0) {
        if (!bVar3 || !bVar4) goto LAB_00149f50;
...
LAB_00149f84:
    ...
    candidateset_init();
    bVar3 = false;
    if (param_3 != 0) goto LAB_00149ffc;
LAB_0014a040:
    plVar14 = local_88;
    local_d0 = &local_78;
    puVar28 = param_1 + 0xc;
...
LAB_0014a738:
      ...
      if (local_70 == 0) {
        plVar14 = malloc(0x10);
        if (plVar14 == (long *)0x0) goto LAB_0014ac78;
        *plVar14 = 0;
...
LAB_0014ab18:
                ...
                if (pcVar11 == (char *)0x0) goto LAB_0014ab18;
              ...
              lVar31 = lVar31 + 1;
              uVar29 = uVar7;
              if (uVar23 <= uVar7) goto LAB_0014a950;
            }
            lVar31 = lVar31 + 1;
            uVar29 = uVar7;
          } while (uVar7 < uVar23);
                    ...
                    if ((*(ulong *)(lVar25 + lVar31) <= uVar19) &&
                      ...
                      if (uVar23 <= uVar27) {
                        ...
                        if (pvVar15 == (void *)0x0) {
                          ...
                          plVar14 = (long *)*__ptr;
                          __ptr[1] = 0;
                          if (plVar14 == (long *)0x0) goto LAB_0014a1cc;
                          goto LAB_0014ac48;
                        }
                        uVar19 = puVar28[-4];
                        *puVar9 = pvVar15;
