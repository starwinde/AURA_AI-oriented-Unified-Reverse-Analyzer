  ...
  if (*(int *)(param_1 + 0xdd0) != 0) {
    do {
      if (*pcVar14 == '\0') {
        ...
        if (uVar3 <= iVar15 + 1U) goto LAB_00187480;
      }
      else {
...
LAB_00187910:
  fwrite(&DAT_001f9df8,1,4,param_2);
  goto LAB_00187484;
LAB_001875a8:
  iVar15 = (int)plVar5[1];
  pcVar14 = local_b0;
...
LAB_001875dc:
  ...
  lVar17 = lVar17 + 1;
  if (s_stack_var_count <= (uint)lVar17) goto code_r0x00187654;
  goto LAB_00187538;
code_r0x00187654:
  if (s_stack_var_count == 0) goto LAB_00187658;
  goto LAB_001878f4;
LAB_00187480:
  if (uVar3 == 0) goto LAB_00187910;
LAB_00187484:
  fwrite(&DAT_001fd2e0,1,4,param_2);
  ...
  if (__stream == (FILE *)0x0) {
    ...
    fclose(__stream);
    if ((*(long *)(param_1 + 0xdd8) == 0) || (*(int *)(param_1 + 0xde0) == 0)) {
      if (s_stack_var_count != 0) goto LAB_0018750c;
    }
    else {
          ...
          if (*(uint *)(s_emit_stack_frame + 0x20) != 0) {
            ...
            if (*(long *)(s_emit_stack_frame + 8) < 1) {
              do {
                ...
                if (lVar19 == lVar1) goto LAB_001875a8;
                plVar5 = plVar5 + 6;
      ...
      do {
        do {
          do {
            ...
            __ptr_00 = __ptr;
            if (pcVar7 == (char *)0x0) goto LAB_001877c8;
            pcVar6 = pcVar7 + 1;
        ...
        if ((piVar9 != (int *)0x0) && (*(uint *)(param_1 + 0xde0) != 0)) {
          ...
          do {
            if (*piVar9 == (int)uVar8) goto LAB_00187698;
            piVar9 = piVar9 + 0x33;
        ...
        if ((__ptr != (void *)0x0) && (lVar17 = 0, uVar3 != 0)) {
          do {
            if (*(ulong *)((long)__ptr + lVar17 * 8) == uVar8) goto LAB_00187698;
            lVar17 = lVar17 + 1;
        ...
        if (__ptr != (void *)0x0) {
          if ((uint)uVar18 <= uVar3) {
            ...
            if (uVar2 <= uVar3) goto LAB_001877bc;
          }
...
LAB_001877c8:
  ...
  fwrite(&DAT_001f99c8,1,2,param_2);
  uVar4 = 0;
LAB_0018781c:
