...

{
  ...
  case 5:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 != 0xc4f) goto LAB_001a6b04;
joined_r0x001aaa48:
    if (uVar7 >> 0x1c == 0xe) {
      return 0;
    }
  ...
  case 10:
    ...
    goto switchD_001a4f6c_caseD_33;
  case 0xb:
...
LAB_001aa80c:
  ...
  case 0x1c:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (param_3 & 0xf) * 2));
    goto joined_r0x001a51f4;
  case 0x1d:
    goto switchD_001a4f6c_caseD_1d;
  case 0x1e:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (uVar8 >> 0x10 & 0xf) * 2));
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (param_3 & 0xf) * 2));
    param_3 = uVar8 >> 8 & 0xf;
...
LAB_001a52c8:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a52c8;
      MCOperand_CreateReg0(param_4,0);
    }
    goto LAB_001a4f30;
  case 0x29:
  ...
  case 0x2c:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 == 0xc4f) goto joined_r0x001aaa48;
    goto LAB_001a6b04;
  case 0x2d:
...
LAB_001a5ee0:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a5ee0;
      MCOperand_CreateReg0(param_4,0);
    }
...
joined_r0x001a7eac:
  ...
  case 0xd5:
    ...
    if (uVar7 == 0xf) goto LAB_001ac5b0;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (ulong)uVar7 * 2));
    goto switchD_001a4f6c_caseD_33;
  case 0xd6:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (uVar8 >> 8 & 7) * 2));
...
LAB_001aca0c:
      ...
      if (iVar2 != 0xf) goto LAB_001aca0c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abe78:
      param_1 = 1;
    }
...
LAB_001aca28:
      ...
      if (iVar2 != 0xf) goto LAB_001aca28;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aa530:
      param_1 = 1;
    }
...
LAB_001ac9ec:
      ...
      if (iVar2 != 0xf) goto LAB_001ac9ec;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7570:
      param_1 = 1;
    }
...
LAB_001ac714:
      ...
      if (iVar2 != 0xf) goto LAB_001ac714;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abc98:
      param_1 = 1;
    }
...
LAB_001ad610:
      ...
      if (iVar2 != 0xf) goto LAB_001ad610;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abcbc:
      param_1 = 1;
    }
...
LAB_001ac998:
      ...
      if (uVar7 != 0xf) goto LAB_001ac998;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abc30:
      param_1 = 1;
    }
...
LAB_001ac9b4:
      ...
      if (uVar7 != 0xf) goto LAB_001ac9b4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abbac:
      param_1 = 1;
    }
...
LAB_001ac864:
      ...
      if (iVar2 != 0xf) goto LAB_001ac864;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abad8:
      param_1 = 1;
    }
...
LAB_001ac95c:
      ...
      if (iVar2 != 0xf) goto LAB_001ac95c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aba54:
      param_1 = 1;
    }
...
LAB_001adfb4:
      ...
      if (iVar2 != 0xf) goto LAB_001adfb4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aba78:
      param_1 = 1;
    }
...
LAB_001ac7d8:
      ...
      if (iVar2 != 0xf) goto LAB_001ac7d8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aa07c:
      param_1 = 1;
    }
...
LAB_001ac74c:
      ...
      if (iVar2 != 0xf) goto LAB_001ac74c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ac480:
      param_1 = 1;
    }
...
LAB_001aca44:
      ...
      if (iVar2 != 0xf) goto LAB_001aca44;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9ffc:
      param_1 = 1;
    }
...
LAB_001ac8f0:
      ...
      if (iVar2 != 0xf) goto LAB_001ac8f0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9f88:
      param_1 = 1;
    }
...
LAB_001ac82c:
      ...
      if (iVar2 != 0xf) goto LAB_001ac82c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9ed8:
      param_1 = 1;
    }
...
LAB_001aca7c:
      ...
      if (iVar2 != 0xf) goto LAB_001aca7c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aae50:
      param_1 = 1;
    }
...
LAB_001ac730:
      ...
      if (iVar2 != 0xf) goto LAB_001ac730;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab030:
      param_1 = 1;
    }
...
LAB_001ab054:
    ...
    if (iVar2 != 0xf) goto LAB_001ab054;
    goto LAB_001ac5b0;
  case 0x10f:
    uVar5 = uVar8 >> 8 & 0xf;
    iVar2 = (int)uVar5;
...
LAB_001ac768:
      ...
      if (iVar2 != 0xf) goto LAB_001ac768;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aafac:
      param_1 = 1;
    }
...
LAB_001ac848:
      ...
      if (iVar2 != 0xf) goto LAB_001ac848;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ac4f4:
      param_1 = 1;
    }
...
LAB_001ac154:
    ...
    goto joined_r0x001a7954;
  case 0x113:
    if ((uVar10 & 0xf) == 0xf) goto LAB_001ac5b0;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (ulong)(uVar10 & 0xf) * 2));
    goto switchD_001a4f6c_caseD_33;
  case 0x115:
  ...
  case 0x117:
    ...
    iVar2 = (int)uVar8;
    if (iVar2 != 0xd) {
      if (iVar2 == 0xf) goto LAB_001ac5b0;
LAB_001a86ec:
      MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + uVar8 * 2));
      return uVar3;
    }
    if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) != 0) goto LAB_001a86ec;
    goto LAB_001ae148;
  case 0x118:
    ...
    iVar2 = (int)uVar8;
    if (iVar2 == 0xd) {
      if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) == 0) goto LAB_001ae148;
    }
    else if (iVar2 == 0xf) goto LAB_001ac5b0;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + uVar8 * 2));
    goto switchD_001a4f6c_caseD_33;
  case 0x119:
    uVar8 = uVar8 >> 8 & 0xf;
...
LAB_001ac940:
      ...
      if (iVar2 != 0xf) goto LAB_001ac940;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abd8c:
      param_1 = 1;
    }
...
LAB_001aca60:
      ...
      if (iVar2 != 0xf) goto LAB_001aca60;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ac07c:
      param_1 = 1;
    }
...
LAB_001ac924:
      ...
      if (iVar2 != 0xf) goto LAB_001ac924;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ac02c:
      param_1 = 1;
    }
...
LAB_001ac9d0:
      ...
      if (iVar2 != 0xf) goto LAB_001ac9d0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aa370:
      param_1 = 1;
    }
...
LAB_001ac89c:
      ...
      if (iVar2 != 0xf) goto LAB_001ac89c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab1a8:
      param_1 = 1;
    }
...
LAB_001adb4c:
      ...
      if (iVar2 != 0xf) goto LAB_001adb4c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab1cc:
      param_1 = 1;
    }
...
LAB_001ac7f4:
      ...
      if (iVar2 != 0xf) goto LAB_001ac7f4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8304:
      param_1 = 1;
    }
...
LAB_001ac8d4:
      ...
      if (iVar2 != 0xf) goto LAB_001ac8d4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8290:
      param_1 = 1;
    }
...
LAB_001ac784:
      ...
      if (iVar2 != 0xf) goto LAB_001ac784;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abfc0:
      param_1 = 1;
    }
...
LAB_001ad5f0:
      ...
      if (uVar7 != 0xf) goto LAB_001ad5f0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001abfe4:
      param_1 = 1;
    }
...
LAB_001ac908:
      ...
      if (iVar2 != 0xf) goto LAB_001ac908;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8234:
      param_1 = 1;
    }
    ...
    if (uVar7 == 0xd) {
      if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) != 0) goto LAB_001a8250;
      goto LAB_001ae148;
    }
    if (uVar7 != 0xf) {
LAB_001a8250:
...
LAB_001ac8b8:
      ...
      if (iVar2 != 0xf) goto LAB_001ac8b8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a81ac:
      param_1 = 1;
    }
...
LAB_001adbb4:
      ...
      if (iVar2 != 0xf) goto LAB_001adbb4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a81d0:
      param_1 = 1;
    }
...
LAB_001ac6f8:
      ...
      if (iVar2 != 0xf) goto LAB_001ac6f8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8124:
      param_1 = 1;
    }
...
LAB_001addc0:
      ...
      if (iVar2 != 0xf) goto LAB_001addc0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8148:
      param_1 = 1;
    }
...
LAB_001ac880:
      ...
      if ((int)uVar5 != 0xf) goto LAB_001ac880;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7f58:
      param_1 = 1;
    }
...
LAB_001adff0:
      ...
      if ((int)uVar13 != 0xf) goto LAB_001adff0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7f7c:
      param_1 = 1;
    }
  ...
  case 0x13f:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 != 0xc4f) goto LAB_001acab4;
joined_r0x001a9538:
    if (uVar7 >> 0x1c == 0xe) {
      return 0;
    }
...
LAB_001a5a3c:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a5a3c;
      MCOperand_CreateReg0(param_4,0);
    }
    uVar10 = uVar7 & 0xff;
    ...
    if ((param_3 & 0xff) != 0) {
      if (uVar1 + uVar10 < 0x21) {
        MCOperand_CreateReg0(param_4,uVar12);
        if (uVar10 == 1) goto switchD_001a4f6c_caseD_33;
        if (uVar1 == 0x1f) {
          return 0;
        }
        uVar10 = uVar10 - 1;
      ...
      uVar8 = (ulong)(uVar1 + 2);
      while (MCOperand_CreateReg0(param_4,*(undefined2 *)(&DAT_0022f15e + uVar8 * 2)),
  ...
  case 0x145:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 == 0xc4f) goto joined_r0x001a9538;
LAB_001acab4:
    MCOperand_CreateImm0(param_4,uVar7 >> 0x1c);
    if (uVar7 >> 0x1c != 0xe) goto LAB_001a4fd8;
    goto LAB_001a516c;
  case 0x148:
    MCOperand_CreateReg0
              (param_4,*(undefined2 *)(DPR + (ulong)(uVar7 & 0xf | (uVar7 & 0x20) >> 1) * 2));
...
LAB_001a9d14:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a9d14;
      MCOperand_CreateReg0(param_4,0);
    }
...
LAB_001a7518:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a7518;
      MCOperand_CreateReg0(param_4,0);
    }
...
LAB_001a9984:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a9984;
      MCOperand_CreateReg0(param_4,0);
    }
    uVar10 = uVar7 & 0xff;
    uVar7 = (uVar7 >> 0x16 & 1) << 8 | (uVar7 & 0xf000) >> 3;
...
LAB_001a98e8:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a98e8;
      MCOperand_CreateReg0(param_4,0);
    }
    iVar2 = DecodeDPRRegListOperand_isra_0
                      (param_4,uVar7 & 0xfe | (uVar7 & 0xf000) >> 4 | (uVar7 & 0x400000) >> 10);
...
LAB_001a93e0:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a93e0;
      MCOperand_CreateReg0(param_4,0);
    }
    iVar2 = DecodeDPRRegListOperand_isra_0(param_4,uVar7 & 0xfe | (uVar7 & 0xf000) >> 4);
    break;
...
LAB_001a4f24:
      ...
      MCOperand_CreateImm0(param_4,uVar8);
      if ((int)uVar8 != 0xe) goto LAB_001a4f24;
      MCOperand_CreateReg0(param_4,0);
    }
LAB_001a4f30:
    if ((uVar7 >> 0x14 & 1) == 0) goto LAB_001a4f34;
    goto LAB_001a521c;
  }
  if (iVar2 == 1) {
LAB_001a5a80:
