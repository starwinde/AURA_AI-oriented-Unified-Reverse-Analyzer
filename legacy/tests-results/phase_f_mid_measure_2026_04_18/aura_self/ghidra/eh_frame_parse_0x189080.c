...
LAB_00189148:
    if (((char *)*puVar30 != (char *)0x0) &&
       (iVar9 = strcmp((char *)*puVar30,".gcc_except_table"), iVar9 == 0)) goto LAB_00189170;
  }
...
LAB_00189170:
  ...
  if (puVar34 != (undefined8 *)0x0) {
    ...
    if (uVar31 == 0) {
      ...
      uVar41 = 0;
      __ptr = (long *)0x0;
      if (puVar30 == (undefined8 *)0x0) goto LAB_0018a1e0;
LAB_00189324:
      uVar40 = (uint)uVar31;
      uVar24 = 0;
      pvVar11 = (void *)0x0;
              ...
              if (uVar31 < uVar33) {
                ...
                if (uVar23 < uVar33) {
                  ...
                  if (*(char *)(lVar10 + uVar23) != -1) {
                    if (uVar33 <= local_70) goto LAB_0018a8b8;
                  ...
                  if (local_70 < uVar33) {
                    ...
                    uVar23 = uVar31;
                    if (uVar33 <= uVar31) goto LAB_00189538;
                    uVar23 = local_70 + 2;
...
LAB_00189650:
                          ...
                          if (uVar18 <= uVar23) goto LAB_00189374;
                        } while (cVar21 != '\x01');
LAB_0018a290:
                        if (uVar23 < uVar33) {
                          unaff_x26 = uVar23 + 1;
...
LAB_0018af24:
                  ...
                  if (cVar21 == '\x01') goto LAB_001897f0;
                  if (cVar21 != '\x03') break;
LAB_001896b4:
                  if (uVar33 < uVar23 + 4) {
                    uVar39 = 0;
...
LAB_00189784:
                    ...
                    do {
                      ...
                      if (uVar18 <= uVar23) goto LAB_00189374;
                      if (cVar21 != '\x01') goto LAB_001896b4;
LAB_001897f0:
                      uVar39 = 0;
                      if (uVar33 <= uVar23) {
LAB_0018af38:
...
LAB_0018af3c:
                      ...
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_0018af38;
                      uVar31 = local_70 + 1;
                      ...
                      local_70 = uVar23;
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_0018af3c;
                      uVar31 = local_70 + 1;
...
LAB_0018a164:
              uVar33 = uVar18 + 8;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_00189d30;
              if (uVar31 < uVar18 + 4) goto LAB_0018a880;
...
LAB_0018a244:
                ...
                uVar18 = local_70;
                if (uVar23 <= uVar31) goto LAB_0018a164;
                break;
              }
              local_70 = uVar31 + 4;
              if (local_70 <= uVar31) {
              ...
              local_70 = uVar31;
              if (uVar31 < 0xfffffffffffffff8) goto LAB_00189d30;
LAB_0018a880:
              uVar33 = uVar31 + 4;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_00189d30;
                ...
                if (*plVar13 == lVar10) {
                  ...
                  if (uVar40 < 0x80000) {
                    if (uVar27 <= uVar40) {
                      ...
                      if (pvVar11 != (void *)0x0) goto LAB_001892f0;
                      break;
                    }
                  }
                  else {
...
LAB_00189d30:
            ...
            uVar26 = uVar25;
            if (uVar41 < 0x10000) {
              if (uVar41 < uVar25) goto LAB_00189d40;
              if (uVar25 == 0) {
                sVar17 = 0x900;
                uVar26 = 0x20;
              }
              ...
              if (plVar13 != (long *)0x0) goto LAB_0018a140;
            }
            else {
LAB_0018a140:
              __ptr = plVar13;
...
LAB_00189db8:
                ...
                *(undefined1 *)((long)plVar13 + uVar39 + lVar10 + 0x24) = 0;
                if (uVar38 < uVar31) {
                  ...
                  if (uVar31 <= local_70) goto LAB_0018ac30;
...
LAB_0018aeb4:
                  ...
                  if (uVar31 <= local_70) goto LAB_0018ac34;
...
LAB_0018ad90:
      ...
      uVar31 = (ulong)uVar40;
      if (puVar30 != (undefined8 *)0x0) goto LAB_00189324;
LAB_0018a1e0:
      pvVar11 = (void *)0x0;
      uVar24 = 0;
    }
