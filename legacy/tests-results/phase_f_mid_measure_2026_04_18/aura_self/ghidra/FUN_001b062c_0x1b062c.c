...
void FUN_001b062c(long param_1,int param_2,undefined8 param_3)

{
  ...
  if (uVar3 == 3) {
    SStream_concat0(param_3,&DAT_001fa1e0);
    goto LAB_001b0720;
  }
  if ((uVar2 >> 2 & 1) == 0) {
    if (uVar3 == 1) {
      SStream_concat0(param_3,&DAT_001fa1e8);
      goto LAB_001b0720;
    }
    if (uVar3 == 2) {
      SStream_concat0(param_3,&DAT_001fa1d8);
      goto LAB_001b0720;
    }
  }
  else {
    ...
    if (uVar3 == 5) {
      SStream_concat0(param_3,&DAT_001fd930);
      return;
    }
  }
  SStream_concat0(param_3,&DAT_001fe008);
LAB_001b0720:
