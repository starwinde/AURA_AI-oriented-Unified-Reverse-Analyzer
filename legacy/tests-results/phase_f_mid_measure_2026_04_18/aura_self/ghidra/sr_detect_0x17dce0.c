          ...
          if (uVar11 < uVar3) {
            ...
            while( true ) {
              ...
              while ((*(int *)(lVar12 + 0x18) != piVar7[2] || (*piVar7 != 0xb))) {
                iVar20 = iVar20 + -1;
                piVar7 = piVar7 + -0x22;
                if (iVar20 == -1) goto joined_r0x0017e170;
              }
...
LAB_0017e018:
              ...
              if (uVar22 <= uVar19) {
                ...
                if (__ptr_00 == (void *)0x0) goto LAB_0017def8;
              }
              lVar12 = uVar21 * 0x10;
              ...
              *(undefined2 *)((long)__ptr_00 + lVar12 + 0xc) = 0;
              uVar21 = uVar15;
              if (uVar3 <= uVar25) {
                if (uVar19 + 1 < 2) goto LAB_0017e174;
                goto LAB_0017de00;
              }
...
LAB_0017de00:
                ...
                iVar26 = -1;
                if (uVar25 < uVar3) goto LAB_0017e0f8;
              }
