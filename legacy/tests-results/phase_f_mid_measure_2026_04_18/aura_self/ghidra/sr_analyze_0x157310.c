...
joined_r0x001578f8:
                    ...
                    uVar24 = *(uint *)(param_1 + 1);
                    lVar29 = lVar29 + 0x88;
                    if (uVar18 <= uVar30) goto LAB_00157580;
                    goto LAB_001574b0;
                  }
...
LAB_001576cc:
            ...
            *(uint *)(puVar22 + 2) = uVar2;
            if (uVar24 != 1) goto LAB_001576cc;
          }
          puVar22 = puVar22 + 0xc;
          if (puVar22 == puVar23) goto LAB_00157778;
        }
        puVar19 = puVar22 + 0xc;
