  ...
  if (uVar9 == 0) {
    ...
    if (uVar4 < 2) {
      ...
      do {
        ...
        pauVar3 = pauVar6 + 1;
        pauVar6 = pauVar6 + 3;
        auVar10 = a64_TBL(ZEXT816(0),auVar10,*pauVar3,_DAT_0020c070);
        iVar11 = iVar11 + (_DAT_0020c090 ^
                          (_DAT_0020c090 ^ _DAT_0020c080) & -(uint)(auVar10._0_4_ == 0));
        iVar12 = iVar12 + (_UNK_0020c094 ^
                          (_UNK_0020c094 ^ _UNK_0020c084) & -(uint)(auVar10._4_4_ == 0));
        iVar13 = iVar13 + (_UNK_0020c098 ^
                          (_UNK_0020c098 ^ _UNK_0020c088) & -(uint)(auVar10._8_4_ == 0));
        iVar14 = iVar14 + (_UNK_0020c09c ^
                          (_UNK_0020c09c ^ _UNK_0020c08c) & -(uint)(auVar10._12_4_ == 0));
