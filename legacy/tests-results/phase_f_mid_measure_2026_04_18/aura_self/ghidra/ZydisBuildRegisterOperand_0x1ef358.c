...
void ZydisBuildRegisterOperand(long param_1,byte *param_2,ulong *param_3)

{
  ...
  if ((*param_2 & 0x3f) != 1) {
    iVar3 = ZydisRegisterGetClass(*(undefined4 *)(param_1 + 4));
    bVar2 = ZydisGetPhysicalId(*(undefined4 *)(param_1 + 4),iVar3);
    if (((iVar3 == 1) && (8 < *(uint *)(param_1 + 4))) && (*(uint *)(param_1 + 4) < 0xd)) {
      *param_3 = *param_3 | 4;
    }
    pbVar4 = (byte *)ZydisGetOperandDetails(param_2);
    bVar1 = *pbVar4 & 0x3f;
    if (bVar1 == 6) {
