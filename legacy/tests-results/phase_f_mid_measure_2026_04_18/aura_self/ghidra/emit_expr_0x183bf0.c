...

{
  ...
  do {
    while( true ) {
      ...
      uVar4 = *param_1;
      if (uVar4 == 0x11) {
        __fprintf_chk(param_2,2,&DAT_001fd000,param_1 + 0x26);
        lVar12 = 0;
        if (param_1[0x4a] != 0) {
          do {
            if ((int)lVar12 == 0) {
      ...
      if (uVar4 < 0x15) {
        if (uVar4 != 0x12) {
          ...
          if ((char)param_1[0x3a] != '\0') {
            uVar6 = __fprintf_chk(param_2,2,&DAT_001fd1d0,param_1 + 0x28);
            return uVar6;
          }
          uVar6 = __fprintf_chk(param_2,2,&DAT_001fd1d8,param_1 + 0x28);
          return uVar6;
        }
        param_3 = 0xd;
        __fprintf_chk(param_2,2,&DAT_001fd008,param_1 + 0x28);
...
LAB_00183fa8:
        ...
        if (3 < param_3) {
          ...
          fwrite(&DAT_001fa4b8,1,3,param_2);
          emit_expr(*(undefined8 *)(param_1 + 0x28),param_2,3);
          fwrite(&DAT_001f9450,1,3,param_2);
    ...
    if (uVar4 == 0xf) {
      ...
      if (uVar4 < 0x13) {
        ...
        if ((param_1[0x2a] - 0xf & 0xfffffffa) != 0) goto LAB_00183ff4;
        if (iVar5 < param_3) {
          fputc(0x28,param_2);
        }
        ...
        switch(param_1[0x2a]) {
        case 2:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa410);
          break;
        case 3:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa418);
          break;
        case 4:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa420);
          break;
        case 5:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa428);
          break;
        case 6:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa430);
          break;
        case 7:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,"|");
          break;
        case 8:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa438);
          break;
        case 9:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa440);
          break;
        case 10:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa448);
          break;
        case 0xb:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,"==");
          break;
        case 0xc:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa450);
          break;
        case 0xd:
        case 0xf:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa458);
          break;
        case 0xe:
        case 0x10:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa460);
          break;
        case 0x11:
        case 0x13:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa468);
          break;
        case 0x12:
        case 0x14:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fa470);
          break;
        default:
          __fprintf_chk(param_2,2,&DAT_001fa4c0,&DAT_001fd1b8);
        }
        fwrite("(uint64_t)(",1,0xb,param_2);
        emit_expr(*(undefined8 *)(param_1 + 0x28),param_2,0);
...
LAB_00183f6c:
    ...
    if (uVar4 != 0x10) {
      if (uVar4 == 0xd) {
        if ((s_emit_func == 0) || (*(uint *)(s_emit_func + 0xdd0) == 0)) goto LAB_00183e40;
        puVar14 = (uint *)(s_emit_func + 0x1d8);
        uVar4 = 0;
        break;
      }
      if (uVar4 != 0xe) goto LAB_00183fa8;
      if ((char)param_1[0x2a] != '\0') {
        uVar6 = __fprintf_chk(*(undefined8 *)(param_1 + 0x28),param_2,2,&DAT_001fcff0);
        return uVar6;
      }
      uVar6 = *(ulong *)(param_1 + 0x26);
      if (((long)uVar6 < 0) || ((long)uVar6 < 0x100 && (char)param_1[0x22] == '\0')) {
        uVar6 = __fprintf_chk(param_2,2,&DAT_001fcff8);
        return uVar6;
      }
    ...
    if (uVar4 == 3) {
      ...
      if (piVar10 != (int *)0x0) {
        if (*piVar10 == 0xf) {
          ...
          __ptr = &DAT_001fa420;
          if ((*piVar10 != 0xe) || ((char)piVar10[0x2a] != '\0')) goto LAB_00183efc;
          lVar8 = *(long *)(piVar10 + 0x26);
          lVar12 = -lVar8;
          if (-1 < lVar8) {
            lVar12 = lVar8;
...
LAB_00183e40:
    ...
    uVar6 = __fprintf_chk(param_2,2,&DAT_001fa488,param_1[0x26]);
    return uVar6;
  }
  goto LAB_00183e18;
LAB_001846d4:
