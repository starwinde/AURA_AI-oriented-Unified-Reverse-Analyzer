...
LAB_001da2dc:
        ...
        SStream_concat(param_2,&DAT_001ff5e8,
      ...
      goto switchD_001d90a4_caseD_662;
    }
    goto LAB_001d901c;
  }
  uVar12 = iVar9 - 0xfd9;
...
LAB_001d8898:
    ...
    if ((((uVar24 & 1) != 0) && (lVar18 = MCOperand_getImm(uVar16), lVar18 == 0)) &&
      ...
      if (lVar18 == 0xf) {
        if (uVar12 < 2) {
          puVar28 = &DAT_001fece0;
        }
        else {
          if (bVar7 || bVar6) goto LAB_001d8900;
          puVar28 = &DAT_001fee20;
        }
        goto LAB_001d93e0;
      }
      if (lVar18 == 0x1f) {
        if ((bVar7 || bVar6) && bVar8) {
          puVar28 = &DAT_001ff5c8;
          goto LAB_001d93e0;
        }
      }
      else if (lVar18 == 7) {
        if (uVar12 < 2) {
          puVar28 = &DAT_001fecd0;
        }
        else {
          if (bVar7 || bVar6) goto LAB_001d8900;
          puVar28 = &DAT_001fee10;
        }
LAB_001d93e0:
...
LAB_001d890c:
      ...
      if (lVar27 < lVar18) {
        ...
        puVar28 = &DAT_001fed38;
        if (uVar12 < 2) {
          puVar28 = &DAT_001fe9b8;
        }
        iVar9 = MCOperand_getReg(uVar25);
        uVar4 = *(ushort *)(RegAsmOffsetNoRegAltName_12 + (ulong)(iVar9 - 1) * 2);
        iVar9 = MCOperand_getReg(uVar19);
      ...
      if (bVar8 || iVar13 == 0x1f) {
        if (iVar13 == 0x3f || !bVar6) {
          local_b8 = &DAT_001fa1e0;
          if (((bVar8 || iVar13 != 0x1f) && (iVar13 != 0x3f || !bVar6)) &&
             (local_b8 = &DAT_001fa1e8, iVar9 != 0xfd9 || iVar13 != 0x1f)) {
LAB_001da80c:
            if (!bVar7 || iVar13 != 0x3f) goto LAB_001d890c;
LAB_001d9e98:
            local_b8 = &DAT_001fa1e8;
          }
        }
        else {
          if (iVar13 + 1 == iVar15) {
          ...
          local_b8 = &DAT_001fa1e0;
          if (bVar8 || iVar13 != 0x1f) {
            if (iVar9 != 0xfd9 || iVar13 != 0x1f) goto LAB_001d890c;
            goto LAB_001d9e98;
          }
        }
      }
        ...
        if (iVar13 + 1 != iVar15) {
          if (iVar13 == 0x3f || !bVar6) {
            local_b8 = &DAT_001fa1e0;
            if (iVar13 != 0x3f || !bVar6) goto LAB_001da80c;
            goto LAB_001d8ac8;
          }
          goto LAB_001d890c;
        }
...
LAB_001d8ac8:
    ...
    if (iVar9 - 0x489U < 2) {
      ...
      if ((iVar14 == 8) || (iVar14 = MCOperand_getReg(uVar19), iVar14 == 9)) {
        if (iVar15 != 0 && iVar15 <= iVar13) goto LAB_001d9878;
        iVar14 = 0x20;
        if (iVar9 == 0x48a) {
          iVar14 = 0x40;
        }
        ...
        uVar11 = AArch64_map_insn(&DAT_001fe640);
        MCInst_setOpcodePub(param_1,uVar11);
        lVar18 = *(long *)(param_1 + 800);
        if (*(int *)(lVar18 + 0x60) != 0) {
          uVar11 = MCInst_getOpcode(param_1);
        ...
        SStream_concat0(param_2,", ");
        printInt32Bang(param_2,iVar13 + 1);
        uVar11 = AArch64_map_insn(&DAT_001fe648);
        MCInst_setOpcodePub(param_1,uVar11);
        lVar18 = *(long *)(param_1 + 800);
        if (*(int *)(lVar18 + 0x60) != 0) {
          uVar11 = MCInst_getOpcode(param_1);
...
LAB_001d9bc8:
          puVar28 = &DAT_001f9a30;
          goto LAB_001d8844;
        }
        goto LAB_001d901c;
      }
      if (iVar9 != 0x1583) goto LAB_001d901c;
      SStream_concat0(param_2,"tsb\tcsync");
      puVar28 = &DAT_001fed00;
LAB_001d8844:
    ...
    *(undefined8 *)(param_1 + 0x3b0) = param_3;
    ...
    if (uVar12 < 0xbe1) {
      if (uVar12 < 0xbd2) {
        if (uVar12 < 0x6c1) {
          if (uVar12 < 0x652) {
            if ((uVar12 == 0x42b) || (uVar12 == 0x434)) goto switchD_001d90a4_caseD_6b3;
          }
          else {
            switch(uVar12) {
            case 0x652:
...
switchD_001d90a4_caseD_652:
            ...
            case 0x68d:
            case 0x691:
              goto switchD_001d90a4_caseD_653;
            case 0x654:
            case 0x658:
            case 0x65c:
            case 0x660:
            case 0x68e:
            case 0x692:
              goto switchD_001d90a4_caseD_654;
            case 0x655:
            case 0x659:
            case 0x65d:
            case 0x661:
            case 0x68f:
            case 0x693:
              goto switchD_001d90a4_caseD_655;
            case 0x694:
              if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
                uVar11 = 4;
                lVar18 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
                *(undefined4 *)(lVar18 + 0x6c) = 4;
                if (*(char *)(lVar18 + 0x67) == '\x01') {
                  ...
                  puVar28 = (undefined *)(local_68 - *(long *)PTR___stack_chk_guard_005ffe88);
                  puVar26 = PTR___stack_chk_guard_005ffe88;
                  if (puVar28 != (undefined *)0x0) goto LAB_001da674;
                  goto LAB_001da5f8;
                }
LAB_001da5c0:
...
LAB_001dabe8:
          ...
          if (uVar12 == 0xb4c) {
            ...
            if (uVar12 == 0x899) goto switchD_001d90a4_caseD_653;
            if (uVar12 < 0x89a) {
              if (uVar12 != 0x7b3) {
                if (uVar12 == 0x7b4) goto switchD_001d90a4_caseD_655;
                if (uVar12 != 0x7b2) goto switchD_001d90a4_caseD_662;
                goto switchD_001d90a4_caseD_653;
              }
            }
            else {
              if (uVar12 == 0x89b) {
switchD_001d90a4_caseD_655:
                if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
                  *(undefined4 *)(*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x6c) = 0xb;
                }
                goto switchD_001d90a4_caseD_662;
              }
              if ((uVar12 != 0xb4b) && (uVar12 != 0x89a)) goto switchD_001d90a4_caseD_662;
            }
switchD_001d90a4_caseD_654:
            if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
            ...
            if (uVar12 != 0xb4f) goto switchD_001d90a4_caseD_655;
switchD_001d90a4_caseD_653:
            if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
          ...
          if (uVar12 == 0xb51) goto switchD_001d90a4_caseD_652;
...
LAB_001d9f58:
          ...
          if ((uVar24 & 1) != 0) goto LAB_001dac68;
        }
...
LAB_001dac30:
          ...
          if ((uVar24 & 0x114400) != 0) goto LAB_001daafc;
          if ((uVar24 & 1) != 0) goto LAB_001da884;
        }
      }
      else {
      ...
      if (uVar12 < 0xc07) {
        if (uVar12 < 0xc01) {
          if (uVar12 != 0xbe1) {
            ...
            if ((uVar24 & 0x4411) != 0) goto LAB_001dad68;
            if ((uVar24 & 0x1144) != 0) goto LAB_001dac30;
            if (uVar12 == 0xc00) {
              iVar9 = 0;
              puVar26 = (undefined *)(local_68 - *(long *)PTR___stack_chk_guard_005ffe88);
              if ((undefined *)(local_68 - *(long *)PTR___stack_chk_guard_005ffe88) ==
...
LAB_001dab9c:
        ...
        if (uVar12 == 0xea3) goto LAB_001dad44;
        if (uVar12 == 0xeaa) goto LAB_001dac68;
      }
    }
...
LAB_001dad44:
        ...
        if (uVar12 == 0xeb5) goto LAB_001dabe8;
        if (uVar12 == 0xeb6) goto LAB_001dab9c;
      }
      ...
      else if (0x100f < uVar12) goto switchD_001d90a4_caseD_6b3;
    }
    else {
      if (uVar12 == 0x16a5) {
        iVar9 = 0;
