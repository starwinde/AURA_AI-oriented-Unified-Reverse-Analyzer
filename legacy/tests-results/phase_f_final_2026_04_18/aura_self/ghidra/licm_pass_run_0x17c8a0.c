  ...
  if (param_1 == (long *)0x0) {
    ...
    if (plVar4 == (long *)0x0) {
      ...
      if (uVar17 == 0) {
        ...
        local_88 = 0;
        local_7c = 0;
        if (puVar19 != (uint *)0x0) goto LAB_0017c930;
LAB_0017c908:
        local_7c = local_7c + 1;
        if (local_7c < uVar17) {
          while( true ) {
                  ...
                  if (uVar17 != 0) {
                    ...
                    do {
                      while( true ) {
                        ...
                        if (uVar15 != 1) goto LAB_0017ca40;
LAB_0017ca10:
                        uVar5 = (ulong)uVar9;
                        if (uVar17 <= uVar9) goto LAB_0017cb80;
                      }
                      if (uVar15 != 0x1c) goto LAB_0017ca10;
LAB_0017ca40:
                      if (*(uint *)(puVar2 + 9) != 0) {
                        puVar8 = puVar2;
                        do {
                              ...
                              do {
                                if (*puVar7 < *(uint *)(param_1 + 1)) {
                                  ...
                                  if (uVar15 != 0) {
                                    ...
                                    do {
                                      if (*(int *)(puVar8 + 3) == *piVar6) goto LAB_0017ca10;
                                      piVar6 = piVar6 + 0x22;
...
LAB_0017cad0:
                          ...
                          *(uint *)(lVar21 + 0x14) = uVar15;
                          ...
                          if (uVar11 < uVar17) goto LAB_0017ccb4;
                        }
                      }
                      else {
                        uVar11 = uVar17 - 1;
                        ...
                        if (1 < *(int *)((long)__ptr + lVar14) - 0x17U &&
                            *(int *)((long)__ptr + lVar14) != 0x1a) goto LAB_0017cc64;
                        if (uVar15 <= uVar17) goto LAB_0017cad0;
LAB_0017ccb4:
...
LAB_0017cb80:
            ...
            local_7c = local_7c + 1;
            plVar4 = local_70;
            if (uVar17 <= local_7c) goto LAB_0017cbc8;
          }
LAB_0017ccf8:
          uVar17 = *(uint *)(local_70 + 1);
          plVar4 = local_70;
