...
LAB_001948e4:
    ...
    if (0xaf7 < uVar2) {
      if (uVar2 < 0xc0c) {
        if (0xc09 < uVar2) goto LAB_001949b0;
      }
      else if (uVar2 - 0xc46 < 0x36) {
        uVar4 = 1L << ((ulong)(uVar2 - 0xc46) & 0x3f);
        if ((uVar4 & 0x20004000010e00) != 0) goto LAB_001947b8;
        if ((uVar4 & 1) != 0) goto LAB_001949b0;
      }
LAB_001948d8:
      uVar2 = *(uint *)(param_1 + 0x5c);
      uVar10 = 3;
...
LAB_001949b0:
      ...
      if ((uVar2 < 0xad3) || ((uVar2 != 0xada && (2 < uVar2 - 0xae5)))) goto LAB_001948d8;
LAB_001947b8:
      uVar2 = *(uint *)(param_1 + 0x5c);
      if (uVar2 == 0) {
        return 3;
