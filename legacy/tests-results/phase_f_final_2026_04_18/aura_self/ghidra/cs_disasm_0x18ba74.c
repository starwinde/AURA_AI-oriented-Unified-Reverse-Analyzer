        ...
        do {
          ...
          *(long *)(piVar5 + 2) = lVar11;
          ...
          if ((uVar7 & 1) == 0) {
            ...
            if ((*(byte *)(param_1 + 0x20) & 1) == 0) goto joined_r0x0018bf38;
            bVar2 = *(byte *)((long)param_1 + 0x81);
            __n = (size_t)bVar2;
            if (uVar12 < bVar2) goto joined_r0x0018bf38;
...
LAB_0018bc5c:
        ...
        uVar13 = uVar14;
joined_r0x0018bf38:
        if (local_6a8 == 0) goto LAB_0018be28;
        piVar5 = local_688;
        if ((uVar13 != local_69c) &&
