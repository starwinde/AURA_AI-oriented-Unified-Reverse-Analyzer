...

{
  ...
  if (5 < param_1) goto LAB_001f181c;
  if (param_1 < 4) {
    if (param_1 == 3) {
LAB_001f1808:
      local_a = 1;
...
LAB_001f181c:
      ...
      if (param_1 == 2) goto LAB_001f1814;
      if (2 < param_1) goto LAB_001f181c;
      if (param_1 != 0) {
        if (param_1 != 1) goto LAB_001f181c;
        goto LAB_001f1808;
      }
      local_a = 2;
    }
...
LAB_001f1984:
        ...
        if (local_a == 0) {
          ...
          if (local_a != 1) goto LAB_001f1984;
          uVar2 = local_9 + 0x45;
        }
      }
    }
