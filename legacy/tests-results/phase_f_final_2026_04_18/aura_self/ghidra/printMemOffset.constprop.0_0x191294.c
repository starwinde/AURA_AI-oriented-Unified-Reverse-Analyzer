...
LAB_00191628:
              ...
              if (((((uVar1 != 1) &&
                ...
                a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar12 + (uVar14 - 0xef)),_DAT_0020b540);
              }
              uVar7 = uVar8 & 0xf0;
              if ((uVar8 & 0xf) != 0) {
                uVar8 = uVar13 - uVar7;
                uVar11 = (ulong)((uVar8 & 0xff) + 1 & 0xff);
                if (6 < (uVar8 & 0xff)) goto LAB_001915ec;
                goto LAB_00191628;
              }
            }
          }
            ...
            do {
              ...
              while (cVar3 != -0x80) {
                ...
                *pcVar4 = cVar3;
                pcVar12 = pcVar12 + -1;
                uVar8 = uVar1 & 0xff;
                if (uVar13 < (uVar1 & 0xff)) goto LAB_00191718;
                pcVar4 = pcVar4 + 1;
                cVar3 = *pcVar12;
              }
              uVar1 = uVar8 + 1;
...
joined_r0x001917a0:
  if ((uVar11 & 1) != 0) {
    ...
    if ((long)uVar11 < 0) {
      ...
      SStream_concat(param_2,&DAT_001fa8c0);
    }
    else {
      SStream_concat(param_2,"0x%lx");
    }
