...
undefined8 cJSON_ReplaceItemInObjectCaseSensitive(long param_1,char *param_2,long *param_3)
    ...
    if (param_1 != 0) {
      ...
      for (plVar5 = plVar6; (plVar5 != (long *)0x0 && ((char *)plVar5[7] != (char *)0x0));
        ...
        if (iVar1 == 0) {
          ...
          *param_3 = lVar7;
          if (lVar7 == 0) {
            if (plVar6 == plVar5) goto LAB_001f6330;
            puVar3 = (undefined8 *)param_3[1];
            if (puVar3 != (undefined8 *)0x0) goto LAB_001f62dc;
          }
          else {
...
LAB_001f6330:
            ...
            puVar3 = (undefined8 *)param_3[1];
            if (puVar3 == (undefined8 *)0x0) goto LAB_001f62e8;
LAB_001f62dc:
            *puVar3 = param_3;
            if (*param_3 != 0) goto LAB_001f62e8;
          }
