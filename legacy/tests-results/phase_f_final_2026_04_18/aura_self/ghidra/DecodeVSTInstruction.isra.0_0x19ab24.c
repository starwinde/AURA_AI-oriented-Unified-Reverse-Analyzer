...

{
  ...
  if (uVar2 < 0xa03) {
    if (0x9c3 < uVar2) {
      ...
      if ((uVar5 & 0x61861b6db) != 0) goto LAB_0019ab90;
      uVar5 = uVar5 & 0x4400000000000000;
      goto joined_r0x0019ac98;
    }
    if (uVar2 < 0x9af) {
      if (uVar2 < 0x971) {
        if (uVar2 < 0x968) {
          if (0x965 < uVar2) goto LAB_0019ab90;
        }
...
LAB_0019ab90:
      ...
      else if ((0x3060c183cc7860f3U >> ((ulong)(uVar2 - 0x971) & 0x3f) & 1) != 0) goto LAB_0019ab90;
    }
  }
  else {
    if (0x3c < uVar2 - 0xa06) goto LAB_0019aba8;
...
LAB_0019aba8:
  ...
  if (uVar2 == 0) {
    ...
    if (0x9a6 < uVar3) goto LAB_0019acc4;
LAB_0019abe0:
    if (0x969 < uVar3) {
      uVar5 = 0x102040a214102885 >> ((ulong)(uVar3 - 0x96a) & 0x3f);
      goto joined_r0x0019ace4;
    }
    if (uVar3 == 0x966) goto LAB_0019ac04;
    if (uVar1 != 0xd) goto LAB_0019acf0;
LAB_0019af50:
    ...
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x9a7) goto LAB_0019abe0;
LAB_0019acc4:
    if (uVar3 - 0x9ad < 0x39) {
      uVar5 = 0x104104924800001 >> ((ulong)(uVar3 - 0x9ad) & 0x3f);
joined_r0x0019ace4:
      if ((uVar5 & 1) == 0) goto LAB_0019ace8;
    }
    else {
LAB_0019ace8:
      if (uVar1 == 0xd) goto LAB_0019af50;
LAB_0019acf0:
      if (uVar1 != 0xf) {
...
LAB_0019ad5c:
    ...
    if ((uVar5 & 0x1ff000000061c387) != 0) goto LAB_0019ad5c;
    if ((uVar5 & 0xff80000000000) == 0) goto LAB_0019ad80;
    if (0x1d < uVar1) {
      return 0;
    }
...
LAB_0019ad80:
  ...
  if (uVar3 < 0xa04) {
    ...
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_0019ade8;
      uVar5 = (ulong)(uVar1 + 1);
    }
LAB_0019add0:
...
LAB_0019ade8:
  ...
  if (uVar3 < 0xa04) {
    ...
    if (0x3c < uVar3 - 0xa06) goto LAB_0019ae38;
    uVar6 = 1L << ((ulong)(uVar3 - 0xa06) & 0x3f);
    uVar5 = (ulong)(uVar1 + 4);
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_0019ae38;
      uVar5 = (ulong)(uVar1 + 2);
    }
  }
  MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (uVar5 & 0x1f) * 2));
