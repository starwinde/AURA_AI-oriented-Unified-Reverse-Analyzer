...
uint FUN_0019814c(long param_1,ulong param_2)

{
  ...
  iVar11 = (int)uVar12;
  if (uVar5 < 0x288) {
    if (0x284 < uVar5) goto LAB_001982f0;
LAB_001981e0:
    uVar5 = 3;
    uVar6 = MCInst_getOpcode(param_1);
    if (0x29a < uVar6) goto LAB_00198310;
LAB_001981f0:
    if (uVar6 < 0x285) goto LAB_00198248;
...
LAB_001985c8:
        if (uVar15 != 0xf) goto LAB_00198248;
        goto LAB_0019824c;
      }
      if ((uVar3 & 1) == 0) {
        ...
        if ((uVar4 & 1) == 0 && uVar2 == 0) goto LAB_00198250;
        if ((uVar17 == 0xf) != 0 || uVar15 == uVar17) {
          uVar6 = 1;
        }
      }
      else {
        if (uVar15 == 0xf) goto LAB_0019824c;
        uVar6 = uVar14;
        if ((uVar4 & 1) == 0 && uVar2 == 0 || uVar15 != uVar17) goto LAB_00198248;
      }
      goto LAB_00198390;
    }
    if ((uVar9 & 0xc80) != 0) {
      if ((uVar7 & uVar17 == 0xf) != 0) goto LAB_001985c8;
      if (uVar15 == 0xf) {
        uVar5 = uVar14;
      }
    ...
    if ((uVar9 & 7) == 0) goto LAB_00198248;
    if ((uVar7 & uVar17 == 0xf) != 0) {
      if (uVar15 == 0xe) goto LAB_0019824c;
      goto LAB_00198248;
    }
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar6 = uVar14;
      if (((uVar4 & 1) != 0 || uVar2 != 0) && (uVar17 == 0xf) != 0) goto LAB_001986d8;
    }
...
LAB_00198454:
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) goto LAB_00198404;
        uVar10 = *(undefined2 *)(GPR + uVar18 * 2);
        goto LAB_00198480;
      }
    }
    else if (uVar7 - 0x360 < 3) goto LAB_00198454;
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar18 * 2));
  }
  else {
    if (2 < uVar5 - 0x360) goto LAB_001981e0;
LAB_001982f0:
    ...
    uVar6 = MCInst_getOpcode(param_1);
    if (uVar6 < 0x29b) goto LAB_001981f0;
LAB_00198310:
    if (uVar6 == 0x367) {
LAB_0019859c:
      uVar6 = uVar5;
    ...
    if (uVar6 < 0x368) {
      if (uVar6 - 0x360 < 3) {
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) {
          ...
          else if (uVar17 == uVar15 + 1) goto LAB_001986d8;
        }
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) goto LAB_00198390;
        goto LAB_00198250;
      }
    }
    else if (uVar6 - 0x36a < 2) goto LAB_0019859c;
LAB_00198248:
    uVar14 = uVar5;
LAB_0019824c:
    uVar6 = uVar14;
...
LAB_00198390:
    ...
    *(undefined1 *)(param_1 + 0x335) = 1;
    ...
    if ((0xb < iVar8 - 0x360U) || ((0xc87UL >> ((ulong)(iVar8 - 0x360U) & 0x3f) & 1) == 0)) {
      ...
      uVar7 = MCInst_getOpcode(param_1);
      if (uVar7 < 0x288) {
        if (uVar7 < 0x285) goto LAB_00198404;
      }
      else {
joined_r0x001986e8:
        if (2 < uVar7 - 0x360) goto LAB_00198404;
      }
      goto LAB_00198454;
    }
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar18 * 2));
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar16 * 2));
    uVar7 = MCInst_getOpcode(param_1);
    if (0x287 < uVar7) goto joined_r0x001986e8;
    if (0x284 < uVar7) goto LAB_00198454;
LAB_00198404:
    iVar8 = MCInst_getOpcode(param_1);
