...
LAB_00172900:
          uStack_70 = 0;
          __strcat_chk(&local_78,&DAT_001fbbe8,0x10);
          if ((*(uint *)(plVar21 + 6) >> 2 & 1) == 0) break;
LAB_00172918:
          __strcat_chk(&local_78,&DAT_001fbbf0,0x10);
          lVar1 = *plVar21;
          lVar18 = plVar21[1];
        }
      } while( true );
...
LAB_0017262c:
    ...
    if (uVar2 != 0) {
      do {
        ...
        bVar4 = false;
        while( true ) {
          puVar15 = &DAT_001fb820;
          if (!bVar6) {
            if (uVar2 < 3 || bVar4) {
              if (uVar2 == 1) {
                puVar15 = &DAT_001f8420;
              }
              else {
                puVar15 = &DAT_001f9918;
                if (uVar2 == 2) {
                  puVar15 = &DAT_001fb818;
                }
              }
            }
            else {
...
LAB_0017187c:
    plVar5 = local_80;
    fwrite(&DAT_001fb880,1,2,param_3);
    fwrite(&DAT_001f9420,1,2,param_3);
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fb888,param_1);
    fwrite(&DAT_001fb8a0,1,2,param_3);
    fwrite(&DAT_001f9420,1,2,param_3);
    uVar22 = *(uint *)(lVar9 + 8);
    if (uVar22 == 3) {
      pcVar12 = "Mach-O";
    ...
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fb8b0,pcVar12);
    fwrite(&DAT_001fb8a0,1,2,param_3);
    fwrite(&DAT_001f9420,1,2,param_3);
    ...
    if (*(int *)(lVar9 + 0x20) != 0) {
      ...
      do {
        while( true ) {
          ...
          puVar13 = &DAT_001fd4a8;
          if (puVar14 != (undefined1 *)0x0) {
            puVar13 = puVar14;
          }
          uVar22 = uVar22 + 1;
          __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fb030,puVar13);
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","vaddr",*(undefined8 *)(lVar1 + 8));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fb048,*(undefined8 *)(lVar1 + 0x18));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"flags\": %u",*(undefined4 *)(lVar1 + 0x30));
          if (*(uint *)(lVar9 + 0x20) <= uVar22) break;
          __fprintf_chk(param_3,2,&DAT_001fb948,&DAT_001f8498);
          lVar20 = lVar20 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar22) goto LAB_00171bd8;
        }
        lVar20 = lVar20 + 0x38;
        __fprintf_chk(param_3,2,&DAT_001fb948,&DAT_001fd4a8);
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            lVar1 = lVar18 + lVar20;
            fwrite("    {",1,5,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fb030,lVar1 + 0x14);
            fwrite(", ",1,2,param_3);
            uVar22 = uVar22 + 1;
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","start",*(undefined8 *)(lVar18 + lVar20));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fb988,*(undefined8 *)(lVar1 + 8));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fb048,*(undefined4 *)(lVar1 + 0x10));
      ...
      if ((plVar21 != (long *)0x0) && ((int)plVar21[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fb9b8,*(undefined8 *)(lVar1 + 0x10))
            ;
            if (uVar22 < *(uint *)(plVar21 + 1)) break;
            __fprintf_chk(param_3,2,&DAT_001fb948,&DAT_001fd4a8);
            lVar20 = lVar20 + 0x18;
...
LAB_00172130:
    fwrite("  ],\n",1,5,param_3);
    fwrite("  \"stats\": {\n",1,0xd,param_3);
    fwrite(&DAT_001fb9d0,1,4,param_3);
...
LAB_00172a64:
    ...
    fputc(10,param_3);
    fwrite(&DAT_001fba20,1,4,param_3);
    fwrite(&DAT_001f8e68,1,2,param_3);
  }
