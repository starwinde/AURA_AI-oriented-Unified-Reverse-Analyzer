...
LAB_001cb4bc:
  ...
  do {
    ...
    if ((uVar5 & 1) == 0) {
      SStream_concat(param_3,&DAT_001fc4b0,AsmStrsvreg_7 + (byte)RegAsmOffsetvreg_8[iVar4 - 1U],
                     param_4);
      lVar10 = *(long *)(param_1 + 800);
      if (*(int *)(lVar10 + 0x60) != 0) goto LAB_001cb604;
LAB_001cb558:
      if (iVar3 + 1 != iVar12) goto LAB_001cb564;
LAB_001cb6a0:
...
LAB_001cb604:
      ...
      *(char *)(lVar11 + 0x67) = (char)uVar9 + '\x01';
      if (iVar3 + 1 == iVar12) goto LAB_001cb6a0;
LAB_001cb564:
      SStream_concat0(param_3,", ");
      if (iVar4 - 0x7bU < 0x1f) goto LAB_001cb5d0;
      if (iVar4 != 0x9a) goto LAB_001cb588;
      iVar4 = 0x7b;
    }
    iVar3 = iVar3 + 1;
  } while (iVar3 != iVar12);
