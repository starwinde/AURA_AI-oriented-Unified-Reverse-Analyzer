      ...
      do {
        ...
        if (*(int *)(lVar2 + 0x10) != 0) {
          do {
            ...
            fwrite(&DAT_001f9420,1,2,param_2);
            iVar4 = *(int *)(lVar9 + lVar7);
            if (iVar4 == 0x1b) {
              if (piVar3[2] == -1) {
                fwrite(&DAT_001f9438,1,3,param_2);
              }
              else {
...
joined_r0x0014d80c:
              if (iVar4 == 1) {
                __fprintf_chk(param_2,2,&DAT_001f9458,*(undefined8 *)(piVar3 + 4));
                iVar4 = *piVar3;
...
LAB_0014d834:
                ...
                if (piVar3[0x12] != 0) {
                  ...
                  do {
                    uVar10 = uVar10 + 1;
                    __fprintf_chk(param_2,2,&DAT_001f9460,*piVar11);
                    piVar11 = piVar11 + 4;
