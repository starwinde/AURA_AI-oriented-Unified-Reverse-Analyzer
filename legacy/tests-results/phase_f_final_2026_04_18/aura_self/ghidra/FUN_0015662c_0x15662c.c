...
int FUN_0015662c(long param_1,long param_2)

{
  ...
  uStack_60 = 0;
  lStack_58 = *(long *)PTR___stack_chk_guard_005ffe88;
          ...
          if (iVar5 == 0x16) {
            if (((*(int *)(lVar1 + 0x48) != 0) && (*(int *)(lVar1 + 0x18) != -1)) &&
              ...
              if (uVar12 != 0) {
                ...
                uVar8 = 1;
                do {
                  if (iVar5 == aiStack_464[uVar8]) goto LAB_00156744;
                  bVar4 = uVar10 != uVar8;
                  uVar8 = uVar8 + 1;
                } while (bVar4);
                if (0xff < uVar12) goto LAB_00156744;
              }
              uVar12 = uVar12 + 1;
...
LAB_00156744:
      ...
      do {
        if (*(char *)((long)__ptr + lVar11) == '\0') {
          iVar5 = iVar5 + 1;
          free(*(void **)(*(long *)(param_1 + 8) + lVar11 * 0x88 + 0x50));
          free(*(void **)(*(long *)(param_1 + 8) + lVar11 * 0x88 + 0x58));
        }
        else {
          if (uVar12 != (uint)lVar11) {
            puVar2 = (undefined8 *)(*(long *)(param_1 + 8) + lVar11 * 0x88);
            puVar7 = (undefined8 *)(*(long *)(param_1 + 8) + (ulong)uVar12 * 0x88);
            uVar14 = *puVar2;
            uVar16 = puVar2[3];
            uVar15 = puVar2[2];
            puVar7[1] = puVar2[1];
  ...
  iVar5 = 0;
LAB_0015668c:
  if (lStack_58 - *(long *)PTR___stack_chk_guard_005ffe88 == 0) {
    return iVar5;
  }
