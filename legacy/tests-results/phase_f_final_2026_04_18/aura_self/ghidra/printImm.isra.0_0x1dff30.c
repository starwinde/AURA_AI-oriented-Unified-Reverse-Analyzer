  ...
  if ((param_5 & 1) == 0) {
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_4 != 0x8000000000000000) {
          lVar1 = -param_4;
          if (-10 < (long)param_4) {
            SStream_concat(param_3,&DAT_001fcbd0,lVar1);
            return;
          }
          do {
            param_4 = param_4 >> 4;
      ...
      if ((long)param_4 < 10) goto LAB_001dff68;
      if (param_4 < 0x10) goto LAB_001e00bc;
      do {
        param_4 = param_4 >> 4;
      } while (0xf < param_4);
      goto joined_r0x001dffd8;
    }
    if ((long)param_4 < 0) {
      if (param_4 == 0x8000000000000000) {
      ...
      if (-10 < (long)param_4) {
        SStream_concat(param_3,&DAT_001fcbd0,-param_4);
        return;
      }
    ...
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_1 == '\0') {
LAB_001e00d4:
          if (param_4 != 0x8000000000000000) goto LAB_001e00e8;
LAB_001e0124:
        ...
        if (param_1 == '\x02') {
          ...
          if (param_1 != '\x01') goto LAB_001e00d4;
...
joined_r0x001dffd8:
      if (param_4 < 10) {
        SStream_concat(param_3,&DAT_00202768);
        return;
      }
LAB_001e00bc:
  ...
  if ((long)param_4 < 10) {
LAB_001dff68:
    SStream_concat(param_3,&DAT_001fa8c0);
    return;
  }
LAB_001dff58:
