...

{
  ...
  if (param_1 == 0 || param_2 == (long *)0x0) goto LAB_001f244c;
  ...
  if (bVar2 < 0x11) {
    ...
    if (bVar2 < 5) {
      if (bVar2 == 1) {
        ...
        uVar3 = s_false_002028e0._4_2_;
        if (pcVar11 == (char *)0x0) goto LAB_001f244c;
        *(undefined4 *)pcVar11 = s_false_002028e0._0_4_;
        *(undefined2 *)(pcVar11 + 4) = uVar3;
      }
      else {
        if ((bVar2 != 2) ||
           (puVar8 = (undefined4 *)ensure(param_2,5), uVar4 = DAT_002028f4,
           puVar8 == (undefined4 *)0x0)) goto LAB_001f244c;
        *puVar8 = DAT_002028f0;
        *(undefined1 *)(puVar8 + 1) = uVar4;
      }
LAB_001f2414:
      ...
      if ((NAN(dVar21)) || (dVar22 = ABS(dVar21), 1.79769313486232e+308 < dVar22)) {
        uVar6 = 4;
        local_90 = (ulong)CONCAT14(DAT_0020b35c,DAT_0020b358);
LAB_001f24dc:
...
LAB_001f28dc:
        ...
        iVar7 = __isoc99_sscanf(&local_90,&DAT_0020b368,&local_98);
        if (iVar7 == 1) {
          if (dVar22 < ABS(local_98)) {
            dVar22 = ABS(local_98);
          }
          if (dVar22 * 2.220446049250313e-16 < ABS(local_98 - dVar21)) goto LAB_001f2a54;
        }
        else {
LAB_001f2a54:
          uVar6 = __sprintf_chk(dVar21,&local_90,2,0x1a,"%1.17g");
        }
        if (uVar6 < 0x1a) goto LAB_001f24dc;
      }
    ...
    if (bVar2 == 0x40) {
          ...
          *puVar12 = 0x7b;
          ...
          if (plVar19 != (long *)0x0) {
            while( true ) {
              ...
              if (puVar12 == (undefined1 *)0x0) goto LAB_001f244c;
              *puVar12 = 0x3a;
              if (*(int *)((long)param_2 + 0x24) != 0) {
                puVar12[1] = 9;
              }
              ...
              if (puVar14 == (undefined2 *)0x0) goto LAB_001f244c;
              puVar16 = puVar14;
              if (*plVar19 != 0) {
      ...
      *puVar12 = 0x5b;
      lVar17 = _DAT_0020b530;
      lVar15 = param_2[2] + _DAT_0020b530;
      param_2[3] = param_2[3] + _UNK_0020b538;
      param_2[2] = lVar15;
