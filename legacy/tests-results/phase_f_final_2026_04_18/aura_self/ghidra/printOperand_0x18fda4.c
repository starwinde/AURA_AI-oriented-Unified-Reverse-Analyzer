...

{
  ...
  if ((uVar7 & 1) != 0) {
    ...
    SStream_concat(param_3,&DAT_001fcc18,
                   &AsmStrs_0 + *(ushort *)(RegAsmOffset_1 + (ulong)(uVar3 - 1) * 2));
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_0018fe28;
    uVar3 = uVar3 & 0xffff;
            ...
            do {
              ...
              while (bVar17 != 0x80) {
                ...
                *pbVar2 = bVar17;
                pbVar9 = pbVar9 + -1;
                uVar3 = uVar4 & 0xff;
                if (uVar10 < (uVar4 & 0xff)) goto LAB_00190338;
                pbVar2 = pbVar2 + 1;
                bVar17 = *pbVar9;
              }
              uVar4 = uVar3 + 1;
...
LAB_00190338:
  ...
  if ((uVar7 & 1) == 0) goto LAB_0018fe28;
  ...
  if (uVar3 == 1) {
    ...
    if (uVar10 < 0x1ce) {
      if (uVar10 < 0x1cc) {
        if (0xac < uVar10) {
          if (uVar10 != 0xee) {
            if (uVar10 == 0x15f) goto LAB_00190588;
            if (uVar10 != 0xe5) goto LAB_00190500;
          }
LAB_00190468:
          uVar7 = uVar7 & 0xff;
          if (uVar7 < 10) goto LAB_00190574;
          SStream_concat(param_3,"$0x%x",uVar7);
          goto LAB_0018fef8;
        }
        if (0xa9 < uVar10) goto LAB_00190408;
        if (uVar10 == 0x18) goto LAB_00190568;
      }
      goto LAB_00190500;
    }
    if (uVar10 == 0x279) goto LAB_00190588;
    if (uVar10 < 0x27a) {
      if (uVar10 == 0x200) {
LAB_00190568:
        uVar7 = uVar14;
        if (uVar14 < 10) goto LAB_00190574;
        goto LAB_0018fed0;
      }
      if (uVar10 == 0x203) goto LAB_00190468;
    }
    else if (uVar10 == 0x5df) goto LAB_00190568;
LAB_00190500:
    uVar7 = uVar14;
    uVar14 = uVar7;
    if ((long)uVar7 < 10) {
      SStream_concat(param_3,&DAT_001fcc38,uVar7);
      goto LAB_0018fef8;
    }
LAB_00190418:
    uVar7 = uVar14;
    ...
    uVar14 = uVar7;
    if (uVar10 < 0x1ce) {
      if (0x1cb < uVar10) goto LAB_00190500;
      if (0xac < uVar10) {
        if (uVar10 != 0xee) {
          if (uVar10 == 0x15f) goto LAB_00190588;
          if (uVar10 != 0xe5) goto LAB_001904b0;
        }
        goto LAB_00190468;
      }
      if (uVar10 < 0xaa) {
        if (uVar10 == 0x18) goto LAB_0018fec0;
        goto LAB_001904b0;
      }
LAB_00190408:
      uVar3 = 4;
...
LAB_00190588:
      ...
      if (uVar10 < 0x27a) {
        if (uVar10 != 0x200) {
          if (uVar10 == 0x203) goto LAB_00190468;
LAB_001904b0:
          if (-1 < (long)uVar7) goto LAB_00190500;
      ...
      else if (uVar10 != 0x5df) goto LAB_001904b0;
LAB_0018fec0:
      if (uVar7 < 10) {
LAB_00190574:
        SStream_concat(param_3,&DAT_001fcc58,uVar7);
      }
      else {
        if (uVar3 == 0) {
