...

{
  ...
  if ((((param_1 != (int *)0x0 && param_2 != 0) && (*param_1 == 0x10)) && (param_1[0x28] == 3)) &&
    ...
    iVar3 = *__src;
    if (iVar3 != 0xf) goto LAB_001862f4;
    if (__src[0x2a] == 2) {
      piVar12 = *(int **)(__src + 0x26);
      piVar11 = *(int **)(__src + 0x28);
      if (piVar12 == (int *)0x0) goto LAB_0018692c;
      if (*piVar12 != 0xd) {
        if ((*piVar12 == 0xe) && ((char)piVar12[0x2a] == '\0')) goto LAB_001864a4;
        goto joined_r0x00186920;
      }
      iVar1 = piVar12[0x26];
      if (piVar11 == (int *)0x0) goto LAB_001862f4;
...
LAB_0018673c:
    ...
    if (lVar5 == lVar8) {
      ...
      if (puVar13 == (undefined4 *)0x0) goto LAB_00186440;
      ...
      *(undefined8 *)(puVar13 + 0x21) = local_70;
      ...
      if (lVar5 != 0 && lVar8 != 0) goto LAB_00186834;
      goto LAB_00186614;
    }
  }
LAB_0018694c:
  ...
  if (piVar12 == (int *)0x0) {
LAB_0018692c:
    if (piVar11 == (int *)0x0) goto LAB_0018666c;
  }
  else {
    iVar3 = *piVar12;
    if (iVar3 != 0xe) goto LAB_00186634;
    if ((char)piVar12[0x2a] != '\0') goto joined_r0x00186920;
LAB_001864a4:
...
LAB_0018664c:
  ...
  if ((0 < lVar5) && (iVar3 = find_array_by_base(param_2,piVar11[0x26]), iVar3 != -1)) {
    ...
    if (iVar1 == iVar4) {
      puVar13 = calloc(1,0x130);
      if (puVar13 == (undefined4 *)0x0) goto LAB_00186444;
    ...
    if (lVar5 == lVar8) {
      ...
      if (puVar13 != (undefined4 *)0x0) {
        ...
        *(undefined8 *)(puVar13 + 0x21) = local_70;
        ...
        if (lVar8 != 0 && lVar5 != 0) {
LAB_00186834:
          __snprintf_chk(lVar8 + 4,0x80,2,0x80,&DAT_001fc7e0,lVar5);
...
LAB_00186628:
  ...
  if (piVar12 != (int *)0x0) {
    iVar3 = *piVar12;
LAB_00186634:
    if (iVar3 != 0xd) goto joined_r0x00186920;
LAB_00186860:
    iVar3 = piVar12[0x26];
    if (piVar11 == (int *)0x0) {
      iVar3 = *__src;
    ...
    iVar1 = *piVar11;
    if (iVar1 != 0xf) goto LAB_0018664c;
    if (piVar11[0x2a] != 4) goto LAB_0018666c;
    ...
    if ((((piVar12 == (int *)0x0) || (*piVar12 != 0xe)) || ((char)piVar12[0x2a] != '\0')) ||
      ...
      if (piVar12 == (int *)0x0) goto LAB_0018666c;
LAB_001868b8:
      ...
      iVar1 = sr_get_array_elem_size(param_2,iVar3);
      if (iVar1 != (int)lVar5) goto LAB_00186918;
      puVar13 = calloc(1,0x130);
      if (puVar13 == (undefined4 *)0x0) goto LAB_00186444;
...
LAB_00186a2c:
        piVar12 = *(int **)(piVar11 + 0x26);
        if (piVar12 != (int *)0x0) goto LAB_001868b8;
LAB_00186918:
        piVar11 = *(int **)(__src + 0x28);
        goto joined_r0x00186920;
      }
      ...
      iVar2 = (int)lVar5;
      if (iVar4 != iVar2) goto LAB_00186a2c;
      puVar13 = calloc(1,0x130);
      if (puVar13 == (undefined4 *)0x0) goto LAB_00186444;
      uVar7 = *(undefined8 *)(__src + 0x26);
      *puVar13 = 0x14;
...
joined_r0x00186920:
  if (piVar11 != (int *)0x0) goto LAB_00186648;
LAB_0018666c:
  iVar3 = *__src;
LAB_001862f4:
  if (iVar3 == 0xd) {
