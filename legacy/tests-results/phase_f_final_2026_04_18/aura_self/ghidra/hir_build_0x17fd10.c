      ...
      do {
        while( true ) {
          ...
          *(undefined4 *)(pcVar13 + 0xc0) = *(undefined4 *)(lVar19 + 0xd0);
          ...
          if (*(uint *)(__s + 0xdd0) <= uVar25) goto LAB_0017fec8;
        }
...
LAB_0017fec8:
    ...
    if ((*(byte *)(param_5 + 0x12) & 1) == 0) {
      *(undefined4 *)(__s + 0x88) = DAT_001f9298;
      __s[0x8c] = cVar4;
      __s[0x108] = '\0';
      __s[0x109] = '\0';
      __s[0x10a] = '\0';
...
LAB_0018030c:
            ...
            uVar23 = *puVar21;
            sVar26 = sVar27;
            if (uVar23 <= uVar25) goto LAB_0017ffc0;
          }
          uVar25 = uVar25 + 1;
          lVar24 = lVar24 + 0x88;
        } while (uVar25 < uVar23);
...
LAB_0017ffd0:
  ...
  if (pvVar11 == (void *)0x0) {
    ...
    if (uVar25 != 0) {
      ...
      puVar8 = puVar21 + (ulong)uVar25 * 0x14;
      do {
        if (*puVar21 != 0) {
          uVar20 = 0;
...
LAB_001800ac:
              ...
              if (*puVar21 <= uVar20) goto LAB_001800c0;
            }
            ...
            do {
              while (uVar3 = *(uint *)(lVar19 + lVar24 * 0x10), uVar23 <= uVar3) {
                lVar24 = lVar24 + 1;
                if (uVar5 <= (uint)lVar24) goto LAB_001800ac;
              }
              lVar24 = lVar24 + 1;
              *(int *)((long)pvVar11 + (ulong)uVar3 * 4) =
                   *(int *)((long)pvVar11 + (ulong)uVar3 * 4) + 1;
