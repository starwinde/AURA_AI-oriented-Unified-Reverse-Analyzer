...
undefined8 decodeInstruction_4_isra_0(byte *param_1,long param_2,uint param_3)
...
LAB_001aebd0:
    ...
    if (bVar2 < 4 || bVar5) {
      ...
      if (bVar2 == 6) {
        ...
        uVar8 = decodeToMCInst_4_isra_0(uVar17,uVar16 & 0xffffffff,param_3,param_2);
        return uVar8;
      }
      if (bVar2 != 7) {
        if (bVar2 != 5) {
        ...
        uVar8 = decodeToMCInst_4_isra_0(uVar17,uVar9 & 0xffffffff,param_3,param_2);
        return uVar8;
      }
      uVar9 = 0;
      lVar6 = 0;
