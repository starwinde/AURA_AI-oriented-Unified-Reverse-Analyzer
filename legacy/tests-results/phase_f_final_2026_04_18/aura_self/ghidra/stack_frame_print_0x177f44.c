...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n","Offset",&DAT_001fa360,
                  &DAT_001fa378,&DAT_001fa370,&DAT_001fc158,"Source");
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n",&DAT_001fc1a0,&DAT_001fc190,
                  &DAT_001fc190,&DAT_001fc190,&DAT_001fc190,&DAT_001fc1a0);
    if (*(int *)(param_1 + 4) != 0) {
      lVar11 = 0;
      uVar10 = 0;
      do {
        ...
        if (uVar5 == 2) {
          pcVar9 = "arg";
LAB_001780e8:
          if (*(int *)(lVar1 + 0x24) == 1) goto LAB_001781a4;
LAB_001780f4:
          pcVar7 = "heuristic";
        }
        else {
          ...
          if (*(int *)(lVar1 + 0x24) != 1) goto LAB_001780f4;
LAB_001781a4:
          pcVar7 = "DWARF";
        }
