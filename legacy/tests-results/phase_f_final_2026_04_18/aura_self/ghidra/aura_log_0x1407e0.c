...
void aura_log(uint param_1,char *param_2,undefined4 param_3,undefined8 param_4)

{
  ...
  if (param_1 < g_log_level) goto LAB_00140920;
  if (g_log_stream == (FILE *)0x0) {
    __stream = *(FILE **)PTR_stderr_005fffd8;
    if (param_1 != 2) goto LAB_00140860;
LAB_00140960:
    pcVar1 = "WARN ";
  }
  else {
    __stream = g_log_stream;
    if (param_1 == 2) goto LAB_00140960;
LAB_00140860:
    if (param_1 < 3) {
      pcVar1 = "DEBUG";
      if (param_1 != 0) {
