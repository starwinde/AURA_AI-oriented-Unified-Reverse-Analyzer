...
LAB_0015aa10:
      ...
      if (uVar4 == 0x15) {
        if (puVar1[2] == 0xffffffff) {
          ...
          __fprintf_chk(param_3,2,&DAT_001f9928);
        }
        switch(puVar1[3]) {
        case 0:
          pcVar2 = "void";
        ...
        if (uVar4 != 0x19) {
          if (uVar4 == 0x1c) {
            if (2 < puVar1[0x12]) {
              ...
              fwrite(&DAT_001f9930,1,3,param_3);
              ...
              fwrite(&DAT_001f9958,1,3,param_3);
              ...
              fwrite(&DAT_001f88f0,1,3,param_3);
              uVar4 = puVar1[0xe];
              goto joined_r0x0015ad30;
            }
          }
        ...
        if (puVar1[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              lVar5 = lVar5 + 1;
              uVar4 = (uint)lVar5;
              if (puVar1[0x18] <= uVar4) goto LAB_0015addc;
            }
            __fprintf_chk(param_3,2,&DAT_001f9928);
            lVar5 = lVar5 + 1;
...
LAB_0015addc:
        fwrite(&DAT_001f99a8,1,3,param_3);
        uVar4 = *(uint *)(param_1 + 0x10);
        goto LAB_0015aa10;
      }
      if (uVar4 == 1) {
      ...
      if (uVar4 < 2) {
        if (puVar1[0x12] == 0) goto LAB_0015aa80;
        if (puVar1[2] == 0xffffffff) {
          fwrite("__undef",1,7,param_3);
        }
        else {
