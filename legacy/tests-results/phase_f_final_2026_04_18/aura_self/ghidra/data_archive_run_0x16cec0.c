...
LAB_0016d038:
      ...
      if (puVar9 == (uint *)0x0) {
        if (in_x5 != (undefined8 *)0x0) {
          pcVar10 = malloc(0x40);
          *in_x5 = pcVar10;
          uVar3 = s_data_archive__allocation_failed_001fb088._24_8_;
          uVar2 = s_data_archive__allocation_failed_001fb088._16_8_;
          uVar7 = s_data_archive__allocation_failed_001fb088._0_8_;
          if (pcVar10 != (char *)0x0) {
            *(undefined8 *)(pcVar10 + 8) = s_data_archive__allocation_failed_001fb088._8_8_;
