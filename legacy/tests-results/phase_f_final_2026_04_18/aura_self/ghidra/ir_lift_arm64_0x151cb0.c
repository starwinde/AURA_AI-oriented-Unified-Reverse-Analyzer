...
LAB_00152800:
      ...
      if (iVar8 == 1) {
        ...
        iVar8 = __isoc99_sscanf(pcVar19,&DAT_001f94a8,&local_288);
      ...
      do {
        ...
        *(undefined8 *)(puVar17 + 4) = 0;
        if ((local_290 < 0x20) &&
          ...
          *(undefined8 *)(puVar17 + 8) = 0;
          *(undefined8 *)(puVar17 + 6) = DAT_0020b3c8;
        }
        puVar17[0x12] = 1;
...
LAB_00152880:
    ...
    if (iVar9 == 1) {
      ...
      iVar9 = __isoc99_sscanf(pcVar31,&DAT_001f94a8,&local_288);
      if (iVar9 == 1) {
        uVar38 = CONCAT44(local_288._4_4_,(int)local_288);
        bVar4 = true;
      }
...
LAB_00152910:
    ...
    if (iVar10 == 1) {
      ...
      iVar10 = __isoc99_sscanf(pcVar31,&DAT_001f94a8,&local_288);
      local_310 = 0;
      if (iVar10 == 1) {
