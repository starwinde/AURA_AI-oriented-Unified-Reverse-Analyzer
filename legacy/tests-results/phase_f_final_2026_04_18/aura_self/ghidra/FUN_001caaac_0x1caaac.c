...
void FUN_001caaac(long param_1,undefined8 param_2,undefined8 param_3)
...
LAB_001cac7c:
    ...
    SStream_concat(param_3,&DAT_001fea88,puVar7);
    iVar4 = uVar8 - 4;
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto joined_r0x001cab40;
  }
  else {
    SStream_concat(param_3,&DAT_001fea88,&DAT_001fe2b0);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto joined_r0x001cab40;
    iVar4 = 1;
  }
  lVar6 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
