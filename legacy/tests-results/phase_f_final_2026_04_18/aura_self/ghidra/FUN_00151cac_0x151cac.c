...
LAB_00152800:
      ...
      if (iVar8 == 1) {
        ...
        iVar8 = __isoc99_sscanf(pcVar19,&DAT_001f94a8,&uStack_288);
...
LAB_00152880:
    ...
    if (iVar9 == 1) {
      ...
      iVar9 = __isoc99_sscanf(pcVar31,&DAT_001f94a8,&uStack_288);
      if (iVar9 == 1) {
        uVar38 = CONCAT44(uStack_288._4_4_,(int)uStack_288);
        bVar4 = true;
      }
...
LAB_00152910:
    ...
    if (iVar10 == 1) {
      ...
      iVar10 = __isoc99_sscanf(pcVar31,&DAT_001f94a8,&uStack_288);
      uStack_310 = 0;
      if (iVar10 == 1) {
