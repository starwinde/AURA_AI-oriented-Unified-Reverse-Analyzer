...

{
  ...
  if ((plVar12 != (long *)0x0) && (uVar10 = *(uint *)(plVar12 + 1), uVar10 != 0)) {
    ...
    lVar9 = 0;
    lVar7 = lVar8;
    if (*(int *)(lVar8 + 4) == -1) goto LAB_00165630;
LAB_001655d0:
    uVar11 = uVar11 + 1;
    if (uVar11 < uVar10) {
      while( true ) {
        ...
        do {
          while (*piVar4 != -1) {
            piVar4 = piVar4 + 6;
            if (piVar2 == piVar4) goto LAB_00165630;
          }
          if (*(long *)(piVar4 + 1) == *(long *)(lVar8 + 8)) goto LAB_001655d0;
          piVar4 = piVar4 + 6;
        } while (piVar2 != piVar4);
LAB_00165630:
        ...
        if (*(uint *)(plVar13 + 1) != 0) {
          ...
          do {
            if (*(long *)(lVar9 + 8) == *plVar3) {
              __fprintf_chk(param_2,2,&DAT_001f87d8,(long)plVar3 + 0x14);
              goto LAB_001657c4;
            }
            plVar3 = plVar3 + 0x13;
          } while (plVar5 != plVar3);
