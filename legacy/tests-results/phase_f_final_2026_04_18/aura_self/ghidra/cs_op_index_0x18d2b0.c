...

{
  ...
  case 1:
    ...
    if (*(int *)(lVar6 + 0x7c) == param_3) {
      ...
      uVar5 = uVar4;
      if (param_3 == *(int *)(lVar6 + 0xb4)) goto LAB_0018e704;
      if (uVar2 == 2) {
        return 0xffffffff;
      }
