...
LAB_00190b50:
              ...
              if (((((uVar1 != 1) &&
                ...
                a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar6 + (uVar13 - 0xef)),_DAT_0020b540);
              }
              uVar8 = uVar9 & 0xf0;
              if ((uVar9 & 0xf) != 0) {
                uVar9 = uVar12 - uVar8;
                uVar14 = (ulong)((uVar9 & 0xff) + 1 & 0xff);
                if (6 < (uVar9 & 0xff)) goto LAB_00190b14;
                goto LAB_00190b50;
              }
            }
          }
            ...
            do {
              ...
              while (cVar3 != -0x80) {
                ...
                *pcVar4 = cVar3;
                pcVar6 = pcVar6 + -1;
                uVar9 = uVar1 & 0xff;
                if (uVar12 < (uVar1 & 0xff)) goto LAB_00190c40;
                pcVar4 = pcVar4 + 1;
                cVar3 = *pcVar6;
              }
              uVar1 = uVar9 + 1;
