...
LAB_0017b86c:
          ...
          if (0 < (int)uVar21) {
            ...
            do {
              if (*piVar10 == 0x1a) goto LAB_0017b86c;
      ...
      do {
        while (uVar19 = *puVar11, (*(byte *)((long)__ptr_03 + (ulong)uVar19) & 1) == 0) {
          ...
          *(undefined1 *)((long)__ptr_03 + (ulong)uVar19) = 1;
          ...
          local_6c = uVar21;
          if (puVar11 == puVar1) goto LAB_0017b9f4;
        }
        puVar11 = puVar11 + 1;
...
LAB_0017b9f4:
      ...
      if (local_6c >> 1 == 0) {
        ...
        puVar11 = __ptr_00;
        if (local_6c != 0) goto LAB_0017baa0;
      }
      else {
        do {
...
LAB_0017baf0:
        ...
        puVar12 = __ptr_00;
        do {
          if (*puVar12 == uVar19) goto joined_r0x0017bcdc;
          puVar12 = puVar12 + 1;
        } while (puVar12 != puVar1);
        lVar35 = lVar31 + (ulong)uVar19 * 0x50;
          ...
          if (((uVar21 < uVar2) && (uVar29 = (ulong)uVar21, *(int *)((long)__s + uVar29 * 4) != -1))
            ...
            while (uVar3 = uVar28, uVar21 != uVar28) {
              while( true ) {
                ...
                if (uVar3 == uVar28) goto LAB_0017bd48;
                uVar28 = uVar3;
                if (uVar3 == 0xffffffff) goto LAB_0017bca8;
              }
              while( true ) {
                uVar3 = uVar21;
                if (uVar21 == 0xffffffff) goto LAB_0017bca8;
                uVar29 = (ulong)uVar21;
                if (*(uint *)((long)__ptr_02 + uVar29 * 4) <= uVar4) break;
                uVar3 = *(uint *)((long)__s + uVar29 * 4);
                bVar8 = uVar3 == uVar21;
                uVar21 = uVar3;
                if (bVar8) goto LAB_0017bd48;
              }
            }
          }
          goto LAB_0017bca8;
        }
        goto joined_r0x0017bcdc;
      }
      iVar20 = 1;
LAB_0017bd54:
...
LAB_0017bca8:
  uVar28 = uVar3;
  puVar22 = puVar22 + 1;
  if (puVar22 == puVar12) goto code_r0x0017bcb4;
  goto LAB_0017bc80;
code_r0x0017bcb4:
...
joined_r0x0017bcdc:
  puVar11 = puVar11 + 1;
  if (puVar11 != __ptr_01 + local_6c) goto LAB_0017baf0;
  if (!bVar6) goto LAB_0017bd54;
  if (iVar20 != 20000) {
    iVar20 = iVar20 + 1;
    puVar11 = __ptr_01;
    bVar6 = bVar7;
...
LAB_0017be3c:
    ...
    *(uint *)((long)puVar15 + (ulong)uVar19 * 4) = uVar19;
    ...
    puVar17 = puVar15;
    uVar37 = _DAT_0020b500;
    uVar38 = _UNK_0020b508;
    do {
      puVar18 = puVar17 + 2;
      puVar17[1] = uVar38;
      *puVar17 = uVar37;
    ...
    if ((uVar2 & 3) != 0) goto LAB_0017be3c;
  }
LAB_0017bd5c:
  free(__ptr_00);
  free(__ptr_01);
