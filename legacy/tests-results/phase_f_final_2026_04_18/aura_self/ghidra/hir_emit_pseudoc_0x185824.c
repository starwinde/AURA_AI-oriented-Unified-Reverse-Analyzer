  ...
  if (*(int *)(param_1 + 0xdd0) != 0) {
    do {
      if (*pcVar14 == '\0') {
        ...
        if (uVar3 <= iVar15 + 1U) goto LAB_00185920;
      }
      else {
...
LAB_00185db0:
  fwrite(&DAT_001f9298,1,4,param_2);
  goto LAB_00185924;
LAB_00185a48:
  iVar15 = (int)plVar5[1];
  pcVar14 = local_b0;
...
LAB_00185a7c:
  ...
  lVar17 = lVar17 + 1;
  if (s_stack_var_count <= (uint)lVar17) goto code_r0x00185af4;
  goto LAB_001859d8;
code_r0x00185af4:
  if (s_stack_var_count == 0) goto LAB_00185af8;
  goto LAB_00185d94;
LAB_00185920:
  if (uVar3 == 0) goto LAB_00185db0;
LAB_00185924:
  fwrite(&DAT_001fc780,1,4,param_2);
  ...
  if (__stream == (FILE *)0x0) {
    ...
    fclose(__stream);
    if ((*(long *)(param_1 + 0xdd8) == 0) || (*(int *)(param_1 + 0xde0) == 0)) {
      if (s_stack_var_count != 0) goto LAB_001859ac;
    }
    else {
          ...
          if (*(uint *)(s_emit_stack_frame + 0x20) != 0) {
            ...
            if (*(long *)(s_emit_stack_frame + 8) < 1) {
              do {
                ...
                if (lVar19 == lVar1) goto LAB_00185a48;
                plVar5 = plVar5 + 6;
      ...
      do {
        do {
          do {
            ...
            __ptr_00 = __ptr;
            if (pcVar7 == (char *)0x0) goto LAB_00185c68;
            pcVar6 = pcVar7 + 1;
        ...
        if ((piVar9 != (int *)0x0) && (*(uint *)(param_1 + 0xde0) != 0)) {
          ...
          do {
            if (*piVar9 == (int)uVar8) goto LAB_00185b38;
            piVar9 = piVar9 + 0x33;
        ...
        if ((__ptr != (void *)0x0) && (lVar17 = 0, uVar3 != 0)) {
          do {
            if (*(ulong *)((long)__ptr + lVar17 * 8) == uVar8) goto LAB_00185b38;
            lVar17 = lVar17 + 1;
        ...
        if (__ptr != (void *)0x0) {
          if ((uint)uVar18 <= uVar3) {
            ...
            if (uVar2 <= uVar3) goto LAB_00185c5c;
          }
...
LAB_00185c68:
  ...
  fwrite(&DAT_001f8e68,1,2,param_2);
  uVar4 = 0;
LAB_00185cbc:
