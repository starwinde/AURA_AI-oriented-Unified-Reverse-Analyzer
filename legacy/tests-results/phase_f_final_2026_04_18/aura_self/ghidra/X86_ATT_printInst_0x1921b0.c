...

{
  ...
  SStream_concat0(param_2,(*(uint *)(OpInfo0_5 + uVar11 * 4) & 0x3fff) + 0x20c2af);
  uVar11 = ((ulong)(uVar3 >> 0xe) & 0x7f) - 1;
  if (0x65 < uVar11) goto switchD_001923fc_default;
...
LAB_00192b48:
  ...
  case 9:
    ...
    goto LAB_00192b48;
  case 10:
    goto switchD_001923fc_caseD_a;
  case 0xb:
  case 0x1a:
    goto switchD_001923fc_caseD_b;
  case 0xc:
    goto switchD_001923fc_caseD_c;
  case 0xd:
    goto switchD_001923fc_caseD_d;
  case 0xf:
  case 0x27:
    goto switchD_001923fc_caseD_f;
  case 0x10:
  ...
  case 0x18:
    ...
    goto LAB_00192b04;
  case 0x19:
    goto switchD_001923fc_caseD_19;
  case 0x1b:
    printPCRelImm_constprop_0(param_1,param_2);
    goto switchD_001923fc_default;
  case 0x1c:
    goto switchD_001923fc_caseD_1c;
  case 0x1d:
    uVar5 = 1;
    goto LAB_00192b00;
  case 0x1e:
...
LAB_001935e4:
    ...
    if (bVar7 < 10) {
      SStream_concat(param_2,&DAT_001fcc58);
    }
    else {
...
LAB_00193870:
    ...
    printOperand(param_1,0,param_2);
LAB_001938b8:
    SStream_concat0(param_2,&DAT_001fcc90);
...
LAB_00193674:
  ...
  case 0x50:
    ...
    goto LAB_00193738;
  case 0x51:
    goto switchD_001923fc_caseD_51;
  case 0x54:
    uVar5 = 0x20;
LAB_00192bcc:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
...
LAB_00192c44:
  ...
  case 0x5a:
    ...
    goto LAB_00192db4;
  case 0x5b:
    goto switchD_001923fc_caseD_5b;
  case 0x5c:
    uVar14 = 8;
LAB_00193738:
    printOperand(param_1,uVar14,param_2);
...
LAB_00193928:
  ...
  if (0x61 < uVar11) goto switchD_001923fc_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
...
LAB_00193c58:
  ...
  case 0x11:
    ...
    goto switchD_001923fc_default;
  case 0x12:
    SStream_concat0(param_2,&DAT_001fccc0);
    break;
  case 0x13:
    SStream_concat0(param_2,&DAT_001fccc8);
    break;
  case 0x14:
...
switchD_001923fc_caseD_f:
  ...
  case 0x27:
    ...
    break;
  case 0x28:
    goto switchD_00192b84_caseD_28;
  case 0x29:
    goto switchD_00192b84_caseD_29;
  case 0x2a:
...
LAB_00192c74:
  ...
  case 0x4e:
    ...
    goto LAB_001931a4;
  case 0x4f:
switchD_001923fc_caseD_51:
    uVar5 = 0x20;
    goto LAB_00192b00;
  case 0x50:
switchD_001923fc_caseD_5b:
    uVar5 = 0x40;
LAB_00192b00:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_00192b04:
...
LAB_00193188:
  ...
  case 0x54:
    ...
    break;
  case 0x57:
    SStream_concat0(param_2,&DAT_001fcd80);
    break;
  case 0x58:
    SStream_concat0(param_2,&DAT_001fcd88);
    break;
  case 0x59:
    SStream_concat0(param_2,&DAT_001fcd90);
    break;
  case 0x5a:
    SStream_concat0(param_2,&DAT_001fcd98);
    break;
  case 0x5b:
    SStream_concat0(param_2,&DAT_001fcda0);
    break;
  case 0x5c:
    SStream_concat0(param_2,&DAT_001fcda8);
    break;
  case 0x5d:
    SStream_concat0(param_2,&DAT_001fcdb0);
    break;
  case 0x5e:
    SStream_concat0(param_2,&DAT_001fcdb8);
    break;
  case 0x5f:
    uVar14 = 7;
LAB_00193e40:
...
LAB_00193164:
  ...
  if (0x34 < uVar11) goto switchD_001923fc_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,1,param_2);
    break;
...
LAB_001934d0:
    ...
    goto switchD_001923fc_default;
  case 0x10:
switchD_001923fc_caseD_1c:
    uVar5 = 1;
    goto LAB_00192aa4;
  case 0x11:
switchD_001923fc_caseD_d:
    uVar5 = 4;
    goto LAB_00192aa4;
  case 0x12:
switchD_001923fc_caseD_b:
    uVar5 = 8;
    goto LAB_00192aa4;
  case 0x13:
switchD_001923fc_caseD_c:
    uVar5 = 2;
LAB_00192aa4:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_00192aa8:
    ...
    goto joined_r0x00192d94;
  case 0x14:
    uVar14 = 3;
LAB_001931c8:
    printOperand(param_1,uVar14,param_2);
switchD_00192cb4_caseD_2:
    SStream_concat0(param_2,", ");
    break;
  case 0x15:
    SStream_concat0(param_2,"{1to4}, ");
...
LAB_00193290:
  ...
  if (0xd < uVar11) goto switchD_001923fc_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,0,param_2);
    break;
...
LAB_00194320:
          ...
          if (uVar11 == 4) goto switchD_00192b84_caseD_29;
          if (uVar11 != 5) goto LAB_00194320;
          SStream_concat0(param_2,", ");
          printOperand(param_1,0,param_2);
        }
        uVar11 = uVar12 >> 0x2d;
        if (uVar11 == 3) {
          ...
          if ((bVar6 & 2) != 0) goto LAB_00192e4c;
          SStream_concat0(param_2,&DAT_001f8580);
          goto switchD_001923fc_default;
        }
        if (uVar12 >> 0x2f == 0) {
          if (uVar11 == 1) goto switchD_00192b84_caseD_29;
          if (uVar11 == 2) goto switchD_001923fc_default;
        }
        else if (uVar11 == 4) {
          pcVar15 = ", ";
LAB_00192b20:
...
switchD_001923fc_default:
    ...
    if (uVar11 != 8) {
      if (8 < uVar11) {
        uVar14 = 3;
        if (uVar11 != 9) goto switchD_001923fc_default;
        goto LAB_00192d7c;
      }
      if (uVar11 == 6) goto switchD_00192b84_caseD_28;
switchD_00192b84_caseD_29:
LAB_00192e4c:
      SStream_concat0(param_2,"} {z}");
      op_addAvxZeroOpmask(param_1);
      goto switchD_001923fc_default;
    }
switchD_00192cfc_caseD_b:
    uVar14 = 5;
LAB_00192d7c:
    printOperand(param_1,uVar14,param_2);
    SStream_concat0(param_2,&DAT_001f8580);
...
joined_r0x00192d94:
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
    ...
    if (uVar9 < 0x9a5) {
      ...
      if (0x3d < uVar9 - 0xa07) goto LAB_001924ec;
            ...
            do {
              ...
              while (cVar2 != -0x80) {
                ...
                *pcVar4 = cVar2;
                pcVar15 = pcVar15 + -1;
                uVar9 = uVar1 & 0xff;
                if (uVar20 < (uVar1 & 0xff)) goto LAB_001928cc;
                pcVar4 = pcVar4 + 1;
                cVar2 = *pcVar15;
              }
              uVar1 = uVar9 + 1;
