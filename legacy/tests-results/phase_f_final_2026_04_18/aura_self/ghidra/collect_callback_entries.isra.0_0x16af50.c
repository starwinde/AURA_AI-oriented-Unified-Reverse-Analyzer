...
LAB_0016aff8:
  ...
  if (param_3 <= uVar11) goto LAB_0016b240;
  goto LAB_0016b008;
LAB_0016b108:
  local_170 = 0;
...
LAB_0016b1c8:
    if (local_170 == *puVar6) goto LAB_0016b0fc;
  }
LAB_0016b1e0:
  if (*param_6 <= uVar8) {
    uVar8 = *param_6 << 1;
    ...
    if (puVar9 == (ulong *)0x0) goto LAB_0016b240;
    *param_6 = uVar8;
    *param_4 = puVar9;
    uVar8 = *param_5;
  }
...
LAB_0016b0fc:
  ...
  if (pcVar13 == pcVar10) goto LAB_0016aff8;
  goto LAB_0016b108;
}
