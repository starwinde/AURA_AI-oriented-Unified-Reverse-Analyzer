...
void FUN_001afacc(long param_1,int param_2,undefined8 param_3)

{
  ...
  if (uVar3 == 3) {
    SStream_concat0(param_3,&DAT_001f9680);
    goto LAB_001afbc0;
  }
  if ((uVar2 >> 2 & 1) == 0) {
    if (uVar3 == 1) {
      SStream_concat0(param_3,&DAT_001f9688);
      goto LAB_001afbc0;
    }
    if (uVar3 == 2) {
      SStream_concat0(param_3,&DAT_001f9678);
      goto LAB_001afbc0;
    }
  }
  else {
    ...
    if (uVar3 == 5) {
      SStream_concat0(param_3,&DAT_001fcdd0);
      return;
    }
  }
  SStream_concat0(param_3,&DAT_001fd4a8);
LAB_001afbc0:
  SStream_concat0(param_3,&DAT_001fd3c8);
  lVar9 = *(long *)(param_1 + 800);
