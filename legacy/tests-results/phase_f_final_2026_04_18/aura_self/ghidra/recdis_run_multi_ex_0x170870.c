...

{
  ...
  if (((param_1 == 0 || param_2 == 0) || ((param_3 == 0 || param_5 == 0) || param_6 == 0)) ||
     (__ptr = calloc(1,0x10), __ptr == (long *)0x0)) goto LAB_00170e0c;
...
LAB_001709c8:
        ...
        *(uint *)(__ptr_01 + 1) = uVar29;
        if (uVar1 != 0) {
          uVar13 = 0;
          do {
            if (uVar26 == __ptr_03[uVar13]) goto LAB_001709c8;
            uVar13 = uVar13 + 1;
          } while (uVar13 != uVar1);
        }
        ...
        if (uVar7 <= uVar1) {
          ...
          if (puVar17 == (ulonglong *)0x0) goto LAB_001709c8;
          *__ptr_00 = puVar17;
                ...
                if (((iVar8 == 0) && (*__s != '\0')) &&
                  ...
                  if (((local_70 != __s) && (param_4 <= uVar18)) && (uVar18 < uVar13)) {
                    if (iVar22 != 0) {
                      puVar16 = puVar17;
                      do {
                        if (*puVar16 == uVar18) goto LAB_00170ba4;
                        puVar16 = puVar16 + 1;
                ...
                if (((__s[-0x40] == 'j') && (iVar8 = strcmp(pcVar28,"jmp"), iVar8 != 0)) &&
                  ...
                  if ((local_70 != __s) && (param_4 <= uVar18 && uVar18 < uVar13)) {
                    if (*(uint *)(__ptr_00 + 1) != 0) {
                      ...
                      do {
                        if (*puVar23 == uVar18) goto LAB_00170bd8;
                        puVar23 = puVar23 + 1;
...
LAB_00170e40:
                  ...
                  goto LAB_00170c04;
                  if (iVar22 == 0) goto LAB_001712cc;
                  puVar16 = puVar17;
                  goto LAB_00170ebc;
                }
                if (iVar9 == 0) goto LAB_00170e40;
                __s = __s + 0xe0;
                uVar29 = uVar27;
              } while (uVar7 != uVar27);
              goto LAB_00170d00;
...
LAB_00170ebc:
    if (*puVar16 == uVar18) goto LAB_00170c04;
  }
LAB_001712cc:
...
LAB_00171110:
              ...
              if ((uVar30 < uVar13 && param_4 <= uVar30) && local_70 != __nptr) {
                ...
                if (pcVar28 == (char *)0x0 || !bVar5) goto LAB_00171208;
                goto LAB_00171170;
              }
            }
            cVar6 = pcVar14[2];
            ...
            if (uVar15 <= param_3) {
              do {
                ...
                if (uVar21 < uVar13 && param_4 <= uVar21) {
                  ...
                  if (iVar22 != 0) {
                    do {
                      if (uVar21 == *puVar16) goto LAB_00171260;
                      puVar16 = puVar16 + 1;
                    } while (puVar17 + (ulong)uVar1 + 1 != puVar16);
                  }
                  queue_push_isra_0(__ptr_01);
...
LAB_00170d00:
  ...
  if (__ptr_02 != (ulong *)0x0) {
    ...
    *(uint *)(__ptr_02 + 2) = uVar27;
    ...
    if (pvVar11 != (void *)0x0) goto code_r0x00170d34;
    free(__ptr_02);
  }
  free(pvVar10);
  uVar29 = *(uint *)(__ptr_01 + 1);
  ...
  *puVar24 = *__ptr_02;
  ...
  do {
    while ((uVar26 != *(ulong *)(pbVar20 + -9) ||
      ...
      if (param_6 <= uVar13) goto LAB_00170dd4;
    }
    iVar22 = (int)uVar13;
    uVar13 = uVar13 + 1;
    pbVar20 = pbVar20 + 0x10;
