...
undefined4 aura_functions_file(long param_1)

{
  ...
  if (param_1 == 0) {
    ...
    lVar3 = load_any_format(param_1,PTR___stack_chk_guard_005ffe88,0);
    if (lVar3 == 0) {
...
LAB_00141e2c:
              ...
              if (__ptr == (void *)0x0) {
                ...
                iVar2 = disasm_run(lVar4,lVar8,uVar9,puVar5[1],__ptr,uVar1);
                disasm_destroy(lVar4);
                if (iVar2 < 1) {
                  __fprintf_chk(*(undefined8 *)PTR_stderr_005fffd8,2,
                ...
                local_70 = func_detect(__ptr,(long)iVar2,lVar3,0);
                free(__ptr);
                file_info_destroy(lVar3);
                if (local_70 != 0) {
                  func_detect_print(local_70,*(undefined8 *)PTR_stdout_005fff40);
                  func_detect_destroy(&local_70);
                  uVar6 = 0;
                  goto LAB_00141ce8;
                }
