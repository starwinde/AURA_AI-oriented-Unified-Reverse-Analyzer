        ...
        do {
          ...
          if (1 < iVar4 - 0x17U && (iVar4 != 0x1a && iVar4 != 0x1b)) {
            ...
            if ((uVar3 == 0xffffffff) ||
              ...
              if (iVar4 == 0x16) goto LAB_0017e8b4;
              if (iVar4 == 0x19) goto LAB_0017e78c;
            }
            else if (iVar4 == 0x16) {
LAB_0017e8b4:
                ...
                if (puVar5 == (undefined4 *)0x0) {
                  ...
                  *puVar5 = 10;
                  ...
                  if (puVar9 != (undefined4 *)0x0) {
                    *puVar9 = 0xd;
                    puVar9[0x26] = uVar13;
                    __snprintf_chk(puVar9 + 0x27,0x40,2,0x40,&DAT_001f9928,uVar13);
                  }
                  uVar13 = *(uint *)(lVar12 + 0x10);
        ...
        do {
          ...
          if (1 < iVar4 - 0x1aU && (iVar4 != 0x17 && iVar4 != 0x18)) {
            ...
            if ((uVar10 == 0xffffffff) ||
              ...
              if (iVar4 == 0x16) goto LAB_0017e5e0;
              if (iVar4 == 0x19) goto LAB_0017e528;
            }
            else if (iVar4 == 0x16) {
LAB_0017e5e0:
              if ((1 < *(uint *)(lVar1 + 0x48)) &&
...
LAB_0017e880:
                  ...
                  if (pvVar8 == (void *)0x0) goto LAB_0017e5d8;
                  uVar10 = param_3[0x28];
...
LAB_0017e528:
                ...
                if (((uVar13 == 0xffffffff) || (*(uint *)(*param_1 + 0x10) <= uVar13)) ||
                  ...
                  if ((puVar6 != (undefined4 *)0x0) && (*puVar6 = 0xc, *param_3 == 0)) {
                    ...
                    uVar13 = param_3[0x29];
                    pvVar8 = *(void **)(param_3 + 0x26);
                    if (uVar13 <= uVar10) goto LAB_0017e880;
                    goto LAB_0017e670;
                  }
                }
                else {
                  ...
                  if (puVar5 != (undefined4 *)0x0) {
                    ...
                    *(undefined4 **)(puVar5 + 0x26) = puVar9;
                    *(undefined4 **)(puVar5 + 0x28) = puVar6;
                    goto joined_r0x0017e5d4;
                  }
                }
              }
              else {
                puVar5 = calloc(1,0x130);
                if (puVar5 == (undefined4 *)0x0) goto LAB_0017e4f0;
                *puVar5 = 10;
                puVar6 = calloc(1,0x130);
                if (puVar6 != (undefined4 *)0x0) {
                  *puVar6 = 0xd;
                  puVar6[0x26] = uVar10;
                  __snprintf_chk(puVar6 + 0x27,0x40,2,0x40,&DAT_001f9928,uVar10);
                }
