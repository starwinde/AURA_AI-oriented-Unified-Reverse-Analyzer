...
LAB_001d977c:
        ...
        SStream_concat(param_2,&DAT_001fea88,
      ...
      goto switchD_001d8544_caseD_662;
    }
    goto LAB_001d84bc;
  }
  uVar12 = iVar9 - 0xfd9;
...
LAB_001d7d38:
    ...
    if ((((uVar24 & 1) != 0) && (lVar18 = MCOperand_getImm(uVar16), lVar18 == 0)) &&
      ...
      if (lVar18 == 0xf) {
        if (uVar12 < 2) {
          puVar28 = &DAT_001fe180;
        }
        else {
          if (bVar7 || bVar6) goto LAB_001d7da0;
          puVar28 = &DAT_001fe2c0;
        }
        goto LAB_001d8880;
      }
      if (lVar18 == 0x1f) {
        if ((bVar7 || bVar6) && bVar8) {
          puVar28 = &DAT_001fea68;
          goto LAB_001d8880;
        }
      }
      else if (lVar18 == 7) {
        if (uVar12 < 2) {
          puVar28 = &DAT_001fe170;
        }
        else {
          if (bVar7 || bVar6) goto LAB_001d7da0;
          puVar28 = &DAT_001fe2b0;
        }
LAB_001d8880:
...
LAB_001d7dac:
      ...
      if (lVar27 < lVar18) {
        ...
        puVar28 = &DAT_001fe1d8;
        if (uVar12 < 2) {
          puVar28 = &DAT_001fde58;
        }
        iVar9 = MCOperand_getReg(uVar25);
        uVar4 = *(ushort *)(RegAsmOffsetNoRegAltName_12 + (ulong)(iVar9 - 1) * 2);
        iVar9 = MCOperand_getReg(uVar19);
      ...
      if (bVar8 || iVar13 == 0x1f) {
        if (iVar13 == 0x3f || !bVar6) {
          local_b8 = &DAT_001f9680;
          if (((bVar8 || iVar13 != 0x1f) && (iVar13 != 0x3f || !bVar6)) &&
             (local_b8 = &DAT_001f9688, iVar9 != 0xfd9 || iVar13 != 0x1f)) {
LAB_001d9cac:
            if (!bVar7 || iVar13 != 0x3f) goto LAB_001d7dac;
LAB_001d9338:
            local_b8 = &DAT_001f9688;
          }
        }
        else {
          if (iVar13 + 1 == iVar15) {
          ...
          local_b8 = &DAT_001f9680;
          if (bVar8 || iVar13 != 0x1f) {
            if (iVar9 != 0xfd9 || iVar13 != 0x1f) goto LAB_001d7dac;
            goto LAB_001d9338;
          }
        }
      }
        ...
        if (iVar13 + 1 != iVar15) {
          if (iVar13 == 0x3f || !bVar6) {
            local_b8 = &DAT_001f9680;
            if (iVar13 != 0x3f || !bVar6) goto LAB_001d9cac;
            goto LAB_001d7f68;
          }
          goto LAB_001d7dac;
        }
...
LAB_001d7f68:
    ...
    if (iVar9 - 0x489U < 2) {
      ...
      if ((iVar14 == 8) || (iVar14 = MCOperand_getReg(uVar19), iVar14 == 9)) {
        if (iVar15 != 0 && iVar15 <= iVar13) goto LAB_001d8d18;
        iVar14 = 0x20;
        if (iVar9 == 0x48a) {
          iVar14 = 0x40;
        }
        ...
        uVar11 = AArch64_map_insn(&DAT_001fdae0);
        MCInst_setOpcodePub(param_1,uVar11);
        lVar18 = *(long *)(param_1 + 800);
        if (*(int *)(lVar18 + 0x60) != 0) {
          uVar11 = MCInst_getOpcode(param_1);
        ...
        SStream_concat0(param_2,", ");
        printInt32Bang(param_2,iVar13 + 1);
        uVar11 = AArch64_map_insn(&DAT_001fdae8);
        MCInst_setOpcodePub(param_1,uVar11);
        lVar18 = *(long *)(param_1 + 800);
        if (*(int *)(lVar18 + 0x60) != 0) {
          uVar11 = MCInst_getOpcode(param_1);
...
LAB_001d9068:
          puVar28 = &DAT_001f8ed0;
          goto LAB_001d7ce4;
        }
        goto LAB_001d84bc;
      }
      if (iVar9 != 0x1583) goto LAB_001d84bc;
      SStream_concat0(param_2,"tsb\tcsync");
      puVar28 = &DAT_001fe1a0;
LAB_001d7ce4:
    ...
    *(undefined8 *)(param_1 + 0x3b0) = param_3;
    ...
    if (uVar12 < 0xbe1) {
      if (uVar12 < 0xbd2) {
        if (uVar12 < 0x6c1) {
          if (uVar12 < 0x652) {
            if ((uVar12 == 0x42b) || (uVar12 == 0x434)) goto switchD_001d8544_caseD_6b3;
          }
          else {
            switch(uVar12) {
            case 0x652:
...
switchD_001d8544_caseD_652:
            ...
            case 0x68d:
            case 0x691:
              goto switchD_001d8544_caseD_653;
            case 0x654:
            case 0x658:
            case 0x65c:
            case 0x660:
            case 0x68e:
            case 0x692:
              goto switchD_001d8544_caseD_654;
            case 0x655:
            case 0x659:
            case 0x65d:
            case 0x661:
            case 0x68f:
            case 0x693:
              goto switchD_001d8544_caseD_655;
            case 0x694:
              if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
                uVar11 = 4;
                lVar18 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
                *(undefined4 *)(lVar18 + 0x6c) = 4;
                if (*(char *)(lVar18 + 0x67) == '\x01') {
                  ...
                  puVar28 = (undefined *)(local_68 - *(long *)PTR___stack_chk_guard_005ffe88);
                  puVar26 = PTR___stack_chk_guard_005ffe88;
                  if (puVar28 != (undefined *)0x0) goto LAB_001d9b14;
                  goto LAB_001d9a98;
                }
LAB_001d9a60:
...
LAB_001da088:
          ...
          if (uVar12 == 0xb4c) {
            ...
            if (uVar12 == 0x899) goto switchD_001d8544_caseD_653;
            if (uVar12 < 0x89a) {
              if (uVar12 != 0x7b3) {
                if (uVar12 == 0x7b4) goto switchD_001d8544_caseD_655;
                if (uVar12 != 0x7b2) goto switchD_001d8544_caseD_662;
                goto switchD_001d8544_caseD_653;
              }
            }
            else {
              if (uVar12 == 0x89b) {
switchD_001d8544_caseD_655:
                if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
                  *(undefined4 *)(*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x6c) = 0xb;
                }
                goto switchD_001d8544_caseD_662;
              }
              if ((uVar12 != 0xb4b) && (uVar12 != 0x89a)) goto switchD_001d8544_caseD_662;
            }
switchD_001d8544_caseD_654:
            if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
            ...
            if (uVar12 != 0xb4f) goto switchD_001d8544_caseD_655;
switchD_001d8544_caseD_653:
            if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
          ...
          if (uVar12 == 0xb51) goto switchD_001d8544_caseD_652;
...
LAB_001d93f8:
          ...
          if ((uVar24 & 1) != 0) goto LAB_001da108;
        }
...
LAB_001da0d0:
          ...
          if ((uVar24 & 0x114400) != 0) goto LAB_001d9f9c;
          if ((uVar24 & 1) != 0) goto LAB_001d9d24;
        }
      }
      else {
      ...
      if (uVar12 < 0xc07) {
        if (uVar12 < 0xc01) {
          if (uVar12 != 0xbe1) {
            ...
            if ((uVar24 & 0x4411) != 0) goto LAB_001da208;
            if ((uVar24 & 0x1144) != 0) goto LAB_001da0d0;
            if (uVar12 == 0xc00) {
              iVar9 = 0;
              puVar26 = (undefined *)(local_68 - *(long *)PTR___stack_chk_guard_005ffe88);
              if ((undefined *)(local_68 - *(long *)PTR___stack_chk_guard_005ffe88) ==
...
LAB_001da03c:
        ...
        if (uVar12 == 0xea3) goto LAB_001da1e4;
        if (uVar12 == 0xeaa) goto LAB_001da108;
      }
    }
...
LAB_001da1e4:
        ...
        if (uVar12 == 0xeb5) goto LAB_001da088;
        if (uVar12 == 0xeb6) goto LAB_001da03c;
      }
      ...
      else if (0x100f < uVar12) goto switchD_001d8544_caseD_6b3;
    }
    else {
      if (uVar12 == 0x16a5) {
        iVar9 = 0;
