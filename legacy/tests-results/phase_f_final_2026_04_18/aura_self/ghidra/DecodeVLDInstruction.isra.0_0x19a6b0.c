...
LAB_0019a704:
    ...
    if (0x646 < uVar1) goto LAB_0019a758;
LAB_0019a7bc:
    if (0x62d < uVar1) {
      uVar1 = uVar1 - 0x62e;
joined_r0x0019a778:
      ...
      if ((uVar4 & 0x14a5000) == 0) {
        if ((uVar4 & 0x999) == 0) goto LAB_0019a808;
        iVar2 = 1;
      }
      else {
        iVar2 = 2;
    ...
    if (uVar1 - 0x5e7 < 9) goto LAB_0019a704;
LAB_0019a790:
    MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (ulong)uVar3 * 2));
LAB_0019a7ac:
    uVar1 = MCInst_getOpcode(param_1);
    if (uVar1 < 0x647) goto LAB_0019a7bc;
LAB_0019a758:
    uVar1 = uVar1 - 0x675;
    if (uVar1 < 0x19) goto joined_r0x0019a778;
  }
LAB_0019a808:
  uVar1 = MCInst_getOpcode(param_1);
  if (uVar1 < 0x647) {
    if (0x62d < uVar1) {
      ...
      if ((uVar4 & 0x14a5000) == 0) goto LAB_0019a83c;
LAB_0019a9b0:
      uVar1 = uVar3 + 4;
LAB_0019a84c:
    ...
    if ((uVar4 & 0x14a5000) != 0) goto LAB_0019a9b0;
LAB_0019a83c:
    if ((uVar4 & 0x999) != 0) {
      uVar1 = uVar3 + 2;
      goto LAB_0019a84c;
  ...
  if (iVar2 - 0x675U < 0x19) {
    ...
    if ((uVar4 & 0x14a5000) == 0) {
      uVar3 = uVar3 + 3;
      if ((uVar4 & 0x999) == 0) goto LAB_0019a8b8;
    }
    else {
      uVar3 = uVar3 + 6;
    }
...
LAB_0019a8b8:
  ...
  if (uVar3 < 0x647) {
    if (0x630 < uVar3) {
      if ((0x210911UL >> ((ulong)(uVar3 - 0x631) & 0x3f) & 1) != 0) goto LAB_0019a9d4;
      goto LAB_0019a910;
    }
    if (uVar3 < 0x5b2) {
      if (0x573 < uVar3) {
        uVar5 = 0x3060c183cc7860f3 >> ((ulong)(uVar3 - 0x574) & 0x3f);
        goto joined_r0x0019aae0;
      }
      if (uVar3 < 0x56b) {
        if (uVar3 < 0x569) goto LAB_0019a910;
        goto LAB_0019a900;
      }
      if (uVar3 - 0x56d < 4) goto LAB_0019a900;
    }
    else {
      if (0x22 < uVar3 - 0x5df) goto LAB_0019a910;
...
LAB_0019a9d4:
    ...
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    if ((int)uVar5 != 0) goto LAB_0019aa08;
LAB_0019a92c:
    MCOperand_CreateImm0(param_1,0);
    uVar4 = (ulong)(param_2 & 0xf);
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x5b2) goto LAB_0019a94c;
LAB_0019aa30:
