  ...
  if (((param_1 != (long *)0x0) && (uVar2 = *(uint *)(param_1 + 1), uVar2 != 0)) &&
    ...
    if (__ptr != (void *)0x0) {
      ...
      do {
        if (*(uint *)(plVar12 + 1) != 0) {
          lVar22 = *plVar12;
          lVar10 = lVar22 + (ulong)*(uint *)(plVar12 + 1) * 0x90;
          do {
      ...
      do {
        if (*(uint *)(plVar16 + 1) != 0) {
          ...
          puVar13 = puVar6 + (ulong)*(uint *)(plVar16 + 1) * 0x24;
          do {
            uVar2 = puVar6[0xc];
            if (uVar2 != 0) {
              uVar4 = *puVar6;
      ...
      do {
        if (*(uint *)(plVar12 + 1) != 0) {
          puVar6 = (uint *)*plVar12;
          puVar13 = puVar6 + (ulong)*(uint *)(plVar12 + 1) * 0x24;
LAB_0015a69c:
          do {
...
LAB_0015a70c:
                ...
                if (((uVar3 <= uVar4) ||
                    (piVar8 = *(int **)((long)__ptr + uVar7 * 0x10), piVar8 == (int *)0x0)) ||
                   (*piVar8 != 1)) goto LAB_0015a86c;
              }
              else if (uVar4 < uVar3) {
                piVar8 = *(int **)((long)__ptr + uVar7 * 0x10);
                if ((piVar8 == (int *)0x0) || (*piVar8 != 1)) goto LAB_0015a6f0;
              }
              else {
LAB_0015a86c:
                if (uVar4 < uVar2) {
          ...
          if (uVar2 != 0) {
            ...
            if (*(uint *)(param_1 + 1) != 0) {
              ...
              do {
                if (*(uint *)(plVar14 + 1) != 0) {
                  piVar8 = (int *)*plVar14;
                  piVar17 = piVar8 + (ulong)*(uint *)(plVar14 + 1) * 0x24;
                  do {
