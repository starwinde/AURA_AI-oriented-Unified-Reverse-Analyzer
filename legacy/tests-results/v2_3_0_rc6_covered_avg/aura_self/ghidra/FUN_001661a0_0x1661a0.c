...
void FUN_001661a0(char *param_1,undefined8 param_2,void *param_3)
...
LAB_0016637c:
    ...
    local_200 = (char *)0xf;
    local_1e0 = uVar6;
    iVar2 = FUN_001f11a4(pvVar4,auStack_58,&local_200);
LAB_0016631c:
    pcVar7 = local_200;
    ...
    if (iVar2 == 0) {
      ...
      if (local_200 == pcVar7) goto LAB_00166450;
...
LAB_001662d8:
      ...
      local_1b8 = 4;
      local_180 = uVar3;
      iVar2 = FUN_001f126c(pvVar4,auStack_58,&local_200,param_2);
      goto LAB_0016631c;
    }
