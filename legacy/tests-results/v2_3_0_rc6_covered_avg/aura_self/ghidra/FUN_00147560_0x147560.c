...
long * FUN_00147560(long param_1)

{
  ...
  if ((param_1 != 0) &&
     (local_30 = FUN_00144c60(param_1,PTR___stack_chk_guard_005ffe88,0), local_30 != 0)) {
    plVar9 = (long *)FUN_00144d80(&local_30);
    if (plVar9 == (long *)0x0) {
      plVar9 = (long *)0x0;
          ...
          do {
            ...
            if (uVar12 <= uVar3) {
              ...
              if (((!bVar1 && 6 < uVar4) && (bVar1 || uVar4 != 7)) &&
                ...
                iVar8 = FUN_00146780(plVar9,puVar2,uVar3,uVar13);
                goto LAB_001475f4;
              }
            }
            uVar11 = uVar11 + 1;
