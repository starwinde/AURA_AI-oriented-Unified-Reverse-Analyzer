...
void FUN_0016b680(long *param_1,long param_2)
  ...
  if (uVar9 == 0) {
    ...
    if (uVar4 < 2) {
      ...
      do {
        ...
        pauVar3 = pauVar6 + 1;
        pauVar6 = pauVar6 + 3;
        auVar10 = a64_TBL(ZEXT816(0),auVar10,*pauVar3,_DAT_0020c6b0);
        iVar11 = iVar11 + (_DAT_0020c6d0 ^
                          (_DAT_0020c6d0 ^ _DAT_0020c6c0) & -(uint)(auVar10._0_4_ == 0));
        iVar12 = iVar12 + (_UNK_0020c6d4 ^
                          (_UNK_0020c6d4 ^ _UNK_0020c6c4) & -(uint)(auVar10._4_4_ == 0));
        iVar13 = iVar13 + (_UNK_0020c6d8 ^
                          (_UNK_0020c6d8 ^ _UNK_0020c6c8) & -(uint)(auVar10._8_4_ == 0));
        iVar14 = iVar14 + (_UNK_0020c6dc ^
                          (_UNK_0020c6dc ^ _UNK_0020c6cc) & -(uint)(auVar10._12_4_ == 0));
