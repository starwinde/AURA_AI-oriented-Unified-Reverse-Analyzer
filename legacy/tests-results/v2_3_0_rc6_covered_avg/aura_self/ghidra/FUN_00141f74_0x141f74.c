...
undefined4 FUN_00141f74(long param_1,ulong param_2,int param_3)
      ...
      if (*(uint *)(lVar6 + 0x20) != 0) {
        ...
        do {
          if (((char *)*puVar12 != (char *)0x0) &&
            ...
            lVar7 = FUN_001446e0(*(undefined4 *)(lVar6 + 0xc));
            if (lVar7 == 0) {
...
LAB_00143304:
              ...
              if (__ptr == (void *)0x0) {
                ...
                iVar5 = FUN_001447f0(lVar7,lVar16 + (param_2 - uVar14),(uVar14 + lVar10) - param_2,
                                     param_2,__ptr,0x200);
                FUN_001447a4(lVar7);
                FUN_00144de4(lVar6);
                if (iVar5 < 1) {
                ...
                lVar6 = FUN_00147b50(__ptr,(long)iVar5,param_2);
                local_b0 = lVar6;
                free(__ptr);
                if (lVar6 == 0) {
                  ...
                  local_a8 = (long *)FUN_001498a0(lVar6);
                    ...
                    if (param_3 == 0) {
                      ...
                      if ((int)plVar4[1] != 0) {
                        ...
                        do {
                          ...
                          if ((uVar8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f99d0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 1 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f99e0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 2 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f99e8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 3 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f99f0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 4 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f99f8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 5 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f9a00);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 6 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f9a08);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 7 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_001f9a10);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_0020bee0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 9 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,&DAT_0020bef0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 10 & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,"r10");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xb & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,"r11");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xc & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,"r12");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xd & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,"r13");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xe & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,"r14");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xf & 1) != 0) {
                            __printf_chk(2,&DAT_001f99d8,"r15");
                          }
                          __printf_chk(2,"\n    kill: ");
                          uVar8 = *(uint *)(lVar6 + 4);
                          if ((uVar8 & 1) != 0) {
                          ...
                          if (uVar8 != 0) {
                            do {
                              while( true ) {
                                ...
                                if ((uVar8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f99d0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 1 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f99e0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 2 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f99e8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 3 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f99f0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 4 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f99f8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 5 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f9a00);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 6 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f9a08);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 7 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_001f9a10);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_0020bee0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 9 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,&DAT_0020bef0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 10 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,"r10");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xb & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,"r11");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xc & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,"r12");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xd & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,"r13");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xe & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,"r14");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xf & 1) != 0) {
                                  __printf_chk(2,&DAT_001f9a58,"r15");
                                }
                                __printf_chk(2,"  use:");
                                uVar8 = *(uint *)(lVar16 + 4);
                                if ((uVar8 & 1) != 0) {
                                ...
                                uVar8 = *(uint *)(lVar6 + 0x18);
                                uVar15 = uVar15 + 1;
                                if (uVar8 <= (uint)uVar15) goto LAB_00142558;
                              }
                              uVar15 = uVar15 + 1;
                          ...
                          do {
                            ...
                            do {
                              if ((1 << (ulong)((uint)lVar7 & 0x1f) & uVar9) != 0) {
                                ...
                                __printf_chk(2,&DAT_001f9918,(&PTR_DAT_005df4a0)[lVar7]);
                                bVar3 = false;
                              }
                              lVar7 = lVar7 + 1;
                            } while (lVar7 != 0x10);
                          ...
                          if (uVar9 != 0) {
                            do {
                              while( true ) {
                                ...
                                lVar6 = lVar6 + 8;
                                uVar11 = uVar1;
                                if (uVar9 <= uVar1) goto LAB_00143008;
                              }
                              lVar6 = lVar6 + 8;
                              uVar11 = uVar1;
                            } while (uVar1 < uVar9);
