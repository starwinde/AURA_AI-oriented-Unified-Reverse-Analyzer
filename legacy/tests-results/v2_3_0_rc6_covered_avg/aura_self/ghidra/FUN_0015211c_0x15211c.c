...
void FUN_0015211c(long *param_1,undefined8 param_2,char *param_3,long param_4)
    ...
    if ((int)param_1[1] != 0) {
      do {
        ...
        *(int *)((long)puVar1 + 0x34) = iVar8;
        ...
        iVar8 = FUN_00152040(puVar1,plStack_298,0,param_4);
        if (iVar8 != -1) {
          ...
          if (cVar7 != '\0') {
            ...
            do {
              ...
              if (cVar7 == ']') {
                ...
                cVar7 = acStack_168[0];
                if (acStack_168[0] == '\0') goto LAB_001528f8;
                sVar23 = strlen(acStack_168);
                pcVar31 = acStack_168 + (sVar23 - 1);
                if (pcVar31 <= acStack_168) goto LAB_001528b8;
                goto LAB_001528a8;
              }
              pcVar30 = pcVar30 + 1;
              cVar7 = *pcVar30;
...
LAB_0015279c:
            ...
            uStack_2a0 = 4;
            uStack_29c = 4;
            iVar10 = FUN_001519c4(acStack_168,&uStack_2b0,&uStack_2a4);
            if (iVar10 == 0) {
              iVar10 = 1;
              goto LAB_00152364;
            }
  ...
  if (cVar7 != '\0') {
    ...
    do {
      ...
      if (cVar7 == ']') {
        ...
        if (acStack_168[0x40] == '\0') goto LAB_00152ac8;
...
LAB_00152940:
  ...
  if (iVar10 == 0) {
    uStack_2b0 = 0xfffffffe;
    iVar10 = FUN_001519c4(pcVar31,&uStack_2ac,&uStack_2a0);
  }
  else {
    iVar10 = FUN_001519c4(pcVar31,&uStack_2ac,&uStack_2a0);
  }
...
LAB_00152bc4:
  ...
  uVar22 = uStack_2b0;
  if (iVar9 == 0) {
    if ((int)uStack_2b0 < 0) goto LAB_001525e0;
    if (bVar4) {
LAB_00152c70:
      if (uVar38 != 0) {
        iVar8 = FUN_00152040(puVar1,plStack_298,uVar38,uVar13);
      ...
      if (iVar8 == 1) {
        ...
        iVar8 = __isoc99_sscanf(pcVar19,&DAT_001fa658,&uStack_288);
...
LAB_001533dc:
          ...
          if (uStack_2ac < 0x20) {
            ...
            auVar45 = FUN_00152040(puVar1,plStack_298,0,uVar13);
          ...
          if (uStack_2a8 < 0x20) {
            ...
            auVar45 = FUN_00152040(puVar1,plStack_298,uStack_310,uVar13);
            uVar34 = auVar45._8_8_;
            iVar41 = auVar45._0_4_;
            uVar37 = auVar45._4_4_;
            if (iVar41 == -1) goto LAB_00152e34;
        ...
        if ((int)uStack_2b0 < 0) goto LAB_001533dc;
        ...
        if (uStack_2ac < 0x20) {
          ...
          auVar45 = FUN_00152040(puVar1,plStack_298,uVar38,uVar13);
          uVar27 = auVar45._8_8_;
...
LAB_00153000:
      FUN_00151cd0(acStack_168 + 0x40,&uStack_290,&uStack_288);
      uVar28 = *(uint *)(puVar1 + 2);
      uVar26 = *(uint *)((long)puVar1 + 0x14);
      iVar8 = (int)plStack_298[2];
      *(int *)(plStack_298 + 2) = iVar8 + 1;
      ...
      *(undefined4 *)((long)puVar16 + 0xc) = uVar11;
      if (uStack_290 < 0x20) {
        ...
        auVar45 = FUN_00152040(puVar1,plStack_298,CONCAT44(uStack_288._4_4_,(int)uStack_288),uVar13)
        ;
...
joined_r0x00153594:
    ...
    if (iVar10 == 0) {
      uVar22 = uStack_2b0;
      uVar11 = uStack_2a4;
      if (-1 < (int)uStack_2b0) goto LAB_00153000;
      goto LAB_001525e0;
    }
...
LAB_00153aac:
    ...
    if (iVar10 == 0) {
      FUN_00151cd0(acStack_e9 + 1,&uStack_290,&uStack_288);
      ...
      do {
        ...
        *(undefined8 *)(puVar17 + 4) = 0;
        if ((uStack_290 < 0x20) &&
          ...
          auVar45 = FUN_00152040(puVar1,plStack_298,
...
LAB_00153d64:
        for (; (int)lVar35 == 0; lVar35 = lVar35 + 1) {
          uVar38 = (ulong)uStack_2b0;
          uVar11 = uStack_2a4;
          if (-1 < (int)uStack_2b0) goto LAB_00153c54;
        }
...
LAB_00154ebc:
                    ...
                    uVar11 = FUN_00151b10(lVar35 + 0x22,&uStack_288);
                    iVar8 = (int)plStack_298[2];
                    *(int *)(plStack_298 + 2) = iVar8 + 1;
                    puVar17 = (undefined4 *)FUN_00151940(puVar1);
                    if (puVar17 == (undefined4 *)0x0) goto LAB_00152e34;
...
LAB_001546a8:
                    ...
                    plVar14 = plStack_298;
                    uVar11 = FUN_00151b10(acStack_168 + 0x40,&uStack_288);
                    iVar8 = (int)plVar14[2];
                  ...
                  auVar45 = FUN_00152040(puVar1,plStack_298,uVar27,uVar13);
                  if (auVar45._0_4_ == -1) goto LAB_00152e34;
                  auVar46 = FUN_00152040(puVar1,plStack_298,0,uVar13);
...
LAB_00154f94:
                  ...
                  uVar11 = FUN_00151b10(&uStack_178,&uStack_288);
                  iVar8 = (int)plStack_298[2];
                  *(int *)(plStack_298 + 2) = iVar8 + 1;
                  puVar20 = (undefined4 *)FUN_00151940(puVar1);
                  if (puVar20 == (undefined4 *)0x0) goto LAB_00152e34;
...
LAB_001545a8:
                ...
                *(undefined8 *)(puVar17 + 0xc) = 0;
                ...
                if ((((char)uStack_178 == '\0') ||
                    (iVar8 = FUN_001519c4(&uStack_178,&uStack_290,&uStack_288), iVar8 == 0)) ||
                   (0x1f < uStack_290)) {
LAB_001544c8:
                  iVar8 = (int)plStack_298[2];
                  *(int *)(plStack_298 + 2) = iVar8 + 1;
...
LAB_0015420c:
            ...
            auVar45 = FUN_00152040(puVar1,plStack_298,1L << (uVar38 & 0x3f),uVar13);
            if (auVar45._0_4_ == -1) goto LAB_00152e34;
            iVar41 = (int)plStack_298[2];
            *(int *)(plStack_298 + 2) = iVar41 + 1;
            puVar17 = (undefined4 *)FUN_00151940(puVar1);
            ...
            *(undefined1 (*) [16])(puVar17 + 10) = auVar45;
            puVar17[0x12] = 2;
            *(undefined8 *)(puVar17 + 0x1c) = uVar13;
            auVar45 = FUN_00152040(puVar1,plStack_298,0);
            if (auVar45._0_4_ == -1) goto LAB_00152e34;
            iVar8 = (int)plStack_298[2];
            *(int *)(plStack_298 + 2) = iVar8 + 1;
            puVar17 = (undefined4 *)FUN_00151940(puVar1);
...
LAB_00152cd8:
    iVar10 = FUN_001519c4(pcVar15,&uStack_2ac,&uStack_2a0);
  }
  else {
    sVar23 = strlen(__s);
...
LAB_00152cf0:
    ...
    if (iVar9 == 1) {
      ...
      iVar9 = __isoc99_sscanf(pcVar31,&DAT_001fa658,&uStack_288);
      if (iVar9 == 1) {
        uVar38 = CONCAT44(uStack_288._4_4_,(int)uStack_288);
        bVar4 = true;
      }
    ...
    if (iVar10 == 3) {
      iVar10 = FUN_001519c4(acStack_e9 + 1,&uStack_2a8,&uStack_29c);
...
LAB_00152bb8:
    ...
    uVar38 = 0;
    iVar10 = FUN_001519c4(__s,&uStack_2a8,&uStack_29c);
    bVar4 = false;
...
LAB_00152d80:
    ...
    if (iVar10 == 1) {
      ...
      iVar10 = __isoc99_sscanf(pcVar31,&DAT_001fa658,&uStack_288);
      uStack_310 = 0;
      if (iVar10 == 1) {
...
LAB_00153fe4:
  if (((uVar28 == 0x1f) && (lVar35 = CONCAT44(uStack_288._4_4_,(int)uStack_288), lVar35 != 0)) &&
    ...
    auVar45 = FUN_00152040(puVar1,plStack_298,lVar35,uVar13);
    iVar8 = (int)plStack_298[2];
    *(int *)(plStack_298 + 2) = iVar8 + 1;
    puVar17 = (undefined4 *)FUN_00151940(puVar1);
    if (puVar17 == (undefined4 *)0x0) goto LAB_00152e34;
