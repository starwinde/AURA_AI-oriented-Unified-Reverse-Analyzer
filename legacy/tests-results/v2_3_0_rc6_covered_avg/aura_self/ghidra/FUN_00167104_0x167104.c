...
void FUN_00167104(long *param_1)
...
LAB_001671f8:
        ...
        if ((((4 < uVar11) && (pcVar6 = *(char **)(*param_1 + 8), *pcVar6 == '\x7f')) &&
          ...
          if (pcVar6[4] == '\x01') {
            ...
            if (pcVar6[4] != '\x02') goto LAB_00167228;
            if (uVar11 == 5) {
              lVar18 = 8;
              uVar11 = 0x10;
              uVar5 = 8;
          ...
          FUN_00166df4(param_1,".init_array",1,".init_array",uVar5,bVar3,&local_a8);
          FUN_00166df4(param_1,".fini_array",2,".fini_array",uVar5,bVar3,&local_a8);
            ...
            if (((((ulong)uVar1 <= uVar11 - 4) && (*(int *)(lVar18 + (ulong)uVar1) == 0x4550)) &&
              ...
              if (sVar2 == 0x20b) {
                if (uVar9 + 0x2c <= uVar11 - 8) {
                  lVar12 = 0x70;
                  FUN_001669f0(lVar18 + uVar9 + 0x2c);
...
LAB_0016730c:
                ...
                if ((uVar9 <= uVar11) &&
                  ...
                  auVar21 = FUN_00166a00(lVar18);
                  lVar12 = auVar21._0_8_;
                  if (lVar12 != 0) {
                    if (sVar2 == 0x20b) {
                      if (lVar12 + 0x18U <= extraout_x11) {
                        auVar22 = FUN_001669f0(lVar18 + lVar12 + 0x18U);
...
LAB_00167358:
                      if (auVar22._0_8_ != 0 && uVar11 <= auVar22._0_8_) {
                        auVar21 = FUN_00166a00(lVar18,auVar22._8_8_,auVar22._0_4_ - (int)uVar11);
                        ...
                        if (uVar11 != 0) {
                          ...
                          if (uVar11 <= uVar9) {
                            ...
                            do {
                              if (sVar2 == 0x20b) {
                                uVar20 = FUN_001669f0(lVar18 + uVar11);
                              }
                              else {
                              ...
                              iVar4 = iVar4 + 1;
                              FUN_00166ca0(&local_a8,uVar20,5,auStack_98);
                              if (iVar4 == 0x100) goto LAB_00167468;
...
LAB_00167188:
  ...
  __stack_chk_fail(uVar5,PTR___stack_chk_guard_005ffe88,0,
                   local_68 - *(long *)PTR___stack_chk_guard_005ffe88);
LAB_001674e0:
  if (uVar9 < uVar13 + uVar11) goto LAB_00167468;
  lVar14 = puVar8[5];
  lVar12 = uVar13 + lVar18;
  lVar10 = FUN_00166dc0(lVar14 + uVar13,uVar5,bVar3,lVar12);
  lVar12 = FUN_00166dc0(lVar14 + lVar12,uVar5);
  if (lVar10 == 0) goto LAB_00167468;
  if (lVar12 == 0 || lVar10 != 0xc) {
    if (lVar12 != 0 && lVar10 == 0xd) {
      FUN_00166ca0(&local_a8,lVar12,4,"DT_FINI");
    }
  }
  else {
    FUN_00166ca0(&local_a8,lVar12,3,"DT_INIT");
  }
  uVar16 = uVar16 + 1;
  if (uVar20 <= uVar16) goto LAB_00167468;
  uVar9 = puVar8[3];
