...
void FUN_001f5864(undefined8 param_1,int param_2,uint param_3)

{
  ...
  if (-1 < param_2) {
    local_88 = (*(code *)PTR_malloc_00600598)((long)param_2);
    if (local_88 != 0) {
      uStack_78 = 0;
      local_68 = (ulong)param_3 << 0x20;
      puStack_60 = PTR_malloc_00600598;
      puStack_58 = PTR_free_006005a0;
      local_50 = PTR_realloc_006005a8;
      lStack_80 = (long)param_2;
      iVar1 = FUN_001f34d4(param_1,&local_88);
      lVar2 = local_88;
      if (iVar1 == 0) {
