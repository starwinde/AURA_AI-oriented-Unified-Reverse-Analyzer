...
uint FUN_001f2830(uint param_1,uint param_2)

{
  ...
  uVar1 = *(uint *)(&DAT_0058c0f0 + (ulong)param_2 * 0xc);
...
LAB_001f2964:
  ...
  uVar2 = *(uint *)(&DAT_0058d270 + ((ulong)uVar1 * 3 + (long)(int)(uint)local_a) * 4);
  if ((uVar2 == 0) && (local_9 = (&DAT_0058c0f4)[(ulong)param_2 * 0xc], uVar2 = param_2, uVar1 < 10)
     ) {
    if (uVar1 < 7) {
      if (uVar1 == 1) {
        if (0x23 < local_9) {
        ...
        local_9 = (&DAT_0058d360)[(int)(uint)local_9];
      }
      else {
        if (uVar1 == 0) {
          return param_2;
