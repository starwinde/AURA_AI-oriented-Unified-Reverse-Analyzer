...
char * FUN_00180d90(long *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
                   long *param_5)
  ...
  *(long *)(__s + 0x80) = param_1[3];
  ...
  if (param_5 != (long *)0x0) {
    ...
    if (uVar25 != 0) {
      ...
      uVar22 = 0;
      *(uint *)(__s + 0xdd0) = uVar25;
LAB_00180ec4:
      do {
        lVar19 = *param_5 + lVar24;
        if (((*(char *)(lVar19 + 0x84) == 'a') && (*(char *)(lVar19 + 0x85) == 'r')) &&
           ((*(char *)(lVar19 + 0x86) == 'g' && (cVar4 = *(char *)(lVar19 + 0x87), cVar4 != '\0'))))
        {
          pcVar7 = (char *)(lVar19 + 0x87);
          do {
            if (9 < (byte)(cVar4 - 0x30U)) goto LAB_00180ef0;
            pcVar7 = pcVar7 + 1;
            cVar4 = *pcVar7;
          } while (cVar4 != '\0');
          __snprintf_chk(pcVar13,0x40,2,0x40,"param_%u",uVar22 + 1);
        }
        else {
LAB_00180ef0:
        ...
        *(undefined4 *)(pcVar13 + 0xc0) = *(undefined4 *)(lVar19 + 0xd0);
        ...
        if (*(int *)(lVar19 + 0xc4) != 1 || 7 < uVar22) {
          ...
          if (*(uint *)(__s + 0xdd0) <= uVar25) break;
          goto LAB_00180ec4;
        }
        *(uint *)(pcVar13 + 200) = uVar22;
        uVar22 = uVar22 + 1;
        lVar24 = lVar24 + 0xd8;
        pcVar13 = pcVar13 + 0xcc;
    ...
    if ((*(byte *)(param_5 + 0x12) & 1) == 0) {
      *(undefined4 *)(__s + 0x88) = DAT_001fa448;
      __s[0x8c] = cVar4;
      __s[0x108] = '\0';
      __s[0x109] = '\0';
      __s[0x10a] = '\0';
      ...
      snprintf(pcVar23,0x80,"%s",__haystack);
...
LAB_001814f8:
  ...
  if (*(uint *)(param_1 + 1) != 0) {
    ...
    puVar8 = puVar21 + (ulong)*(uint *)(param_1 + 1) * 0x14;
    do {
      uVar25 = *puVar21;
      if (uVar25 != 0) {
        lVar24 = 0;
...
LAB_0018140c:
            ...
            uVar25 = *puVar21;
            sVar26 = sVar27;
            if (uVar25 <= uVar22) goto LAB_00181068;
          }
          uVar22 = uVar22 + 1;
          lVar24 = lVar24 + 0x90;
        } while (uVar22 < uVar25);
...
LAB_00181078:
  ...
  if (pvVar11 == (void *)0x0) {
    ...
    if (uVar22 != 0) {
      ...
      puVar8 = puVar21 + (ulong)uVar22 * 0x14;
      do {
        if (*puVar21 != 0) {
          uVar20 = 0;
            ...
            while( true ) {
              ...
              if (uVar5 != 0) {
                ...
                if (1 < uVar5) {
                  ...
                  if ((2 < uVar5) && (uVar5 = puVar18[8], uVar5 < uVar25)) {
...
LAB_00181154:
              ...
              if (*puVar21 <= uVar20) goto LAB_00181168;
            }
            lVar19 = *(long *)(puVar18 + 0xe);
            lVar24 = 0;
            do {
              while (uVar3 = *(uint *)(lVar19 + lVar24 * 0x10), uVar25 <= uVar3) {
                lVar24 = lVar24 + 1;
                if (uVar5 <= (uint)lVar24) goto LAB_00181154;
              }
              lVar24 = lVar24 + 1;
              *(int *)((long)pvVar11 + (ulong)uVar3 * 4) =
                   *(int *)((long)pvVar11 + (ulong)uVar3 * 4) + 1;
...
LAB_00181168:
    ...
    local_190 = pvVar11;
    local_188 = calloc((ulong)uVar22,1);
    pvVar12 = (void *)0x0;
    if (local_188 != (void *)0x0) {
      ...
      if (pvVar11 == (void *)0x0) {
        ...
        *(void **)(__s + 0xde8) = pvVar11;
        FUN_0017fdb0(&local_1b8,0,uVar22,pvVar11);
      }
      FUN_0017e770(*(undefined8 *)(__s + 0xde8),__s,param_1);
