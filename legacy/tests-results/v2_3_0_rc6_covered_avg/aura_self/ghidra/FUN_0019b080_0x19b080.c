...
ulong FUN_0019b080(undefined8 param_1,ulong param_2)

{
  ...
  FUN_00190100(param_1,*(undefined2 *)(&DAT_0022f4e0 + ((ulong)(iVar1 * 2 + uVar4) & 0x1f) * 2));
  FUN_00190100(param_1,*(undefined2 *)(&DAT_0022f4e0 + ((ulong)(iVar1 * 3 + uVar4) & 0x1f) * 2));
  if (uVar2 == 0xf) {
