...
void FUN_001cc1d0(long param_1,undefined8 param_2,undefined8 param_3,int param_4)

{
  ...
  iVar4 = FUN_00190080();
  FUN_00190370(param_3,&DAT_002b3bf0 +
                       *(ushort *)(&DAT_002b4900 + (ulong)((iVar4 + iVar3) - 0xf8) * 2));
  lVar7 = *(long *)(param_1 + 800);
  if (*(int *)(lVar7 + 0x60) != 0) {
    uVar5 = FUN_0018ffb0(param_1);
    bVar1 = *(byte *)(param_1 + 0x366);
    lVar7 = FUN_001dbcf0(lVar7,uVar5);
