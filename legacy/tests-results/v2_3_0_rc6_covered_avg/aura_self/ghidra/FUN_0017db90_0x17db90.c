...
bool FUN_0017db90(long *param_1,undefined4 *param_2)

{
  ...
  if (param_1 == (long *)0x0) {
    ...
    plVar4 = (long *)FUN_0017b990(param_1,0);
    local_70 = plVar4;
    if (plVar4 == (long *)0x0) {
      bVar3 = false;
    }
      ...
      if (uVar17 == 0) {
        ...
        local_88 = 0;
        local_7c = 0;
        if (puVar19 != (uint *)0x0) goto LAB_0017dc20;
LAB_0017dbf8:
        local_7c = local_7c + 1;
        if (local_7c < uVar17) {
          while( true ) {
...
LAB_0017dc20:
            if (((puVar19[4] == 0) || (*(uint *)(param_1 + 1) <= *puVar19)) ||
               (lVar21 = *param_1 + (ulong)*puVar19 * 0x50, *(int *)(lVar21 + 0x20) == 0))
            goto LAB_0017dbf8;
            lVar20 = 0;
            uVar17 = 0xffffffff;
            do {
              uVar9 = *(uint *)(*(long *)(lVar21 + 0x18) + lVar20 * 4);
              uVar5 = FUN_0017c6b4(puVar19,uVar9);
            ...
            uVar9 = puVar19[4];
            iVar16 = 0;
            lVar21 = *param_1 + (ulong)uVar17 * 0x50;
            do {
              if (uVar9 == 0) break;
              lVar20 = 0;
              bVar3 = false;
LAB_0017dcc4:
              do {
                ...
                if (uVar17 < *(uint *)(param_1 + 1)) {
                  lVar13 = *param_1 + (ulong)uVar17 * 0x50;
                  ...
                  if (uVar17 != 0) {
                    ...
                    do {
                      while( true ) {
                        ...
                        if (uVar15 != 1) goto LAB_0017dd30;
LAB_0017dd00:
                        uVar5 = (ulong)uVar9;
                        if (uVar17 <= uVar9) goto LAB_0017de70;
                      }
                      if (uVar15 != 0x1c) goto LAB_0017dd00;
LAB_0017dd30:
                      if (*(uint *)(puVar2 + 9) != 0) {
                        puVar8 = puVar2;
                        do {
                            ...
                            if (puVar19[4] != 0) {
                              ...
                              do {
                                if (*puVar7 < *(uint *)(param_1 + 1)) {
                                  lVar14 = *param_1 + (ulong)*puVar7 * 0x50;
                                  uVar15 = *(uint *)(lVar14 + 0x10);
                                  if (uVar15 != 0) {
                                    piVar6 = (int *)(*(long *)(lVar14 + 8) + 8);
                                    piVar10 = piVar6 + (ulong)uVar15 * 0x24;
                                    do {
                                      if (*(int *)(puVar8 + 3) == *piVar6) goto LAB_0017dd00;
                                      piVar6 = piVar6 + 0x24;
...
LAB_0017df54:
                        uVar11 = uVar17;
                        if (uVar17 < uVar15) {
                          puVar8 = (undefined8 *)((long)__ptr + (ulong)uVar17 * 0x90);
                        }
                        else {
LAB_0017ddc0:
                          if (uVar15 == 0) {
                          ...
                          uVar17 = *(uint *)(lVar21 + 0x10);
                          *(void **)(lVar21 + 8) = __ptr;
                          lVar14 = (ulong)uVar11 * 0x90;
                          *(uint *)(lVar21 + 0x14) = uVar15;
                          puVar8 = (undefined8 *)((long)__ptr + lVar14);
                          if (uVar11 < uVar17) goto LAB_0017dfa4;
                        }
                      }
                      else {
                        uVar11 = uVar17 - 1;
                        ...
                        if (1 < *(int *)((long)__ptr + lVar14) - 0x17U &&
                            *(int *)((long)__ptr + lVar14) != 0x1a) goto LAB_0017df54;
                        if (uVar15 <= uVar17) goto LAB_0017ddc0;
LAB_0017dfa4:
                        memmove((void *)((long)__ptr + (ulong)(uVar11 + 1) * 0x90),puVar8,
                                (ulong)(uVar17 - uVar11) * 0x90);
                      ...
                      *puVar8 = uVar22;
                      ...
                      puVar8[0xe] = uVar23;
                      uVar22 = puVar2[0x10];
                      puVar8[0x11] = puVar2[0x11];
                      puVar8[0x10] = uVar22;
                      *(uint *)(lVar21 + 0x10) = uVar17 + 1;
                      uVar17 = *(uint *)(lVar13 + 0x10);
                      if (uVar9 < uVar17) {
                        memmove((void *)(*(long *)(lVar13 + 8) + lVar12),
                                (void *)(*(long *)(lVar13 + 8) + (ulong)uVar9 * 0x90),
                                (ulong)((uVar17 - 1) - uVar18) * 0x90);
                        uVar17 = *(uint *)(lVar13 + 0x10);
                      }
                      uVar17 = uVar17 - 1;
...
LAB_0017de70:
            ...
            local_7c = local_7c + 1;
            plVar4 = local_70;
            if (uVar17 <= local_7c) goto LAB_0017deb8;
          }
LAB_0017dfe8:
          uVar17 = *(uint *)(local_70 + 1);
          plVar4 = local_70;
