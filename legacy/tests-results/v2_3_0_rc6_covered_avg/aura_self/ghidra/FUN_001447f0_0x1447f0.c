...
ulong FUN_001447f0(undefined8 *param_1,long param_2,undefined8 param_3,undefined8 param_4,
...

{
  ...
  if ((param_2 == 0 || param_5 == 0) || param_1 == (undefined8 *)0x0) {
    ...
    uVar2 = FUN_0018cbc4(*param_1);
    if (uVar2 == 0) {
      uVar4 = 0;
      uVar1 = FUN_0018c5c0(*param_1);
