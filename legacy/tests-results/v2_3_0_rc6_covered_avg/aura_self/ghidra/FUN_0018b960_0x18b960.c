...
long * FUN_0018b960(long param_1,ulong param_2,long param_3,ulong param_4,ulong param_5)
...
LAB_0018ba84:
                ...
                if (local_70 == pcVar9) goto LAB_0018ba84;
                ...
                if ((((uVar14 < param_5) || (param_4 + param_5 < uVar14 + 8)) ||
                   ...
                   (param_4 + param_5 <= uVar14)) goto LAB_0018ba84;
                iVar6 = strcmp(__s1,"call");
                uVar15 = 0;
                if ((iVar6 == 0) && (uVar17 != 0)) {
                  pcVar8 = strchr(pcVar12,0x5b);
...
LAB_0018bc88:
                ...
                if (*(uint *)((long)__ptr + 0xc) <= uVar2) {
                  ...
                  if (pvVar7 == (void *)0x0) goto LAB_0018ba84;
                  *__ptr = (long)pvVar7;
                  *(uint *)((long)__ptr + 0xc) = uVar3;
                }
                if (0x3ff < uVar2) goto LAB_0018ba84;
                              ...
                              do {
                                ...
                                if (param_5 <= uVar19 && uVar19 < param_4 + param_5) {
                                  ...
                                  if (*(uint *)((long)__ptr + 0xc) <= uVar2) {
                                    ...
                                    pvVar7 = realloc((void *)*__ptr,(ulong)uVar3 * 0x18);
                                    if (pvVar7 == (void *)0x0) goto LAB_0018becc;
                                    *__ptr = (long)pvVar7;
                                    *(uint *)((long)__ptr + 0xc) = uVar3;
                                  }
                                  if (uVar2 < 0x400) {
...
LAB_0018bd28:
  pcVar8 = pcVar8 + 0xe0;
  if (pcVar8 == __s1 + -0x20) goto LAB_0018ba98;
  goto LAB_0018bd34;
}
