...
void FUN_001b1f80(long param_1,int param_2,undefined8 param_3)

{
  ...
  uVar8 = FUN_0018ffd0();
  uVar5 = FUN_001900a0();
  lVar9 = FUN_001900a0(uVar8);
  uVar5 = uVar5 & 0xff;
  uVar1 = (uint)(lVar9 >> 7) & 0x1e;
  iVar6 = FUN_0018ffb0(param_1);
  if (iVar6 == 0x2ac) {
  ...
  uVar10 = FUN_001900a0(uVar8);
  if (uVar10 != uVar14) {
    FUN_001903f0(param_3,"#%u, #%u",uVar5,uVar1);
  ...
  if (bVar4) {
    if (0x12 < uVar3 + 9) goto LAB_001b2164;
  }
  else if (((int)uVar3 < 0) || (9 < (int)uVar3)) {
LAB_001b2164:
    FUN_001903f0(param_3,"#0x%x",uVar3);
    goto LAB_001b20ec;
  }
  FUN_001903f0(param_3,&DAT_001fdd78,(ulong)uVar3);
LAB_001b20ec:
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
    return;
  }
