...
void FUN_001917b0(long param_1,undefined8 param_2)

{
  ...
  if ((long)uVar3 < 10) {
    FUN_001903f0(param_2,&DAT_001fba60,uVar3);
  }
  else {
    FUN_001903f0(param_2,"0x%lx",uVar3);
  }
