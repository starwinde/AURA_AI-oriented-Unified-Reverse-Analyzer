...
undefined8 FUN_0019b800(undefined8 param_1,uint param_2)
...
LAB_0019b854:
      ...
      FUN_00190100(param_1,*(undefined2 *)(&DAT_0022f230 + (ulong)uVar3 * 2));
      goto LAB_0019b8fc;
    }
    if (0x1d < uVar3) {
      return 0;
    }
    FUN_00190100(param_1,*(undefined2 *)(&DAT_0022f330 + (ulong)uVar3 * 2));
    uVar1 = FUN_0018ffb0(param_1);
...
joined_r0x0019b8c8:
      ...
      FUN_00190100(param_1,*(undefined2 *)(&DAT_0022f4e0 + ((ulong)(uVar3 + iVar2) & 0x1f) * 2));
    }
  }
  else {
...
LAB_0019b98c:
  ...
  if (iVar2 - 0x675U < 0x19) {
    ...
    FUN_00190100(param_1,*(undefined2 *)(&DAT_0022f4e0 + ((ulong)uVar3 & 0x1f) * 2));
  }
LAB_0019ba08:
...
LAB_0019bb58:
    ...
    FUN_00190140(param_1,(long)(4 << uVar5));
    uVar3 = FUN_0018ffb0(param_1);
