...
undefined8 FUN_001eaac4(undefined8 *param_1,long param_2,byte *param_3)
...
LAB_001eb75c:
    ...
    if (bVar8 == 0x20) {
      ...
      bVar8 = FUN_001e8184(*(undefined8 *)(param_2 + 0x20));
      bVar9 = FUN_001e7e28(*param_1);
      if (bVar9 < bVar8) {
        return 0;
      }
      lVar13 = FUN_001f2ee0(param_3);
      if (*(char *)(param_1 + 5) == '\0') {
        uVar4 = FUN_001e7e6c(param_1,lVar13,*(undefined2 *)(param_2 + 0x28),1);
      ...
      uVar4 = FUN_001e82f8(param_1,*(undefined8 *)(param_2 + 0x20),param_3);
    ...
    if (0x20 < bVar8) goto LAB_001eb75c;
    if (bVar8 < 0x1b) {
      if (bVar8 < 0x17) goto LAB_001eb75c;
    }
    else if (bVar8 != 0x1f) goto LAB_001eb75c;
  }
  ...
  local_4c = 0;
  if (uVar12 != 0) {
    local_4c = FUN_001e8184(uVar12);
    if (0x20 < local_4c) {
      return 0;
    }
    uVar4 = FUN_001e9950(param_1);
    *(undefined1 *)((long)param_1 + 0x2c) = uVar4;
    if (*(char *)((long)param_1 + 0x2c) != '\0') {
      if ((uVar12 & (long)((1 << (ulong)(*(byte *)((long)param_1 + 0x2c) & 0x1f)) + -1)) == 0) {
        cVar5 = FUN_001e8184((long)uVar12 >> ((ulong)*(byte *)((long)param_1 + 0x2c) & 0x3f));
        if (cVar5 == '\b') {
          local_4c = 8;
        }
      }
  ...
  if ((*param_3 & 0x3f) == 0x1f) {
    ...
    if (*(char *)(param_1 + 5) == '\0') {
      if (((*(byte *)(param_1[1] + 8) & 0x80) == 0) &&
        ...
        cVar5 = FUN_001ea414(param_1,param_2,lVar13);
        if (cVar5 == '\0') {
          return 0;
        }
      }
...
LAB_001eaee8:
  ...
  iVar10 = FUN_001f2768(*(undefined4 *)(param_2 + 0x10));
  if ((iVar10 == 0) && (*(int *)(param_2 + 0x10) != 0)) {
    return 0;
  }
  iVar11 = FUN_001f2768(*(undefined4 *)(param_2 + 0x14));
  if ((iVar11 == 0) && (*(int *)(param_2 + 0x14) != 0)) {
    return 0;
  }
  if (bVar2) {
    cVar5 = FUN_001e7d38(*(undefined4 *)*param_1);
    cVar6 = FUN_001f2720(*(undefined4 *)(param_2 + 0x14));
    if (((*(int *)*param_1 != 0) || (iVar10 != 4)) && ((iVar10 != 3 && (iVar10 != 0)))) {
      return 0;
    }
    if (((iVar10 == 3) && (cVar5 != '@')) &&
       (cVar7 = FUN_001f2720(*(undefined4 *)(param_2 + 0x10)), '\a' < cVar7)) {
      return 0;
    }
    if (((*(byte *)(param_1[1] + 6) & 7) != 4) &&
       (cVar7 = FUN_001f2720(*(undefined4 *)(param_2 + 0x10)), '\x0f' < cVar7)) {
      return 0;
    }
    local_4a = 7;
    if (cVar5 == '@') {
    ...
    cVar5 = FUN_001e8c34(param_1,iVar10,*(undefined4 *)(param_2 + 0x10));
    if ((cVar5 == '\0') && ((!bVar1 || (*(int *)*param_1 != 0)))) {
      return 0;
    }
    cVar5 = FUN_001e8c34(param_1,iVar11,*(undefined4 *)(param_2 + 0x14));
    if (cVar5 == '\0') {
      return 0;
    }
  ...
  if (iVar10 == 0) {
    if (iVar11 == 0) {
      ...
      if (*(int *)*param_1 == 0) {
        ...
        if ((local_4c < local_49) &&
           (bVar8 = FUN_001e8204(~((-1L << ((ulong)(local_49 - 1) & 0x3f)) << 1) &
      ...
      local_49 = FUN_001e7d38(*(undefined4 *)*param_1);
    }
    else {
      local_49 = FUN_001f2b94(*(undefined4 *)*param_1,iVar11);
    }
  }
  else if (bVar1) {
    ...
    local_49 = FUN_001f2b94(*(undefined4 *)*param_1,iVar10);
  }
  if (*(int *)*param_1 == 0) {
    if ((bVar1) && (iVar11 != 0)) {
      return 0;
    ...
    if (bVar2) {
      ...
      cVar5 = FUN_001e8dd0(*(undefined4 *)(param_2 + 0x10),*(undefined4 *)(param_2 + 0x14));
      if (cVar5 == -1) {
        return 0;
      }
  ...
  if (((*(byte *)(param_1[2] + 4) & 0x30) == 0x10) &&
     (cVar5 = *(char *)((long)param_1 + 0x29), cVar6 = FUN_001e7d38(*(undefined4 *)*param_1),
     cVar5 != cVar6)) {
    return 0;
  }
