...
undefined8 * FUN_0017b990(long *param_1)

{
  ...
  if (((param_1 != (long *)0x0) && (*(uint *)(param_1 + 1) != 0)) &&
    ...
    local_f0[1] = 0;
    local_e8 = (void *)0x0;
    FUN_0017b670(param_1,0,pvVar5,&local_e8,local_f0,local_f0 + 1);
    free(pvVar5);
    uVar37 = local_f0[0];
    if (local_f0[0] != 0) {
      ...
      do {
        ...
        if (uVar36 != 0) {
          puVar7 = __ptr;
LAB_0017ba84:
          if (*puVar7 != uVar9) goto LAB_0017ba78;
          local_b8 = (uint *)((ulong)local_b8 & 0xffffffff00000000);
          local_90 = (uint *)0x0;
          uVar31 = *(uint *)(param_1 + 1);
          uVar33 = (ulong)uVar31;
          FUN_0017b7e4(*param_1,uVar33,uVar9,uVar32,&local_90,&local_b8);
          puVar38 = local_90;
          if (local_90 != (uint *)0x0) {
            ...
            if (__ptr_00 != (byte *)0x0) {
              ...
              if (uVar31 == 0) {
                pvVar5 = malloc(0);
                uVar37 = 0;
                if (pvVar5 != (void *)0x0) goto LAB_0017bb9c;
              }
              else {
                uVar34 = 0;
                pbVar15 = __ptr_00;
...
LAB_0017bce4:
        ...
        FUN_0017b7e4(lVar27,(int)lVar11,uVar9,uVar32,__ptr + uVar33 * 0x18 + 2,
                     __ptr + uVar33 * 0x18 + 4);
LAB_0017bbc4:
        lVar29 = lVar29 + 1;
...
LAB_0017bde4:
            ...
            piVar26 = piVar23 + (long)(int)uVar31 * 0x24;
            do {
              iVar4 = *piVar26;
              if (iVar4 - 0x17U < 2 || iVar4 == 0x1a) {
                if (-1 < iVar20) goto LAB_0017bd94;
                piVar12 = (int *)0x0;
                if (iVar4 == 0x17) goto LAB_0017bf18;
                goto LAB_0017bdd8;
              }
              piVar26 = piVar26 + -0x24;
            } while (piVar26 != piVar23 + ((ulong)uVar32 - (ulong)uVar31) * 0x24 + -0x48);
            piVar26 = (int *)0x0;
            if (iVar20 < 0) goto LAB_0017bde4;
LAB_0017bd94:
            piVar12 = (int *)(*(long *)(lVar27 + 8) + (long)iVar20 * 0x90);
            do {
              if (*piVar12 - 0x17U < 2 || *piVar12 == 0x1a) goto LAB_0017bdc8;
              iVar20 = iVar20 + -1;
              piVar12 = piVar12 + -0x24;
            } while (iVar20 != -1);
            piVar12 = (int *)0x0;
LAB_0017bdc8:
            if (piVar26 == (int *)0x0) goto LAB_0017bde4;
            iVar4 = *piVar26;
            if (iVar4 == 0x17) {
              if (-1 < (int)uVar31) {
                piVar23 = *(int **)(lVar11 + 8);
                  ...
                  if (iVar4 - 0x17U < 2 || iVar4 == 0x1a) {
                    if (((iVar4 == 0x17) && (piVar26[0x12] != 0)) && (uVar37 != 0)) {
                      ...
                      do {
                        if (*(uint *)(puVar18 + 1) != 0) {
                          piVar12 = (int *)*puVar18;
                          piVar17 = piVar12 + (ulong)*(uint *)(puVar18 + 1) * 0x24;
                          do {
                            if (piVar26[6] == piVar12[2]) {
                              iVar4 = *piVar12;
                              if (((1 < iVar4 - 0xdU && iVar4 != 0x11) && (9 < iVar4 - 0xbU)) ||
                                 ((uint)piVar12[0x12] < 2)) goto LAB_0017c188;
                              uVar31 = piVar12[6];
                              piVar26 = piVar23 + (ulong)uVar32 * 0x24;
                              goto LAB_0017c000;
                            }
                            piVar12 = piVar12 + 0x24;
...
LAB_0017bdd8:
              if (piVar12 == (int *)0x0 || iVar4 != 0x18) goto LAB_0017bde4;
              uVar25 = 0;
              iVar4 = 0;
              uVar31 = 0;
              iVar20 = 0;
...
joined_r0x0017c3d4:
            uVar31 = uVar28;
            uVar32 = uVar21;
            if (sVar19 == sVar35) goto LAB_0017c448;
            puVar38 = puVar38 + 0x18;
            sVar19 = sVar19 + 1;
          } while( true );
        }
...
LAB_0017ba78:
  puVar7 = puVar7 + 0x18;
  if (puVar7 == __ptr + (ulong)uVar36 * 0x18) goto LAB_0017bce4;
  goto LAB_0017ba84;
LAB_0017c000:
...
LAB_0017c064:
    ...
    if (iVar22 != -1 && iVar20 != -1) {
      do {
        if (*(uint *)(puVar18 + 1) != 0) {
          piVar17 = (int *)*puVar18;
          piVar24 = piVar17 + (ulong)*(uint *)(puVar18 + 1) * 0x24;
          do {
            if (piVar17[2] == iVar20) {
              iVar20 = *piVar17;
              if ((1 < iVar20 - 2U) || ((uint)piVar17[0x12] < 2)) goto LAB_0017bff4;
              uVar21 = piVar17[6];
              if (uVar21 != uVar32 && piVar17[10] != uVar32) goto LAB_0017bff4;
              if (uVar21 == uVar32) {
                uVar21 = piVar17[10];
              }
              uVar28 = 0;
...
LAB_0017c0f4:
  do {
    if (*(uint *)(puVar18 + 1) != 0) {
      ...
      do {
        if (piVar17[2] == uVar21) {
          if (*piVar17 != 1) goto LAB_0017bff4;
...
LAB_0017bff4:
  ...
  if (piVar23 == piVar26) goto LAB_0017c188;
  goto LAB_0017c000;
LAB_0017c448:
  if (uVar31 != 0xffffffff) {
  ...
  uVar9 = uVar9 + 1;
  puVar7 = puVar7 + 0x18;
  if (uVar36 == uVar9) goto code_r0x0017c474;
  goto LAB_0017c3b4;
code_r0x0017c474:
