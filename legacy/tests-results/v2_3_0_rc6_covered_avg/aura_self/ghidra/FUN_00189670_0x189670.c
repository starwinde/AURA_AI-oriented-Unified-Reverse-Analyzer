...
undefined8 * FUN_00189670(long param_1)
...
LAB_00189738:
    if (((char *)*puVar30 != (char *)0x0) &&
       (iVar9 = strcmp((char *)*puVar30,".gcc_except_table"), iVar9 == 0)) goto LAB_00189760;
  }
...
LAB_00189760:
  ...
  if (puVar34 != (undefined8 *)0x0) {
    ...
    if (uVar31 == 0) {
      ...
      uVar41 = 0;
      __ptr = (long *)0x0;
      if (puVar30 == (undefined8 *)0x0) goto LAB_0018a7d0;
LAB_00189914:
      uVar40 = (uint)uVar31;
      uVar24 = 0;
      pvVar11 = (void *)0x0;
            ...
            if (((uVar31 != 0) && (uVar23 = puVar30[1], uVar23 <= uVar31)) &&
              ...
              if (uVar31 < uVar33) {
                ...
                if (*(char *)(lVar10 + uVar31) != -1) {
                  lVar14 = FUN_00189190(lVar10,uVar33,&local_70);
                ...
                if (uVar23 < uVar33) {
                  ...
                  if (*(char *)(lVar10 + uVar23) != -1) {
                    if (uVar33 <= local_70) goto LAB_0018aea8;
                  ...
                  if (local_70 < uVar33) {
                    ...
                    uVar23 = uVar31;
                    if (uVar33 <= uVar31) goto LAB_00189b28;
                    uVar23 = local_70 + 2;
...
LAB_00189c40:
                          ...
                          if (uVar18 <= uVar23) goto LAB_00189964;
                        } while (cVar21 != '\x01');
LAB_0018a880:
                        if (uVar23 < uVar33) {
                          unaff_x26 = uVar23 + 1;
...
LAB_0018b514:
                  ...
                  if (cVar21 == '\x01') goto LAB_00189de0;
                  if (cVar21 != '\x03') break;
LAB_00189ca4:
                  if (uVar33 < uVar23 + 4) {
                    uVar39 = 0;
...
LAB_00189d74:
                    ...
                    do {
                      ...
                      if (uVar18 <= uVar23) goto LAB_00189964;
                      if (cVar21 != '\x01') goto LAB_00189ca4;
LAB_00189de0:
                      uVar39 = 0;
                      if (uVar33 <= uVar23) {
LAB_0018b528:
...
LAB_0018b52c:
                      ...
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_0018b528;
                      uVar31 = local_70 + 1;
                      ...
                      local_70 = uVar23;
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_0018b52c;
                      uVar31 = local_70 + 1;
...
LAB_0018a754:
              uVar33 = uVar18 + 8;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_0018a320;
              if (uVar31 < uVar18 + 4) goto LAB_0018ae70;
...
LAB_0018a834:
                ...
                uVar18 = local_70;
                if (uVar23 <= uVar31) goto LAB_0018a754;
                break;
              }
              local_70 = uVar31 + 4;
              if (local_70 <= uVar31) {
              ...
              local_70 = uVar31;
              if (uVar31 < 0xfffffffffffffff8) goto LAB_0018a320;
LAB_0018ae70:
              uVar33 = uVar31 + 4;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_0018a320;
                ...
                if (*plVar13 == lVar10) {
                  ...
                  if (uVar40 < 0x80000) {
                    if (uVar27 <= uVar40) {
                      ...
                      if (pvVar11 != (void *)0x0) goto LAB_001898e0;
                      break;
                    }
                  }
                  else {
LAB_001898e0:
                  ...
                  *(uint *)((long)local_d8 + lVar10 + 8) = uVar26;
                  uVar15 = FUN_00189190(lVar36,uVar31,&local_70,uVar16,uVar22);
                  *(undefined8 *)(extraout_x11_00 + 0x10) = uVar15;
                  uVar15 = FUN_00189190(lVar36,uVar31,extraout_x12,extraout_w13 & 0xf,0);
                  ...
                  *(undefined8 *)(extraout_x11_01 + 0x18) = uVar15;
                  if ((cVar21 != '\0') && (local_70 < uVar31)) {
                    ...
                    if (*(char *)((long)plVar13 + 0x22) != -1 && uVar18 != 0) {
                      uVar15 = FUN_00189190(lVar36,uVar31,extraout_x12_00,
...
LAB_0018a320:
            ...
            uVar26 = uVar25;
            if (uVar41 < 0x10000) {
              if (uVar41 < uVar25) goto LAB_0018a330;
              if (uVar25 == 0) {
                sVar17 = 0x900;
                uVar26 = 0x20;
              }
              ...
              if (plVar13 != (long *)0x0) goto LAB_0018a730;
            }
            else {
LAB_0018a730:
              __ptr = plVar13;
...
LAB_0018a3a8:
                ...
                *(undefined1 *)((long)plVar13 + uVar39 + lVar10 + 0x24) = 0;
                if (uVar38 < uVar31) {
                  ...
                  if (uVar31 <= local_70) goto LAB_0018b220;
...
LAB_0018b4a4:
                  ...
                  if (uVar31 <= local_70) goto LAB_0018b224;
...
LAB_0018b380:
                  ...
                  if (1 < uVar42) {
                    do {
                      ...
                      if (cVar21 == 'P') {
                        ...
                        FUN_00189190(lVar36,uVar31,puVar29,uVar16,uVar22);
      ...
      uVar31 = (ulong)uVar40;
      if (puVar30 != (undefined8 *)0x0) goto LAB_00189914;
LAB_0018a7d0:
      pvVar11 = (void *)0x0;
      uVar24 = 0;
    }
