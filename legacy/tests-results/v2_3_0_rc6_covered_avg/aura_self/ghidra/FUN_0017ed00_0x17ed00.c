...
undefined4 * FUN_0017ed00(undefined *param_1,uint *param_2)
      ...
      *puVar4 = 0x10;
      ...
      if (uVar2 == 0) {
        ...
        if (puVar7 != (undefined4 *)0x0) {
          *puVar7 = 0xd;
          puVar7[0x26] = uVar2;
          __snprintf_chk(puVar7 + 0x27,0x40,2,0x40,&DAT_001faad0,uVar2);
        }
      }
      else {
        puVar7 = (undefined4 *)FUN_0017f300(param_1,param_2[6]);
      }
      uVar10 = (undefined1)param_2[0x22];
      uVar2 = param_2[3];
      *(undefined4 **)(puVar4 + 0x26) = puVar7;
LAB_0017edb0:
      FUN_0017e4a0(uVar2,uVar10);
    ...
    if (uVar2 < 0x16) {
      if (uVar2 == 1) {
        ...
        if (lVar13 == 0) {
          puVar4 = (undefined4 *)FUN_0017eb40(*(undefined8 *)(param_2 + 4),0,0);
          return puVar4;
        }
        goto LAB_0017f2e4;
      }
      if (uVar2 < 2) {
        if (param_2[0x12] != 0) {
          ...
          if (local_58 == *(long *)PTR___stack_chk_guard_005ffe88) {
            puVar4 = (undefined4 *)FUN_0017f300(param_1,param_2[6],0,0);
            return puVar4;
          }
          goto LAB_0017f2e4;
        }
        ...
        *puVar4 = 0xf;
        puVar4[0x2a] = uVar2;
        uVar5 = FUN_0017f300(param_1,uVar1);
        uVar2 = param_2[10];
        *(undefined8 *)(puVar4 + 0x26) = uVar5;
        uVar5 = FUN_0017f300(param_1,uVar2);
        uVar10 = (undefined1)param_2[0x22];
        uVar2 = param_2[3];
              ...
              do {
                if (((char *)*puVar8 != (char *)0x0) &&
                  ...
                  if ((((ulong)puVar8[1] <= uVar17) &&
                     ...
                     (local_60 = (long *)FUN_00173990(plVar18), local_60 != (long *)0x0)) {
    ...
    if (puVar4 != (undefined4 *)0x0) {
      *puVar4 = 0xd;
      puVar4[0x26] = uVar2;
      __snprintf_chk(puVar4 + 0x27,0x40,2,0x40,&DAT_001faad0,uVar2);
    }
  }
  goto LAB_0017eeb8;
LAB_0017f270:
  ...
  snprintf(&DAT_006007f0,0x80,"%s");
  FUN_001753a0(&local_60);
  pcVar15 = &DAT_006007f0;
LAB_0017f108:
...
LAB_0017ef64:
  ...
  if (uVar2 != 0) {
    ...
    *(void **)(puVar4 + 0x48) = pvVar6;
    ...
    puVar4[0x4b] = uVar2;
    while( true ) {
      uVar5 = FUN_0017f300(param_1,*(undefined4 *)(*(long *)(param_2 + 0x14) + lVar13 * 2));
...
LAB_0017f00c:
  FUN_0017e4a0(param_2[3],(char)param_2[0x22]);
  *(undefined8 *)(puVar4 + 3) = uStack_e8;
  *(undefined8 *)(puVar4 + 1) = local_f0;
  *(undefined8 *)(puVar4 + 7) = uStack_d8;
  *(undefined8 *)(puVar4 + 5) = uStack_e0;
