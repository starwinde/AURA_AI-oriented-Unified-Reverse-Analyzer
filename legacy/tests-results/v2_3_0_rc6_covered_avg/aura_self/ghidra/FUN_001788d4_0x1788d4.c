...
void FUN_001788d4(undefined8 *param_1,long param_2)

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    uVar6 = FUN_00176b50(*(undefined4 *)((long)param_1 + 0x14));
    __fprintf_chk(param_2,2,"  Convention:   %s\n",uVar6);
    __fprintf_chk(param_2,2,"  Variables:    %u\n\n",*(undefined4 *)(param_1 + 4));
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n","Offset",&DAT_001fb500,
                  &DAT_001fb518,&DAT_001fb510,&DAT_001fd2e8,"Source");
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n",&DAT_001fd330,&DAT_001fd320,
                  &DAT_001fd320,&DAT_001fd320,&DAT_001fd320,&DAT_001fd330);
    if (*(int *)(param_1 + 4) != 0) {
      lVar11 = 0;
      uVar10 = 0;
      do {
