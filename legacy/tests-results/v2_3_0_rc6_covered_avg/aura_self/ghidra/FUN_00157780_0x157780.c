...
long * FUN_00157780(long *param_1)
...
joined_r0x00157cac:
              iVar7 = 8;
              if (iVar25 - 1U < 7) {
                iVar7 = *(int *)(&DAT_0020c638 + (ulong)(iVar25 - 1U) * 4);
              }
            }
            else {
              if (*(int *)(lVar20 + 0x48) != 1) {
                iVar25 = *(int *)(lVar20 + 0x2c);
                goto joined_r0x00157cac;
              }
              iVar7 = 8;
              iVar25 = 4;
            }
            ...
            local_80 = 0;
            local_8c = iVar4;
            iVar6 = FUN_001573c4(*param_1,uVar24,iVar4,&local_8c,&local_80,local_88,local_88 + 1);
            iVar16 = local_88[0];
            iVar4 = local_8c;
            if (iVar6 == 1) {
...
LAB_00157ec8:
                ...
                do {
                  if (local_8c == *piVar12) {
                    FUN_001572d0(piVar12,local_80,iVar7,iVar25);
...
LAB_00157de0:
              ...
              *piVar12 = iVar4;
              ...
              if (local_88[0] != iVar7) {
                iVar25 = 4;
                if (local_88[0] - 1U < 4) {
                  iVar25 = *(int *)(&DAT_0020c658 + (ulong)(local_88[0] - 1U) * 4);
                }
              }
...
LAB_00157920:
          do {
            ...
            if (((iVar25 - 0x15U < 2) && (iVar4 = *(int *)(lVar26 + 0x48), iVar4 != 0)) &&
              ...
              local_80 = 0;
              local_8c = iVar7;
              iVar7 = FUN_001573c4(*param_1,uVar24,iVar7,&local_8c,&local_80,local_88,local_88 + 1);
...
joined_r0x00157d68:
                      uVar15 = 8;
                      if (iVar25 - 1U < 7) {
                        uVar15 = *(undefined4 *)(&DAT_0020c638 + (ulong)(iVar25 - 1U) * 4);
                      }
                    }
                    else {
                      if (iVar4 != 1) {
                        iVar25 = *(int *)(lVar26 + 0x2c);
                        goto joined_r0x00157d68;
                      }
                      uVar15 = 8;
                      iVar25 = 4;
                    }
                    FUN_001572d0(piVar10,0,uVar15,iVar25);
                    uVar18 = *(uint *)(lVar28 + 0x10);
                    uVar30 = uVar30 + 1;
                    uVar24 = *(uint *)(param_1 + 1);
                    lVar29 = lVar29 + 0x90;
                    if (uVar18 <= uVar30) goto LAB_001579f0;
                    goto LAB_00157920;
                  }
...
LAB_00157b3c:
            ...
            *(uint *)(puVar22 + 2) = uVar2;
            if (uVar24 != 1) goto LAB_00157b3c;
          }
          puVar22 = puVar22 + 0xc;
          if (puVar22 == puVar23) goto LAB_00157be8;
        }
        puVar19 = puVar22 + 0xc;
