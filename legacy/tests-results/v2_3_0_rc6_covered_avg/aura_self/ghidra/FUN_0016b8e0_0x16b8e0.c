...
void FUN_0016b8e0(long param_1,long param_2,ulong param_3,undefined8 *param_4,uint *param_5,
                 uint *param_6)
...
LAB_0016b988:
  ...
  if (param_3 <= uVar11) goto LAB_0016bbd0;
  goto LAB_0016b998;
LAB_0016ba98:
  local_170 = 0;
...
LAB_0016bb58:
    if (local_170 == *puVar6) goto LAB_0016ba8c;
  }
LAB_0016bb70:
  if (*param_6 <= uVar8) {
    uVar8 = *param_6 << 1;
    ...
    if (puVar9 == (ulong *)0x0) goto LAB_0016bbd0;
    *param_6 = uVar8;
    *param_4 = puVar9;
    uVar8 = *param_5;
  }
...
LAB_0016ba8c:
  ...
  if (pcVar13 == pcVar10) goto LAB_0016b988;
  goto LAB_0016ba98;
}
