...
void FUN_0016a570(long *param_1)
...
LAB_0016a72c:
  ...
  *in_x4 = 0;
  ...
  if ((((int)param_1[1] != 1) || (*param_1 == 0)) ||
     (local_70 = (undefined8 *)FUN_00173990(param_1), local_70 == (undefined8 *)0x0))
  goto LAB_0016a72c;
  uVar17 = *(uint *)(local_70 + 1);
  if (uVar17 == 0) {
LAB_0016a8e0:
    FUN_001753a0(&local_70);
    goto LAB_0016a72c;
  }
    ...
    if (*(uint *)(param_1 + 4) != 0) {
      ...
      do {
        if (((char *)*puVar21 != (char *)0x0) &&
          ...
          if ((plVar23 != (long *)0x0) && (uVar27 = puVar21[3], uVar27 != 0)) goto LAB_0016a778;
          break;
        }
        puVar21 = puVar21 + 7;
    ...
    if (lVar10 != 0) {
      if (lVar10 == 1) {
        if ((ulong)puVar18[3] <= uVar15) {
          FUN_00140820(2,0,0,"DT_NEEDED offset %lu out of .dynstr range (%lu)");
          goto LAB_0016a8b0;
        }
...
LAB_0016a8b0:
      ...
      if (bVar4 && !bVar3) goto code_r0x0016a8c4;
    }
