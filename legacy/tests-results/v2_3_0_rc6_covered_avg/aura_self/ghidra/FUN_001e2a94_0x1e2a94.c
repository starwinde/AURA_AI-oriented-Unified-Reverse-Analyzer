...
void FUN_001e2a94(long param_1,char *param_2)

{
  ...
  uVar5 = *(uint *)(&DAT_003eb570 + (uVar9 & 0xffffffff) * 4);
  uVar8 = *(uint *)(&DAT_003fa450 + (uVar9 & 0xffffffff) * 4);
  FUN_00190370(param_2,(uVar8 & 0x3fff) + 0x3e847f);
  uVar9 = (((ulong)uVar8 & 0xfc000) >> 0xe) - 1;
  if (0x32 < uVar9) goto switchD_001e2c60_default;
  switch(uVar9 & 0xffffffff) {
  case 0:
    FUN_001e20d0(param_1,0,param_2);
    break;
  case 1:
    pcVar11 = "word ptr ";
    *(undefined1 *)(param_1 + 0x328) = 2;
    goto LAB_001e3558;
  case 2:
    FUN_001e20d0(param_1,1,param_2);
    break;
  case 3:
    pcVar11 = "dword ptr ";
    *(undefined1 *)(param_1 + 0x328) = 4;
LAB_001e3558:
    FUN_00190370(param_2,pcVar11);
    FUN_001e1630(param_1,0,param_2);
    break;
  case 4:
    FUN_00190370(param_2,"qword ptr ");
    uVar3 = 8;
    goto LAB_001e2d80;
  case 5:
    FUN_00190370(param_2,"byte ptr ");
    uVar3 = 1;
    goto LAB_001e2d80;
  case 6:
    iVar7 = FUN_0018ffb0(param_1);
    if ((iVar7 == 0x39b) || (iVar7 == 0x3b2)) {
      ...
      FUN_00190370(param_2,"dword ptr ");
      *(undefined1 *)(param_1 + 0x328) = 4;
    }
    FUN_001e1630(param_1,0,param_2);
    break;
  case 7:
    if ((*(char *)(param_1 + 6) == '\x10') &&
       ((iVar7 = FUN_0018ffb0(param_1), iVar7 == 0x2c9 || (iVar7 == 0x68b)))) {
      FUN_00190370(param_2,"xmmword ptr ");
      uVar3 = 0x10;
    }
    else {
      uVar3 = 8;
  ...
  case 9:
    ...
    FUN_001e20d0(param_1,5,param_2);
    goto switchD_001e2c60_default;
  case 10:
    uVar10 = FUN_0018ffd0(param_1,0);
    uVar9 = FUN_00190030();
    if ((uVar9 & 1) != 0) {
      lVar12 = FUN_001900a0(uVar10);
      uVar9 = (ulong)*(ushort *)(*(long *)(param_1 + 0x310) + 0x10) + lVar12 +
              *(long *)(param_1 + 0x318);
      cVar4 = FUN_001e6b30(*(undefined4 *)(param_1 + 8),0);
      uVar1 = uVar9 & 0xffffffff;
      if (*(int *)(*(long *)(param_1 + 800) + 4) == 8) {
        uVar1 = uVar9;
      }
      FUN_001e1080(*(undefined1 *)(param_1 + 6),*(long *)(param_1 + 800),param_2,uVar1,1);
      ...
      if (*(int *)(lVar12 + 0x60) != 0) {
        ...
        *(ulong *)(lVar17 + (ulong)bVar2 * 0x30 + 0xb0) = uVar1;
        ...
        pcVar11 = (char *)FUN_001e68d4(lVar12,uVar6,
...
LAB_001e37d0:
  ...
  case 0x10:
    pcVar11 = "word ptr ";
    FUN_00190370(param_2,"word ptr ");
    uVar3 = 2;
LAB_001e32a0:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    FUN_001e2620(param_1,1,param_2);
    FUN_00190370(param_2,", ");
    FUN_00190370(param_2,pcVar11);
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    FUN_001e2880(param_1,param_2);
    goto switchD_001e2c60_default;
  case 0x11:
    FUN_001e1b20(param_1,0,param_2);
    goto switchD_001e2c60_default;
  case 0x12:
    iVar7 = FUN_0018ffb0(param_1);
    if (1 < iVar7 - 0x388U) {
      FUN_00190370(param_2,"xword ptr ");
    }
    *(undefined1 *)(param_1 + 0x328) = 10;
    FUN_001e1630(param_1,0,param_2);
    goto switchD_001e2c60_default;
  case 0x13:
    FUN_001e1ec0(param_1,0,param_2);
    break;
  case 0x14:
    FUN_00190370(param_2,"byte ptr ");
...
LAB_001e33fc:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    FUN_001e2620(param_1,0,param_2);
    goto switchD_001e2c60_default;
  case 0x1b:
    FUN_00190370(param_2,"word ptr ");
    *(undefined1 *)(param_1 + 0x328) = 2;
    FUN_001e1360(param_1,param_2);
    break;
  case 0x1c:
    FUN_00190370(param_2,"dword ptr ");
    *(undefined1 *)(param_1 + 0x328) = 4;
  ...
  case 0x23:
  case 0x25:
    FUN_00190370(param_2,"ymmword ptr ");
    uVar3 = 0x20;
    goto LAB_001e2d80;
  case 0x24:
  case 0x26:
    FUN_00190370(param_2,"zmmword ptr ");
    uVar3 = 0x40;
LAB_001e2d80:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    FUN_001e1630(param_1,0,param_2);
...
LAB_001e3130:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    FUN_001e1630(param_1,1,param_2);
    FUN_00190370(param_2,&DAT_001fde30);
    FUN_001e20d0(param_1,6,param_2);
    FUN_00190370(param_2,&DAT_001fe630);
    FUN_001e20d0(param_1,7,param_2);
    goto switchD_001e2c60_default;
  case 0x2d:
    *(undefined1 *)(param_1 + 0x328) = 2;
    FUN_00190370(param_2,"word ptr ");
    goto LAB_001e30d4;
  case 0x2e:
    FUN_001e20d0(param_1,2,param_2);
    FUN_00190370(param_2,", ");
    FUN_001e20d0(param_1,3,param_2);
    goto switchD_001e2c60_default;
  case 0x2f:
    *(undefined1 *)(param_1 + 0x328) = 4;
    FUN_00190370(param_2,"dword ptr ");
  ...
  case 0x31:
    ...
    *(undefined1 *)(param_1 + 0x328) = 1;
LAB_001e30d4:
    FUN_001e1630(param_1,2,param_2);
    FUN_00190370(param_2,", ");
    FUN_001e20d0(param_1,1,param_2);
    goto switchD_001e2c60_default;
  case 0x32:
  ...
  case 1:
    ...
    goto switchD_001e2c60_default;
  case 2:
    puVar15 = &DAT_001fde60;
    break;
  case 3:
    puVar15 = &DAT_001fde68;
    break;
  case 4:
    puVar15 = &DAT_001fde70;
    break;
  case 5:
    puVar15 = &DAT_001fde78;
    break;
  case 6:
    ...
    goto switchD_001e2c60_default;
  case 7:
    FUN_00190370(param_2,&DAT_002039e0);
    FUN_001e66e4(param_1,0x12);
    goto switchD_001e2c60_default;
  case 8:
    FUN_00190370(param_2,&DAT_002039e8);
  ...
  case 10:
    ...
    goto switchD_001e2c60_default;
  case 0xb:
    FUN_00190370(param_2,&DAT_00203a00);
    FUN_001e66e4(param_1,2);
    goto switchD_001e2c60_default;
  case 0xc:
    goto switchD_001e2dc0_caseD_c;
  case 0xd:
    FUN_00190370(param_2,&DAT_00203a10);
    FUN_001e6740(param_1,1);
    goto switchD_001e2c60_default;
  case 0xe:
    FUN_00190370(param_2,&DAT_001fde30);
    goto LAB_001e2e48;
  case 0xf:
    ...
    goto LAB_001e2e48;
  case 0x10:
    puVar15 = &DAT_001fdf20;
    break;
  case 0x11:
    puVar15 = &DAT_001fdf28;
    break;
  case 0x12:
    puVar15 = &DAT_001fdf30;
    break;
  case 0x13:
    puVar15 = &DAT_001fdf38;
    break;
  case 0x14:
...
LAB_001e3dc4:
  ...
  case 0x12:
    ...
    break;
  case 0x14:
    FUN_001e1ec0(param_1,2,param_2);
    break;
  case 0x15:
    FUN_001e20d0(param_1,0,param_2);
    goto switchD_001e2c60_default;
  case 0x16:
    FUN_001e1b20(param_1,1,param_2);
    goto switchD_001e2c60_default;
  case 0x17:
  case 0x20:
    FUN_00190370(param_2,"zmmword ptr ");
...
LAB_001e3f88:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    FUN_001e1630(param_1,3,param_2);
    FUN_00190370(param_2,", ");
    FUN_001e20d0(param_1,8,param_2);
    goto switchD_001e2c60_default;
  default:
...
switchD_001e2dc0_caseD_c:
    FUN_00190370(param_2,&DAT_00203a08);
    FUN_001e66e4(param_1,10);
    break;
  case 7:
    FUN_00190370(param_2,&DAT_001fe630);
    goto LAB_001e3908;
  ...
  case 0x19:
    ...
    uVar10 = 4;
LAB_001e39e0:
    FUN_001e68a4(param_1,uVar10);
    FUN_001e1ec0(param_1,6,param_2);
    break;
  case 0x1a:
    FUN_00190370(param_2,"xmmword ptr ");
    uVar3 = 0x10;
...
LAB_001e3b64:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    FUN_001e1630(param_1,4,param_2);
    break;
  case 0x21:
    *(undefined1 *)(param_1 + 0x328) = 4;
    FUN_00190370(param_2,"dword ptr ");
...
switchD_001e4194_default:
    ...
    case 6:
      FUN_001e1ec0(param_1,3,param_2);
      break;
    case 7:
    case 0x14:
      FUN_00190370(param_2,"xmmword ptr ");
...
LAB_001e4570:
    ...
    case 0x10:
      ...
      goto LAB_001e4784;
    case 1:
      FUN_001e1d34(param_1,4,param_2);
      break;
    case 2:
      FUN_001e1d34(param_1,3,param_2);
      break;
    case 3:
    case 0x11:
      FUN_00190370(param_2,"xmmword ptr ");
      ...
      goto LAB_001e464c;
    case 4:
      FUN_001e20d0(param_1,4,param_2);
      break;
    case 5:
      FUN_001e20d0(param_1,3,param_2);
      break;
    ...
    case 10:
      ...
      goto switchD_001e2c60_default;
    case 0xb:
      FUN_001e1dd4(param_1,4,param_2);
      break;
    case 0xc:
      FUN_001e1dd4(param_1,3,param_2);
      break;
    case 0xd:
switchD_001e4194_caseD_5:
      FUN_001e1ec0(param_1,7,param_2);
      goto switchD_001e2c60_default;
    case 0xe:
      *(undefined1 *)(param_1 + 0x328) = 4;
      FUN_00190370(param_2,"dword ptr ");
...
switchD_001e4634_caseD_1b:
        FUN_001e1ec0(param_1,8,param_2);
      }
...
switchD_001e4634_caseD_1a:
          ...
          FUN_001e1ec0(param_1,9,param_2);
        }
        else {
LAB_001e4ac8:
...
switchD_001e3cbc_caseD_1c:
        FUN_001e1ec0(param_1,5,param_2);
      }
      else {
        if (uVar8 != 5) goto LAB_001e4ac8;
switchD_001e4634_default:
        FUN_001e1ec0(param_1,4,param_2);
      }
      break;
    case 10:
...
switchD_001e2c60_default:
  ...
  uVar5 = FUN_001e5b80(uVar10,local_58);
  local_60 = uVar5;
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
    ...
    if (uVar5 == 0) {
      uVar10 = FUN_0018ffb0(param_1);
      uVar9 = FUN_001e5cb4(uVar10,&local_60,local_58,&uStack_5c,local_54);
      if ((uVar9 & 1) == 0) {
    ...
    uVar6 = FUN_0018ffb0(param_1);
    pcVar11 = (char *)FUN_001e68d4(lVar17,uVar6,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98)
    ;
    if (pcVar11 == (char *)0x0) {
      uVar13 = 0;
      uVar3 = 0;
