...
undefined8 FUN_001afcf0(byte *param_1,long param_2,uint param_3)
...
LAB_001afd70:
      ...
      param_1 = pbVar10 + 3;
      uVar7 = FUN_001af874(lVar6,*(undefined8 *)(param_2 + 800));
      if ((uVar7 & 1) == 0) {
        bVar2 = pbVar10[2];
        bVar3 = pbVar10[1];
        pbVar10 = extraout_x8;
...
LAB_001afd20:
    ...
    if (bVar2 < 4 || bVar5) {
      if (bVar2 == 2) {
        ...
        if (uVar1 >> (ulong)(pbVar10[1] & 0x1f) != (uint)lVar6) {
      ...
      if (bVar2 == 6) {
        ...
        FUN_0018ff90(param_2,lVar6);
        uVar8 = FUN_001a5484(uVar17,uVar16 & 0xffffffff,param_3,param_2);
        return uVar8;
      }
      if (bVar2 != 7) {
        if (bVar2 != 5) {
        ...
        FUN_0018ff00(param_2);
        FUN_0018ff90(param_2,uVar16 & 0xffffffff);
        uVar8 = FUN_001a5484(uVar17,uVar9 & 0xffffffff,param_3,param_2);
        return uVar8;
      }
      uVar9 = 0;
      lVar6 = 0;
      ...
      if ((((uint)lVar6 ^ (uint)lVar13) & param_3) != (uint)lVar13) {
        uVar17 = 1;
      }
    }
  } while( true );
  ...
  uVar16 = (ulong)(uVar1 >> (ulong)(pbVar10[1] & 0x1f));
  bVar2 = *param_1;
  bVar5 = false;
  pbVar10 = param_1;
  if (bVar2 == 4) goto LAB_001afd70;
  goto LAB_001afd20;
}
