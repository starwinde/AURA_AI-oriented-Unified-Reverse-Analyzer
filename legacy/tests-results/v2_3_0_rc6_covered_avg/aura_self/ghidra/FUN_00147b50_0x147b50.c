...
long * FUN_00147b50(ulong *param_1,ulong param_2,long param_3)
        ...
        if (uVar6 != 0) {
          if (uVar26 < param_2) {
            ...
            if (sVar23 != 0) {
              uVar16 = 0;
              do {
                if (uVar29 == __ptr[uVar16]) goto LAB_00147c0c;
                uVar16 = uVar16 + 1;
              } while (uVar16 != sVar23);
            }
            if (uVar24 <= sVar23) {
              ...
              if (__ptr_01 == (ulong *)0x0) goto LAB_0014805c;
            }
          ...
          if (uVar6 < 9) {
            if (uVar6 < 7) {
              if ((uVar6 == 4) || ((uVar6 & 0xfffffffb) == 2)) {
                iVar7 = FUN_00147930(puVar14,&local_70);
LAB_00147f90:
                uVar24 = local_70;
                if (iVar7 != 0) {
                  if (sVar23 != 0) {
                    uVar29 = 0;
                    do {
                      if (local_70 == __ptr_01[uVar29]) goto LAB_00147c30;
                      uVar29 = uVar29 + 1;
                    } while (uVar29 != sVar23);
                  }
                  puVar12 = __ptr_01;
                  ...
                  if (uVar17 <= sVar23) {
                    ...
                    __ptr = __ptr_01;
                    if (puVar12 == (ulong *)0x0) goto LAB_0014805c;
                  }
              ...
              if (pcVar13 != (char *)0x0) {
                iVar7 = FUN_00147930(pcVar13 + 1,&local_70);
                goto LAB_00147f90;
              }
            }
          }
...
LAB_00147c30:
      ...
      qsort(__ptr_01,sVar23,8,FUN_00147710);
      if (sVar23 == 0) {
        uVar26 = 0;
      }
      else {
...
LAB_00147eac:
            ...
            if (iVar7 - 4U < 2) {
              if (((iVar7 == 4) && (iVar7 = FUN_00147930(lVar22 + 0x60,&local_70), iVar7 != 0)) &&
                 (*(uint *)(__ptr_00 + 1) != 0)) {
                uVar26 = 0;
                do {
                  if (local_70 == *(ulong *)(*__ptr_00 + uVar26 * 0x20)) {
                    ...
                    pvVar10 = (void *)__ptr_00[2];
                    uVar4 = uVar20;
                    if (uVar6 < uVar21) goto LAB_00147f4c;
                    goto LAB_0014828c;
                  }
                  uVar26 = uVar26 + 1;
...
LAB_0014828c:
                ...
                if (pvVar10 == (void *)0x0) {
                  pvVar10 = (void *)*__ptr_00;
                  if (pvVar10 == (void *)0x0) goto LAB_00148460;
                  lVar15 = 0;
                  if ((int)__ptr_00[1] != 0) {
                    do {
                      lVar22 = lVar15 * 0x20;
...
LAB_001481d0:
              iVar7 = FUN_00147930(pcVar13,&local_70);
              uVar6 = *(uint *)(__ptr_00 + 1);
              if (iVar7 == 0) goto LAB_001483a4;
              if (uVar6 != 0) {
                uVar26 = 0;
                do {
                  if (local_70 == *(ulong *)(*__ptr_00 + uVar26 * 0x20)) {
