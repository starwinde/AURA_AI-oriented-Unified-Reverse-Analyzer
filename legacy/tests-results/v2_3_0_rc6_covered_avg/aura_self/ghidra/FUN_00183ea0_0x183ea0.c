...
size_t FUN_00183ea0(undefined4 *param_1,FILE *param_2,int param_3)

{
  ...
  case 0:
    ...
    if (param_1[0x28] == 0) {
      ...
      do {
        FUN_00183ea0(*(undefined8 *)(*(long *)(param_1 + 0x26) + lVar13 * 8),param_2,param_3);
        piVar7 = *(int **)(*(long *)(param_1 + 0x26) + lVar13 * 8);
        if (((piVar7 != (int *)0x0) && (*piVar7 == 0xc)) &&
           (sVar12 = FUN_001679d0(piVar7 + 0x26), (int)sVar12 == 1)) {
          return sVar12;
        }
  ...
  case 1:
    ...
    if (param_3 < 1) {
      ...
      FUN_00183ea0(*(undefined8 *)(param_1 + 0x28),param_2,iVar5);
      if (*(long *)(param_1 + 0x2a) != 0) goto LAB_001844f8;
    }
    else {
      do {
        iVar15 = iVar14;
...
LAB_001844f8:
        fwrite("} else {\n",1,9,param_2);
        FUN_00183ea0(*(undefined8 *)(param_1 + 0x2a),param_2,iVar5);
        if (param_3 < 1) goto LAB_0018455c;
      }
      iVar5 = 0;
      do {
        iVar5 = iVar5 + 1;
  ...
  case 2:
    ...
    if (param_3 < 1) {
      ...
      FUN_001831e0(*(undefined8 *)(param_1 + 0x26),param_2,0);
      fwrite(&DAT_001fabe0,1,4,param_2);
      FUN_00183ea0(*(undefined8 *)(param_1 + 0x28),param_2,param_3 + 1);
    }
    else {
      do {
        iVar14 = iVar5;
  ...
  case 4:
    ...
    fwrite(&DAT_001fabe0,1,4,param_2);
    FUN_00183ea0(*(undefined8 *)(param_1 + 0x2c),param_2,param_3 + 1);
    if (0 < param_3) {
      iVar5 = 0;
      do {
        iVar5 = iVar5 + 1;
  ...
  case 5:
    ...
    if (param_3 < 1) {
      ...
      FUN_001831e0(*(undefined8 *)(param_1 + 0x26),param_2,0);
      fwrite(&DAT_001fabe0,1,4,param_2);
      if (param_1[0x2a] != 0) goto LAB_001841e8;
    }
    else {
      do {
        iVar5 = iVar5 + 1;
...
LAB_001841e8:
        ...
        do {
          ...
          iVar5 = 0;
          FUN_00183ea0(puVar2[2],param_2,param_3 + 1);
          if (-1 < param_3) {
            do {
              iVar5 = iVar5 + 1;
              fwrite(&DAT_001fcb60,1,4,param_2);
...
LAB_001840c0:
  ...
  case 0xc:
    ...
    iVar5 = FUN_001679d0(param_1 + 0x26);
    if (iVar5 == 1) {
