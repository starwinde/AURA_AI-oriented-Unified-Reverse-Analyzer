...
undefined8 FUN_001519c4(char *param_1,uint *param_2,undefined4 *param_3)
...
LAB_00151a7c:
  ...
  if ((*param_1 == 's') && (param_1[1] == 'p')) {
    uVar3 = 0x1f;
    uVar6 = 4;
    if (param_1[2] == '\0') goto LAB_00151a7c;
  }
  if (cVar1 == 'x') {
    ...
    uVar3 = (uint)lVar5;
    if (uVar3 < 0x1f) goto LAB_00151a78;
    cVar1 = *param_1;
  }
  if ((cVar1 == 'w') && (ppuVar4 = __ctype_b_loc(), ((*ppuVar4)[(byte)param_1[1]] >> 0xb & 1) != 0))
  {
    ...
    uVar6 = 3;
    uVar3 = (uint)lVar5;
    if (uVar3 < 0x1f) goto LAB_00151a7c;
  }
  return 0;
}
