...
LAB_0017a744:
  ...
  piVar8 = (int *)*puVar12;
  piVar11 = piVar8 + (ulong)*(uint *)(puVar12 + 1) * 0x24;
LAB_0017a6b8:
  if (piVar8[0x12] == 2) {
    if (*piVar8 == 3) {
    ...
    if (*(uint *)(puVar10 + 1) != 0) {
      ...
      do {
        if (piVar8[10] == piVar6[2]) {
          if (((*piVar6 != 3) || (piVar6[0x12] != 2)) || (piVar6[6] == -1)) goto LAB_0017a738;
          uVar13 = 0;
          puVar10 = puVar1;
          goto LAB_0017a82c;
        }
...
LAB_0017a82c:
  do {
    if (*(uint *)(puVar10 + 1) != 0) {
      piVar7 = (int *)*puVar10;
      piVar9 = piVar7 + (ulong)*(uint *)(puVar10 + 1) * 0x24;
      do {
    ...
    if (*(uint *)(puVar10 + 1) != 0) {
      ...
      do {
        if (piVar8[6] == piVar6[2]) {
          if (((*piVar6 != 8) || (piVar6[0x12] != 2)) || (piVar6[10] == -1)) goto LAB_0017a738;
          uVar13 = 0;
          puVar10 = puVar1;
          goto LAB_0017a910;
        }
...
LAB_0017a738:
  piVar8 = piVar8 + 0x24;
  if (piVar8 == piVar11) goto LAB_0017a744;
  goto LAB_0017a6b8;
}
