...
void FUN_001bde04(long param_1,void *param_2,undefined1 *param_3,void *param_4,undefined1 *param_5)
  ...
  if (bVar2 != 0) {
    ...
    do {
      if (*piVar4 == 1) {
        ...
        if ((bVar2 & 1) != 0) {
          uVar3 = FUN_001908d0(param_2,uVar6,piVar4[1]);
          if ((uVar3 & 1) == 0) {
            lVar1 = uVar6 * 2;
            bVar2 = *(byte *)((long)piVar4 + 0x1d);
        ...
        if (((bVar2 >> 1 & 1) != 0) &&
           (uVar3 = FUN_001908d0(param_4,uVar7,piVar4[1]), (uVar3 & 1) == 0)) {
          lVar1 = uVar7 * 2;
...
LAB_001bdeb0:
        ...
        if ((piVar4[1] != 0) && (uVar3 = FUN_001908d0(param_2,uVar6), (uVar3 & 1) == 0)) {
          lVar1 = uVar6 * 2;
          uVar6 = (ulong)((int)uVar6 + 1U & 0xff);
          *(short *)((long)param_2 + lVar1) = (short)piVar4[1];
        }
        if ((piVar4[2] != 0) && (uVar3 = FUN_001908d0(param_2,uVar6), (uVar3 & 1) == 0)) {
          lVar1 = uVar6 * 2;
          uVar6 = (ulong)((int)uVar6 + 1U & 0xff);
