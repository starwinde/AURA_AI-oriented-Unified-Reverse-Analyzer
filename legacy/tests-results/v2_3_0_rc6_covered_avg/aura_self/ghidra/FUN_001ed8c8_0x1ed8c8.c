...
undefined4 FUN_001ed8c8(int *param_1,undefined8 *param_2)

{
  ...
  *param_2 = param_1;
  ...
  bVar2 = FUN_001f25f0(param_1[2],&local_28);
  ...
  uVar3 = FUN_001e7d88(param_1[8]);
  uVar4 = FUN_001e7dd8(param_1[9]);
  sVar6 = FUN_001ed3cc(param_1);
  uVar8 = FUN_001ed6fc(param_1);
  if (uVar8 == 0) {
    uVar10 = 0x8020000d;
  }
  else {
    for (local_3b = 0; local_3b < bVar2; local_3b = local_3b + 1) {
      if (sVar6 == *(short *)((long)local_28 + 2)) {
        local_20 = 0;
        FUN_001f2c14(*(byte *)((long)local_28 + 6) & 7,*(undefined2 *)local_28,&local_20);
        if ((((uint)((ulong)*local_28 >> 0x37) & 7 & uVar7) != 0) &&
           (uVar9 = FUN_001e7ce8(*(byte *)((long)local_28 + 6) & 7), (uVar9 & uVar8) != 0)) {
          if (*param_1 == 5) {
...
LAB_001edb18:
              if ((((!bVar1) || ((*(byte *)(local_20 + 5) & 0x40) == 0)) &&
                ...
                *(undefined1 *)((long)param_2 + 0x35) = 0;
                if ((((*(byte *)(local_20 + 4) & 0xe) == 2) || (*(char *)(param_2 + 5) != '\b')) &&
                   ((cVar5 = FUN_001ed104(param_2), cVar5 != '\0' &&
                    (cVar5 = FUN_001ecd04(param_2,param_1), cVar5 != '\0')))) {
                  cVar5 = FUN_001ed45c(param_2);
                  if (cVar5 != '\0') {
                    if ((undefined8 *)param_2[1] == local_28) goto LAB_001ee0d0;
                    local_3b = local_3b + 1;
                  ...
                  if (*(char *)((long)param_2 + 0x29) == '\0') {
                    ...
                    /* WARNING: Subroutine does not return */
                      __assert_fail("definition->address_sizes & (match->easz >> 4)",
                           ...
                           (uint)(*(byte *)((long)param_2 + 0x29) >> 4)) == 0) goto LAB_001ee0d0;
                  if (uVar7 == 4) {
                    ...
                    /* WARNING: Subroutine does not return */
                      ...
                      else if (*(char *)(param_2 + 5) == ' ') goto LAB_001ee0d0;
                    }
          ...
          else if ((*param_1 == 0) || ((*(byte *)((long)local_28 + 6) & 7) != 5)) goto LAB_001edb18;
        }
      }
LAB_001ee0d0:
