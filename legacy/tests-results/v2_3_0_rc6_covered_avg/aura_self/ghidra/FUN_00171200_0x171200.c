...
long * FUN_00171200(long param_1,long param_2,ulong param_3,ulong param_4,long param_5,ulong param_6
                   )

{
  ...
  if (((param_1 == 0 || param_2 == 0) || ((param_3 == 0 || param_5 == 0) || param_6 == 0)) ||
     (__ptr = calloc(1,0x10), __ptr == (long *)0x0)) goto LAB_0017179c;
      ...
      *__ptr_01 = (long)pvVar12;
      if (pvVar12 != (void *)0x0) {
        ...
        do {
          lVar19 = uVar26 * 0x10;
          uVar26 = uVar26 + 1;
          FUN_00171110(__ptr_01,*(undefined8 *)(param_5 + lVar19));
...
LAB_00171358:
        ...
        *(uint *)(__ptr_01 + 1) = uVar29;
        if (uVar1 != 0) {
          uVar13 = 0;
          do {
            if (uVar26 == __ptr_03[uVar13]) goto LAB_00171358;
            uVar13 = uVar13 + 1;
          } while (uVar13 != uVar1);
        }
        ...
        if (uVar7 <= uVar1) {
          ...
          if (puVar17 == (ulonglong *)0x0) goto LAB_00171358;
          *__ptr_00 = puVar17;
        ...
        *(int *)(__ptr_00 + 1) = iVar22;
        ...
        if ((param_4 <= uVar26) && (uVar13 = param_3 + param_4, uVar26 < uVar13)) {
          ...
          if (pvVar10 != (void *)0x0) {
            uVar7 = FUN_001447f0(param_1,param_2 + (uVar26 - param_4),uVar30,uVar26,pvVar10,__nmemb)
            ;
            if (0 < (int)uVar7) {
                ...
                if (((iVar8 == 0) && (*__s != '\0')) &&
                  ...
                  if (((local_70 != __s) && (param_4 <= uVar18)) && (uVar18 < uVar13)) {
                    if (iVar22 != 0) {
                      puVar16 = puVar17;
                      do {
                        if (*puVar16 == uVar18) goto LAB_00171534;
                        puVar16 = puVar16 + 1;
                      } while (puVar17 + (ulong)uVar1 + 1 != puVar16);
                    }
                    FUN_00171110(__ptr_01,uVar18);
                  }
                }
LAB_00171534:
                if (((__s[-0x40] == 'j') && (iVar8 = strcmp(pcVar28,"jmp"), iVar8 != 0)) &&
                  ...
                  if ((local_70 != __s) && (param_4 <= uVar18 && uVar18 < uVar13)) {
                    if (*(uint *)(__ptr_00 + 1) != 0) {
                      ...
                      do {
                        if (*puVar23 == uVar18) goto LAB_00171568;
                        puVar23 = puVar23 + 1;
...
LAB_001717d0:
                  ...
                  goto LAB_00171594;
                  if (iVar22 == 0) goto LAB_00171c5c;
                  puVar16 = puVar17;
                  goto LAB_0017184c;
                }
                if (iVar9 == 0) goto LAB_001717d0;
                __s = __s + 0xe0;
                uVar29 = uVar27;
              } while (uVar7 != uVar27);
              goto LAB_00171690;
...
LAB_0017184c:
    if (*puVar16 == uVar18) goto LAB_00171594;
  }
LAB_00171c5c:
  FUN_00171110(__ptr_01);
LAB_00171594:
...
LAB_00171aa0:
              ...
              if ((uVar30 < uVar13 && param_4 <= uVar30) && local_70 != __nptr) {
                ...
                if (pcVar28 == (char *)0x0 || !bVar5) goto LAB_00171b98;
                goto LAB_00171b00;
              }
            }
            cVar6 = pcVar14[2];
            ...
            if (uVar15 <= param_3) {
              do {
                ...
                if (uVar21 < uVar13 && param_4 <= uVar21) {
                  ...
                  if (iVar22 != 0) {
                    do {
                      if (uVar21 == *puVar16) goto LAB_00171bf0;
                      puVar16 = puVar16 + 1;
                    } while (puVar17 + (ulong)uVar1 + 1 != puVar16);
                  }
                  FUN_00171110(__ptr_01);
...
LAB_00171690:
  ...
  if (__ptr_02 != (ulong *)0x0) {
    ...
    *(uint *)(__ptr_02 + 2) = uVar27;
    ...
    if (pvVar11 != (void *)0x0) goto code_r0x001716c4;
    free(__ptr_02);
  }
  free(pvVar10);
  uVar29 = *(uint *)(__ptr_01 + 1);
  ...
  *puVar24 = *__ptr_02;
  ...
  do {
    while ((uVar26 != *(ulong *)(pbVar20 + -9) ||
      ...
      if (param_6 <= uVar13) goto LAB_00171764;
    }
    iVar22 = (int)uVar13;
    uVar13 = uVar13 + 1;
    pbVar20 = pbVar20 + 0x10;
