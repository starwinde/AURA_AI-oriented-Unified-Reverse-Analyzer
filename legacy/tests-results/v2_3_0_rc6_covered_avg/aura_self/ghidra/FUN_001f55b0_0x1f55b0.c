...
void * FUN_001f55b0(undefined8 param_1)

{
  ...
  local_78 = (void *)(*(code *)PTR_malloc_00600598)
                               (0x100,PTR___stack_chk_guard_005ffe88,PTR_malloc_00600598,0);
  uStack_70 = 0x100;
  local_58 = CONCAT44(1,(undefined4)local_58);
  puStack_50 = PTR_malloc_00600598;
  puStack_48 = PTR_free_006005a0;
  local_40 = PTR_realloc_006005a8;
  if (local_78 != (void *)0x0) {
    iVar2 = FUN_001f34d4(param_1,&local_78);
    lVar1 = local_68;
    pvVar4 = local_78;
    if (iVar2 != 0) {
      if (local_78 != (void *)0x0) {
      ...
      if (PTR_realloc_006005a8 == (undefined *)0x0) {
        pvVar4 = (void *)(*(code *)PTR_malloc_00600598)(local_68 + 1);
        if (pvVar4 != (void *)0x0) {
          sVar3 = local_68 + 1U;
        ...
        if (pvVar4 != (void *)0x0) goto LAB_001f5670;
      }
    }
    if (local_78 != (void *)0x0) {
