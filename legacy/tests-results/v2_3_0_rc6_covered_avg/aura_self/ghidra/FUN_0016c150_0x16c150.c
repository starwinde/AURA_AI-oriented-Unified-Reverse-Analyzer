...
void FUN_0016c150(long *param_1)
...
LAB_0016c348:
            ...
            if (iVar3 == 2) {
              ...
              for (uVar12 = uVar15 + 6; uVar12 <= uVar2; uVar12 = uVar12 + 1) {
                if ((*(int *)((long)plVar1 + (uVar12 - 5)) == 0x4f452525) &&
                   (*(char *)((long)plVar1 + (uVar12 - 1)) == 'F')) goto joined_r0x0016c490;
              }
            }
            else {
              uVar12 = uVar15;
          ...
          if (((uVar15 <= uVar2) && ((short)*plVar16 == -0x2701)) &&
             (lVar9 = 1, *(char *)((long)plVar16 + 2) == -1)) goto LAB_0016c348;
          if (uVar15 + 3 <= uVar2) {
            if ((int)*plVar16 == 0x38464947) {
              lVar9 = 2;
              if (*(short *)((long)plVar16 + 4) == 0x6137) goto LAB_0016c348;
              iVar3 = (int)*plVar16;
            }
            else {
              iVar3 = (int)*plVar16;
          ...
          if (uVar17 <= uVar2) {
            ...
            if (iVar3 == 0x46445025) {
              ...
              if (iVar3 != 0x5367674f) goto LAB_0016c2c4;
              lVar9 = 8;
            }
            goto LAB_0016c348;
          }
LAB_0016c2c4:
          if (uVar15 - 1 <= uVar2) {
            if ((short)*plVar16 == 0x4d42) {
              ...
              lVar9 = 10;
              if ((short)*plVar16 != 0x5a4d) goto LAB_0016c2f0;
            }
            goto LAB_0016c348;
          }
          goto LAB_0016c2f0;
      ...
      if (in_x5 != (undefined8 *)0x0) {
        pcVar13 = malloc(0x40);
        *in_x5 = pcVar13;
        uVar8 = s_embedded_media__allocation_faile_001fbde8._24_8_;
        uVar7 = s_embedded_media__allocation_faile_001fbde8._16_8_;
        uVar6 = s_embedded_media__allocation_faile_001fbde8._8_8_;
        uVar10 = s_embedded_media__allocation_faile_001fbde8._0_8_;
        if (pcVar13 != (char *)0x0) {
          *(undefined2 *)(pcVar13 + 0x20) = s_embedded_media__allocation_faile_001fbde8._32_2_;
...
LAB_0016c2f0:
  ...
  uVar17 = uVar17 + 1;
  uVar15 = uVar15 + 1;
  if (uVar2 <= uVar12) goto LAB_0016c3e0;
  goto LAB_0016c308;
LAB_0016c3e0:
  if ((int)__ptr[1] != 0) {
    if (in_x4 != (undefined8 *)0x0) {
