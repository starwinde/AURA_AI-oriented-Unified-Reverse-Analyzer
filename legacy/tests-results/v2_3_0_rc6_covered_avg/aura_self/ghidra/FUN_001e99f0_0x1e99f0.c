...
bool FUN_001e99f0(long *param_1,long param_2,ushort *param_3)

{
  ...
  puVar6 = (ushort *)FUN_001f2f18(param_3);
  iVar5 = FUN_001f2768(*(undefined4 *)(param_2 + 4));
  uVar4 = FUN_001f2b94(*(undefined4 *)*param_1,iVar5);
  if (uVar4 == 0) {
    return false;
  }
  local_18 = false;
  ...
  case 1:
    ...
    if (bVar2 == 2) {
      ...
      uVar1 = *puVar6;
      cVar3 = FUN_001f2720(*(undefined4 *)(param_2 + 4));
      if ((uVar1 >> 8 & 0x3f) != (int)cVar3) {
        return false;
      }
      cVar3 = FUN_001e8798(param_1,uVar4);
      if (cVar3 == '\0') {
        return false;
      }
    }
...
LAB_001e9c0c:
      ...
      if (((byte)*puVar6 & 7) == 0) {
        ...
        cVar3 = FUN_001e86f4(param_1,uVar4);
        if (cVar3 == '\0') {
          return false;
        }
      }
  ...
  case 4:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),1);
    if (cVar3 == '\0') {
      return false;
    }
    cVar3 = FUN_001e8ad8(param_1,*(undefined4 *)(param_2 + 4),0);
    if (cVar3 == '\0') {
      return false;
    }
    break;
  case 5:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),2);
    if (cVar3 == '\0') {
      return false;
    }
    break;
  case 6:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),3);
    if (cVar3 == '\0') {
      return false;
    }
    break;
  case 7:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),4);
    if (cVar3 == '\0') {
      return false;
    }
    break;
  case 8:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),iVar5);
    if (cVar3 == '\0') {
      return false;
    }
    cVar3 = FUN_001e8ad8(param_1,*(undefined4 *)(param_2 + 4),0);
  ...
  case 0xe:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),7);
    if (cVar3 == '\0') {
      return false;
    }
  ...
  case 0xf:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),8);
    if (cVar3 == '\0') {
      return false;
    }
    local_18 = (*puVar6 & 0x3f) == 5;
  ...
  case 0x10:
    ...
    cVar3 = FUN_001e8900(param_1,*(undefined4 *)(param_2 + 4),9);
    if (cVar3 == '\0') {
      return false;
    }
    break;
