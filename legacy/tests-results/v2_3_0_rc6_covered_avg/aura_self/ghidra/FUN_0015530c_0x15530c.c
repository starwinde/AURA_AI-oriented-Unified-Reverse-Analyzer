...
undefined8 FUN_0015530c(long *param_1)
...
LAB_0015568c:
        ...
        if (__ptr_00 != (void *)0x0) {
          ...
          if (uVar29 != 0) {
            ...
            plVar20 = plStack_20 + (ulong)uVar29 * 10;
            do {
              if (*(uint *)(plStack_20 + 1) != 0) {
                lVar30 = *plStack_20;
                lVar10 = lVar30 + (ulong)*(uint *)(plStack_20 + 1) * 0x90;
LAB_00155548:
                do {
