...
void FUN_00191e30(long param_1,int param_2,undefined8 param_3)

{
  ...
  *(undefined1 *)(lVar10 + 200) = uVar2;
  uVar6 = FUN_0018ffb0();
  pcVar8 = (char *)FUN_001e68d4(lVar15,uVar6,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98);
  if (pcVar8 == (char *)0x0) {
    local_50[0] = 0;
  }
  else {
...
LAB_001921f0:
            ...
            if (((((uVar1 != 1) &&
                  (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x1f)),_DAT_0020c6e0
                          ), uVar1 != 2)) &&
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x2f)),_DAT_0020c6e0)
                 , uVar1 != 3)) &&
                ((((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x3f)),
                 ...
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x8f)),_DAT_0020c6e0)
                 , uVar1 != 9)))) &&
               ((((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0x9f)),_DAT_0020c6e0
                          ), uVar1 != 10 &&
                  (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xaf)),_DAT_0020c6e0
                          ), uVar1 != 0xb)) &&
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xbf)),_DAT_0020c6e0)
                 , uVar1 != 0xc)) &&
                ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xcf)),_DAT_0020c6e0)
                 , uVar1 != 0xd &&
                 (a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xdf)),_DAT_0020c6e0)
                 , uVar1 == 0xf)))))) {
              a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar8 + (uVar12 - 0xef)),_DAT_0020c6e0);
            }
            uVar9 = uVar7 & 0xf0;
            if ((uVar7 & 0xf) != 0) {
              uVar7 = uVar11 - uVar9;
              uVar13 = (ulong)((uVar7 & 0xff) + 1 & 0xff);
              if (6 < (uVar7 & 0xff)) goto LAB_001921b4;
              goto LAB_001921f0;
            }
          }
        }
          ...
          do {
            ...
            while (cVar3 != -0x80) {
              ...
              *pcVar4 = cVar3;
              pcVar8 = pcVar8 + -1;
              uVar7 = uVar1 & 0xff;
              if (uVar11 < (uVar1 & 0xff)) goto LAB_001922e0;
              pcVar4 = pcVar4 + 1;
              cVar3 = *pcVar8;
            }
            uVar1 = uVar7 + 1;
...
joined_r0x00192318:
  if (iVar5 != 0) {
    FUN_00190d40(param_1,param_2 + 1,param_3);
    FUN_00190370(param_3,&DAT_001fde10);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      uVar7 = FUN_001e6bd4(iVar5);
      lVar15 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
  ...
  FUN_00190ef4(param_1,param_2,param_3);
  FUN_00190370(param_3,")");
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 3) {
