...
ulong FUN_00189190(long param_1,ulong param_2,ulong *param_3,byte param_4,long param_5)
      ...
      if (bVar3 == 2) {
        if (uVar12 + 2 <= param_2) {
          ...
          *param_3 = uVar12 + 2;
          ...
          goto joined_r0x00189364;
        }
        goto LAB_00189430;
      }
      if (bVar3 == 3) {
        if (param_2 < uVar12 + 4) goto LAB_00189430;
      ...
      if (bVar3 < 0xc) {
        if (bVar3 == 9) {
          ...
          *param_3 = uVar9;
          ...
          if (param_2 < uVar12 + 2) goto LAB_00189430;
          uVar6 = *(undefined1 *)(param_1 + uVar12);
          uVar2 = *(undefined1 *)(param_1 + uVar12 + 1);
          *param_3 = uVar12 + 2;
