...
void FUN_0016e710(long param_1,ulong *param_2,long param_3,undefined8 param_4,undefined8 *param_5,
                 undefined8 *param_6)
...
LAB_0016e7cc:
      ...
      FUN_0014bbe0(&local_68);
      FUN_0014b5d0(param_1,&local_68,uVar12,uVar13 + uVar6,uVar1,uVar14);
      if (local_60 != 0) {
        puVar11 = malloc(0x10);
