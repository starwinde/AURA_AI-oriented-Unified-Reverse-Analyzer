...
undefined8 FUN_00155310(long *param_1)
...
LAB_00155728:
                      ...
                      do {
                        uVar3 = *puVar16;
                        puVar16 = puVar16 + 1;
                        if (uVar7 == uVar3) goto LAB_00155468;
                      } while (puVar12 != puVar16);
                      uVar31 = *(uint *)((long)__ptr_01 + lVar10 + 0xc);
                      iVar14 = uVar5 + 1;
                      if (uVar31 <= uVar5) {
                        if (uVar31 == 0) goto LAB_00155728;
                        iVar18 = uVar31 << 1;
...
LAB_00155780:
                      ...
                      do {
                        uVar5 = *puVar12;
                        puVar12 = puVar12 + 1;
                        if (uVar7 == uVar5) goto LAB_0015568c;
                      } while (puVar11 != puVar12);
                      uVar19 = *(uint *)((long)__ptr_01 + lVar22 + 0xc);
                      iVar14 = uVar31 + 1;
                      if (uVar19 <= uVar31) {
                        if (uVar19 == 0) goto LAB_00155780;
                        iVar18 = uVar19 << 1;
...
LAB_0015568c:
        ...
        if (__ptr_00 != (void *)0x0) {
          ...
          if (uVar29 != 0) {
            uVar19 = 0;
            lVar9 = *param_1;
            local_20 = (long *)(lVar9 + 8);
            plVar20 = local_20 + (ulong)uVar29 * 10;
            do {
              if (*(uint *)(local_20 + 1) != 0) {
                lVar30 = *local_20;
                lVar10 = lVar30 + (ulong)*(uint *)(local_20 + 1) * 0x90;
LAB_00155548:
                do {
                  if (*(uint *)(lVar30 + 8) < uVar2) {
                    auVar33 = FUN_001550a0((ulong)*(uint *)(lVar30 + 8) << 4,lVar30,__ptr,uVar2);
              ...
              if (uVar2 << 2 != 0) {
                ...
                do {
                  ...
                  if (uVar31 < uVar2) {
                    ...
                    if (((uVar5 < uVar29) &&
                        (lVar30 = lVar9 + (ulong)uVar5 * 0x50, uVar7 < *(uint *)(lVar30 + 0x10))) &&
                       (lVar30 = *(long *)(lVar30 + 8) + (ulong)uVar7 * 0x90,
                       *(uint *)(lVar30 + 8) == uVar31)) {
                      auVar33 = FUN_001550a0((ulong)uVar31 << 4,lVar30,__ptr,uVar2);
                      ...
                      if (uVar31 < uVar7) {
                        if (uVar7 == 1 && uVar31 == 1) {
                          uVar17 = 2;
                          lVar30 = 0;
                          if (lVar22 == lVar10) goto LAB_0015586c;
                        }
                      }
                      else if (uVar7 == 1) {
                        ...
                        else if (uVar31 == 1 && lVar22 == lVar10) goto LAB_0015586c;
                      }
                      else if (uVar31 == uVar7) goto LAB_0015586c;
...
LAB_001558cc:
                    uVar29 = uVar29 + 1;
                    lVar10 = lVar10 + 0x90;
                    if (uVar19 <= uVar29) goto LAB_00155948;
                  }
                  iVar14 = *piVar1;
                  if ((iVar14 == 1) || (iVar14 - 0x16U < 5)) goto LAB_001558cc;
                  if (iVar14 == 0x1b) {
...
LAB_00155948:
              ...
              lVar30 = lVar30 + 1;
              if (uVar29 <= (uint)lVar30) goto LAB_00155978;
              lVar9 = *param_1;
            } while( true );
          }
          uVar28 = 0;
