...
void FUN_001dea60(long param_1)
  ...
  *(char *)(param_1 + 0x42) =
  ...
  if (iVar6 == 0) {
    ...
    *(long *)(param_1 + 0x58) = lVar11;
    ...
    if (cVar2 == '\x04') {
      iVar9 = 0x24;
      *(undefined8 *)(param_1 + 0xbc) = DAT_0020c5b8;
    }
    else if (cVar2 == '\b') {
      iVar9 = 0x34;
      *(undefined8 *)(param_1 + 0xbc) = DAT_0020c5c0;
    }
    else if (cVar2 == '\x02') {
      iVar9 = 0x14;
      *(undefined8 *)(param_1 + 0xbc) = DAT_0020c5b0;
    }
    else {
...
LAB_001ded84:
          ...
          if (iVar6 != 1) {
            ...
            *(undefined8 *)(param_1 + 0xc4) = DAT_0020c5c8;
            if ((*(byte *)(param_1 + 0x10) & 1) != 0) {
              iVar6 = 0;
              goto LAB_001decc8;
            }
...
LAB_001dec58:
      *(undefined4 *)(param_1 + 200) = uVar7;
      if (uVar13 == 4) {
        *(undefined4 *)(param_1 + 0xc4) = 0x15;
        iVar6 = FUN_001ddea0(param_1);
        goto joined_r0x001decbc;
      }
      ...
      *(undefined4 *)(param_1 + 200) = 0;
      if (uVar13 != 4) {
        ...
        *(undefined8 *)(param_1 + 0xc4) = DAT_0020c5d0;
        if ((*(byte *)(param_1 + 0x10) & 1) == 0) {
          lVar14 = 0;
          *(undefined1 *)(param_1 + 0x10) = 1;
          *(char *)(param_1 + 0x40) = cVar5 - (char)*(undefined8 *)(param_1 + 0x68);
