...
void FUN_001e1ec0(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  FUN_0018ffd0(param_1,param_2,0);
  uVar5 = FUN_001900a0();
  uVar11 = uVar5 & 0xff;
  if (*(int *)(*(long *)(param_1 + 800) + 0x68) == 4) {
    if (uVar11 < 10) {
      FUN_001903f0(param_3,&DAT_001fba60,uVar11);
    }
    else if (((uVar5 & 0xf0) == 0) || (0x9f < uVar11)) {
      FUN_001903f0(param_3,"0%lxh",uVar11);
    }
    else {
      FUN_001903f0(param_3,&DAT_00203908,uVar11);
    }
  }
  else {
    if (9 < uVar11) {
      FUN_001903f0(param_3,"0x%lx",uVar11);
      lVar12 = *(long *)(param_1 + 800);
      iVar2 = *(int *)(lVar12 + 0x60);
      goto joined_r0x001e1f7c;
    }
    FUN_001903f0(param_3,&DAT_001fba60,uVar11);
  }
  lVar12 = *(long *)(param_1 + 800);
...
joined_r0x001e1f7c:
  if (iVar2 != 0) {
    ...
    *(undefined1 *)(lVar9 + 200) = 1;
    ...
    pcVar6 = (char *)FUN_001e68d4(lVar12,uVar4,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98);
    if (pcVar6 == (char *)0x0) {
      local_40[0] = '\0';
    }
    else {
