...
void FUN_001e2620(long param_1,int param_2,undefined8 param_3)

{
  ...
  if (*(int *)(lVar12 + 0x60) == 0) {
    ...
    *(undefined1 *)(lVar8 + 200) = uVar2;
    uVar5 = FUN_0018ffb0();
    pcVar7 = (char *)FUN_001e68d4(lVar12,uVar5,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98);
    if (pcVar7 == (char *)0x0) {
      local_50[0] = '\0';
    }
    else {
...
LAB_001e27b4:
  ...
  if (iVar4 != 0) {
    FUN_001e12b0(param_1,param_2 + 1,param_3);
  ...
  FUN_001e20d0(param_1,param_2,param_3);
