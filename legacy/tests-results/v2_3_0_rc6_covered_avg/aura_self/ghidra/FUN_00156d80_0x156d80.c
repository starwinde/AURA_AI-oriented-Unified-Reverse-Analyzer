...
undefined4 FUN_00156d80(long *param_1)

{
  ...
  if (((param_1 == (long *)0x0) || ((int)param_1[1] == 0)) ||
     (local_50 = FUN_00178e20(param_1,(int)param_1[1],0), local_50 == 0)) {
    uVar4 = 0;
  }
  else {
    if ((int)param_1[1] == 0) {
      ...
      do {
        uVar2 = uVar2 + 1;
        iVar1 = FUN_00156aa0(*param_1 + lVar3,local_50);
        lVar3 = lVar3 + 0x50;
        if (0 < iVar1) {
          uVar4 = 1;
        }
