...
void FUN_00182590(undefined4 *param_1,FILE *param_2)

{
  ...
  case 0:
    ...
    if (param_1[0x28] != 0) {
      do {
        lVar1 = lVar4 * 8;
        lVar4 = lVar4 + 1;
        FUN_00182590(*(undefined8 *)(*(long *)(param_1 + 0x26) + lVar1),param_2);
  ...
  case 1:
    ...
    FUN_00181cf0(*(undefined8 *)(param_1 + 0x28),param_2,2);
    if (*(long *)(param_1 + 0x2a) != 0) {
      fputc(0x20,param_2);
      fputc(0x20,param_2);
      fwrite("} ELSE {\n",1,9,param_2);
      FUN_00181cf0(*(undefined8 *)(param_1 + 0x2a),param_2,2);
    }
    goto LAB_0018283c;
  case 2:
    fputc(0x20,param_2);
  ...
  case 5:
    ...
    if (param_1[0x2a] != 0) {
      do {
        ...
        lVar4 = lVar4 + 0x18;
        FUN_00181cf0(*(undefined8 *)(lVar1 + 0x10),param_2,3);
...
LAB_0018283c:
  ...
  case 0xb:
    ...
    if (*(long *)(param_1 + 0x26) == 0) goto LAB_0018265c;
    fputc(0x20,param_2);
    uVar2 = *(undefined8 *)(param_1 + 0x26);
LAB_00182658:
    FUN_00181884(uVar2,param_2);
LAB_0018265c:
    fwrite(";\n",1,2,param_2);
    return;
  default:
