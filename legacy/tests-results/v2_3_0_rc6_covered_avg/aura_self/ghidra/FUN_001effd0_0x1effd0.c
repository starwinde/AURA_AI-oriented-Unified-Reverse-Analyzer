...
undefined8 FUN_001effd0(long *param_1,ulong *param_2)

{
  ...
  *(byte *)((long)param_2 + 0x17) = *(byte *)(param_1[1] + 5) & 7;
  ...
  FUN_001f2458(*(undefined4 *)(*param_1 + 8),param_2 + 7);
  if ((int)param_2[7] != 0) {
...
LAB_001f0330:
    ...
    *(byte *)((long)param_2 + 0x1e) = *(byte *)(param_1[1] + 8) >> 6 & 1;
    ...
    bVar4 = FUN_001e8e64(*(undefined4 *)(*param_1 + 0x17c));
    *(byte *)((long)param_2 + 0x12) = bVar4 | *(byte *)((long)param_2 + 0x12);
    bVar4 = FUN_001e8ee8(*(undefined4 *)(*param_1 + 0x180));
    *(byte *)((long)param_2 + 0x12) = bVar4 | *(byte *)((long)param_2 + 0x12);
...
LAB_001f079c:
  ...
  do {
    ...
    if (uVar2 == 4) {
      if ((*pbVar6 & 0x3f) != 3) {
        pbVar6 = (byte *)FUN_001f2f18(pbVar6);
        if ((*pbVar6 & 0x3f) == 5) {
...
LAB_001f0aa0:
      ...
      if (uVar2 == 3) {
        ...
        *(undefined1 *)((long)param_2 + 0x22) = *(undefined1 *)((long)param_1 + 0x2b);
        ...
        if (uVar2 == 1) {
          FUN_001ef948(puVar1,pbVar6,param_2);
        }
        else {
          ...
          if ((*pbVar6 & 0x3f) == 0x20) {
            *(undefined1 *)((long)param_2 + 0x21) = *(undefined1 *)((long)param_1 + 0x2a);
            ...
            FUN_001efb58(param_1,puVar1,param_2);
