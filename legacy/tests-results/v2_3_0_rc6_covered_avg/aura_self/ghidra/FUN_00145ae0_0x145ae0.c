...
long * FUN_00145ae0(long param_1)

{
  ...
  if ((param_1 != 0) &&
     (local_80 = FUN_00144c60(param_1,PTR___stack_chk_guard_005ffe88,0), local_80 != 0)) {
    plVar13 = (long *)FUN_00144d80(&local_80);
    if (plVar13 == (long *)0x0) {
      FUN_00144bf0(local_80);
    }
    else {
...
LAB_00145e30:
                        if (((local_a0 == 0) ||
                            (uVar23 = FUN_00145a80(pcVar2,local_88,local_a0,uVar5), uVar23 == 0)) ||
                           (uVar30 < uVar23)) {
                          if (((local_a4 == 0) ||
                              (uVar23 = FUN_00145a80(pcVar2,local_88,local_a4,uVar5), uVar23 == 0))
                             || (uVar5 - 0x28 < uVar23)) goto LAB_00145dbc;
                          uVar12 = 0;
...
LAB_00145e84:
                          ...
                          do {
                            ...
                            uVar23 = FUN_00145a80(pcVar2,local_88,iVar22,uVar5);
                            if (uVar23 != 0) {
                              lVar14 = 4;
                              ...
                              for (; uVar23 <= uVar5 - lVar14; uVar23 = uVar23 + lVar14) {
                                ...
                                if (((uVar28 & uVar26) == 0) &&
                                  ...
                                  uVar12 = 0x10000;
                                  if (local_a4 != 0) goto LAB_00146300;
                                  uVar23 = 0x10000;
                                  uVar33 = 0;
                                  goto LAB_00145e84;
                                }
...
LAB_00146318:
                            uVar33 = 0;
                            uVar35 = uVar12;
                            goto joined_r0x00146320;
                          }
LAB_00146300:
                          uVar23 = FUN_00145a80(pcVar2,local_88,local_a4,uVar5);
                          if ((uVar23 == 0) || (uVar5 - 0x28 < uVar23)) goto LAB_00146318;
                          uVar33 = *(uint *)(pcVar4 + uVar23 + 0x18);
                          if (0x10000 < uVar33) {
                            uVar33 = 0x10000;
                          }
                          uVar35 = uVar12 + uVar33;
                          if (uVar12 + uVar33 < 0x10001) goto joined_r0x00146320;
                          uVar23 = 0x10000;
                          uVar35 = 0x10000;
                        }
                        ...
                        if (local_e0 != (void *)0x0) {
                          ...
                          if (local_a0 == 0 || uVar12 == 0) {
                            ...
                            lVar14 = FUN_00145a80(pcVar2,local_88,local_a0,uVar5);
                            if (lVar14 == 0) {
                              uVar12 = 0;
                              if (bVar9) goto LAB_00145edc;
                            }
                            else {
                              uVar12 = 0;
                              for (piVar27 = (int *)(pcVar4 + lVar14);
                                ...
                                if (uVar23 != 0) {
                                  ...
                                  for (; uVar23 <= uVar5 - lVar14 && uVar12 < uVar35;
                                    ...
                                    if (uVar24 == 0) break;
                                    if ((uVar24 & uVar26) == 0) {
                                      lVar17 = FUN_00145a80(pcVar2,local_88,
...
LAB_00145edc:
                                ...
                                uVar23 = FUN_00145a80(pcVar2,uVar30,local_a4,uVar5);
                                if ((uVar23 == 0) || (uVar5 - 0x28 < uVar23)) {
LAB_00146050:
                                  uVar33 = 0;
                                }
                                else {
                                  lVar14 = FUN_00145a80(extraout_x9,uVar30 & 0xffffffff,
                                                        *(undefined4 *)(pcVar4 + uVar23 + 0x20));
                                  lVar17 = FUN_00145a80(extraout_x9_00,uVar30 & 0xffffffff,
                                                        extraout_x10 & 0xffffffff);
                                  if (extraout_x10_00 == 0 || lVar17 == 0) goto LAB_00146050;
                                  uVar33 = *(uint *)(extraout_x8 + 0x18);
                                  lVar18 = FUN_00145a80(0,extraout_x9_01,uVar30 & 0xffffffff,
                                  ...
                                  while ((uVar33 != (uint)uVar23 &&
                                         ...
                                         uVar23 <= uVar32))) {
                                    uVar23 = FUN_00145a80(pcVar2,local_88,
...
LAB_00145fd4:
                                      ...
                                      if (uVar5 - uVar23 <= sVar19) goto LAB_00145fd4;
                                    }
                                    if (((lVar18 == 0) ||
                        ...
                        if (puVar15 != (undefined8 *)0x0) goto LAB_00145cb0;
                      }
                    }
                    else {
