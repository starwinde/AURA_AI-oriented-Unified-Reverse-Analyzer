...
undefined8 FUN_0018c8d4(uint *param_1,undefined8 param_2,int *param_3)

{
  ...
  uVar7 = (uint)param_2;
  if (uVar7 == 4) {
    PTR_vsnprintf_00600590 = *(undefined **)(param_3 + 8);
    PTR_free_00600588 = *(undefined **)(param_3 + 6);
    PTR_realloc_00600580 = *(undefined **)(param_3 + 4);
    PTR_calloc_00600578 = *(undefined **)(param_3 + 2);
    PTR_malloc_00600570 = *(undefined **)param_3;
    return 0;
  }
  if (param_1 == (uint *)0x0) {
    return 4;
  ...
  if (uVar7 < 7) {
    ...
    if (uVar7 == 7) {
      ...
      if (*(char **)(param_3 + 2) != (char *)0x0) {
        while( true ) {
          if (piVar8 == (int *)0x0) {
            piVar5 = (int *)(*(code *)PTR_malloc_00600570)(0x30);
  ...
  uVar4 = (ulong)*param_1;
LAB_0018ca74:
                    /* WARNING: Could not recover jumptable at 0x0018ca98. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  uVar3 = (*(code *)(&PTR_FUN_005ff850)[uVar4 * 3])(param_1,param_2,param_3);
  return uVar3;
}
