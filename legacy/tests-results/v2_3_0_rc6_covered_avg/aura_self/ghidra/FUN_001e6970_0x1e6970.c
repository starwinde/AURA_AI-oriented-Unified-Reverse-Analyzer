...
void FUN_001e6970(long param_1,void *param_2,undefined1 *param_3,void *param_4,undefined1 *param_5)
  ...
  if (bVar2 != 0) {
    ...
    do {
      if (*piVar4 == 1) {
        ...
        if ((bVar2 & 1) != 0) {
          uVar3 = FUN_001908d0(param_2,uVar7,piVar4[2]);
          if ((uVar3 & 1) == 0) {
            lVar1 = uVar7 * 2;
            bVar2 = *(byte *)((long)piVar4 + 0x21);
        ...
        if (((bVar2 >> 1 & 1) == 0) ||
           (uVar3 = FUN_001908d0(param_4,uVar6,piVar4[2]), (uVar3 & 1) != 0)) goto LAB_001e6a24;
        lVar1 = uVar6 * 2;
        ...
        *(short *)((long)param_4 + lVar1) = (short)piVar4[2];
        ...
        if ((piVar4[3] != 0) && (uVar3 = FUN_001908d0(param_2,uVar7), (uVar3 & 1) == 0)) {
          lVar1 = uVar7 * 2;
          uVar7 = (ulong)((int)uVar7 + 1U & 0xff);
          *(short *)((long)param_2 + lVar1) = (short)piVar4[3];
        }
        if ((piVar4[4] != 0) && (uVar3 = FUN_001908d0(param_2,uVar7), (uVar3 & 1) == 0)) {
          lVar1 = uVar7 * 2;
          uVar7 = (ulong)((int)uVar7 + 1U & 0xff);
