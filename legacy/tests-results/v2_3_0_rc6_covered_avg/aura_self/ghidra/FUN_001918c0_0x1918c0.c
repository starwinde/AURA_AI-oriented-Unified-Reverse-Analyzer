...
void FUN_001918c0(long param_1,undefined8 param_2)

{
  ...
  if (*(int *)(lVar15 + 0x60) != 0) {
    ...
    *(undefined1 *)(lVar10 + 200) = uVar2;
    uVar5 = FUN_0018ffb0();
    pcVar6 = (char *)FUN_001e68d4(lVar15,uVar5,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98);
    if (pcVar6 == (char *)0x0) {
      local_40[0] = 0;
    }
    else {
...
LAB_00191ca0:
              ...
              if (((((uVar1 != 1) &&
                ...
                a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar6 + (uVar13 - 0xef)),_DAT_0020c6e0);
              }
              uVar8 = uVar9 & 0xf0;
              if ((uVar9 & 0xf) != 0) {
                uVar9 = uVar12 - uVar8;
                uVar14 = (ulong)((uVar9 & 0xff) + 1 & 0xff);
                if (6 < (uVar9 & 0xff)) goto LAB_00191c64;
                goto LAB_00191ca0;
              }
            }
          }
            ...
            do {
              ...
              while (cVar3 != -0x80) {
                ...
                *pcVar4 = cVar3;
                pcVar6 = pcVar6 + -1;
                uVar9 = uVar1 & 0xff;
                if (uVar12 < (uVar1 & 0xff)) goto LAB_00191d90;
                pcVar4 = pcVar4 + 1;
                cVar3 = *pcVar6;
              }
              uVar1 = uVar9 + 1;
...
LAB_00191d90:
  ...
  if (*(int *)(lVar15 + 4) == 8) {
    FUN_00190370(param_2,"(",lVar10);
    lVar10 = *(long *)(param_1 + 800);
    iVar7 = *(int *)(lVar10 + 0x60);
  }
  else {
    FUN_00190370(param_2,"%es:(",lVar10);
    lVar10 = *(long *)(param_1 + 800);
    iVar7 = *(int *)(lVar10 + 0x60);
    if (iVar7 == 0) goto LAB_00191950;
