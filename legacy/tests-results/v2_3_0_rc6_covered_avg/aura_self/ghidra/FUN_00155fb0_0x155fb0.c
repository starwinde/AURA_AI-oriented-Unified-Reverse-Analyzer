...
uint FUN_00155fb0(long *param_1)
...
LAB_001564ec:
    ...
    *__ptr_00 = 0;
    do {
      ...
      if (piVar18[(ulong)uVar13 * 0x14 + 0xc] != 0) {
        piVar16 = *(int **)(piVar18 + (ulong)uVar13 * 0x14 + 10);
        piVar17 = piVar16 + (uint)piVar18[(ulong)uVar13 * 0x14 + 0xc];
        do {
          uVar9 = 0;
          piVar21 = piVar18;
          do {
      ...
      if (piVar18[(ulong)uVar13 * 0x14 + 4] != 0) {
        piVar17 = *(int **)(piVar18 + (ulong)uVar13 * 0x14 + 2);
        piVar16 = piVar17 + (ulong)(uint)piVar18[(ulong)uVar13 * 0x14 + 4] * 0x24;
        do {
          while (iVar35 = *piVar17, 1 < iVar35 - 0x17U) {
            piVar17 = piVar17 + 0x24;
            if (piVar16 == piVar17) goto LAB_00156184;
          }
          piVar21 = local_70;
          iVar36 = 0;
...
LAB_00156210:
      ...
      if ((uVar29 & 0xf) != 0) {
        ...
        if (uVar13 < uVar29) goto LAB_00156210;
      }
    }
    if (uVar31 == 0) goto LAB_001564ec;
    lVar22 = 0;
    pcVar5 = __ptr;
    do {
      while (*pcVar5 != '\0') {
        pcVar5 = pcVar5 + 1;
        lVar22 = lVar22 + 0x50;
        if (__ptr + uVar25 == pcVar5) goto LAB_00156404;
      }
      lVar26 = 0;
      uVar29 = 0;
    ...
    do {
      if (__ptr[uVar20] != '\0') {
        if (uVar29 != (uint)uVar20) {
          ...
          puVar10 = (undefined8 *)(*param_1 + (ulong)uVar29 * 0x50);
          uVar32 = *puVar2;
          uVar34 = puVar2[3];
          uVar33 = puVar2[2];
          puVar10[1] = puVar2[1];
      ...
      if (uVar8 != 0) {
        ...
        do {
          ...
          if (uVar29 != 0) {
            ...
            } while (piVar17 + (ulong)uVar29 * 0x14 != piVar16);
          }
          lVar22 = lVar22 + 1;
          if (uVar8 <= (uint)lVar22) goto LAB_001568f8;
          uVar29 = *(uint *)(param_1 + 1);
        } while( true );
      }
      goto LAB_00156478;
...
LAB_001569ec:
  ...
  if (0xfffffffd < uVar29 - 1) goto LAB_00155ff0;
  uVar25 = (ulong)uVar29;
  __ptr_01 = calloc(uVar25,8);
  if (__ptr_01 == (void *)0x0) goto LAB_00155ff0;
    ...
    if (plVar6 != (long *)0x0) {
      ...
      do {
        while (*puVar14 == 0) {
          ...
          if (plVar24 == plVar27) goto LAB_001565fc;
        }
      ...
      if (pvVar7 == (void *)0x0) {
        ...
        while (iVar35 != 0) {
          ...
          if (uVar31 < uVar29) {
            ...
            if (uVar13 <= uVar31) goto LAB_00156710;
            lVar19 = lVar22 + (ulong)uVar31 * 0x50;
            uVar3 = *(uint *)((long)__ptr_01 + lVar26 + 4);
            if ((*(uint *)(lVar19 + 0x10) <= uVar3) ||
               (*(char *)(plVar6[uVar31] + (ulong)uVar3) != '\0')) goto LAB_00156710;
            lVar19 = *(long *)(lVar19 + 8);
            *(undefined1 *)(plVar6[uVar31] + (ulong)uVar3) = 1;
            lVar26 = lVar19 + (ulong)uVar3 * 0x90;
...
LAB_00156880:
            ...
            if ((*(int *)(lVar19 + (ulong)uVar3 * 0x90) == 0x1b) && (*(uint *)(lVar26 + 0x60) != 0))
            {
            ...
            do {
              if (*(char *)(lVar30 + lVar19) == '\0') {
                ...
                if (uVar31 != (uint)lVar19) {
                  ...
                  puVar10 = (undefined8 *)(*(long *)(lVar26 + 8) + (ulong)uVar31 * 0x90);
                  uVar32 = *puVar2;
                  uVar34 = puVar2[3];
                  uVar33 = puVar2[2];
                  puVar10[1] = puVar2[1];
...
LAB_00156478:
    ...
    if (uVar29 <= uVar13) goto LAB_001569ec;
    goto LAB_00156488;
  }
  piVar16 = *(int **)piVar18;
  uVar31 = 0;
  do {
    while ((*piVar16 != 0x1b || (uVar15 = piVar16[0x18], uVar15 == 0))) {
      ...
      if (uVar8 <= uVar31) goto LAB_001569d8;
    }
    ...
    while (uVar29 != 0) {
      ...
      do {
        ...
        piVar12 = piVar12 + 0x14;
      } while (piVar17 + (ulong)uVar29 * 0x14 != piVar12);
      iVar36 = (int)uVar25;
      uVar8 = uVar8 + 1;
