...
void FUN_0016cec4(long param_1,long param_2,long param_3,undefined8 param_4,undefined8 *param_5)
    ...
    if (*(uint *)(param_1 + 0x20) == 0) {
      ...
      do {
        if (((char *)*puVar5 != (char *)0x0) &&
           (iVar3 = strcmp((char *)*puVar5,".text"), iVar3 == 0)) goto LAB_0016cfc0;
        puVar5 = puVar5 + 7;
