...
void FUN_0017e4a0(ulong *param_1,uint param_2,byte param_3)
...
switchD_0017e56c_caseD_4:
  ...
  lVar4 = (long)(char)(&switchD_0017e56c::switchdataD_0020c900)[param_2] * 4 + 0x17e570;
  switch(param_2) {
  case 0:
    local_20 = 0x10000000000;
    local_a0 = (ulong)CONCAT14(DAT_001fa44c,DAT_001fa448);
    break;
  case 1:
    pcVar2 = "int8_t";
    uVar3 = 1;
  ...
  case 5:
    if (param_3 == 4) {
      ...
      if (param_3 == 1) {
        ...
        local_a0 = DAT_001fb390;
        uStack_98 = (ulong)DAT_001fb398;
      }
    }
    else if (param_3 == 8) {
...
LAB_0017e730:
      local_a0 = (ulong)CONCAT24(DAT_001fa444,DAT_001fa440);
    }
  ...
  case 9:
    ...
    local_a0 = s_long_double_001fa460._0_8_;
    uStack_98 = (ulong)(uint)s_long_double_001fa460._8_4_;
    break;
  case 10:
    uVar3 = 0x10;
    pcVar2 = "__m128";
