...
void FUN_001720f0(long param_1,int param_2,FILE *param_3)

{
  ...
  FUN_00140820(1,0,0,"headless: analyzing %s (format=%s)",param_1,pcVar12);
  lVar9 = FUN_001459e0(param_1);
  if (((lVar9 == 0) && (lVar9 = FUN_00145ae0(param_1), lVar9 == 0)) &&
     (lVar9 = FUN_00147560(param_1), lVar9 == 0)) {
    FUN_00140820(3,0,0,"headless: failed to load file: %s",param_1);
    uVar11 = 0xfffffff9;
    goto LAB_001731cc;
  }
...
LAB_00172208:
    local_80 = (long *)0x0;
    local_8c = 0;
    if (param_2 != 0) goto LAB_0017220c;
LAB_00172d48:
    plVar5 = local_80;
...
LAB_00172f68:
      ...
      if ((uVar8 & 1) != 0) goto LAB_0017330c;
LAB_00172f7c:
      local_78 = 0;
      if ((uVar8 >> 1 & 1) != 0) goto LAB_00173290;
LAB_00172f80:
      uStack_70 = 0;
      if ((uVar8 >> 2 & 1) != 0) goto LAB_001732a8;
      do {
        lVar1 = *plVar20;
        lVar17 = plVar20[1];
        while( true ) {
          if (lVar1 != 0) {
            ...
            uVar21 = uVar21 + 1;
            lVar19 = lVar19 + 0x38;
            if (*(uint *)(lVar9 + 0x20) <= uVar21) goto LAB_00172fbc;
            goto LAB_00172f68;
          }
          __fprintf_chk(param_3,2,"| %u | `%s` | `0x%lx` | %lu | %s |\n",uVar21,&DAT_001fe648,lVar17
                        ,plVar20[3],&local_78);
          uVar21 = uVar21 + 1;
          lVar19 = lVar19 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar21) goto LAB_00172fbc;
          plVar20 = (long *)(*(long *)(lVar9 + 0x18) + lVar19);
          uVar8 = *(uint *)(plVar20 + 6);
          if ((uVar8 & 1) == 0) goto LAB_00172f7c;
LAB_0017330c:
          local_78 = 0x52;
          if ((uVar8 >> 1 & 1) == 0) goto LAB_00172f80;
LAB_00173290:
          uStack_70 = 0;
          __strcat_chk(&local_78,&DAT_001fcd78,0x10);
          if ((*(uint *)(plVar20 + 6) >> 2 & 1) == 0) break;
LAB_001732a8:
          __strcat_chk(&local_78,&DAT_001fcd80,0x10);
          lVar1 = *plVar20;
          lVar17 = plVar20[1];
        }
      } while( true );
      ...
      do {
        ...
        while( true ) {
          ...
          if (!bVar6) {
            if (uVar2 < 3 || bVar4) {
              if (uVar2 == 1) {
                ...
                puVar13 = &DAT_001faac0;
                if (uVar2 == 2) {
                  puVar13 = &DAT_001fc9a8;
                }
              }
            }
            else {
          ...
          __fprintf_chk(param_3,2,"| %u | `%s` | `0x%lx` | %lu | %s |\n",uVar3,*puVar16,puVar16[2],
                        puVar16[3],puVar13);
          if (uVar8 <= uVar3 + 1) goto LAB_001730cc;
          puVar16 = (undefined8 *)(*(long *)(lVar9 + 0x28) + lVar19);
          uVar2 = *(uint *)(puVar16 + 4);
          bVar6 = uVar2 == 3;
          uVar3 = uVar3 + 1;
...
LAB_001730cc:
    ...
    if (((plVar5 == (long *)0x0) || (plVar20 = (long *)*plVar5, plVar20 == (long *)0x0)) ||
      ...
      fputc(10,param_3);
      fwrite("## Call Graph\n\n",1,0xf,param_3);
      if (plVar5 != (long *)0x0) goto LAB_0017314c;
LAB_00173160:
...
LAB_0017314c:
      ...
      if ((plVar20 == (long *)0x0) || ((int)plVar20[1] == 0)) goto LAB_00173160;
        ...
        do {
          ...
          if (plVar10 != (long *)0x0) {
            ...
            if (uVar8 < *(uint *)(plVar10 + 1)) {
              puVar13 = (undefined *)(*plVar10 + (ulong)uVar8 * 0x98 + 0x14);
            }
            uVar8 = *(uint *)(lVar1 + 4);
            pcVar12 = "external";
    ...
    do {
      if (((char *)*puVar16 != (char *)0x0) &&
         (iVar7 = strcmp((char *)*puVar16,".text"), iVar7 == 0)) goto LAB_001721e8;
      puVar16 = puVar16 + 7;
    } while (puVar18 + (ulong)uVar21 * 7 != puVar16);
    uVar8 = *(uint *)(puVar18 + 6);
    puVar16 = puVar18;
    while ((uVar8 >> 2 & 1) == 0) {
      if (puVar18 + (ulong)uVar21 * 7 == puVar16 + 7) goto LAB_001721f8;
      uVar8 = *(uint *)(puVar16 + 0xd);
      puVar16 = puVar16 + 7;
    }
LAB_001721e8:
    if (((puVar16[5] == 0) || (puVar16[4] == 0)) ||
       (lVar19 = FUN_001446e0(*(undefined4 *)(lVar9 + 0xc)), lVar19 == 0)) goto LAB_001721f8;
    local_a0 = calloc(200000,0xe0);
    if (local_a0 == (void *)0x0) {
      FUN_001447a4(lVar19);
      goto LAB_001721f8;
    }
    iVar7 = FUN_001447f0(lVar19,puVar16[5],puVar16[4],puVar16[1],local_a0,200000);
    local_8c = iVar7;
    if (iVar7 < 0) {
      local_8c = 0;
    }
    FUN_001447a4(lVar19);
    local_80 = (long *)0x0;
    if (iVar7 < 1) goto LAB_00172208;
    local_80 = (long *)FUN_00149f60(local_a0,(long)local_8c,lVar9,0);
    if (param_2 == 0) goto LAB_00172d48;
LAB_0017220c:
    plVar5 = local_80;
    fwrite(&DAT_001fca10,1,2,param_3);
    fwrite(&DAT_001fa5d0,1,2,param_3);
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fca18,param_1);
    fwrite(&DAT_001fca30,1,2,param_3);
    fwrite(&DAT_001fa5d0,1,2,param_3);
    uVar21 = *(uint *)(lVar9 + 8);
    if (uVar21 == 3) {
      pcVar12 = "Mach-O";
    ...
    __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fca40,pcVar12);
    fwrite(&DAT_001fca30,1,2,param_3);
    fwrite(&DAT_001fa5d0,1,2,param_3);
    ...
    if (*(int *)(lVar9 + 0x20) != 0) {
      ...
      do {
        while( true ) {
          ...
          fwrite("    {",1,5,param_3);
          lVar1 = lVar17 + lVar19;
          puVar14 = *(undefined **)(lVar17 + lVar19);
          puVar13 = &DAT_001fe648;
          if (puVar14 != (undefined *)0x0) {
            puVar13 = puVar14;
          }
          uVar21 = uVar21 + 1;
          __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fc1d0,puVar13);
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","vaddr",*(undefined8 *)(lVar1 + 8));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fc1e8,*(undefined8 *)(lVar1 + 0x18));
          fwrite(", ",1,2,param_3);
          __fprintf_chk(param_3,2,"\"flags\": %u",*(undefined4 *)(lVar1 + 0x30));
          if (*(uint *)(lVar9 + 0x20) <= uVar21) break;
          __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001f95d8);
          lVar19 = lVar19 + 0x38;
          if (*(uint *)(lVar9 + 0x20) <= uVar21) goto LAB_00172568;
        }
        lVar19 = lVar19 + 0x38;
        __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001fe648);
    ...
    if (*(int *)(lVar9 + 0x30) != 0) {
      ...
      do {
        while( true ) {
          ...
          lVar1 = lVar17 + lVar19;
          fwrite("    {",1,5,param_3);
          puVar13 = *(undefined **)(lVar1 + 8);
          if ((*(undefined **)(lVar1 + 8) == (undefined *)0x0) &&
             (puVar14 = *(undefined **)(lVar17 + lVar19), puVar13 = local_a8,
          ...
          lVar19 = lVar19 + 0x28;
          __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001fe648);
          if (*(uint *)(lVar9 + 0x30) <= uVar21) goto LAB_00172710;
        }
        __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001f95d8);
        lVar19 = lVar19 + 0x28;
      ...
      if ((plVar20 != (long *)0x0) && ((int)plVar20[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            lVar1 = lVar17 + lVar19;
            fwrite("    {",1,5,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"%s\"",&DAT_001fc1d0,lVar1 + 0x14);
            fwrite(", ",1,2,param_3);
            uVar21 = uVar21 + 1;
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"","start",*(undefined8 *)(lVar17 + lVar19));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fcb18,*(undefined8 *)(lVar1 + 8));
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": %lu",&DAT_001fc1e8,*(undefined4 *)(lVar1 + 0x10));
            if (uVar21 < *(uint *)(plVar20 + 1)) break;
            lVar19 = lVar19 + 0x98;
            __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001fe648);
            if (*(uint *)(plVar20 + 1) <= uVar21) goto LAB_001728e4;
          }
          __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001f95d8);
          lVar19 = lVar19 + 0x98;
        } while (uVar21 < *(uint *)(plVar20 + 1));
      ...
      if ((plVar20 != (long *)0x0) && ((int)plVar20[1] != 0)) {
        ...
        do {
          while( true ) {
            ...
            fwrite(", ",1,2,param_3);
            __fprintf_chk(param_3,2,"\"%s\": \"0x%lx\"",&DAT_001fcb48,*(undefined8 *)(lVar1 + 0x10))
            ;
            if (uVar21 < *(uint *)(plVar20 + 1)) break;
            __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001fe648);
            lVar19 = lVar19 + 0x18;
            if (*(uint *)(plVar20 + 1) <= uVar21) goto LAB_00172ac0;
          }
          __fprintf_chk(param_3,2,&DAT_001fcad8,&DAT_001f95d8);
          lVar19 = lVar19 + 0x18;
        } while (uVar21 < *(uint *)(plVar20 + 1));
...
LAB_00172ac0:
    fwrite("  ],\n",1,5,param_3);
    fwrite("  \"stats\": {\n",1,0xd,param_3);
    fwrite(&DAT_001fcb60,1,4,param_3);
...
LAB_001733f4:
      ...
      fwrite(&DAT_001fca30,1,2,param_3);
      if (plVar5[1] == 0) goto LAB_001733f4;
      uVar15 = *(undefined4 *)(plVar5[1] + 8);
    }
    fwrite(&DAT_001fcb60,1,4,param_3);
    __fprintf_chk(param_3,2,"\"%s\": %lu","call_edge_count",uVar15);
    fputc(10,param_3);
    fwrite(&DAT_001fcbb0,1,4,param_3);
    fwrite(&DAT_001fa010,1,2,param_3);
  }
  FUN_0014ae20(&local_80);
  free(local_a0);
  FUN_00144de4(lVar9);
  FUN_00140820(1,0,0,"headless: analysis complete");
  uVar11 = 0;
LAB_001731cc:
