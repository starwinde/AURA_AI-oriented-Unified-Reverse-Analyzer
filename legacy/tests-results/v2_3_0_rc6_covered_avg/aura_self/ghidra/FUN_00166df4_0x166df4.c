...
void FUN_00166df4(long param_1,char *param_2,undefined4 param_3,undefined8 param_4,int param_5,
...
LAB_00167058:
    ...
    if (uVar1 - 1 < 0xfffffffffffffffe) {
      ...
      uVar6 = uVar6 + 1;
      FUN_00166ca0(param_7,uVar1,param_3,auStack_a8);
  ...
  goto LAB_00166e88;
LAB_00166f00:
  if (uVar5 < uVar6 + uVar10) goto LAB_00166e88;
  ...
  if (uVar9 - 1 < 0xfffffffffffffffe) {
    ...
    FUN_00166ca0(param_7,uVar9,param_3,auStack_a8);
    if (uVar3 <= lVar12 + 1U) goto LAB_00166e88;
    uVar5 = puVar7[3];
  }
  else if (uVar3 <= lVar12 + 1U) goto LAB_00166e88;
  lVar12 = lVar12 + 1;
  uVar10 = uVar6 + uVar10;
  goto LAB_00166f00;
...
LAB_00166fb8:
    ...
    if ((ulong)uVar2 - 1 < 0xfffffffffffffffe) {
      ...
      uVar10 = uVar10 + 1;
      FUN_00166ca0(param_7,(ulong)uVar2,param_3,auStack_a8);
