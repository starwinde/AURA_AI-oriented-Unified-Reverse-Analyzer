...
int FUN_0014b5d0(long param_1,long param_2,ulong param_3,ulong param_4,uint param_5,long param_6)

{
  ...
  if (((param_2 != 0 && param_3 <= param_4) && (param_2 == 0 || param_4 != param_3)) && param_1 != 0
    ...
    iVar14 = 0;
    do {
      pcVar10 = (&PTR_s__init_array_005df850)[lVar12];
      if (pcVar10 != (char *)0x0) {
                ...
                if (local_1a0 == 8) {
                  while( true ) {
                    ...
                    if ((param_3 <= uVar6 && uVar6 < param_4) &&
                       (iVar3 = FUN_0014bbf0(param_2,uVar6,5,0x28,0), iVar3 != 0)) {
                      iVar2 = iVar2 + 1;
                    }
                    uVar6 = lVar11 + 0x10;
                    lVar11 = lVar11 + 8;
    ...
    if ((param_6 != 0 && param_5 != 0) && (lVar12 = FUN_001446e0(), lVar12 != 0)) {
      ppuVar13 = &PTR_s__rodata_005df870;
      do {
        pcVar10 = *ppuVar13;
        if (pcVar10 != (char *)0x0) {
          puVar7 = *(undefined8 **)(param_1 + 0x18);
                  ...
                  if (local_1a0 == 8) {
                    ...
                    while( true ) {
                      ...
                      if ((param_3 <= uVar6 && uVar6 < param_4) &&
                        ...
                        iVar2 = FUN_001447f0(lVar12,param_6 + (uVar6 - param_3),uVar5,uVar6,
                                             auStack_148,1);
                        if ((0 < iVar2) &&
                           (iVar2 = FUN_0014bbf0(param_2,uVar6,5,0x28,0), iVar2 != 0)) {
        ...
        ppuVar13 = ppuVar13 + 1;
      } while (ppuVar13 != &PTR_DAT_005df888);
      FUN_001447a4(lVar12);
    }
  }
