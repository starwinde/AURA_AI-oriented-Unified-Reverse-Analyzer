...
undefined4 FUN_001443e0(long param_1,undefined8 param_2)
...
LAB_001445f4:
              ...
              if (__ptr == (void *)0x0) {
                ...
                iVar2 = FUN_001447f0(lVar4,lVar8,puVar5[3],puVar5[1],__ptr,0x40000);
                FUN_001447a4(lVar4);
                FUN_00144de4(lVar3);
                if (iVar2 < 1) {
                  __fprintf_chk(*(undefined8 *)PTR_stderr_005fffd8,2,
                ...
                lVar3 = FUN_0016fe60(__ptr,(long)iVar2);
                local_60 = lVar3;
                free(__ptr);
                puVar1 = PTR_stdout_005fff40;
                if (lVar3 != 0) {
                  __printf_chk(2,"=== Cross-references for 0x%lx ===\n\n",param_2);
                  FUN_001708e4(local_60,param_2,*(undefined8 *)puVar1);
                  putchar(10);
                  FUN_00170a84(local_60,param_2,*(undefined8 *)puVar1);
                  __printf_chk(2,"\n--- Xref table summary: %u total entries ---\n",
                               *(undefined4 *)(local_60 + 8));
                  FUN_00170490(&local_60);
                  uVar6 = 0;
                  goto LAB_001444a0;
                }
