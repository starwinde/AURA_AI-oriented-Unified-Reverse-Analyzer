...
void FUN_0016bc64(long param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4,
...
LAB_0016bd38:
        ...
        if (((*(int *)((long)puVar5 + 0x24) - 1U < 2) &&
          ...
          if (local_78 != 0) {
            plVar6 = local_70;
            do {
              if (lVar10 == *plVar6) goto LAB_0016bda0;
              plVar6 = plVar6 + 3;
          ...
          if (local_74 <= local_78) {
            ...
            __ptr = local_70;
            if (plVar6 != (long *)0x0) goto LAB_0016bdc0;
            if (local_78 != 0) {
              plVar6 = local_70 + 1;
...
LAB_0016bdc0:
          ...
          *(undefined4 *)(plVar6 + uVar1 * 3 + 2) = 0;
          if ((int)lVar7 + 1U < uVar11) goto LAB_0016bdac;
        }
        else {
LAB_0016bda0:
          if ((int)lVar7 + 1U < uVar11) goto LAB_0016bdac;
        }
        FUN_0016b8e0(param_1,param_2,param_3,&local_70,&local_78,&local_74);
        uVar11 = local_78;
        if (local_78 == 0) {
          free(local_70);
          goto LAB_0016bce4;
