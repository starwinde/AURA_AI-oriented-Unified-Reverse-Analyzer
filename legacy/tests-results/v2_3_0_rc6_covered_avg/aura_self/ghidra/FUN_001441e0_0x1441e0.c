...
void FUN_001441e0(long param_1)
  ...
  if (param_1 == 0) {
    ...
    if (lVar2 == 0) {
      ...
      if (lVar3 == 0) {
        ...
        if (*(uint *)(lVar2 + 0x20) != 0) {
          ...
          do {
            if (((char *)*puVar7 != (char *)0x0) &&
              ...
              lVar6 = 0;
              if ((puVar7[5] != 0) &&
                 (lVar5 = FUN_001446e0(*(undefined4 *)(lVar2 + 0xc)), lVar6 = local_50,
                 lVar3 = local_58, lVar5 != 0)) {
                __ptr = malloc(0x3800000);
                if (__ptr != (void *)0x0) {
                  iVar1 = FUN_001447f0(lVar5,puVar7[5],puVar7[3],puVar7[1],__ptr,0x40000);
                  if (0 < iVar1) {
                    local_50 = FUN_0016fe60(__ptr,(long)iVar1);
                  }
                  free(__ptr);
                }
                FUN_001447a4(lVar5);
        ...
        lVar6 = 0;
LAB_00144274:
        FUN_00170ef4(lVar3,lVar6,*(undefined8 *)PTR_stdout_005fff40);
        if (local_50 != 0) {
          FUN_00170490(&local_50);
        }
        FUN_00170eb4(&local_58);
        FUN_00144de4(lVar2);
        uVar4 = 0;
      }
    }
