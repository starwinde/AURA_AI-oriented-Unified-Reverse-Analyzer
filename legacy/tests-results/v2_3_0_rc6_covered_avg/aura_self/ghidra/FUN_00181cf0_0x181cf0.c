...
void FUN_00181cf0(undefined4 *param_1,FILE *param_2,int param_3)

{
  ...
  case 0:
    ...
    if (param_1[0x28] != 0) {
      do {
        lVar6 = lVar7 * 8;
        lVar7 = lVar7 + 1;
        FUN_00181cf0(*(undefined8 *)(*(long *)(param_1 + 0x26) + lVar6),param_2,param_3);
  ...
  case 1:
    ...
    iVar4 = 0;
    if (iVar5 < 1) {
      fwrite(&DAT_001fd698,1,4,param_2);
      FUN_00181884(*(undefined8 *)(param_1 + 0x26),param_2);
      fwrite(&DAT_001fabe0,1,4,param_2);
      FUN_00181cf0(*(undefined8 *)(param_1 + 0x28),param_2,param_3);
      if (*(long *)(param_1 + 0x2a) == 0) break;
LAB_00182390:
      fwrite("} ELSE {\n",1,9,param_2);
      FUN_00181cf0(*(undefined8 *)(param_1 + 0x2a),param_2,param_3);
      if (iVar5 < 1) break;
    }
    else {
      do {
  ...
  case 2:
    ...
    if (param_3 < 1) {
      ...
      FUN_00181884(*(undefined8 *)(param_1 + 0x26),param_2);
      fwrite(&DAT_001fabe0,1,4,param_2);
      FUN_00181cf0(*(undefined8 *)(param_1 + 0x28),param_2,param_3 + 1);
    }
    else {
      do {
        iVar4 = iVar4 + 1;
  ...
  case 4:
    ...
    if (*(long *)(param_1 + 0x26) != 0) {
      FUN_00181884(*(long *)(param_1 + 0x26),param_2);
    }
    fwrite(&DAT_001fd6d0,1,2,param_2);
    FUN_00181884(*(undefined8 *)(param_1 + 0x28),param_2);
    fwrite(&DAT_001fd6d0,1,2,param_2);
    if (*(long *)(param_1 + 0x2a) != 0) {
      FUN_00181884(*(long *)(param_1 + 0x2a),param_2);
    }
    fwrite(&DAT_001fabe0,1,4,param_2);
    FUN_00181cf0(*(undefined8 *)(param_1 + 0x2c),param_2,param_3 + 1);
    if (0 < iVar5) {
      iVar4 = 0;
      do {
        iVar4 = iVar4 + 1;
...
LAB_00181fcc:
      ...
      do {
        ...
        lVar7 = lVar7 + 1;
        FUN_00181cf0(*(undefined8 *)(*(long *)(param_1 + 0x28) + lVar6 + 0x10),param_2,param_3 + 2);
