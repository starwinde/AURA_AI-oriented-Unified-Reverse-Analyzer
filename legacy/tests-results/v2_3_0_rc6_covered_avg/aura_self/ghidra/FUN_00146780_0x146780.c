...
void FUN_00146780(long param_1,long param_2,ulong param_3,ulong param_4)
              ...
              do {
                ...
                if (*(int *)(param_2 + uVar21) == 0x1000000) {
                  if ((0x37 < param_3) && (uVar21 <= param_3 - 0x38)) {
                    iVar12 = FUN_00146764(param_2,1,uVar21 + 0x30);
                    goto LAB_001471fc;
                  }
                }
                else if ((0x47 < param_3 && *(int *)(param_2 + uVar21) == 0x19000000) &&
                        (uVar21 <= param_3 - 0x48)) {
                  iVar12 = FUN_00146764(param_2,1,uVar21 + 0x40);
LAB_001471fc:
...
LAB_00146924:
              if (uVar18 == 0) goto LAB_00146c80;
LAB_00146928:
              pvVar13 = calloc((ulong)uVar18,0x38);
              *(void **)(param_1 + 0x18) = pvVar13;
              if (pvVar13 == (void *)0x0) goto LAB_00146a68;
            }
            else {
              if (0x37 < param_3) {
                uVar10 = 0;
                ...
                do {
                  ...
                  if (*(int *)(param_2 + uVar21) == 1) {
                    if (uVar21 <= param_3 - 0x38) {
                      iVar12 = FUN_00146764(param_2,0,uVar21 + 0x30);
                      goto LAB_00147310;
                    }
                  }
                  else if ((0x47 < param_3 && *(int *)(param_2 + uVar21) == 0x19) &&
                          (uVar21 <= param_3 - 0x48)) {
                    iVar12 = FUN_00146764(param_2,0,uVar21 + 0x40);
LAB_00147310:
                    uVar18 = uVar18 + iVar12;
                    if (0x200 < uVar18) {
                      uVar18 = 0x200;
              ...
              if (uVar19 == 1) {
                if ((0x37 < param_3) && (uVar32 <= param_3 - 0x38)) {
                  ...
                  for (lVar20 = param_2 + uVar32 + 0x38;
                    ...
                    uVar14 = FUN_00146420(lVar20 + 0x10);
...
LAB_001471c0:
                *(undefined4 *)(param_1 + 0x30) = 0;
                ...
                if (param_3 - lVar20 < (ulong)local_ec) goto LAB_001471c0;
                if (uVar11 < uVar33) {
                  uVar33 = uVar11;
                }
                uVar10 = 0;
                uVar18 = 0;
                do {
                  uVar11 = FUN_00146764(param_2,uVar1 == 0xcefaedfe,uVar30);
                  ...
                  if (uVar3 == 0xfeedfacf || uVar3 == 0xcffaedfe) {
                    ...
                    uVar32 = FUN_00146764(param_2,uVar1 == 0xcefaedfe,uVar30 + 8);
                  ...
                  if (((uVar11 != 0 && uVar11 < (uint)local_f8) && bVar6 < 0x20) &&
                    ...
                    if (sVar16 < param_3 - uVar21) {
                      ...
                      if ((bVar6 & (bVar6 & 0xe) == 0) == 0) {
                        if ((bVar6 & 0xe) != 0xe) goto LAB_00146bac;
                        uVar24 = 1;
                      }
                      else {
                        uVar11 = 1;
