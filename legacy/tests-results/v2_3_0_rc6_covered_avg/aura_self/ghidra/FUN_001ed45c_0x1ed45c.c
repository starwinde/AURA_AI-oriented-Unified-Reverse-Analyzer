...
bool FUN_001ed45c(long *param_1)

{
  ...
  if (*(int *)(*param_1 + 8) == 0x1f9) {
    bVar2 = FUN_001e8184(*(undefined8 *)(*param_1 + 0xa8));
    ...
    if (uVar1 != 0x65) {
      ...
      if (uVar1 != 0x25) {
        ...
        *(undefined1 *)(param_1 + 5) = 0;
        cVar3 = FUN_001e7d38(*(undefined4 *)*param_1);
        return cVar3 == '@';
      }
    }
    *(undefined1 *)(param_1 + 5) = 0;
  ...
  cVar3 = FUN_001f2720(*(undefined4 *)(*param_1 + 0x34));
  cVar4 = FUN_001f2720(*(undefined4 *)(*param_1 + (long)(int)(uint)bVar2 * 0x40 + 0x34));
  if ((cVar3 < '\b') && ('\a' < cVar4)) {
    param_1[1] = param_1[1] + 10;
    FUN_001f2c14(*(byte *)(param_1[1] + 6) & 7,*(undefined2 *)param_1[1],param_1 + 2);
    lVar5 = FUN_001f2e04(param_1[2]);
    param_1[3] = lVar5;
    return true;
  }
  return false;
