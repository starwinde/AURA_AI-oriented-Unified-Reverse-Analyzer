...
void FUN_001ccc60(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((uVar7 & 1) == 0) {
      ...
      if (*(int *)(lVar8 + 0x60) != 0) {
        if ((*(byte *)(lVar8 + 0x6c) & 1) == 0) {
          if ((*(byte *)(lVar8 + 0x6d) & 1) == 0) {
            ...
            lVar8 = FUN_001dbcf0(lVar8,uVar5);
    ...
    iVar4 = FUN_00190080(uVar6);
    FUN_00190370(param_3,&DAT_002b3bf0 + *(ushort *)(&DAT_002b4900 + (ulong)(iVar4 - 1) * 2));
    ...
    if (*(int *)(lVar10 + 0x60) != 0) {
      if ((*(byte *)(lVar10 + 0x6c) & 1) == 0) {
        ...
        uVar5 = FUN_0018ffb0(param_1);
        bVar1 = *(byte *)(param_1 + 0x366);
        lVar10 = FUN_001dbcf0(lVar10,uVar5);
        lVar8 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
