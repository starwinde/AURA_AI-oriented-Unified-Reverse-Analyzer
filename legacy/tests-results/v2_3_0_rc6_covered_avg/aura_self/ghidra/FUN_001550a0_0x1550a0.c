...
undefined1  [16] FUN_001550a0(uint *param_1,long param_2,uint param_3)

{
  ...
  if (uVar3 < 0xf) {
    ...
    if (param_1[0x12] == 0) goto LAB_0015510c;
    uVar3 = param_1[6];
  }
  else {
    if (uVar3 == 0x1b) {
        ...
        do {
          if (*puVar11 < param_3) {
            ...
            if ((int)uVar8 == 0) {
              ...
              if (((int)uVar8 != 2 && uVar3 != 2) && (lVar12 == lVar13)) goto LAB_00155208;
              lVar12 = 0;
              uVar8 = 2;
              break;
            }
...
LAB_00155208:
    ...
    if ((((uVar3 != 0x1c) || (param_1[0x12] < 3)) || (param_3 <= param_1[6])) ||
       (lVar12 = (ulong)param_1[6] * 0x10, *(int *)(param_2 + lVar12) != 1)) goto LAB_0015510c;
