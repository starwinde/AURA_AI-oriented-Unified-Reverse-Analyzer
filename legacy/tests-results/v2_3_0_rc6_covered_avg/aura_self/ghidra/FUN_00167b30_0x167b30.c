...
void FUN_00167b30(long param_1,long param_2,ulong param_3,long param_4,undefined8 *param_5)

{
  ...
  FUN_00176034(&local_130,param_2,param_3,iVar3,0);
  lVar19 = FUN_00176fd0(param_2,param_3,param_4,iVar3,&local_130,0);
  local_138 = lVar19;
    ...
    if (local_12c != 0) {
      if (local_130 == 5) {
        ...
        if (local_130 == 3) {
          ...
          if (local_130 != 4) goto LAB_00167c44;
          ppuVar35 = &PTR_DAT_00600190;
          ppuVar34 = &PTR_DAT_006001c0;
          uVar36 = 8;
          bVar14 = true;
          uVar51 = 6;
        }
        ...
        if (local_130 != 7) goto LAB_00167c44;
        ppuVar35 = &PTR_DAT_00600230;
        uVar36 = 8;
        ppuVar34 = &PTR_DAT_00600270;
        uVar51 = 8;
        bVar14 = true;
      }
      uVar15 = local_12c;
      ...
      uVar38 = 0;
      uVar32 = (ulong)uVar30;
      if (uVar30 < uVar51) goto LAB_001693ec;
LAB_00168508:
      uVar37 = 8;
...
LAB_00169174:
                  ...
                  if (iVar18 < iVar16) {
                    ...
                    if (iVar17 != 0) goto code_r0x00169170;
        ...
        do {
          while (puVar31 = (undefined8 *)(*(long *)(lVar19 + 0x18) + lVar44),
            ...
            *(uint *)(puVar40 + 0x1a) = uVar30;
            ...
            uVar30 = *(uint *)(lVar19 + 0x20);
            if (uVar30 <= uVar51) goto joined_r0x00167df4;
          }
          uVar51 = uVar51 + 1;
          lVar44 = lVar44 + 0x30;
        } while (uVar51 < uVar30);
...
LAB_00168128:
          ...
          lVar19 = 1;
          ppuVar35 = &PTR_DAT_005dfe00;
          pcVar42 = PTR_DAT_005dfe40;
          pcVar46 = local_1e8;
          pcVar27 = (char *)&local_90;
          if (PTR_DAT_005dfe40 == (undefined *)0x0) goto LAB_00168300;
LAB_001681a8:
...
LAB_00168220:
          ...
          do {
            ...
            if (pcVar21 == (char *)0x0) {
              if (!bVar49) goto joined_r0x001682ec;
              bVar8 = false;
              goto LAB_00168290;
            }
            pcVar29 = pcVar21 + sVar25;
...
LAB_00168290:
          ...
          if (((iVar16 == 0) || (iVar16 = strncmp(pcVar45,pcVar46,2), iVar16 == 0)) && (!bVar14)) {
            if ((*pcVar27 == '\0') && (pcVar29 = strchr(pcVar45,0x2c), pcVar29 != (char *)0x0)) {
              ...
              do {
                ...
                if (pcVar28 == (char *)0x0) {
                  if (pcVar46 == (char *)0x0) goto LAB_001696b4;
                  sVar25 = strlen(pcVar46);
                  pcVar42 = pcVar29;
                  goto LAB_00169c64;
                }
      ...
      local_78 = 0;
      uVar32 = uVar39;
      if (uVar39 == 0) goto LAB_0016833c;
      goto LAB_00168098;
    }
    goto LAB_00167df8;
  }
  FUN_00178844(&local_138);
  uVar33 = 2;
  goto LAB_00167e48;
LAB_00169f50:
  if (iVar16 <= iVar18) goto code_r0x00169f5c;
  iVar17 = strcmp(local_218,(char *)&local_88);
  local_218 = local_218 + 0x10;
  if (iVar17 == 0) goto joined_r0x00168688;
  iVar18 = iVar18 + 1;
  goto LAB_00169f50;
code_r0x00169f5c:
  if (iVar16 < 8) {
    ...
    if (pcVar45 == (char *)0x0) {
      bVar11 = false;
      if (pcVar48 != (char *)0x0) goto LAB_00168700;
LAB_0016919c:
      pcVar27 = acStack_118;
      do {
        ...
        while (pbVar26 = (byte *)strstr((char *)pbVar24,pcVar27), pbVar26 != (byte *)0x0) {
          ...
          if (((pbVar26 <= __s) ||
            ...
            bVar11 = bVar8;
            if (pcVar27 != (char *)0x0) goto LAB_00169448;
            goto LAB_00169234;
          }
        }
        pcVar27 = pcVar27 + 0x10;
...
LAB_0016868c:
    ...
    do {
      ...
      if (pbVar26 == (byte *)0x0) goto LAB_00169188;
      pbVar24 = pbVar26 + sVar25;
    } while (((__s < pbVar26) &&
...
joined_r0x00168688:
    if (pcVar45 != (char *)0x0) goto LAB_0016868c;
LAB_00169188:
    bVar11 = false;
    if (pcVar48 == (char *)0x0) {
LAB_00169190:
      bVar11 = bVar8;
      if (iVar16 < 1) goto LAB_0016933c;
      goto LAB_0016919c;
    }
LAB_00168700:
            ...
            if (((iVar18 == 0) || (iVar18 = strcmp((char *)pbVar24,"strh"), iVar18 == 0)) ||
              ...
              if (iVar18 != 0) {
                ...
                if (iVar18 != 0) {
                  ...
                  bVar12 = true;
                  if (iVar18 != 0) goto LAB_00169234;
                }
                bVar6 = *__s;
                if (bVar6 != 0x77) {
                  if (bVar6 < 0x78) {
                    if (bVar6 == 0x57) goto LAB_00169c44;
                    if (bVar6 != 0x58) {
                      bVar12 = true;
                      goto LAB_00169234;
                    }
                    ...
                    bVar12 = true;
                    if (bVar6 != 0x78) goto LAB_00169234;
                  }
                  uVar51 = 8;
                  goto LAB_001695c0;
                }
...
LAB_0016933c:
  ...
  __s = __s + 0xe0;
  bVar8 = bVar11;
  if (uVar32 <= uVar50) goto code_r0x0016934c;
  goto LAB_00168668;
code_r0x00169170:
...
code_r0x0016934c:
  ...
  if (bVar49) {
    if ((!bVar8) && (bVar14)) goto LAB_00169794;
  }
  else {
LAB_00169784:
...
LAB_00169390:
  ...
  if (uVar39 == uVar15) goto LAB_00169878;
  uVar30 = *(uint *)(puVar20 + 1);
  uVar51 = *(uint *)((long)puVar20 + 0xc);
  uVar38 = (undefined4)uVar39;
  uVar32 = (ulong)uVar30;
  if (uVar51 <= uVar30) goto LAB_00168508;
LAB_001693ec:
  pvVar23 = (void *)*puVar20;
  goto LAB_00168548;
...
LAB_00169c64:
    ...
    if (pcVar21 == (char *)0x0) goto LAB_001696b4;
  }
LAB_001696a8:
  (&cStack_99)[lVar19] = '\x01';
LAB_001696b4:
...
joined_r0x001682ec:
  do {
    ...
    if (lVar19 == 9) {
      pcVar45 = pcVar45 + 0xe0;
      if (pcVar45 != pcVar48) goto LAB_00168128;
      goto LAB_0016833c;
    }
    pcVar27 = pcVar27 + 1;
    ppuVar35 = ppuVar35 + 1;
    ...
    if (pcVar42 != (char *)0x0) goto LAB_001681a8;
LAB_00168300:
    puVar22 = *ppuVar35;
joined_r0x00169824:
    bVar49 = false;
...
LAB_00169b38:
        do {
          ...
          do {
            ...
            if (pcVar48 == (char *)0x0) goto LAB_00169bfc;
            pcVar46 = pcVar48 + 3;
...
LAB_00168b78:
          do {
            ...
            do {
              ...
              if (pcVar48 == (char *)0x0) goto LAB_00168c3c;
              pcVar46 = pcVar48 + 2;
            } while (((pcVar42 < pcVar48) &&
                     ((byte)(pcVar48[-1] + 0x9fU) < 0x1a || (byte)(pcVar48[-1] - 0x30U) < 10)) ||
...
LAB_00168c3c:
      ...
      pcVar45 = "int";
      pcVar48 = pcVar45;
      if (param_3 != 0) goto LAB_00168aa8;
    }
LAB_00168b00:
...
LAB_00167e0c:
    uVar13 = DAT_001fa44c;
    *(undefined4 *)(puVar20 + 2) = DAT_001fa448;
