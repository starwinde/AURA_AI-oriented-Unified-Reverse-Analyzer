...
void FUN_0018d2d4(int *param_1,long *param_2,ulong *param_3,long *param_4,int *param_5)
    ...
    *(long *)(param_5 + 2) = local_110;
    ...
    if ((uVar4 & 1) != 0) {
      ...
      *(ushort *)(local_118 + 4) = local_632;
      ...
      FUN_0018c330(param_1,param_5,auStack_630,auStack_428,*(undefined8 *)(param_1 + 0x12),*param_2)
      ;
      if (*param_1 == 3) {
      ...
      if ((ulong)bVar1 <= *param_3) {
        ...
        if (*(code **)(param_1 + 0x24) == (code *)0x0) {
          ...
          *(short *)(param_5 + 4) = (short)__n;
          ...
          puVar11 = (undefined1 *)*param_2;
LAB_0018d42c:
          iVar2 = FUN_001907d0((long)param_5 + 0x4a,0xa0,"0x%02x",*puVar11);
          lVar6 = (long)param_5 + 0x4a + (long)iVar2;
          lVar9 = 0xa0 - (long)iVar2;
          if (__n != 1) {
            puVar10 = puVar11 + 1;
            do {
              iVar2 = FUN_001907d0(lVar6,lVar9,", 0x%02x",*puVar10);
