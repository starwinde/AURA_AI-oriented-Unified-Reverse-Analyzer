...
void FUN_001923e4(long param_1,undefined8 param_2)

{
  ...
  uVar9 = FUN_0018ffd0(param_1,0);
  uVar10 = FUN_0018ffd0(param_1,1);
  lVar17 = *(long *)(param_1 + 800);
  if (*(int *)(lVar17 + 0x60) == 0) {
    iVar5 = FUN_00190080(uVar10);
  }
  else {
    ...
    *(undefined1 *)(lVar15 + 200) = uVar2;
    ...
    pcVar12 = (char *)FUN_001e68d4(lVar17,uVar6,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98)
    ;
    if (pcVar12 == (char *)0x0) {
      local_50[0] = 0;
    }
...
LAB_00192778:
              ...
              if (((((uVar1 != 1) &&
                ...
                a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar12 + (uVar14 - 0xef)),_DAT_0020c6e0);
              }
              uVar7 = uVar8 & 0xf0;
              if ((uVar8 & 0xf) != 0) {
                uVar8 = uVar13 - uVar7;
                uVar11 = (ulong)((uVar8 & 0xff) + 1 & 0xff);
                if (6 < (uVar8 & 0xff)) goto LAB_0019273c;
                goto LAB_00192778;
              }
            }
          }
            ...
            do {
              ...
              while (cVar3 != -0x80) {
                ...
                *pcVar4 = cVar3;
                pcVar12 = pcVar12 + -1;
                uVar8 = uVar1 & 0xff;
                if (uVar13 < (uVar1 & 0xff)) goto LAB_00192868;
                pcVar4 = pcVar4 + 1;
                cVar3 = *pcVar12;
              }
              uVar1 = uVar8 + 1;
...
LAB_00192868:
  ...
  if (iVar5 != 0) {
    FUN_00190d40(param_1,1,param_2);
    FUN_00190370(param_2,&DAT_001fde10);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      uVar8 = FUN_001e6bd4(iVar5);
      lVar17 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
      *(uint *)(lVar17 + (ulong)*(byte *)(lVar17 + 0xa0) * 0x30 + 0xb0) = uVar8 & 0xffff;
      uVar11 = FUN_00190030(uVar9);
      goto joined_r0x001928f0;
    }
  }
  uVar11 = FUN_00190030(uVar9);
joined_r0x001928f0:
  if ((uVar11 & 1) != 0) {
    uVar11 = FUN_001900a0(uVar9);
    lVar17 = *(long *)(param_1 + 800);
    if (*(int *)(lVar17 + 0x60) != 0) {
      lVar15 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
    ...
    if ((long)uVar11 < 0) {
      FUN_001903f0(param_2,"0x%lx",
                   uVar11 & *(ulong *)(PTR_DAT_005ffe50 + (ulong)*(uint *)(lVar17 + 4) * 8));
    }
    else if ((long)uVar11 < 10) {
      FUN_001903f0(param_2,&DAT_001fba60);
    }
    else {
      FUN_001903f0(param_2,"0x%lx");
    }
