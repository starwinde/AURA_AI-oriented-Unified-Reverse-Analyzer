...
bool FUN_0017e050(long *param_1,undefined4 *param_2)
        ...
        do {
          ...
          if ((*(int *)(*(long *)(lVar1 + 8) + lVar22) == 4) && (1 < (uint)puVar2[0x12])) {
            ...
            while( true ) {
              ...
              puVar12 = puVar10 + (ulong)uVar16 * 10;
              do {
                if (*(uint *)(puVar10 + 1) != 0) {
                  piVar8 = (int *)*puVar10;
                  piVar11 = piVar8 + (ulong)*(uint *)(puVar10 + 1) * 0x24;
LAB_0017e110:
                  if ((*piVar8 != 1) || (iVar4 != piVar8[2])) goto LAB_0017e104;
                  ...
                  if ((0 < (long)uVar21) && ((uVar21 - 1 & uVar21) == 0)) {
                    ...
                    *(int *)(param_1 + 2) = iVar5 + 1;
                    if (uVar16 <= uVar13) {
                      uVar16 = uVar16 << 1;
                      __ptr = realloc(__ptr,(ulong)uVar16 * 0x90);
                      if (__ptr != (void *)0x0) {
                        uVar13 = *(uint *)(lVar1 + 0x10);
                        *(void **)(lVar1 + 8) = __ptr;
...
LAB_0017e1d8:
                    ...
                    uVar20 = uVar20 + 1;
                    memmove((void *)((long)__ptr + (ulong)uVar20 * 0x90),
                            (void *)((long)__ptr + lVar22),(ulong)uVar13 * 0x90);
...
LAB_0017e104:
  piVar8 = piVar8 + 0x24;
  if (piVar11 == piVar8) goto LAB_0017e2b8;
  goto LAB_0017e110;
}
