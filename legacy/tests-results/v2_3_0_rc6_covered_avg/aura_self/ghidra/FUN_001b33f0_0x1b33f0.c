...
void FUN_001b33f0(long param_1,undefined8 param_2)

{
  ...
  if ((uVar1 >> 5 & 1) == 0) {
    ...
    if (uVar4 < 10) {
      FUN_001903f0(param_2,", lsl #%u",uVar4);
    }
    else {
      FUN_001903f0(param_2,", lsl #0x%x",uVar4);
    }
  ...
  if (uVar4 == 0) {
    uVar4 = 0x20;
LAB_001b3428:
    FUN_001903f0(param_2,", asr #0x%x",uVar4);
  }
  else {
    if (9 < uVar4) goto LAB_001b3428;
    FUN_001903f0(param_2,", asr #%u",uVar4);
  }
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
    return;
  }
