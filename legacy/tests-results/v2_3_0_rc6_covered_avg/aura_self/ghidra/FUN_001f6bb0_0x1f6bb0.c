...
void FUN_001f6bb0(long param_1,int param_2)
...
LAB_001f6c18:
  ...
  if (plVar4 == (long *)0x0 || lVar2 == 0) {
    if (plVar4 == (long *)0x0) goto LAB_001f6c18;
  }
  else {
    do {
      plVar1 = (long *)*plVar1;
    ...
    if (plVar1 == (long *)0x0) goto LAB_001f6c14;
    if (plVar4 != plVar1) {
      plVar3 = (long *)plVar1[1];
      if (plVar3 == (long *)0x0) goto LAB_001f6c18;
      lVar2 = *plVar1;
      *plVar3 = lVar2;
      if (lVar2 == 0) {
