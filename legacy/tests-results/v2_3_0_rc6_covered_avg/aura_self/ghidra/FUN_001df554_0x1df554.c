...
undefined4 FUN_001df554(char *param_1,code *param_2,undefined8 param_3,long param_4,int param_5)
  ...
  if (param_5 == 2) {
    ...
    *(long *)(param_1 + 0x58) = lVar17;
    if ((local_6e & 0xf0) == 0x40) {
      ...
      if (local_6e < 0x68) {
        if (uVar12 < 0x2e) {
          if (local_6e != 0x26) goto LAB_001e0970;
        }
...
LAB_001e0970:
      ...
      else if ((local_6e != 0xf0) && (1 < (uVar12 + 0xe & 0xff))) goto LAB_001e0970;
    }
    else {
      param_2 = *(code **)(param_1 + 0x48);
      param_3 = *(undefined8 *)(param_1 + 0x50);
  ...
  lVar17 = lVar14 + 1;
  *(long *)(param_1 + 0x58) = lVar17;
  if (lVar14 != *(long *)(param_1 + 0x68)) goto LAB_001df628;
...
LAB_001df630:
    if (uVar12 < 0x2e) {
      ...
      if ((1L << ((ulong)(uVar12 - 0x2e) & 0x3f) & 0xc0000000010101U) == 0) {
        if (uVar12 == 0x67) {
          ...
          if (uVar12 != 0x66) {
            ...
            if (uVar12 != 0x62) {
              iVar5 = *(int *)(param_1 + 0x60);
              if (iVar5 != 2) goto LAB_001dfa04;
              if (0xf < (uVar12 - 0x40 & 0xff)) goto LAB_001e0ecc;
              iVar5 = (**(code **)(param_1 + 0x48))
                                (*(undefined8 *)(param_1 + 0x50),&local_6d,lVar17);
              if (iVar5 != 0) goto switchD_001e0be8_caseD_10;
              iVar5 = *(int *)(param_1 + 0x60);
      ...
      if (uVar12 == 0x3e) {
        ...
        if (uVar12 == 0x2e) goto LAB_001df9d0;
        if (uVar12 != 0x36) goto switchD_001e0be8_caseD_10;
        uVar13 = 2;
      }
      else if (uVar12 == 100) {
        uVar13 = 5;
        ...
        if (uVar12 != 0x65) goto switchD_001e0be8_caseD_10;
        uVar13 = 6;
      }
    }
LAB_001df9d0:
...
LAB_001df628:
    if (uVar12 < 0x68) goto LAB_001df630;
    if (uVar12 == 0xf0) goto LAB_001e0704;
  }
  else {
    if (local_6e != 0xf3) {
...
LAB_001df90c:
        ...
        goto switchD_001e0be8_caseD_10;
      }
      goto LAB_001df628;
    }
    ...
    if (*(int *)(param_1 + 0x60) != 2) goto LAB_001df994;
    if ((byte)(local_6d - 0x40) < 0x10) goto LAB_001df90c;
  }
  if (1 < (uVar12 + 0xe & 0xff)) goto LAB_001e0e44;
LAB_001df994:
  FUN_001de2f4(param_1,uVar12);
  param_5 = *(int *)(param_1 + 0x60);
  param_1[1] = local_6e;
LAB_001df68c:
  param_2 = *(code **)(param_1 + 0x48);
...
LAB_001dfe20:
    ...
    *(long *)(param_1 + 0x70) = *(long *)(param_1 + 0x58) - *(long *)(param_1 + 0x68);
    if ((ulong)(*(long *)(param_1 + 0x58) - *(long *)(param_1 + 0x68)) < 0x10) {
      ...
      *(undefined **)(param_1 + 0xd0) = &DAT_003e5020 + (ulong)**(ushort **)(param_1 + 0x90) * 0xc;
      goto LAB_001df5c8;
    }
  }
  goto switchD_001e0be8_caseD_10;
...
LAB_001df784:
    ...
    if (iVar7 == 3) {
      ...
      if (uVar12 != 2) {
        if (uVar12 == 3) goto LAB_001df7c8;
LAB_001e0208:
        bVar3 = uVar12 != 1;
        uVar12 = 1;
        if (bVar3) goto switchD_001e0be8_caseD_10;
      }
LAB_001e0210:
...
LAB_001df7c8:
      ...
      if (iVar7 == 1) goto LAB_001df7c8;
      if (iVar7 != 4) goto LAB_001dfa20;
      ...
      if (bVar10 == 9) {
        ...
        if (bVar10 != 10) {
          if (bVar10 != 8) goto switchD_001e0be8_caseD_10;
          goto LAB_001df7c8;
        }
        pcVar16 = *(code **)(param_1 + 0x48);
        uVar13 = 6;
    ...
    *(long *)(param_1 + 0x58) = *(long *)(param_1 + 0x58) + 1;
    ...
    if (uVar12 == 0xc5) {
      ...
      if ((iVar5 == 2) || (((byte)local_6a & 0xc0) == 0xc0)) {
        ...
        iVar7 = *(int *)(param_1 + 0x78);
        *(long *)(param_1 + 0x58) = *(long *)(param_1 + 0x58) + -1;
        if (iVar7 != 1) goto joined_r0x001e0188;
      }
      param_1[0x3c] = local_6e;
      iVar5 = (**(code **)(param_1 + 0x48))(*(undefined8 *)(param_1 + 0x50),param_1 + 0x3d);
      if (iVar5 == 0) {
...
LAB_001dfd74:
      if (iVar5 == 0) goto LAB_001df750;
      if (iVar5 == 1) goto LAB_001e0194;
      if (iVar5 == 2) goto LAB_001dfd88;
      goto LAB_001df784;
    }
    if (uVar12 == 0x8f) {
      iVar5 = (**(code **)(param_1 + 0x48))(*(undefined8 *)(param_1 + 0x50),&local_6a);
  ...
  if (iVar5 == 0) {
    ...
    if (bVar10 == 0) {
      ...
      if (*(int *)(param_1 + 0x84) == 0) {
        ...
        if (cVar11 == -0xe) goto LAB_001e0500;
        uVar19 = uVar12 | 2;
        if (cVar11 != -0xd) {
          uVar19 = uVar12;
        }
...
LAB_001dfb34:
      if ((*(ulong *)(param_1 + 0x80) & 0xffffffff0000ff00) != 0x20000f800 &&
        ...
        iVar5 = FUN_001deec4(&local_6c,param_1,uVar12);
        if (iVar5 != 0) goto switchD_001e0be8_caseD_10;
        if ((*(int *)(param_1 + 0x60) == 0) || ((param_1[0x38] & 1U) != 0)) {
          uVar6 = (uint)local_6c;
          puVar20 = &DAT_003dd8b0 + (ulong)local_6c * 2;
          if ((uVar12 >> 4 & 1) != 0) goto LAB_001e0268;
          iVar5 = FUN_001deec4(&local_6a,param_1,uVar12 | 0x10);
          if (iVar5 == 0) {
            uVar1 = *(ushort *)(&DAT_00366870 + (ulong)local_6c * 2);
            if ((uVar1 - 1 & 0xffff) < 0x62b) {
              puVar9 = &DAT_0036dfe0 + (ulong)uVar1 * 4;
              while (local_6c == *(ushort *)(puVar9 + -4)) {
                if ((uint)*(ushort *)(puVar9 + -2) == (uint)local_6a) {
                  if ((*(int *)(param_1 + 0x60) == 0) != (bool)param_1[0x38]) {
                    puVar20 = &DAT_003dd8b0 + (ulong)local_6a * 2;
                    uVar6 = (uint)local_6a;
                  }
                  break;
                }
                puVar9 = puVar9 + 4;
                if (puVar9 == &DAT_0036f890 + ((long)(int)-(uint)uVar1 + (ulong)uVar1) * 4) break;
              }
            }
          }
        }
...
LAB_001e0268:
          ...
          if (((*(ulong *)(param_1 + 0x80) & 0xffffffff0000ff00) != 0x9000) ||
            ...
            *(undefined **)(param_1 + 0x90) = puVar20;
            goto LAB_001dfbbc;
          }
          param_1[0x81] = -0x6f;
          iVar5 = FUN_001deec4(&local_6a,param_1,uVar12);
          if (iVar5 == 0) {
            uVar6 = (uint)local_6a;
            puVar20 = &DAT_003dd8b0 + (ulong)local_6a * 2;
          }
    ...
    iVar5 = FUN_001deec4(&local_6c,param_1,uVar6);
    if (iVar5 != 0) goto switchD_001e0be8_caseD_10;
    uVar6 = (uint)local_6c;
    *(ushort *)(param_1 + 0x88) = local_6c;
    *(undefined **)(param_1 + 0x90) = &DAT_003dd8b0 + (ulong)local_6c * 2;
  }
  else {
    if (iVar5 == 3) {
...
LAB_001dfa9c:
      bVar4 = param_1[0x3e];
      bVar10 = bVar4 & 3;
      if (bVar10 != 2) goto LAB_001dfaac;
LAB_001e0548:
      uVar6 = uVar12 | 0x42;
    }
    else {
      if (iVar5 != 1) {
        if (iVar5 != 4) goto switchD_001e0be8_caseD_10;
        goto LAB_001dfa9c;
      }
      bVar4 = param_1[0x3d];
      bVar10 = bVar4 & 3;
      if (bVar10 == 2) goto LAB_001e0548;
LAB_001dfaac:
      if (bVar10 == 3) {
        uVar6 = uVar12 | 0x44;
      }
...
LAB_001dfad8:
    ...
    if (iVar7 != 0) {
      uVar6 = uVar12;
      if (iVar7 != 2) goto LAB_001dfb14;
LAB_001e01b0:
      iVar5 = *(int *)(param_1 + 0x84);
      if ((param_1[0x38] & 1U) == 0) goto LAB_001dfb20;
      bVar10 = param_1[0x81];
      if (bVar10 < 0x90) {
        if ((bVar10 < 0x82) || (iVar5 != 1)) goto LAB_001dfb20;
LAB_001e01dc:
        uVar12 = uVar12 ^ 0x10;
        param_1[0x7e] = '\x04';
        param_1[0x7f] = '\x04';
        ...
        if (1 < (byte)(bVar10 + 0x18)) goto LAB_001dfb20;
        if (iVar5 == 0) goto LAB_001e01dc;
      }
      goto LAB_001dfb34;
    }
    uVar6 = uVar12 ^ 0x20;
...
LAB_001dfb14:
    if (iVar5 == 0) goto LAB_001dfb18;
    iVar5 = FUN_001deec4(&local_6c,param_1,uVar6);
    if (iVar5 != 0) goto switchD_001e0be8_caseD_10;
    if (((2 < *(int *)(param_1 + 0x78) - 2U) || (-1 < param_1[0x3e])) ||
       ((iVar5 = FUN_001deec4(&local_6a,param_1,uVar6 | 8), uVar2 = local_6a, uVar1 = local_6c,
        iVar5 == 0 &&
        ((uVar12 = FUN_001e5400(local_6a), uVar1 = uVar2, uVar12 != 0xffffffff &&
         (PTR_DAT_005ffee0[((ulong)uVar12 * 4 + (ulong)uVar12) * 0x10 + 4] != '\0')))))) {
      iVar5 = *(int *)(param_1 + 0x84);
      uVar12 = uVar6;
      goto LAB_001dfb20;
    }
    ...
    *(undefined **)(param_1 + 0x90) = &DAT_003dd8b0 + (ulong)uVar1 * 2;
  }
LAB_001dfbbc:
  if (uVar6 != 0) {
          ...
          if (uVar6 < 0x13d) {
            ...
            if (uVar6 < 0x2c8) {
              if (uVar6 < 0x2bf) {
                ...
                if (0x21 < uVar12) goto switchD_001e0be8_caseD_10;
...
joined_r0x001e0310:
              if ((uVar8 & 1) != 0) goto LAB_001dfc18;
            }
          }
          else {
...
LAB_001df958:
        ...
        if (uVar6 == 0x3b5d) goto LAB_001dfc18;
        uVar12 = uVar6 - 0x3b5f & 0xffff;
        if (0x3d < uVar12) goto switchD_001e0be8_caseD_10;
        uVar8 = 0x271389c4e0029215 >> ((ulong)uVar12 & 0x3f);
      }
joined_r0x001e0938:
      if ((uVar8 & 1) == 0) goto switchD_001e0be8_caseD_10;
    }
LAB_001dfc18:
    iVar5 = *(int *)(param_1 + 0x78);
    if (iVar5 == 3) {
...
LAB_001e0bb0:
          ...
          uVar8 = (ulong)uVar1;
          bVar10 = (&DAT_003e5020)[((uVar8 * 2 + (ulong)uVar1) * 2 + (long)iVar5) * 2];
          if (0x21 < bVar10) goto switchD_001e0be8_caseD_10;
          uVar12 = (uint)bVar10;
          switch(bVar10) {
          case 0:
          case 0x1a:
          ...
          case 0x20:
          case 0x21:
            goto switchD_001e0be8_caseD_0;
          default:
            iVar5 = FUN_001dea60(param_1);
            if ((iVar5 == 0) &&
               (iVar5 = FUN_001de5b0(param_1,&DAT_003e5020 + (lVar17 + (ulong)uVar1 * 6) * 2),
               iVar5 == 0)) {
          ...
          case 0xf:
            ...
            if ((iVar7 == 0) && ((*(int *)(param_1 + 0xc4) - 0x15U & 0xffffffef) == 0)) {
              ...
              cVar11 = (&DAT_003e5021)[(uVar8 * 6 + (long)iVar5) * 2];
              if (cVar11 == '\r') {
                ...
                if (cVar11 != '\f') goto switchD_001e0be8_caseD_10;
          ...
          case 0x12:
            ...
            iVar7 = FUN_001de0d0(param_1,1);
            if (iVar7 != 0) goto switchD_001e0be8_caseD_10;
            bVar3 = (byte)((&DAT_003e5021)[(uVar8 * 6 + (long)iVar5) * 2] - 0x14) < 2;
            goto switchD_001e0be8_caseD_0;
          case 0x13:
            iVar5 = FUN_001de0d0(param_1,2);
            break;
          case 0x14:
            iVar5 = FUN_001de0d0(param_1,4);
            break;
          case 0x15:
            iVar5 = FUN_001de0d0(param_1,8);
            break;
          case 0x16:
            iVar5 = FUN_001de000(param_1,1);
            break;
          case 0x17:
            iVar5 = FUN_001de000(param_1,2);
            break;
          case 0x18:
            iVar5 = FUN_001de000(param_1,4);
            break;
          case 0x19:
            iVar5 = FUN_001de000(param_1,8);
            break;
          case 0x1b:
            iVar5 = FUN_001de0d0(param_1,param_1[0x7f]);
            break;
          case 0x1c:
            iVar5 = FUN_001de0d0(param_1,param_1[0x7d]);
            if (iVar5 == 0) {
          ...
          case 0x1d:
            ...
            goto switchD_001e0be8_caseD_0;
          case 0x1e:
            iVar5 = FUN_001de000(param_1,0);
          }
          if (iVar5 != 0) goto switchD_001e0be8_caseD_10;
switchD_001e0be8_caseD_0:
          lVar17 = lVar17 + 1;
          if (lVar17 == 6) goto LAB_001dfe20;
          goto LAB_001e0bb0;
        }
      }
...
LAB_001dfc7c:
    ...
    case 0x20:
    case 0x21:
      goto switchD_001dfcbc_caseD_0;
    default:
      iVar5 = FUN_001dea60(param_1);
      if ((iVar5 == 0) &&
         (iVar5 = FUN_001de5b0(param_1,&DAT_003e5020 + (lVar17 + (ulong)uVar1 * 6) * 2), iVar5 == 0)
         ) {
    ...
    case 0x12:
      ...
      goto switchD_001dfcbc_caseD_0;
    case 0x13:
      uVar6 = FUN_001de0d0(param_1,2);
      break;
    case 0x14:
      uVar6 = FUN_001de0d0(param_1,4);
      break;
    case 0x15:
      uVar6 = FUN_001de0d0(param_1,8);
      break;
    case 0x16:
      uVar6 = FUN_001de000(param_1,1);
      break;
    case 0x17:
      uVar6 = FUN_001de000(param_1,2);
      break;
    case 0x18:
      uVar6 = FUN_001de000(param_1,4);
      break;
    case 0x19:
      uVar6 = FUN_001de000(param_1,8);
      break;
    case 0x1b:
      uVar6 = FUN_001de0d0(param_1,param_1[0x7f]);
      break;
    case 0x1c:
      iVar5 = FUN_001de0d0(param_1,param_1[0x7d]);
      if (iVar5 == 0) {
    ...
    case 0x1d:
      ...
      goto switchD_001dfcbc_caseD_0;
    case 0x1e:
      uVar6 = FUN_001de000(param_1,0);
    }
    if (uVar6 != 0) goto switchD_001e0be8_caseD_10;
switchD_001dfcbc_caseD_0:
    lVar17 = lVar17 + 1;
    if (lVar17 == 6) goto code_r0x001dfe1c;
    goto LAB_001dfc7c;
  }
switchD_001e0be8_caseD_10:
LAB_001df5c4:
  uVar13 = 0xffffffff;
LAB_001df5c8:
