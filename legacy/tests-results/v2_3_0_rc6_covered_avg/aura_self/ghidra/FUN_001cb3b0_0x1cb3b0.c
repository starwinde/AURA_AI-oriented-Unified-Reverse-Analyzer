...
undefined8 FUN_001cb3b0(byte *param_1,undefined8 param_2,uint param_3)
...
LAB_001cb3e0:
    ...
    if (bVar2 == 6) {
      ...
      FUN_0018ff90(param_2,lVar15);
      uVar7 = FUN_001be490(uVar17,uVar8 & 0xffffffff,param_3,param_2);
      return uVar7;
    }
    if (bVar2 != 7) {
      if (bVar2 != 5) {
      ...
      FUN_0018ff90(param_2,uVar8 & 0xffffffff);
      uVar7 = FUN_001be490(uVar17,uVar5 & 0xffffffff,param_3,param_2);
      return uVar7;
    }
    uVar8 = 0;
    lVar15 = 0;
