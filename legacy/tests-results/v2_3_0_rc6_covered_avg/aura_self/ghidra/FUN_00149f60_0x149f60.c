...
undefined8 * FUN_00149f60(ulong *param_1,ulong param_2,long param_3,byte *param_4)

{
  ...
  if (__ptr != (undefined8 *)0x0) {
    ...
    *__ptr = 0;
    ...
    if (param_4 == (byte *)0x0) {
      if (param_3 == 0) {
        if (!bVar3 || !bVar4) goto LAB_00149fd0;
        local_88 = (long *)FUN_0016fe60(param_1,param_2);
        bVar32 = 0;
        FUN_0014bbe0(&local_78);
LAB_0014a388:
        bVar3 = false;
        goto LAB_0014a0c0;
      }
...
LAB_0014a004:
    ...
    FUN_0014bbe0();
    bVar3 = false;
    if (param_3 != 0) goto LAB_0014a07c;
LAB_0014a0c0:
    plVar14 = local_88;
    local_d0 = &local_78;
    puVar28 = param_1 + 0xc;
    ...
    do {
      ...
      if (iVar5 == 0) {
        ...
        if (iVar6 != 0) goto LAB_0014a264;
        if ((puVar18 == (ulong *)0x0) || (iVar5 = strcmp((char *)(puVar18 + 4),"mov"), iVar5 != 0))
        {
LAB_0014a218:
          iVar5 = FUN_0014bbf0(local_d0,puVar28[-0xc],0,0x3c,0);
        }
        else {
          puVar10 = puVar18 + 0xc;
          ...
          uVar17 = puVar28[-0xc];
LAB_0014a324:
          iVar5 = FUN_0014bbf0(local_d0,uVar17,0,0x50,0);
        }
        if (iVar5 == 0) goto LAB_0014a234;
      }
      else {
LAB_0014a264:
    ...
    do {
      ...
      if (((((iVar5 == 0) ||
          ...
          ((iVar5 = FUN_00149e00(puVar18 + 8,&local_80), iVar5 != 0 &&
           (local_80 < uVar20 + uVar17 && uVar19 <= local_80)))) &&
         (iVar5 = FUN_0014bbf0(local_d0,local_80,1,0xffffffb4,0), iVar5 == 0)) goto LAB_0014a234;
      uVar30 = uVar30 + 1;
    ...
    if ((plVar14 != (long *)0x0) && (uVar23 = *(uint *)(plVar14 + 1), uVar23 != 0)) {
      ...
      do {
        ...
        if ((*(int *)(lVar25 + 0x10) == 0) &&
          ...
          iVar5 = FUN_0014bbf0(local_d0,uVar20,2,0xffffffaa,0);
          if (iVar5 == 0) goto LAB_0014a234;
    ...
    if (param_3 == 0) {
      iVar5 = FUN_0014bbf0(local_d0,*param_1,0,0x3c,0);
      if (iVar5 != 0) goto LAB_0014a7b8;
LAB_0014a234:
      FUN_0014bdb4(local_d0);
      if (local_88 != (long *)0x0) {
        FUN_00170490(&local_88);
      }
    }
    else {
        ...
        do {
          ...
          if ((*(int *)(lVar25 + 0x20) == 1) && (lVar21 = *(long *)(lVar25 + 0x10), lVar21 != 0)) {
            if (*(long *)(lVar25 + 0x18) == 0) {
              iVar5 = FUN_0014bbf0(local_d0,lVar21,3,0xffffffa0,0);
              if (iVar5 == 0) goto LAB_0014a234;
              uVar23 = *(uint *)(param_3 + 0x30);
            }
            else {
              iVar5 = FUN_0014bbf0(local_d0,lVar21,3,0xffffffc8);
              if (iVar5 == 0) goto LAB_0014a234;
              uVar23 = *(uint *)(param_3 + 0x30);
            }
          }
      ...
      if (iVar5 == 0) goto LAB_0014a234;
      uVar30 = *param_1;
      lVar31 = param_1[param_2 * 0x1c + -0x1c] + param_1[param_2 * 0x1c + -0x19];
      FUN_0014b090(param_3,local_d0,uVar30,lVar31);
      if ((*(int *)(param_3 + 0xc) == 4) && (*(uint *)(param_3 + 0x20) != 0)) {
        puVar8 = *(undefined8 **)(param_3 + 0x18);
        puVar9 = puVar8 + (ulong)*(uint *)(param_3 + 0x20) * 7;
        do {
          if (((char *)*puVar8 != (char *)0x0) &&
             (iVar5 = strcmp((char *)*puVar8,".text"), iVar5 == 0)) {
            if (puVar8[5] != 0) {
              FUN_0014b514(param_3,local_d0,uVar30,lVar31,puVar8[5],4);
            }
            break;
          }
          puVar8 = puVar8 + 7;
      ...
      FUN_0014ba20(param_3,local_d0);
      FUN_0014b5d0(param_3,local_d0,uVar30,lVar31,*(undefined4 *)(param_3 + 0xc),0);
      FUN_0014bcc0(local_d0);
LAB_0014a7b8:
      FUN_0014bcc0(local_d0);
      if (local_88 != (long *)0x0) {
        FUN_00170490(&local_88);
      ...
      if (local_70 == 0) {
        plVar14 = malloc(0x10);
        if (plVar14 == (long *)0x0) goto LAB_0014acf8;
        *plVar14 = 0;
...
LAB_0014ab98:
                ...
                if (pcVar11 == (char *)0x0) goto LAB_0014ab98;
              ...
              lVar31 = lVar31 + 1;
              uVar29 = uVar7;
              if (uVar23 <= uVar7) goto LAB_0014a9d0;
            }
            lVar31 = lVar31 + 1;
            uVar29 = uVar7;
          } while (uVar7 < uVar23);
          ...
          if (pvVar15 != (void *)0x0) {
            ...
            do {
              ...
              if (((iVar5 == 0) ||
                 ...
                 (iVar5 = FUN_00149e00(puVar28 + 8,&local_80), uVar17 = local_80, iVar5 != 0)) {
                    ...
                    if ((*(ulong *)(lVar25 + lVar31) <= uVar19) &&
                      ...
                      if (uVar23 <= uVar27) {
                        ...
                        if (pvVar15 == (void *)0x0) {
                          ...
                          plVar14 = (long *)*__ptr;
                          __ptr[1] = 0;
                          if (plVar14 == (long *)0x0) goto LAB_0014a24c;
                          goto LAB_0014acc8;
                        }
                        uVar19 = puVar28[-4];
                        *puVar9 = pvVar15;
