...
undefined1 FUN_001e8fc8(long *param_1)

{
  ...
  if ((*(byte *)(lVar4 + 0xd) & 0x7c) == 4) {
    ...
    bVar1 = (&DAT_00571160)
            [(int)((*(byte *)(lVar4 + 0xe) & 3) << 1 | (uint)(*(byte *)(lVar4 + 0xd) >> 7))];
    ...
    case 2:
      ...
      uVar3 = (&UNK_00571168)
              [(long)(int)(uint)bVar2 +
               (long)(int)(uint)(*(int *)(*param_1 + 0x170) != 0) * 9 + (long)(int)(uint)bVar1 * 3];
      break;
    case 3:
      if (2 < bVar1) {
                    /* WARNING: Subroutine does not return */
      ...
      uVar3 = (&UNK_00571180)
              [(long)(int)(uint)bVar2 +
               (long)(int)(uint)(*(int *)(*param_1 + 0x170) != 0) * 6 + (long)(int)(uint)bVar1 * 3];
      break;
    case 4:
      uVar3 = (&DAT_00571190)[(int)(uint)bVar2];
      break;
    case 5:
    case 8:
      if (5 < (byte)((*(byte *)(lVar4 + 0xe) & 3) << 1 | *(byte *)(lVar4 + 0xd) >> 7)) {
    ...
    case 6:
      ...
      uVar3 = (&DAT_005711a0)[(int)(uint)bVar1];
      break;
    case 7:
      uVar3 = 4;
      break;
    ...
    case 0xb:
      ...
      break;
    case 0xc:
      uVar3 = (&DAT_005711a8)[(int)(uint)bVar2];
      break;
    case 0xd:
      uVar3 = (&DAT_005711b0)[(int)(uint)bVar2];
      break;
    case 0xe:
      uVar3 = (&DAT_005711b8)[(int)(uint)bVar2];
      break;
    case 0xf:
      uVar3 = 4;
      break;
    case 0x10:
      uVar3 = (&DAT_005711c0)[(int)(uint)bVar2];
      break;
    case 0x11:
      uVar3 = (&UNK_005711c8)
