...
void FUN_0017c740(long *param_1,uint param_2,long param_3,long param_4,uint *param_5)
                              ...
                              if ((bVar7 & 1) == 0) {
                                *(undefined1 *)(param_3 + (ulong)uVar5) = 1;
                                ...
                                if (uVar8 != 0) {
                                  ...
                                  lVar20 = 0;
                                  uVar6 = *puVar15;
                                  if (uVar1 <= uVar6) goto LAB_0017c97c;
                                  do {
                                    if ((*(byte *)(param_3 + (ulong)uVar6) & 1) == 0) {
                                      FUN_0017c740(param_1,(ulong)uVar6,param_3,param_4);
                                      uVar8 = *(uint *)(lVar9 + 0x20);
                                    }
LAB_0017c97c:
                                    do {
                                      lVar20 = lVar20 + 1;
                                      if (uVar8 <= (uint)lVar20) goto LAB_0017ca2c;
