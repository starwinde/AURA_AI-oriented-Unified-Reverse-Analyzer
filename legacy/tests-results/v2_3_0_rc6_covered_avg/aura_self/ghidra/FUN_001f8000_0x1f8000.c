...
undefined8 * FUN_001f8000(long param_1,ulong param_2,int param_3)

{
  ...
  *(undefined4 *)(puVar2 + 5) = uVar1;
  ...
  if (pcVar8 != (char *)0x0) {
    sVar3 = strlen(pcVar8);
    pvVar4 = (void *)(*(code *)PTR_malloc_00600598)(sVar3 + 1);
    if (pvVar4 == (void *)0x0) {
      puVar2[4] = 0;
      goto LAB_001f8158;
    }
...
LAB_001f8158:
    ...
    do {
      while( true ) {
        plVar5 = (long *)FUN_001f8000(plVar7,param_2 + 1,1);
        if (plVar5 == (long *)0x0) goto LAB_001f8158;
        if (plVar6 == (long *)0x0) break;
        *plVar6 = (long)plVar5;
        plVar7 = (long *)*plVar7;
        plVar5[1] = (long)plVar6;
        plVar6 = plVar5;
        if (plVar7 == (long *)0x0) goto LAB_001f81b0;
      }
      plVar7 = (long *)*plVar7;
      puVar2[2] = plVar5;
      plVar6 = plVar5;
