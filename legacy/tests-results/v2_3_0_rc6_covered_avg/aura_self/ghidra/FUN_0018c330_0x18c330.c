...
void FUN_0018c330(long param_1,int *param_2,char *param_3,undefined8 param_4,code *param_5,
                 long param_6)

{
  ...
  *(undefined1 *)((long)param_2 + 0x4a) = 0;
  ...
  while (pcVar9 = pcVar4, cVar10 != '\0') {
    while( true ) {
      pcVar9 = pcVar4;
      if (cVar10 == ' ' || cVar10 == '\t') goto LAB_0018c3fc;
      if (cVar10 == '|') break;
      pcVar9 = pcVar4 + 1;
      *pcVar4 = *param_3;
      param_3 = param_3 + 1;
