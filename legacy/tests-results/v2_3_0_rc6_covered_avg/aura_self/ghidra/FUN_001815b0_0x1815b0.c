...
void FUN_001815b0(undefined8 *param_1)

{
  ...
  if (__ptr != (undefined4 *)0x0) {
    ...
    case 0:
      if (__ptr[0x28] != 0) {
        ...
        do {
          lVar1 = lVar3 * 8;
          lVar3 = lVar3 + 1;
          FUN_0017e310(*(undefined8 *)(*(long *)(__ptr + 0x26) + lVar1));
    ...
    case 1:
    case 0x15:
      FUN_0017e310(*(undefined8 *)(__ptr + 0x26));
      FUN_0017e310(*(undefined8 *)(__ptr + 0x28));
      FUN_0017e310(*(undefined8 *)(__ptr + 0x2a));
      break;
    case 2:
    case 3:
    case 10:
    ...
    case 4:
      ...
      FUN_0017e310(*(undefined8 *)(__ptr + 0x28));
      FUN_0017e310(*(undefined8 *)(__ptr + 0x2a));
      FUN_0017e310(*(undefined8 *)(__ptr + 0x2c));
      break;
    case 5:
      FUN_0017e310(*(undefined8 *)(__ptr + 0x26));
      if (__ptr[0x2a] != 0) {
    ...
    case 0x11:
      ...
      if (__ptr[0x4a] != 0) {
        do {
          lVar1 = lVar3 * 8;
          lVar3 = lVar3 + 1;
          FUN_0017e310(*(undefined8 *)(*(long *)(__ptr + 0x48) + lVar1));
