...
undefined8 FUN_001f71f0(long param_1,char *param_2,long *param_3)

{
  ...
  *(uint *)(param_3 + 3) = *(uint *)(param_3 + 3) & 0xfffffdff;
  plVar2 = (long *)FUN_001f33f4(param_1,param_2,0);
  if (param_1 == 0) {
    return 0;
  }
  ...
  *param_3 = lVar6;
  if (lVar6 == 0) {
    if (plVar2 == plVar3) goto LAB_001f7300;
    puVar4 = (undefined8 *)param_3[1];
    if (puVar4 != (undefined8 *)0x0) goto LAB_001f72c4;
  }
  else {
...
LAB_001f7300:
    ...
    puVar4 = (undefined8 *)param_3[1];
    if (puVar4 == (undefined8 *)0x0) goto LAB_001f72d0;
LAB_001f72c4:
    *puVar4 = param_3;
    if (*param_3 != 0) goto LAB_001f72d0;
  }
