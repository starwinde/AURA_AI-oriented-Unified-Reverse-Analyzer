...
/* WARNING: Removing unreachable block (ram,0x001ec0dc) */

undefined8 FUN_001ec048(long param_1,long param_2)

{
  ...
  if (uVar1 < 0x12) {
    ...
    case 0xe:
      ...
      break;
    default:
      goto switchD_001ec16c_default;
    }
  }
  else {
    if ((0x19 < uVar1) || (uVar1 < 0x12)) {
switchD_001ec16c_default:
