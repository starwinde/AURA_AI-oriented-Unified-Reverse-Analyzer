...
int FUN_001f106c(undefined8 param_1,undefined8 param_2,ulong *param_3,undefined8 param_4)

{
  ...
  iVar1 = FUN_001ed8c8(param_1,auStack_50);
  if (-1 < iVar1) {
    local_60 = *param_3;
    if (0xf < local_60) {
      local_60 = 0xf;
    ...
    local_58 = 0;
    local_68 = param_2;
    iVar1 = FUN_001effd0(auStack_50,param_4);
    if (-1 < iVar1) {
      iVar1 = FUN_001ef40c(param_4,&local_68);
