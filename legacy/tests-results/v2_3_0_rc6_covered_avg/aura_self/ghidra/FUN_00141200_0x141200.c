...
void FUN_00141200(long param_1,int param_2)
  ...
  if (param_1 == 0) {
    ...
    if (lVar6 == 0) {
      ...
      if (param_2 == 0) {
        ...
        uVar9 = FUN_00144f60(*(undefined4 *)(lVar6 + 0xc));
...
LAB_001416f4:
        ...
        puts(",");
        __printf_chk(2,"  \"arch\": ");
        FUN_00144f60(*(undefined4 *)(lVar6 + 0xc));
        FUN_00140d70();
        puts(",");
        ...
        if (*(int *)(lVar6 + 0x20) != 0) {
          ...
          do {
            while( true ) {
              ...
              __printf_chk(2,"    {\"name\": ");
              puVar8 = *(undefined **)(lVar13 + lVar11);
              puVar2 = &DAT_001fe648;
...
LAB_001414ac:
          do {
            ...
            lVar10 = lVar13 + lVar11;
            if (*(long *)(lVar10 + 8) == 0) {
              FUN_00140d70(*(undefined8 *)(lVar13 + lVar11));
