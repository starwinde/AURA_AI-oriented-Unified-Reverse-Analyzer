...
long * FUN_0017caa0(long *param_1)
...
LAB_0017cb5c:
          ...
          if (0 < (int)uVar21) {
            piVar10 = (int *)(*plVar36 + (ulong)uVar21 * 0x90 + -0x90);
            do {
              if (*piVar10 == 0x1a) goto LAB_0017cb5c;
              piVar10 = piVar10 + -0x24;
            } while (piVar10 !=
                     (int *)((ulong)uVar21 * 0x90 + (ulong)(uVar21 - 1) * -0x90 + *plVar36 + -0x120)
                    );
          }
        }
        uVar19 = uVar19 + 1;
      ...
      do {
        while (uVar19 = *puVar11, (*(byte *)((long)__ptr_03 + (ulong)uVar19) & 1) == 0) {
          ...
          *(undefined1 *)((long)__ptr_03 + (ulong)uVar19) = 1;
          ...
          local_6c = uVar21;
          if (puVar11 == puVar1) goto LAB_0017cce4;
        }
        puVar11 = puVar11 + 1;
...
LAB_0017cce4:
      ...
      if (local_6c >> 1 == 0) {
        ...
        puVar11 = __ptr_00;
        if (local_6c != 0) goto LAB_0017cd90;
      }
      else {
        do {
...
LAB_0017cde0:
        ...
        puVar12 = __ptr_00;
        do {
          if (*puVar12 == uVar19) goto joined_r0x0017cfcc;
          puVar12 = puVar12 + 1;
        } while (puVar12 != puVar1);
        lVar35 = lVar31 + (ulong)uVar19 * 0x50;
          ...
          if (((uVar21 < uVar2) && (uVar29 = (ulong)uVar21, *(int *)((long)__s + uVar29 * 4) != -1))
            ...
            while (uVar3 = uVar28, uVar21 != uVar28) {
              while( true ) {
                ...
                if (uVar3 == uVar28) goto LAB_0017d038;
                uVar28 = uVar3;
                if (uVar3 == 0xffffffff) goto LAB_0017cf98;
              }
              while( true ) {
                uVar3 = uVar21;
                if (uVar21 == 0xffffffff) goto LAB_0017cf98;
                uVar29 = (ulong)uVar21;
                if (*(uint *)((long)__ptr_02 + uVar29 * 4) <= uVar4) break;
                uVar3 = *(uint *)((long)__s + uVar29 * 4);
                bVar8 = uVar3 == uVar21;
                uVar21 = uVar3;
                if (bVar8) goto LAB_0017d038;
              }
            }
          }
          goto LAB_0017cf98;
        }
        goto joined_r0x0017cfcc;
      }
      iVar20 = 1;
LAB_0017d044:
...
LAB_0017cf98:
  uVar28 = uVar3;
  puVar22 = puVar22 + 1;
  if (puVar22 == puVar12) goto code_r0x0017cfa4;
  goto LAB_0017cf70;
code_r0x0017cfa4:
...
joined_r0x0017cfcc:
  puVar11 = puVar11 + 1;
  if (puVar11 != __ptr_01 + local_6c) goto LAB_0017cde0;
  if (!bVar6) goto LAB_0017d044;
  if (iVar20 != 20000) {
    iVar20 = iVar20 + 1;
    puVar11 = __ptr_01;
    bVar6 = bVar7;
...
LAB_0017d12c:
    ...
    *(uint *)((long)puVar15 + (ulong)uVar19 * 4) = uVar19;
    ...
    puVar17 = puVar15;
    uVar37 = _DAT_0020c6a0;
    uVar38 = _UNK_0020c6a8;
    do {
      puVar18 = puVar17 + 2;
      puVar17[1] = uVar38;
      *puVar17 = uVar37;
    ...
    if ((uVar2 & 3) != 0) goto LAB_0017d12c;
  }
LAB_0017d04c:
  free(__ptr_00);
  free(__ptr_01);
