...
void FUN_00159850(long *param_1)

{
  ...
  iVar3 = 0;
  if (uVar13 == 0) goto LAB_00159888;
  uVar12 = *(uint *)(param_1 + 1);
  lVar32 = *param_1;
  iVar3 = FUN_00159780(lVar32,uVar12,uVar13);
  __ptr = malloc((ulong)uVar13 << 2);
  DAT_006005e0 = __ptr;
  __ptr_00 = calloc((ulong)uVar13,4);
  DAT_006005e8 = __ptr_00;
  if (uVar13 - 1 < 3) {
    uVar4 = 0;
LAB_00159958:
    uVar17 = uVar4 + 1;
    *(uint *)((long)__ptr + (ulong)uVar4 * 4) = uVar4;
    ...
    puVar7 = __ptr;
    uVar33 = _DAT_0020c6a0;
    uVar34 = _UNK_0020c6a8;
    do {
      puVar20 = puVar7 + 2;
      puVar7[1] = uVar34;
      *puVar7 = uVar33;
    ...
    if ((uVar13 & 3) != 0) goto LAB_00159958;
  }
  if (uVar12 != 0) {
    puVar19 = (uint *)(lVar32 + 0x10);
    puVar25 = puVar19 + (ulong)uVar12 * 0x14;
    puVar22 = puVar19;
    do {
      uVar12 = *puVar22;
      if (uVar12 != 0) {
...
LAB_001599ac:
            ...
            if (uVar12 <= uVar4) goto LAB_00159ae0;
          }
          uVar21 = piVar14[2];
          uVar17 = piVar14[6];
          if (uVar21 == 0xffffffff || uVar17 == 0xffffffff) goto LAB_001599ac;
          uVar5 = uVar21;
          if (uVar21 < uVar17) {
            uVar5 = uVar17;
          }
          if (uVar13 <= uVar5 || uVar21 == uVar17) goto LAB_001599ac;
...
LAB_00159acc:
            ...
            if (uVar17 == uVar21) goto LAB_00159acc;
            uVar12 = uVar21;
            if (uVar17 < uVar21) {
              uVar12 = uVar17;
            }
            ...
            *(uint *)((long)__ptr + (ulong)uVar17 * 4) = uVar12;
            if (iVar6 != iVar2) goto LAB_00159acc;
...
LAB_00159ae0:
    ...
    do {
      while (uVar13 = *puVar19, uVar13 == 0) {
        ...
        *puVar19 = 0;
        puVar19 = puVar22;
        if (puVar22 == puVar25) goto LAB_00159c04;
      }
      piVar24 = *(int **)(puVar19 + -2);
      uVar12 = 0;
      uVar4 = 0;
      piVar14 = piVar24;
      do {
        if (((*piVar14 != 0) || (piVar14[0x12] == 0)) || (piVar14[2] != piVar14[6])) {
          if (uVar4 != uVar12) {
            ...
            piVar18 = piVar24 + (ulong)uVar12 * 0x24;
            ...
            *(undefined8 *)(piVar18 + 0x1c) = uVar34;
            uVar33 = *(undefined8 *)(piVar14 + 0x20);
            *(undefined8 *)(piVar18 + 0x22) = *(undefined8 *)(piVar14 + 0x22);
            *(undefined8 *)(piVar18 + 0x20) = uVar33;
          }
          uVar12 = uVar12 + 1;
        }
        uVar4 = uVar4 + 1;
    ...
    *(uint *)(plVar8 + 1) = uVar12;
    ...
    if (uVar13 != 0) {
      ...
      do {
        if (*(uint *)(puVar20 + 1) != 0) {
          piVar14 = (int *)*puVar20;
          piVar24 = piVar14 + (ulong)*(uint *)(puVar20 + 1) * 0x24;
          do {
            while( true ) {
              uVar13 = piVar14[2];
              uVar15 = (ulong)uVar13;
...
LAB_00159d64:
              piVar14 = piVar14 + 0x24;
              if (piVar14 == piVar24) goto LAB_00159db0;
            }
            iVar6 = *piVar14;
            iVar2 = piVar14[3];
            if (iVar6 != 1) {
...
LAB_0015a078:
            ...
            *(undefined1 *)((long)pvVar9 + uVar15) = 1;
            ...
            if (iVar2 != 6) goto LAB_00159d64;
            piVar14 = piVar14 + 0x24;
            *(undefined1 *)((long)__ptr_02 + (ulong)uVar13) = 1;
          } while (piVar14 != piVar24);
        }
LAB_00159db0:
        puVar20 = puVar20 + 10;
          ...
          if ((*(char *)((long)pvVar9 + uVar15) == '\0') ||
            ...
            if (uVar12 < uVar13) {
              ...
              if (*(long *)(lVar32 + uVar15 * 8) == 0) {
                if (*(char *)((long)__ptr_04 + uVar15) == '\0' || 4 < iVar30) goto LAB_0015a110;
                iVar31 = iVar30 + 1;
                pcVar11 = strdup((&PTR_s_i_005dfbc0)[iVar30]);
...
LAB_0015a110:
              if (*(char *)((long)__ptr_03 + uVar15) == '\0') {
                ...
                if (iVar6 == 0) {
                  local_88[0] = s_result_001faa08[0];
                  local_88[1] = s_result_001faa08[1];
                  local_88[2] = s_result_001faa08[2];
                  local_88[3] = s_result_001faa08[3];
                  local_88[4] = s_result_001faa08[4];
                  local_88[5] = s_result_001faa08[5];
                  local_88[6] = s_result_001faa08[6];
                }
                else {
          ...
          if (uVar13 == uVar12) goto LAB_0015a0d4;
        }
        uVar15 = uVar15 + 1;
        __ptr_00 = DAT_006005e8;
        iVar30 = iVar31;
  ...
  DAT_006005f0 = plVar8;
  iVar6 = FUN_00159780(*param_1,(int)param_1[1],(int)param_1[2]);
  free(__ptr);
  free(__ptr_00);
  DAT_006005e0 = (undefined8 *)0x0;
  iVar3 = iVar3 - iVar6;
  DAT_006005e8 = (void *)0x0;
LAB_00159888:
