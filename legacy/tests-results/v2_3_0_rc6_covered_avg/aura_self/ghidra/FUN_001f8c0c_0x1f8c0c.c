...
bool FUN_001f8c0c(long param_1,long param_2,undefined4 param_3)
  ...
  if (uVar1 < 0x41) {
    ...
    if (uVar1 != 0x10) {
        ...
        while( true ) {
          if (plVar5 == (long *)0x0) {
            ...
            while( true ) {
              ...
              lVar4 = FUN_001f33f4(param_1,plVar5[7],param_3);
              if (lVar4 == 0) break;
              iVar3 = FUN_001f8c10(plVar5,lVar4,param_3);
              if (iVar3 == 0) {
                return false;
              }
              plVar5 = (long *)*plVar5;
          ...
          lVar4 = FUN_001f33f4(param_2,plVar5[7],param_3);
          if (lVar4 == 0) {
            return false;
          }
          iVar3 = FUN_001f8c10(plVar5,lVar4,param_3);
      ...
      if (plVar6 != (long *)0x0 && plVar5 != (long *)0x0) {
        do {
          iVar3 = FUN_001f8c10(plVar6,plVar5,param_3);
          if (iVar3 == 0) {
            return false;
          }
          plVar6 = (long *)*plVar6;
