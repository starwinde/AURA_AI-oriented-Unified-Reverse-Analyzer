...
ulong FUN_0014be90(long *param_1)

{
  ...
  do {
    if (*(uint *)(puVar8 + 1) != 0) {
      piVar3 = (int *)*puVar8;
      piVar6 = piVar3 + (ulong)*(uint *)(puVar8 + 1) * 0x24;
      do {
        iVar2 = piVar3[0x12];
        if (iVar2 != 0) {
          if ((piVar3[6] != -1) &&
             (iVar1 = FUN_0014bdf0(param_1,piVar3[6]), piVar3 = extraout_x10, param_1 = extraout_x13
          ...
          if (iVar2 != 1) {
            if ((piVar3[10] != -1) &&
               (iVar1 = FUN_0014bdf0(param_1,piVar3[10]), piVar3 = extraout_x10_00,
            ...
            if (((iVar2 != 2) && (piVar3[0xe] != -1)) &&
               (iVar2 = FUN_0014bdf0(param_1,piVar3[0xe]), piVar3 = extraout_x10_01,
        ...
        if ((*piVar3 == 0x1b) && (piVar3[0x18] != 0)) {
          ...
          do {
            if ((*piVar4 != -1) &&
               (iVar2 = FUN_0014bdf0(param_1,*piVar4), piVar3 = extraout_x10_02,
               piVar4 = extraout_x11, param_1 = extraout_x13_02, piVar5 = extraout_x14,
               piVar6 = extraout_x15_02, uVar7 = extraout_x18_02, extraout_w12_01 != iVar2)) {
              uVar7 = 1;
              *extraout_x11 = iVar2;
            }
            piVar4 = piVar4 + 4;
