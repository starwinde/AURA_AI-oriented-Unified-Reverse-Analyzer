...
void FUN_0016c940(long *param_1,long param_2,ulong param_3,undefined8 param_4,undefined8 *param_5,
                 undefined8 *param_6)

{
  ...
  if (((param_1 != (long *)0x0) && ((int)param_1[1] == 1)) && (param_2 != 0 && param_3 != 0)) {
    local_78 = 0;
    if (*param_1 != 0) {
      local_78 = FUN_00173990();
    }
    __ptr = calloc(1,0x10);
    if (__ptr == (undefined8 *)0x0) {
      FUN_001753a0(&local_78);
...
LAB_0016ca38:
            ...
            if (local_70 != __nptr) {
              if (uVar6 != 0) {
                if ((local_78 == 0) || (lVar8 = FUN_00175340(local_78,uVar6), lVar8 == 0)) {
...
LAB_0016cbbc:
  ...
  if (*(uint *)((long)__ptr + 0xc) <= uVar3) {
    ...
    if (pvVar4 == (void *)0x0) goto joined_r0x0016cc6c;
    *__ptr = pvVar4;
    uVar3 = *(uint *)(__ptr + 1);
...
joined_r0x0016cc6c:
  ...
  uVar14 = uVar14 + 1;
  if (param_3 <= uVar14) goto LAB_0016ca80;
  goto LAB_0016c9f8;
LAB_0016ca80:
  FUN_001753a0(&local_78);
  if (*(int *)(__ptr + 1) != 0) {
