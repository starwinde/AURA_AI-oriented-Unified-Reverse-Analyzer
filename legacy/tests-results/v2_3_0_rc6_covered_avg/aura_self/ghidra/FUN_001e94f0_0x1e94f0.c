...
/* WARNING: Removing unreachable block (ram,0x001e96b4) */

undefined1 FUN_001e94f0(long *param_1)
...
LAB_001e95d4:
      ...
      if (1 < uVar1 - 3) goto LAB_001e95d4;
      local_a = 2;
    }
  }
  bVar2 = FUN_001e8e64(*(undefined4 *)(*param_1 + 0x17c));
  bVar3 = FUN_001e8ee8(*(undefined4 *)(*param_1 + 0x180));
  bVar2 = bVar2 | bVar3;
...
LAB_001e98dc:
    ...
    if (0x19 < uVar1) goto LAB_001e9924;
    if (uVar1 != 0x18) {
      if (0x18 < uVar1) goto LAB_001e9924;
      if (uVar1 == 0x17) goto LAB_001e98dc;
      if (0x17 < uVar1) {
LAB_001e9924:
                    /* WARNING: Subroutine does not return */
...
LAB_001e97f8:
            if (bVar2 < 3) {
              return (&UNK_00571220)[(long)(int)(uint)bVar2 + (long)(int)(uint)local_a * 3];
            }
                    /* WARNING: Subroutine does not return */
          ...
          if ((uVar1 < 0x16) && (uVar1 < 0x15)) {
            if (uVar1 < 10) {
              ...
              if ((uVar6 & 0x470) != 0) {
                if (bVar2 < 8) {
                  return (&UNK_00571208)[(long)(int)(uint)bVar2 + (long)(int)(uint)local_a * 8];
                }
                    /* WARNING: Subroutine does not return */
                __assert_fail("sss < (sizeof(lookup[index]) / sizeof((lookup[index])[0]))",
              ...
              if ((uVar6 & 0x107) != 0) {
                if (bVar2 < 8) {
                  return (&UNK_005711f0)[(long)(int)(uint)bVar2 + (long)(int)(uint)local_a * 8];
                }
                    /* WARNING: Subroutine does not return */
                __assert_fail("sss < (sizeof(lookup[index]) / sizeof((lookup[index])[0]))",
                              "/home/str_dgx_spark/Desktop/AURA/third_party/zydis/src/Encoder.c",
              ...
              if ((uVar6 & 0x288) != 0) goto LAB_001e97f8;
            }
          }
        }
        goto LAB_001e9924;
    ...
    uVar4 = (&UNK_00571230)[(long)(int)(uint)bVar2 + (long)(int)(uint)local_a * 8];
  }
  return uVar4;
}
