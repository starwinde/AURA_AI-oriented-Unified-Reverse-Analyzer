...
void FUN_001f4480(long param_1,long *param_2)

{
  ...
  if ((param_2 == (long *)0x0) || (lVar14 = *param_2, lVar14 == 0)) goto LAB_001f4574;
  uVar2 = param_2[1];
  uVar10 = param_2[2];
  uVar6 = uVar10 + 4;
  if (uVar2 < uVar6) {
          ...
          if (uVar10 < uVar2) {
            do {
              if (0x20 < *(byte *)(lVar14 + uVar10)) {
                if (uVar2 == uVar10) goto LAB_001f4bd0;
                uVar10 = param_2[2];
                if (uVar2 <= uVar10) goto LAB_001f4b84;
                goto LAB_001f49ec;
              }
              uVar10 = uVar10 + 1;
              param_2[2] = uVar10;
...
LAB_001f49ec:
              if (*(char *)(lVar14 + uVar10) == ']') {
                ...
                do {
                  ...
                  puVar13 = puVar12;
                  if (puVar7 == (undefined8 *)0x0) goto LAB_001f4b90;
                  puVar7[1] = 0;
                  *puVar7 = 0;
                  puVar7[3] = 0;
                  puVar7[2] = 0;
                  ...
                  iVar4 = FUN_001f4480(puVar7,param_2);
                  if (iVar4 == 0) goto LAB_001f4b68;
                  lVar14 = *param_2;
                  uVar6 = param_2[1];
                  uVar10 = param_2[2];
                  if (lVar14 == 0) {
LAB_001f4ad4:
                    if (uVar6 <= uVar10) goto LAB_001f4b68;
                  }
                  else {
                    if (uVar6 <= uVar10) goto LAB_001f4b68;
                    do {
                      if (0x20 < *(byte *)(lVar14 + uVar10)) {
                        if (uVar10 != uVar6) goto LAB_001f4ad4;
                        break;
                      }
                      uVar10 = uVar10 + 1;
                      param_2[2] = uVar10;
                ...
                if ((uVar6 <= uVar10) || (*(char *)(lVar14 + uVar10) != ']')) goto LAB_001f4b68;
        ...
        if (uVar10 < uVar2) {
          do {
            if (0x20 < *(byte *)(lVar14 + uVar10)) {
              if (uVar2 == uVar10) goto LAB_001f4be4;
              uVar10 = param_2[2];
              if (uVar2 <= uVar10) goto LAB_001f4b84;
              goto LAB_001f4674;
            }
            ...
            if (*(char *)(lVar14 + uVar10) == '}') {
              ...
              do {
                ...
                *puVar7 = 0;
                ...
                iVar4 = FUN_001f3c94(puVar7,param_2);
                if (iVar4 == 0) goto LAB_001f4b68;
                lVar14 = *param_2;
                uVar6 = param_2[1];
                uVar10 = param_2[2];
...
LAB_001f475c:
                ...
                if (*(char *)(lVar14 + uVar10) != ':') goto LAB_001f4b68;
                uVar10 = uVar10 + 1;
                param_2[2] = uVar10;
...
LAB_001f480c:
                  ...
                  do {
                    if (0x20 < *(byte *)(lVar14 + uVar10)) {
                      if (uVar10 != uVar6) goto LAB_001f480c;
                      break;
                    }
                    uVar10 = uVar10 + 1;
                    param_2[2] = uVar10;
