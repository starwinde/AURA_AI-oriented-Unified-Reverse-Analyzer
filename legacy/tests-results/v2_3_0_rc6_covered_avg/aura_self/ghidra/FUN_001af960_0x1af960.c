...
undefined8 FUN_001af960(byte *param_1,long param_2,uint param_3)
...
LAB_001af990:
    ...
    if (bVar2 < 4 || bVar5) {
      ...
      if (bVar2 == 6) {
        ...
        uVar8 = FUN_0019c4c4(uVar17,uVar16 & 0xffffffff,param_3,param_2);
        return uVar8;
      }
      if (bVar2 != 7) {
        if (bVar2 != 5) {
        ...
        uVar8 = FUN_0019c4c4(uVar17,uVar9 & 0xffffffff,param_3,param_2);
        return uVar8;
      }
      uVar9 = 0;
      lVar6 = 0;
