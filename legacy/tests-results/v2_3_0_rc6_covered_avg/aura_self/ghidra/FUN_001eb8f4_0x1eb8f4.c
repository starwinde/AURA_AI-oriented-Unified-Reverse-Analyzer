...
undefined8 FUN_001eb8f4(long param_1,long param_2,byte *param_3)
...
LAB_001eba94:
    ...
    if (uVar1 == 3) {
      ...
      if ((uVar1 < 3) || (1 < uVar1 - 0x1b)) goto LAB_001eba94;
      cVar2 = FUN_001e82f8(param_1,*(undefined8 *)(param_2 + 0x38),param_3);
      pbVar3 = (byte *)FUN_001f2f18(param_3);
      if ((*pbVar3 & 0x3f) == 5) {
