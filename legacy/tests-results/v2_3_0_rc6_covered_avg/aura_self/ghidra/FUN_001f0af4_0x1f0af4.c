...
undefined8 FUN_001f0af4(uint *param_1)

{
  ...
  if (((((((*param_1 < 6) && (param_1[1] < 0x40)) && (param_1[2] < 0x75e)) &&
    ...
    if ((param_1[1] & DAT_005714c8) == DAT_005714c8) {
      uVar4 = 0x80100004;
    }
    else {
        ...
        if (((*(ulong *)(param_1 + 4) & 0x100000000) == 0) ||
          ...
          if (((*(ulong *)(param_1 + 4) & 0x400000000) == 0) ||
            ...
            if (((*(ulong *)(param_1 + 4) & 0x1000000000) == 0) ||
              ...
              if ((&DAT_005714d0)[(ulong)param_1[6] + (ulong)param_1[7] * 5] == '\0') {
                uVar4 = 0x80100004;
              }
              else {
                if (*param_1 == 0) {
                  ...
                  if (uVar2 < 3) {
                    if (uVar2 == 1) {
                      ...
                      if (((0x14a < puVar1[4]) || (0x14a < puVar1[5])) ||
                         (cVar3 = FUN_001e8a7c((char)puVar1[6]), cVar3 == '\0')) {
                        return 0x80100004;
                      }
                    }
                  }
