...
void FUN_001b1900(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((uVar6 & 1) != 0) {
    ...
    *(undefined4 *)(lVar9 + 0x98) = uVar3;
    ...
    lVar10 = FUN_001bddc0(lVar10,uVar3);
    if (lVar10 == 0) {
      cVar7 = '\0';
    }
    else {
  ...
  uVar6 = FUN_00190030(uVar5);
  if ((uVar6 & 1) == 0) {
    return;
  }
  uVar3 = FUN_0018ffb0(param_1);
  iVar4 = FUN_001900a0(uVar5);
  uVar6 = FUN_001bdd50(*(undefined8 *)(param_1 + 800),uVar3);
  if ((uVar6 & 1) != 0) {
    iVar8 = (int)*(undefined8 *)(param_1 + 0x318);
    uVar11 = iVar8 + 8;
    if ((*(uint *)(*(long *)(param_1 + 800) + 4) >> 4 & 1) != 0) {
      uVar1 = iVar8 + 4;
      uVar6 = FUN_001bddb0(*(long *)(param_1 + 800),uVar3);
...
LAB_001b1ac4:
      if (*(int *)(*(long *)(param_1 + 800) + 100) == 0) {
        FUN_00190614(param_3,iVar4);
        goto LAB_001b19f0;
      }
    }
  }
  else if ((uVar11 - 0x75 & 0xfffffffb) != 0) goto LAB_001b1ac4;
  FUN_001906d0(param_3,iVar4);
LAB_001b19f0:
