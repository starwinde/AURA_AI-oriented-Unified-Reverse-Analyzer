...
void FUN_00190ef4(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  uVar6 = FUN_0018ffd0(param_1,param_2,0);
  uVar7 = FUN_00190020();
  if ((uVar7 & 1) != 0) {
    uVar3 = FUN_00190080(uVar6);
    FUN_001903f0(param_3,&DAT_001fddb8,
                 &UNK_0020cd50 + *(ushort *)(&DAT_0020d220 + (ulong)(uVar3 - 1) * 2));
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_00190f78;
    uVar3 = uVar3 & 0xffff;
    if ((*(byte *)(*(long *)(param_1 + 800) + 0x6c) & 1) != 0) {
      uVar3 = FUN_001e6bd4(uVar3);
    ...
    *(undefined1 *)(lVar11 + (ulong)*(byte *)(lVar11 + 0xa0) * 0x30 + 200) =
    ...
    pcVar8 = (char *)FUN_001e68d4(uVar6,uVar5,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98);
    if (pcVar8 == (char *)0x0) {
      local_50[0] = 0;
    }
    else {
            ...
            do {
              ...
              while (bVar17 != 0x80) {
                ...
                *pbVar2 = bVar17;
                pbVar9 = pbVar9 + -1;
                uVar3 = uVar4 & 0xff;
                if (uVar10 < (uVar4 & 0xff)) goto LAB_00191488;
                pbVar2 = pbVar2 + 1;
                bVar17 = *pbVar9;
              }
              uVar4 = uVar3 + 1;
...
LAB_00191488:
  ...
  uVar7 = FUN_00190030(uVar6);
  if ((uVar7 & 1) == 0) goto LAB_00190f78;
  uVar7 = FUN_001900a0(uVar6);
  uVar6 = FUN_0018ffb0(param_1);
  uVar3 = FUN_001e6b30(uVar6,&local_51);
  uVar3 = uVar3 & 0xff;
  uVar4 = uVar3;
  if (uVar3 == 1) {
    ...
    if (uVar10 < 0x1ce) {
      if (uVar10 < 0x1cc) {
        if (0xac < uVar10) {
          if (uVar10 != 0xee) {
            if (uVar10 == 0x15f) goto LAB_001916d8;
            if (uVar10 != 0xe5) goto LAB_00191650;
          }
LAB_001915b8:
          uVar7 = uVar7 & 0xff;
          if (uVar7 < 10) goto LAB_001916c4;
          FUN_001903f0(param_3,"$0x%x",uVar7);
          goto LAB_00191048;
        }
        if (0xa9 < uVar10) goto LAB_00191558;
        if (uVar10 == 0x18) goto LAB_001916b8;
      }
      goto LAB_00191650;
    }
    if (uVar10 == 0x279) goto LAB_001916d8;
    if (uVar10 < 0x27a) {
      if (uVar10 == 0x200) {
LAB_001916b8:
        uVar7 = uVar14;
        if (uVar14 < 10) goto LAB_001916c4;
        goto LAB_00191020;
      }
      if (uVar10 == 0x203) goto LAB_001915b8;
    }
    else if (uVar10 == 0x5df) goto LAB_001916b8;
LAB_00191650:
    uVar7 = uVar14;
    uVar14 = uVar7;
    if ((long)uVar7 < 10) {
      FUN_001903f0(param_3,&DAT_001fddd8,uVar7);
      goto LAB_00191048;
    }
LAB_00191568:
    uVar7 = uVar14;
    FUN_001903f0(param_3,"$0x%lx",uVar7);
  }
  else {
    uVar10 = **(uint **)(param_1 + 0x310);
    uVar14 = uVar7;
    if (uVar10 < 0x1ce) {
      if (0x1cb < uVar10) goto LAB_00191650;
      if (0xac < uVar10) {
        if (uVar10 != 0xee) {
          if (uVar10 == 0x15f) goto LAB_001916d8;
          if (uVar10 != 0xe5) goto LAB_00191600;
        }
        goto LAB_001915b8;
      }
      if (uVar10 < 0xaa) {
        if (uVar10 == 0x18) goto LAB_00191010;
        goto LAB_00191600;
      }
LAB_00191558:
      uVar3 = 4;
...
LAB_001916d8:
      ...
      if (uVar10 < 0x27a) {
        if (uVar10 != 0x200) {
          if (uVar10 == 0x203) goto LAB_001915b8;
LAB_00191600:
          if (-1 < (long)uVar7) goto LAB_00191650;
          ...
          if (uVar7 == 0x8000000000000000) {
            FUN_00190370(param_3,"$0x8000000000000000");
          }
          else if ((long)uVar7 < -9) {
            FUN_001903f0(param_3,"$-0x%lx",-uVar7);
          }
          else {
            FUN_001903f0(param_3,"$-%lu",-uVar7);
          }
          goto LAB_00191048;
        }
      }
      else if (uVar10 != 0x5df) goto LAB_00191600;
LAB_00191010:
      if (uVar7 < 10) {
LAB_001916c4:
        FUN_001903f0(param_3,&DAT_001fddf8,uVar7);
      }
      else {
        if (uVar3 == 0) {
...
LAB_00191020:
        uVar7 = uVar14 & *(ulong *)(PTR_DAT_005ffe50 + (long)(int)uVar4 * 8);
        FUN_001903f0(param_3,"$0x%lx",uVar7);
      }
    }
  }
