...
void FUN_001ccb80(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  uVar4 = FUN_0018ffd0();
  uVar5 = FUN_001900a0();
  FUN_001903f0(param_3,&DAT_001fdfc8,uVar5);
  ...
  lVar6 = FUN_001dbcf0(lVar7,uVar3);
