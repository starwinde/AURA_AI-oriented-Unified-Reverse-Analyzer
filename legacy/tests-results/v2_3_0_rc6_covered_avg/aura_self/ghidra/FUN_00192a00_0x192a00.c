...
void FUN_00192a00(long param_1,ulong param_2,undefined8 param_3)

{
  ...
  uVar10 = FUN_0018ffd0(param_1,param_2,0);
  uVar11 = FUN_0018ffd0(param_1,iVar4 + 2);
  uVar12 = FUN_0018ffd0(param_1,iVar4 + 3);
  uVar13 = FUN_0018ffd0(param_1,iVar4 + 4);
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_00192a8c;
  ...
  *(undefined8 *)(lVar16 + 0xc0) = 0;
  ...
  pcVar15 = (char *)FUN_001e68d4(uVar21,uVar8,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98);
  if (pcVar15 == (char *)0x0) {
    local_70[0] = 0;
  }
  else {
...
LAB_00192f50:
            ...
            if ((((((uVar1 != 1) &&
                ...
                ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0x5f)),_DAT_0020c6e0
                         ), uVar1 != 6 &&
               ...
               ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0x8f)),_DAT_0020c6e0)
                , uVar1 != 9 &&
              ...
              a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0xef)),_DAT_0020c6e0);
            }
            uVar9 = uVar7 & 0xf0;
            if ((uVar7 & 0xf) != 0) {
              uVar7 = uVar18 - uVar9;
              uVar14 = (ulong)((uVar7 & 0xff) + 1 & 0xff);
              if (6 < (uVar7 & 0xff)) goto LAB_00192f14;
              goto LAB_00192f50;
            }
          }
        }
          ...
          do {
            ...
            while (cVar3 != -0x80) {
              ...
              *pcVar5 = cVar3;
              pcVar15 = pcVar15 + -1;
              uVar7 = uVar1 & 0xff;
              if (uVar18 < (uVar1 & 0xff)) goto LAB_00193040;
              pcVar5 = pcVar5 + 1;
              cVar3 = *pcVar15;
            }
            uVar1 = uVar7 + 1;
...
LAB_00192a8c:
  ...
  if (iVar6 != 0) {
    FUN_00190d40(param_1,iVar4 + 4,param_3);
    FUN_00190370(param_3,&DAT_001fde10);
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      uVar7 = FUN_001e6bd4(iVar6);
      lVar16 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
  ...
  if ((uVar14 & 1) != 0) {
    ...
    if (uVar20 != 0) {
      iVar6 = FUN_00190080(uVar11);
      if ((iVar6 == 0) && (iVar6 = FUN_00190080(uVar10), iVar6 == 0)) {
        if ((long)uVar20 < 0) {
          FUN_001903f0(param_3,"0x%lx",
                       uVar20 & *(ulong *)(PTR_DAT_005ffe50 +
                                          (ulong)*(uint *)(*(long *)(param_1 + 800) + 4) * 8));
        }
        else if ((long)uVar20 < 10) {
          FUN_001903f0(param_3,&DAT_001fba60,uVar20);
        }
        else {
          FUN_001903f0(param_3,"0x%lx",uVar20);
        }
      }
      else {
        FUN_00190564(param_3,uVar20);
      }
    }
  }
  iVar6 = FUN_00190080(uVar11);
  if ((iVar6 == 0) && (iVar6 = FUN_00190080(uVar10), iVar6 == 0)) {
    ...
    iVar6 = FUN_00190080(uVar10);
    if (iVar6 != 0) {
      FUN_00190d40(param_1,param_2 & 0xffffffff,param_3);
    }
    iVar6 = FUN_00190080(uVar11);
    if ((iVar6 != 0) && (iVar6 = FUN_00190080(uVar11), iVar6 != 0x1e)) {
      FUN_00190370(param_3,", ");
      FUN_00190d40(param_1,iVar4 + 2,param_3);
      FUN_0018ffd0(param_1,iVar4 + 1);
      lVar16 = FUN_001900a0();
      if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
      ...
      if (lVar16 != 1) {
        FUN_001903f0(param_3,&DAT_001fde18);
      }
    }
    FUN_00190370(param_3,")");
  }
