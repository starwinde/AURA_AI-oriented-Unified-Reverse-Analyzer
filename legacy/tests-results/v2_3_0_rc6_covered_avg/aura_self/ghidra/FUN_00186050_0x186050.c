...
size_t FUN_00186050(undefined4 *param_1,FILE *param_2)

{
  ...
  case 0:
    ...
    if (param_1[0x28] == 0) {
      ...
      do {
        FUN_00186050(*(undefined8 *)(*(long *)(param_1 + 0x26) + lVar7 * 8),param_2);
  ...
  case 1:
    ...
    FUN_001855a0(*(undefined8 *)(param_1 + 0x28),param_2);
    if (*(long *)(param_1 + 0x2a) != 0) {
      fwrite(&DAT_001fcb60,1,4,param_2);
      fwrite("} else {\n",1,9,param_2);
      FUN_001855a0(*(undefined8 *)(param_1 + 0x2a),param_2);
    }
    goto LAB_0018637c;
  case 2:
    fwrite(&DAT_001fcb60,1,4,param_2);
...
LAB_00186600:
  ...
  case 4:
    ...
    fwrite(&DAT_001fabe0,1,4,param_2);
    FUN_001855a0(*(undefined8 *)(param_1 + 0x2c),param_2);
    fwrite(&DAT_001fcb60,1,4,param_2);
    goto LAB_001863a0;
  case 5:
    fwrite(&DAT_001fcb60,1,4,param_2);
    ...
    if (param_1[0x2a] != 0) {
      ...
      do {
        ...
        uVar2 = uVar2 + 1;
        lVar7 = lVar7 + 0x18;
        FUN_001855a0(*(undefined8 *)(lVar4 + 0x10),param_2);
        fwrite(&DAT_001fcb60,1,4,param_2);
        fwrite(&DAT_001fcb60,1,4,param_2);
        fwrite("break;\n",1,7,param_2);
