...
/* WARNING: Removing unreachable block (ram,0x001eff68) */

void FUN_001efb58(undefined8 *param_1,long param_2,ulong *param_3)

{
  ...
  *param_3 = *param_3 | 1;
  ...
  if (*(char *)((long)param_1 + 0x29) == '\x10') {
    cVar2 = FUN_001e8dd0(*(undefined4 *)(param_2 + 0x10),*(undefined4 *)(param_2 + 0x14));
    if (cVar2 == -1) {
  ...
  bVar3 = FUN_001f2720(*(undefined4 *)(param_2 + 0x10));
  cVar2 = FUN_001f2720(*(undefined4 *)(param_2 + 0x14));
  *(undefined1 *)((long)param_3 + 0x21) = *(undefined1 *)((long)param_1 + 0x2a);
  bVar1 = *(byte *)((long)param_3 + 0x21);
  if (bVar1 == 0x20) {
LAB_001efe30:
...
LAB_001efe40:
    ...
    if (0x10 < bVar1) goto LAB_001efe40;
    if (bVar1 == 0) {
      if ((bVar3 & 7) == 5) {
        *(undefined1 *)((long)param_3 + 0x21) = 8;
        param_3[5] = 0;
...
LAB_001effa4:
      ...
      if (bVar1 == 4) {
        *(undefined1 *)(param_3 + 3) = 2;
        ...
        if (4 < bVar1) goto LAB_001effa4;
        if (1 < bVar1) {
          if (bVar1 != 2) goto LAB_001effa4;
