...
void FUN_0016e450(long param_1,ulong *param_2,long param_3,undefined8 param_4,undefined8 *param_5,
                 undefined8 *param_6)
...
LAB_0016e55c:
      ...
      if (iVar4 != 0) {
        ...
        FUN_0018b790(param_2,param_3,&local_78,uVar12,uVar13 + uVar6,iVar4,uVar5);
        if (local_70 != 0) {
          puVar11 = malloc(0x10);
