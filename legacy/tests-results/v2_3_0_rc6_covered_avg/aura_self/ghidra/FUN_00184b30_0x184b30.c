...
size_t FUN_00184b30(int *param_1,FILE *param_2)

{
  ...
  case 0:
    ...
    if (param_1[0x28] != 0) {
      lVar9 = 0;
      do {
        FUN_00183ea0(*(undefined8 *)(*(long *)(param_1 + 0x26) + lVar9 * 8),param_2,3);
        piVar7 = *(int **)(*(long *)(param_1 + 0x26) + lVar9 * 8);
        if (((piVar7 != (int *)0x0) && (*piVar7 == 0xc)) &&
           (sVar8 = FUN_001679d0(piVar7 + 0x26), (int)sVar8 == 1)) {
          return sVar8;
        }
        uVar5 = param_1[0x28];
        lVar9 = lVar9 + 1;
  ...
  case 1:
    ...
    FUN_00183ea0(*(undefined8 *)(param_1 + 0x28),param_2,4);
    if (*(long *)(param_1 + 0x2a) != 0) {
      ...
      fwrite("} else {\n",1,9,param_2);
      FUN_00183ea0(*(undefined8 *)(param_1 + 0x2a),param_2,4);
    }
    iVar4 = 3;
    do {
      fwrite(&DAT_001fcb60,1,4,param_2);
  ...
  case 3:
    ...
    FUN_001831e0(*(undefined8 *)(param_1 + 0x26),param_2,0);
    sVar8 = fwrite(&DAT_001fab50,1,3,param_2);
    return sVar8;
  case 4:
    iVar4 = 3;
    do {
    ...
    fwrite(&DAT_001fabe0,1,4,param_2);
    iVar4 = 3;
    FUN_00183ea0(*(undefined8 *)(param_1 + 0x2c),param_2,4);
    do {
      fwrite(&DAT_001fcb60,1,4,param_2);
      iVar4 = iVar4 + -1;
    } while (iVar4 != 0);
  ...
  case 5:
    ...
    if (param_1[0x2a] != 0) {
      ...
      do {
        ...
        iVar4 = 4;
        FUN_00183ea0(puVar2[2],param_2,4);
        do {
          fwrite(&DAT_001fcb60,1,4,param_2);
          iVar4 = iVar4 + -1;
        } while (iVar4 != 0);
...
LAB_00184e68:
    sVar8 = fwrite(&DAT_001fa010,1,2,param_2);
    return sVar8;
  case 6:
    iVar4 = 3;
    do {
  ...
  case 0xc:
    ...
    if (param_1[0x4a] != 0) {
      ...
      do {
        ...
        lVar1 = lVar9 * 8;
        lVar9 = lVar9 + 1;
        FUN_001831e0(*(undefined8 *)(lVar6 + lVar1),param_2,0);
      } while ((uint)lVar9 < (uint)param_1[0x4a]);
    }
    fwrite(&DAT_001fd880,1,2,param_2);
    iVar4 = FUN_001679d0(param_1 + 0x26);
    if (iVar4 == 1) {
