...
void FUN_00186974(long param_1,FILE *param_2,undefined8 param_3)

{
  ...
  DAT_00600890 = param_1;
  DAT_00600898 = param_3;
  ...
  if (*(int *)(param_1 + 0xdd0) != 0) {
    do {
      if (*pcVar14 == '\0') {
        ...
        if (uVar3 <= iVar15 + 1U) goto LAB_00186a70;
      }
      else {
...
LAB_00186f00:
  fwrite(&DAT_001fa448,1,4,param_2);
  goto LAB_00186a74;
LAB_00186b98:
  iVar15 = (int)plVar5[1];
  pcVar14 = local_b0;
...
LAB_00186bcc:
  ...
  lVar17 = lVar17 + 1;
  if (DAT_00600870 <= (uint)lVar17) goto code_r0x00186c44;
  goto LAB_00186b28;
code_r0x00186c44:
  if (DAT_00600870 == 0) goto LAB_00186c48;
  goto LAB_00186ee4;
LAB_00186a70:
  if (uVar3 == 0) goto LAB_00186f00;
LAB_00186a74:
  fwrite(&DAT_001fd920,1,4,param_2);
  free(DAT_00600878);
  DAT_00600870 = 0;
  DAT_00600878 = (void *)0x0;
  DAT_00600880 = 0;
  local_a0 = (char *)0x0;
  local_98 = 0;
  ...
  if (__stream == (FILE *)0x0) {
    if ((*(long *)(param_1 + 0xdd8) != 0) && (*(int *)(param_1 + 0xde0) != 0)) {
      FUN_00182e70(param_1,param_2,0);
    }
    FUN_00186050(*(undefined8 *)(param_1 + 0xde8),param_2);
  }
  else {
    FUN_00186050(*(undefined8 *)(param_1 + 0xde8),__stream);
    fclose(__stream);
    if ((*(long *)(param_1 + 0xdd8) == 0) || (*(int *)(param_1 + 0xde0) == 0)) {
      if (DAT_00600870 != 0) goto LAB_00186afc;
    }
    else {
      FUN_00182e70(param_1,param_2,local_a0);
      if (DAT_00600870 != 0) {
LAB_00186afc:
        lVar17 = 0;
        local_b0 = "int16_t";
LAB_00186b28:
        lVar19 = *(long *)((long)DAT_00600878 + lVar17 * 8);
        uVar4 = FUN_001830f0(lVar19);
        if (DAT_00600888 != 0) {
          if (*(uint *)(DAT_00600888 + 0x20) != 0) {
            plVar5 = *(long **)(DAT_00600888 + 0x18);
            plVar11 = plVar5 + (ulong)*(uint *)(DAT_00600888 + 0x20) * 6;
            if (*(long *)(DAT_00600888 + 8) < 1) {
              do {
                ...
                if (lVar19 == lVar1) goto LAB_00186b98;
                plVar5 = plVar5 + 6;
              ...
              do {
                ...
                if ((lVar19 == lVar1) || (lVar19 == *(long *)(DAT_00600888 + 8) - lVar1))
                goto LAB_00186b98;
                plVar5 = plVar5 + 6;
              } while (plVar5 != plVar11);
            }
      ...
      do {
        do {
          do {
            ...
            __ptr_00 = __ptr;
            if (pcVar7 == (char *)0x0) goto LAB_00186db8;
            pcVar6 = pcVar7 + 1;
        ...
        if ((piVar9 != (int *)0x0) && (*(uint *)(param_1 + 0xde0) != 0)) {
          ...
          do {
            if (*piVar9 == (int)uVar8) goto LAB_00186c88;
            piVar9 = piVar9 + 0x33;
        ...
        if ((__ptr != (void *)0x0) && (lVar17 = 0, uVar3 != 0)) {
          do {
            if (*(ulong *)((long)__ptr + lVar17 * 8) == uVar8) goto LAB_00186c88;
            lVar17 = lVar17 + 1;
        ...
        if (__ptr != (void *)0x0) {
          if ((uint)uVar18 <= uVar3) {
            ...
            if (uVar2 <= uVar3) goto LAB_00186dac;
          }
