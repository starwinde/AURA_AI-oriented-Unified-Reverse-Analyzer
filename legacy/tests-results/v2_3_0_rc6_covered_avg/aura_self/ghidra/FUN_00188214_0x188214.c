...
void FUN_00188214(ulong *param_1,uint param_2)

{
  ...
  if (param_2 < 4) {
    ...
    if (param_2 == 7) {
      local_20 = 0x10000000004;
      local_a0._0_6_ = CONCAT24(s_float_001fa450._4_2_,s_float_001fa450._0_4_);
    ...
    if (param_2 != 8) {
      if (param_2 == 5) {
        ...
        local_a0._0_6_ = CONCAT24(DAT_001fa444,DAT_001fa440);
        local_a0 = (ulong)(uint6)local_a0;
        uVar3 = DAT_001fa440;
      }
      else {
