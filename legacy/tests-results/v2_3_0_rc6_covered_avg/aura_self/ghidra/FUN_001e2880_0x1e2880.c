...
void FUN_001e2880(long param_1,undefined8 param_2)

{
  ...
  if (*(int *)(lVar12 + 0x60) != 0) {
    ...
    *(undefined1 *)(lVar9 + 200) = uVar2;
    uVar4 = FUN_0018ffb0();
    pcVar5 = (char *)FUN_001e68d4(lVar12,uVar4,*(long *)(*(long *)(param_1 + 0x310) + 0xf0) + 0x98);
    if (pcVar5 == (char *)0x0) {
      local_40[0] = '\0';
    }
    else {
...
LAB_001e2a34:
  ...
  if (*(int *)(lVar12 + 4) == 8) {
    FUN_00190370(param_2,&DAT_001fdf80,lVar9);
    lVar9 = *(long *)(param_1 + 800);
    iVar6 = *(int *)(lVar9 + 0x60);
  }
  else {
    FUN_00190370(param_2,&DAT_00203980,lVar9);
    lVar9 = *(long *)(param_1 + 800);
    iVar6 = *(int *)(lVar9 + 0x60);
    if (iVar6 == 0) goto LAB_001e2910;
