...
undefined4 * FUN_001883d4(int *param_1,long param_2)
  ...
  if ((((param_1 != (int *)0x0 && param_2 != 0) && (*param_1 == 0x10)) && (param_1[0x28] == 3)) &&
    ...
    if (__src[0x2a] == 2) {
      ...
      if ((*piVar11 == 0xe) && ((char)piVar11[0x2a] == '\0')) {
        ...
        iVar3 = FUN_001582d0(param_2);
        if (iVar3 != 0) {
          iVar4 = 0;
          do {
            iVar2 = FUN_00158400(param_2,iVar4);
            if (iVar1 == iVar2) {
              iVar3 = 0;
              iVar1 = FUN_00158300(param_2,iVar4);
...
LAB_0018888c:
    lVar8 = FUN_00158334(param_2,iVar4,iVar3);
    if (lVar5 == lVar8) {
      ...
      *(undefined1 *)(puVar13 + 0x3a) = 1;
      ...
      FUN_001584c4(param_2,iVar4,iVar3);
      FUN_00188214(&local_f0);
      ...
      *(undefined8 *)(puVar13 + 0x21) = local_70;
      lVar5 = FUN_00158434(param_2,iVar4);
...
LAB_0018879c:
  ...
  if ((0 < lVar5) && (iVar3 = FUN_00188020(param_2,piVar11[0x26]), iVar3 != -1)) {
    iVar1 = FUN_001583d0(param_2,iVar3);
    iVar4 = (int)lVar5;
    if (iVar1 == iVar4) {
      puVar13 = calloc(1,0x130);
      ...
      *puVar13 = 0x14;
      uVar7 = FUN_001880a0(uVar7);
      *(undefined8 *)(puVar13 + 0x26) = uVar7;
      uVar7 = FUN_001880a0(*(undefined8 *)(piVar12 + 0x26));
      *(undefined8 *)(puVar13 + 0x28) = uVar7;
      puVar13[0x2a] = iVar4;
      FUN_00158510(param_2,iVar3);
      goto LAB_00188534;
    }
  }
  iVar3 = *__src;
    ...
    if (lVar5 == lVar8) {
      ...
      if (puVar13 != (undefined4 *)0x0) {
        ...
        *(undefined8 *)(puVar13 + 0x21) = local_70;
        ...
        if (lVar8 != 0 && lVar5 != 0) {
LAB_00188984:
          __snprintf_chk(lVar8 + 4,0x80,2,0x80,&DAT_001fd980,lVar5);
...
LAB_00188a08:
      if (((*piVar12 != 0xe) || ((char)piVar12[0x2a] != '\0')) ||
         ((lVar5 = *(long *)(piVar12 + 0x26), lVar5 < 1 ||
          (iVar3 = FUN_00188020(param_2,iVar3), iVar3 == -1)))) {
        piVar11 = *(int **)(__src + 0x28);
        goto joined_r0x00188a70;
      }
      iVar1 = FUN_001583d0(param_2,iVar3);
      ...
      *(undefined8 *)(puVar13 + 0x26) = uVar7;
      uVar7 = FUN_001880a0(uVar10);
      *(undefined8 *)(puVar13 + 0x28) = uVar7;
      puVar13[0x2a] = iVar1;
      FUN_00158510(param_2,iVar3);
    }
    else {
      iVar1 = FUN_00188020(param_2,iVar3);
      if (iVar1 == -1) {
LAB_00188b7c:
        piVar12 = *(int **)(piVar11 + 0x26);
...
LAB_00188a68:
      ...
      iVar4 = FUN_001583d0(param_2,iVar1);
      iVar2 = (int)lVar5;
      ...
      *puVar13 = 0x14;
      uVar7 = FUN_001880a0(uVar7);
      *(undefined8 *)(puVar13 + 0x26) = uVar7;
      uVar7 = FUN_001880a0(*(undefined8 *)(piVar11 + 0x26));
      *(undefined8 *)(puVar13 + 0x28) = uVar7;
      puVar13[0x2a] = iVar2;
      FUN_00158510(param_2,iVar1);
    }
LAB_00188534:
    FUN_00188214(&local_f0);
...
LAB_00188444:
  ...
  while (iVar3 = iVar3 + 1, iVar1 != iVar3) {
LAB_001884b0:
    lVar5 = FUN_00158334(param_2,iVar4,iVar3);
    if (lVar5 == 0) {
      puVar13 = calloc(1,0x130);
      if (puVar13 != (undefined4 *)0x0) {
        *puVar13 = 0x13;
