...
void FUN_001e20d0(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  uVar8 = FUN_0018ffd0(param_1,param_2,0);
  uVar9 = FUN_00190020();
  if ((uVar9 & 1) == 0) {
    uVar9 = FUN_00190030(uVar8);
    if ((uVar9 & 1) == 0) goto LAB_001e2260;
    uVar11 = FUN_001900a0(uVar8);
    uVar8 = FUN_0018ffb0(param_1);
    uVar4 = FUN_001e6b30(uVar8,&local_51);
    uVar4 = uVar4 & 0xff;
    ...
    if (uVar6 < 0x1ce) {
      if (uVar6 < 0x1cc) {
        if (0xac < uVar6) {
          if (uVar6 != 0xee) {
            if (uVar6 == 0x15f) goto LAB_001e2508;
            if (uVar6 != 0xe5) goto LAB_001e24e8;
          }
LAB_001e249c:
          uVar9 = uVar9 & 0xff;
          FUN_001e1080(uVar3,*(undefined8 *)(param_1 + 800),param_3,uVar9,1);
          goto LAB_001e2324;
        }
        if (uVar6 < 0xaa) {
          if (uVar6 == 0x18) goto LAB_001e2554;
          goto LAB_001e24e8;
        }
        uVar4 = 4;
        if ((int)param_2 == 1) {
...
LAB_001e2508:
      ...
      if (uVar9 < 10) {
LAB_001e2590:
        FUN_001e1080(uVar3,uVar8,param_3,uVar9,1);
      }
      else {
        uVar9 = uVar9 & 0xffff;
        FUN_001e1080(uVar3,uVar8,param_3,uVar9,1);
...
LAB_001e2554:
          uVar8 = *(undefined8 *)(param_1 + 800);
          if (uVar9 < 10) goto LAB_001e2590;
          uVar6 = uVar4;
          if (uVar4 == 0) {
            uVar6 = (uint)*(byte *)(param_1 + 0x334);
          }
          uVar9 = uVar9 & *(ulong *)(PTR_DAT_005ffe50 + (long)(int)uVar6 * 8);
          FUN_001e1080(uVar3,uVar8,param_3,uVar9,1);
          goto LAB_001e2324;
        }
        if (uVar6 == 0x203) goto LAB_001e249c;
      }
      else if (uVar6 == 0x5df) goto LAB_001e2554;
LAB_001e24e8:
      FUN_001e1080(uVar3,*(long *)(param_1 + 800),param_3,uVar9,
    ...
    if (*(int *)(lVar13 + 0x60) != 0) {
      ...
      if ((*(byte *)(lVar13 + 0x6c) & 1) == 0) {
        ...
        *(ulong *)(lVar16 + (long)(int)(uint)bVar2 * 0x30 + 0xb0) = uVar9;
        ...
        pcVar10 = (char *)FUN_001e68d4(lVar13,uVar7,
...
LAB_001e23d4:
  ...
  uVar4 = FUN_00190080(uVar8);
  FUN_00190370(param_3,&UNK_003e7d80 + *(ushort *)(&DAT_003e8250 + (ulong)(uVar4 - 1) * 2));
