...
void FUN_001f34d4(long param_1,long *param_2)

{
  ...
  if (bVar2 < 0x11) {
    if (bVar2 == 4) {
      puVar8 = (undefined4 *)FUN_001f3080(param_2,5);
      uVar4 = DAT_0020c4fc;
    ...
    if (bVar2 < 5) {
      if (bVar2 == 1) {
        pcVar11 = (char *)FUN_001f3080(param_2,6);
        uVar3 = s_false_00203a80._4_2_;
        if (pcVar11 == (char *)0x0) goto LAB_001f359c;
        *(undefined4 *)pcVar11 = s_false_00203a80._0_4_;
        *(undefined2 *)(pcVar11 + 4) = uVar3;
      }
      else {
        if ((bVar2 != 2) ||
           (puVar8 = (undefined4 *)FUN_001f3080(param_2,5), uVar4 = DAT_00203a94,
           puVar8 == (undefined4 *)0x0)) goto LAB_001f359c;
        *puVar8 = DAT_00203a90;
        *(undefined1 *)(puVar8 + 1) = uVar4;
      }
LAB_001f3564:
      ...
      if ((NAN(dVar21)) || (dVar22 = ABS(dVar21), 1.79769313486232e+308 < dVar22)) {
        uVar6 = 4;
        local_90 = (ulong)CONCAT14(DAT_0020c4fc,DAT_0020c4f8);
LAB_001f362c:
        uVar20 = (ulong)(int)uVar6;
        puVar10 = (ulong *)FUN_001f3080(param_2,uVar20 + 1);
...
LAB_001f3a2c:
        ...
        iVar7 = __isoc99_sscanf(&local_90,&DAT_0020c508,&local_98);
        if (iVar7 == 1) {
          if (dVar22 < ABS(local_98)) {
            dVar22 = ABS(local_98);
          }
          if (dVar22 * 2.220446049250313e-16 < ABS(local_98 - dVar21)) goto LAB_001f3ba4;
        }
        else {
LAB_001f3ba4:
          uVar6 = __sprintf_chk(dVar21,&local_90,2,0x1a,"%1.17g");
        }
        if (uVar6 < 0x1a) goto LAB_001f362c;
      }
    ...
    if (bVar2 == 0x40) {
      ...
      if ((ulong)param_2[3] < 1000) {
        ...
        puVar12 = (undefined1 *)FUN_001f3080(param_2,uVar1);
        if (puVar12 != (undefined1 *)0x0) {
          *puVar12 = 0x7b;
          ...
          if (plVar19 != (long *)0x0) {
            while( true ) {
              if (iVar7 != 0) {
                lVar17 = FUN_001f3080(param_2,param_2[3]);
                if (lVar17 == 0) goto LAB_001f359c;
                uVar20 = 0;
                if (param_2[3] != 0) {
                  uVar18 = 0;
                  do {
              ...
              iVar7 = FUN_001f31a4(plVar19[7],param_2);
              if (iVar7 == 0) goto LAB_001f359c;
              if (*param_2 != 0) {
                lVar17 = param_2[2];
              ...
              puVar12 = (undefined1 *)FUN_001f3080(param_2,lVar17);
              if (puVar12 == (undefined1 *)0x0) goto LAB_001f359c;
              *puVar12 = 0x3a;
              if (*(int *)((long)param_2 + 0x24) != 0) {
                puVar12[1] = 9;
              }
              param_2[2] = param_2[2] + lVar17;
              iVar7 = FUN_001f34d4(plVar19,param_2);
              if (iVar7 == 0) goto LAB_001f359c;
              if (*param_2 != 0) {
                lVar17 = param_2[2];
                sVar13 = strlen((char *)(*param_2 + lVar17));
              ...
              puVar14 = (undefined2 *)FUN_001f3080(param_2,uVar20 + 1);
              if (puVar14 == (undefined2 *)0x0) goto LAB_001f359c;
              puVar16 = puVar14;
              if (*plVar19 != 0) {
          ...
          puVar14 = (undefined2 *)FUN_001f3080(param_2,lVar17);
      ...
      if (*(char **)(param_1 + 0x20) != (char *)0x0) {
        ...
        __dest = (void *)FUN_001f3080(param_2,sVar13 + 1);
        if (__dest != (void *)0x0) {
          ...
          goto LAB_001f3564;
            ...
            && (puVar12 = (undefined1 *)FUN_001f3080(param_2,1), puVar12 != (undefined1 *)0x0)) {
      *puVar12 = 0x5b;
      lVar17 = _DAT_0020c6d0;
      lVar15 = param_2[2] + _DAT_0020c6d0;
      param_2[3] = param_2[3] + _UNK_0020c6d8;
      param_2[2] = lVar15;
      ...
      puVar14 = (undefined2 *)FUN_001f3080(param_2,2);
      if (puVar14 != (undefined2 *)0x0) {
        *puVar14 = 0x5d;
        param_2[3] = param_2[3] + -1;
        goto LAB_001f3564;
