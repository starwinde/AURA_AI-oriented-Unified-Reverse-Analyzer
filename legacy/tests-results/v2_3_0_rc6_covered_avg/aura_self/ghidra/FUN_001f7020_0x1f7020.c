...
undefined8 FUN_001f7020(long param_1,long *param_2,long *param_3)

{
  ...
  *param_3 = lVar3;
  if (lVar3 == 0) {
    if (plVar2 == param_2) goto LAB_001f70a8;
    puVar1 = (undefined8 *)param_3[1];
    if (puVar1 != (undefined8 *)0x0) goto LAB_001f7074;
  }
  else {
...
LAB_001f70a8:
      ...
      *param_2 = 0;
      param_2[1] = 0;
      FUN_001f43e0(param_2);
      return 1;
    }
    puVar1 = (undefined8 *)param_3[1];
    if (puVar1 == (undefined8 *)0x0) goto LAB_001f7080;
LAB_001f7074:
    *puVar1 = param_3;
    if (*param_3 != 0) goto LAB_001f7080;
  }
