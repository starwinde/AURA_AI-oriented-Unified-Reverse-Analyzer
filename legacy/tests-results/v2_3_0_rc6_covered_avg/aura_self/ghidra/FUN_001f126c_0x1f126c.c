...
int FUN_001f126c(undefined4 *param_1,long param_2,ulong *param_3,ulong param_4)

{
  ...
  if (((param_1 == (undefined4 *)0x0) || (param_2 == 0)) || (param_3 == (ulong *)0x0)) {
    ...
    iVar7 = FUN_001f0af4(param_1,0);
    if (-1 < iVar7) {
      lVar10 = FUN_001f22bc(param_1[2]);
      local_a0 = (int *)0x0;
      bVar4 = false;
      local_98 = 0;
      uVar8 = FUN_001e7d38(*param_1);
      uVar8 = (uVar8 & 0xff) >> 5;
...
LAB_001f18d0:
            ...
            if (bVar6 != 0) {
              ...
              cVar3 = (&DAT_00571510)[(ulong)(uint)param_1[8] + (long)(int)uVar8 * 4];
              if (cVar3 < '\0') {
                iVar7 = -0x7feffffc;
              }
              else {
...
LAB_001f18fc:
          ...
          local_20 = DAT_00570f38;
          uVar5 = local_20;
          local_1e = DAT_00570f3a;
          local_bd = false;
          local_bc = 0;
          local_20._1_1_ = (undefined1)((ushort)DAT_00570f38 >> 8);
          local_20 = uVar5;
          if (*(char *)(lVar10 + 9) == '\0') {
            ...
            if (param_1[7] == 0) {
              ...
              local_90 = (undefined2 *)(&UNK_005714f0 + (long)(int)uVar8 * 3);
            }
            else {
            ...
            local_90 = (undefined2 *)(&UNK_00571500 + (long)(int)uVar8 * 3);
          }
          else {
            if (param_1[9] != 4) {
...
LAB_001f1978:
      ...
      iVar7 = FUN_001f106c(param_1,param_2,param_3,auStack_60);
      if (-1 < iVar7) {
        if (local_a0 != (int *)0x0) {
          uVar12 = *param_3;
          if (-uVar12 < param_4) {
