...
int FUN_001eebec(long param_1,undefined8 param_2)

{
  ...
  FUN_001ee8f4(param_1,&local_33,&local_32,&local_31,&local_30);
  ...
  if ((local_33 == 1) && ((local_30 & 0xb) == 0)) {
    local_2f = (~local_30 & 4) << 5 | (local_31 & 0xf) << 3 | *(char *)(param_1 + 0x14) << 2 |
               local_32;
    iVar1 = FUN_001ee2b4(0xffffffc5,param_2);
    local_2c = iVar1;
    if (iVar1 < 0) goto LAB_001eee48;
    iVar1 = FUN_001ee2b4(local_2f,param_2);
    local_28 = iVar1;
  }
  else {
    ...
    local_2d = (local_30 & 8) << 4 | (local_31 & 0xf) << 3 | *(char *)(param_1 + 0x14) << 2 |
               local_32;
    iVar1 = FUN_001ee2b4(0xffffffc4,param_2);
    local_24 = iVar1;
    if ((iVar1 < 0) || (iVar1 = FUN_001ee2b4(local_2e,param_2), local_20 = iVar1, iVar1 < 0))
    goto LAB_001eee48;
    iVar1 = FUN_001ee2b4(local_2d,param_2);
    local_1c = iVar1;
  }
  if (-1 < iVar1) {
    iVar1 = 0x100000;
