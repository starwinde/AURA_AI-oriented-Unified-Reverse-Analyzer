...
undefined4 FUN_00140e94(long param_1)
      ...
      if (*(uint *)(lVar4 + 0x20) != 0) {
        ...
        do {
          if (((char *)*puVar16 != (char *)0x0) &&
            ...
            lVar6 = FUN_001446e0(*(undefined4 *)(lVar4 + 0xc));
            if (lVar6 != 0) {
              uVar13 = 0;
              uVar7 = FUN_00144f60(*(undefined4 *)(lVar4 + 0xc));
              __printf_chk(2,"Disassembly of .text from \'%s\' [%s]:\n",param_1,uVar7);
              __printf_chk(2,"  0x%016lx .. 0x%016lx  (%lu bytes)\n\n",puVar16[1],
                           puVar16[1] + puVar16[3]);
              uVar8 = puVar16[3];
              if (uVar8 != 0) goto LAB_00140fe8;
              goto LAB_001410e0;
            }
...
LAB_00140fe8:
  do {
    iVar3 = FUN_001447f0(lVar6,lVar5 + uVar13,uVar8 - uVar13,uVar13 + puVar16[1],local_e068,0x100);
    if (iVar3 < 1) break;
    puVar10 = local_e060;
...
LAB_00141088:
        ...
        if (uVar12 < 8) goto LAB_00141088;
      }
      if (puVar10[0x58] == '\0') {
        __printf_chk(2,&DAT_001f9280,puVar10 + 0x18);
      }
      else {
