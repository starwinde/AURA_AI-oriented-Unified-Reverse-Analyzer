...
int FUN_001eea38(long param_1,undefined8 param_2)

{
  ...
  FUN_001ee8f4(param_1,&local_2a,&local_29,&local_28,&local_27);
  ...
  ;
  iVar1 = FUN_001ee2b4(0xffffff8f,param_2);
  local_24 = iVar1;
  if (((-1 < iVar1) && (iVar1 = FUN_001ee2b4(local_26,param_2), local_20 = iVar1, -1 < iVar1)) &&
     (local_1c = FUN_001ee2b4(local_25,param_2), iVar1 = local_1c, -1 < local_1c)) {
    iVar1 = 0x100000;
  }
