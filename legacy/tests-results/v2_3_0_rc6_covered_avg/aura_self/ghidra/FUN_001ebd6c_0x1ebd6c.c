...
undefined8 FUN_001ebd6c(long param_1,long param_2)

{
  ...
  if ((*(byte *)(*(long *)(param_1 + 8) + 6) & 7) == 4) {
    ...
    cVar3 = FUN_001f2458(*(undefined4 *)(param_2 + 8),auStack_24);
    if (((cVar3 == '\0') &&
...
LAB_001ebfd4:
        ...
        if (bVar2 == 2) {
          ...
          if ((bVar1 & 3) == 0) {
            ...
            if (bVar2 != 1) goto LAB_001ebfd4;
            if ((*(char *)(param_2 + 0x178) != '\0') || (*(int *)(param_2 + 0x174) != 0)) {
              uVar4 = 0;
              goto LAB_001ec014;
            }
            cVar3 = FUN_001ebac4(local_20,*(ushort *)(*(long *)(param_1 + 8) + 8) >> 8 & 3,
