...
void FUN_00176034(undefined8 *param_1,long param_2,ulong param_3,uint param_4)

{
  ...
  local_90 = 0;
  local_88 = 0;
  if (param_2 == 0 || param_3 == 0) goto LAB_00176110;
  if (param_4 == 3) {
    local_98 = 6;
    goto LAB_00176110;
  }
  if (3 < param_4) {
    if (param_4 != 4) goto LAB_00176110;
    uVar18 = param_3;
    if (0x14 < param_3) {
      uVar18 = 0x14;
    }
...
LAB_00176378:
            ...
            if (pcVar23 != (char *)0x0) {
              ...
              do {
                ...
                if (pcVar12 == (char *)0x0) goto LAB_00176360;
            ...
            do {
              ...
              if (pcVar14 == (char *)0x0) goto LAB_00176378;
            ...
            if (iVar8 == 0) {
LAB_00176400:
              if (!bVar5) goto LAB_00176360;
            }
            else {
LAB_00176344:
              iVar8 = strncmp(pcVar13,*ppuVar16,2);
              if (iVar8 == 0) goto LAB_00176400;
            }
...
LAB_00176680:
      ...
      if (iVar8 != 0) {
        iVar8 = FUN_00175690(pcVar19 + -0x40);
        pcVar13 = (char *)&local_70;
        puVar22 = &local_78;
        ppuVar16 = &PTR_DAT_005e00d0;
        pcVar20 = local_d0;
LAB_001767f4:
        pcVar23 = *ppuVar16;
        if (pcVar23 != (char *)0x0) {
          ...
          do {
            pcVar12 = strstr(pcVar14,pcVar23);
            if (pcVar12 == (char *)0x0) {
              if (ppuVar16[1] == (undefined *)0x0) goto joined_r0x001768c4;
              bVar5 = false;
              goto LAB_00176738;
            }
            pcVar14 = pcVar12 + sVar11;
...
LAB_001767a4:
          ...
          if ((*pcVar13 == '\0') && (pcVar14 = strchr(pcVar19,0x2c), pcVar14 != (char *)0x0)) {
            ...
            do {
              ...
              if (pcVar15 == (char *)0x0) {
                if (pcVar20 == (char *)0x0) goto LAB_001768ac;
                sVar11 = strlen(pcVar20);
                pcVar23 = pcVar14;
                goto LAB_0017695c;
              }
...
LAB_00176738:
          ...
          do {
            ...
            if (pcVar12 == (char *)0x0) {
              if (!bVar5) goto joined_r0x001768c4;
              break;
            }
            pcVar14 = pcVar12 + sVar11;
          } while (((pcVar19 < pcVar12) &&
  ...
  if (param_4 != 1) {
    if (param_4 == 2) {
      uVar6 = FUN_00175994();
      uVar7 = FUN_00175844(param_2,param_3,(long)&local_88 + 4);
  ...
  uVar6 = FUN_00175994();
  iVar8 = FUN_00175844(param_2,param_3,(long)&local_88 + 4);
  uVar3 = local_88;
  local_88 = CONCAT44(local_88._4_4_,iVar8);
  uVar4 = local_88;
  local_88._4_2_ = SUB82(uVar3,4);
  if ((uVar6 & 0x88) == 0 || (uVar6 & 0x104) == 0) {
    if ((iVar8 == 0) || (local_88._4_2_ == 0)) goto LAB_00176448;
...
LAB_0017695c:
    ...
    if (pcVar12 == (char *)0x0) goto LAB_001768ac;
  }
LAB_001768a4:
  *(undefined1 *)puVar22 = 1;
LAB_001768ac:
  *pcVar13 = '\x01';
joined_r0x001768c4:
  if (ppuVar16 == &PTR_DAT_005e0140) goto LAB_001768c8;
  puVar22 = (undefined8 *)((long)puVar22 + 1);
  pcVar13 = pcVar13 + 1;
  pcVar20 = ppuVar16[3];
  ppuVar16 = ppuVar16 + 2;
...
LAB_001768c8:
  ...
  if (pcVar17 == pcVar19) goto LAB_001768d8;
  goto LAB_00176680;
LAB_001768d8:
  if ((char)local_78 != '\0') {
    if (local_78._1_1_ == '\0') {
...
LAB_001764a8:
    if ((((*pcVar17 == 'x') && (pcVar17[1] == '0')) || ((*pcVar17 == 'w' && (pcVar17[1] == '0'))))
       && ((0x19 < (byte)(pcVar17[2] + 0x9fU) && 9 < (byte)(pcVar17[2] - 0x30U) &&
           (iVar8 = FUN_00175690(pcVar17 + -0x40), iVar8 == 0)))) {
      if (uVar18 <= uVar21) goto LAB_00176af0;
  ...
  while( true ) {
    while (pcVar13 = strstr(pcVar17,"w0"), pcVar13 != (char *)0x0) {
      ...
      if (((pcVar13 <= pcVar19) ||
         ...
         (0x19 < (byte)(pcVar13[2] + 0x9fU) && 9 < (byte)(pcVar13[2] - 0x30U))) goto LAB_00176110;
    }
