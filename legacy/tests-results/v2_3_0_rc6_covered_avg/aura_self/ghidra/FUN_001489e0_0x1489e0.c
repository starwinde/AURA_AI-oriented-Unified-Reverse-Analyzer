...
undefined8 FUN_001489e0(long *param_1,FILE *param_2)
      ...
      if (*(int *)(lVar1 + 0x18) != 0) {
        do {
          while( true ) {
            ...
            fwrite(&DAT_001f9e68,1,2,param_2);
            FUN_00147a40(param_2,lVar2 + 0x20);
            if (*(char *)(lVar2 + 0x60) == '\0') break;
            fputc(0x20,param_2);
            uVar8 = uVar8 + 1;
            FUN_00147a40(param_2,lVar2 + 0x60);
            lVar7 = lVar7 + 0xe0;
...
LAB_00148af8:
      fwrite(&DAT_001fa008,1,4,param_2);
      uVar9 = uVar9 + 1;
