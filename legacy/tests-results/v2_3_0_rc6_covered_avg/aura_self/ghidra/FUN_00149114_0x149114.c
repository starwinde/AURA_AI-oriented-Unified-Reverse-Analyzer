...
void FUN_00149114(long param_1,uint *param_2,uint *param_3)
...
LAB_0014925c:
    ...
    if ((iVar3 == 0) || (iVar3 = strcasecmp(__s1,"lea"), iVar3 == 0)) {
      ...
      uVar5 = FUN_00148f70(__dest);
      if (-1 < (int)uVar5) {
        if (__dest == (byte *)0x0) {
          *param_2 = 1 << (ulong)(uVar5 & 0x1f);
          uVar5 = FUN_00148f70(pbVar13);
          if (-1 < (int)uVar5) {
...
LAB_00149464:
    ...
    if (((((iVar3 == 0) || (iVar3 = strcasecmp(__s1,"sub"), iVar3 == 0)) ||
      ...
      if (bVar2) {
        uVar6 = FUN_00148f70(__dest);
        uVar5 = 0;
        uVar4 = FUN_00148f70(pbVar13);
        if ((-1 < (int)uVar6) &&
           ((__dest == (byte *)0x0 ||
