...
undefined8 FUN_001ec77c(long *param_1)

{
  ...
  if (bVar2 == 5) {
    ...
    if (bVar2 == 3) {
      ...
      if ((*(byte *)(lVar8 + 0xc) & 0x20) != 0) {
        ...
        cVar4 = FUN_001f2720(*(undefined4 *)(lVar7 + 0x34));
        cVar5 = FUN_001f2720(*(undefined4 *)(lVar7 + 0x84));
        cVar3 = FUN_001f2720(*(undefined4 *)(lVar7 + 0xb4));
  ...
  if ((local_3e != 0) && (*piVar1 == 1)) {
    ...
    cVar4 = FUN_001f2720(*(undefined4 *)(lVar7 + 0x34));
    cVar5 = FUN_001f2720(*(undefined4 *)(lVar7 + 0xc4));
    if (cVar4 == cVar5) {
      return 0;
    }
  }
