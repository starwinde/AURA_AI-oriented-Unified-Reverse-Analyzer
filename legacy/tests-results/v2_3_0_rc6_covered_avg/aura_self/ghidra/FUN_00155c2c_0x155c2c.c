...
ulong FUN_00155c2c(long *param_1)
    ...
    if (*(uint *)(puVar8 + 1) != 0) {
      ...
      do {
        while( true ) {
          ...
          if (iVar2 != 0) {
            if ((piVar3[6] != -1) &&
               (iVar1 = FUN_00155b50(param_1,piVar3[6]), piVar3 = extraout_x10, uVar5 = extraout_x13
               , param_1 = extraout_x14, piVar7 = extraout_x18, iVar2 = extraout_w11,
               extraout_w12 != iVar1)) {
            ...
            if (iVar2 != 1) {
              if ((piVar3[10] != -1) &&
                 (iVar1 = FUN_00155b50(param_1,piVar3[10]), piVar3 = extraout_x10_00,
              ...
              if (((iVar2 != 2) && (piVar3[0xe] != -1)) &&
                 (iVar2 = FUN_00155b50(param_1,piVar3[0xe]), piVar3 = extraout_x10_01,
          ...
          do {
            if ((*piVar4 != -1) &&
               (iVar2 = FUN_00155b50(param_1,*piVar4), piVar3 = extraout_x10_02,
