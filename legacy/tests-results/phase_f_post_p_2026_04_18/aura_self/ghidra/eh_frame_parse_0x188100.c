...
LAB_001881c8:
    if (((char *)*puVar30 != (char *)0x0) &&
       (iVar9 = strcmp((char *)*puVar30,".gcc_except_table"), iVar9 == 0)) goto LAB_001881f0;
  }
...
LAB_001881f0:
  ...
  if (puVar34 != (undefined8 *)0x0) {
    ...
    if (uVar31 == 0) {
      ...
      uVar41 = 0;
      __ptr = (long *)0x0;
      if (puVar30 == (undefined8 *)0x0) goto LAB_00189260;
LAB_001883a4:
      uVar40 = (uint)uVar31;
      uVar24 = 0;
      pvVar11 = (void *)0x0;
              ...
              if (uVar31 < uVar33) {
                ...
                if (uVar23 < uVar33) {
                  ...
                  if (*(char *)(lVar10 + uVar23) != -1) {
                    if (uVar33 <= local_70) goto LAB_00189938;
                  ...
                  if (local_70 < uVar33) {
                    ...
                    uVar23 = uVar31;
                    if (uVar33 <= uVar31) goto LAB_001885b8;
                    uVar23 = local_70 + 2;
...
LAB_001886d0:
                          ...
                          if (uVar18 <= uVar23) goto LAB_001883f4;
                        } while (cVar21 != '\x01');
LAB_00189310:
                        if (uVar23 < uVar33) {
                          unaff_x26 = uVar23 + 1;
...
LAB_00189fa4:
                  ...
                  if (cVar21 == '\x01') goto LAB_00188870;
                  if (cVar21 != '\x03') break;
LAB_00188734:
                  if (uVar33 < uVar23 + 4) {
                    uVar39 = 0;
...
LAB_00188804:
                    ...
                    do {
                      ...
                      if (uVar18 <= uVar23) goto LAB_001883f4;
                      if (cVar21 != '\x01') goto LAB_00188734;
LAB_00188870:
                      uVar39 = 0;
                      if (uVar33 <= uVar23) {
LAB_00189fb8:
...
LAB_00189fbc:
                      ...
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_00189fb8;
                      uVar31 = local_70 + 1;
                      ...
                      local_70 = uVar23;
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_00189fbc;
                      uVar31 = local_70 + 1;
...
LAB_001891e4:
              uVar33 = uVar18 + 8;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_00188db0;
              if (uVar31 < uVar18 + 4) goto LAB_00189900;
...
LAB_001892c4:
                ...
                uVar18 = local_70;
                if (uVar23 <= uVar31) goto LAB_001891e4;
                break;
              }
              local_70 = uVar31 + 4;
              if (local_70 <= uVar31) {
              ...
              local_70 = uVar31;
              if (uVar31 < 0xfffffffffffffff8) goto LAB_00188db0;
LAB_00189900:
              uVar33 = uVar31 + 4;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_00188db0;
                ...
                if (*plVar13 == lVar10) {
                  ...
                  if (uVar40 < 0x80000) {
                    if (uVar27 <= uVar40) {
                      ...
                      if (pvVar11 != (void *)0x0) goto LAB_00188370;
                      break;
                    }
                  }
                  else {
...
LAB_00188db0:
            ...
            uVar26 = uVar25;
            if (uVar41 < 0x10000) {
              if (uVar41 < uVar25) goto LAB_00188dc0;
              if (uVar25 == 0) {
                sVar17 = 0x900;
                uVar26 = 0x20;
              }
              ...
              if (plVar13 != (long *)0x0) goto LAB_001891c0;
            }
            else {
LAB_001891c0:
              __ptr = plVar13;
...
LAB_00188e38:
                ...
                *(undefined1 *)((long)plVar13 + uVar39 + lVar10 + 0x24) = 0;
                if (uVar38 < uVar31) {
                  ...
                  if (uVar31 <= local_70) goto LAB_00189cb0;
...
LAB_00189f34:
                  ...
                  if (uVar31 <= local_70) goto LAB_00189cb4;
...
LAB_00189e10:
      ...
      uVar31 = (ulong)uVar40;
      if (puVar30 != (undefined8 *)0x0) goto LAB_001883a4;
LAB_00189260:
      pvVar11 = (void *)0x0;
      uVar24 = 0;
    }
