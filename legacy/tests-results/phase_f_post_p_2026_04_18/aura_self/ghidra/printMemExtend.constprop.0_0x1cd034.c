...
void printMemExtend_constprop_0(long param_1,undefined8 param_2,char param_3,ulong param_4)

{
  ...
  if (param_3 == 'x' && iVar2 == 0) {
    ...
    if (iVar2 == 0) {
      SStream_concat(param_2,"%cxt%c",0x75,param_3);
      ...
      SStream_concat(param_2,"%cxt%c",0x73,param_3);
      if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
        lVar4 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
  ...
  SStream_concat(param_2,&DAT_001fe6f0,iVar2);
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
    return;
  }
  lVar4 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
