...

{
  ...
  if ((uVar7 & 1) != 0) {
    ...
    SStream_concat(param_3,&DAT_001fc858,
                   &AsmStrs_0 + *(ushort *)(RegAsmOffset_1 + (ulong)(uVar3 - 1) * 2));
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_0018fa08;
    uVar3 = uVar3 & 0xffff;
            ...
            do {
              ...
              while (bVar17 != 0x80) {
                ...
                *pbVar2 = bVar17;
                pbVar9 = pbVar9 + -1;
                uVar3 = uVar4 & 0xff;
                if (uVar10 < (uVar4 & 0xff)) goto LAB_0018ff18;
                pbVar2 = pbVar2 + 1;
                bVar17 = *pbVar9;
              }
              uVar4 = uVar3 + 1;
...
LAB_0018ff18:
  ...
  if ((uVar7 & 1) == 0) goto LAB_0018fa08;
  ...
  if (uVar3 == 1) {
    ...
    if (uVar10 < 0x1ce) {
      if (uVar10 < 0x1cc) {
        if (0xac < uVar10) {
          if (uVar10 != 0xee) {
            if (uVar10 == 0x15f) goto LAB_00190168;
            if (uVar10 != 0xe5) goto LAB_001900e0;
          }
LAB_00190048:
          uVar7 = uVar7 & 0xff;
          if (uVar7 < 10) goto LAB_00190154;
          SStream_concat(param_3,"$0x%x",uVar7);
          goto LAB_0018fad8;
        }
        if (0xa9 < uVar10) goto LAB_0018ffe8;
        if (uVar10 == 0x18) goto LAB_00190148;
      }
      goto LAB_001900e0;
    }
    if (uVar10 == 0x279) goto LAB_00190168;
    if (uVar10 < 0x27a) {
      if (uVar10 == 0x200) {
LAB_00190148:
        uVar7 = uVar14;
        if (uVar14 < 10) goto LAB_00190154;
        goto LAB_0018fab0;
      }
      if (uVar10 == 0x203) goto LAB_00190048;
    }
    else if (uVar10 == 0x5df) goto LAB_00190148;
LAB_001900e0:
    uVar7 = uVar14;
    uVar14 = uVar7;
    if ((long)uVar7 < 10) {
      SStream_concat(param_3,&DAT_001fc878,uVar7);
      goto LAB_0018fad8;
    }
LAB_0018fff8:
    uVar7 = uVar14;
    ...
    uVar14 = uVar7;
    if (uVar10 < 0x1ce) {
      if (0x1cb < uVar10) goto LAB_001900e0;
      if (0xac < uVar10) {
        if (uVar10 != 0xee) {
          if (uVar10 == 0x15f) goto LAB_00190168;
          if (uVar10 != 0xe5) goto LAB_00190090;
        }
        goto LAB_00190048;
      }
      if (uVar10 < 0xaa) {
        if (uVar10 == 0x18) goto LAB_0018faa0;
        goto LAB_00190090;
      }
LAB_0018ffe8:
      uVar3 = 4;
...
LAB_00190168:
      ...
      if (uVar10 < 0x27a) {
        if (uVar10 != 0x200) {
          if (uVar10 == 0x203) goto LAB_00190048;
LAB_00190090:
          if (-1 < (long)uVar7) goto LAB_001900e0;
      ...
      else if (uVar10 != 0x5df) goto LAB_00190090;
LAB_0018faa0:
      if (uVar7 < 10) {
LAB_00190154:
        SStream_concat(param_3,&DAT_001fc898,uVar7);
      }
      else {
        if (uVar3 == 0) {
