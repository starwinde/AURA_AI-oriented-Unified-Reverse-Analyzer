...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n","Offset",&DAT_001f9fa0,
                  &DAT_001f9fb8,&DAT_001f9fb0,&DAT_001fbd98,"Source");
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n",&DAT_001fbde0,&DAT_001fbdd0,
                  &DAT_001fbdd0,&DAT_001fbdd0,&DAT_001fbdd0,&DAT_001fbde0);
    if (*(int *)(param_1 + 4) != 0) {
      lVar11 = 0;
      uVar10 = 0;
      do {
        ...
        if (uVar5 == 2) {
          pcVar9 = "arg";
LAB_00178288:
          if (*(int *)(lVar1 + 0x24) == 1) goto LAB_00178344;
LAB_00178294:
          pcVar7 = "heuristic";
        }
        else {
          ...
          if (*(int *)(lVar1 + 0x24) != 1) goto LAB_00178294;
LAB_00178344:
          pcVar7 = "DWARF";
        }
