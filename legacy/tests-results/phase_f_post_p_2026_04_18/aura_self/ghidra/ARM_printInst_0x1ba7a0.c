...

{
  ...
  if (uVar7 == 0x370) {
    ...
    if (iVar8 == 0xc) {
      ...
      if (lVar12 == -4) {
        SStream_concat0(param_2,&DAT_001f8bb0);
        MCInst_setOpcodePub(param_1,0x80);
        printPredicateOperand(param_1,4,param_2);
        SStream_concat0(param_2,&DAT_001fd1c8);
...
LAB_001bb47c:
        ...
        if (lVar12 == 0) {
          SStream_concat0(param_2,&DAT_001f8160,0);
          return;
        }
        goto LAB_001bc474;
      }
...
LAB_001bb384:
      ...
      iVar8 = MCOperand_getReg();
      if (iVar8 != 0xc) goto LAB_001ba920;
...
LAB_001bac94:
        ...
        iVar8 = MCOperand_getReg();
        if (iVar8 == 0xc) {
          SStream_concat0(param_2,&DAT_001fd1d8);
          uVar18 = 0x18a;
          goto LAB_001bb3b0;
        }
      }
      else if (uVar7 < 0x697) {
        if (uVar7 == 0x387) goto LAB_001bab44;
        if (uVar7 == 0x692) goto LAB_001bac94;
      }
      else if (uVar7 == 0xa45) goto LAB_001bb384;
    }
    else {
      if (uVar7 == 0xc0f) {
LAB_001bab44:
...
LAB_001bb16c:
          ...
          if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
            SStream_concat0(param_2,&DAT_001f8bb8);
...
joined_r0x001ba884:
        ...
        else if (uVar7 == 0xbe3) goto LAB_001ba810;
      }
      else if (uVar7 == 0xc5d) {
        uVar7 = 3;
        bVar5 = true;
        ...
        SStream_concat0(param_2,&DAT_001fd1e0);
...
LAB_001bc24c:
        ...
        if (uVar7 == 0x262) goto LAB_001bb5f8;
        if (uVar7 == 0x27a) goto LAB_001bb16c;
      }
      else if (uVar7 == 0x29d) {
        MCInst_getOperand(param_1,2);
        iVar8 = MCOperand_getReg();
...
LAB_001bb4c8:
      ...
      if (uVar7 == 0x2b1) {
        ...
        uVar7 = uVar9 & 7;
        if (uVar7 == 3) {
          SStream_concat0(param_2,&DAT_001f92c8);
          MCInst_setOpcodePub(param_1,99);
        }
        else if ((uVar9 >> 2 & 1) == 0) {
          if (uVar7 == 1) {
            SStream_concat0(param_2,&DAT_001f92d0);
            MCInst_setOpcodePub(param_1,10);
          }
          else {
            if (uVar7 != 2) goto LAB_001bc144;
            SStream_concat0(param_2,&DAT_001f92c0);
          ...
          SStream_concat0(param_2,&DAT_001fca10);
          MCInst_setOpcodePub(param_1,0x94);
        }
        else {
LAB_001bc144:
          SStream_concat0(param_2,&DAT_001fd0e8);
        }
...
LAB_001ba810:
      ...
      if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
        ...
        SStream_concat0(param_2,&DAT_001fcde8);
        iVar8 = *(int *)(*(long *)(param_1 + 800) + 0x60);
        goto joined_r0x001ba884;
      }
    }
    else if (uVar7 == 0x365) goto LAB_001bb4c8;
LAB_001ba920:
