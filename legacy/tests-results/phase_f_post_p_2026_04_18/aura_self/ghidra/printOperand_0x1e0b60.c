...

{
  ...
  if ((uVar9 & 1) == 0) {
    ...
    if ((uVar9 & 1) == 0) goto LAB_001e0cf0;
    ...
    if (uVar6 < 0x1ce) {
      if (uVar6 < 0x1cc) {
        if (0xac < uVar6) {
          if (uVar6 != 0xee) {
            if (uVar6 == 0x15f) goto LAB_001e0f98;
            if (uVar6 != 0xe5) goto LAB_001e0f78;
          }
LAB_001e0f2c:
          uVar9 = uVar9 & 0xff;
        ...
        if (uVar6 < 0xaa) {
          if (uVar6 == 0x18) goto LAB_001e0fe4;
          goto LAB_001e0f78;
        }
        uVar4 = 4;
        if ((int)param_2 == 1) {
...
LAB_001e0fe4:
        ...
        if (uVar6 == 0x203) goto LAB_001e0f2c;
      }
      else if (uVar6 == 0x5df) goto LAB_001e0fe4;
LAB_001e0f78:
