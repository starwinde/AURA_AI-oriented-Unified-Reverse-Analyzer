                    ...
                    if (param_3 == 0) {
                      ...
                      if ((int)plVar4[1] != 0) {
                        ...
                        do {
                          ...
                          if ((uVar8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f8470);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 1 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f8480);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 2 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f8488);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 3 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f8490);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 4 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f8498);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 5 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f84a0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 6 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f84a8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 7 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_001f84b0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_0020a980);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 9 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,&DAT_0020a990);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 10 & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,"r10");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xb & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,"r11");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xc & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,"r12");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xd & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,"r13");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xe & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,"r14");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xf & 1) != 0) {
                            __printf_chk(2,&DAT_001f8478,"r15");
                          }
                          __printf_chk(2,"\n    kill: ");
                          uVar8 = *(uint *)(lVar6 + 4);
                          if ((uVar8 & 1) != 0) {
                          ...
                          if (uVar8 != 0) {
                            do {
                              while( true ) {
                                ...
                                if ((uVar8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f8470);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 1 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f8480);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 2 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f8488);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 3 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f8490);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 4 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f8498);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 5 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f84a0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 6 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f84a8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 7 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_001f84b0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_0020a980);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 9 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,&DAT_0020a990);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 10 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,"r10");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xb & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,"r11");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xc & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,"r12");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xd & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,"r13");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xe & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,"r14");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xf & 1) != 0) {
                                  __printf_chk(2,&DAT_001f84f8,"r15");
                                }
                                __printf_chk(2,"  use:");
                                uVar8 = *(uint *)(lVar16 + 4);
                                if ((uVar8 & 1) != 0) {
                          ...
                          do {
                            ...
                            do {
                              if ((1 << (ulong)((uint)lVar7 & 0x1f) & uVar9) != 0) {
                                ...
                                __printf_chk(2,&DAT_001f83b8,(&s_reg_names)[lVar7]);
                                bVar3 = false;
                              }
                              lVar7 = lVar7 + 1;
                            } while (lVar7 != 0x10);
