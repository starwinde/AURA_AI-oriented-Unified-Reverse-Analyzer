...
LAB_001ca338:
    ...
    if (iVar4 == 0) {
      ...
      if (uVar5 == 0xbf5) goto LAB_001ca518;
      if (uVar5 < 0xbf6) {
        if (uVar5 != 0x6d4) {
          if (0x6d4 < uVar5) {
            if (uVar5 != 0xb3e) {
              if (uVar5 < 0xb3f) {
                if (uVar5 == 0xb39) goto LAB_001ca518;
                if (uVar5 == 0xb3c) goto LAB_001ca3a8;
              }
              else if (uVar5 == 0xb41) {
LAB_001ca3a8:
                local_44 = 2;
...
LAB_001ca558:
      ...
      if (uVar5 == 0x13db) goto LAB_001ca518;
      if (uVar5 < 0x13dc) {
        if (uVar5 == 0xd7b) goto LAB_001ca4a0;
        if (uVar5 < 0xd7c) {
          if (uVar5 == 0xbfa) goto LAB_001ca518;
          if ((uVar5 == 0xbfd) || (uVar5 == 0xbf8)) goto LAB_001ca3a8;
        }
        else if (uVar5 - 0x10f6 < 9) {
          uVar7 = 0x155L >> ((ulong)(uVar5 - 0x10f6) & 0x3f);
joined_r0x001ca610:
          if ((uVar7 & 1) != 0) goto LAB_001ca558;
        }
      }
      else {
        if (uVar5 == 0x14b7) goto LAB_001ca4a0;
        if (uVar5 < 0x14b8) {
          if (uVar5 == 0x13e0) goto LAB_001ca518;
          if ((uVar5 == 0x13e3) || (uVar5 == 0x13de)) goto LAB_001ca3a8;
        }
        else if (uVar5 - 0x16a4 < 7) {
          uVar7 = 0x55L >> ((ulong)(uVar5 - 0x16a4) & 0x3f);
          goto joined_r0x001ca610;
        }
      }
LAB_001ca328:
      if (iVar4 == 0) {
        ...
        if (uVar5 != 0x6d4) {
          if (0x6d4 < uVar5) {
            if (uVar5 != 0xb3e) {
              if (uVar5 < 0xb3f) {
                if (uVar5 == 0xb39) goto LAB_001ca518;
                if (uVar5 == 0xb3c) goto LAB_001ca4f8;
              }
              else if (uVar5 == 0xb41) {
LAB_001ca4f8:
                local_44 = 2;
...
LAB_001ca4a0:
        ...
        if (uVar5 < 0xd7c) {
          ...
          uVar7 = 0x155L >> ((ulong)(uVar5 - 0x10f6) & 0x3f);
joined_r0x001ca5e4:
          if ((uVar7 & 1) != 0) goto LAB_001ca464;
        }
      }
      else {
        if (uVar5 == 0x14b7) goto LAB_001ca4a0;
