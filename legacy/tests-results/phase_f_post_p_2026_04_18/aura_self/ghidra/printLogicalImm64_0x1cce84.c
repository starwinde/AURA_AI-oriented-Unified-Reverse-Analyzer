...
LAB_001ccf58:
    if (uVar9 < 10) {
      SStream_concat(param_3,&DAT_001fc818,uVar9 & 0xffffffff);
      lVar13 = *(long *)(param_1 + 800);
      iVar1 = *(int *)(lVar13 + 0x60);
      goto joined_r0x001ccfa8;
    }
    SStream_concat(param_3,"#0x%lx",uVar9);
  }
  else {
    if (uVar12 < 0x2ad) {
      if ((uVar12 == 0x19) || (uVar12 == 0x120)) goto LAB_001ccf58;
    }
    else if (uVar12 == 0x467) goto LAB_001ccf58;
