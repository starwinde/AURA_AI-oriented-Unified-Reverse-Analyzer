...
void printAddrModeImm12Operand(long param_1,int param_2,undefined8 param_3,char param_4)

{
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
    ...
    if (iVar2 != -0x80000000) goto LAB_001b2e78;
LAB_001b2ea8:
    iVar8 = 0;
    iVar2 = 0;
  }
    ...
    *(undefined4 *)(lVar9 + ((ulong)bVar1 * 2 + (ulong)bVar1) * 0x10 + 0x98) = uVar3;
    iVar2 = MCOperand_getImm(uVar5);
    if (iVar2 == -0x80000000) goto LAB_001b2ea8;
LAB_001b2e78:
    if (-1 < iVar2) {
