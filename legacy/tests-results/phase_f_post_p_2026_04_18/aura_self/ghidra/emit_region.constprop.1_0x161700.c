...
LAB_00161770:
    if ((*(byte *)(param_8 + local_c8) & 1) != 0) goto LAB_001618b0;
    lVar15 = *param_1;
    *(undefined1 *)(param_8 + local_c8) = 1;
    ...
    if ((int)uVar5 < 0) {
      if (((*(byte *)(param_4 + local_c8) & 1) == 0) || (param_5 == (undefined8 *)0x0)) {
        ...
        piVar23 = (int *)0x0;
        if (uVar5 != 0) goto LAB_00161800;
      }
    }
    else {
      piVar23 = (int *)(*(long *)(lVar21 + 8) + (long)(int)uVar5 * 0x88);
      do {
        if (*piVar23 - 0x17U < 2 || *piVar23 == 0x1a) goto LAB_001617e8;
...
LAB_00163260:
                  ...
                  do {
                    ...
                    if ((uVar4 == (uint)uVar17) || (uVar5 = uVar5 + 1, uVar19 < uVar5)) {
                      if (uVar16 < uVar19) {
                        if (uVar16 != uVar18) goto LAB_00162e08;
                        uVar16 = (uint)uVar20;
                        uVar20 = local_c8;
                      }
                      break;
...
joined_r0x001632b0:
                  uVar17 = uVar20;
                  uVar4 = uVar16;
                  if (puVar10 != (uint *)0x0) goto LAB_0016291c;
                }
LAB_00162e44:
                iVar6 = 8;
                do {
...
LAB_00162e08:
                ...
                do {
                  ...
                  goto joined_r0x001632b0;
                  uVar4 = uVar9;
                } while (uVar9 != uVar18);
                uVar17 = (ulong)uVar16;
                uVar4 = (uint)uVar20;
                if (puVar10 == (uint *)0x0) goto LAB_00162e44;
LAB_0016291c:
                if ((puVar10[6] != 3) || (iVar6 = 8, (puVar10[0x11] & 1) == 0)) goto LAB_00162e44;
                do {
                  fputc(0x20,param_9);
                  iVar6 = iVar6 + -1;
                } while (iVar6 != 0);
                  ...
                  if (uVar16 != 0xd) {
                    if (uVar16 < 0xe) {
                      if (uVar16 == 0xb) {
                        ...
                        if (uVar16 != 0xc) goto LAB_001635cc;
                        fwrite(&DAT_001f9650,1,4,param_9);
                      }
                      goto LAB_001629d4;
                    }
                    if (uVar16 == 0xe) goto LAB_0016339c;
                  }
...
LAB_001633b8:
                  ...
                  if (uVar16 < 0x14) {
                    if (uVar16 == 0x11) goto LAB_001633b8;
                  }
                  else if (uVar16 != 0x14) {
LAB_001635cc:
...
LAB_001629d4:
              ...
              uVar16 = *(uint *)(param_1 + 1);
              if (uVar16 <= uVar4 || param_3 == uVar4) goto LAB_001618b0;
...
LAB_001622ac:
              ...
              lVar15 = extraout_x12;
              uVar16 = extraout_w11;
              if (uVar5 < extraout_w11) goto LAB_00161d64;
            }
          }
        }
        else {
LAB_00161800:
          ...
          do {
            if (*puVar10 == uVar18) goto LAB_00161830;
            uVar4 = uVar4 + 1;
...
LAB_00161830:
          if (piVar23 != (int *)0x0) {
            if (*piVar23 == 0x17) {
              ...
              uVar16 = piVar23[0x1a];
              cf_emit_block_body_part_0_isra_0(lVar15,local_c8,param_9,2);
              if (puVar10 == (uint *)0x0) goto LAB_001631dc;
              uVar4 = puVar10[5];
              uVar19 = *(uint *)(param_1 + 1);
              if (uVar4 < uVar19) {
                if (uVar5 == uVar4) {
                ...
                if (uVar5 < uVar19) {
                  lVar15 = *param_1;
                  if (uVar5 != uVar18) goto LAB_00163260;
                }
      ...
      if (piVar11[4] != 0) {
        do {
          ...
          if ((*(byte *)(lVar21 + 0xc) & 1) == 0) {
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar5 < uVar16) goto LAB_00162764;
LAB_001626d8:
            ...
            uVar16 = *(uint *)(param_1 + 1);
            uVar5 = *(uint *)(lVar21 + 8);
            if (uVar16 <= uVar5) goto LAB_001626d8;
LAB_00162764:
            pvVar12 = calloc((ulong)uVar16,1);
            if (pvVar12 == (void *)0x0) goto LAB_001626d8;
            uVar4 = piVar11[8];
...
LAB_00162820:
      ...
      uVar16 = *(uint *)(param_1 + 1);
      uVar5 = piVar11[6];
      if (uVar5 < uVar16 && param_3 != uVar5) goto LAB_001621f0;
      goto LAB_001618b0;
    }
...
LAB_001621b4:
    ...
    if (piVar23 == (int *)0x0) goto LAB_001618b0;
    iVar6 = *piVar23;
    if (iVar6 == 0x18) {
      uVar5 = piVar23[0x19];
      uVar16 = *(uint *)(param_1 + 1);
      if (param_3 != uVar5 && uVar5 < uVar16) goto LAB_001621f0;
      goto LAB_001618b0;
    }
    if (iVar6 == 0x1a) {
      iVar6 = 8;
        ...
        if (piVar23[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              lVar15 = lVar15 + 1;
              uVar16 = (uint)lVar15;
              if ((uint)piVar23[0x18] <= uVar16) goto LAB_00162280;
            }
            __fprintf_chk(param_9,2,&DAT_001f9570);
            lVar15 = lVar15 + 1;
...
LAB_00162280:
    ...
    if (iVar6 != 0x17) goto LAB_001618b0;
    uVar16 = piVar23[0x19];
    uVar5 = piVar23[0x1a];
...
LAB_00162440:
        ...
        if (uVar4 < uVar18) goto LAB_0016192c;
        local_80[0] = uVar18;
        local_78 = param_5;
        plStack_70 = param_1;
      ...
      uVar18 = *(uint *)(param_1 + 1);
      if (uVar18 <= uVar4) goto LAB_00162440;
LAB_0016192c:
      uVar20 = (ulong)uVar4;
      if (uVar5 == uVar4) {
        iVar6 = 8;
            ...
            if (uVar5 != 0) {
              ...
              do {
                ...
                if ((*(int *)(*(long *)(lVar15 + 8) + lVar21 * 0x88) == 0x1b) &&
                  ...
                  uVar17 = 0;
LAB_00162c60:
                  if (uVar16 != *(uint *)(*(long *)(lVar22 + 0x58) + uVar17 * 4)) goto LAB_00162c54;
                  iVar6 = 0xc;
                  do {
                    fputc(0x20,param_9);
                    iVar6 = iVar6 + -1;
...
LAB_00161a8c:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar18 = *(uint *)(lVar15 + 0x10);
                    if (uVar18 <= (uint)lVar21) goto LAB_00161b3c;
                  }
LAB_00161a40:
                  lVar21 = lVar21 + 1;
...
LAB_00161c4c:
                    ...
                    fwrite("; /* phi */\n",1,0xc,param_9);
                    uVar16 = *(uint *)(lVar15 + 0x10);
                    if (uVar16 <= (uint)lVar21) goto LAB_00161cf8;
                  }
LAB_00161c00:
                  lVar21 = lVar21 + 1;
                } while ((uint)lVar21 < uVar16);
...
LAB_00161cf8:
    ...
    if (1 < iVar6 - 1U) {
      if (1 < iVar7 - 1U) goto LAB_0016190c;
      iVar6 = 8;
      do {
        fputc(0x20,param_9);
        iVar6 = iVar6 + -1;
      ...
      if (*(uint *)(param_1 + 1) <= uVar16 || param_3 == uVar16) goto LAB_001618b0;
      bVar2 = *(byte *)(param_8 + (ulong)uVar16);
      uVar5 = uVar16;
      goto joined_r0x001623d4;
    }
    iVar8 = 8;
    if (iVar7 - 1U < 2) {
      do {
...
LAB_001621f0:
  ...
  if ((*(byte *)(param_8 + (ulong)uVar5) & 1) != 0) goto LAB_001618b0;
  goto LAB_00161770;
LAB_00162c54:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_00162c14;
  goto LAB_00162c60;
LAB_00162078:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_00162038;
  goto LAB_00162084;
LAB_00161a80:
  uVar17 = uVar17 + 1;
  if (uVar17 == *(uint *)(lVar22 + 0x60)) goto LAB_00161a40;
  goto LAB_00161a8c;
LAB_00161c40:
  uVar17 = uVar17 + 1;
  if (*(uint *)(lVar22 + 0x60) == uVar17) goto LAB_00161c00;
  goto LAB_00161c4c;
}
