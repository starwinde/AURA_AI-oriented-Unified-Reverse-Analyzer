    ...
    if (local_12c != 0) {
      if (local_130 == 5) {
        ...
        if (local_130 == 3) {
          ...
          if (local_130 != 4) goto LAB_00167454;
        ...
        if (local_130 != 7) goto LAB_00167454;
      ...
      uVar38 = 0;
      uVar32 = (ulong)uVar30;
      if (uVar30 < uVar51) goto LAB_00168bfc;
LAB_00167d18:
      uVar37 = 8;
...
LAB_00168984:
                  ...
                  if (iVar18 < iVar16) {
                    ...
                    if (iVar17 != 0) goto code_r0x00168980;
        ...
        do {
          while (puVar31 = (undefined8 *)(*(long *)(lVar19 + 0x18) + lVar44),
            ...
            *(uint *)(puVar40 + 0x1a) = uVar30;
            ...
            uVar30 = *(uint *)(lVar19 + 0x20);
            if (uVar30 <= uVar51) goto joined_r0x00167604;
          }
          uVar51 = uVar51 + 1;
          lVar44 = lVar44 + 0x30;
        } while (uVar51 < uVar30);
...
LAB_00167938:
          ...
          if (s_aarch64_fp_d_regs == (undefined *)0x0) goto LAB_00167b10;
LAB_001679b8:
...
LAB_00167a30:
          ...
          do {
            ...
            if (pcVar21 == (char *)0x0) {
              if (!bVar49) goto joined_r0x00167afc;
              bVar8 = false;
              goto LAB_00167aa0;
            }
            pcVar29 = pcVar21 + sVar25;
...
LAB_00167aa0:
          ...
          if (((iVar16 == 0) || (iVar16 = strncmp(pcVar45,pcVar46,2), iVar16 == 0)) && (!bVar14)) {
            if ((*pcVar27 == '\0') && (pcVar29 = strchr(pcVar45,0x2c), pcVar29 != (char *)0x0)) {
              ...
              do {
                ...
                if (pcVar28 == (char *)0x0) {
                  if (pcVar46 == (char *)0x0) goto LAB_00168ec4;
                  sVar25 = strlen(pcVar46);
                  pcVar42 = pcVar29;
                  goto LAB_00169474;
                }
  ...
  goto LAB_00167658;
LAB_00169760:
  if (iVar16 <= iVar18) goto code_r0x0016976c;
  iVar17 = strcmp(local_218,(char *)&local_88);
  local_218 = local_218 + 0x10;
  if (iVar17 == 0) goto joined_r0x00167e98;
  iVar18 = iVar18 + 1;
  goto LAB_00169760;
code_r0x0016976c:
  if (iVar16 < 8) {
    ...
    if (pcVar45 == (char *)0x0) {
      bVar11 = false;
      if (pcVar48 != (char *)0x0) goto LAB_00167f10;
LAB_001689ac:
      pcVar27 = acStack_118;
      do {
        ...
        while (pbVar26 = (byte *)strstr((char *)pbVar24,pcVar27), pbVar26 != (byte *)0x0) {
          ...
          if (((pbVar26 <= __s) ||
            ...
            bVar11 = bVar8;
            if (pcVar27 != (char *)0x0) goto LAB_00168c58;
            goto LAB_00168a44;
          }
        }
        pcVar27 = pcVar27 + 0x10;
...
LAB_00167e9c:
    ...
    do {
      ...
      if (pbVar26 == (byte *)0x0) goto LAB_00168998;
      pbVar24 = pbVar26 + sVar25;
    } while (((__s < pbVar26) &&
...
joined_r0x00167e98:
    if (pcVar45 != (char *)0x0) goto LAB_00167e9c;
LAB_00168998:
    bVar11 = false;
    if (pcVar48 == (char *)0x0) {
LAB_001689a0:
      bVar11 = bVar8;
      if (iVar16 < 1) goto LAB_00168b4c;
      goto LAB_001689ac;
    }
LAB_00167f10:
            ...
            if (((iVar18 == 0) || (iVar18 = strcmp((char *)pbVar24,"strh"), iVar18 == 0)) ||
              ...
              if (iVar18 != 0) {
                ...
                if (iVar18 != 0) {
                  ...
                  bVar12 = true;
                  if (iVar18 != 0) goto LAB_00168a44;
                }
                bVar6 = *__s;
                if (bVar6 != 0x77) {
                  if (bVar6 < 0x78) {
                    if (bVar6 == 0x57) goto LAB_00169454;
                    if (bVar6 != 0x58) {
                      bVar12 = true;
                      goto LAB_00168a44;
                    }
                    ...
                    bVar12 = true;
                    if (bVar6 != 0x78) goto LAB_00168a44;
                  }
                  uVar51 = 8;
                  goto LAB_00168dd0;
                }
...
LAB_00168b4c:
  ...
  __s = __s + 0xe0;
  bVar8 = bVar11;
  if (uVar32 <= uVar50) goto code_r0x00168b5c;
  goto LAB_00167e78;
code_r0x00168980:
...
code_r0x00168b5c:
  ...
  if (bVar49) {
    if ((!bVar8) && (bVar14)) goto LAB_00168fa4;
  }
  else {
LAB_00168f94:
...
LAB_00168ba0:
  ...
  if (uVar39 == uVar15) goto LAB_00169088;
  uVar30 = *(uint *)(puVar20 + 1);
  uVar51 = *(uint *)((long)puVar20 + 0xc);
  uVar38 = (undefined4)uVar39;
  uVar32 = (ulong)uVar30;
  if (uVar51 <= uVar30) goto LAB_00167d18;
LAB_00168bfc:
  pvVar23 = (void *)*puVar20;
  goto LAB_00167d58;
...
LAB_00169474:
    ...
    if (pcVar21 == (char *)0x0) goto LAB_00168ec4;
  }
LAB_00168eb8:
  (&cStack_99)[lVar19] = '\x01';
LAB_00168ec4:
...
joined_r0x00167afc:
  do {
    ...
    if (lVar19 == 9) {
      pcVar45 = pcVar45 + 0xe0;
      if (pcVar45 != pcVar48) goto LAB_00167938;
      goto LAB_00167b4c;
    }
    pcVar27 = pcVar27 + 1;
    ppuVar35 = ppuVar35 + 1;
    ...
    if (pcVar42 != (char *)0x0) goto LAB_001679b8;
LAB_00167b10:
    puVar22 = *ppuVar35;
joined_r0x00169034:
    bVar49 = false;
...
LAB_00169348:
        do {
          ...
          do {
            ...
            if (pcVar48 == (char *)0x0) goto LAB_0016940c;
            pcVar46 = pcVar48 + 3;
...
LAB_00168388:
          do {
            ...
            do {
              ...
              if (pcVar48 == (char *)0x0) goto LAB_0016844c;
              pcVar46 = pcVar48 + 2;
            } while (((pcVar42 < pcVar48) &&
                     ((byte)(pcVar48[-1] + 0x9fU) < 0x1a || (byte)(pcVar48[-1] - 0x30U) < 10)) ||
...
LAB_0016844c:
      ...
      pcVar45 = "int";
      pcVar48 = pcVar45;
      if (param_3 != 0) goto LAB_001682b8;
    }
LAB_00168310:
...
LAB_0016761c:
    uVar13 = DAT_001f8ee4;
    *(undefined4 *)(puVar20 + 2) = DAT_001f8ee0;
