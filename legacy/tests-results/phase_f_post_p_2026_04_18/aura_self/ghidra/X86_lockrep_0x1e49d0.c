...

{
  ...
  if (cVar1 == -0xe) {
    ...
    if (8 < uVar4 - 0x3b68) {
      if (uVar4 - 0x92 < 0x3b23) goto LAB_001e4c5c;
...
LAB_001e4c5c:
    ...
    while( true ) {
      ...
      if (uVar4 < uVar11) {
        uVar8 = uVar7 - 1;
        if (uVar8 < uVar5) goto LAB_001e4ca8;
      }
      else {
        uVar5 = uVar7 + 1;
        if (uVar8 < uVar5) goto LAB_001e4ca8;
    ...
    if (uVar3 == 0x1e6) {
      if (uVar4 == 0x6a3) goto LAB_001e4e00;
    }
    else if (uVar3 < 0x1e7) {
      if (uVar3 == 0x6d) {
        if (uVar4 == 0x2b6) goto LAB_001e4e00;
      }
      else if (uVar3 < 0x6e) {
        if (uVar3 == 0x6c) goto LAB_001e4e00;
      }
      else if (uVar3 < 0xee) {
        if (((0xeb < uVar3) || (uVar3 < 0x71)) || (uVar3 == 0xe9)) goto LAB_001e4e00;
      }
      else if (uVar3 < 0x15c) {
        if (0x157 < uVar3) goto LAB_001e4e00;
      }
      else if (uVar3 == 0x1e5) goto LAB_001e4e00;
    }
    else if (uVar3 == 0x28e) {
      if (uVar4 == 0x9d1) goto LAB_001e4e00;
    }
    else if (uVar3 < 0x28f) {
      if (uVar3 < 0x207) {
...
LAB_001e4e00:
      ...
      else if (uVar3 == 0x28d) goto LAB_001e4e00;
    }
    else if ((uVar3 < 0x291) || ((ushort)(uVar3 - 0x2c4) < 4)) goto LAB_001e4e00;
LAB_001e4ca8:
    uVar11 = 0x1e23;
    uVar8 = 0x3b22;
    uVar5 = 0;
    ...
    while( true ) {
      ...
      if (uVar4 < uVar11) {
        uVar8 = uVar7 - 1;
        if (uVar8 < uVar5) goto LAB_001e4b80;
      }
      else {
        uVar5 = uVar7 + 1;
        if (uVar8 < uVar5) {
    ...
    if (0x110 < uVar3) {
      if (uVar3 < 0x161) {
        if (0x15e < uVar3) goto LAB_001e4f58;
        *(undefined1 *)(param_1 + 0x330) = 0;
      }
      else {
        if (uVar3 == 0x279) goto LAB_001e4f58;
        *(undefined1 *)(param_1 + 0x330) = 0;
      }
LAB_001e4b88:
      cVar1 = *(char *)(param_1 + 0x331);
      goto joined_r0x001e4b90;
    }
    if (((uVar3 < 0xfe) && (uVar3 != 0x3e)) && (uVar3 != 0xac)) goto LAB_001e4b80;
LAB_001e4f58:
    SStream_concat(param_2,&DAT_00202650);
  }
  else if (cVar1 == -0xd) {
    uVar4 = MCInst_getOpcode();
    if (uVar4 - 0x3b68 < 9) {
    ...
    while( true ) {
      ...
      if (uVar4 < uVar11) {
        uVar8 = uVar7 - 1;
        if (uVar8 < uVar5) goto LAB_001e4ad0;
      }
      else {
        uVar5 = uVar7 + 1;
        if (uVar8 < uVar5) goto LAB_001e4ad0;
    ...
    if (*(ushort *)(insns + ((ulong)uVar7 * 4 + (ulong)uVar7) * 0x10 + 2) < 0x207) {
      if (uVar5 < 0x1e5) {
        if (uVar5 == 0x159) {
          if (uVar4 == 0x4fc) goto LAB_001e4d98;
        }
        else {
          if (0x159 < uVar5) {
            uVar5 = uVar5 - 0x15a;
            goto joined_r0x001e5148;
          }
          if (uVar5 < 0xee) {
            if ((0xeb < uVar5) || (uVar5 == 0xe9)) goto LAB_001e4d98;
          }
          else if (uVar5 == 0x158) goto LAB_001e4d98;
        }
      }
      else if (((1L << ((ulong)(uVar5 - 0x1e5) & 0x3f) & 0x380000051U) != 0) ||
              ((uVar5 == 0x1e6 && (uVar4 == 0x699)))) goto LAB_001e4d98;
LAB_001e4ad0:
      uVar11 = 0x1e23;
      uVar8 = 0x3b22;
      uVar5 = 0;
      ...
      while( true ) {
        ...
        if (uVar4 < uVar11) {
          uVar8 = uVar7 - 1;
          if (uVar8 < uVar5) goto LAB_001e4b28;
        }
        else {
          uVar5 = uVar7 + 1;
          if (uVar8 < uVar5) goto LAB_001e4b28;
      ...
      uVar3 = *(ushort *)(insns + ((ulong)uVar7 * 4 + (ulong)uVar7) * 0x10 + 2);
      if (uVar3 == 0x70) goto LAB_001e4fa4;
      if (uVar3 < 0x71) {
        if (uVar3 == 0x6d) {
          if (uVar4 == 0x2b6) {
LAB_001e4fa4:
        ...
        else if ((uVar3 & 0xfffd) == 0x6c) goto LAB_001e4fa4;
      }
      else if (uVar3 == 0x28e) {
        if (uVar4 == 0x9d1) goto LAB_001e4fa4;
      }
      else if (uVar3 < 0x28f) {
        if (uVar3 == 0x28d) goto LAB_001e4fa4;
      }
      else if ((ushort)(uVar3 - 0x28f) < 2) goto LAB_001e4fa4;
LAB_001e4b28:
      uVar11 = 0x1e23;
      uVar8 = 0x3b22;
      uVar5 = 0;
...
LAB_001e4b80:
    ...
    if (uVar5 == 0x2c5) {
      if (uVar4 == 0xa84) goto LAB_001e4d98;
      goto LAB_001e4ad0;
    }
    if (0x2c5 < uVar5) {
      uVar5 = uVar5 - 0x2c6;
joined_r0x001e5148:
      if ((uVar5 & 0xffff) < 2) goto LAB_001e4d98;
      goto LAB_001e4ad0;
    }
    if (uVar5 != 0x2c4) goto LAB_001e4ad0;
LAB_001e4d98:
    pcVar9 = "rep|";
LAB_001e4e0c:
  ...
  if (cVar1 == '>') {
    ...
    if (uVar5 - 0x92 < 0x3b23) {
      ...
      while( true ) {
        ...
        if (uVar5 < uVar11) {
          uVar4 = uVar8 - 1;
          if (uVar4 < uVar7) goto LAB_001e4a34;
        }
        else {
          uVar7 = uVar8 + 1;
          if (uVar4 < uVar7) goto LAB_001e4a34;
