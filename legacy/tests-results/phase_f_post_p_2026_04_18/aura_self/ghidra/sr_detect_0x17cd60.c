          ...
          if (uVar11 < uVar3) {
            ...
            while( true ) {
              ...
              while ((*(int *)(lVar12 + 0x18) != piVar7[2] || (*piVar7 != 0xb))) {
                iVar20 = iVar20 + -1;
                piVar7 = piVar7 + -0x22;
                if (iVar20 == -1) goto joined_r0x0017d1f0;
              }
...
LAB_0017d098:
              ...
              if (uVar22 <= uVar19) {
                ...
                if (__ptr_00 == (void *)0x0) goto LAB_0017cf78;
              }
              lVar12 = uVar21 * 0x10;
              ...
              *(undefined2 *)((long)__ptr_00 + lVar12 + 0xc) = 0;
              uVar21 = uVar15;
              if (uVar3 <= uVar25) {
                if (uVar19 + 1 < 2) goto LAB_0017d1f4;
                goto LAB_0017ce80;
              }
...
LAB_0017ce80:
                ...
                iVar26 = -1;
                if (uVar25 < uVar3) goto LAB_0017d178;
              }
