...
LAB_0015abb0:
      ...
      if (uVar4 == 0x15) {
        if (puVar1[2] == 0xffffffff) {
          ...
          __fprintf_chk(param_3,2,&DAT_001f9570);
        }
        switch(puVar1[3]) {
        case 0:
          pcVar2 = "void";
        ...
        if (uVar4 != 0x19) {
          if (uVar4 == 0x1c) {
            if (2 < puVar1[0x12]) {
              ...
              fwrite(&DAT_001f9578,1,3,param_3);
              ...
              fwrite(&DAT_001f95a0,1,3,param_3);
              ...
              fwrite(&DAT_001f84d0,1,3,param_3);
              uVar4 = puVar1[0xe];
              goto joined_r0x0015aed0;
            }
          }
        ...
        if (puVar1[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              lVar5 = lVar5 + 1;
              uVar4 = (uint)lVar5;
              if (puVar1[0x18] <= uVar4) goto LAB_0015af7c;
            }
            __fprintf_chk(param_3,2,&DAT_001f9570);
            lVar5 = lVar5 + 1;
...
LAB_0015af7c:
        fwrite(&DAT_001f95f0,1,3,param_3);
        uVar4 = *(uint *)(param_1 + 0x10);
        goto LAB_0015abb0;
      }
      if (uVar4 == 1) {
      ...
      if (uVar4 < 2) {
        if (puVar1[0x12] == 0) goto LAB_0015ac20;
        if (puVar1[2] == 0xffffffff) {
          fwrite("__undef",1,7,param_3);
        }
        else {
