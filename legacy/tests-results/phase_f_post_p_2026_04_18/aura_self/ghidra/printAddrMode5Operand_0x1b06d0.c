...

{
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
    ...
    uVar10 = (uint)bVar1;
    if (bVar1 != 0 || param_4 != '\0') goto LAB_001b0778;
LAB_001b0828:
    if ((uVar2 & 0x100) == 0) goto LAB_001b07e0;
    uVar11 = 0;
    puVar9 = &DAT_001f9500;
LAB_001b0838:
    ...
    *(undefined8 *)(lVar8 + 0xa0) = uVar4;
    bVar1 = MCOperand_getImm(uVar5);
    uVar10 = (uint)bVar1;
    if (bVar1 == 0 && param_4 == '\0') goto LAB_001b0828;
LAB_001b0778:
    uVar11 = uVar10 << 2;
    if (uVar11 < 10) {
      puVar9 = &DAT_001fd0e8;
    ...
    SStream_concat(param_3,&DAT_001fca28,puVar9,uVar11);
  }
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
    lVar12 = *(long *)(*(long *)(param_1 + 0x310) + 0xf0);
