...
void FUN_00156edc(long param_1,long param_2,uint param_3,undefined4 param_4)

{
  ...
  if (uVar4 == 0) {
    if (*(int *)(param_1 + 0x14) != 0) goto LAB_00156f8c;
LAB_00156fc8:
    __size = 0xc0;
    uVar2 = 8;
  }
    ...
    if (uVar4 < uVar2) goto LAB_00156f8c;
    if (uVar2 == 0) goto LAB_00156fc8;
    uVar2 = uVar2 << 1;
