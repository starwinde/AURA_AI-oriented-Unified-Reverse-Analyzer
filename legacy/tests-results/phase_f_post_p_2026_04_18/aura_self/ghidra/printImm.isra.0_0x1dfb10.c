  ...
  if ((param_5 & 1) == 0) {
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_4 != 0x8000000000000000) {
          lVar1 = -param_4;
          if (-10 < (long)param_4) {
            SStream_concat(param_3,&DAT_001fc810,lVar1);
            return;
          }
          do {
            param_4 = param_4 >> 4;
      ...
      if ((long)param_4 < 10) goto LAB_001dfb48;
      if (param_4 < 0x10) goto LAB_001dfc9c;
      do {
        param_4 = param_4 >> 4;
      } while (0xf < param_4);
      goto joined_r0x001dfbb8;
    }
    if ((long)param_4 < 0) {
      if (param_4 == 0x8000000000000000) {
      ...
      if (-10 < (long)param_4) {
        SStream_concat(param_3,&DAT_001fc810,-param_4);
        return;
      }
    ...
    if (*(int *)(param_2 + 0x68) == 4) {
      if ((long)param_4 < 0) {
        if (param_1 == '\0') {
LAB_001dfcb4:
          if (param_4 != 0x8000000000000000) goto LAB_001dfcc8;
LAB_001dfd04:
        ...
        if (param_1 == '\x02') {
          ...
          if (param_1 != '\x01') goto LAB_001dfcb4;
...
joined_r0x001dfbb8:
      if (param_4 < 10) {
        SStream_concat(param_3,&DAT_002023a8);
        return;
      }
LAB_001dfc9c:
  ...
  if ((long)param_4 < 10) {
LAB_001dfb48:
    SStream_concat(param_3,&DAT_001fa500);
    return;
  }
LAB_001dfb38:
