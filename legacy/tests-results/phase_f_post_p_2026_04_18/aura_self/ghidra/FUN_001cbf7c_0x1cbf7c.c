...
void FUN_001cbf7c(long param_1,undefined8 param_2,undefined8 param_3,int param_4)

{
  ...
  if (param_4 == 8) {
    cVar2 = MCOperand_getImm();
    printInt64Bang(param_3,(long)cVar2);
  }
  else if (param_4 == 0x10) {
    sVar3 = MCOperand_getImm();
    printInt64Bang(param_3,(long)sVar3);
  }
  else {
    uVar6 = MCOperand_getImm();
    printInt64Bang(param_3,uVar6);
  }
  ...
  lVar7 = AArch64_get_op_access(lVar8,uVar4);
