...

{
  ...
  if ((((param_1 != (int *)0x0 && param_2 != 0) && (*param_1 == 0x10)) && (param_1[0x28] == 3)) &&
    ...
    iVar3 = *__src;
    if (iVar3 != 0xf) goto LAB_00186ed4;
    if (__src[0x2a] == 2) {
      piVar12 = *(int **)(__src + 0x26);
      piVar11 = *(int **)(__src + 0x28);
      if (piVar12 == (int *)0x0) goto LAB_0018750c;
      if (*piVar12 != 0xd) {
        if ((*piVar12 == 0xe) && ((char)piVar12[0x2a] == '\0')) goto LAB_00187084;
        goto joined_r0x00187500;
      }
      iVar1 = piVar12[0x26];
      if (piVar11 == (int *)0x0) goto LAB_00186ed4;
...
LAB_0018731c:
    ...
    if (lVar5 == lVar8) {
      ...
      if (puVar13 == (undefined4 *)0x0) goto LAB_00187020;
      ...
      *(undefined8 *)(puVar13 + 0x21) = local_70;
      ...
      if (lVar5 != 0 && lVar8 != 0) goto LAB_00187414;
      goto LAB_001871f4;
    }
  }
LAB_0018752c:
  ...
  if (piVar12 == (int *)0x0) {
LAB_0018750c:
    if (piVar11 == (int *)0x0) goto LAB_0018724c;
  }
  else {
    iVar3 = *piVar12;
    if (iVar3 != 0xe) goto LAB_00187214;
    if ((char)piVar12[0x2a] != '\0') goto joined_r0x00187500;
LAB_00187084:
...
LAB_0018722c:
  ...
  if ((0 < lVar5) && (iVar3 = find_array_by_base(param_2,piVar11[0x26]), iVar3 != -1)) {
    ...
    if (iVar1 == iVar4) {
      puVar13 = calloc(1,0x130);
      if (puVar13 == (undefined4 *)0x0) goto LAB_00187024;
    ...
    if (lVar5 == lVar8) {
      ...
      if (puVar13 != (undefined4 *)0x0) {
        ...
        *(undefined8 *)(puVar13 + 0x21) = local_70;
        ...
        if (lVar8 != 0 && lVar5 != 0) {
LAB_00187414:
          __snprintf_chk(lVar8 + 4,0x80,2,0x80,&DAT_001fc420,lVar5);
...
LAB_00187208:
  ...
  if (piVar12 != (int *)0x0) {
    iVar3 = *piVar12;
LAB_00187214:
    if (iVar3 != 0xd) goto joined_r0x00187500;
LAB_00187440:
    iVar3 = piVar12[0x26];
    if (piVar11 == (int *)0x0) {
      iVar3 = *__src;
    ...
    iVar1 = *piVar11;
    if (iVar1 != 0xf) goto LAB_0018722c;
    if (piVar11[0x2a] != 4) goto LAB_0018724c;
    ...
    if ((((piVar12 == (int *)0x0) || (*piVar12 != 0xe)) || ((char)piVar12[0x2a] != '\0')) ||
      ...
      if (piVar12 == (int *)0x0) goto LAB_0018724c;
LAB_00187498:
      ...
      iVar1 = sr_get_array_elem_size(param_2,iVar3);
      if (iVar1 != (int)lVar5) goto LAB_001874f8;
      puVar13 = calloc(1,0x130);
      if (puVar13 == (undefined4 *)0x0) goto LAB_00187024;
...
LAB_0018760c:
        piVar12 = *(int **)(piVar11 + 0x26);
        if (piVar12 != (int *)0x0) goto LAB_00187498;
LAB_001874f8:
        piVar11 = *(int **)(__src + 0x28);
        goto joined_r0x00187500;
      }
      ...
      iVar2 = (int)lVar5;
      if (iVar4 != iVar2) goto LAB_0018760c;
      puVar13 = calloc(1,0x130);
      if (puVar13 == (undefined4 *)0x0) goto LAB_00187024;
      uVar7 = *(undefined8 *)(__src + 0x26);
      *puVar13 = 0x14;
...
joined_r0x00187500:
  if (piVar11 != (int *)0x0) goto LAB_00187228;
LAB_0018724c:
  iVar3 = *__src;
LAB_00186ed4:
  if (iVar3 == 0xd) {
