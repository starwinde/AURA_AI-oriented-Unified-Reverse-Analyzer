...
LAB_00166a08:
        ...
        if ((((4 < uVar11) && (pcVar6 = *(char **)(*param_1 + 8), *pcVar6 == '\x7f')) &&
          ...
          if (pcVar6[4] == '\x01') {
            ...
            if (pcVar6[4] != '\x02') goto LAB_00166a38;
            if (uVar11 == 5) {
              lVar18 = 8;
              uVar11 = 0x10;
              uVar5 = 8;
                        ...
                        if (uVar11 != 0) {
                          ...
                          if (uVar11 <= uVar9) {
                            ...
                            do {
                              ...
                              if (iVar4 == 0x100) goto LAB_00166c78;
...
LAB_00166cf0:
  ...
  uVar16 = uVar16 + 1;
  if (uVar20 <= uVar16) goto LAB_00166c78;
  uVar9 = puVar8[3];
