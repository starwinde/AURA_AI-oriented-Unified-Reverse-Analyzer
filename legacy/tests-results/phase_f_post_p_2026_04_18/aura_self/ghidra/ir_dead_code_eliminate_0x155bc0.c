    ...
    *__ptr_00 = 0;
    do {
      ...
      if (piVar18[(ulong)uVar13 * 0x14 + 4] != 0) {
        ...
        piVar16 = piVar17 + (ulong)(uint)piVar18[(ulong)uVar13 * 0x14 + 4] * 0x22;
        do {
          while (iVar35 = *piVar17, 1 < iVar35 - 0x17U) {
            piVar17 = piVar17 + 0x22;
            if (piVar16 == piVar17) goto LAB_00155d94;
          }
          piVar21 = local_70;
          iVar36 = 0;
...
LAB_00155e20:
      ...
      if ((uVar29 & 0xf) != 0) {
        ...
        if (uVar13 < uVar29) goto LAB_00155e20;
      }
    }
    if (uVar31 == 0) goto LAB_001560fc;
    lVar22 = 0;
    pcVar5 = __ptr;
    do {
      while (*pcVar5 != '\0') {
        pcVar5 = pcVar5 + 1;
        lVar22 = lVar22 + 0x50;
        if (__ptr + uVar25 == pcVar5) goto LAB_00156014;
      }
      lVar26 = 0;
      uVar29 = 0;
...
LAB_00156098:
      ...
      if (uVar8 != 0) {
        ...
        do {
          ...
          lVar22 = lVar22 + 1;
          if (uVar8 <= (uint)lVar22) goto LAB_00156508;
          uVar29 = *(uint *)(param_1 + 1);
        } while( true );
      }
      goto LAB_00156088;
...
LAB_001565fc:
  ...
  if (0xfffffffd < uVar29 - 1) goto LAB_00155c00;
  uVar25 = (ulong)uVar29;
  __ptr_01 = calloc(uVar25,8);
  if (__ptr_01 == (void *)0x0) goto LAB_00155c00;
    ...
    if (plVar6 != (long *)0x0) {
      ...
      do {
        while (*puVar14 == 0) {
          ...
          if (plVar24 == plVar27) goto LAB_0015620c;
        }
...
LAB_00156088:
    ...
    if (uVar29 <= uVar13) goto LAB_001565fc;
    goto LAB_00156098;
  }
  piVar16 = *(int **)piVar18;
  uVar31 = 0;
  do {
    while ((*piVar16 != 0x1b || (uVar15 = piVar16[0x18], uVar15 == 0))) {
      ...
      if (uVar8 <= uVar31) goto LAB_001565e8;
    }
