...
undefined8 parse_string(long param_1,long *param_2)
    ...
    while (uVar10 < uVar13) {
      if (*pbVar14 == 0x22) {
        if ((uVar10 < uVar13) &&
           ...
           pbVar2 = pbVar4, pbVar4 != (byte *)0x0)) goto joined_r0x001f27f8;
        break;
      }
      if (*pbVar14 == 0x5c) {
        pbVar14 = pbVar14 + 1;
    ...
    if (bVar5 == 0x6e) {
      ...
      if (bVar5 < 0x6f) {
        if (bVar5 == 0x62) {
          ...
          if (bVar5 != 0x66) goto LAB_001f28c8;
          pbVar11 = pbVar2 + 1;
          pbVar15 = pbVar15 + 2;
          bVar5 = 0xc;
        }
        ...
        if ((long)pbVar14 - (long)pbVar15 < 6) goto LAB_001f28c8;
        bVar5 = pbVar15[2];
        uVar6 = bVar5 - 0x30;
        if ((uVar6 & 0xff) < 10) {
LAB_001f2978:
          ...
          if ((uVar6 & 0xff) < 10) {
            ...
            if ((bVar5 - 0x41 & 0xff) < 6) {
              ...
              if (5 < (uVar6 - 0x61 & 0xff)) goto LAB_001f2c70;
          ...
          if (0x3ff < uVar6 - 0xdc00) {
            if (0x3ff < uVar6 - 0xd800) {
              if (uVar6 < 0x80) goto LAB_001f2c74;
              if (0x7ff < uVar6) {
                lVar12 = 6;
                bVar5 = 0xe0;
                uVar7 = 2;
            ...
            if (((5 < (long)pbVar14 - (long)(pbVar15 + 6)) && (pbVar15[6] == 0x5c)) &&
              ...
              if (9 < (uVar7 & 0xff)) {
                ...
                if ((bVar5 - 0x41 & 0xff) < 6) {
                  ...
                  if (5 < (uVar7 - 0x61 & 0xff)) goto LAB_001f28c8;
                  uVar7 = uVar7 - 0x57;
                }
              }
              bVar5 = pbVar15[9];
...
LAB_001f2bec:
        ...
        if (uVar6 != 0x72) goto LAB_001f28c8;
        pbVar11 = pbVar2 + 1;
        pbVar15 = pbVar15 + 2;
        bVar5 = 0xd;
      }
