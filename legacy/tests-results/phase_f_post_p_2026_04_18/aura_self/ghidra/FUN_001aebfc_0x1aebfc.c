...
bool FUN_001aebfc(long param_1,uint *param_2,ulong param_3,long param_4,undefined2 *param_5)
...
LAB_001af050:
  ...
  if (iVar10 != 0xafa) goto LAB_001aee7c;
...
LAB_001af198:
    ...
    if (3 < iVar10 + 1U) goto LAB_001af198;
    uVar6 = uVar11 & 1;
    if (((int)uVar20 >> (iVar10 + 1U & 0x1f) & 1U) == uVar6) {
      bVar17 = bVar4;
      if (uVar12 < 8) goto LAB_001af268;
      *(byte *)(param_1 + 0x54) = bVar4;
LAB_001aefc8:
      *(undefined4 *)(param_1 + 0x5c) = 1;
      if (iVar10 == 2) goto LAB_001af32c;
...
LAB_001af268:
      ...
      *(uint *)(param_1 + 0x5c) = uVar1;
      uVar12 = uVar1;
      if (iVar10 == 2) goto LAB_001af198;
      if (((int)uVar20 >> (iVar10 + 2U & 0x1f) & 1U) == uVar6) {
        if (uVar1 != 8) goto LAB_001af308;
        *(byte *)(param_1 + 0x54) = bVar4;
        *(undefined4 *)(param_1 + 0x5c) = 1;
        if (iVar10 != 0) goto LAB_001af32c;
LAB_001af2a8:
        if (uVar6 == (uVar20 >> 3 & 1)) {
          uVar14 = 2;
      ...
      if (uVar1 != 8) goto LAB_001aeff4;
      *(byte *)(param_1 + 0x54) = bVar4 ^ 1;
      *(undefined4 *)(param_1 + 0x5c) = 1;
      if (iVar10 == 0) goto LAB_001af2a8;
LAB_001af32c:
      uVar14 = 1;
    }
LAB_001af024:
