...

{
  ...
  SStream_concat0(param_2,(*(uint *)(OpInfo0_5 + uVar11 * 4) & 0x3fff) + 0x20beef);
  uVar11 = ((ulong)(uVar3 >> 0xe) & 0x7f) - 1;
  if (0x65 < uVar11) goto switchD_00191fdc_default;
...
LAB_00192728:
  ...
  case 9:
    ...
    goto LAB_00192728;
  case 10:
    goto switchD_00191fdc_caseD_a;
  case 0xb:
  case 0x1a:
    goto switchD_00191fdc_caseD_b;
  case 0xc:
    goto switchD_00191fdc_caseD_c;
  case 0xd:
    goto switchD_00191fdc_caseD_d;
  case 0xf:
  case 0x27:
    goto switchD_00191fdc_caseD_f;
  case 0x10:
  ...
  case 0x18:
    ...
    goto LAB_001926e4;
  case 0x19:
    goto switchD_00191fdc_caseD_19;
  case 0x1b:
    printPCRelImm_constprop_0(param_1,param_2);
    goto switchD_00191fdc_default;
  case 0x1c:
    goto switchD_00191fdc_caseD_1c;
  case 0x1d:
    uVar5 = 1;
    goto LAB_001926e0;
  case 0x1e:
...
LAB_001931c4:
    ...
    if (bVar7 < 10) {
      SStream_concat(param_2,&DAT_001fc898);
    }
    else {
...
LAB_00193450:
    ...
    printOperand(param_1,0,param_2);
LAB_00193498:
    SStream_concat0(param_2,&DAT_001fc8d0);
...
LAB_00193254:
  ...
  case 0x50:
    ...
    goto LAB_00193318;
  case 0x51:
    goto switchD_00191fdc_caseD_51;
  case 0x54:
    uVar5 = 0x20;
LAB_001927ac:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
...
LAB_00192824:
  ...
  case 0x5a:
    ...
    goto LAB_00192994;
  case 0x5b:
    goto switchD_00191fdc_caseD_5b;
  case 0x5c:
    uVar14 = 8;
LAB_00193318:
    printOperand(param_1,uVar14,param_2);
...
LAB_00193508:
  ...
  if (0x61 < uVar11) goto switchD_00191fdc_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
...
LAB_00193838:
  ...
  case 0x11:
    ...
    goto switchD_00191fdc_default;
  case 0x12:
    SStream_concat0(param_2,&DAT_001fc900);
    break;
  case 0x13:
    SStream_concat0(param_2,&DAT_001fc908);
    break;
  case 0x14:
    SStream_concat0(param_2,&DAT_001fc910);
    break;
  case 0x15:
  case 0x1c:
    uVar5 = 8;
    goto LAB_00192d00;
  case 0x16:
    SStream_concat0(param_2,&DAT_001fc918);
    break;
  case 0x17:
    iVar8 = MCInst_getOpcode(param_1);
    if ((iVar8 == 0x39b) || (iVar8 == 0x3b2)) {
...
switchD_00191fdc_caseD_f:
  ...
  case 0x27:
    ...
    break;
  case 0x28:
    goto switchD_00192764_caseD_28;
  case 0x29:
    goto switchD_00192764_caseD_29;
  case 0x2a:
...
LAB_00192854:
  ...
  case 0x4e:
    ...
    goto LAB_00192d84;
  case 0x4f:
switchD_00191fdc_caseD_51:
    uVar5 = 0x20;
    goto LAB_001926e0;
  case 0x50:
switchD_00191fdc_caseD_5b:
    uVar5 = 0x40;
LAB_001926e0:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_001926e4:
...
LAB_00192d68:
  ...
  case 0x5a:
    ...
    break;
  case 0x5b:
    SStream_concat0(param_2,&DAT_001fc9e0);
    break;
  case 0x5c:
    SStream_concat0(param_2,&DAT_001fc9e8);
    break;
  case 0x5d:
    SStream_concat0(param_2,&DAT_001fc9f0);
    break;
  case 0x5e:
    SStream_concat0(param_2,&DAT_001fc9f8);
    break;
  case 0x5f:
    uVar14 = 7;
LAB_00193a20:
...
LAB_00192d44:
  ...
  if (0x34 < uVar11) goto switchD_00191fdc_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,1,param_2);
    break;
...
LAB_001930b0:
    ...
    goto switchD_00191fdc_default;
  case 0x10:
switchD_00191fdc_caseD_1c:
    uVar5 = 1;
    goto LAB_00192684;
  case 0x11:
switchD_00191fdc_caseD_d:
    uVar5 = 4;
    goto LAB_00192684;
  case 0x12:
switchD_00191fdc_caseD_b:
    uVar5 = 8;
    goto LAB_00192684;
  case 0x13:
switchD_00191fdc_caseD_c:
    uVar5 = 2;
LAB_00192684:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_00192688:
    ...
    goto joined_r0x00192974;
  case 0x14:
    uVar14 = 3;
LAB_00192da8:
    printOperand(param_1,uVar14,param_2);
switchD_00192894_caseD_2:
    SStream_concat0(param_2,", ");
    break;
  case 0x15:
    SStream_concat0(param_2,"{1to4}, ");
...
LAB_00192e70:
  ...
  if (0xd < uVar11) goto switchD_00191fdc_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,0,param_2);
    break;
...
LAB_00193f00:
          ...
          if (uVar11 == 4) goto switchD_00192764_caseD_29;
          if (uVar11 != 5) goto LAB_00193f00;
          SStream_concat0(param_2,", ");
          printOperand(param_1,0,param_2);
        }
        uVar11 = uVar12 >> 0x2d;
        if (uVar11 == 3) {
          ...
          if ((bVar6 & 2) != 0) goto LAB_00192a2c;
          SStream_concat0(param_2,&DAT_001f8160);
          goto switchD_00191fdc_default;
        }
        if (uVar12 >> 0x2f == 0) {
          if (uVar11 == 1) goto switchD_00192764_caseD_29;
          if (uVar11 == 2) goto switchD_00191fdc_default;
        }
        else if (uVar11 == 4) {
          pcVar15 = ", ";
LAB_00192700:
...
switchD_00191fdc_default:
    ...
    if (uVar11 != 8) {
      if (8 < uVar11) {
        uVar14 = 3;
        if (uVar11 != 9) goto switchD_00191fdc_default;
        goto LAB_0019295c;
      }
      if (uVar11 == 6) goto switchD_00192764_caseD_28;
switchD_00192764_caseD_29:
LAB_00192a2c:
      SStream_concat0(param_2,"} {z}");
      op_addAvxZeroOpmask(param_1);
      goto switchD_00191fdc_default;
    }
switchD_001928dc_caseD_b:
    uVar14 = 5;
LAB_0019295c:
    printOperand(param_1,uVar14,param_2);
    SStream_concat0(param_2,&DAT_001f8160);
...
joined_r0x00192974:
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
    ...
    if (uVar9 < 0x9a5) {
      ...
      if (0x3d < uVar9 - 0xa07) goto LAB_001920cc;
            ...
            do {
              ...
              while (cVar2 != -0x80) {
                ...
                *pcVar4 = cVar2;
                pcVar15 = pcVar15 + -1;
                uVar9 = uVar1 & 0xff;
                if (uVar20 < (uVar1 & 0xff)) goto LAB_001924ac;
                pcVar4 = pcVar4 + 1;
                cVar2 = *pcVar15;
              }
              uVar1 = uVar9 + 1;
