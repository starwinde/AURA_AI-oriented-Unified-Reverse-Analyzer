...

{
  ...
  SStream_concat0(param_2,(uVar8 & 0x3fff) + 0x3e6f1f);
  uVar9 = (((ulong)uVar8 & 0xfc000) >> 0xe) - 1;
  if (0x32 < uVar9) goto switchD_001e16f0_default;
...
LAB_001e1b64:
  ...
  if (0x17 < uVar9) goto switchD_001e16f0_default;
  switch(uVar9 & 0xffffffff) {
  case 0:
    SStream_concat0(param_2,", ");
    goto LAB_001e18d8;
  case 1:
    ...
    goto switchD_001e16f0_default;
  case 2:
    puVar15 = &DAT_001fc900;
    break;
  case 3:
    puVar15 = &DAT_001fc908;
    break;
  case 4:
    puVar15 = &DAT_001fc910;
    break;
  case 5:
    puVar15 = &DAT_001fc918;
    break;
  case 6:
    SStream_concat0(param_2,&DAT_001fc8b0);
    printOperand(param_1,0,param_2);
    goto switchD_001e16f0_default;
  case 7:
    SStream_concat0(param_2,&DAT_00202480);
    op_addReg(param_1,0x12);
    goto switchD_001e16f0_default;
  case 8:
    SStream_concat0(param_2,&DAT_00202488);
    op_addReg(param_1,3);
    goto switchD_001e16f0_default;
  case 9:
  ...
  case 10:
    ...
    goto switchD_001e16f0_default;
  case 0xb:
    SStream_concat0(param_2,&DAT_002024a0);
    op_addReg(param_1,2);
    goto switchD_001e16f0_default;
  case 0xc:
    goto switchD_001e1850_caseD_c;
  case 0xd:
    SStream_concat0(param_2,&DAT_002024b0);
    op_addImm(param_1,1);
    goto switchD_001e16f0_default;
  case 0xe:
    SStream_concat0(param_2,&DAT_001fc8d0);
  ...
  case 0x13:
    ...
    break;
  case 0x14:
    puVar15 = &DAT_001fc9e0;
    break;
  case 0x15:
    puVar15 = &DAT_001fc9e8;
    break;
  case 0x16:
    puVar15 = &DAT_001fc9f0;
    break;
  case 0x17:
    puVar15 = &DAT_001fc9f8;
    break;
  default:
    goto switchD_001e16f0_default;
  }
...
LAB_001e2914:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    ...
    goto switchD_001e16f0_default;
  case 0x1c:
    goto switchD_001e274c_caseD_1c;
  case 0x1d:
  case 0x1e:
    SStream_concat0(param_2,"ymmword ptr ");
    uVar3 = 0x20;
...
LAB_001e2a18:
    *(undefined1 *)(param_1 + 0x328) = uVar3;
    ...
    goto switchD_001e16f0_default;
  default:
    goto switchD_001e274c_default;
  }
LAB_001e1900:
  uVar9 = (CONCAT44(uVar5,uVar8) >> 0x1f & 0x3f) - 1;
  if (0x22 < uVar9) goto switchD_001e16f0_default;
  switch(uVar9 & 0xffffffff) {
  case 0:
    goto switchD_001e192c_caseD_0;
  case 1:
  ...
  case 5:
    ...
    break;
  case 6:
switchD_001e1850_caseD_c:
    SStream_concat0(param_2,&DAT_002024a8);
  ...
  case 0xf:
    ...
    goto LAB_001e2398;
  case 0x10:
    goto switchD_001e192c_caseD_10;
  case 0x11:
    goto switchD_001e192c_caseD_11;
  case 0x12:
    goto switchD_001e192c_caseD_12;
  case 0x13:
    goto switchD_001e192c_caseD_13;
  case 0x14:
    goto switchD_001e192c_caseD_14;
  case 0x15:
...
LAB_001e3000:
    ...
    if (0x1d < uVar9) goto switchD_001e30c4_default;
    switch(uVar9 & 0xffffffff) {
    case 0:
    case 0x10:
      SStream_concat0(param_2,"xmmword ptr ");
...
switchD_001e2c24_caseD_5:
    ...
    case 0x19:
      ...
      break;
    case 0x1a:
      goto switchD_001e30c4_caseD_1a;
    case 0x1b:
      goto switchD_001e30c4_caseD_1b;
    case 0x1c:
      SStream_concat0(param_2,"byte ptr ");
      uVar3 = 1;
LAB_001e3214:
...
LAB_001e30dc:
      *(undefined1 *)(param_1 + 0x328) = uVar3;
      ...
      break;
    default:
      goto switchD_001e30c4_default;
    }
    uVar9 = ((ulong)(uVar5 >> 0x14) & 0xf) - 1;
    if (10 < uVar9) break;
    switch(uVar9 & 0xffffffff) {
    case 0:
switchD_001e192c_caseD_11:
      SStream_concat0(param_2,"{1to2}");
      break;
    case 1:
switchD_001e192c_caseD_12:
      SStream_concat0(param_2,"{1to4}");
      break;
    case 2:
switchD_001e192c_caseD_13:
      SStream_concat0(param_2,"{1to8}");
      break;
    case 3:
      SStream_concat0(param_2,", ");
...
LAB_001e3138:
      uVar8 = uVar5 >> 0x18 & 7;
      if (uVar8 == 3) {
switchD_001e30c4_caseD_1b:
        printU8Imm(param_1,8,param_2);
      }
      else if ((uVar5 >> 0x1a & 1) == 0) {
        if (uVar8 == 1) {
switchD_001e30c4_caseD_1a:
...
switchD_001e274c_caseD_1c:
        printU8Imm(param_1,5,param_2);
      }
      else {
        if (uVar8 != 5) goto LAB_001e3558;
switchD_001e30c4_default:
        printU8Imm(param_1,4,param_2);
      }
      break;
    case 10:
switchD_001e192c_caseD_10:
      SStream_concat0(param_2,", {sae}");
      op_addAvxSae(param_1);
    }
  }
switchD_001e16f0_default:
