...
LAB_0017521c:
  ...
  if (pcVar2 == (char *)0x0) {
    do {
      ...
      if (pcVar2 == (char *)0x0) goto LAB_00175280;
      pcVar5 = pcVar2 + 3;
    } while (((pcVar6 < pcVar2) &&
...
LAB_00175280:
  do {
    ...
    pcVar5 = pcVar6;
    pcVar2 = pcVar6;
    if (pcVar3 == (char *)0x0) goto LAB_00175758;
    pcVar4 = pcVar3 + 3;
  } while (((pcVar6 < pcVar3) &&
...
LAB_00175758:
    ...
    if (pcVar4 == (char *)0x0) goto LAB_001752e4;
  }
  uVar7 = uVar7 | 2;
LAB_001752e4:
  do {
    ...
    pcVar5 = pcVar6;
    pcVar4 = pcVar6;
    if (pcVar3 == (char *)0x0) goto LAB_001756e4;
    pcVar2 = pcVar3 + 3;
  } while (((pcVar6 < pcVar3) &&
           ((byte)(pcVar3[-1] + 0x9fU) < 0x1a || (byte)(pcVar3[-1] - 0x30U) < 10)) ||
          ((byte)(pcVar3[3] + 0x9fU) < 0x1a || (byte)(pcVar3[3] - 0x30U) < 10));
...
LAB_00175348:
  do {
    ...
    pcVar5 = pcVar6;
    pcVar2 = pcVar6;
    if (pcVar3 == (char *)0x0) goto LAB_00175670;
    pcVar4 = pcVar3 + 3;
  } while (((pcVar6 < pcVar3) &&
           ((byte)(pcVar3[-1] + 0x9fU) < 0x1a || (byte)(pcVar3[-1] - 0x30U) < 10)) ||
          ((byte)(pcVar3[3] + 0x9fU) < 0x1a || (byte)(pcVar3[3] - 0x30U) < 10));
...
LAB_001753ac:
  do {
    ...
    pcVar5 = pcVar6;
    pcVar4 = pcVar6;
    if (pcVar3 == (char *)0x0) goto LAB_001755fc;
    pcVar2 = pcVar3 + 2;
  } while (((pcVar6 < pcVar3) &&
           ((byte)(pcVar3[-1] + 0x9fU) < 0x1a || (byte)(pcVar3[-1] - 0x30U) < 10)) ||
...
LAB_00175410:
  do {
    ...
    pcVar5 = pcVar6;
    pcVar2 = pcVar6;
    if (pcVar3 == (char *)0x0) goto LAB_00175588;
    pcVar4 = pcVar3 + 2;
  } while (((pcVar6 < pcVar3) &&
           ((byte)(pcVar3[-1] + 0x9fU) < 0x1a || (byte)(pcVar3[-1] - 0x30U) < 10)) ||
          ((byte)(pcVar3[2] + 0x9fU) < 0x1a || (byte)(pcVar3[2] - 0x30U) < 10));
...
LAB_00175474:
  do {
    ...
    pcVar5 = pcVar6;
    if (pcVar4 == (char *)0x0) goto LAB_00175518;
    pcVar2 = pcVar4 + 3;
  } while (((pcVar6 < pcVar4) &&
           ((byte)(pcVar4[-1] + 0x9fU) < 0x1a || (byte)(pcVar4[-1] - 0x30U) < 10)) ||
          ((byte)(pcVar4[3] + 0x9fU) < 0x1a || (byte)(pcVar4[3] - 0x30U) < 10));
...
LAB_001756e4:
    ...
    if (pcVar2 == (char *)0x0) goto LAB_00175348;
  }
  uVar7 = uVar7 | 4;
  goto LAB_00175348;
  while (((pcVar5 = pcVar4 + 3, pcVar6 < pcVar4 &&
...
LAB_00175670:
    ...
    if (pcVar4 == (char *)0x0) goto LAB_001753ac;
  }
  uVar7 = uVar7 | 8;
  goto LAB_001753ac;
  while (((pcVar5 = pcVar2 + 3, pcVar6 < pcVar2 &&
...
LAB_001755fc:
    ...
    if (pcVar2 == (char *)0x0) goto LAB_00175410;
  }
  uVar7 = uVar7 | 0x10;
  goto LAB_00175410;
  while (((pcVar5 = pcVar4 + 3, pcVar6 < pcVar4 &&
...
LAB_00175588:
    ...
    if (pcVar4 == (char *)0x0) goto LAB_00175474;
  }
  uVar7 = uVar7 | 0x20;
  goto LAB_00175474;
LAB_00175518:
  do {
    ...
    if (pcVar4 == (char *)0x0) goto LAB_001754d4;
    pcVar5 = pcVar4 + 3;
  } while (((pcVar6 < pcVar4) &&
           ((byte)(pcVar4[-1] + 0x9fU) < 0x1a || (byte)(pcVar4[-1] - 0x30U) < 10)) ||
          ((byte)(pcVar4[3] + 0x9fU) < 0x1a || (byte)(pcVar4[3] - 0x30U) < 10));
