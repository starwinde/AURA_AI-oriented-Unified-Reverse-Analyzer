...

{
  ...
  SStream_concat0(param_3,&DAT_001f8060);
...
LAB_001cb09c:
  ...
  do {
    ...
    if ((uVar5 & 1) == 0) {
      SStream_concat(param_3,&DAT_001fc0f0,AsmStrsvreg_7 + (byte)RegAsmOffsetvreg_8[iVar4 - 1U],
                     param_4);
      lVar10 = *(long *)(param_1 + 800);
      if (*(int *)(lVar10 + 0x60) != 0) goto LAB_001cb1e4;
LAB_001cb138:
      if (iVar3 + 1 != iVar12) goto LAB_001cb144;
LAB_001cb280:
...
LAB_001cb1e4:
      ...
      *(char *)(lVar11 + 0x67) = (char)uVar9 + '\x01';
      if (iVar3 + 1 == iVar12) goto LAB_001cb280;
LAB_001cb144:
      SStream_concat0(param_3,", ");
      if (iVar4 - 0x7bU < 0x1f) goto LAB_001cb1b0;
      if (iVar4 != 0x9a) goto LAB_001cb168;
      iVar4 = 0x7b;
    }
    iVar3 = iVar3 + 1;
  } while (iVar3 != iVar12);
  SStream_concat0(param_3,&DAT_001f8160);
  return;
}
