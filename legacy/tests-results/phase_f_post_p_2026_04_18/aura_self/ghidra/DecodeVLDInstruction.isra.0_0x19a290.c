...
LAB_0019a2e4:
    ...
    if (0x646 < uVar1) goto LAB_0019a338;
LAB_0019a39c:
    if (0x62d < uVar1) {
      uVar1 = uVar1 - 0x62e;
joined_r0x0019a358:
      ...
      if ((uVar4 & 0x14a5000) == 0) {
        if ((uVar4 & 0x999) == 0) goto LAB_0019a3e8;
        iVar2 = 1;
      }
      else {
        iVar2 = 2;
    ...
    if (uVar1 - 0x5e7 < 9) goto LAB_0019a2e4;
LAB_0019a370:
    MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (ulong)uVar3 * 2));
LAB_0019a38c:
    uVar1 = MCInst_getOpcode(param_1);
    if (uVar1 < 0x647) goto LAB_0019a39c;
LAB_0019a338:
    uVar1 = uVar1 - 0x675;
    if (uVar1 < 0x19) goto joined_r0x0019a358;
  }
LAB_0019a3e8:
  uVar1 = MCInst_getOpcode(param_1);
  if (uVar1 < 0x647) {
    if (0x62d < uVar1) {
      ...
      if ((uVar4 & 0x14a5000) == 0) goto LAB_0019a41c;
LAB_0019a590:
      uVar1 = uVar3 + 4;
LAB_0019a42c:
    ...
    if ((uVar4 & 0x14a5000) != 0) goto LAB_0019a590;
LAB_0019a41c:
    if ((uVar4 & 0x999) != 0) {
      uVar1 = uVar3 + 2;
      goto LAB_0019a42c;
  ...
  if (iVar2 - 0x675U < 0x19) {
    ...
    if ((uVar4 & 0x14a5000) == 0) {
      uVar3 = uVar3 + 3;
      if ((uVar4 & 0x999) == 0) goto LAB_0019a498;
    }
    else {
      uVar3 = uVar3 + 6;
    }
...
LAB_0019a498:
  ...
  if (uVar3 < 0x647) {
    if (0x630 < uVar3) {
      if ((0x210911UL >> ((ulong)(uVar3 - 0x631) & 0x3f) & 1) != 0) goto LAB_0019a5b4;
      goto LAB_0019a4f0;
    }
    if (uVar3 < 0x5b2) {
      if (0x573 < uVar3) {
        uVar5 = 0x3060c183cc7860f3 >> ((ulong)(uVar3 - 0x574) & 0x3f);
        goto joined_r0x0019a6c0;
      }
      if (uVar3 < 0x56b) {
        if (uVar3 < 0x569) goto LAB_0019a4f0;
        goto LAB_0019a4e0;
      }
      if (uVar3 - 0x56d < 4) goto LAB_0019a4e0;
    }
    else {
      if (0x22 < uVar3 - 0x5df) goto LAB_0019a4f0;
...
LAB_0019a5b4:
    ...
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar4 * 2));
    if ((int)uVar5 != 0) goto LAB_0019a5e8;
LAB_0019a50c:
    MCOperand_CreateImm0(param_1,0);
    uVar4 = (ulong)(param_2 & 0xf);
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x5b2) goto LAB_0019a52c;
LAB_0019a610:
