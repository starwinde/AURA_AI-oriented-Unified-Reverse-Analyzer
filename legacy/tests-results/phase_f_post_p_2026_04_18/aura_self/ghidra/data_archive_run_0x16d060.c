...
void data_archive_run(long *param_1)
...
joined_r0x0016d290:
    ...
    if (pcVar6 == (char *)0x0) {
      ...
      if (0xfff < __n) goto joined_r0x0016d290;
    ...
    if ((0xfff < uVar4) ||
       (__ptr = (undefined8 *)data_archive_load(acStack_1068), __ptr == (undefined8 *)0x0))
    goto joined_r0x0016d290;
    __ptr_00 = (void *)*__ptr;
    uVar4 = *(uint *)(__ptr + 1);
    if (uVar4 != 0) {
      lVar12 = 0;
      ...
      do {
        while( true ) {
          ...
          *puVar1 = 0;
          puVar1[1] = 0;
          puVar1[2] = 0;
          if (uVar5 <= (uint)lVar12) goto LAB_0016d1d8;
        }
        lVar12 = lVar12 + 1;
...
LAB_0016d1d8:
      ...
      if (puVar9 == (uint *)0x0) {
        if (in_x5 != (undefined8 *)0x0) {
          pcVar10 = malloc(0x40);
          *in_x5 = pcVar10;
          uVar3 = s_data_archive__allocation_failed_001facc8._24_8_;
          uVar2 = s_data_archive__allocation_failed_001facc8._16_8_;
          uVar7 = s_data_archive__allocation_failed_001facc8._0_8_;
          if (pcVar10 != (char *)0x0) {
            *(undefined8 *)(pcVar10 + 8) = s_data_archive__allocation_failed_001facc8._8_8_;
