...
LAB_0018a514:
                ...
                if (local_70 == pcVar9) goto LAB_0018a514;
                ...
                if ((((uVar14 < param_5) || (param_4 + param_5 < uVar14 + 8)) ||
                   ...
                   (param_4 + param_5 <= uVar14)) goto LAB_0018a514;
                iVar6 = strcmp(__s1,"call");
                uVar15 = 0;
                if ((iVar6 == 0) && (uVar17 != 0)) {
                  pcVar8 = strchr(pcVar12,0x5b);
...
LAB_0018a718:
                ...
                if (*(uint *)((long)__ptr + 0xc) <= uVar2) {
                  ...
                  if (pvVar7 == (void *)0x0) goto LAB_0018a514;
                  *__ptr = (long)pvVar7;
                  *(uint *)((long)__ptr + 0xc) = uVar3;
                }
                if (0x3ff < uVar2) goto LAB_0018a514;
                              ...
                              do {
                                ...
                                if (param_5 <= uVar19 && uVar19 < param_4 + param_5) {
                                  ...
                                  if (*(uint *)((long)__ptr + 0xc) <= uVar2) {
                                    ...
                                    pvVar7 = realloc((void *)*__ptr,(ulong)uVar3 * 0x18);
                                    if (pvVar7 == (void *)0x0) goto LAB_0018a95c;
                                    *__ptr = (long)pvVar7;
                                    *(uint *)((long)__ptr + 0xc) = uVar3;
                                  }
                                  if (uVar2 < 0x400) {
...
LAB_0018a7b8:
  pcVar8 = pcVar8 + 0xe0;
  if (pcVar8 == __s1 + -0x20) goto LAB_0018a528;
  goto LAB_0018a7c4;
}
