...
void xref_print_from(long param_1,undefined8 param_2,FILE *param_3)

{
  ...
  iVar2 = xref_from(param_1,param_2,&local_70);
  __fprintf_chk(param_3,2,"Xref From 0x%lx (%u references):\n",param_2,iVar2);
  if (local_68 != 0) {
    puVar4 = local_70;
    do {
      iVar1 = *(int *)(puVar4 + 2);
      puVar3 = &DAT_001f8fd8;
      if ((iVar1 != 1) && (puVar3 = &DAT_001fa4a8, iVar1 != 2)) {
        puVar3 = &DAT_001f8950;
        if (iVar1 != 0) {
          puVar3 = &DAT_001f9560;
        }
