  ...
  if (param_1 == (long *)0x0) {
    ...
    if (plVar4 == (long *)0x0) {
      ...
      if (uVar17 == 0) {
        ...
        local_88 = 0;
        local_7c = 0;
        if (puVar19 != (uint *)0x0) goto LAB_0017d430;
LAB_0017d408:
        local_7c = local_7c + 1;
        if (local_7c < uVar17) {
          while( true ) {
                  ...
                  if (uVar17 != 0) {
                    ...
                    do {
                      while( true ) {
                        ...
                        if (uVar15 != 1) goto LAB_0017d540;
LAB_0017d510:
                        uVar5 = (ulong)uVar9;
                        if (uVar17 <= uVar9) goto LAB_0017d680;
                      }
                      if (uVar15 != 0x1c) goto LAB_0017d510;
LAB_0017d540:
                      if (*(uint *)(puVar2 + 9) != 0) {
                        puVar8 = puVar2;
                        do {
                              ...
                              do {
                                if (*puVar7 < *(uint *)(param_1 + 1)) {
                                  ...
                                  if (uVar15 != 0) {
                                    ...
                                    do {
                                      if (*(int *)(puVar8 + 3) == *piVar6) goto LAB_0017d510;
                                      piVar6 = piVar6 + 0x22;
...
LAB_0017d5d0:
                          ...
                          *(uint *)(lVar21 + 0x14) = uVar15;
                          ...
                          if (uVar11 < uVar17) goto LAB_0017d7b4;
                        }
                      }
                      else {
                        uVar11 = uVar17 - 1;
                        ...
                        if (1 < *(int *)((long)__ptr + lVar14) - 0x17U &&
                            *(int *)((long)__ptr + lVar14) != 0x1a) goto LAB_0017d764;
                        if (uVar15 <= uVar17) goto LAB_0017d5d0;
LAB_0017d7b4:
...
LAB_0017d680:
            ...
            local_7c = local_7c + 1;
            plVar4 = local_70;
            if (uVar17 <= local_7c) goto LAB_0017d6c8;
          }
LAB_0017d7f8:
          uVar17 = *(uint *)(local_70 + 1);
          plVar4 = local_70;
