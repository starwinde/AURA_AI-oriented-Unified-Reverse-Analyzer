...

{
  ...
  *(undefined1 *)(psVar7 + 0x14) = uVar3;
  if (param_3 == 0x922) {
    if (*(int *)(param_1 + 4) == 8) goto LAB_001e4018;
    uVar5 = 2;
    psVar7[0x15] = 0x13;
    psVar7[0x16] = 0x18;
...
LAB_001e4018:
  ...
  if (uVar15 < 0x1e5) {
    if (0x15b < uVar15) {
      if (2 < uVar15 - 0x15c) goto LAB_001e4210;
      iVar2 = *(int *)(param_1 + 4);
      if (iVar2 == 4) {
        sVar10 = 0x16;
LAB_001e41e0:
    ...
    if (0x157 < uVar15) {
      if (*(int *)(param_1 + 4) == 2) {
        ...
        if (uVar5 != 0) {
          ...
          psVar8 = psVar9 + uVar5;
          do {
            if (*psVar9 == 0x1d) goto LAB_001e4484;
            psVar9 = psVar9 + 1;
          } while (psVar9 != psVar8);
        }
      }
        ...
        if (uVar5 != 0) {
          ...
          psVar8 = psVar9 + uVar5;
          do {
            if (*psVar9 == 0x1d) goto LAB_001e40d8;
            psVar9 = psVar9 + 1;
          } while (psVar9 != psVar8);
        }
      }
    ...
    if (uVar15 < 0x6f) {
      if (uVar15 < 0x6c) goto LAB_001e4210;
    }
    else if (uVar15 != 0x70) goto LAB_001e4210;
  }
  else if ((0x53UL >> ((ulong)(uVar15 - 0x1e5) & 0x3f) & 1) == 0) goto LAB_001e4210;
  if (*(int *)(param_1 + 4) != 2) {
    if (*(int *)(param_1 + 4) != 8) goto LAB_001e4210;
    bVar4 = *(byte *)(psVar7 + 0x14);
    if (bVar4 == 0) {
      if (uVar5 == 0) goto LAB_001e4210;
LAB_001e4380:
      psVar8 = psVar7 + 0x15;
      uVar15 = 0;
      do {
...
LAB_001e4210:
  *(undefined8 *)((long)psVar7 + 0x53) = *(undefined8 *)(insns + lVar16 + 0x46);
  bVar4 = count_positive8(lVar16 + 0x44473e);
