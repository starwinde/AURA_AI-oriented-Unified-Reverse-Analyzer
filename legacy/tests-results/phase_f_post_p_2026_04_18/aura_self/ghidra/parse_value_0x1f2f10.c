...

{
  ...
  if ((param_2 == (long *)0x0) || (lVar14 = *param_2, lVar14 == 0)) goto LAB_001f3004;
  uVar2 = param_2[1];
  uVar10 = param_2[2];
  uVar6 = uVar10 + 4;
  if (uVar2 < uVar6) {
    ...
    {
LAB_001f2fc0:
      if (uVar2 <= uVar10) goto LAB_001f3004;
          ...
          if (uVar10 < uVar2) {
            do {
              if (0x20 < *(byte *)(lVar14 + uVar10)) {
                if (uVar2 == uVar10) goto LAB_001f3660;
                uVar10 = param_2[2];
                if (uVar2 <= uVar10) goto LAB_001f3614;
                goto LAB_001f347c;
              }
              uVar10 = uVar10 + 1;
              param_2[2] = uVar10;
...
LAB_001f347c:
              if (*(char *)(lVar14 + uVar10) == ']') {
                ...
                do {
                  ...
                  puVar13 = puVar12;
                  if (puVar7 == (undefined8 *)0x0) goto LAB_001f3620;
                  puVar7[1] = 0;
                  *puVar7 = 0;
                  puVar7[3] = 0;
                  puVar7[2] = 0;
                  ...
                  if (iVar4 == 0) goto LAB_001f35f8;
                  lVar14 = *param_2;
                  uVar6 = param_2[1];
                  uVar10 = param_2[2];
                  if (lVar14 == 0) {
LAB_001f3564:
                    if (uVar6 <= uVar10) goto LAB_001f35f8;
                  }
                  else {
                    if (uVar6 <= uVar10) goto LAB_001f35f8;
                    do {
                      if (0x20 < *(byte *)(lVar14 + uVar10)) {
                        if (uVar10 != uVar6) goto LAB_001f3564;
                        break;
                      }
                      uVar10 = uVar10 + 1;
                      param_2[2] = uVar10;
                ...
                if ((uVar6 <= uVar10) || (*(char *)(lVar14 + uVar10) != ']')) goto LAB_001f35f8;
        ...
        if (uVar10 < uVar2) {
          do {
            if (0x20 < *(byte *)(lVar14 + uVar10)) {
              if (uVar2 == uVar10) goto LAB_001f3674;
              uVar10 = param_2[2];
              if (uVar2 <= uVar10) goto LAB_001f3614;
              goto LAB_001f3104;
            }
...
LAB_001f31ec:
                ...
                if (*(char *)(lVar14 + uVar10) != ':') goto LAB_001f35f8;
                uVar10 = uVar10 + 1;
                param_2[2] = uVar10;
...
LAB_001f329c:
                  ...
                  do {
                    if (0x20 < *(byte *)(lVar14 + uVar10)) {
                      if (uVar10 != uVar6) goto LAB_001f329c;
                      break;
                    }
                    uVar10 = uVar10 + 1;
                    param_2[2] = uVar10;
