  ...
  if (uVar9 == 0) {
    ...
    if (uVar4 < 2) {
      ...
      do {
        ...
        pauVar3 = pauVar6 + 1;
        pauVar6 = pauVar6 + 3;
        auVar10 = a64_TBL(ZEXT816(0),auVar10,*pauVar3,_DAT_0020b150);
        iVar11 = iVar11 + (_DAT_0020b170 ^
                          (_DAT_0020b170 ^ _DAT_0020b160) & -(uint)(auVar10._0_4_ == 0));
        iVar12 = iVar12 + (_UNK_0020b174 ^
                          (_UNK_0020b174 ^ _UNK_0020b164) & -(uint)(auVar10._4_4_ == 0));
        iVar13 = iVar13 + (_UNK_0020b178 ^
                          (_UNK_0020b178 ^ _UNK_0020b168) & -(uint)(auVar10._8_4_ == 0));
        iVar14 = iVar14 + (_UNK_0020b17c ^
                          (_UNK_0020b17c ^ _UNK_0020b16c) & -(uint)(auVar10._12_4_ == 0));
