    ...
    if (*(uint *)(param_1 + 4) != 0) {
      ...
      do {
        if (((char *)*puVar21 != (char *)0x0) &&
          ...
          if ((plVar23 != (long *)0x0) && (uVar27 = puVar21[3], uVar27 != 0)) goto LAB_00169f88;
          break;
        }
        puVar21 = puVar21 + 7;
...
LAB_0016a0c0:
      ...
      if (bVar4 && !bVar3) goto code_r0x0016a0d4;
    }
