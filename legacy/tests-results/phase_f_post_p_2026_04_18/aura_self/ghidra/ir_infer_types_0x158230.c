        ...
        do {
          while (uVar21 = *puVar9, 0xe < uVar21) {
            if (uVar21 == 0x1b) {
              ...
              if (uVar21 - 0x11 < 4) goto LAB_00158584;
            }
...
LAB_001582e4:
            puVar9 = puVar9 + 0x22;
            if (puVar9 == puVar11) goto LAB_001582f0;
          }
          if (10 < uVar21) {
LAB_00158584:
            uVar4 = 6;
LAB_001582bc:
          ...
          if (8 < uVar21) {
LAB_001582b0:
            if (puVar9[0x12] == 0) goto LAB_001582e4;
LAB_001582b8:
            uVar4 = (ulong)puVar9[7];
            goto LAB_001582bc;
          }
          if (uVar21 < 2) {
            if (uVar21 != 0) goto LAB_001582e4;
            goto LAB_001582b0;
          }
          if (1 < puVar9[0x12]) {
          ...
          if (puVar9[0x12] == 1) goto LAB_001582b8;
          puVar9 = puVar9 + 0x22;
                  ...
                  if (*(uint *)(plVar8 + 1) != 0) {
                    ...
                    do {
                      if (*puVar13 == *(uint *)(lVar5 + 8)) {
                        if (*(int *)(lVar5 + 0xc) != 5) goto LAB_00158458;
