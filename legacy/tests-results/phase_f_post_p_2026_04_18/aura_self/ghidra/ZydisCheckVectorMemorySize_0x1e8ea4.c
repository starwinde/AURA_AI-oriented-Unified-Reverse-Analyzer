...
LAB_001e9248:
        ...
        if (uVar1 == 3) {
          ...
          if (3 < uVar1) goto LAB_001e9248;
          if (uVar1 == 1) {
            local_14 = 0;
          }
          else if (uVar1 != 2) goto LAB_001e9248;
        }
      }
    }
    else {
...
LAB_001e93d4:
  ...
  if (uVar3 < 4) {
    if (3 < uVar3) goto LAB_001e93d4;
    if (uVar3 < 2) {
      if (uVar3 != 0) {
        if (uVar3 != 1) goto LAB_001e93d4;
        goto LAB_001e93ac;
      }
...
LAB_001e9388:
      ...
      if ((uVar5 & 0x5555) == 0) {
        if ((uVar5 & 0xaa88) == 0) {
          if ((uVar5 & 0x22) == 0) goto LAB_001e9388;
          local_14 = 0x20;
          local_12 = 4;
        }
        else {
...
LAB_001e9498:
  ...
  if (uVar3 < 3) {
    if ((*(byte *)(lVar4 + 0xe) & 7) != 0) {
      if (1 < uVar3 - 1) goto LAB_001e9498;
      local_14 = local_12;
    }
  }
  else {
  ...
  if (uVar3 < 0xc) {
    if (uVar3 < 10) {
      if (uVar3 != 0) {
        if (1 < uVar3 - 3) goto LAB_001e9508;
        local_14 = local_12;
      }
    }
    else {
