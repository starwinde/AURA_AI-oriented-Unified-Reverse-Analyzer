...
LAB_001e0304:
  ...
  if (iVar6 == 0) {
    SStream_concat0(param_3,&DAT_001fca20);
  ...
  if ((iVar6 == 0) || (iVar6 = MCOperand_getReg(uVar11), iVar6 == 0x1e)) {
    ...
    if (bVar4) {
      SStream_concat0(param_3,&DAT_002023d8);
    }
    _printOperand(param_1,iVar3 + 2,param_3);
    if (lVar10 != 1) {
      SStream_concat(param_3,&DAT_002023e0,lVar10);
    }
    bVar4 = true;
    uVar14 = MCOperand_isImm(uVar12);
  }
  if ((uVar14 & 1) != 0) {
    ...
    if (uVar14 == 0) {
      ...
      if ((long)uVar14 < 0) {
        SStream_concat0(param_3,&DAT_002023e8);
