...
void FUN_00151d2c(long *param_1,undefined8 param_2,char *param_3,long param_4)
          ...
          if (cVar7 != '\0') {
            ...
            do {
              ...
              if (cVar7 == ']') {
                ...
                cVar7 = acStack_168[0];
                if (acStack_168[0] == '\0') goto LAB_00152508;
                sVar23 = strlen(acStack_168);
                pcVar31 = acStack_168 + (sVar23 - 1);
                if (pcVar31 <= acStack_168) goto LAB_001524c8;
                goto LAB_001524b8;
              }
              pcVar30 = pcVar30 + 1;
              cVar7 = *pcVar30;
  ...
  if (cVar7 != '\0') {
    ...
    do {
      ...
      if (cVar7 == ']') {
        ...
        if (acStack_168[0x40] == '\0') goto LAB_001526d8;
...
LAB_001527d4:
  ...
  uVar22 = uStack_2b0;
  if (iVar9 == 0) {
    if ((int)uStack_2b0 < 0) goto LAB_001521f0;
    if (bVar4) {
LAB_00152880:
      if (uVar38 != 0) {
      ...
      if (iVar8 == 1) {
        ...
        iVar8 = __isoc99_sscanf(pcVar19,&DAT_001f90f0,&uStack_288);
...
LAB_00152fec:
        ...
        if ((int)uStack_2b0 < 0) goto LAB_00152fec;
...
joined_r0x001531a4:
    ...
    if (iVar10 == 0) {
      uVar22 = uStack_2b0;
      uVar11 = uStack_2a4;
      if (-1 < (int)uStack_2b0) goto LAB_00152c10;
      goto LAB_001521f0;
    }
...
LAB_00153974:
        for (; (int)lVar35 == 0; lVar35 = lVar35 + 1) {
          uVar38 = (ulong)uStack_2b0;
          uVar11 = uStack_2a4;
          if (-1 < (int)uStack_2b0) goto LAB_00153864;
        }
...
LAB_00152900:
    ...
    if (iVar9 == 1) {
      ...
      iVar9 = __isoc99_sscanf(pcVar31,&DAT_001f90f0,&uStack_288);
      if (iVar9 == 1) {
        uVar38 = CONCAT44(uStack_288._4_4_,(int)uStack_288);
        bVar4 = true;
      }
...
LAB_00152990:
    ...
    if (iVar10 == 1) {
      ...
      iVar10 = __isoc99_sscanf(pcVar31,&DAT_001f90f0,&uStack_288);
      uStack_310 = 0;
      if (iVar10 == 1) {
