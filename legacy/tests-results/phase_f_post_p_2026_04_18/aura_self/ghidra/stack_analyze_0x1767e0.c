        ...
        if (pcVar12 != (char *)0x0) {
          ...
          if (((iVar7 != 0) || (pcVar11 = strstr(pcVar16,"rsp"), pcVar11 == (char *)0x0)) &&
            ...
            if (cVar3 == ']') {
              ...
              if (local_20d8 == pcVar11) goto LAB_00177a1c;
            ...
            if (uVar8 != 0) {
              ...
              sVar23 = __nmemb;
              if (0x1ff < uVar8) goto LAB_00177a1c;
            }
...
LAB_00176f68:
      ...
      if (pvVar15 == (void *)0x0) goto LAB_00176b30;
...
LAB_00177478:
              ...
              *(uint *)(__ptr + 4) = uVar8;
              ...
              if ((long)uVar21 < 0) goto LAB_00177560;
              *(undefined4 *)((long)pvVar15 + lVar24 + 0x20) = 0;
LAB_0017741c:
              pcVar12 = "var_%x";
LAB_00177430:
              ...
              *(char **)((long)pvVar15 + lVar24 + 0x10) = pcVar12;
              uVar8 = *(uint *)((long)pvVar15 + lVar24 + 8);
joined_r0x00177454:
              if (uVar8 == 4) goto LAB_00177478;
              if (3 < uVar8) {
                if (uVar8 == 8) goto LAB_00177504;
                pcVar16 = "unknown";
                if (uVar8 == 0x10) {
                  pcVar16 = local_2118;
                }
            ...
            uVar25 = (ulong)uVar8;
            if (puVar14 == puVar32 + 2) goto LAB_00177550;
            puVar32 = puVar32 + 2;
          ...
          *(undefined4 *)((long)pvVar15 + lVar24 + 0x28) = uVar2;
          ...
          if (bVar1 && param_4 == 4) {
            if ((long)uVar21 < (long)uVar10) {
              if ((long)uVar21 < 0) goto LAB_001773a4;
              *(undefined4 *)((long)pvVar15 + lVar24 + 0x20) = 0;
LAB_0017733c:
              pcVar12 = "var_%x";
            }
            ...
            *(char **)((long)pvVar15 + lVar24 + 0x10) = pcVar12;
            ...
            if (uVar8 < 5) {
              if (uVar8 == 1) {
                ...
                pcVar16 = "uint16_t";
                if (uVar8 != 2) goto LAB_00177670;
              }
              goto LAB_00177008;
            }
            if (uVar8 == 8) goto LAB_00177394;
            if (uVar8 != 0x10) {
LAB_00177670:
              pcVar16 = "unknown";
              goto LAB_00177008;
...
LAB_00177008:
          ...
          uVar25 = (ulong)uVar8;
          if (puVar14 == puVar32 + 2) goto LAB_001770f8;
          puVar32 = puVar32 + 2;
          pvVar15 = (void *)__ptr[3];
        } while( true );
      }
        ...
        do {
          ...
          if (((((((bVar4 == 0x6c) && (pcVar16[-0x3f] == 'd')) && (pcVar16[-0x3e] == 'r')) ||
            ...
            if (pcVar31 == (char *)0x0) {
              ...
              if (pcVar31 + 1 == local_20d8) goto LAB_00176f58;
              uVar8 = (uint)*__s1;
            }
            ...
            if (uVar8 != 0) {
              ...
              do {
                if (*puVar14 == uVar25) {
                  ...
                  *(int *)((long)puVar14 + 0xc) = *(int *)((long)puVar14 + 0xc) + 1;
                  sVar30 = __nmemb;
                  goto joined_r0x00176f54;
                }
                puVar14 = puVar14 + 2;
              } while (&local_20a8 + __nmemb * 2 != puVar14);
              sVar23 = __nmemb;
              if (0x1ff < uVar8) goto LAB_00176f58;
            }
            uVar8 = uVar8 + 1;
            sVar30 = (size_t)uVar8;
            (&local_20a8)[sVar23 * 2] = uVar25;
          ...
          if (pcVar12 != (char *)0x0) {
            ...
            if ((((iVar7 != 0) || (pcVar11 = strstr(pcVar16,"esp"), pcVar11 == (char *)0x0)) &&
              ...
              if (cVar3 == ']') {
                ...
                if (pcVar31 == local_20d8) goto LAB_0017695c;
              ...
              if (uVar29 != 0) {
                ...
                sVar23 = __nmemb;
                if (0x1ff < uVar29) goto LAB_0017695c;
              }
...
LAB_001770f8:
    ...
    if (uVar8 != 0) {
      plVar28 = plVar26;
      do {
        if ((*plVar28 == 0) && ((int)plVar28[4] == 1)) goto LAB_0017713c;
        plVar28 = plVar28 + 6;
...
LAB_0017713c:
      if (local_2138 < 2) goto LAB_00177d74;
      plVar28 = plVar26;
      if (uVar8 != 1) goto LAB_00177150;
      if (param_6 == (long *)0x0) goto LAB_00177db4;
      if (plVar26 != (long *)0x0) goto LAB_001771dc;
      uVar25 = 1;
      goto LAB_001772b4;
    }
    uVar8 = 1;
...
LAB_00177d74:
    ...
    do {
      uVar8 = (uint)uVar25;
      if ((int)*plVar28 == 3) goto LAB_00177da0;
      plVar28 = plVar28 + 6;
    } while (plVar18 != plVar28);
    if (local_2108 <= uVar8) {
LAB_00177da0:
      if (uVar8 == 1) goto LAB_00177da8;
      goto LAB_00177558;
    }
