      ...
      if (param_1[0x4a] != 0) {
        ...
        do {
          ...
          while( true ) {
            ...
            if (param_1[0x4a] <= (uint)lVar8) goto LAB_001814c0;
    ...
    if (uVar2 < 0x12) {
      if (uVar2 == 0xe) {
        if ((char)param_1[0x2a] == '\0') {
          sVar4 = __fprintf_chk(param_2,2,&DAT_001fc0d8,*(undefined8 *)(param_1 + 0x26));
          return sVar4;
        }
        sVar4 = __fprintf_chk(*(undefined8 *)(param_1 + 0x28),param_2,2,&DAT_001fc0d0);
        return sVar4;
      }
      if (uVar2 < 0xf) {
        if (uVar2 != 0xc) {
...
LAB_0018162c:
          ...
          sVar4 = __fprintf_chk(param_2,2,&DAT_001fc0f8,uVar6);
          return sVar4;
        }
        goto LAB_00181538;
      }
      if (uVar2 == 0xf) {
        ...
        __fprintf_chk(param_2,2,&DAT_001f95a8,pcVar7);
...
LAB_001814c0:
    ...
    if (uVar2 != 0x12) {
      ...
      sVar4 = __fprintf_chk(param_2,2,&DAT_001fc0f0,puVar3,param_1 + 0x28);
      return sVar4;
    }
