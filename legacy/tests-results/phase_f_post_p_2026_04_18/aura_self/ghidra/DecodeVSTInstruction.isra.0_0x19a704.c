...

{
  ...
  if (uVar2 < 0xa03) {
    if (0x9c3 < uVar2) {
      ...
      if ((uVar5 & 0x61861b6db) != 0) goto LAB_0019a770;
      uVar5 = uVar5 & 0x4400000000000000;
      goto joined_r0x0019a878;
    }
    if (uVar2 < 0x9af) {
      if (uVar2 < 0x971) {
        if (uVar2 < 0x968) {
          if (0x965 < uVar2) goto LAB_0019a770;
        }
...
LAB_0019a770:
      ...
      else if ((0x3060c183cc7860f3U >> ((ulong)(uVar2 - 0x971) & 0x3f) & 1) != 0) goto LAB_0019a770;
    }
  }
  else {
    if (0x3c < uVar2 - 0xa06) goto LAB_0019a788;
...
LAB_0019a788:
  ...
  if (uVar2 == 0) {
    ...
    if (0x9a6 < uVar3) goto LAB_0019a8a4;
LAB_0019a7c0:
    if (0x969 < uVar3) {
      uVar5 = 0x102040a214102885 >> ((ulong)(uVar3 - 0x96a) & 0x3f);
      goto joined_r0x0019a8c4;
    }
    if (uVar3 == 0x966) goto LAB_0019a7e4;
    if (uVar1 != 0xd) goto LAB_0019a8d0;
LAB_0019ab30:
    ...
    uVar3 = MCInst_getOpcode(param_1);
    if (uVar3 < 0x9a7) goto LAB_0019a7c0;
LAB_0019a8a4:
    if (uVar3 - 0x9ad < 0x39) {
      uVar5 = 0x104104924800001 >> ((ulong)(uVar3 - 0x9ad) & 0x3f);
joined_r0x0019a8c4:
      if ((uVar5 & 1) == 0) goto LAB_0019a8c8;
    }
    else {
LAB_0019a8c8:
      if (uVar1 == 0xd) goto LAB_0019ab30;
LAB_0019a8d0:
      if (uVar1 != 0xf) {
...
LAB_0019a93c:
    ...
    if ((uVar5 & 0x1ff000000061c387) != 0) goto LAB_0019a93c;
    if ((uVar5 & 0xff80000000000) == 0) goto LAB_0019a960;
    if (0x1d < uVar1) {
      return 0;
    }
...
LAB_0019a960:
  ...
  if (uVar3 < 0xa04) {
    ...
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_0019a9c8;
      uVar5 = (ulong)(uVar1 + 1);
    }
LAB_0019a9b0:
...
LAB_0019a9c8:
  ...
  if (uVar3 < 0xa04) {
    ...
    if (0x3c < uVar3 - 0xa06) goto LAB_0019aa18;
    uVar6 = 1L << ((ulong)(uVar3 - 0xa06) & 0x3f);
    uVar5 = (ulong)(uVar1 + 4);
    if ((uVar6 & 0x14a500000000294a) == 0) {
      if ((uVar6 & 0x999000000001) == 0) goto LAB_0019aa18;
      uVar5 = (ulong)(uVar1 + 2);
    }
  }
  MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (uVar5 & 0x1f) * 2));
