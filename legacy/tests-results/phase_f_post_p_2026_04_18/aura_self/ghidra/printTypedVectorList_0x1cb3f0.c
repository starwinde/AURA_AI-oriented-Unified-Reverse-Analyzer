...

{
  ...
  uVar2 = (uint)param_4;
  if (uVar2 == 0) {
    cs_snprintf(auStack_68,0x20,&DAT_001fe6d0,uVar1,param_5,PTR___stack_chk_guard_005ffe88,0);
    if (uVar1 == 0x68) goto LAB_001cb56c;
    if (uVar1 < 0x69) {
      if (uVar1 == 0x62) goto LAB_001cb564;
      if (uVar1 == 100) {
LAB_001cb4c0:
        uVar3 = 0xd;
        goto LAB_001cb4c8;
...
LAB_001cb5cc:
      ...
      if (uVar1 == 0x73) goto LAB_001cb524;
    }
  }
  else {
...
LAB_001cb564:
      ...
      if (uVar1 == 100) {
        if (uVar2 == 1) goto LAB_001cb4c0;
        uVar3 = 0xc;
        if (uVar2 == 2) goto LAB_001cb4c8;
      }
    }
    else if (uVar1 == 0x71) {
      if (uVar2 == 1) goto LAB_001cb5cc;
    }
    else if (uVar1 == 0x73) {
      uVar3 = 10;
      if ((uVar2 == 2) || (uVar3 = 9, uVar2 == 4)) goto LAB_001cb4c8;
      if (uVar2 != 1) {
        uVar3 = 0;
        goto LAB_001cb4c8;
      }
