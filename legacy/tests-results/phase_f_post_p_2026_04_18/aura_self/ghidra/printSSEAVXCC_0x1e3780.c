...

{
  ...
  switch(bVar1 & 0x1f) {
  case 1:
    SStream_concat0(param_3,&DAT_001fcc28);
  ...
  case 3:
    ...
    break;
  case 4:
    SStream_concat0(param_3,&DAT_002024f8);
    op_addAvxCC(param_1,5);
    break;
  case 5:
    SStream_concat0(param_3,&DAT_00202500);
    op_addAvxCC(param_1,6);
    break;
  case 6:
    SStream_concat0(param_3,&DAT_001f8e80);
    op_addAvxCC(param_1,7);
    break;
  case 7:
    SStream_concat0(param_3,&DAT_00202508);
  ...
  case 8:
    ...
    break;
  case 9:
    SStream_concat0(param_3,&DAT_001f8e78);
    op_addAvxCC(param_1,10);
    break;
  case 10:
    SStream_concat0(param_3,&DAT_00202518);
  ...
  case 0xd:
    ...
    break;
  case 0xe:
    SStream_concat0(param_3,&DAT_001fcc30);
    op_addAvxCC(param_1,0xf);
    break;
  case 0xf:
    SStream_concat0(param_3,&DAT_00202530);
  ...
  case 0x1f:
    ...
    break;
  default:
    SStream_concat0(param_3,&DAT_001fcbe0);
