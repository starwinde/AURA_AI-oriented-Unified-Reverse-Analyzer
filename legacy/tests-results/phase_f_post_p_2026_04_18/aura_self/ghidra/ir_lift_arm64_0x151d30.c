    ...
    if ((int)param_1[1] != 0) {
      do {
        ...
        if (uVar28 <= uVar22) {
          ...
          if (pvVar12 == (void *)0x0) goto LAB_00152a44;
          ...
          if (cVar7 != '\0') {
            ...
            do {
              ...
              if (cVar7 == ']') {
                ...
                local_168[sVar23] = '\0';
                cVar7 = local_168[0];
                if (local_168[0] == '\0') goto LAB_00152508;
                sVar23 = strlen(local_168);
                pcVar31 = local_168 + (sVar23 - 1);
                if (pcVar31 <= local_168) goto LAB_001524c8;
                goto LAB_001524b8;
              }
              pcVar30 = pcVar30 + 1;
              cVar7 = *pcVar30;
        ...
        if (uVar28 != 0xffffffff) {
          ...
          if (uVar26 < *(uint *)(plVar14 + 1)) {
            ...
            if (uVar28 == 0) {
              ...
              piVar24 = __ptr;
              do {
                if (*piVar24 == *(int *)(lVar36 + lVar33)) goto LAB_0015227c;
                piVar24 = piVar24 + 1;
  ...
  if (cVar7 != '\0') {
    ...
    do {
      ...
      if (cVar7 == ']') {
        ...
        if (local_168[0x40] == '\0') goto LAB_001526d8;
        sVar23 = strlen(pcVar15);
        pcVar31 = pcVar15 + (sVar23 - 1);
        if (pcVar15 + (sVar23 - 1) <= pcVar15) goto LAB_0015269c;
        goto LAB_0015268c;
      }
      pcVar31 = pcVar31 + 1;
      cVar7 = *pcVar31;
...
LAB_001527d4:
  ...
  uVar22 = local_2b0;
  if (iVar9 == 0) {
    if ((int)local_2b0 < 0) goto LAB_001521f0;
    if (bVar4) {
LAB_00152880:
      if (uVar38 != 0) {
        iVar8 = arm_emit_const(puVar1,local_298,uVar38,uVar13);
        if (iVar8 == -1) goto LAB_00152a44;
      ...
      if (iVar8 == 1) {
        ...
        iVar8 = __isoc99_sscanf(pcVar19,&DAT_001f90f0,&local_288);
        if (iVar8 != 1) goto LAB_001527fc;
...
LAB_00152fec:
        ...
        if (iVar10 != 2) goto LAB_00152bbc;
        if ((int)local_2b0 < 0) goto LAB_00152fec;
...
joined_r0x001531a4:
    ...
    if (iVar10 == 0) {
      uVar11 = 2;
      goto joined_r0x001531a4;
    }
    iVar10 = strcmp(pcVar19,"ldrsw");
    if (iVar10 == 0) {
      uVar22 = local_2b0;
      uVar11 = local_2a4;
      if (-1 < (int)local_2b0) goto LAB_00152c10;
      goto LAB_001521f0;
    }
...
LAB_00153864:
      do {
        ...
        *(int *)(local_298 + 2) = iVar8 + 1;
        ...
        if (puVar17 == (undefined4 *)0x0) goto LAB_00152a44;
        iVar41 = *(int *)(puVar1 + 2);
        *puVar17 = 0x15;
        puVar17[2] = iVar8;
        puVar17[3] = uVar11;
        *(undefined8 *)(puVar17 + 4) = 0;
        if ((local_290 < 0x20) &&
          ...
          *(int *)(local_298 + 2) = iVar9 + 1;
          ...
          if (puVar20 == (undefined4 *)0x0) goto LAB_00152a44;
          ...
          *(undefined8 *)(puVar17 + 8) = 0;
          *(undefined8 *)(puVar17 + 6) = DAT_0020b008;
        }
        puVar17[0x12] = 1;
...
LAB_00153974:
        for (; (int)lVar35 == 0; lVar35 = lVar35 + 1) {
          uVar38 = (ulong)local_2b0;
          uVar11 = local_2a4;
          if (-1 < (int)local_2b0) goto LAB_00153864;
        }
                        ...
                        *(undefined8 *)(puVar17 + 6) = uVar27;
                        do {
                          if (*(int *)((long)&local_1f8 + uVar38 * 4) == -1) {
                            if ((int)uVar38 == 0) goto LAB_00154c3c;
                            break;
                          }
                          uVar38 = uVar38 + 1;
                        } while (uVar38 != 8);
...
LAB_00154a78:
                          ...
                          *(undefined8 *)(puVar17 + 0x1c) = uVar13;
                          do {
                            if (*(int *)((long)&local_1f8 + uVar38 * 4) == -1) {
                              if ((int)uVar38 == 0) goto LAB_0015483c;
                              break;
                            }
                            uVar38 = uVar38 + 1;
                          } while (uVar38 != 8);
...
LAB_00154c94:
                      ...
                      *(undefined8 *)(puVar17 + 0x1c) = uVar13;
                      do {
                        if (*(int *)((long)&local_1f8 + uVar38 * 4) == -1) {
                          if ((int)uVar38 == 0) goto LAB_00154c84;
                          break;
                        }
                        uVar38 = uVar38 + 1;
                      } while (uVar38 != 8);
...
LAB_00153f44:
            ...
            if (bVar4) {
              if (-1 < (long)uVar38) goto LAB_00153e1c;
              uVar38 = 0;
            }
            else {
              uVar38 = 0;
...
LAB_00152210:
  lVar32 = lVar32 + 1;
  if (*(uint *)(lVar29 + 0x18) <= (uint)lVar32) goto LAB_00152220;
  goto LAB_00151f28;
  while( true ) {
    pcVar30 = pcVar31 + -1;
    *pcVar31 = '\0';
...
LAB_001528e8:
    ...
    pcVar31 = __s;
    if (cVar7 != ' ') goto LAB_001528bc;
    do {
      pcVar31 = pcVar31 + 1;
    } while (*pcVar31 == ' ');
    if (pcVar31 == __s) goto LAB_001528bc;
    sVar23 = strlen(pcVar31);
...
LAB_00152900:
    ...
    if (iVar9 == 1) {
      ...
      iVar9 = __isoc99_sscanf(pcVar31,&DAT_001f90f0,&local_288);
      if (iVar9 == 1) {
        uVar38 = CONCAT44(local_288._4_4_,(int)local_288);
        bVar4 = true;
      }
...
LAB_00152990:
    ...
    if (iVar10 == 1) {
      ...
      iVar10 = __isoc99_sscanf(pcVar31,&DAT_001f90f0,&local_288);
      local_310 = 0;
      if (iVar10 == 1) {
