...

{
  ...
  case 5:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 != 0xc4f) goto LAB_001a5b84;
joined_r0x001a9ac8:
    if (uVar7 >> 0x1c == 0xe) {
      return 0;
    }
  ...
  case 10:
    ...
    goto switchD_001a3fec_caseD_33;
  case 0xb:
...
LAB_001a988c:
  ...
  case 0x1c:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (param_3 & 0xf) * 2));
    goto joined_r0x001a4274;
  case 0x1d:
    goto switchD_001a3fec_caseD_1d;
  case 0x1e:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (uVar8 >> 0x10 & 0xf) * 2));
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (param_3 & 0xf) * 2));
    param_3 = uVar8 >> 8 & 0xf;
...
LAB_001a4348:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a4348;
      MCOperand_CreateReg0(param_4,0);
    }
    goto LAB_001a3fb0;
  case 0x29:
  ...
  case 0x2c:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 == 0xc4f) goto joined_r0x001a9ac8;
    goto LAB_001a5b84;
  case 0x2d:
...
LAB_001a4f60:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a4f60;
      MCOperand_CreateReg0(param_4,0);
    }
...
joined_r0x001a6f2c:
  ...
  case 0xd5:
    ...
    if (uVar7 == 0xf) goto LAB_001ab630;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (ulong)uVar7 * 2));
    goto switchD_001a3fec_caseD_33;
  case 0xd6:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (uVar8 >> 8 & 7) * 2));
...
LAB_001aba8c:
      ...
      if (iVar2 != 0xf) goto LAB_001aba8c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aaef8:
      param_1 = 1;
    }
...
LAB_001abaa8:
      ...
      if (iVar2 != 0xf) goto LAB_001abaa8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a95b0:
      param_1 = 1;
    }
...
LAB_001aba6c:
      ...
      if (iVar2 != 0xf) goto LAB_001aba6c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a65f0:
      param_1 = 1;
    }
...
LAB_001ab794:
      ...
      if (iVar2 != 0xf) goto LAB_001ab794;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aad18:
      param_1 = 1;
    }
...
LAB_001ac690:
      ...
      if (iVar2 != 0xf) goto LAB_001ac690;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aad3c:
      param_1 = 1;
    }
...
LAB_001aba18:
      ...
      if (uVar7 != 0xf) goto LAB_001aba18;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aacb0:
      param_1 = 1;
    }
...
LAB_001aba34:
      ...
      if (uVar7 != 0xf) goto LAB_001aba34;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aac2c:
      param_1 = 1;
    }
...
LAB_001ab8e4:
      ...
      if (iVar2 != 0xf) goto LAB_001ab8e4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aab58:
      param_1 = 1;
    }
...
LAB_001ab9dc:
      ...
      if (iVar2 != 0xf) goto LAB_001ab9dc;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aaad4:
      param_1 = 1;
    }
...
LAB_001ab858:
      ...
      if (iVar2 != 0xf) goto LAB_001ab858;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a90fc:
      param_1 = 1;
    }
...
LAB_001ab7cc:
      ...
      if (iVar2 != 0xf) goto LAB_001ab7cc;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab500:
      param_1 = 1;
    }
...
LAB_001abac4:
      ...
      if (iVar2 != 0xf) goto LAB_001abac4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a907c:
      param_1 = 1;
    }
...
LAB_001ab970:
      ...
      if (iVar2 != 0xf) goto LAB_001ab970;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9008:
      param_1 = 1;
    }
...
LAB_001ab8ac:
      ...
      if (iVar2 != 0xf) goto LAB_001ab8ac;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8f58:
      param_1 = 1;
    }
...
LAB_001abafc:
      ...
      if (iVar2 != 0xf) goto LAB_001abafc;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9ed0:
      param_1 = 1;
    }
...
LAB_001ab7b0:
      ...
      if (iVar2 != 0xf) goto LAB_001ab7b0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aa0b0:
      param_1 = 1;
    }
...
LAB_001aa0d4:
    ...
    if (iVar2 != 0xf) goto LAB_001aa0d4;
    goto LAB_001ab630;
  case 0x10f:
    uVar5 = uVar8 >> 8 & 0xf;
    iVar2 = (int)uVar5;
...
LAB_001ab7e8:
      ...
      if (iVar2 != 0xf) goto LAB_001ab7e8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aa02c:
      param_1 = 1;
    }
...
LAB_001ab8c8:
      ...
      if (iVar2 != 0xf) goto LAB_001ab8c8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab574:
      param_1 = 1;
    }
...
LAB_001ab1d4:
    ...
    goto joined_r0x001a69d4;
  case 0x113:
    if ((uVar10 & 0xf) == 0xf) goto LAB_001ab630;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (ulong)(uVar10 & 0xf) * 2));
    goto switchD_001a3fec_caseD_33;
  case 0x115:
  ...
  case 0x117:
    ...
    iVar2 = (int)uVar8;
    if (iVar2 != 0xd) {
      if (iVar2 == 0xf) goto LAB_001ab630;
LAB_001a776c:
      MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + uVar8 * 2));
      return uVar3;
    }
    if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) != 0) goto LAB_001a776c;
    goto LAB_001ad1c8;
  case 0x118:
    ...
    iVar2 = (int)uVar8;
    if (iVar2 == 0xd) {
      if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) == 0) goto LAB_001ad1c8;
    }
    else if (iVar2 == 0xf) goto LAB_001ab630;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + uVar8 * 2));
    goto switchD_001a3fec_caseD_33;
  case 0x119:
    uVar8 = uVar8 >> 8 & 0xf;
...
LAB_001ab9c0:
      ...
      if (iVar2 != 0xf) goto LAB_001ab9c0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aae0c:
      param_1 = 1;
    }
...
LAB_001abae0:
      ...
      if (iVar2 != 0xf) goto LAB_001abae0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab0fc:
      param_1 = 1;
    }
...
LAB_001ab9a4:
      ...
      if (iVar2 != 0xf) goto LAB_001ab9a4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab0ac:
      param_1 = 1;
    }
...
LAB_001ab91c:
      ...
      if (iVar2 != 0xf) goto LAB_001ab91c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aa228:
      param_1 = 1;
    }
...
LAB_001acbcc:
      ...
      if (iVar2 != 0xf) goto LAB_001acbcc;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001aa24c:
      param_1 = 1;
    }
...
LAB_001ab874:
      ...
      if (iVar2 != 0xf) goto LAB_001ab874;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7384:
      param_1 = 1;
    }
...
LAB_001ab954:
      ...
      if (iVar2 != 0xf) goto LAB_001ab954;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7310:
      param_1 = 1;
    }
...
LAB_001ab804:
      ...
      if (iVar2 != 0xf) goto LAB_001ab804;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab040:
      param_1 = 1;
    }
...
LAB_001ac670:
      ...
      if (uVar7 != 0xf) goto LAB_001ac670;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001ab064:
      param_1 = 1;
    }
...
LAB_001ab988:
      ...
      if (iVar2 != 0xf) goto LAB_001ab988;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a72b4:
      param_1 = 1;
    }
    ...
    if (uVar7 == 0xd) {
      if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) != 0) goto LAB_001a72d0;
      goto LAB_001ad1c8;
    }
    if (uVar7 != 0xf) {
LAB_001a72d0:
...
LAB_001ab938:
      ...
      if (iVar2 != 0xf) goto LAB_001ab938;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a722c:
      param_1 = 1;
    }
...
LAB_001acc34:
      ...
      if (iVar2 != 0xf) goto LAB_001acc34;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7250:
      param_1 = 1;
    }
...
LAB_001ab778:
      ...
      if (iVar2 != 0xf) goto LAB_001ab778;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a71a4:
      param_1 = 1;
    }
...
LAB_001ace40:
      ...
      if (iVar2 != 0xf) goto LAB_001ace40;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a71c8:
      param_1 = 1;
    }
...
LAB_001ab900:
      ...
      if ((int)uVar5 != 0xf) goto LAB_001ab900;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a6fd8:
      param_1 = 1;
    }
...
LAB_001ad070:
      ...
      if ((int)uVar13 != 0xf) goto LAB_001ad070;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a6ffc:
      param_1 = 1;
    }
  ...
  case 0x13f:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 != 0xc4f) goto LAB_001abb34;
joined_r0x001a85b8:
    if (uVar7 >> 0x1c == 0xe) {
      return 0;
    }
...
LAB_001a4abc:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a4abc;
      MCOperand_CreateReg0(param_4,0);
    }
    uVar10 = uVar7 & 0xff;
    ...
    if ((param_3 & 0xff) != 0) {
      if (uVar1 + uVar10 < 0x21) {
        MCOperand_CreateReg0(param_4,uVar12);
        if (uVar10 == 1) goto switchD_001a3fec_caseD_33;
        if (uVar1 == 0x1f) {
          return 0;
        }
        uVar10 = uVar10 - 1;
      ...
      uVar8 = (ulong)(uVar1 + 2);
      while (MCOperand_CreateReg0(param_4,*(undefined2 *)(&DAT_0022e23e + uVar8 * 2)),
  ...
  case 0x145:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 == 0xc4f) goto joined_r0x001a85b8;
LAB_001abb34:
    MCOperand_CreateImm0(param_4,uVar7 >> 0x1c);
    if (uVar7 >> 0x1c != 0xe) goto LAB_001a4058;
    goto LAB_001a41ec;
  case 0x148:
    MCOperand_CreateReg0
              (param_4,*(undefined2 *)(DPR + (ulong)(uVar7 & 0xf | (uVar7 & 0x20) >> 1) * 2));
...
LAB_001a8d94:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a8d94;
      MCOperand_CreateReg0(param_4,0);
    }
...
LAB_001a6598:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a6598;
      MCOperand_CreateReg0(param_4,0);
    }
...
LAB_001a8a04:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a8a04;
      MCOperand_CreateReg0(param_4,0);
    }
    uVar10 = uVar7 & 0xff;
    uVar7 = (uVar7 >> 0x16 & 1) << 8 | (uVar7 & 0xf000) >> 3;
...
LAB_001a8968:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a8968;
      MCOperand_CreateReg0(param_4,0);
    }
    iVar2 = DecodeDPRRegListOperand_isra_0
                      (param_4,uVar7 & 0xfe | (uVar7 & 0xf000) >> 4 | (uVar7 & 0x400000) >> 10);
...
LAB_001a8460:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a8460;
      MCOperand_CreateReg0(param_4,0);
    }
    iVar2 = DecodeDPRRegListOperand_isra_0(param_4,uVar7 & 0xfe | (uVar7 & 0xf000) >> 4);
    break;
...
LAB_001a3fa4:
      ...
      MCOperand_CreateImm0(param_4,uVar8);
      if ((int)uVar8 != 0xe) goto LAB_001a3fa4;
      MCOperand_CreateReg0(param_4,0);
    }
LAB_001a3fb0:
    if ((uVar7 >> 0x14 & 1) == 0) goto LAB_001a3fb4;
    goto LAB_001a429c;
  }
  if (iVar2 == 1) {
LAB_001a4b00:
