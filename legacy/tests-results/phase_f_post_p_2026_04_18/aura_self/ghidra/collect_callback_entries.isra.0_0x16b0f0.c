...
LAB_0016b198:
  ...
  if (param_3 <= uVar11) goto LAB_0016b3e0;
  goto LAB_0016b1a8;
LAB_0016b2a8:
  local_170 = 0;
...
LAB_0016b368:
    if (local_170 == *puVar6) goto LAB_0016b29c;
  }
LAB_0016b380:
  if (*param_6 <= uVar8) {
    uVar8 = *param_6 << 1;
    ...
    if (puVar9 == (ulong *)0x0) goto LAB_0016b3e0;
    *param_6 = uVar8;
    *param_4 = puVar9;
    uVar8 = *param_5;
  }
...
LAB_0016b29c:
  ...
  if (pcVar13 == pcVar10) goto LAB_0016b198;
  goto LAB_0016b2a8;
}
