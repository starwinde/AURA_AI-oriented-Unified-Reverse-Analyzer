...
int FUN_001063d4(undefined8 *param_1,undefined8 *param_2)

{
  ...
  if (*(int *)(param_2 + 0x13) == 3 || *(int *)(param_2 + 0x13) == 9) {
    uVar3 = 1;
    if (iVar2 == 3 || iVar2 == 9) goto LAB_00106440;
LAB_00106484:
    ...
    uVar3 = (uint)bVar1;
    if (iVar2 != 3 && iVar2 != 9) goto LAB_00106484;
    iVar2 = bVar1 - 1;
  }
  if (iVar2 != 0) {
    return iVar2;
...
LAB_00106440:
  iVar2 = ((uint)((long)param_1[0x11] < (long)param_2[0x11]) -
