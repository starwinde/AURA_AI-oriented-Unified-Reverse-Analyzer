...
LAB_00186608:
    if (((char *)*puVar30 != (char *)0x0) &&
       (iVar9 = strcmp((char *)*puVar30,".gcc_except_table"), iVar9 == 0)) goto LAB_00186630;
  }
...
LAB_00186630:
  ...
  if (puVar34 != (undefined8 *)0x0) {
    ...
    if (uVar31 == 0) {
      ...
      uVar41 = 0;
      __ptr = (long *)0x0;
      if (puVar30 == (undefined8 *)0x0) goto LAB_001876a0;
LAB_001867e4:
      uVar40 = (uint)uVar31;
      uVar24 = 0;
      pvVar11 = (void *)0x0;
              ...
              if (uVar31 < uVar33) {
                ...
                if (uVar23 < uVar33) {
                  ...
                  if (*(char *)(lVar10 + uVar23) != -1) {
                    if (uVar33 <= local_70) goto LAB_00187d78;
                  ...
                  if (local_70 < uVar33) {
                    ...
                    uVar23 = uVar31;
                    if (uVar33 <= uVar31) goto LAB_001869f8;
                    uVar23 = local_70 + 2;
...
LAB_00186b10:
                          ...
                          if (uVar18 <= uVar23) goto LAB_00186834;
                        } while (cVar21 != '\x01');
LAB_00187750:
                        if (uVar23 < uVar33) {
                          unaff_x26 = uVar23 + 1;
...
LAB_001883e4:
                  ...
                  if (cVar21 == '\x01') goto LAB_00186cb0;
                  if (cVar21 != '\x03') break;
LAB_00186b74:
                  if (uVar33 < uVar23 + 4) {
                    uVar39 = 0;
...
LAB_00186c44:
                    ...
                    do {
                      ...
                      if (uVar18 <= uVar23) goto LAB_00186834;
                      if (cVar21 != '\x01') goto LAB_00186b74;
LAB_00186cb0:
                      uVar39 = 0;
                      if (uVar33 <= uVar23) {
LAB_001883f8:
...
LAB_001883fc:
                      ...
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_001883f8;
                      uVar31 = local_70 + 1;
                      ...
                      local_70 = uVar23;
                      uVar23 = local_70;
                      if (uVar33 <= local_70) goto LAB_001883fc;
                      uVar31 = local_70 + 1;
...
LAB_00187624:
              uVar33 = uVar18 + 8;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_001871f0;
              if (uVar31 < uVar18 + 4) goto LAB_00187d40;
...
LAB_00187704:
                ...
                uVar18 = local_70;
                if (uVar23 <= uVar31) goto LAB_00187624;
                break;
              }
              local_70 = uVar31 + 4;
              if (local_70 <= uVar31) {
              ...
              local_70 = uVar31;
              if (uVar31 < 0xfffffffffffffff8) goto LAB_001871f0;
LAB_00187d40:
              uVar33 = uVar31 + 4;
              local_70 = uVar31;
              if (uVar31 < uVar33) goto LAB_001871f0;
                ...
                if (*plVar13 == lVar10) {
                  ...
                  if (uVar40 < 0x80000) {
                    if (uVar27 <= uVar40) {
                      ...
                      if (pvVar11 != (void *)0x0) goto LAB_001867b0;
                      break;
                    }
                  }
                  else {
...
LAB_001871f0:
            ...
            uVar26 = uVar25;
            if (uVar41 < 0x10000) {
              if (uVar41 < uVar25) goto LAB_00187200;
              if (uVar25 == 0) {
                sVar17 = 0x900;
                uVar26 = 0x20;
              }
              ...
              if (plVar13 != (long *)0x0) goto LAB_00187600;
            }
            else {
LAB_00187600:
              __ptr = plVar13;
...
LAB_00187278:
                ...
                *(undefined1 *)((long)plVar13 + uVar39 + lVar10 + 0x24) = 0;
                if (uVar38 < uVar31) {
                  ...
                  if (uVar31 <= local_70) goto LAB_001880f0;
...
LAB_00188374:
                  ...
                  if (uVar31 <= local_70) goto LAB_001880f4;
...
LAB_00188250:
      ...
      uVar31 = (ulong)uVar40;
      if (puVar30 != (undefined8 *)0x0) goto LAB_001867e4;
LAB_001876a0:
      pvVar11 = (void *)0x0;
      uVar24 = 0;
    }
