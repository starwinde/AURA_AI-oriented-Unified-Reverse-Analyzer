...

{
  ...
  param_1 = param_1 + (param_2 & 0xffffffff) * 0x48;
...
LAB_0015ab10:
      ...
      if (uVar2 == 0x15) {
        if (puVar1[2] == 0xffffffff) {
          ...
          __fprintf_chk(param_3,2,&DAT_001f8930);
        }
        switch(puVar1[3]) {
        case 0:
          pcVar3 = "void";
        ...
        if (uVar2 != 0x19) {
          if (uVar2 == 0x1c) {
            if (2 < puVar1[0x12]) {
              ...
              fwrite(&DAT_001f8938,1,3,param_3);
              ...
              fwrite(&DAT_001f8960,1,3,param_3);
              ...
              fwrite(&DAT_001f7910,1,3,param_3);
              uVar7 = puVar1[0xe];
              goto joined_r0x0015ae40;
            }
          }
        ...
        if (puVar1[0x18] != 0) {
          do {
            ...
            while( true ) {
              ...
              fwrite("__undef",1,7,param_3);
              uVar7 = (uint)lVar8;
              if (puVar1[0x18] <= uVar7) goto LAB_0015aee8;
            }
            __fprintf_chk(param_3,2,&DAT_001f8930);
            lVar8 = lVar8 + 1;
...
LAB_0015aee8:
        fwrite(&DAT_001f89b0,1,3,param_3);
        uVar7 = *(uint *)(param_1 + 0x10);
        goto LAB_0015ab10;
      }
      if (uVar2 == 1) {
      ...
      if (uVar2 < 2) {
        if (puVar1[0x12] == 0) goto LAB_0015ab8c;
        if (puVar1[2] == 0xffffffff) {
          fwrite("__undef",1,7,param_3);
        }
        else {
