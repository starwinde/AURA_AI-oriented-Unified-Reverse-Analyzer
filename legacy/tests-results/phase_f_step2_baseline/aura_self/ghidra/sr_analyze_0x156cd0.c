...
joined_r0x001572b8:
                    ...
                    uVar24 = *(uint *)(param_1 + 1);
                    lVar29 = lVar29 + 0x88;
                    if (uVar18 <= uVar30) goto LAB_00156f40;
                    goto LAB_00156e70;
                  }
...
LAB_0015708c:
            ...
            *(uint *)(puVar22 + 2) = uVar2;
            if (uVar24 != 1) goto LAB_0015708c;
          }
          puVar22 = puVar22 + 0xc;
          if (puVar22 == puVar23) goto LAB_00157138;
        }
        puVar19 = puVar22 + 0xc;
