...
int FUN_0014adec(long param_1,long param_2,ulong param_3,ulong param_4)
...
LAB_0014af30:
        if ((uint)uVar9 <= iVar2 + 1U) goto LAB_0014afa0;
      }
      else {
        if (0xffff < uVar7) {
          uVar7 = 0xffff;
        ...
        if (iVar3 == 0) goto LAB_0014af30;
        iVar11 = iVar11 + 1;
        if (*(uint *)(lVar4 + 0x18) <= iVar2 + 1U) goto LAB_0014afa0;
      }
      iVar2 = iVar2 + 1;
      lVar8 = lVar8 + 0x28;
      lVar6 = *(long *)(lVar4 + 0x10);
  ...
  do {
    lVar1 = lVar6 + lVar8;
    lVar8 = lVar8 + 0x28;
    if (*(long *)(lVar1 + 0x10) != 0) goto LAB_0014af28;
...
LAB_0014aef4:
    ...
    uVar10 = uVar10 + 1;
    lVar8 = lVar8 + 0x28;
    if ((uint)uVar9 <= uVar10) goto LAB_0014aef4;
    lVar6 = *(long *)(lVar4 + 0x10);
  } while( true );
}
