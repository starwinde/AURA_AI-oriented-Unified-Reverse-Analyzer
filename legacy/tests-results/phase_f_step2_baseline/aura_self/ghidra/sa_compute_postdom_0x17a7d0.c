...
LAB_0017a88c:
          ...
          if (0 < (int)uVar21) {
            ...
            do {
              if (*piVar10 == 0x1a) goto LAB_0017a88c;
      ...
      do {
        while (uVar19 = *puVar11, (*(byte *)((long)__ptr_03 + (ulong)uVar19) & 1) == 0) {
          lVar35 = lVar31 + (ulong)uVar19 * 0x48;
          *(undefined1 *)((long)__ptr_03 + (ulong)uVar19) = 1;
          ...
          if (uVar21 != 0) {
            ...
            do {
              ...
              if ((uVar28 < uVar2) && ((*(byte *)((long)__ptr_03 + (ulong)uVar28) & 1) == 0)) {
                lVar13 = lVar31 + (ulong)uVar28 * 0x48;
                  ...
                  do {
                    ...
                    if ((uVar3 < uVar2) && ((*(byte *)((long)__ptr_03 + (ulong)uVar3) & 1) == 0)) {
                      *(undefined1 *)((long)__ptr_03 + (ulong)uVar3) = 1;
                      lVar26 = lVar31 + (ulong)uVar3 * 0x48;
                        ...
                        do {
                          ...
                          if ((uVar4 < uVar2) &&
                            ...
                            *(undefined1 *)((long)__ptr_03 + (ulong)uVar4) = 1;
                            lVar25 = lVar31 + (ulong)uVar4 * 0x48;
          ...
          local_6c = uVar21;
          if (puVar11 == puVar1) goto LAB_0017aa14;
        }
        puVar11 = puVar11 + 1;
...
LAB_0017aa14:
      ...
      if (local_6c >> 1 == 0) {
        ...
        puVar11 = __ptr_00;
        if (local_6c != 0) goto LAB_0017aac0;
      }
      else {
        do {
...
LAB_0017ab10:
        ...
        puVar12 = __ptr_00;
        do {
          if (*puVar12 == uVar19) goto joined_r0x0017acfc;
          puVar12 = puVar12 + 1;
        } while (puVar12 != puVar1);
        lVar35 = lVar31 + (ulong)uVar19 * 0x48;
          ...
          if (((uVar21 < uVar2) && (uVar29 = (ulong)uVar21, *(int *)((long)__s + uVar29 * 4) != -1))
            ...
            while (uVar3 = uVar28, uVar21 != uVar28) {
              while( true ) {
                ...
                if (uVar3 == uVar28) goto LAB_0017ad68;
                uVar28 = uVar3;
                if (uVar3 == 0xffffffff) goto LAB_0017acc8;
              }
              while( true ) {
                uVar3 = uVar21;
                if (uVar21 == 0xffffffff) goto LAB_0017acc8;
                uVar29 = (ulong)uVar21;
                if (*(uint *)((long)__ptr_02 + uVar29 * 4) <= uVar4) break;
                uVar3 = *(uint *)((long)__s + uVar29 * 4);
                bVar8 = uVar3 == uVar21;
                uVar21 = uVar3;
                if (bVar8) goto LAB_0017ad68;
              }
            }
          }
          goto LAB_0017acc8;
        }
        goto joined_r0x0017acfc;
      }
      iVar20 = 1;
LAB_0017ad74:
...
LAB_0017acc8:
  uVar28 = uVar3;
  puVar22 = puVar22 + 1;
  if (puVar22 == puVar12) goto code_r0x0017acd4;
  goto LAB_0017aca0;
code_r0x0017acd4:
...
joined_r0x0017acfc:
  puVar11 = puVar11 + 1;
  if (puVar11 != __ptr_01 + local_6c) goto LAB_0017ab10;
  if (!bVar6) goto LAB_0017ad74;
  if (iVar20 != 20000) {
    iVar20 = iVar20 + 1;
    puVar11 = __ptr_01;
    bVar6 = bVar7;
...
LAB_0017ae5c:
    ...
    *(uint *)((long)puVar15 + (ulong)uVar19 * 4) = uVar19;
    ...
    puVar17 = puVar15;
    uVar37 = _DAT_0020a520;
    uVar38 = _UNK_0020a528;
    do {
      puVar18 = puVar17 + 2;
      puVar17[1] = uVar38;
      *puVar17 = uVar37;
    ...
    if ((uVar2 & 3) != 0) goto LAB_0017ae5c;
  }
LAB_0017ad7c:
  free(__ptr_00);
  free(__ptr_01);
