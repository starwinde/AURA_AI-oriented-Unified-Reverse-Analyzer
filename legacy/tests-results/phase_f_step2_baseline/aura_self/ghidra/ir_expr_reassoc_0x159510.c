...
LAB_0015973c:
                ...
                if (((uVar3 <= uVar4) ||
                    (piVar8 = *(int **)((long)__ptr + uVar7 * 0x10), piVar8 == (int *)0x0)) ||
                   (*piVar8 != 1)) goto LAB_0015989c;
              }
              else if (uVar4 < uVar3) {
                piVar8 = *(int **)((long)__ptr + uVar7 * 0x10);
                if ((piVar8 == (int *)0x0) || (*piVar8 != 1)) goto LAB_00159720;
              }
              else {
LAB_0015989c:
                if (uVar4 < uVar2) {
        ...
        if (plVar12 == plVar15) {
          ...
          if (uVar2 != 0) {
            ...
            do {
              ...
              plVar12 = plVar12 + 9;
            } while (plVar14 + (ulong)uVar2 * 9 != plVar12);
            iVar21 = iVar21 + iVar20;
            uVar2 = *(uint *)(param_1 + 2);
            if (*(uint *)(param_1 + 1) != 0) {
              iVar20 = 0;
              plVar12 = plVar14 + (ulong)*(uint *)(param_1 + 1) * 9;
              do {
                if (*(uint *)(plVar14 + 1) != 0) {
                  piVar8 = (int *)*plVar14;
