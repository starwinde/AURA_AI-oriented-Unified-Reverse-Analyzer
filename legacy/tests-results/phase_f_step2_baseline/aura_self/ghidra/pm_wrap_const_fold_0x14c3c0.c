...
LAB_0014c4f4:
    puVar13 = puVar13 + 9;
    if (puVar1 + (ulong)uVar2 * 9 == puVar13) {
      return uVar14;
    }
  }
  puVar8 = (uint *)*puVar13;
  puVar12 = puVar8 + (ulong)*(uint *)(puVar13 + 1) * 0x22;
LAB_0014c400:
  if ((puVar8[0x12] == 2) && (uVar3 = *puVar8, uVar3 - 2 < 9)) {
    if (*(uint *)(param_1 + 1) != 0) {
      ...
      do {
        if (*(uint *)(puVar9 + 1) != 0) {
          piVar6 = (int *)*puVar9;
          piVar4 = piVar6 + (ulong)*(uint *)(puVar9 + 1) * 0x22;
          do {
...
LAB_0014c470:
  do {
    if (*(uint *)(puVar9 + 1) != 0) {
      piVar4 = (int *)*puVar9;
      piVar11 = piVar4 + (ulong)*(uint *)(puVar9 + 1) * 0x22;
      do {
...
LAB_0014c4e8:
  puVar8 = puVar8 + 0x22;
  if (puVar12 == puVar8) goto LAB_0014c4f4;
  goto LAB_0014c400;
}
