...
void compute_loop_body_isra_0
               (long param_1,uint param_2,uint param_3,uint param_4,undefined8 *param_5,
               uint *param_6)

{
  ...
  if (param_3 != param_4) {
    ...
    *__ptr_00 = param_4;
    while( true ) {
      iVar8 = (int)uVar9;
      lVar5 = param_1 + (ulong)param_4 * 0x48;
  ...
  if (param_2 == 0) {
    pvVar4 = malloc(0);
    uVar10 = 0;
    if (pvVar4 != (void *)0x0) goto LAB_00179644;
  }
  else {
    uVar9 = 0;
    pbVar3 = __ptr;
