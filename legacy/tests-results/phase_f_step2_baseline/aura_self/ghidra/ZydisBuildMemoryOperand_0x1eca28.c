...
/* WARNING: Removing unreachable block (ram,0x001ece38) */
...
LAB_001ecd10:
    ...
    if (0x10 < bVar1) goto LAB_001ecd10;
    if (bVar1 == 0) {
      if ((bVar3 & 7) == 5) {
        *(undefined1 *)((long)param_3 + 0x21) = 8;
        param_3[5] = 0;
...
LAB_001ece74:
      ...
      if (bVar1 == 4) {
        *(undefined1 *)(param_3 + 3) = 2;
        ...
        if (4 < bVar1) goto LAB_001ece74;
        if (1 < bVar1) {
          if (bVar1 != 2) goto LAB_001ece74;
