  ...
  do {
    ...
    if (uVar27 != 0) {
      ...
      if (uVar27 - 1 < 4) {
        ...
        if ((uVar27 & 3) == 0) goto LAB_00157f54;
      }
...
LAB_00157fc4:
          ...
          if (uVar5 <= uVar27) goto LAB_001580a8;
        }
        uVar17 = piVar23[0x18];
        if ((uVar17 == 0) ||
...
LAB_00158564:
        ...
        uVar5 = *(uint *)(param_1 + 1);
        local_18[4] = 0;
        if (uVar5 <= uVar18) goto LAB_00158584;
      }
    }
LAB_00158584:
    if ((int)uVar24 == 0) goto LAB_001585b8;
  }
  else {
    piVar12 = piVar21;
    do {
...
LAB_001581c0:
    if ((int)uVar15 == 0) {
      uVar27 = piVar25[5];
      uVar17 = uVar18;
      if (uVar27 <= uVar18) goto LAB_001581f0;
...
LAB_001581f0:
    ...
    if (pvVar6 == (void *)0x0) goto LAB_001582c0;
    uVar18 = piVar25[4];
...
LAB_001582d0:
  lVar13 = lVar13 + 4;
  if ((ulong)uVar5 << 2 == lVar13) goto LAB_001582dc;
  goto LAB_001580f0;
  while( true ) {
    uVar17 = (int)uVar15 - 1;
    uVar15 = (ulong)uVar17;
...
LAB_00158370:
    if ((int)uVar15 == 0) {
      ...
      uVar17 = uVar18;
      if (uVar27 <= uVar18) goto LAB_001583b4;
      lVar10 = (ulong)uVar18 * 0x88;
      goto LAB_00158430;
    }
  }
...
LAB_0015847c:
  lVar13 = lVar13 + 4;
  if ((ulong)uVar5 << 2 == lVar13) goto LAB_00158488;
  goto LAB_00158310;
}
