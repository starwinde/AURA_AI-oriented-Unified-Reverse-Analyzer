        ...
        *(undefined1 *)((long)pvVar5 + sVar6) = 0;
        ...
        if (iVar2 != 0) {
          ...
          if (iVar2 != 0) {
            ...
            else if (0x1000 < uVar3) goto LAB_0016bec0;
              ...
              *(undefined4 *)((long)plVar10 + 0xc) = *(undefined4 *)(lVar8 + 0x28);
              ...
              if (lVar9 != 0) {
                for (plVar18 = *(long **)(lVar9 + 0x10); plVar18 != (long *)0x0;
                  ...
                  if (iVar2 != 0) {
                    lVar8 = cJSON_GetObjectItemCaseSensitive(plVar18,&DAT_001f9fa0);
                    lVar9 = cJSON_GetObjectItemCaseSensitive(plVar18,"category");
                    lVar11 = cJSON_GetObjectItemCaseSensitive(plVar18,&DAT_001f9fb8);
