    ...
    if (local_f0[0] != 0) {
      ...
      do {
        ...
        if (uVar36 != 0) {
          puVar7 = __ptr;
LAB_001797b4:
          if (*puVar7 != uVar9) goto LAB_001797a8;
          ...
          if (local_90 != (uint *)0x0) {
            ...
            if (__ptr_00 != (byte *)0x0) {
              ...
              if (uVar31 == 0) {
                pvVar5 = malloc(0);
                uVar37 = 0;
                if (pvVar5 != (void *)0x0) goto LAB_001798cc;
              }
              else {
                uVar34 = 0;
                pbVar15 = __ptr_00;
          ...
          if (pvVar5 == (void *)0x0) {
            ...
            if (uVar9 == 0) {
              ...
              do {
                ...
                if (uVar21 < uVar37) {
                  lVar11 = lVar29 + (ulong)uVar21 * 0x48;
...
LAB_00179a48:
          puVar7[5] = uVar32;
          lVar11 = lVar29 + (ulong)*puVar7 * 0x48;
          lVar27 = lVar29 + (ulong)puVar7[1] * 0x48;
...
LAB_00179b14:
            ...
            do {
              ...
              if (iVar4 - 0x17U < 2 || iVar4 == 0x1a) {
                if (-1 < iVar20) goto LAB_00179ac4;
                piVar12 = (int *)0x0;
                if (iVar4 == 0x17) goto LAB_00179c48;
                goto LAB_00179b08;
              }
              piVar26 = piVar26 + -0x22;
            } while (piVar26 != piVar23 + ((ulong)uVar32 - (ulong)uVar31) * 0x22 + -0x44);
            piVar26 = (int *)0x0;
            if (iVar20 < 0) goto LAB_00179b14;
LAB_00179ac4:
            piVar12 = (int *)(*(long *)(lVar27 + 8) + (long)iVar20 * 0x88);
            do {
              if (*piVar12 - 0x17U < 2 || *piVar12 == 0x1a) goto LAB_00179af8;
              iVar20 = iVar20 + -1;
              piVar12 = piVar12 + -0x22;
            } while (iVar20 != -1);
            piVar12 = (int *)0x0;
LAB_00179af8:
            if (piVar26 == (int *)0x0) goto LAB_00179b14;
            iVar4 = *piVar26;
            if (iVar4 == 0x17) {
              if (-1 < (int)uVar31) {
                piVar23 = *(int **)(lVar11 + 8);
                  ...
                  if (iVar4 - 0x17U < 2 || iVar4 == 0x1a) {
                    if (((iVar4 == 0x17) && (piVar26[0x12] != 0)) && (uVar37 != 0)) {
                      ...
                      do {
                          ...
                          do {
                            if (piVar26[6] == piVar12[2]) {
                              ...
                              if (((1 < iVar4 - 0xdU && iVar4 != 0x11) && (9 < iVar4 - 0xbU)) ||
                                 ((uint)piVar12[0x12] < 2)) goto LAB_00179eb8;
                              uVar31 = piVar12[6];
                        ...
                        puVar18 = puVar18 + 9;
                      } while (puVar6 + (ulong)uVar37 * 9 != puVar18);
                    }
                    break;
                  }
                  piVar26 = piVar26 + -0x22;
...
LAB_00179b08:
              if (piVar12 == (int *)0x0 || iVar4 != 0x18) goto LAB_00179b14;
              uVar25 = 0;
              iVar4 = 0;
              uVar31 = 0;
              iVar20 = 0;
...
joined_r0x0017a104:
            uVar31 = uVar28;
            uVar32 = uVar21;
            if (sVar19 == sVar35) goto LAB_0017a178;
            puVar38 = puVar38 + 0x18;
            sVar19 = sVar19 + 1;
          } while( true );
        }
...
LAB_001797a8:
  puVar7 = puVar7 + 0x18;
  if (puVar7 == __ptr + (ulong)uVar36 * 0x18) goto LAB_00179a14;
  goto LAB_001797b4;
LAB_00179d30:
      ...
      do {
        if (*(uint *)(puVar18 + 1) != 0) {
          ...
          do {
            if (piVar17[2] == iVar20) {
              iVar20 = *piVar17;
              if ((1 < iVar20 - 2U) || ((uint)piVar17[0x12] < 2)) goto LAB_00179d24;
              uVar21 = piVar17[6];
              if (uVar21 != uVar32 && piVar17[10] != uVar32) goto LAB_00179d24;
              if (uVar21 == uVar32) {
                uVar21 = piVar17[10];
              }
              uVar28 = 0;
...
LAB_00179e24:
  do {
    if (*(uint *)(puVar18 + 1) != 0) {
      ...
      do {
        if (piVar17[2] == uVar21) {
          if (*piVar17 != 1) goto LAB_00179d24;
...
LAB_00179d24:
  ...
  if (piVar23 == piVar26) goto LAB_00179eb8;
  goto LAB_00179d30;
LAB_0017a178:
  if (uVar31 != 0xffffffff) {
  ...
  uVar9 = uVar9 + 1;
  puVar7 = puVar7 + 0x18;
  if (uVar36 == uVar9) goto code_r0x0017a1a4;
  goto LAB_0017a0e4;
code_r0x0017a1a4:
