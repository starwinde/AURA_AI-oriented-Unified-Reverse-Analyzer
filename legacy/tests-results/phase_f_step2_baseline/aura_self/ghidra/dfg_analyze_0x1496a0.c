...
LAB_0014975c:
          *puVar11 = uVar12;
          puVar11[1] = uVar12;
          if (uVar19 <= (int)lVar18 + 1U) goto LAB_001498bc;
        }
        else {
          uVar8 = uVar21 - 1;
          ...
          if (uVar21 <= uVar8 + 1) goto LAB_0014975c;
          uVar12 = uVar12 | puVar10[(ulong)(uVar8 + 1) * 2];
          if (uVar21 <= uVar8 + 2) goto LAB_0014975c;
          uVar12 = uVar12 | puVar10[(ulong)(uVar8 + 2) * 2];
          if (uVar21 <= uVar8 + 3) goto LAB_0014975c;
          uVar12 = uVar12 | puVar10[(ulong)(uVar8 + 3) * 2];
          if (uVar21 <= uVar8 + 4) goto LAB_0014975c;
    ...
    if (uVar19 != 0) {
      ...
      do {
        while( true ) {
          ...
          if (pvVar6 == (void *)0x0) goto LAB_00149aa0;
          puVar11 = puVar11 + 8;
          *(uint *)((long)pvVar6 + uVar13 * 4) = uVar12;
          uVar17 = uVar13 + 1;
          __ptr = pvVar6;
          if ((ulong)uVar19 == uVar13 + 1) goto LAB_00149948;
        }
...
LAB_00149978:
      ...
      while ((int)uVar17 != 0) {
        while( true ) {
          ...
          if (uVar19 != 0) goto LAB_00149978;
LAB_00149a00:
          if ((uVar12 == 0) && (puVar11[3] == uVar21)) break;
          puVar11[2] = 0;
          puVar11[3] = uVar21;
          if ((int)uVar17 == 0) goto LAB_00149a1c;
        }
      }
    }
LAB_00149a1c:
