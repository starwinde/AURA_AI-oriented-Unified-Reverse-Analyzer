...
LAB_001789c4:
    puVar12 = puVar12 + 9;
    if (puVar12 == puVar1 + (ulong)uVar2 * 9) {
      return iVar5;
    }
  }
  piVar8 = (int *)*puVar12;
  ...
  if (piVar8[0x12] == 2) {
    if (*piVar8 == 3) {
      if ((piVar8[6] != -1) && (uVar3 = *(uint *)(param_1 + 1), uVar3 != 0)) {
        ...
        do {
          ...
          puVar10 = puVar10 + 9;
        } while (puVar10 != puVar1 + (ulong)uVar3 * 9);
      }
    }
    else if (((*piVar8 == 8) && (piVar8[10] != -1)) && (uVar3 = *(uint *)(param_1 + 1), uVar3 != 0))
    {
      ...
      do {
        ...
        puVar10 = puVar10 + 9;
      } while (puVar1 + (ulong)uVar3 * 9 != puVar10);
    }
  }
  goto LAB_001789b8;
  while (puVar10 = puVar10 + 9, puVar10 != puVar1 + (ulong)uVar3 * 9) {
LAB_00178a50:
    if (*(uint *)(puVar10 + 1) != 0) {
      piVar6 = (int *)*puVar10;
      piVar7 = piVar6 + (ulong)*(uint *)(puVar10 + 1) * 0x22;
      do {
        if (piVar8[10] == piVar6[2]) {
          if (((*piVar6 != 3) || (piVar6[0x12] != 2)) || (piVar6[6] == -1)) goto LAB_001789b8;
          uVar13 = 0;
          puVar10 = puVar1;
          goto LAB_00178aac;
        }
...
LAB_00178aac:
  ...
  goto LAB_001789b8;
  while (puVar10 = puVar10 + 9, puVar1 + (ulong)uVar3 * 9 != puVar10) {
LAB_00178b34:
    if (*(uint *)(puVar10 + 1) != 0) {
      piVar6 = (int *)*puVar10;
      piVar7 = piVar6 + (ulong)*(uint *)(puVar10 + 1) * 0x22;
      do {
        if (piVar8[6] == piVar6[2]) {
          if (((*piVar6 != 8) || (piVar6[0x12] != 2)) || (piVar6[10] == -1)) goto LAB_001789b8;
          uVar13 = 0;
          puVar10 = puVar1;
          goto LAB_00178b90;
        }
...
LAB_001789b8:
  piVar8 = piVar8 + 0x22;
  if (piVar8 == piVar11) goto LAB_001789c4;
  goto LAB_00178938;
}
