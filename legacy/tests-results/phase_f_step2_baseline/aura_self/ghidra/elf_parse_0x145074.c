...
LAB_00145144:
        bVar5 = uVar25 == 0x3e;
        if (!bVar5) goto LAB_0014514c;
LAB_001451f4:
        *(undefined4 *)((long)param_1 + 0xc) = 2;
        param_1[2] = uVar13;
        if ((local_130 != 0 && uVar28 != 0) && uVar30 != 0) goto LAB_00145218;
      }
      else {
        uVar25 = *(ushort *)(pcVar10 + 0x12);
        ...
        bVar5 = false;
        if (uVar25 == 0x3e) goto LAB_001451f4;
LAB_0014514c:
...
LAB_00145218:
          if ((uVar31 <= local_130) ||
             ...
             (ulong)uVar28 * (ulong)uVar30 - (uVar31 - local_130) != 0)) goto LAB_001453e0;
          local_100 = (char *)0x0;
          local_f8 = 0;
          bVar5 = cVar3 != '\x01';
            ...
            if (iVar6 != 0) {
              ...
              if ((local_100 == (char *)0x0) || ((uint)local_f8 <= local_98)) {
                ...
                *(char **)(lVar20 + lVar29) = pcVar19;
                if (pcVar19 == (char *)0x0) goto LAB_001457b8;
              }
              else {
                ...
                if (local_f8 == uVar13) {
                  ...
                  do {
                    ...
                    sVar21 = sVar17 + 1;
                    sVar16 = sVar21;
                    if ((local_100 + uVar13)[sVar17] == '\0') goto LAB_0014539c;
...
LAB_0014539c:
                ...
                *(void **)(lVar20 + lVar29) = pvVar9;
                if (pvVar9 == (void *)0x0) goto LAB_001457b8;
          ...
          do {
            ...
            do {
              ...
              if ((iVar7 != 0) && (local_c4 == extraout_w9)) {
                ...
                if (uVar12 != 0) {
                  if ((uVar31 <= uVar12) || (uVar31 - uVar12 < uVar22)) goto LAB_00145184;
                  pcVar19 = (char *)0x0;
                  sVar21 = 0;
                  if (uVar13 != 0) {
                  ...
                  if (pvVar9 == (void *)0x0) goto LAB_001457b8;
                  if (uVar22 < uVar13) goto LAB_00145184;
...
LAB_001456dc:
  ...
  if ((pcVar19 == (char *)0x0) || ((uint)uVar26 <= uVar15)) {
    ...
    *plVar32 = (long)pcVar10;
    if (pcVar10 == (char *)0x0) goto LAB_001457b8;
  }
  else {
    uVar12 = (ulong)uVar15;
    sVar16 = 0;
    if (uVar26 == uVar12) {
      ...
      do {
        ...
        sVar16 = sVar14 + 1;
        sVar17 = sVar16;
        if ((pcVar19 + uVar12)[sVar14] == '\0') goto LAB_00145740;
...
LAB_00145740:
  ...
  *(uint *)(param_1 + 6) = uVar28;
  if (sVar21 <= uVar31) goto LAB_00145184;
