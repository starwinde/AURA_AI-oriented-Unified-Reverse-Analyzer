  ...
  if (1 < (int)param_1) {
    ...
    do {
      while( true ) {
        ...
        if (param_1 == uVar12) goto LAB_0013f8f0;
      }
      uVar12 = uVar12 + 1;
...
LAB_0013fc30:
        ...
        for (lVar17 = 0; lVar17 != lVar13; lVar17 = lVar17 + 1) {
          ...
          if (lVar9 != 0) {
            __printf_chk(2,&DAT_001f7158,*(undefined8 *)(lVar9 + 8),*(undefined8 *)(lVar9 + 0x10));
          }
        }
        uVar12 = 0;
        goto LAB_0013fb94;
