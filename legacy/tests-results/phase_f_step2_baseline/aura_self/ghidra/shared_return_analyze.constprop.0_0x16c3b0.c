    ...
    if (__ptr != (ulong *)0x0) {
      ...
      do {
        while( true ) {
          ...
          if (param_2 <= uVar20) goto LAB_0016c4f0;
        }
        puVar5 = __ptr;
        uVar17 = uVar27;
        if (uVar27 <= uVar24) {
          ...
          if (puVar5 == (ulong *)0x0) goto LAB_0016c9b0;
        }
            ...
            if (((*pcVar14 != 'l') || (pcVar14[1] != 'r')) || (pcVar14[2] != '\0')) {
              ...
              if ((local_270 != pcVar14) && (uVar11 != 0)) {
                ...
                if (local_2b8 <= uVar27) {
                  ...
                  if (puVar6 == (ulong *)0x0) goto LAB_0016c9dc;
                }
                ...
                if (uVar27 != 0) {
                  ...
                  do {
                    while ((uVar15 == puVar10[1] &&
                      ...
                      uVar12 = uVar12 + 1;
                      puVar10 = puVar10 + 2;
                      if (0x3f < uVar1 || uVar27 <= uVar12) goto LAB_0016c760;
                    }
                    uVar12 = uVar12 + 1;
                    puVar10 = puVar10 + 2;
...
LAB_0016c760:
                  if (1 < (uint)uVar21) {
                    if (uVar16 != 0) {
                      puVar10 = puVar6;
                      do {
                        if (uVar15 == *puVar10) goto LAB_0016c5f4;
