...
void FUN_001103e4(FILE *param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  iVar6 = -0x20;
  uVar8 = 0;
  local_c8 = *(long *)PTR___stack_chk_guard_0013ffd0;
  ...
  while( true ) {
    ...
    plVar3 = plVar3 + 1;
    if (uVar8 == 10) {
      __fprintf_chk(param_1,2,"%s (%s) %s\n",param_2,"GNU coreutils",param_4);
      uVar1 = dcgettext(0,&DAT_0011c948,5);
...
LAB_00110578:
      if (local_c8 - *(long *)PTR___stack_chk_guard_0013ffd0 == 0) {
        return;
      }
