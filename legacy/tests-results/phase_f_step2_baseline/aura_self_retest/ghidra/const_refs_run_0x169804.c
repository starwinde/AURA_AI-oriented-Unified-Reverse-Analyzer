...
joined_r0x00169b90:
              if (bVar3 == 0) {
LAB_00169904:
                if (iVar19 < 1) goto LAB_00169970;
                goto LAB_0016990c;
              }
            }
            pcVar7 = strchr((char *)__haystack,0x23);
            if (pcVar7 == (char *)0x0) goto LAB_00169904;
            bVar3 = pcVar7[1];
            __haystack = (byte *)(pcVar7 + 1);
            if (bVar3 == 0x30) {
              if ((pcVar7[2] & 0xdfU) == 0x58) goto LAB_001698b0;
              ppuVar8 = __ctype_b_loc();
              uVar4 = (*ppuVar8)[0x30];
            }
            else {
            ...
            if ((uVar4 >> 0xb & 1) == 0) goto joined_r0x00169b90;
            local_90 = 0;
            iVar6 = __isoc99_sscanf(__haystack,&DAT_001f9830,&local_90);
            if ((iVar6 == 1) &&
               ((iVar19 < 1 ||
                ((local_88[0] != local_90 &&
                 ((iVar19 == 1 ||
...
LAB_00169918:
          uVar12 = *puVar22;
          if ((plVar21 == (long *)0x0) || (*(uint *)(param_1 + 0x20) == 0)) goto joined_r0x00169a5c;
          plVar23 = plVar21;
LAB_00169938:
          if (((plVar23[3] == 0) || (uVar12 < (ulong)plVar23[1])) ||
             ((ulong)(plVar23[3] + plVar23[1]) <= uVar12)) goto LAB_00169958;
          pcVar7 = (char *)*plVar23;
          if (pcVar7 == (char *)0x0) goto joined_r0x00169a5c;
          uVar13 = (uint)uVar14;
          uVar16 = (uint)uVar17;
          pvVar11 = pvVar15;
          if (uVar16 <= uVar13) {
...
LAB_00169958:
  plVar23 = plVar23 + 7;
  if (plVar23 == plVar21 + (ulong)*(uint *)(param_1 + 0x20) * 7) goto joined_r0x00169a5c;
  goto LAB_00169938;
joined_r0x00169a5c:
  puVar22 = puVar22 + 1;
  if (puVar22 == puVar1) goto LAB_00169970;
  goto LAB_00169918;
}
