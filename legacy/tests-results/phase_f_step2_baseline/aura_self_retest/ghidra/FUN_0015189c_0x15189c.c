...
void FUN_0015189c(long *param_1,undefined8 param_2,char *param_3,long param_4)
  ...
  if ((param_1 != (long *)0x0) && (plStack_288 = calloc(1,0xa0), plStack_288 != (long *)0x0)) {
    *(undefined4 *)(plStack_288 + 2) = 0;
    ...
    if ((int)param_1[1] != 0) {
      do {
        plVar16 = plStack_288;
        uVar24 = *(uint *)(plStack_288 + 1);
        uVar29 = *(uint *)((long)plStack_288 + 0xc);
            ...
            do {
              while (cVar9 != '[') {
                if (cVar9 == ']') {
                  ...
                  memcpy(acStack_158,pcVar33,sVar25);
                  acStack_158[sVar25] = '\0';
                  cVar9 = acStack_158[0];
                  if (acStack_158[0] == '\0') goto LAB_00152060;
                  sVar25 = strlen(acStack_158);
                  pcVar33 = acStack_158 + (sVar25 - 1);
                  if (acStack_158 < pcVar33) goto LAB_00152014;
                  goto LAB_00152024;
                }
                pcVar32 = pcVar32 + 1;
                cVar9 = *pcVar32;
...
LAB_00151f00:
            snprintf(acStack_158,0x40,"%s",pcVar33);
            cVar9 = acStack_158[0];
            if (acStack_158[0] != '\0') {
              sVar25 = strlen(acStack_158);
              pcVar33 = acStack_158 + (sVar25 - 1);
              if (acStack_158 < pcVar33) {
                do {
                  cVar9 = acStack_158[0];
                  if (*pcVar33 != ' ') break;
                  pcVar32 = pcVar33 + -1;
              ...
              if (cVar9 == ' ') {
                ...
                if (pcVar33 != acStack_158) {
                  sVar25 = strlen(pcVar33);
                  __memmove_chk(acStack_158,pcVar33,sVar25 + 1,0x40);
                }
              }
            }
    ...
    do {
      while (cVar9 != '[') {
        if (cVar9 == ']') {
          ...
          if (acStack_158[0x40] == '\0') goto LAB_00152228;
...
LAB_001520a8:
  ...
  if (iVar10 == 0) {
    uStack_2a0 = 0xfffffffe;
    iVar10 = arm64_reg_lookup(pcVar33,&uStack_29c,&uStack_290);
  }
  else {
    iVar10 = arm64_reg_lookup(pcVar33,&uStack_29c,&uStack_290);
  }
...
LAB_0015231c:
  ...
  uVar24 = uStack_2a0;
  if (iVar11 == 0) {
    if ((int)uStack_2a0 < 0) goto LAB_00151c88;
    if (!bVar6) {
      ...
      if (iVar10 == 1) {
        uVar35 = CONCAT44(uStack_27c,uStack_280);
      }
      else {
        iVar10 = __isoc99_sscanf(pcVar21,&DAT_001f84c8,&uStack_278);
        if (iVar10 != 1) goto LAB_00152344;
        uVar35 = CONCAT44(uStack_278._4_4_,(int)uStack_278);
      }
    }
    if (uVar35 != 0) {
      iVar10 = arm_emit_const(puVar2,plStack_288,uVar35,uVar15);
      if (iVar10 == -1) goto LAB_001525a8;
      lVar28 = lVar28 + 1;
      *(int *)((long)&uStack_1e8 + (long)(int)uVar24 * 4) = iVar10;
      uVar29 = *(uint *)(lVar1 + 0x18);
      *(undefined4 *)((long)&uStack_270 + (long)(int)uVar24 * 4) = 5;
      if (uVar29 <= (uint)lVar28) goto LAB_00151c9c;
      goto LAB_00151a90;
    }
LAB_00152344:
    lVar30 = plStack_288[2];
    lVar28 = lVar28 + 1;
    *(undefined4 *)((long)&uStack_270 + (long)(int)uVar24 * 4) = 5;
    *(int *)(plStack_288 + 2) = (int)lVar30 + 1;
    *(int *)((long)&uStack_1e8 + (long)(int)uVar24 * 4) = (int)lVar30;
  ...
  if (((iVar11 == 0) || (iVar11 = strcmp(pcVar21,"movz"), iVar11 == 0)) ||
    ...
    if (-1 < (int)uStack_2a0) {
      ...
      *(undefined4 *)((long)puVar18 + 0xc) = uStack_294;
      ...
      lVar28 = lVar28 + 1;
      *(int *)((long)&uStack_1e8 + (long)(int)uVar24 * 4) = iVar10;
      *(undefined4 *)((long)&uStack_270 + (long)(int)uVar24 * 4) = uStack_294;
      puVar18[0xe] = uVar15;
      if (*(uint *)(lVar1 + 0x18) <= (uint)lVar28) goto LAB_00151c9c;
      goto LAB_00151a90;
    }
...
LAB_00151bc4:
        ...
        *(int *)((long)&uStack_1e8 + (long)(int)uVar24 * 4) = iVar11;
        *(undefined4 *)((long)&uStack_270 + (long)(int)uVar24 * 4) = uStack_294;
      ...
      if (-1 < (int)uStack_2a0) {
        lVar30 = (long)(int)uStack_2a0;
        iVar10 = *(int *)((long)&uStack_1e8 + lVar30 * 4);
        if (iVar10 == -1) {
          iVar10 = (int)plStack_288[2];
          *(int *)(plStack_288 + 2) = iVar10 + 1;
        }
        if (uStack_29c < 0x20) {
          ...
          auVar44 = arm_emit_const(puVar2,plStack_288,uVar35,uVar15);
          uVar38 = auVar44._8_8_;
          iVar12 = auVar44._0_4_;
          uVar27 = auVar44._4_4_;
          if (iVar12 == -1) goto LAB_001525a8;
        ...
        *(int *)((long)&uStack_1e8 + lVar30 * 4) = iVar11;
        *(uint *)(puVar2 + 2) = uVar24 + 1;
        *(undefined4 *)((long)&uStack_270 + lVar30 * 4) = uVar43;
              ...
              do {
                ...
                *(undefined8 *)(puVar19 + 4) = 0;
                   ...
                   (iVar12 = *(int *)((long)&uStack_1e8 + (long)(int)uStack_280 * 4), iVar12 != -1))
                {
                  auVar44 = arm_emit_const(puVar2,plStack_288,
                                           CONCAT44(uStack_278._4_4_,(int)uStack_278) + lVar30 * 8,
                                           uVar15);
                ...
                *(undefined8 *)(puVar19 + 0x1c) = uVar15;
                if ((int)uVar35 < 0x20) {
                  ...
                  *(int *)((long)&uStack_1e8 + uVar35) = iVar10;
                  *(undefined4 *)((long)&uStack_270 + uVar35) = uVar13;
                }
                lVar30 = lVar30 + 1;
                if (lVar30 == 2) break;
LAB_001534ec:
                for (; (int)lVar30 == 0; lVar30 = lVar30 + 1) {
                  uVar35 = (ulong)uStack_2a0;
                  uVar13 = uStack_294;
                  if (-1 < (int)uStack_2a0) goto LAB_001533d0;
                }
                uVar35 = (ulong)uStack_29c;
                uVar13 = uStack_290;
                ...
                if (uVar24 == 0xffffffff) {
                  ...
                  *(undefined1 (*) [16])(puVar19 + 10) = auVar44;
                  ...
                  if (uVar24 < 0x20) {
                    ...
                    iVar10 = *(int *)((long)&uStack_1e8 + uVar35);
                    if (iVar10 == -1) goto LAB_00153830;
                    uVar13 = *(undefined4 *)((long)&uStack_270 + uVar35);
                  }
                  else {
LAB_00153830:
                    iVar10 = (int)plStack_288[2];
            ...
            if (iVar10 == 0) {
              ...
              if (uStack_29c < 0x20) {
                ...
                uVar43 = auVar44._4_4_;
                if (iStack_2dc == -1) goto LAB_001525a8;
              }
LAB_00152ed0:
...
LAB_0015409c:
                        ...
                        uVar13 = arm64_cond_suffix_to_cmp(lVar30 + 0x22,&uStack_278);
                        iVar10 = (int)plStack_288[2];
                        *(int *)(plStack_288 + 2) = iVar10 + 1;
                        puVar19 = (undefined4 *)arm_irblock_alloc_instr(puVar2);
                        if (puVar19 == (undefined4 *)0x0) goto LAB_001525a8;
                    ...
                    if (iVar10 != 0) {
                      ...
                      if (iVar10 != 0) {
                        ...
                        if (iVar10 == 0) {
                          ...
                          *(undefined8 *)(puVar19 + 4) = 0;
                          if (acStack_158[0] == '#') {
                            uVar23 = strtoull(acStack_158 + 1,(char **)0x0,0);
                          }
                          else if (acStack_158[0] == '0') {
                            uVar23 = strtoull(acStack_158,(char **)0x0,0);
                          }
                          else {
                            uVar23 = 0;
                          }
                          ...
                          *(undefined8 *)(puVar19 + 6) = DAT_0020a3e8;
                          do {
                            if (*(int *)((long)&uStack_1e8 + uVar35 * 4) == -1) {
                          ...
                          *(undefined8 *)(puVar19 + 0x16) = 0;
                          ...
                          do {
                            uVar13 = *(undefined4 *)((long)&uStack_270 + lVar30 * 4);
                            lVar34 = lVar30 * 4;
                            lVar30 = lVar30 + 1;
                            *puVar22 = *(undefined4 *)((long)&uStack_1e8 + lVar34);
                            puVar22[1] = uVar13;
...
LAB_00154474:
                        ...
                        if (iVar10 != 0) {
                          ...
                          if (iVar10 == 0) {
                            for (pcVar21 = acStack_158; cVar9 = *pcVar21,
                                cVar9 == ' ' || cVar9 == '#'; pcVar21 = pcVar21 + 1) {
                            }
                            if ((cVar9 == '\0') ||
                               (uVar23 = strtoull(pcVar21,(char **)&uStack_278,0),
...
LAB_001545ac:
                        ...
                        *(undefined8 *)(puVar19 + 4) = 0;
                        if (uStack_2a0 < 0x20) {
                          uVar35 = -(ulong)(uStack_2a0 >> 0x1f) & 0xfffffffc00000000 |
                                   (ulong)uStack_2a0 << 2;
                          iVar11 = *(int *)((long)&uStack_1e8 + uVar35);
...
LAB_00153cd4:
                        ...
                        plVar16 = plStack_288;
                        uVar13 = arm64_cond_suffix_to_cmp(acStack_158 + 0x40,&uStack_278);
                      ...
                      auVar44 = arm_emit_const(puVar2,plStack_288,1,uVar15);
                      if (auVar44._0_4_ == -1) goto LAB_001525a8;
                      auVar45 = arm_emit_const(puVar2,plStack_288,0,uVar15);
                      ...
                      *(int *)(plStack_288 + 2) = iVar11 + 1;
                      ...
                      puVar19[2] = iVar11;
                      *(int *)((long)&uStack_1e8 + uVar35) = iVar11;
                      *puVar19 = 0x1c;
                      puVar19[7] = 6;
                      *(long *)(puVar19 + 0xc) = auVar44._8_8_;
                      *(long *)(puVar19 + 0xe) = auVar45._0_8_;
                      *(undefined4 *)((long)&uStack_270 + uVar35) = uStack_294;
                      puVar19[3] = uStack_294;
                      *(undefined8 *)(puVar19 + 4) = 0;
                      puVar19[6] = iVar10;
                      *(undefined8 *)(puVar19 + 8) = 0;
...
LAB_00154040:
                      ...
                      if (pcVar21 != (char *)0x0) {
                        ...
                        for (lVar30 = 0;
                          ...
                          *(byte *)((long)&uStack_168 + lVar30) = bVar5;
                        }
                        *(undefined1 *)((long)&uStack_168 + (long)(int)lVar30) = 0;
                      }
                    ...
                    *(undefined8 *)(puVar19 + 8) = 0;
                    if (uStack_29c < 0x20) {
                      uVar20 = -(ulong)(uStack_29c >> 0x1f) & 0xfffffffc00000000 |
                               (ulong)uStack_29c << 2;
                      iVar11 = *(int *)((long)&uStack_1e8 + uVar20);
                      if (iVar11 == -1) goto LAB_00153c84;
                      uVar13 = *(undefined4 *)((long)&uStack_270 + uVar20);
                    }
                    else {
LAB_00153c84:
                      iVar11 = (int)plStack_288[2];
...
LAB_00153ba4:
                      ...
                      *(int *)(plStack_288 + 2) = iVar11 + 1;
                      ...
                      uVar20 = -(ulong)(uStack_280 >> 0x1f) & 0xfffffffc00000000 |
                               (ulong)uStack_280 << 2;
                      iVar11 = *(int *)((long)&uStack_1e8 + uVar20);
                ...
                if (uStack_2a0 < 0x20) {
                  uVar20 = -(ulong)(uStack_2a0 >> 0x1f) & 0xfffffffc00000000 |
                           (ulong)uStack_2a0 << 2;
                  iVar10 = *(int *)((long)&uStack_1e8 + uVar20);
...
LAB_001538ec:
                ...
                auVar44 = arm_emit_const(puVar2,plStack_288,1L << (uVar35 & 0x3f),uVar15);
                if (auVar44._0_4_ == -1) goto LAB_001525a8;
                iVar11 = (int)plStack_288[2];
                *(int *)(plStack_288 + 2) = iVar11 + 1;
                puVar19 = (undefined4 *)arm_irblock_alloc_instr(puVar2);
            ...
            if (uStack_2a0 < 0x20) {
              uVar35 = -(ulong)(uStack_2a0 >> 0x1f) & 0xfffffffc00000000 | (ulong)uStack_2a0 << 2;
              iVar10 = *(int *)((long)&uStack_1e8 + uVar35);
              if (iVar10 == -1) goto LAB_0015377c;
              uVar43 = *(undefined4 *)((long)&uStack_270 + uVar35);
            }
            else {
LAB_0015377c:
              uVar43 = 4;
          ...
          *(undefined4 *)(puVar18 + 1) = 0xffffffff;
          if (uStack_280 < 0x20) {
            lVar30 = (long)(int)uStack_280;
            iVar11 = *(int *)((long)&uStack_1e8 + lVar30 * 4);
...
LAB_00152720:
  ...
  *(undefined4 *)((long)puVar18 + 0xc) = uVar13;
  if (uStack_280 < 0x20) {
    lVar30 = (long)(int)uStack_280;
    iVar12 = *(int *)((long)&uStack_1e8 + lVar30 * 4);
    if (iVar12 != -1) {
      ...
      *(uint *)(puVar2 + 2) = uVar29 + 1;
      ...
      uVar43 = *(undefined4 *)((long)&uStack_270 + lVar30 * 4);
      *(undefined4 *)((long)pvVar14 + lVar34 + 0x84) = 0;
      *(undefined8 *)((long)pvVar14 + lVar34 + 0xc) = 0;
      *(undefined8 *)((long)pvVar14 + lVar34 + 4) = 0;
      *(undefined8 *)((long)pvVar14 + lVar34 + 0x1c) = 0;
...
LAB_00152c6c:
  ...
  *(int *)((long)&uStack_1e8 + (long)(int)uVar24 * 4) = iVar10;
  uVar29 = *(uint *)(lVar1 + 0x18);
  *(undefined4 *)((long)&uStack_270 + (long)(int)uVar24 * 4) = uVar13;
  if (uVar29 <= (uint)lVar28) goto LAB_00151c9c;
  goto LAB_00151a90;
  while( true ) {
    pcVar32 = pcVar33 + -1;
...
LAB_00152470:
    ...
    iVar11 = __isoc99_sscanf(pcVar33,"0x%lx",&uStack_280);
    if (iVar11 == 1) {
      uVar35 = CONCAT44(uStack_27c,uStack_280);
      bVar6 = true;
    }
    else {
      iVar11 = __isoc99_sscanf(pcVar33,&DAT_001f84c8,&uStack_278);
      if (iVar11 == 1) {
        uVar35 = CONCAT44(uStack_278._4_4_,(int)uStack_278);
        bVar6 = true;
      }
...
LAB_00152500:
    ...
    iVar10 = __isoc99_sscanf(pcVar33,"0x%lx",&uStack_280);
    if (iVar10 == 1) {
      ...
      uVar38 = 0;
      iVar10 = __isoc99_sscanf(pcVar33,&DAT_001f84c8,&uStack_278);
      if (iVar10 == 1) {
  ...
  goto LAB_0015231c;
LAB_00153794:
  if (((uVar29 == 0x1f) && (lVar30 = CONCAT44(uStack_278._4_4_,(int)uStack_278), lVar30 != 0)) &&
     (pcVar21 = strchr(acStack_158 + 0x80,0x21), pcVar21 != (char *)0x0)) {
    auVar44 = arm_emit_const(puVar2,plStack_288,lVar30,uVar15);
    iVar10 = (int)plStack_288[2];
    *(int *)(plStack_288 + 2) = iVar10 + 1;
    puVar19 = (undefined4 *)arm_irblock_alloc_instr(puVar2);
    if (puVar19 == (undefined4 *)0x0) goto LAB_001525a8;
