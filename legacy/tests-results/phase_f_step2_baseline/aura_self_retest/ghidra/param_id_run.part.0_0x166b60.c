...
LAB_0016733c:
        ...
        local_1b0 = 0;
        uVar30 = (ulong)uVar28;
        if (uVar28 < uVar42) goto LAB_00167fb4;
LAB_00167398:
        uVar35 = 8;
...
LAB_00167d3c:
                    ...
                    if (iVar18 < iVar16) {
                      ...
                      if (iVar17 != 0) goto code_r0x00167d38;
...
LAB_00166e20:
    *(bool *)(puVar20 + 0x12) = local_118 != 0;
    if (local_118 == 0) goto LAB_00166e34;
LAB_00167058:
...
LAB_001683a8:
        do {
          ...
          do {
            ...
            if (pcVar43 == (char *)0x0) goto LAB_0016846c;
            pcVar26 = pcVar43 + 3;
...
LAB_00167740:
          do {
            ...
            do {
              ...
              if (pcVar43 == (char *)0x0) goto LAB_00167804;
              pcVar26 = pcVar43 + 2;
            } while (((pcVar39 < pcVar43) &&
                     ((byte)(pcVar43[-1] + 0x9fU) < 0x1a || (byte)(pcVar43[-1] - 0x30U) < 10)) ||
...
LAB_00167804:
      ...
      pcVar41 = "int";
      pcVar43 = pcVar41;
      if (param_3 != 0) goto LAB_00167298;
    }
LAB_001672f0:
      ...
      do {
        while (puVar29 = (undefined8 *)(*(long *)(lVar19 + 0x18) + lVar46),
          ...
          *(int *)(puVar36 + 0x1a) = iVar16;
          ...
          uVar28 = *(uint *)(lVar19 + 0x20);
          if (uVar28 <= uVar42) goto LAB_00166e20;
        }
        uVar42 = uVar42 + 1;
        lVar46 = lVar46 + 0x30;
      } while (uVar42 < uVar28);
    ...
    do {
      while (puVar29 = (undefined8 *)(*(long *)(lVar19 + 0x18) + lVar46), *(int *)(puVar29 + 4) == 2
        ...
        *(uint *)(puVar36 + 0x1a) = uVar28;
        ...
        __snprintf_chk((long)puVar36 + 0x84,0x40,2,0x40,"arg%u",*(undefined4 *)puVar36);
        uVar28 = *(uint *)(lVar19 + 0x20);
        if (uVar28 <= uVar42) goto LAB_00167038;
      }
      uVar42 = uVar42 + 1;
      lVar46 = lVar46 + 0x30;
    } while (uVar42 < uVar28);
LAB_00167038:
    *(bool *)(puVar20 + 0x12) = local_118 != 0;
    if (local_118 != 0) goto LAB_00167058;
LAB_00166e34:
    uVar14 = DAT_001f82bc;
    *(undefined4 *)(puVar20 + 2) = DAT_001f82b8;
...
LAB_00166e6c:
  ...
  return;
LAB_00168640:
  if (iVar16 <= iVar18) goto code_r0x0016864c;
  iVar17 = strcmp(local_1f0,(char *)local_88);
  local_1f0 = local_1f0 + 0x10;
  if (iVar17 == 0) goto joined_r0x00167510;
  iVar18 = iVar18 + 1;
  goto LAB_00168640;
code_r0x0016864c:
  if (iVar16 < 8) {
    ...
    if (pcVar41 == (char *)0x0) {
      bVar10 = false;
      if (pcVar43 != (char *)0x0) goto LAB_00167588;
LAB_00167d64:
      pcVar25 = acStack_108;
      do {
        ...
        while (pbVar24 = (byte *)strstr((char *)pbVar22,pcVar25), pbVar24 != (byte *)0x0) {
          ...
          if (((pbVar24 <= __s) ||
            ...
            bVar10 = bVar11;
            if (pcVar25 != (char *)0x0) goto LAB_00168010;
            goto LAB_00167dfc;
          }
        }
        pcVar25 = pcVar25 + 0x10;
...
LAB_00167514:
    ...
    do {
      ...
      if (pbVar24 == (byte *)0x0) goto LAB_00167d50;
      pbVar22 = pbVar24 + sVar23;
    } while (((__s < pbVar24) &&
...
joined_r0x00167510:
    if (pcVar41 != (char *)0x0) goto LAB_00167514;
LAB_00167d50:
    bVar10 = false;
    if (pcVar43 == (char *)0x0) {
LAB_00167d58:
      bVar10 = bVar11;
      if (iVar16 < 1) goto LAB_00167f04;
      goto LAB_00167d64;
    }
LAB_00167588:
            ...
            if (((iVar18 == 0) || (iVar18 = strcmp((char *)pbVar22,"strh"), iVar18 == 0)) ||
              ...
              if (iVar18 != 0) {
                ...
                if (iVar18 != 0) {
                  ...
                  bVar13 = true;
                  if (iVar18 != 0) goto LAB_00167dfc;
                }
                bVar6 = *__s;
                if (bVar6 != 0x77) {
                  if (bVar6 < 0x78) {
                    if (bVar6 == 0x57) goto LAB_001684b4;
                    if (bVar6 != 0x58) {
                      bVar13 = true;
                      goto LAB_00167dfc;
                    }
                    ...
                    bVar13 = true;
                    if (bVar6 != 0x78) goto LAB_00167dfc;
                  }
                  uVar28 = 8;
                  goto LAB_00168188;
                }
...
LAB_00167f04:
  ...
  __s = __s + 0xe0;
  bVar11 = bVar10;
  if (uVar30 <= uVar45) goto code_r0x00167f14;
  goto LAB_001674f0;
code_r0x00167d38:
...
code_r0x00167f14:
  ...
  if (bVar44) {
    if ((!bVar11) && (bVar12)) goto LAB_0016827c;
  }
  else {
LAB_0016826c:
...
LAB_00167f58:
  ...
  if (uVar37 == uVar15) goto LAB_00168344;
  uVar28 = *(uint *)(puVar20 + 1);
  uVar42 = *(uint *)((long)puVar20 + 0xc);
  local_1b0 = (undefined4)uVar37;
  uVar30 = (ulong)uVar28;
  if (uVar42 <= uVar28) goto LAB_00167398;
LAB_00167fb4:
  pvVar21 = (void *)*puVar20;
  goto LAB_001673d8;
}
