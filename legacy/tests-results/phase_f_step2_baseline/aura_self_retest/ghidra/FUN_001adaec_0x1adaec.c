...
void FUN_001adaec(long param_1,int param_2,undefined8 param_3)

{
  ...
  if (uVar3 == 3) {
    SStream_concat0(param_3,&DAT_001f86a0);
    goto LAB_001adbe0;
  }
  if ((uVar2 >> 2 & 1) == 0) {
    if (uVar3 == 1) {
      SStream_concat0(param_3,&DAT_001f86a8);
      goto LAB_001adbe0;
    }
    if (uVar3 == 2) {
      SStream_concat0(param_3,&DAT_001f8698);
      goto LAB_001adbe0;
    }
  }
  else {
    ...
    if (uVar3 == 5) {
      SStream_concat0(param_3,&DAT_001fbd50);
      return;
    }
  }
  SStream_concat0(param_3,&DAT_001fc428);
LAB_001adbe0:
  SStream_concat0(param_3,&DAT_001fc348);
  lVar9 = *(long *)(param_1 + 800);
