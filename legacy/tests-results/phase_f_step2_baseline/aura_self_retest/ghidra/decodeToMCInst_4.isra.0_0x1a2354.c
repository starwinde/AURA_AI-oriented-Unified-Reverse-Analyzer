...

{
  ...
  case 5:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 != 0xc4f) goto LAB_001a3fc4;
joined_r0x001a7f08:
    if (uVar7 >> 0x1c == 0xe) {
      return 0;
    }
  ...
  case 10:
    ...
    goto switchD_001a242c_caseD_33;
  case 0xb:
...
LAB_001a7ccc:
  ...
  case 0x1c:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (param_3 & 0xf) * 2));
    goto joined_r0x001a26b4;
  case 0x1d:
    goto switchD_001a242c_caseD_1d;
  case 0x1e:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (uVar8 >> 0x10 & 0xf) * 2));
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (param_3 & 0xf) * 2));
    param_3 = uVar8 >> 8 & 0xf;
...
LAB_001a2788:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a2788;
      MCOperand_CreateReg0(param_4,0);
    }
    goto LAB_001a23f0;
  case 0x29:
  ...
  case 0x2c:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 == 0xc4f) goto joined_r0x001a7f08;
    goto LAB_001a3fc4;
  case 0x2d:
...
LAB_001a33a0:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a33a0;
      MCOperand_CreateReg0(param_4,0);
    }
...
joined_r0x001a536c:
  ...
  case 0xd5:
    ...
    if (uVar7 == 0xf) goto LAB_001a9a70;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (ulong)uVar7 * 2));
    goto switchD_001a242c_caseD_33;
  case 0xd6:
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (uVar8 >> 8 & 7) * 2));
...
LAB_001a9ecc:
      ...
      if (iVar2 != 0xf) goto LAB_001a9ecc;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9338:
      param_1 = 1;
    }
...
LAB_001a9ee8:
      ...
      if (iVar2 != 0xf) goto LAB_001a9ee8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a79f0:
      param_1 = 1;
    }
...
LAB_001a9eac:
      ...
      if (iVar2 != 0xf) goto LAB_001a9eac;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a4a30:
      param_1 = 1;
    }
...
LAB_001a9bd4:
      ...
      if (iVar2 != 0xf) goto LAB_001a9bd4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9158:
      param_1 = 1;
    }
...
LAB_001aaad0:
      ...
      if (iVar2 != 0xf) goto LAB_001aaad0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a917c:
      param_1 = 1;
    }
...
LAB_001a9e58:
      ...
      if (uVar7 != 0xf) goto LAB_001a9e58;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a90f0:
      param_1 = 1;
    }
...
LAB_001a9e74:
      ...
      if (uVar7 != 0xf) goto LAB_001a9e74;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a906c:
      param_1 = 1;
    }
...
LAB_001a9d24:
      ...
      if (iVar2 != 0xf) goto LAB_001a9d24;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8f98:
      param_1 = 1;
    }
...
LAB_001a9e1c:
      ...
      if (iVar2 != 0xf) goto LAB_001a9e1c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8f14:
      param_1 = 1;
    }
...
LAB_001ab474:
      ...
      if (iVar2 != 0xf) goto LAB_001ab474;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8f38:
      param_1 = 1;
    }
...
LAB_001a9c98:
      ...
      if (iVar2 != 0xf) goto LAB_001a9c98;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a753c:
      param_1 = 1;
    }
...
LAB_001a9c0c:
      ...
      if (iVar2 != 0xf) goto LAB_001a9c0c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9940:
      param_1 = 1;
    }
...
LAB_001a9f04:
      ...
      if (iVar2 != 0xf) goto LAB_001a9f04;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a74bc:
      param_1 = 1;
    }
...
LAB_001a9db0:
      ...
      if (iVar2 != 0xf) goto LAB_001a9db0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7448:
      param_1 = 1;
    }
...
LAB_001a9cec:
      ...
      if (iVar2 != 0xf) goto LAB_001a9cec;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7398:
      param_1 = 1;
    }
...
LAB_001a9f3c:
      ...
      if (iVar2 != 0xf) goto LAB_001a9f3c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8310:
      param_1 = 1;
    }
...
LAB_001a9bf0:
      ...
      if (iVar2 != 0xf) goto LAB_001a9bf0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a84f0:
      param_1 = 1;
    }
...
LAB_001a8514:
    ...
    if (iVar2 != 0xf) goto LAB_001a8514;
    goto LAB_001a9a70;
  case 0x10f:
    uVar5 = uVar8 >> 8 & 0xf;
    iVar2 = (int)uVar5;
...
LAB_001a9c28:
      ...
      if (iVar2 != 0xf) goto LAB_001a9c28;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a846c:
      param_1 = 1;
    }
...
LAB_001a9d08:
      ...
      if (iVar2 != 0xf) goto LAB_001a9d08;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a99b4:
      param_1 = 1;
    }
...
LAB_001a9614:
    ...
    goto joined_r0x001a4e14;
  case 0x113:
    if ((uVar10 & 0xf) == 0xf) goto LAB_001a9a70;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + (ulong)(uVar10 & 0xf) * 2));
    goto switchD_001a242c_caseD_33;
  case 0x115:
  ...
  case 0x117:
    ...
    iVar2 = (int)uVar8;
    if (iVar2 != 0xd) {
      if (iVar2 == 0xf) goto LAB_001a9a70;
LAB_001a5bac:
      MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + uVar8 * 2));
      return uVar3;
    }
    if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) != 0) goto LAB_001a5bac;
    goto LAB_001ab608;
  case 0x118:
    ...
    iVar2 = (int)uVar8;
    if (iVar2 == 0xd) {
      if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) == 0) goto LAB_001ab608;
    }
    else if (iVar2 == 0xf) goto LAB_001a9a70;
    MCOperand_CreateReg0(param_4,*(undefined2 *)(GPR + uVar8 * 2));
    goto switchD_001a242c_caseD_33;
  case 0x119:
    uVar8 = uVar8 >> 8 & 0xf;
...
LAB_001a9e00:
      ...
      if (iVar2 != 0xf) goto LAB_001a9e00;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a924c:
      param_1 = 1;
    }
...
LAB_001a9f20:
      ...
      if (iVar2 != 0xf) goto LAB_001a9f20;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a953c:
      param_1 = 1;
    }
...
LAB_001a9de4:
      ...
      if (iVar2 != 0xf) goto LAB_001a9de4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a94ec:
      param_1 = 1;
    }
...
LAB_001a9e90:
      ...
      if (iVar2 != 0xf) goto LAB_001a9e90;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a7830:
      param_1 = 1;
    }
...
LAB_001a9d5c:
      ...
      if (iVar2 != 0xf) goto LAB_001a9d5c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a8668:
      param_1 = 1;
    }
...
LAB_001ab00c:
      ...
      if (iVar2 != 0xf) goto LAB_001ab00c;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a868c:
      param_1 = 1;
    }
...
LAB_001a9cb4:
      ...
      if (iVar2 != 0xf) goto LAB_001a9cb4;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a57c4:
      param_1 = 1;
    }
...
LAB_001a9d94:
      ...
      if (iVar2 != 0xf) goto LAB_001a9d94;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a5750:
      param_1 = 1;
    }
...
LAB_001a9c44:
      ...
      if (iVar2 != 0xf) goto LAB_001a9c44;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a9480:
      param_1 = 1;
    }
...
LAB_001aaab0:
      ...
      if (uVar7 != 0xf) goto LAB_001aaab0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a94a4:
      param_1 = 1;
    }
...
LAB_001a9dc8:
      ...
      if (iVar2 != 0xf) goto LAB_001a9dc8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a56f4:
      param_1 = 1;
    }
    ...
    if (uVar7 == 0xd) {
      if ((*(uint *)(*(long *)(param_4 + 800) + 4) >> 6 & 1) != 0) goto LAB_001a5710;
      goto LAB_001ab608;
    }
    if (uVar7 != 0xf) {
LAB_001a5710:
...
LAB_001a9d78:
      ...
      if (iVar2 != 0xf) goto LAB_001a9d78;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a566c:
      param_1 = 1;
    }
...
LAB_001ab074:
      ...
      if (iVar2 != 0xf) goto LAB_001ab074;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a5690:
      param_1 = 1;
    }
...
LAB_001a9bb8:
      ...
      if (iVar2 != 0xf) goto LAB_001a9bb8;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a55e4:
      param_1 = 1;
    }
...
LAB_001ab280:
      ...
      if (iVar2 != 0xf) goto LAB_001ab280;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a5608:
      param_1 = 1;
    }
...
LAB_001a9d40:
      ...
      if ((int)uVar5 != 0xf) goto LAB_001a9d40;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a5418:
      param_1 = 1;
    }
...
LAB_001ab4b0:
      ...
      if ((int)uVar13 != 0xf) goto LAB_001ab4b0;
      MCOperand_CreateReg0(param_4,0xb);
LAB_001a543c:
      param_1 = 1;
    }
  ...
  case 0x13f:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 != 0xc4f) goto LAB_001a9f74;
joined_r0x001a69f8:
    if (uVar7 >> 0x1c == 0xe) {
      return 0;
    }
...
LAB_001a2efc:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a2efc;
      MCOperand_CreateReg0(param_4,0);
    }
    uVar10 = uVar7 & 0xff;
    ...
    if ((param_3 & 0xff) != 0) {
      if (uVar1 + uVar10 < 0x21) {
        MCOperand_CreateReg0(param_4,uVar12);
        if (uVar10 == 1) goto switchD_001a242c_caseD_33;
        if (uVar1 == 0x1f) {
          return 0;
        }
        uVar10 = uVar10 - 1;
      ...
      uVar8 = (ulong)(uVar1 + 2);
      while (MCOperand_CreateReg0(param_4,*(undefined2 *)(&DAT_0022d61e + uVar8 * 2)),
  ...
  case 0x145:
    ...
    iVar2 = MCInst_getOpcode(param_4);
    if (iVar2 == 0xc4f) goto joined_r0x001a69f8;
LAB_001a9f74:
    MCOperand_CreateImm0(param_4,uVar7 >> 0x1c);
    if (uVar7 >> 0x1c != 0xe) goto LAB_001a2498;
    goto LAB_001a262c;
  case 0x148:
    MCOperand_CreateReg0
              (param_4,*(undefined2 *)(DPR + (ulong)(uVar7 & 0xf | (uVar7 & 0x20) >> 1) * 2));
...
LAB_001a71d4:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a71d4;
      MCOperand_CreateReg0(param_4,0);
    }
...
LAB_001a49d8:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a49d8;
      MCOperand_CreateReg0(param_4,0);
    }
...
LAB_001a6e44:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a6e44;
      MCOperand_CreateReg0(param_4,0);
    }
    uVar10 = uVar7 & 0xff;
    uVar7 = (uVar7 >> 0x16 & 1) << 8 | (uVar7 & 0xf000) >> 3;
...
LAB_001a6da8:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a6da8;
      MCOperand_CreateReg0(param_4,0);
    }
    iVar2 = DecodeDPRRegListOperand_isra_0
                      (param_4,uVar7 & 0xfe | (uVar7 & 0xf000) >> 4 | (uVar7 & 0x400000) >> 10);
...
LAB_001a68a0:
      ...
      MCOperand_CreateImm0(param_4,uVar10);
      if (uVar10 != 0xe) goto LAB_001a68a0;
      MCOperand_CreateReg0(param_4,0);
    }
    iVar2 = DecodeDPRRegListOperand_isra_0(param_4,uVar7 & 0xfe | (uVar7 & 0xf000) >> 4);
    break;
...
LAB_001a23e4:
      ...
      MCOperand_CreateImm0(param_4,uVar8);
      if ((int)uVar8 != 0xe) goto LAB_001a23e4;
      MCOperand_CreateReg0(param_4,0);
    }
LAB_001a23f0:
    if ((uVar7 >> 0x14 & 1) == 0) goto LAB_001a23f4;
    goto LAB_001a26dc;
  }
  if (iVar2 == 1) {
LAB_001a2f40:
