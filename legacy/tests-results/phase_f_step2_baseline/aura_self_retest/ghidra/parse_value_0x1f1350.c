...

{
  ...
  if ((param_2 == (long *)0x0) || (lVar14 = *param_2, lVar14 == 0)) goto LAB_001f1444;
  uVar2 = param_2[1];
  uVar10 = param_2[2];
  uVar6 = uVar10 + 4;
  if (uVar2 < uVar6) {
    ...
    {
LAB_001f1400:
      if (uVar2 <= uVar10) goto LAB_001f1444;
          ...
          if (uVar10 < uVar2) {
            do {
              if (0x20 < *(byte *)(lVar14 + uVar10)) {
                if (uVar2 == uVar10) goto LAB_001f1aa0;
                uVar10 = param_2[2];
                if (uVar2 <= uVar10) goto LAB_001f1a54;
                goto LAB_001f18bc;
              }
              uVar10 = uVar10 + 1;
              param_2[2] = uVar10;
...
LAB_001f18bc:
              if (*(char *)(lVar14 + uVar10) == ']') {
                ...
                do {
                  ...
                  puVar13 = puVar12;
                  if (puVar7 == (undefined8 *)0x0) goto LAB_001f1a60;
                  puVar7[1] = 0;
                  *puVar7 = 0;
                  puVar7[3] = 0;
                  puVar7[2] = 0;
                  ...
                  if (iVar4 == 0) goto LAB_001f1a38;
                  lVar14 = *param_2;
                  uVar6 = param_2[1];
                  uVar10 = param_2[2];
                  if (lVar14 == 0) {
LAB_001f19a4:
                    if (uVar6 <= uVar10) goto LAB_001f1a38;
                  }
                  else {
                    if (uVar6 <= uVar10) goto LAB_001f1a38;
                    do {
                      if (0x20 < *(byte *)(lVar14 + uVar10)) {
                        if (uVar10 != uVar6) goto LAB_001f19a4;
                        break;
                      }
                      uVar10 = uVar10 + 1;
                      param_2[2] = uVar10;
                ...
                if ((uVar6 <= uVar10) || (*(char *)(lVar14 + uVar10) != ']')) goto LAB_001f1a38;
        ...
        if (uVar10 < uVar2) {
          do {
            if (0x20 < *(byte *)(lVar14 + uVar10)) {
              if (uVar2 == uVar10) goto LAB_001f1ab4;
              uVar10 = param_2[2];
              if (uVar2 <= uVar10) goto LAB_001f1a54;
              goto LAB_001f1544;
            }
...
LAB_001f162c:
                ...
                if (*(char *)(lVar14 + uVar10) != ':') goto LAB_001f1a38;
                uVar10 = uVar10 + 1;
                param_2[2] = uVar10;
...
LAB_001f16dc:
                  ...
                  do {
                    if (0x20 < *(byte *)(lVar14 + uVar10)) {
                      if (uVar10 != uVar6) goto LAB_001f16dc;
                      break;
                    }
                    uVar10 = uVar10 + 1;
                    param_2[2] = uVar10;
