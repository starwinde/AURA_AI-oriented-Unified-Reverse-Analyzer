  ...
  if (uVar2 != 0) {
    ...
    do {
      ...
      if (((sVar4 == 0) || (*(char *)((long)piVar1 + sVar4 + 0x43) != '*')) &&
         (param_3 != (char *)0x0)) {
        if ((char)piVar1[1] == '\0') {
          __snprintf_chk(acStack_a8,0x40,2,0x40,&DAT_001fb550,*piVar1);
        }
        else {
          __snprintf_chk(acStack_a8,0x40,2,0x40,&DAT_001fb548,piVar1 + 1);
        }
        pcVar5 = strstr(param_3,acStack_a8);
        fwrite(&DAT_001fa940,1,4,param_2);
        if ((char)piVar1[1] == '\0') {
          puVar7 = &DAT_001f88c8;
          if (pcVar5 == (char *)0x0) goto LAB_00180f54;
          goto LAB_00180f58;
        }
        puVar7 = &DAT_001f88c8;
        if (pcVar5 == (char *)0x0) goto LAB_00180f78;
LAB_00180ec0:
