...

{
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_0018f95c;
...
LAB_0018fe20:
            ...
            if ((((((uVar1 != 1) &&
                ...
                ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0x5f)),_DAT_0020a560
                         ), uVar1 != 6 &&
               ...
               ((a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0x8f)),_DAT_0020a560)
                , uVar1 != 9 &&
              ...
              a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar20 - 0xef)),_DAT_0020a560);
            }
            uVar9 = uVar7 & 0xf0;
            if ((uVar7 & 0xf) != 0) {
              uVar7 = uVar18 - uVar9;
              uVar14 = (ulong)((uVar7 & 0xff) + 1 & 0xff);
              if (6 < (uVar7 & 0xff)) goto LAB_0018fde4;
              goto LAB_0018fe20;
            }
          }
        }
          ...
          do {
            ...
            while (cVar3 != -0x80) {
              ...
              *pcVar5 = cVar3;
              pcVar15 = pcVar15 + -1;
              uVar7 = uVar1 & 0xff;
              if (uVar18 < (uVar1 & 0xff)) goto LAB_0018ff10;
              pcVar5 = pcVar5 + 1;
              cVar3 = *pcVar15;
            }
            uVar1 = uVar7 + 1;
...
LAB_0018f95c:
    ...
    if (uVar20 != 0) {
      ...
      if ((iVar6 == 0) && (iVar6 = MCOperand_getReg(uVar10), iVar6 == 0)) {
        if ((long)uVar20 < 0) {
          ...
          SStream_concat(param_3,&DAT_001f9830,uVar20);
        }
        else {
  ...
  if ((iVar6 == 0) && (iVar6 = MCOperand_getReg(uVar10), iVar6 == 0)) {
    if (uVar20 == 0) {
      SStream_concat0(param_3,&DAT_001fdc78);
    }
  }
  else {
    ...
    if ((iVar6 != 0) && (iVar6 = MCOperand_getReg(uVar11), iVar6 != 0x1e)) {
      ...
      if (lVar16 != 1) {
        SStream_concat(param_3,&DAT_001fbbf8);
      }
    }
    SStream_concat0(param_3,")");
  }
