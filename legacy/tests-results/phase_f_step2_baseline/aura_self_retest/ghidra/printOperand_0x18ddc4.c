...

{
  ...
  if ((uVar7 & 1) != 0) {
    ...
    SStream_concat(param_3,&DAT_001fbb98,
                   &AsmStrs_0 + *(ushort *)(RegAsmOffset_1 + (ulong)(uVar3 - 1) * 2));
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) goto LAB_0018de48;
    uVar3 = uVar3 & 0xffff;
            ...
            do {
              ...
              while (bVar17 != 0x80) {
                ...
                *pbVar2 = bVar17;
                pbVar9 = pbVar9 + -1;
                uVar3 = uVar4 & 0xff;
                if (uVar10 < (uVar4 & 0xff)) goto LAB_0018e358;
                pbVar2 = pbVar2 + 1;
                bVar17 = *pbVar9;
              }
              uVar4 = uVar3 + 1;
...
LAB_0018e358:
  ...
  if ((uVar7 & 1) == 0) goto LAB_0018de48;
  ...
  if (uVar3 == 1) {
    ...
    if (uVar10 < 0x1ce) {
      if (uVar10 < 0x1cc) {
        if (0xac < uVar10) {
          if (uVar10 != 0xee) {
            if (uVar10 == 0x15f) goto LAB_0018e5a8;
            if (uVar10 != 0xe5) goto LAB_0018e520;
          }
LAB_0018e488:
          uVar7 = uVar7 & 0xff;
          if (uVar7 < 10) goto LAB_0018e594;
          SStream_concat(param_3,"$0x%x",uVar7);
          goto LAB_0018df18;
        }
        if (0xa9 < uVar10) goto LAB_0018e428;
        if (uVar10 == 0x18) goto LAB_0018e588;
      }
      goto LAB_0018e520;
    }
    if (uVar10 == 0x279) goto LAB_0018e5a8;
    if (uVar10 < 0x27a) {
      if (uVar10 == 0x200) {
LAB_0018e588:
        uVar7 = uVar14;
        if (uVar14 < 10) goto LAB_0018e594;
        goto LAB_0018def0;
      }
      if (uVar10 == 0x203) goto LAB_0018e488;
    }
    else if (uVar10 == 0x5df) goto LAB_0018e588;
LAB_0018e520:
    uVar7 = uVar14;
    uVar14 = uVar7;
    if ((long)uVar7 < 10) {
      SStream_concat(param_3,&DAT_001fbbb8,uVar7);
      goto LAB_0018df18;
    }
LAB_0018e438:
    uVar7 = uVar14;
    ...
    uVar14 = uVar7;
    if (uVar10 < 0x1ce) {
      if (0x1cb < uVar10) goto LAB_0018e520;
      if (0xac < uVar10) {
        if (uVar10 != 0xee) {
          if (uVar10 == 0x15f) goto LAB_0018e5a8;
          if (uVar10 != 0xe5) goto LAB_0018e4d0;
        }
        goto LAB_0018e488;
      }
      if (uVar10 < 0xaa) {
        if (uVar10 == 0x18) goto LAB_0018dee0;
        goto LAB_0018e4d0;
      }
LAB_0018e428:
      uVar3 = 4;
...
LAB_0018e5a8:
      ...
      if (uVar10 < 0x27a) {
        if (uVar10 != 0x200) {
          if (uVar10 == 0x203) goto LAB_0018e488;
LAB_0018e4d0:
          if (-1 < (long)uVar7) goto LAB_0018e520;
      ...
      else if (uVar10 != 0x5df) goto LAB_0018e4d0;
LAB_0018dee0:
      if (uVar7 < 10) {
LAB_0018e594:
        SStream_concat(param_3,&DAT_001fbbd8,uVar7);
      }
      else {
        if (uVar3 == 0) {
