...
/* WARNING: Removing unreachable block (ram,0x001e6584) */
...
LAB_001e64a4:
      ...
      if (1 < uVar1 - 3) goto LAB_001e64a4;
      local_a = 2;
    }
  }
...
LAB_001e67ac:
    ...
    if (0x19 < uVar1) goto LAB_001e67f4;
    if (uVar1 != 0x18) {
      if (0x18 < uVar1) goto LAB_001e67f4;
      if (uVar1 == 0x17) goto LAB_001e67ac;
      if (0x17 < uVar1) {
LAB_001e67f4:
                    /* WARNING: Subroutine does not return */
...
LAB_001e66c8:
          ...
          if ((uVar1 < 0x16) && (uVar1 < 0x15)) {
            if (uVar1 < 10) {
              ...
              if ((uVar6 & 0x288) != 0) goto LAB_001e66c8;
            }
          }
        }
        goto LAB_001e67f4;
