...

{
  ...
  if (5 < param_1) goto LAB_001ef83c;
  if (param_1 < 4) {
    if (param_1 == 3) {
LAB_001ef828:
      local_a = 1;
...
LAB_001ef83c:
      ...
      if (param_1 == 2) goto LAB_001ef834;
      if (2 < param_1) goto LAB_001ef83c;
      if (param_1 != 0) {
        if (param_1 != 1) goto LAB_001ef83c;
        goto LAB_001ef828;
      }
      local_a = 2;
    }
...
LAB_001ef9a4:
        ...
        if (local_a == 0) {
          ...
          if (local_a != 1) goto LAB_001ef9a4;
          uVar2 = local_9 + 0x45;
        }
      }
    }
