...
void cf_emit_structured(long *param_1,long param_2)
  ...
  if (param_1 == (long *)0x0) {
    ...
    if (uVar1 == 0) {
      ...
      if ((__ptr == (void *)0x0 || __ptr_00 == (void *)0x0) || __ptr_01 == (undefined4 *)0x0) {
            ...
            if (uVar2 < uVar1) {
              if (__ptr_01[uVar2] == 1) {
                *(undefined1 *)((long)__ptr + (ulong)uVar2) = 1;
                ...
                __ptr_01[uVar2] = 1;
                lVar16 = lVar20 + (ulong)uVar2 * 0x48;
                    ...
                    if (uVar3 < uVar1) {
                      if (__ptr_01[uVar3] == 1) {
                        *(undefined1 *)((long)__ptr + (ulong)uVar3) = 1;
                        ...
                        __ptr_01[uVar3] = 1;
                        lVar18 = lVar20 + (ulong)uVar3 * 0x48;
                            ...
                            if (uVar4 < uVar1) {
                              if (__ptr_01[uVar4] == 1) {
                                *(undefined1 *)((long)__ptr + (ulong)uVar4) = 1;
                                ...
                                __ptr_01[uVar4] = 1;
                                lVar10 = lVar20 + (ulong)uVar4 * 0x48;
                                    ...
                                    if (uVar5 < uVar1) {
                                      if (__ptr_01[uVar5] == 1) {
                                        *(undefined1 *)((long)__ptr + (ulong)uVar5) = 1;
                                        ...
                                        dfs_mark(param_1,(ulong)uVar5,__ptr_01,__ptr);
                                        uVar8 = *(uint *)(lVar10 + 0x30);
                                        lVar13 = extraout_x9;
                                        lVar16 = extraout_x14;
                                        lVar17 = extraout_x15;
        ...
        *__ptr_01 = 2;
        local_80 = (undefined8 *)loop_detect(param_1);
        ...
        local_78 = sa_compute_postdom(param_1);
        local_70 = sr_detect(param_1);
        emit_region_constprop_0
                  (param_1,0,(int)param_1[1],__ptr,local_80,local_78,local_70,__ptr_00,param_2);
        sr_destroy(&local_70);
        sa_postdom_destroy(&local_78);
        loop_info_destroy(&local_80);
        free(__ptr);
        free(__ptr_00);
        free(__ptr_01);
        uVar7 = 0;
