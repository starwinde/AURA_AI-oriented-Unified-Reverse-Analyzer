...
LAB_00158988:
    ...
    *(uint *)((long)__ptr + (ulong)uVar4 * 4) = uVar4;
    ...
    puVar7 = __ptr;
    uVar33 = _DAT_0020a520;
    uVar34 = _UNK_0020a528;
    do {
      puVar20 = puVar7 + 2;
      puVar7[1] = uVar34;
      *puVar7 = uVar33;
    ...
    if ((uVar13 & 3) != 0) goto LAB_00158988;
  }
  if (uVar12 != 0) {
    puVar19 = (uint *)(lVar32 + 0x10);
    puVar24 = puVar19 + (ulong)uVar12 * 0x12;
    puVar22 = puVar19;
    do {
      uVar12 = *puVar22;
      if (uVar12 != 0) {
...
LAB_001589dc:
            ...
            if (uVar12 <= uVar4) goto LAB_00158b10;
          }
          uVar21 = piVar14[2];
          uVar17 = piVar14[6];
          if (uVar21 == 0xffffffff || uVar17 == 0xffffffff) goto LAB_001589dc;
          uVar5 = uVar21;
          if (uVar21 < uVar17) {
            uVar5 = uVar17;
          }
          if (uVar13 <= uVar5 || uVar21 == uVar17) goto LAB_001589dc;
...
LAB_00158afc:
            ...
            if (uVar17 == uVar21) goto LAB_00158afc;
            uVar12 = uVar21;
            if (uVar17 < uVar21) {
              uVar12 = uVar17;
            }
            ...
            *(uint *)((long)__ptr + (ulong)uVar17 * 4) = uVar12;
            if (iVar6 != iVar2) goto LAB_00158afc;
...
LAB_00158b10:
    ...
    do {
      while (uVar13 = *puVar19, uVar13 == 0) {
        puVar22 = puVar19 + 0x12;
        *puVar19 = 0;
        puVar19 = puVar22;
        if (puVar22 == puVar24) goto LAB_00158c34;
      }
...
LAB_00159368:
    ...
    *(uint *)(plVar8 + 1) = uVar12;
    ...
    if (uVar13 != 0) {
      puVar7 = (undefined8 *)(lVar32 + (ulong)uVar13 * 0x48 + 8);
...
LAB_00158d94:
              piVar14 = piVar14 + 0x22;
              if (piVar14 == piVar26) goto LAB_00158de0;
            }
            iVar6 = *piVar14;
            iVar2 = piVar14[3];
            if (iVar6 != 1) {
...
LAB_00159054:
                            ...
                            if (piVar18 == piVar25) goto LAB_001590a8;
                          }
                          uVar4 = piVar14[((uVar10 ^ 1) + 1) * 4 + 2];
                          *(undefined1 *)((long)__ptr_04 + uVar15) = 1;
                          if (uVar12 <= uVar4) goto LAB_00159054;
                          piVar18 = piVar18 + 0x22;
          ...
          if ((*(char *)((long)pvVar9 + uVar15) == '\0') ||
            ...
            if (uVar12 < uVar13) {
              ...
              if (*(long *)(lVar32 + uVar15 * 8) == 0) {
                if (*(char *)((long)__ptr_04 + uVar15) == '\0' || 4 < iVar30) goto LAB_00159140;
                iVar31 = iVar30 + 1;
...
LAB_00159140:
              if (*(char *)((long)__ptr_03 + uVar15) == '\0') {
                ...
                if (iVar6 == 0) {
                  local_88[0] = s_result_001f8868[0];
                  local_88[1] = s_result_001f8868[1];
                  local_88[2] = s_result_001f8868[2];
                  local_88[3] = s_result_001f8868[3];
                  local_88[4] = s_result_001f8868[4];
                  local_88[5] = s_result_001f8868[5];
                  local_88[6] = s_result_001f8868[6];
                }
                else {
          ...
          if (uVar13 == uVar12) goto LAB_00159104;
        }
        uVar15 = uVar15 + 1;
        __ptr_00 = g_rank;
        iVar30 = iVar31;
