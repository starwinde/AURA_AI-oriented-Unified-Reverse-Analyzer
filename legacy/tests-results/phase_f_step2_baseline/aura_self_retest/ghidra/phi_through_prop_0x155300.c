...
int phi_through_prop(long *param_1)
...
LAB_00155350:
      do {
        ...
        if (((*(int *)(*(long *)(lVar1 + 8) + lVar9) == 0x1b) && (puVar2[0x18] != 0)) &&
           (iVar6 = chase_copy_src(param_1,**(undefined4 **)(puVar2 + 0x14)), uVar8 = extraout_x13,
           iVar6 != -1)) {
          __ptr = extraout_x14;
          if (extraout_w11 != 1) {
            puVar7 = (undefined4 *)((long)extraout_x14 + 0x10);
            do {
              iVar6 = chase_copy_src(param_1,*puVar7);
              uVar8 = extraout_x13_00;
              if (extraout_w12 != iVar6) goto LAB_001553c8;
              puVar7 = extraout_x10;
