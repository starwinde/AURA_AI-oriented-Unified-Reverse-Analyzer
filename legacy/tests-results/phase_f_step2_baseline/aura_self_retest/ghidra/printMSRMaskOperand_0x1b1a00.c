...
void printMSRMaskOperand(long param_1,undefined8 param_2,undefined8 param_3)

{
  ...
  if ((uVar7 & 1) == 0) {
    ...
    if (uVar3 >> 4 == 0) {
      ...
      SStream_concat0(param_3,&DAT_001fbfd8);
    }
    else {
      SStream_concat0(param_3,&DAT_001fbfd0);
    }
    if ((uVar4 & 0xf) == 0) {
      return;
    }
    SStream_concat0(param_3,&DAT_001fbfe0);
    if ((uVar4 >> 3 & 1) == 0) {
      uVar9 = 0;
      uVar11 = 1;
      uVar13 = 2;
      ...
      SStream_concat0(param_3,&DAT_001fbfe8);
      uVar9 = 8;
      uVar11 = 9;
      uVar13 = 10;
      uVar12 = 0xb;
    ...
    if ((uVar4 >> 1 & 1) != 0) {
      SStream_concat0(param_3,&DAT_001fbd70);
      uVar11 = uVar12;
      uVar9 = uVar13;
    }
    if ((uVar4 & 1) != 0) {
  ...
  if (uVar4 == 0xffffffff) {
    if (uVar3 < 10) {
      SStream_concat(param_3,&DAT_001fbb80,uVar3);
    }
    else {
      SStream_concat(param_3,&DAT_001fbfb0,uVar3);
    }
    if (*(int *)(*(long *)(param_1 + 800) + 0x60) == 0) {
      return;
    }
