...
LAB_001ec410:
    ...
    if (uVar1 == 4) {
      ...
      if (4 < uVar1) goto LAB_001ec410;
      if (uVar1 == 3) {
        iVar2 = ZydisEmitVex(param_1,param_2);
      }
      else {
        if (3 < uVar1) goto LAB_001ec410;
        if (uVar1 < 2) {
          iVar2 = ZydisEmitRex(param_1,param_2);
        }
        else {
          if (uVar1 != 2) goto LAB_001ec410;
...
LAB_001ec598:
    ...
    if (uVar1 == 3) {
      ...
      if (uVar1 == 2) {
        ...
        if (2 < uVar1) goto LAB_001ec598;
        if (uVar1 == 0) goto LAB_001ec5dc;
        if (uVar1 != 1) goto LAB_001ec598;
        iVar2 = ZydisEmitByte(0xf,param_2);
      }
    }
  }
