...
joined_r0x0016c190:
    ...
    if (pcVar6 == (char *)0x0) {
      ...
      if (0xfff < __n) goto joined_r0x0016c190;
      ...
      do {
        while( true ) {
          ...
          *puVar1 = 0;
          puVar1[1] = 0;
          puVar1[2] = 0;
          if (uVar5 <= (uint)lVar12) goto LAB_0016c0d8;
        }
        lVar12 = lVar12 + 1;
...
LAB_0016c0d8:
      ...
      if (puVar9 == (uint *)0x0) {
        if (in_x5 != (undefined8 *)0x0) {
          pcVar10 = malloc(0x40);
          *in_x5 = pcVar10;
          uVar3 = s_data_archive__allocation_failed_001f9ff8._24_8_;
          uVar2 = s_data_archive__allocation_failed_001f9ff8._16_8_;
          uVar7 = s_data_archive__allocation_failed_001f9ff8._0_8_;
          if (pcVar10 != (char *)0x0) {
            *(undefined8 *)(pcVar10 + 8) = s_data_archive__allocation_failed_001f9ff8._8_8_;
