                ...
                if (*(uint *)(puVar9 + 1) != 0) {
                  ...
                  do {
                    if ((*piVar3 == 1) && (iVar17 == piVar3[2])) {
                      if (*(long *)(piVar3 + 4) != 0) goto LAB_00179274;
                      iVar14 = iVar14 + 1;
                      *piVar6 = 0;
                      piVar6[0x12] = 1;
                      goto LAB_00178fc8;
      ...
      if (*(uint *)(puVar9 + 1) != 0) {
        ...
        do {
          if ((*piVar6 == 1) && (puVar10[6] == piVar6[2])) {
            puVar9 = puVar1;
            if (puVar10[10] == 0xffffffff) goto LAB_00179228;
            goto LAB_001791b0;
          }
          piVar6 = piVar6 + 0x22;
        } while (piVar7 != piVar6);
...
LAB_00179100:
  piVar6 = piVar6 + 0x22;
  if (piVar6 == piVar7) goto LAB_0017910c;
  goto LAB_00179010;
LAB_001791b0:
  do {
    if (*(uint *)(puVar9 + 1) != 0) {
        ...
        if ((*piVar7 == 1) && (puVar10[10] == piVar7[2])) {
          ...
          if (uVar13 == 0xd) {
            ...
            if (uVar13 == 0xb) {
              ...
              uVar5 = (ulong)(lVar11 != lVar4);
              if (uVar13 != 0xc) goto LAB_00179228;
            }
          }
          else {
            uVar5 = (ulong)(lVar11 <= lVar4);
            if (uVar13 != 0xe) goto LAB_00179228;
          }
          iVar18 = iVar18 + 1;
          *puVar10 = 1;
...
LAB_00179228:
  ...
  if (puVar15 == puVar10) goto LAB_00179234;
  goto LAB_00179140;
}
