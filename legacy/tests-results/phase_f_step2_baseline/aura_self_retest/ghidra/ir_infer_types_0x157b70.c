        ...
        do {
          while (uVar8 = *puVar6, 0xe < uVar8) {
            if (uVar8 == 0x1b) {
              ...
              if (uVar8 - 0x11 < 4) goto LAB_00157d54;
            }
...
LAB_00157c2c:
            puVar6 = puVar6 + 0x22;
            if (puVar6 == puVar18) goto LAB_00157c38;
          }
          if (10 < uVar8) {
LAB_00157d54:
            uVar4 = 6;
LAB_00157c04:
          ...
          if (8 < uVar8) {
LAB_00157bf8:
            if (puVar6[0x12] == 0) goto LAB_00157c2c;
LAB_00157c00:
            uVar4 = (ulong)puVar6[7];
            goto LAB_00157c04;
          }
          if (uVar8 < 2) {
            if (uVar8 != 0) goto LAB_00157c2c;
            goto LAB_00157bf8;
          }
          if (1 < puVar6[0x12]) {
          ...
          if (puVar6[0x12] == 1) goto LAB_00157c00;
          puVar6 = puVar6 + 0x22;
