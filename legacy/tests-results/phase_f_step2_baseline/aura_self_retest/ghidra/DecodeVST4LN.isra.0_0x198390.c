...
undefined8 DecodeVST4LN_isra_0(undefined8 param_1,uint param_2)

{
  ...
  if (uVar1 == 0xf) {
    ...
    MCOperand_CreateImm0(param_1,lVar8);
  }
  else {
    MCOperand_CreateReg0(param_1,uVar2);
    MCOperand_CreateReg0(param_1,uVar2);
  ...
  if (uVar1 < 0x20) {
    ...
    if (uVar3 < 0x20) {
      MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (ulong)uVar3 * 2));
      if (uVar5 + uVar3 < 0x20) {
        MCOperand_CreateReg0(param_1,*(undefined2 *)(DPR + (ulong)(uVar5 + uVar3) * 2));
