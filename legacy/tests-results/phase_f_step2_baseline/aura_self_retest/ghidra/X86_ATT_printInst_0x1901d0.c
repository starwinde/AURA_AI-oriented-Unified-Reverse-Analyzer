...

{
  ...
  SStream_concat0(param_2,(*(uint *)(OpInfo0_5 + uVar11 * 4) & 0x3fff) + 0x20b2cf);
  uVar11 = ((ulong)(uVar3 >> 0xe) & 0x7f) - 1;
  if (0x65 < uVar11) goto switchD_0019041c_default;
...
LAB_00190b68:
  ...
  case 9:
    ...
    goto LAB_00190b68;
  case 10:
    goto switchD_0019041c_caseD_a;
  case 0xb:
  case 0x1a:
    goto switchD_0019041c_caseD_b;
  case 0xc:
    goto switchD_0019041c_caseD_c;
  case 0xd:
    goto switchD_0019041c_caseD_d;
  case 0xf:
  case 0x27:
    goto switchD_0019041c_caseD_f;
  case 0x10:
  ...
  case 0x18:
    ...
    goto LAB_00190b24;
  case 0x19:
    goto switchD_0019041c_caseD_19;
  case 0x1b:
    printPCRelImm_constprop_0(param_1,param_2);
    goto switchD_0019041c_default;
  case 0x1c:
    goto switchD_0019041c_caseD_1c;
  case 0x1d:
    uVar5 = 1;
    goto LAB_00190b20;
  case 0x1e:
...
LAB_00191604:
    ...
    if (bVar7 < 10) {
      SStream_concat(param_2,&DAT_001fbbd8);
    }
    else {
...
LAB_00191890:
    ...
    printOperand(param_1,0,param_2);
LAB_001918d8:
    SStream_concat0(param_2,&DAT_001fbc10);
...
LAB_00191694:
  ...
  case 0x50:
    ...
    goto LAB_00191758;
  case 0x51:
    goto switchD_0019041c_caseD_51;
  case 0x54:
    uVar5 = 0x20;
LAB_00190bec:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
...
LAB_00190c64:
  ...
  case 0x5a:
    ...
    goto LAB_00190dd4;
  case 0x5b:
    goto switchD_0019041c_caseD_5b;
  case 0x5c:
    uVar14 = 8;
LAB_00191758:
    printOperand(param_1,uVar14,param_2);
...
LAB_00191948:
  ...
  if (0x61 < uVar11) goto switchD_0019041c_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
...
LAB_00191c78:
  ...
  case 0x11:
    ...
    goto switchD_0019041c_default;
  case 0x12:
    SStream_concat0(param_2,&DAT_001fbc40);
    break;
  case 0x13:
    SStream_concat0(param_2,&DAT_001fbc48);
    break;
  case 0x14:
    SStream_concat0(param_2,&DAT_001fbc50);
    break;
  case 0x15:
  case 0x1c:
    uVar5 = 8;
    goto LAB_00191140;
  case 0x16:
    SStream_concat0(param_2,&DAT_001fbc58);
    break;
  case 0x17:
    iVar8 = MCInst_getOpcode(param_1);
    if ((iVar8 == 0x39b) || (iVar8 == 0x3b2)) {
...
switchD_0019041c_caseD_f:
  ...
  case 0x27:
    ...
    break;
  case 0x28:
    goto switchD_00190ba4_caseD_28;
  case 0x29:
    goto switchD_00190ba4_caseD_29;
  case 0x2a:
...
LAB_00190c94:
  ...
  case 0x4e:
    ...
    goto LAB_001911c4;
  case 0x4f:
switchD_0019041c_caseD_51:
    uVar5 = 0x20;
    goto LAB_00190b20;
  case 0x50:
switchD_0019041c_caseD_5b:
    uVar5 = 0x40;
LAB_00190b20:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_00190b24:
...
LAB_001911a8:
  ...
  case 0x54:
    ...
    break;
  case 0x57:
    SStream_concat0(param_2,&DAT_001fbd00);
    break;
  case 0x58:
    SStream_concat0(param_2,&DAT_001fbd08);
    break;
  case 0x59:
    SStream_concat0(param_2,&DAT_001fbd10);
    break;
  case 0x5a:
    SStream_concat0(param_2,&DAT_001fbd18);
    break;
  case 0x5b:
    SStream_concat0(param_2,&DAT_001fbd20);
    break;
  case 0x5c:
    SStream_concat0(param_2,&DAT_001fbd28);
    break;
  case 0x5d:
    SStream_concat0(param_2,&DAT_001fbd30);
    break;
  case 0x5e:
    SStream_concat0(param_2,&DAT_001fbd38);
    break;
  case 0x5f:
    uVar14 = 7;
LAB_00191e60:
...
LAB_00191184:
  ...
  if (0x34 < uVar11) goto switchD_0019041c_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,1,param_2);
    break;
...
LAB_001914f0:
    ...
    goto switchD_0019041c_default;
  case 0x10:
switchD_0019041c_caseD_1c:
    uVar5 = 1;
    goto LAB_00190ac4;
  case 0x11:
switchD_0019041c_caseD_d:
    uVar5 = 4;
    goto LAB_00190ac4;
  case 0x12:
switchD_0019041c_caseD_b:
    uVar5 = 8;
    goto LAB_00190ac4;
  case 0x13:
switchD_0019041c_caseD_c:
    uVar5 = 2;
LAB_00190ac4:
    *(undefined1 *)(param_1 + 0x328) = uVar5;
LAB_00190ac8:
    ...
    goto joined_r0x00190db4;
  case 0x14:
    uVar14 = 3;
LAB_001911e8:
    printOperand(param_1,uVar14,param_2);
switchD_00190cd4_caseD_2:
    SStream_concat0(param_2,", ");
    break;
  case 0x15:
    SStream_concat0(param_2,"{1to4}, ");
...
LAB_001912b0:
  ...
  if (0xd < uVar11) goto switchD_0019041c_default;
  switch(uVar11 & 0xffffffff) {
  case 0:
    printOperand(param_1,0,param_2);
    break;
...
LAB_00192340:
          ...
          if (uVar11 == 4) goto switchD_00190ba4_caseD_29;
          if (uVar11 != 5) goto LAB_00192340;
          SStream_concat0(param_2,", ");
          printOperand(param_1,0,param_2);
        }
        uVar11 = uVar12 >> 0x2d;
        if (uVar11 == 3) {
          ...
          if ((bVar6 & 2) != 0) goto LAB_00190e6c;
          SStream_concat0(param_2,&DAT_001f75a0);
          goto switchD_0019041c_default;
        }
        if (uVar12 >> 0x2f == 0) {
          if (uVar11 == 1) goto switchD_00190ba4_caseD_29;
          if (uVar11 == 2) goto switchD_0019041c_default;
        }
        else if (uVar11 == 4) {
          pcVar15 = ", ";
LAB_00190b40:
...
switchD_0019041c_default:
    ...
    if (uVar11 != 8) {
      if (8 < uVar11) {
        uVar14 = 3;
        if (uVar11 != 9) goto switchD_0019041c_default;
        goto LAB_00190d9c;
      }
      if (uVar11 == 6) goto switchD_00190ba4_caseD_28;
switchD_00190ba4_caseD_29:
LAB_00190e6c:
      SStream_concat0(param_2,"} {z}");
      op_addAvxZeroOpmask(param_1);
      goto switchD_0019041c_default;
    }
switchD_00190d1c_caseD_b:
    uVar14 = 5;
LAB_00190d9c:
    printOperand(param_1,uVar14,param_2);
    SStream_concat0(param_2,&DAT_001f75a0);
...
joined_r0x00190db4:
  ...
  if (*(int *)(*(long *)(param_1 + 800) + 0x60) != 0) {
    ...
    if (uVar9 < 0x9a5) {
      ...
      if (0x3d < uVar9 - 0xa07) goto LAB_0019050c;
...
LAB_00190800:
              ...
              if (((((uVar1 != 1) &&
                ...
                a64_TBL(ZEXT816(0),*(undefined1 (*) [16])(pcVar15 + (uVar11 - 0xef)),_DAT_0020a560);
              }
              uVar16 = uVar9 & 0xf0;
              if ((uVar9 & 0xf) != 0) {
                uVar9 = uVar20 - uVar16;
                uVar12 = (ulong)((uVar9 & 0xff) + 1 & 0xff);
                if (6 < (uVar9 & 0xff)) goto LAB_001907c4;
                goto LAB_00190800;
              }
            }
          }
            ...
            do {
              ...
              while (cVar2 != -0x80) {
                ...
                *pcVar4 = cVar2;
                pcVar15 = pcVar15 + -1;
                uVar9 = uVar1 & 0xff;
                if (uVar20 < (uVar1 & 0xff)) goto LAB_001908ec;
                pcVar4 = pcVar4 + 1;
                cVar2 = *pcVar15;
              }
              uVar1 = uVar9 + 1;
