      ...
      do {
        ...
        if (*(int *)(lVar2 + 0x10) != 0) {
          do {
            ...
            fwrite(&DAT_001f8440,1,2,param_2);
            iVar4 = *(int *)(lVar9 + lVar7);
            if (iVar4 == 0x1b) {
              if (piVar3[2] == -1) {
                fwrite(&DAT_001f8458,1,3,param_2);
              }
              else {
              ...
              case 0x1c:
                ...
                iVar4 = *piVar3;
                goto joined_r0x0014d57c;
              }
              fputs(__s,param_2);
              iVar4 = *piVar3;
joined_r0x0014d57c:
              if (iVar4 == 1) {
                __fprintf_chk(param_2,2,&DAT_001f8478,*(undefined8 *)(piVar3 + 4));
                iVar4 = *piVar3;
                if (iVar4 != 0x17) goto LAB_0014d4d4;
LAB_0014d5a4:
                ...
                if (piVar3[0x12] != 0) {
                  ...
                  do {
                    uVar10 = uVar10 + 1;
                    __fprintf_chk(param_2,2,&DAT_001f8480,*piVar11);
                    piVar11 = piVar11 + 4;
                  } while (uVar10 < (uint)piVar3[0x12]);
                  iVar4 = *piVar3;
                }
                if (iVar4 == 0x17) goto LAB_0014d5a4;
LAB_0014d4d4:
                if (iVar4 == 0x18) {
