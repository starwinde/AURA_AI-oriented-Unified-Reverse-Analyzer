    ...
    do {
      ...
      *(undefined1 *)(lVar17 + uVar25) = 1;
      ...
      if (-1 < (int)uVar16) {
        ...
        do {
          if (*piVar8 - 0x17U < 2 || *piVar8 == 0x1a) goto LAB_0017da40;
          piVar8 = piVar8 + -0x22;
          ...
          if (puVar10 != (undefined4 *)0x0) {
            ...
            *puVar10 = 10;
            ...
            if (puVar14 != (undefined4 *)0x0) {
              *puVar14 = 0xd;
              puVar14[0x26] = uVar4;
              __snprintf_chk(puVar14 + 0x27,0x40,2,0x40,&DAT_001f8930);
            }
            ...
            if (puVar14 != (undefined4 *)0x0) {
              ...
              *puVar14 = 0xf;
              ...
              if (puVar15 != (undefined4 *)0x0) {
                *puVar15 = 0xd;
                puVar15[0x26] = uVar4;
                __snprintf_chk(puVar15 + 0x27,0x40,2,0x40,&DAT_001f8930);
              }
          ...
          *(void **)(puVar9 + 0x2c) = pvVar11;
          if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
            ...
            if (uVar26 <= uVar16) {
              ...
              if (pvVar11 == (void *)0x0) goto LAB_0017e3e4;
              uVar16 = param_4[0x28];
...
joined_r0x0017e094:
            if (iVar3 != 0x17) {
              emit_block_stmts(param_1,uVar25,param_4);
              if (*(uint *)(lVar21 + 0x30) < 3) goto LAB_0017daa0;
              puVar9 = calloc(1,0x130);
            ...
            *(void **)(puVar9 + 0x28) = pvVar11;
            if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
              ...
              if (uVar22 <= uVar16) {
                ...
                if (pvVar11 == (void *)0x0) goto LAB_0017e1d4;
                uVar16 = param_4[0x28];
                *(void **)(param_4 + 0x26) = pvVar11;
...
LAB_0017ecdc:
            *(void **)(puVar9 + 0x28) = pvVar11;
            if (uVar26 < uVar16) goto LAB_0017e870;
LAB_0017e310:
            puVar10 = calloc(1,0x130);
            if (puVar10 != (undefined4 *)0x0) {
              *puVar10 = 0xe;
...
LAB_0017ecd8:
              ...
              *(undefined1 *)(lVar21 + uVar25) = 1;
              ...
              uVar16 = *(uint *)(local_190 + 1);
              pvVar12 = calloc((ulong)uVar16,1);
              if (pvVar12 == (void *)0x0) goto LAB_0017ecd8;
              lVar21 = param_1[6];
              __memcpy_chk(pvVar12,lVar21,(ulong)uVar16);
              uVar22 = *(uint *)(lVar17 + 4);
              *(undefined1 *)(lVar21 + uVar25) = 1;
...
LAB_0017e3e4:
      ...
      if (2 < *(uint *)(lVar21 + 0x30)) {
        ...
        if (puVar9 != (undefined4 *)0x0) {
          *puVar9 = 5;
          if (piVar8 == (int *)0x0) goto LAB_0017dd98;
LAB_0017dd90:
          if (piVar8[0x12] == 0) goto LAB_0017dd98;
          puVar10 = (undefined4 *)build_expr(param_1,piVar8[6]);
LAB_0017de3c:
      ...
      if (iVar1 != 0x18) {
        ...
        *(void **)(puVar9 + 0x28) = pvVar11;
        if (uVar26 < uVar16) {
          ...
          if ((param_4 != (int *)0x0) && (*param_4 == 0)) goto LAB_0017dc3c;
        }
        else {
LAB_0017e4b0:
          if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
LAB_0017dc3c:
            ...
            if (uVar26 <= uVar16) {
              pvVar11 = realloc(pvVar11,((ulong)uVar26 & 0x7fffffff) << 4);
              if (pvVar11 == (void *)0x0) goto LAB_0017dc58;
              uVar16 = param_4[0x28];
              *(void **)(param_4 + 0x26) = pvVar11;
              param_4[0x29] = uVar26 << 1;
            }
    ...
    if (piVar8 == (int *)0x0) {
      ...
      *(void **)(piVar8 + 0x26) = pvVar11;
      ...
      if ((puVar10 != (undefined4 *)0x0) && (*puVar10 = 8, *piVar8 == 0)) {
        ...
        if (uVar26 <= uVar16) {
          pvVar11 = realloc(pvVar11,((ulong)uVar26 & 0x7fffffff) << 4);
          if (pvVar11 == (void *)0x0) goto LAB_0017df78;
          uVar16 = piVar8[0x28];
          *(void **)(piVar8 + 0x26) = pvVar11;
...
LAB_0017df94:
  if ((param_4 != (int *)0x0) && (*param_4 == 0)) {
    ...
    if (uVar26 <= uVar16) {
      pvVar11 = realloc(pvVar11,((ulong)uVar26 & 0x7fffffff) << 4);
      if (pvVar11 == (void *)0x0) goto LAB_0017dacc;
      uVar16 = param_4[0x28];
      *(void **)(param_4 + 0x26) = pvVar11;
      param_4[0x29] = uVar26 << 1;
    }
