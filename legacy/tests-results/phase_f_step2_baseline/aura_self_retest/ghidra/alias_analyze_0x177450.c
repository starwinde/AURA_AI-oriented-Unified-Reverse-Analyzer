...
LAB_00177538:
        ...
        puVar5 = __ptr_00;
        uVar26 = _DAT_0020a520;
        uVar27 = _UNK_0020a528;
        do {
          puVar9 = puVar5 + 4;
        ...
        if ((uVar1 & 3) != 0) goto LAB_00177538;
      }
      ...
      if (puVar5 == (uint *)0x0) {
        ...
        puVar21 = puVar9 + (ulong)uVar7 * 0x12;
        do {
          uVar7 = *puVar9;
          if (uVar7 != 0) {
              ...
              while( true ) {
                ...
                if (uVar11 < 2) {
                  ...
                  if ((uVar11 < uVar1) && (puVar10[7] - 4 < 2)) {
                    ...
                    uVar11 = puVar10[10];
                    uVar6 = (ulong)uVar11;
                    if ((uVar1 <= uVar11) || (1 < puVar10[0xb] - 4)) goto LAB_001775d0;
                    uVar7 = __ptr_00[uVar15];
                    puVar16 = __ptr_00 + uVar15;
                    if (uVar14 != uVar7) {
                      do {
                  ...
                  if (uVar14 == uVar11) goto LAB_00177638;
...
LAB_001775d0:
                ...
                if (uVar7 <= uVar4) goto LAB_00177650;
              }
              if (uVar11 == 0x1b) {
...
LAB_001779f8:
                      ...
                      if (uVar8 < uVar11) {
                        *puVar17 = uVar7;
                        lVar19 = lVar19 + 1;
                        uVar11 = puVar10[0x18];
                        if (uVar11 <= (uint)lVar19) goto LAB_00177638;
                        goto LAB_001779e8;
                      }
                      if (uVar8 == uVar11) {
                        *puVar18 = uVar22;
...
LAB_00177b30:
            ...
            if (uVar4 == uVar7) goto LAB_00177b30;
          }
          uVar7 = uVar7 + 1;
          puVar5 = puVar5 + 1;
        } while (uVar1 != uVar7);
        *(int *)((long)__ptr + 0x14) = iVar13;
        aura_log(1,0,0,&DAT_001fb180,lVar25,(ulong)uVar1);
        puVar24 = __ptr;
      }
      goto LAB_001776dc;
    }
