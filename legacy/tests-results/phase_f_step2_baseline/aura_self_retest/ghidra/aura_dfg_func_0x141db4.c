                    ...
                    if (param_3 == 0) {
                      ...
                      if ((int)plVar4[1] != 0) {
                        ...
                        do {
                          ...
                          if ((uVar8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78b0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 1 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78c0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 2 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78c8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 3 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78d0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 4 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78d8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 5 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78e0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 6 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78e8);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 7 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_001f78f0);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 8 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_00209d60);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 9 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,&DAT_00209d70);
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 10 & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,"r10");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xb & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,"r11");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xc & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,"r12");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xd & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,"r13");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xe & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,"r14");
                            uVar8 = *(uint *)(lVar7 + lVar16);
                          }
                          if ((uVar8 >> 0xf & 1) != 0) {
                            __printf_chk(2,&DAT_001f78b8,"r15");
                          }
                          __printf_chk(2,"\n    kill: ");
                          uVar8 = *(uint *)(lVar6 + 4);
                          if ((uVar8 & 1) != 0) {
                          ...
                          if (uVar8 != 0) {
                            do {
                              while( true ) {
                                ...
                                if ((uVar8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78b0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 1 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78c0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 2 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78c8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 3 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78d0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 4 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78d8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 5 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78e0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 6 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78e8);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 7 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_001f78f0);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 8 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_00209d60);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 9 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,&DAT_00209d70);
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 10 & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,"r10");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xb & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,"r11");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xc & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,"r12");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xd & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,"r13");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xe & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,"r14");
                                  uVar8 = *(uint *)(lVar10 + lVar7);
                                }
                                if ((uVar8 >> 0xf & 1) != 0) {
                                  __printf_chk(2,&DAT_001f7938,"r15");
                                }
                                __printf_chk(2,"  use:");
                                uVar8 = *(uint *)(lVar16 + 4);
                                if ((uVar8 & 1) != 0) {
                          ...
                          do {
                            ...
                            do {
                              if ((1 << (ulong)((uint)lVar7 & 0x1f) & uVar9) != 0) {
                                ...
                                __printf_chk(2,&DAT_001f77f8,(&s_reg_names)[lVar7]);
                                bVar3 = false;
                              }
                              lVar7 = lVar7 + 1;
                            } while (lVar7 != 0x10);
