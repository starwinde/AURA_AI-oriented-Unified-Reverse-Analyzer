...

{
  ...
  if (uVar7 == 0x370) {
    ...
    if (iVar8 == 0xc) {
      ...
      if (lVar12 == -4) {
        SStream_concat0(param_2,&DAT_001f7f88);
        MCInst_setOpcodePub(param_1,0x80);
        printPredicateOperand(param_1,4,param_2);
        SStream_concat0(param_2,&DAT_001fc508);
...
LAB_001b98bc:
        ...
        if (lVar12 == 0) {
          SStream_concat0(param_2,&DAT_001f75a0,0);
          return;
        }
        goto LAB_001ba8b4;
      }
...
LAB_001b97c4:
      ...
      iVar8 = MCOperand_getReg();
      if (iVar8 != 0xc) goto LAB_001b8d60;
...
LAB_001b90d4:
        ...
        iVar8 = MCOperand_getReg();
        if (iVar8 == 0xc) {
          SStream_concat0(param_2,&DAT_001fc518);
          uVar18 = 0x18a;
          goto LAB_001b97f0;
        }
      }
      else if (uVar7 < 0x697) {
        if (uVar7 == 0x387) goto LAB_001b8f84;
        if (uVar7 == 0x692) goto LAB_001b90d4;
      }
      else if (uVar7 == 0xa45) goto LAB_001b97c4;
    }
    else {
      if (uVar7 == 0xc0f) {
LAB_001b8f84:
...
LAB_001b95ac:
          ...
          if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
            SStream_concat0(param_2,&DAT_001f7f90);
            MCInst_setOpcodePub(param_1,0x7f);
            printPredicateOperand(param_1,2,param_2);
            if (uVar7 == 0xb17) {
              SStream_concat0(param_2,&DAT_001fc458);
            }
            SStream_concat0(param_2,&DAT_001fc128);
...
joined_r0x001b8cc4:
        ...
        else if (uVar7 == 0xbe3) goto LAB_001b8c50;
      }
      else if (uVar7 == 0xc5d) {
        uVar7 = 3;
        bVar5 = true;
        ...
        SStream_concat0(param_2,&DAT_001fc520);
...
LAB_001ba68c:
        ...
        if (uVar7 == 0x262) goto LAB_001b9a38;
        if (uVar7 == 0x27a) goto LAB_001b95ac;
      }
      else if (uVar7 == 0x29d) {
        MCInst_getOperand(param_1,2);
        iVar8 = MCOperand_getReg();
...
LAB_001b9908:
      ...
      if (uVar7 == 0x2b1) {
        ...
        uVar7 = uVar9 & 7;
        if (uVar7 == 3) {
          SStream_concat0(param_2,&DAT_001f86a0);
          MCInst_setOpcodePub(param_1,99);
        }
        else if ((uVar9 >> 2 & 1) == 0) {
          if (uVar7 == 1) {
            SStream_concat0(param_2,&DAT_001f86a8);
            MCInst_setOpcodePub(param_1,10);
          }
          else {
            if (uVar7 != 2) goto LAB_001ba584;
            SStream_concat0(param_2,&DAT_001f8698);
          ...
          SStream_concat0(param_2,&DAT_001fbd50);
          MCInst_setOpcodePub(param_1,0x94);
        }
        else {
LAB_001ba584:
          SStream_concat0(param_2,&DAT_001fc428);
        }
...
LAB_001b8c50:
      ...
      if ((iVar8 == 0xc) && (uVar9 = MCInst_getNumOperands(param_1), 5 < uVar9)) {
        ...
        SStream_concat0(param_2,&DAT_001fc128);
        iVar8 = *(int *)(*(long *)(param_1 + 800) + 0x60);
        goto joined_r0x001b8cc4;
      }
    }
    else if (uVar7 == 0x365) goto LAB_001b9908;
LAB_001b8d60:
