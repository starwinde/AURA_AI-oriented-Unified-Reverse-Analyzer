...

{
  ...
  if (param_1 != (undefined8 *)0x0) {
    ...
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n","Offset",&DAT_001f9348,
                  &DAT_001f9360,&DAT_001f9358,&DAT_001fb0d8,"Source");
    __fprintf_chk(param_2,2,"  %-14s %-6s %-20s %-14s %-10s %s\n",&DAT_001fb120,&DAT_001fb110,
                  &DAT_001fb110,&DAT_001fb110,&DAT_001fb110,&DAT_001fb120);
    if (*(int *)(param_1 + 4) != 0) {
      lVar11 = 0;
      uVar10 = 0;
      do {
        ...
        if (uVar5 == 2) {
          pcVar9 = "arg";
LAB_00177104:
          if (*(int *)(lVar1 + 0x24) == 1) goto LAB_001771c0;
LAB_00177110:
          pcVar7 = "heuristic";
        }
        else {
          ...
          if (*(int *)(lVar1 + 0x24) != 1) goto LAB_00177110;
LAB_001771c0:
          pcVar7 = "DWARF";
        }
