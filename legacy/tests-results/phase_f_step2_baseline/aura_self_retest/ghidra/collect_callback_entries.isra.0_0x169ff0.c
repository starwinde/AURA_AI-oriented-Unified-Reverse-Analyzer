...
LAB_0016a098:
  ...
  if (param_3 <= uVar11) goto LAB_0016a2e0;
  goto LAB_0016a0a8;
LAB_0016a1a8:
  local_170 = 0;
...
LAB_0016a268:
    if (local_170 == *puVar6) goto LAB_0016a19c;
  }
LAB_0016a280:
  if (*param_6 <= uVar8) {
    uVar8 = *param_6 << 1;
    ...
    if (puVar9 == (ulong *)0x0) goto LAB_0016a2e0;
    *param_6 = uVar8;
    *param_4 = puVar9;
    uVar8 = *param_5;
  }
...
LAB_0016a19c:
  ...
  if (pcVar13 == pcVar10) goto LAB_0016a098;
  goto LAB_0016a1a8;
}
