...
uint FUN_0019616c(long param_1,ulong param_2)

{
  ...
  iVar11 = (int)uVar12;
  if (uVar5 < 0x288) {
    if (0x284 < uVar5) goto LAB_00196310;
LAB_00196200:
    uVar5 = 3;
    uVar6 = MCInst_getOpcode(param_1);
    if (0x29a < uVar6) goto LAB_00196330;
LAB_00196210:
    if (uVar6 < 0x285) goto LAB_00196268;
...
LAB_001965e8:
        if (uVar15 != 0xf) goto LAB_00196268;
        goto LAB_0019626c;
      }
      if ((uVar3 & 1) == 0) {
        ...
        if ((uVar4 & 1) == 0 && uVar2 == 0) goto LAB_00196270;
        if ((uVar17 == 0xf) != 0 || uVar15 == uVar17) {
          uVar6 = 1;
        }
      }
      else {
        if (uVar15 == 0xf) goto LAB_0019626c;
        uVar6 = uVar14;
        if ((uVar4 & 1) == 0 && uVar2 == 0 || uVar15 != uVar17) goto LAB_00196268;
      }
      goto LAB_001963b0;
    }
    if ((uVar9 & 0xc80) != 0) {
      if ((uVar7 & uVar17 == 0xf) != 0) goto LAB_001965e8;
      if (uVar15 == 0xf) {
        uVar5 = uVar14;
      }
    ...
    if ((uVar9 & 7) == 0) goto LAB_00196268;
    if ((uVar7 & uVar17 == 0xf) != 0) {
      if (uVar15 == 0xe) goto LAB_0019626c;
      goto LAB_00196268;
    }
    ...
    if ((uVar3 & 1) == 0) {
      ...
      uVar6 = uVar14;
      if (((uVar4 & 1) != 0 || uVar2 != 0) && (uVar17 == 0xf) != 0) goto LAB_001966f8;
    }
...
LAB_00196474:
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) goto LAB_00196424;
        uVar10 = *(undefined2 *)(GPR + uVar18 * 2);
        goto LAB_001964a0;
      }
    }
    else if (uVar7 - 0x360 < 3) goto LAB_00196474;
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar18 * 2));
  }
  else {
    if (2 < uVar5 - 0x360) goto LAB_00196200;
LAB_00196310:
    ...
    uVar6 = MCInst_getOpcode(param_1);
    if (uVar6 < 0x29b) goto LAB_00196210;
LAB_00196330:
    if (uVar6 == 0x367) {
LAB_001965bc:
      uVar6 = uVar5;
    ...
    if (uVar6 < 0x368) {
      if (uVar6 - 0x360 < 3) {
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) {
          ...
          else if (uVar17 == uVar15 + 1) goto LAB_001966f8;
        }
        ...
        if ((uVar4 & 1) != 0 || uVar2 != 0) goto LAB_001963b0;
        goto LAB_00196270;
      }
    }
    else if (uVar6 - 0x36a < 2) goto LAB_001965bc;
LAB_00196268:
    uVar14 = uVar5;
LAB_0019626c:
    uVar6 = uVar14;
...
LAB_001963b0:
    ...
    *(undefined1 *)(param_1 + 0x335) = 1;
    ...
    if ((0xb < iVar8 - 0x360U) || ((0xc87UL >> ((ulong)(iVar8 - 0x360U) & 0x3f) & 1) == 0)) {
      ...
      uVar7 = MCInst_getOpcode(param_1);
      if (uVar7 < 0x288) {
        if (uVar7 < 0x285) goto LAB_00196424;
      }
      else {
joined_r0x00196708:
        if (2 < uVar7 - 0x360) goto LAB_00196424;
      }
      goto LAB_00196474;
    }
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar18 * 2));
    MCOperand_CreateReg0(param_1,*(undefined2 *)(GPR + uVar16 * 2));
    uVar7 = MCInst_getOpcode(param_1);
    if (0x287 < uVar7) goto joined_r0x00196708;
    if (0x284 < uVar7) goto LAB_00196474;
LAB_00196424:
    iVar8 = MCInst_getOpcode(param_1);
