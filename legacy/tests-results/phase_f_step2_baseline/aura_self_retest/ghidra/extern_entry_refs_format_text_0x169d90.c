  ...
  if (uVar9 == 0) {
    ...
    if (uVar4 < 2) {
      ...
      do {
        ...
        pauVar3 = pauVar6 + 1;
        pauVar6 = pauVar6 + 3;
        auVar10 = a64_TBL(ZEXT816(0),auVar10,*pauVar3,_DAT_0020a530);
        iVar11 = iVar11 + (_DAT_0020a550 ^
                          (_DAT_0020a550 ^ _DAT_0020a540) & -(uint)(auVar10._0_4_ == 0));
        iVar12 = iVar12 + (_UNK_0020a554 ^
                          (_UNK_0020a554 ^ _UNK_0020a544) & -(uint)(auVar10._4_4_ == 0));
        iVar13 = iVar13 + (_UNK_0020a558 ^
                          (_UNK_0020a558 ^ _UNK_0020a548) & -(uint)(auVar10._8_4_ == 0));
        iVar14 = iVar14 + (_UNK_0020a55c ^
                          (_UNK_0020a55c ^ _UNK_0020a54c) & -(uint)(auVar10._12_4_ == 0));
