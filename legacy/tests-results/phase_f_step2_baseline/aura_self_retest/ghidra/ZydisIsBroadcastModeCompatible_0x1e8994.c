...
undefined8 ZydisIsBroadcastModeCompatible(long param_1,uint param_2,int param_3)
...
LAB_001e8a44:
      ...
      if (param_2 == 1) {
        ...
        if (param_2 != 2) goto LAB_001e8a44;
        local_7 = 0x20;
      }
    }
...
LAB_001e8bf8:
      ...
      if (bVar2 == 0x10) {
        ...
        if (0x10 < bVar2) goto LAB_001e8bf8;
        if (bVar2 == 8) {
          local_4 = 3;
        }
        else {
          if (8 < bVar2) goto LAB_001e8bf8;
          if (bVar2 == 2) {
            local_4 = 1;
          }
          else {
            if (bVar2 != 4) goto LAB_001e8bf8;
            local_4 = 2;
          }
        }
      }
