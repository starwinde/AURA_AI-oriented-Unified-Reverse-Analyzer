...
tracker (markdown `Status:` line per `issue-tracker.md`).
...
write the corresponding label string into the issue file's `Status:`
line.

Edit the right-hand column to match whatever vocabulary you actually
use.
